...
It provides a local source of truth for HarmonyOS NEXT (primarily API 12+, with API 10-18 version notes and compatibility/change hints), with 3,400+ Markdown references across ArkTS, ArkUI, and NDK topics.
