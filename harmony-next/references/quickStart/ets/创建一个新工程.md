...
1. 选择**Application**应用开发（本文以应用开发为例，Atomic Service对应为元服务开发），选择模板“**Empty Ability**”，点击**Next**进行下一步配置。

1. 进入配置工程界面，**Compatible SDK**选择“**5.0.0(12)**”，其他参数保持默认设置即可。

1. 在工程配置信息界面，点击**Finish**，完成工程创建。
