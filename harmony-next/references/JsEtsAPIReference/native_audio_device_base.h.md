...
名称typedef关键字描述[OH_AudioDeviceDescriptorArray](OH_AudioDeviceDescriptorArray.md)OH_AudioDeviceDescriptorArray声明音频设备描述符数组。[OH_AudioDeviceDescriptor](OH_AudioDeviceDescriptor.md)OH_AudioDeviceDescriptor声明音频设备描述符。该实例用于获取更多音频设备详细信息属性。
...
参数项描述[OH_AudioDeviceDescriptor](OH_AudioDeviceDescriptor.md) *audioDeviceDescriptor音频设备描述符。通过 [OH_AudioRoutingManager_GetDevices](native_audio_routing_manager.h.md#ZH-CN_TOPIC_0000002529445675__oh_audioroutingmanager_getdevices) 或者[OH_AudioRoutingManager_OnDeviceChangedCallback](native_audio_routing_manager.h.md#ZH-CN_TOPIC_0000002529445675__oh_audioroutingmanager_ondevicechangedcallback)获取。[OH_AudioDevice_Type](#ZH-CN_TOPIC_0000002497445734__oh_audiodevice_type) *deviceType设备类型指针。将设置设备类型值的变量，指向[OH_AudioDevice_Type](zh-cn_topic_0000002497445734.html#ZH-CN_TOPIC_0000002497445734__oh_audiodevice_type)。
