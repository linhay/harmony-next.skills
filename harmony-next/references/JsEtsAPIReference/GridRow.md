...
gutter[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | [GutterOption](#ZH-CN_TOPIC_0000002497604868__gutteroption)否是
...
名称类型只读可选说明x[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | [GridRowSizeOption](#ZH-CN_TOPIC_0000002497604868__gridrowsizeoption)否是栅格子组件水平方向间距。y[Length](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__length) | [GridRowSizeOption](#ZH-CN_TOPIC_0000002497604868__gridrowsizeoption)否是栅格子组件竖直方向间距。
...
名称类型只读可选说明xs[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在最小宽度类型设备上，栅格子组件的间距。

默认值：0vp

sm[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在小宽度类型设备上，栅格子组件的间距。

默认值：0vp

md[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在中等宽度类型设备上，栅格子组件的间距。

默认值：0vp

lg[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在大宽度类型设备上，栅格子组件的间距。

默认值：0vp

xl[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在特大宽度类型设备上，栅格子组件的间距。

默认值：0vp

xxl[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是
...
设置GridRow中的GridCol垂直主轴方向对齐方式。GridCol本身也可通过alignSelf([ItemAlign](枚举说明.md#ZH-CN_TOPIC_0000002529284967__itemalign))设置自身对齐方式。当上述两种对齐方式都设置时，以GridCol自身设置为准。
...
参数名类型必填说明value[ItemAlign](枚举说明.md#ZH-CN_TOPIC_0000002529284967__itemalign)是
