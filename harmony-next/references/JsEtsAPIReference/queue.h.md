...
名称描述[ffrt_queue_t](ffrt_queue_t.md)队列句柄。
...
参数项描述[ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr队列属性指针。
...
参数项描述[ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr队列属性指针。[ffrt_qos_t](type_def.h.md#ZH-CN_TOPIC_0000002497605556__变量) qosQoS属性值。
...
参数项描述[const ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr队列属性指针。
...
参数项描述[ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr串行队列属性指针。uint64_t timeout_us串行队列任务执行的timeout时间(微秒)。
...
参数项描述[const ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr串行队列属性指针。
...
参数项描述[ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr串行队列属性指针。[ffrt_function_header_t](ffrt_function_header_t.md)* f超时回调方法执行体。
...
类型说明FFRT_C_API [ffrt_function_header_t](ffrt_function_header_t.md)*返回串行队列超时回调方法。
...
参数项描述[ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr队列属性指针。const int max_concurrency最大并发度。
...
参数项描述[ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr队列属性指针。bool mode设置队列任务运行方式。true表示以线程模式运行, false表示以协程方式运行。
...
参数项描述[ffrt_queue_type_t](queue.h.md#ZH-CN_TOPIC_0000002529285545__ffrt_queue_type_t) type队列类型。const char* name队列名字。[const ffrt_queue_attr_t](ffrt_queue_attr_t.md)* attr队列属性。

**返回：**

类型说明FFRT_C_API [ffrt_queue_t](ffrt_queue_t.md)
...
参数项描述[ffrt_queue_t](ffrt_queue_t.md) queue队列句柄。
...
参数项描述[ffrt_queue_t](ffrt_queue_t.md) queue队列句柄。[ffrt_function_header_t](ffrt_function_header_t.md)* f任务的执行体。[const ffrt_task_attr_t](ffrt_task_attr_t.md)* attr任务属性。
...
参数项描述[ffrt_queue_t](ffrt_queue_t.md) queue队列句柄。[ffrt_function_t](type_def.h.md#ZH-CN_TOPIC_0000002497605556__ffrt_function_t) func指定的任务函数。void* arg传递给任务函数的参数。[const ffrt_task_attr_t](ffrt_task_attr_t.md)* attr任务属性。
...
类型说明FFRT_C_API [ffrt_queue_t](ffrt_queue_t.md)返回主线程队列句柄。
