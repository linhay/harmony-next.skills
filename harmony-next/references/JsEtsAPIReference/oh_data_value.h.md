...
名称typedef关键字描述[OH_Data_Value](OH_Data_Value.md)OH_Data_Value定义[OH_Data_Value](OH_Data_Value.md)结构类型。
...
创建[OH_Data_Value](OH_Data_Value.md)实例，用于储存单条键值对数据。

**起始版本：** 18

**返回：**

类型说明[OH_Data_Value](OH_Data_Value.md)

执行成功时返回指向[OH_Data_Value](OH_Data_Value.md)实例的指针。否则返回nullptr。
...
销毁[OH_Data_Value](OH_Data_Value.md)对象。

**起始版本：** 18

**参数：**

参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。int64_t val表示整型数据。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。double val表示REAL类型数据。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。const char *val表示字符串类型数据。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。const unsigned char *val表示BLOB类型数据。size_t length该参数是输入参数，表示开发者传入的BLOB类型数据的大小。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。const [Data_Asset](Data_Asset.md) *val表示指向[Data_Asset](Data_Asset.md)对象的指针。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。const [Data_Asset](Data_Asset.md) * const * val表示指向[Data_Asset](Data_Asset.md)对象的指针。size_t length该参数是输入参数，表示开发者传入的[Data_Asset](Data_Asset.md)对象数组元素的个数。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。const float *val表示指向float数组对象的指针。size_t length该参数是输入参数，表示开发者传入的表示float数组的大小。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。int sign表示正负数，0表示正整数，1表示负整数。const uint64_t *trueForm表示指向整型数组的指针。size_t length该参数是输入参数，表示开发者传入的表示整型数组的大小。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。[OH_ColumnType](#ZH-CN_TOPIC_0000002529284693__oh_columntype) *type一个输出参数，表示数据类型。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。bool *val一个输出参数，true表示空，false表示不为空。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。int64_t *val一个输出参数，表示指向整型数据的指针。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。double *val一个输出参数，表示指向REAL类型数据的指针。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。const char **val
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。const uint8_t **val
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。[Data_Asset](Data_Asset.md) *val
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。size_t *length该参数是输出参数，表示ASSETS类型数据的大小。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。size_t *length该参数是输出参数，表示float数组类型数据的大小。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。float *val
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。size_t *length该参数是输出参数，表示整型数组的大小。
...
参数项描述[OH_Data_Value](OH_Data_Value.md) *value表示指向[OH_Data_Value](OH_Data_Value.md)实例的指针。int *sign一个输出参数，表示正负数，0表示正整数，1表示负整数。uint64_t *trueForm
