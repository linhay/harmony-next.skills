...
名称typedef关键字描述[ffrt_function_header_t](ffrt_function_header_t.md)ffrt_function_header_t任务执行体。[ffrt_dependence_t](ffrt_dependence_t.md)ffrt_dependence_t依赖数据结构。[ffrt_deps_t](ffrt_deps_t.md)ffrt_deps_t依赖结构定义。[ffrt_task_attr_t](ffrt_task_attr_t.md)ffrt_task_attr_t并行任务属性结构。[ffrt_queue_attr_t](ffrt_queue_attr_t.md)ffrt_queue_attr_t串行队列属性结构。[ffrt_condattr_t](ffrt_condattr_t.md)ffrt_condattr_tFFRT条件变量属性结构。[ffrt_mutexattr_t](ffrt_mutexattr_t.md)ffrt_mutexattr_tFFRT锁属性结构。[ffrt_rwlockattr_t](ffrt_rwlockattr_t.md)ffrt_rwlockattr_tFFRT读写锁属性结构。[ffrt_mutex_t](ffrt_mutex_t.md)ffrt_mutex_tFFRT互斥锁结构。[ffrt_rwlock_t](ffrt_rwlock_t.md)ffrt_rwlock_tFFRT读写锁结构。[ffrt_cond_t](ffrt_cond_t.md)ffrt_cond_tFFRT条件变量结构。void*[ffrt_task_handle_t](ffrt_task_handle_t.md)并行任务句柄。[ffrt_fiber_t](ffrt_fiber_t.md)ffrt_fiber_t纤程结构。
