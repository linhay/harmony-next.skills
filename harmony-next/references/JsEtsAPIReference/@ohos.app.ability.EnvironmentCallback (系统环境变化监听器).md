...
[注册系统环境变化的监听](ApplicationContext (应用上下文).md#ZH-CN_TOPIC_0000002529284613__applicationcontextonenvironment)后，在系统环境变化时触发回调。
...
[注册系统环境变化的监听](ApplicationContext (应用上下文).md#ZH-CN_TOPIC_0000002529284613__applicationcontextonenvironment)后，在系统内存变化时触发回调。
