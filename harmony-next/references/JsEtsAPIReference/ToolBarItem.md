...
通过[toolbar](工具栏设置.md#ZH-CN_TOPIC_0000002529444821__toolbar)通用属性为窗口标题栏添加工具栏项。

 该组件从API version 20开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

 该组件一般配合[toolbar](工具栏设置.md#ZH-CN_TOPIC_0000002529444821__toolbar)通用属性进行使用。
...
默认在标题栏对应分栏开头位置创建工具栏项，分栏位置由绑定该[toolbar](工具栏设置.md#ZH-CN_TOPIC_0000002529444821__toolbar)属性的组件所在分栏位置而定。
...
示例代码参考[toolbar](工具栏设置.md#ZH-CN_TOPIC_0000002529444821__示例)。