...
1. 有关Kit API的更多详细信息，请参考[开发说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/development-intro-api)。
...
请参考[es2abc 错误码](Es2abc 编译器错误码.md)进行处理。
