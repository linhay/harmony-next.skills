...
offset[Offset](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__offset)否
...
参数名类型必填说明alignType[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[CalendarAlign](#ZH-CN_TOPIC_0000002497444908__calendaralign枚举说明)>是
...
参数名类型必填说明callback[Callback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<Date>是选中的日期值。
...
名称类型只读可选说明hintRadiusnumber | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是
