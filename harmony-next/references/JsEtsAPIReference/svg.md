...
支持[svg](svg.md)、[rect](rect.md)、[circle](circle.md)、[ellipse](ellipse.md)、[path](path.md)、[line](line.md)、[polygon](polygon.md)、[polyline](polyline.md)、[text](text.md)、[animate](animate.md)、[animateTransform](animateTransform.md)。
