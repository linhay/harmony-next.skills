...
direction[GradientDirection](枚举说明.md#ZH-CN_TOPIC_0000002529284967__gradientdirection)否是
...
通过[slider](slider.md)接口动态调整[borderImage](#ZH-CN_TOPIC_0000002497444854__borderimage)接口中属性值。
...
通过[borderImage](#ZH-CN_TOPIC_0000002497444854__borderimage)接口中的slice、width和outset属性值使用[LocalizedEdgeWidths](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__localizededgewidths12)类型。
