...
控制自定义键盘的输入、删除、关闭等操作。示例代码参考[onInterceptKeyboardAttach](事件.md#ZH-CN_TOPIC_0000002497445228__oninterceptkeyboardattach12)。
...
插入功能按键，目前仅支持Enter键类型，取值见[EnterKeyType](@ohos.inputMethod (输入法框架).md#ZH-CN_TOPIC_0000002529285281__enterkeytype10)。
