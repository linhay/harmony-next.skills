...
[security_antivirus.h](security_antivirus.h.md)
...
SecurityAntivirus_ErrCode [HMS_SecurityAntivirus_UpdateAntivirus](#section5548172953619)(const [SecurityAntivirus_Antivirus](zh-cn_topic_0000002515108491.html)* antivirus)

三方EDR应用向HarmonyOS安全防护服务更新自身应用信息，包含包名、当前版本号、上次更新时间、病毒防护开关状态、用户ID。

SecurityAntivirus_ErrCode [HMS_SecurityAntivirus_QueryAntivirus](#section499213812378)([SecurityAntivirus_Antivirus](zh-cn_topic_0000002515108491.html)** list, uint32_t* length)

零信任应用向HarmonyOS安全防护服务查询所有三方EDR注册信息。

SecurityAntivirus_ErrCode [HMS_SecurityAntivirus_QueryPreinstalledAntivirus](#section109159243919)([SecurityAntivirus_Antivirus](zh-cn_topic_0000002515108491.html)** list, uint32_t* length)
