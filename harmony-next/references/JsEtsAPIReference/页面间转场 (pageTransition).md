...
当路由([router](@ohos.router (页面路由)(不推荐).md))进行切换时，可以通过在[pageTransition](自定义组件的生命周期.md#ZH-CN_TOPIC_0000002529444913__pagetransition9)函数中自定义页面入场和页面退场的转场动效。详细指导请参考[页面转场动画](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-page-transition-animation)。
...
curve[Curve](枚举说明.md#ZH-CN_TOPIC_0000002529284967__curve) | string | [ICurve](@ohos.curves (插值计算).md#ZH-CN_TOPIC_0000002497604788__icurve9)10+否是
