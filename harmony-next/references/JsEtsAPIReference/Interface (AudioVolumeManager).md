...
参数名类型必填说明streamUsage[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage)是需要获取音量值的音频流。
...
参数名类型必填说明streamUsage[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage)是需要获取的最小音量值的音频流。
...
参数名类型必填说明streamUsage[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage)是需要获取的最大音量值的音频流。
...
参数名类型必填说明streamUsage[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage)是检查是否为静音的音频流。
...
参数名类型必填说明streamUsage[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage)是音频流。volumeLevelnumber是音量值等级。device[DeviceType](Enums.md#ZH-CN_TOPIC_0000002529285695__devicetype)是设备类型。
...
参数名类型必填说明typestring是事件回调类型，支持的事件为'streamVolumeChange'，当系统音量发生变化时，触发该事件。streamUsage[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage)是音频流使用类型。callbackCallback<[StreamVolumeEvent](Interfaces (其他).md#ZH-CN_TOPIC_0000002497445724__streamvolumeevent20)>是回调函数，返回变化后的音量信息。
