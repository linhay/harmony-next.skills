...
参数名类型必填说明value[HitTestMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__hittestmode9)是设置当前组件的触摸测试类型。
...
该示例通过设置不同的[HitTestMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__hittestmode9)值演示了Block和Transparent的触摸测试效果。
