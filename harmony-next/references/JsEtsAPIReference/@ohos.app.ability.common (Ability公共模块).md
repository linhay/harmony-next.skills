...
类型说明[_UIAbilityContext.default](UIAbilityContext.md)UIAbilityContext组件上下文。
...
类型说明[_AbilityStageContext.default](AbilityStageContext.md)AbilityStage组件上下文。
...
类型说明[_ApplicationContext.default](ApplicationContext (应用上下文).md)应用上下文。
...
类型说明[_BaseContext.default](BaseContext.md)所有Context的父类。
...
类型说明[_Context.default](Context (Stage模型的上下文基类).md)Stage模型的上下文基类。
...
类型说明[_ExtensionContext.default](ExtensionContext.md)ExtensionAbility组件上下文。
...
类型说明[_FormExtensionContext.default](FormExtensionContext.md)FormExtensionAbility组件上下文。
...
类型说明[_VpnExtensionContext.default](VpnExtensionContext.md)VpnExtensionAbility组件上下文。
...
类型说明[_EventHub.default](EventHub.md)系统提供的基于发布-订阅模式实现的事件通信机制。
...
类型说明[_PacMap](DataAbilityHelper.md#ZH-CN_TOPIC_0000002529284609__pacmap)存储基础数据类型的容器。
...
类型说明[_AbilityStartCallback](AbilityStartCallback.md)定义拉起UIExtensionAbility的回调结果。
...
类型说明[_ConnectOptions](ConnectOptions.md)在连接指定的后台服务时作为入参，用于接收与后台服务的连接状态。
...
类型说明[_UIExtensionContext.default](UIExtensionContext.md)UIExtensionAbility组件上下文。
...
类型说明[_EmbeddableUIAbilityContext.default](EmbeddableUIAbilityContext.md)EmbeddableUIAbility组件上下文。
...
类型说明[_PhotoEditorExtensionContext.default](PhotoEditorExtensionContext.md)PhotoEditorExtensionAbility组件上下文。
...
类型说明[_UIServiceProxy.default](UIServiceProxy.md)提供与UIServiceExtensionAbility服务端数据通信的能力。
...
类型说明[_UIServiceExtensionConnectCallback.default](UIServiceExtensionConnectCallback.md)提供UIServiceExtensionAbility连接回调数据能力。
...
类型说明[_AppServiceExtensionContext.default](AppServiceExtensionContext (应用后台服务扩展组件上下文).md)AppServiceExtensionAbility组件上下文。
...
类型说明[_FormEditExtensionContext.default](FormEditExtensionContext.md)FormEditExtensionAbility组件上下文。
...
类型说明[_LiveFormExtensionContext.default](LiveFormExtensionContext.md)LiveFormExtensionAbility组件上下文。
