...
名称typedef关键字描述[UsbSerial_Params](UsbSerial_Params.md)**attribute**((aligned(8))) UsbSerial_Params定义USB SERIAL DDK使用的USB串口参数.[UsbSerial_DeviceHandle](UsbSerial_DeviceHandle.md)UsbSerial_DeviceHandleUSB串口设备数据结构（不透明）。
