...
参数名类型必填说明value[TextInputOptions](#ZH-CN_TOPIC_0000002529444859__textinputoptions对象说明)否TextInput组件参数。
...
名称类型只读可选说明placeholder[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是设置无输入时的提示文本。text[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
controller8+[TextInputController](#ZH-CN_TOPIC_0000002529444859__textinputcontroller8)否是设置TextInput控制器。

#### 属性

除支持[通用属性](通用属性.md)，还支持以下属性：

默认情况下，通用属性[padding](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__padding)的默认值为：
...
当输入框设置padding为0时，可设置[borderRadius](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderradius)为0避免光标被截断。当光标在文本框边缘显示异常时，请检查是否是padding、borderRadius属性影响造成。

从API version 10开始，单行输入框可设置.width('auto')使组件宽度自适应文本宽度，自适应时组件宽度受constraintSize属性以及父容器传递的最大最小宽度限制，其余使用方式参考[尺寸设置](尺寸设置.md)。
...
参数名类型必填说明value[InputType](#ZH-CN_TOPIC_0000002529444859__inputtype枚举说明)是
...
设置[密码模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input#密码模式)时，装饰线[decoration](#ZH-CN_TOPIC_0000002529444859__decoration12)、下划线[showUnderline](#ZH-CN_TOPIC_0000002529444859__showunderline10)不生效。
...
参数名类型必填说明value[Font](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font)否

placeholder文本样式。

Wearable设备上默认值为：18fp

推荐使用[loadFontSync](@ohos.graphics.text (文本模块).md#ZH-CN_TOPIC_0000002497605988__loadfontsync)注册自定义字体。
...
参数名类型必填说明value[EnterKeyType](#ZH-CN_TOPIC_0000002529444859__enterkeytype枚举说明)是
...
参数名类型必填说明value[FontStyle](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontstyle)是
...
参数名类型必填说明valuenumber | [FontWeight](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontweight) | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是
...
从API version 11开始，设置inputFilter且输入的字符不为空字符，会导致[type](#ZH-CN_TOPIC_0000002529444859__type)接口附带的文本过滤效果失效。
...
参数名类型必填说明value[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是正则表达式。errorCallback<string>否正则匹配失败时，返回被过滤的内容。
...
输入框类型介绍请参考[type](#ZH-CN_TOPIC_0000002529444859__type)接口。
...
参数名类型必填说明value[TextInputStyle](#ZH-CN_TOPIC_0000002529444859__textinputstyle9枚举说明) | [TextContentStyle](zh-cn_topic_0000002529284967.html#ZH-CN_TOPIC_0000002529284967__textcontentstyle10)是
...
可通过[align](位置设置.md#ZH-CN_TOPIC_0000002529284821__align)属性控制文本段落在垂直方向上的位置。此组件中不可使用align属性控制文本段落在水平方向上的位置。
...
参数名类型必填说明value[TextAlign](枚举说明.md#ZH-CN_TOPIC_0000002529284967__textalign)是
...
参数名类型必填说明value[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)是文本选中底板颜色。
...
参数名类型必填说明value[CaretStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__caretstyle10)是光标的风格。
...
设置控件作为文本框单位。需搭配[showUnderline](#ZH-CN_TOPIC_0000002529444859__showunderline10)使用，当showUnderline为true时生效。
...
参数名类型必填说明value[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是文本输入时，文本框的显示单位。
...
当参数类型为ResourceStr并且输入内容不符合定义规范时，提示错误文本，当提示错误单行文本超长时，末尾以省略号显示。当参数类型为undefined时，不显示错误状态。请参考[示例2](#ZH-CN_TOPIC_0000002529444859__示例2设置下划线)。
...
参数名类型必填说明value[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | undefined否
...
参数名类型必填说明value[PasswordIcon](#ZH-CN_TOPIC_0000002529444859__passwordicon10对象说明)是
...
参数名类型必填说明value[BarState](枚举说明.md#ZH-CN_TOPIC_0000002529284967__barstate)是
...
默认在输入控件失去焦点时，关闭自定义键盘，开发者也可以通过[TextInputController](#ZH-CN_TOPIC_0000002529444859__textinputcontroller8).[stopEditing](#ZH-CN_TOPIC_0000002529444859__stopediting10)方法控制键盘关闭。

当设置自定义键盘时，可以通过绑定[onKeyPrelme](按键事件.md#ZH-CN_TOPIC_0000002529284805__onkeypreime12)事件规避物理键盘的输入。
...
参数名类型必填说明value[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8) | [ComponentContent](ComponentContent.md#ZH-CN_TOPIC_0000002497444816__componentcontent-1)22+ | undefined22+是自定义键盘。设定值为undefined时，关闭自定义键盘。options12+[KeyboardOptions](RichEditor.md#ZH-CN_TOPIC_0000002497604894__keyboardoptions12)否设置自定义键盘是否支持避让功能。
...
需要[CopyOptions](枚举说明.md#ZH-CN_TOPIC_0000002529284967__copyoptions9)为CopyOptions.LocalDevice或CopyOptions.CROSS_DEVICE时，本功能生效。
...
参数名类型必填说明valuestring是定义生成密码的规则。

#### cancelButton11+

cancelButton(options: CancelButtonOptions)

设置右侧清除按钮样式，仅支持图片类型的图标。不支持[内联模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input#内联模式)。示例请参考[示例4（设置右侧清除按钮样式）](#ZH-CN_TOPIC_0000002529444859__示例4设置右侧清除按钮样式)。
...
参数名类型必填说明options[CancelButtonOptions](Search.md#ZH-CN_TOPIC_0000002497444916__cancelbuttonoptions12对象说明)是
...
参数value为true时，才能设置options，文本框开启计数下标功能，需要配合[maxLength](#ZH-CN_TOPIC_0000002529444859__maxlength)（设置最大字符限制）一起使用。字符计数器显示的效果是当前输入字符数/最大可输入字符数。

当输入字符数大于最大字符数乘百分比值时，显示字符计数器。如果用户设置计数器时不设置InputCounterOptions，那么当前输入字符数超过最大字符数时，边框和计数器下标将变为红色。用户同时设置参数value为true和[InputCounterOptions](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__inputcounteroptions11对象说明)，当thresholdPercentage数值在有效区间内，且输入字符数超过最大字符数时，边框和计数器下标将变为红色，框体抖动。highlightBorder设置为false，则不显示红色边框，计数器默认显示红色，框体抖动。
...
[示例5（设置计数器）](#ZH-CN_TOPIC_0000002529444859__示例5设置计数器)展示了设置showCounter的效果。
...
options[InputCounterOptions](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__inputcounteroptions11对象说明)否计数器的配置项。
...
参数名类型必填说明value[ContentType](#ZH-CN_TOPIC_0000002529444859__contenttype12枚举说明)是自动填充类型。
...
开启输入框下划线[showUnderline](#ZH-CN_TOPIC_0000002529444859__showunderline10)时，支持配置下划线颜色。
...
参数名类型必填说明value[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [UnderlineColor](#ZH-CN_TOPIC_0000002529444859__underlinecolor12对象说明) | undefined是
...
参数名类型必填说明valuenumber | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)是文本的文本行高。
...
参数名类型必填说明value[TextDecorationOptions](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__textdecorationoptions12对象说明)是
...
参数名类型必填说明valuenumber | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)是
...
参数名类型必填说明value[WordBreak](枚举说明.md#ZH-CN_TOPIC_0000002529284967__wordbreak11)是
...
参数名类型必填说明value[TextOverflow](枚举说明.md#ZH-CN_TOPIC_0000002529284967__textoverflow)是

文本超长时的显示方式。

[内联模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input#内联模式)非编辑态下默认值：TextOverflow.Ellipsis
...
需配合[maxFontSize](#ZH-CN_TOPIC_0000002529444859__maxfontsize12)以及[maxLines](#ZH-CN_TOPIC_0000002529444859__maxlines10)(组件设置为内联输入风格且编辑态时使用)或布局大小限制使用，单独设置不生效。

自适应字号生效时，fontSize设置不生效。

minFontSize小于或等于0时，自适应字号不生效，此时按照[fontSize](#ZH-CN_TOPIC_0000002529444859__fontsize)属性的值生效，未设置时按照其默认值生效。
...
需配合[minFontSize](#ZH-CN_TOPIC_0000002529444859__minfontsize12)以及[maxLines](#ZH-CN_TOPIC_0000002529444859__maxlines10)(组件设置为内联输入风格且编辑态时使用)或布局大小限制使用，单独设置不生效。

自适应字号生效时，fontSize设置不生效。

maxFontSize小于等于0或者maxFontSize小于minFontSize时，自适应字号不生效，此时按照[fontSize](#ZH-CN_TOPIC_0000002529444859__fontsize)属性的值生效，未设置时按照其默认值生效。
...
当设置为TextHeightAdaptivePolicy.MAX_LINES_FIRST时，优先使用[maxLines](#ZH-CN_TOPIC_0000002529444859__maxlines10)属性来调整文本高度。如果使用maxLines属性的布局大小超过了布局约束，则尝试在[minFontSize](#ZH-CN_TOPIC_0000002529444859__minfontsize12)和[maxFontSize](#ZH-CN_TOPIC_0000002529444859__maxfontsize12)的范围内缩小字体以显示更多文本。
...
参数名类型必填说明value[TextHeightAdaptivePolicy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__textheightadaptivepolicy10)是
...
当[输入框的类型](#ZH-CN_TOPIC_0000002529444859__inputtype枚举说明)设置为Password、NEW_PASSWORD和NUMBER_PASSWORD模式时，密码保护功能才能生效。非密码输入模式则不会触发该功能。

[密码模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input#密码模式)时，由于输入框后端的状态和前端应用侧的状态管理变量会不一致，可能导致末尾图标的状态异常。建议在[onSecurityStateChange](#ZH-CN_TOPIC_0000002529444859__onsecuritystatechange12)上增加状态同步。参考[示例1（设置与获取光标位置）](#ZH-CN_TOPIC_0000002529444859__示例1设置与获取光标位置)。
...
参数名类型必填说明strategy[LineBreakStrategy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__linebreakstrategy12)是
...
仅设置[内联模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input#内联模式)时该属性生效。
...
参数名类型必填说明mode[AutoCapitalizationMode](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__autocapitalizationmode20枚举说明)是自动大小写模式，默认状态无效。
...
参数名类型必填说明width[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)>是
...
参数名类型必填说明color[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)>是描边颜色。默认值为字体颜色，设置异常值时取默认值。
...
参数名类型必填说明halfLeading[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<boolean>是
...
参数名类型必填说明scale[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<number | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)>是
...
使用前需在工程中配置configuration.json文件和app.json5文件，具体详见[示例18设置最小字体范围与最大字体范围](#ZH-CN_TOPIC_0000002529444859__示例18设置最小字体范围与最大字体范围)。
...
设置右侧清除按钮样式，仅支持symbol图标。不支持[内联模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input#内联模式)。示例请参考[示例15（设置symbol类型清除按钮)](#ZH-CN_TOPIC_0000002529444859__示例15设置symbol类型清除按钮)。
...
参数名类型必填说明symbolOptions[CancelButtonSymbolOptions](Search.md#ZH-CN_TOPIC_0000002497444916__cancelbuttonsymboloptions12对象说明)是
...
参数名类型必填说明mode[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[EllipsisMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__ellipsismode11)>是
...
启用之后，仅[输入模式](#ZH-CN_TOPIC_0000002529444859__inputtype枚举说明)设置为Password、NEW_PASSWORD或NUMBER_PASSWORD的输入框在进行自动填充时动效可生效。
...
密码输入模式中，[decoration](#ZH-CN_TOPIC_0000002529444859__decoration12)、[showUnderline](#ZH-CN_TOPIC_0000002529444859__showunderline10)不生效。
...
名称说明Default默认风格，光标宽1.5vp，光标高度与文本选中底板高度和字体大小相关。Inline
...
[内联模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input#内联模式)下，不支持拖入文本。
...
名称类型只读可选说明onIconSrcstring | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是

密码输入模式时，能够切换密码可见时显示的图标。

string格式可用于加载网络图片和本地图片。

offIconSrcstring | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是
...
参数名类型必填说明callback[EditableTextOnChangeCallback](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__editabletextonchangecallback12)是当前输入文本内容变化时的回调。
...
非TV设备按下回车键时输入框默认会失焦且收起键盘，可在OnSubmitCallback回调中配置是否收起键盘，参考[示例2（设置下划线）](#ZH-CN_TOPIC_0000002529444859__示例2设置下划线)。
...
参数名类型必填说明callback[OnSubmitCallback](#ZH-CN_TOPIC_0000002529444859__onsubmitcallback18)是提交回调。
...
从API version 7开始支持，从API version 8开始废弃，建议使用[onEditChange](#ZH-CN_TOPIC_0000002529444859__oneditchange8)替代。

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

**参数：**

参数名类型必填说明isEditingboolean是为true表示正在输入。
...
参数名类型必填说明callbackCallback<boolean>是输入状态变化回调，返回值为true表示输入框处于编辑态，返回值为false表示输入框处于非编辑态。
...
参数名类型必填说明callback[OnPasteCallback](#ZH-CN_TOPIC_0000002529444859__onpastecallback18)是粘贴回调。
...
参数名类型必填说明callback[OnTextSelectionChangeCallback](#ZH-CN_TOPIC_0000002529444859__ontextselectionchangecallback18)是文本选择变化回调或光标位置变化回调。
...
参数名类型必填说明callback[OnContentScrollCallback](#ZH-CN_TOPIC_0000002529444859__oncontentscrollcallback18)是文本内容滚动回调。
...
参数名类型必填说明callbackCallback<boolean>是回调函数。
...
参数名类型必填说明callbackCallback<[InsertValue](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__insertvalue12对象说明), boolean>是
...
参数名类型必填说明callbackCallback<[InsertValue](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__insertvalue12对象说明)>是
...
参数名类型必填说明callbackCallback<[DeleteValue](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__deletevalue12对象说明), boolean>是
...
参数名类型必填说明callbackCallback<[DeleteValue](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__deletevalue12对象说明)>是
...
参数名类型必填说明callbackCallback<[EditableTextChangeValue](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__editabletextchangevalue15), boolean>是
...
参数名类型必填说明callbackCallback<[IMEClient](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__imeclient20对象说明)>是在输入框将要绑定输入法前触发该回调。

#### TextInputController8+

TextInput组件的控制器继承自[TextContentControllerBase](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__textcontentcontrollerbase)，涉及的接口有[getTextContentRect](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__gettextcontentrect)、[getTextContentLineCount](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__gettextcontentlinecount)、[getCaretOffset](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__getcaretoffset11)、[addText](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__addtext15)、[deleteText](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__deletetext15)、[getSelection](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__getselection15)、[clearPreviewText](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__clearpreviewtext17)、[setStyledPlaceholder](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__setstyledplaceholder22)。
...
参数名类型必填说明valuenumber是从字符串开始到光标所在位置的字符长度。
...
参数名类型必填说明selectionStartnumber是文本选择区域起始位置，文本框中文字的起始位置为0。selectionEndnumber是文本选择区域结束位置。当selectionEnd<0时，按照0处理；当selectionEnd大于文本长度时，按照文本长度处理。options12+[SelectionOptions](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__selectionoptions12对象说明)否
...
名称类型只读可选说明typing[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是键入时下划线颜色。不填写、undefined、null、无效值时恢复默认。normal[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是非特殊状态时下划线颜色。不填写、undefined、null、无效值时恢复默认。error[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是错误时下划线颜色。不填写、undefined、null、无效值时恢复默认。此选项会修改showCounter属性中达到最大字符数时的颜色。disable[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是禁用时下划线颜色。不填写、undefined、null、无效值时恢复默认。
...
参数名类型必填说明contentstring是粘贴的文本内容。event[PasteEvent](RichEditor.md#ZH-CN_TOPIC_0000002497604894__pasteevent11)是用户自定义的粘贴事件。
...
参数名类型必填说明enterKey[EnterKeyType](#ZH-CN_TOPIC_0000002529444859__enterkeytype枚举说明)是输入法回车键类型。event[SubmitEvent](#ZH-CN_TOPIC_0000002529444859__submitevent11)是提交事件。可以控制是否收起键盘。
...
参数名类型必填说明selectionStartnumber是所选文本的起始位置，文字的起始位置为0。selectionEndnumber是所选文本的结束位置。
...
参数名类型必填说明totalOffsetXnumber是文本在内容区的横坐标偏移，单位px。totalOffsetYnumber是文本在内容区的纵坐标偏移，单位px。

#### 示例

#### 示例1（设置与获取光标位置）

从API version 8开始，该示例通过[controller](#ZH-CN_TOPIC_0000002529444859__textinputcontroller8)实现了光标位置的设置与获取的功能，同时，可以使用!!实现text参数的双向数据绑定（从API version 18开始）。
...
从API version 10开始支持，该示例通过[showUnderline](#ZH-CN_TOPIC_0000002529444859__showunderline10)、[showError](#ZH-CN_TOPIC_0000002529444859__showerror10)、[showUnit](#ZH-CN_TOPIC_0000002529444859__showunit10)、[passwordIcon](#ZH-CN_TOPIC_0000002529444859__passwordicon10)属性展示了下划线在不同场景的效果，同时，可以通过[underlineColor](#ZH-CN_TOPIC_0000002529444859__underlinecolor12)（从API version 12开始）支持配置下划线颜色。
...
该示例通过[customKeyboard](#ZH-CN_TOPIC_0000002529444859__customkeyboard10)（从API version 10开始）属性分别将value中的入参类型设置为[CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)和[ComponentContent](ComponentContent.md#ZH-CN_TOPIC_0000002497444816__componentcontent-1)，实现了自定义键盘的功能。

从API version 22开始[customKeyboard](#ZH-CN_TOPIC_0000002529444859__customkeyboard10)属性新增了入参类型[ComponentContent](zh-cn_topic_0000002497444816.html#ZH-CN_TOPIC_0000002497444816__componentcontent-1)。
...
该示例通过[cancelButton](#ZH-CN_TOPIC_0000002529444859__cancelbutton11)属性展示了自定义右侧清除按钮样式的效果。
...
该示例通过[maxLength](#ZH-CN_TOPIC_0000002529444859__maxlength)、[showCounter](#ZH-CN_TOPIC_0000002529444859__showcounter11)（从API version 11开始）、[showUnderline](#ZH-CN_TOPIC_0000002529444859__showunderline10)（从API version 10开始）属性实现了计数器的功能。
...
该示例通过[onChange](#ZH-CN_TOPIC_0000002529444859__onchange)回调实现了电话号码格式化为XXX XXXX XXXX的功能。
...
从API version 12开始，该示例通过[wordBreak](#ZH-CN_TOPIC_0000002529444859__wordbreak12)属性实现了TextInput不同断行规则下的效果。
...
从API version 12开始，该示例通过[lineHeight](#ZH-CN_TOPIC_0000002529444859__lineheight12)、[letterSpacing](#ZH-CN_TOPIC_0000002529444859__letterspacing12)、[decoration](#ZH-CN_TOPIC_0000002529444859__decoration12)属性展示了不同样式的文本效果。
...
从API version 12开始，该示例通过[fontFeature](#ZH-CN_TOPIC_0000002529444859__fontfeature12)属性实现了文本在不同文字特性下的展示效果。
...
该示例通过[customKeyboard](#ZH-CN_TOPIC_0000002529444859__customkeyboard10)（从API version 10开始）属性配置[KeyboardOptions](zh-cn_topic_0000002497604894.html#ZH-CN_TOPIC_0000002497604894__keyboardoptions12)（从API version 12开始）接口实现了自定义键盘避让的效果。
...
从API version 12开始，该示例通过[minFontSize](#ZH-CN_TOPIC_0000002529444859__minfontsize12)、[maxFontSize](#ZH-CN_TOPIC_0000002529444859__maxfontsize12)、[heightAdaptivePolicy](#ZH-CN_TOPIC_0000002529444859__heightadaptivepolicy12)属性实现了文本自适应字号的功能。
...
从API version 12开始，该示例通过[lineBreakStrategy](#ZH-CN_TOPIC_0000002529444859__linebreakstrategy12)属性实现了TextInput不同折行规则下的效果。
...
从API version 12开始，该示例通过[onWillInsert](#ZH-CN_TOPIC_0000002529444859__onwillinsert12)、[onDidInsert](#ZH-CN_TOPIC_0000002529444859__ondidinsert12)、[onWillDelete](#ZH-CN_TOPIC_0000002529444859__onwilldelete12)、[onDidDelete](#ZH-CN_TOPIC_0000002529444859__ondiddelete12)接口实现了插入和删除的效果。
...
从API version 12开始，该示例通过[editMenuOptions](#ZH-CN_TOPIC_0000002529444859__editmenuoptions12)接口实现了文本设置自定义菜单扩展项的文本内容、图标以及回调的功能，同时，可以在[onPrepareMenu](zh-cn_topic_0000002529444865.html#ZH-CN_TOPIC_0000002529444865__属性-1)（从API version 20开始）回调中，进行菜单数据的设置。
...
从API version 18开始，该示例通过[cancelButton](#ZH-CN_TOPIC_0000002529444859__cancelbutton18)属性展示了自定义右侧symbol类型清除按钮样式的效果。
...
该示例通过[textOverflow](#ZH-CN_TOPIC_0000002529444859__textoverflow12)（从API version 12开始）、[ellipsisMode](#ZH-CN_TOPIC_0000002529444859__ellipsismode18)（从API version 18开始）、[style](#ZH-CN_TOPIC_0000002529444859__style9)（从API version 9开始）属性展示了文本超长省略以及调整省略位置的效果。
...
从API version 8开始，该示例通过[onEditChange](#ZH-CN_TOPIC_0000002529444859__oneditchange8)、[onCopy](#ZH-CN_TOPIC_0000002529444859__oncopy8)、[onCut](#ZH-CN_TOPIC_0000002529444859__oncopy8)、[onPaste](#ZH-CN_TOPIC_0000002529444859__onpaste8)、[onContentScroll](#ZH-CN_TOPIC_0000002529444859__oncontentscroll10)（从API version 10开始）接口实现了输入框监测输入状态变化、复制、剪切、粘贴、文本内容滚动回调的效果，同时，可以通过设置[selectAll](#ZH-CN_TOPIC_0000002529444859__selectall11)（从API version 11开始）属性，输入框初始状态下是否全选文本。
...
从API version 18开始，该示例通过[minFontScale](#ZH-CN_TOPIC_0000002529444859__minfontscale18)、[maxFontScale](#ZH-CN_TOPIC_0000002529444859__maxfontscale18)设置字体显示最小与最大范围。
...
系统字体缩放倍数为2倍系统字体缩放倍数为3.2倍

#### 示例19（设置选中指定区域的文本内容）

从API version 10开始，该示例通过[setTextSelection](#ZH-CN_TOPIC_0000002529444859__settextselection10)方法展示如何设置选中指定区域的文本内容以及菜单的显隐策略。
...
从API version 20开始，该示例通过[strokeWidth](#ZH-CN_TOPIC_0000002529444859__strokewidth20)和[strokeColor](#ZH-CN_TOPIC_0000002529444859__strokecolor20)属性设置文本的描边宽度及颜色。
...
从API version 20开始，该示例通过[enableAutoSpacing](#ZH-CN_TOPIC_0000002529444859__enableautospacing20)属性设置中西文自动间距。
...
从API version 22开始，该示例通过[showCounter](#ZH-CN_TOPIC_0000002529444859__showcounter11)属性的counterTextColor和counterTextOverflowColor设置字符计数颜色以及超出字符颜色。
...
从API version 22开始，该示例通过[setStyledPlaceholder](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__setstyledplaceholder22)接口设置placeholder富文本样式。
...
从API version 22开始，该示例通过[IMEClient](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__imeclient20对象说明)的setExtraConfig设置输入法扩展信息。
