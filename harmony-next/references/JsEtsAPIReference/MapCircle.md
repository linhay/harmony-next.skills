...
更新和查询圆的接口，继承[BaseOverlay](BaseOverlay.md)。在调用map.[MapComponentController](MapComponentController.md)类的[addCircle](MapComponentController.md#section8212148102813)方法时会返回该类型的实例。
