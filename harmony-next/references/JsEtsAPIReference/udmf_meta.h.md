...
名称描述UDMF_META_ENTITY "general.entity"
...
UDMF_META_OPENHARMONY_HINOTE "HarmonyOS.hinote"系统定义的笔记数据类型，归属类型为COMPOSITE_OBJECT。UDMF_META_OPENHARMONY_STYLED_STRING "openharmony.styled-string"
