...
Array<scanBarcode.[ScanCodeRect](scanBarcode (默认界面扫码).md#section1456184716188)>
...
scanBarcode.[ScanOptions](scanBarcode (默认界面扫码).md#section1285191073117)
...
Promise<Array<scanBarcode.[ScanResult](scanBarcode (默认界面扫码).md#section10614317162112)>>
...
AsyncCallback<Array<scanBarcode.[ScanResult](scanBarcode (默认界面扫码).md#section10614317162112)>>

是

回调函数，当启动相机流扫码成功，err为undefined，data为获取到的Array<scanBarcode.[ScanResult](scanBarcode (默认界面扫码).md#section10614317162112)>；否则为错误对象。
...
scanBarcode.[Point](scanBarcode (默认界面扫码).md#section9634457911)
