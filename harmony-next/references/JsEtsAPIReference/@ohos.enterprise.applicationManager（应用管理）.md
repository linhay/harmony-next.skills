...
应用[唯一标识符](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/common_problem_of_application#什么是appidentifier)的数组，可以通过接口[bundleManager.getinstalledbundlelist](zh-cn_topic_0000002529445553.html#ZH-CN_TOPIC_0000002529445553__bundlemanagergetinstalledbundlelist20)获取bundleInfo.signatureInfo.appIdentifier。
...
参数名类型必填说明admin[Want](@ohos.app.ability.Want (Want).md)是企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。appIdentifiersArray<string>是应用[唯一标识符](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/common_problem_of_application#什么是appidentifier)的数组。可以通过接口[bundleManager.getinstalledbundlelist](zh-cn_topic_0000002529445553.html#ZH-CN_TOPIC_0000002529445553__bundlemanagergetinstalledbundlelist20)获取bundleInfo.signatureInfo.appIdentifier。取值范围：数组长度不能超过200。accountIdnumber是
...
参数名类型必填说明admin[Want](@ohos.app.ability.Want (Want).md)是企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。appIdentifiersArray<string>是应用[唯一标识符](BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo)的数组，可以通过接口[bundleManager.getBundleInfo](@ohos.bundle.bundleManager (应用程序包管理模块).md#ZH-CN_TOPIC_0000002497444634__bundlemanagergetbundleinfo14-2)获取bundleInfo.signatureInfo.appIdentifier。重复设置时，新设置的数组会覆盖旧的设置，最多设置200个。
...
类型说明Array<string>允许在Kiosk模式下运行的应用[唯一标识符](BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo)清单。
...
参数名类型必填说明appIdentifierstring是应用[唯一标识符](BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo)，可以通过接口[bundleManager.getBundleInfo](@ohos.bundle.bundleManager (应用程序包管理模块).md#ZH-CN_TOPIC_0000002497444634__bundlemanagergetbundleinfo14-2)获取bundleInfo.signatureInfo.appIdentifier。
