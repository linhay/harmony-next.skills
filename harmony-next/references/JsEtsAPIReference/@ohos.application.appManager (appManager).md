...
类型说明Promise<Array<[ProcessRunningInfo](ProcessRunningInfo.md)>>Promise对象，返回有关运行进程的信息。
...
参数名类型必填说明callbackAsyncCallback<Array<[ProcessRunningInfo](ProcessRunningInfo.md)>>是回调函数，返回有关运行进程的信息。
