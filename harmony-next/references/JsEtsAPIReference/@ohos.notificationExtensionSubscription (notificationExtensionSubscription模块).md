...
类型说明[_NotificationExtensionSubscriptionInfo](NotificationExtensionSubscriptionInfo.md)用于描述通知扩展订阅的信息。
...
类型说明[_GrantedBundleInfo](NotificationCommonDef.md#ZH-CN_TOPIC_0000002529446079__grantedbundleinfo22)授权应用的包信息。