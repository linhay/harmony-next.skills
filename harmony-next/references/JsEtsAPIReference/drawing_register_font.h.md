...
参数项描述[OH_Drawing_FontCollection](OH_Drawing_FontCollection.md)*指向[OH_Drawing_FontCollection](OH_Drawing_FontCollection.md)对象的指针。const char* fontFamily指需要注册的字体的字体名称。const char* familySrc指需要注册的字体文件的路径。
...
参数项描述[OH_Drawing_FontCollection](OH_Drawing_FontCollection.md)*指向[OH_Drawing_FontCollection](OH_Drawing_FontCollection.md)对象的指针。const char* fontFamily指需要注册的字体的字体名称。uint8_t* fontBuffer指需要注册的字体文件的缓冲区。size_t length指需要注册的字体文件的长度。
...
参数项描述[OH_Drawing_FontCollection](OH_Drawing_FontCollection.md)* fontCollection指向[OH_Drawing_FontCollection](OH_Drawing_FontCollection.md)对象的指针。const char* fontFamily需要取消注册的字体家族名称。
