...
参数名类型必填说明options[TextMenuOptions](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuoptions16对象说明)是
...
此接口调用后将影响文本组件的接口[editMenuOptions](Text.md#ZH-CN_TOPIC_0000002497444914__editmenuoptions12)，其回调方法[onCreateMenu](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__oncreatemenu12)的入参列表中不包含被屏蔽的菜单选项。
...
系统服务菜单项指除[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)中的复制、剪切、全选、粘贴以外的菜单项。
...
参数名类型必填说明itemsArray<[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)>是
