...
参数名类型必填说明source[image.PixelMap](Interface (PixelMap).md)是image模块创建的PixelMap实例。可通过图片解码或直接创建获得，具体可见[Image Kit简介](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-overview)。
...
参数名类型必填说明source[image.PixelMap](Interface (PixelMap).md)是image模块创建的PixelMap实例。可通过图片解码或直接创建获得，具体可见[Image Kit简介](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-overview)。regionArray<number>是
...
参数名类型必填说明source[image.PixelMap](Interface (PixelMap).md)是image模块创建的PixelMap实例。可通过图片解码或直接创建获得，具体可见[Image Kit简介](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-overview)。callbackAsyncCallback<[ColorPicker](#ZH-CN_TOPIC_0000002497605972__colorpicker)>是回调函数。返回创建的ColorPicker实例。
...
类型说明Promise<[image.PixelMap](Interface (PixelMap).md)>Promise对象。返回已添加链表效果的源图像的image.PixelMap。
...
类型说明[image.PixelMap](Interface (PixelMap).md)已添加效果的源图像的image.PixelMap。
