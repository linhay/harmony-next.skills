...
接口调用方ID，调用方联系钱包运营申请交通卡服务时获取，仅对**受邀应用**开放申请。
...
[DeviceType](#section423812461512)
...
Promise<[CardMetadataInDevice](#section691675771410)[]>
...
指定卡的卡号，要求使用[getCardMetadataInDevice](#section3931434195115) 返回的 [CardMetadataInDevice](#section691675771410) 中的[CardMetadata](#section16396135219146) 对应的logicalCardNumber。
...
存在该卡的设备的ID，要求使用[getCardMetadataInDevice](#section3931434195115) 返回的[CardMetadataInDevice](#section691675771410) 对应的deviceId。
...
Promise<[TransitCardInfo](#section1175310561152)>
...
城市的一种交通卡产品的ID，要求使用 [getCardMetadataInDevice](#section3931434195115) 返回的 [CardMetadataInDevice](#section691675771410)中的 [CardMetadata](#section16396135219146) 对应的issuerId。
...
开卡令牌，要求使用[canAddTransitCard](#section842743618139)接口返回的字符串。
...
Promise<[CardMetadata](#section16396135219146)>
...
卡的序列号，要求使用[getCardMetadataInDevice](#section3931434195115)返回的[CardMetadataInDevice](#section691675771410)中的[CardMetadata](#section16396135219146)对应的logicalCardNumber。
...
卡所在的设备ID，要求使用[getCardMetadataInDevice](#section3931434195115)返回的[CardMetadataInDevice](#section691675771410)对应的deviceId。
...
[CardMetadata](#section16396135219146)[]
