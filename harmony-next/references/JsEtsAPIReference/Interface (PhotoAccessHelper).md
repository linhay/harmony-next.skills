...
参数名类型必填说明burstKeystring是一组连拍照片的唯一标识：uuid(可传入[PhotoKeys](Enums.md#ZH-CN_TOPIC_0000002529445919__photokeys)的BURST_KEY)。字符串长度为36。options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是连拍照片检索选项。
...
参数名类型必填说明photoType[PhotoType](Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是创建的文件类型，IMAGE或者VIDEO类型。extensionstring是文件名后缀参数，例如：'jpg'。options[CreateOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__createoptions)是
...
参数名类型必填说明photoType[PhotoType](Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是创建的文件类型，IMAGE或者VIDEO类型。extensionstring是文件名后缀参数，例如：'jpg'。callbackAsyncCallback<string>是callback返回创建的图片和视频的uri。
...
参数名类型必填说明photoType[PhotoType](Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是创建的文件类型，IMAGE或者VIDEO类型。extensionstring是文件名后缀参数，例如：'jpg'。options[CreateOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__createoptions)否
...
参数名类型必填说明type[AlbumType](Enums.md#ZH-CN_TOPIC_0000002529445919__albumtype)是相册类型。subtype[AlbumSubtype](Enums.md#ZH-CN_TOPIC_0000002529445919__albumsubtype)是相册子类型。options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是检索选项。callbackAsyncCallback<[FetchResult](Interface (FetchResult).md)<[Album](Interface (Album).md)>>是callback返回获取相册的结果集。
...
参数名类型必填说明type[AlbumType](Enums.md#ZH-CN_TOPIC_0000002529445919__albumtype)是相册类型。subtype[AlbumSubtype](Enums.md#ZH-CN_TOPIC_0000002529445919__albumsubtype)是相册子类型。callbackAsyncCallback<[FetchResult](Interface (FetchResult).md)<[Album](Interface (Album).md)>>是callback返回获取相册的结果集。
...
参数名类型必填说明type[AlbumType](Enums.md#ZH-CN_TOPIC_0000002529445919__albumtype)是相册类型。subtype[AlbumSubtype](Enums.md#ZH-CN_TOPIC_0000002529445919__albumsubtype)是相册子类型。options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)否检索选项，不填时默认根据相册类型检索。
...
该接口依赖于[MediaChangeRequest](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__mediachangerequest11)对象，详细代码示例请参见[MediaAssetChangeRequest](Class (MediaAssetChangeRequest).md)和[MediaAlbumChangeRequest](Class (MediaAlbumChangeRequest).md)中的接口示例。
...
参数名类型必填说明photoType[PhotoType](Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是媒体文件类型。
...
以下错误码的详细介绍请参见[通用错误码](通用错误码.md)和[媒体库错误码](媒体库错误码.md)。
...
从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAssetChangeRequest.deleteAssets](Class (MediaAssetChangeRequest).md#ZH-CN_TOPIC_0000002497445968__deleteassets11-1)替代。
...
参数名类型必填说明options[RecentPhotoOptions](Classes (其他).md#ZH-CN_TOPIC_0000002497605950__recentphotooptions20)否
...
类型说明Promise<[RecentPhotoInfo](Classes (其他).md#ZH-CN_TOPIC_0000002497605950__recentphotoinfo20)>Promise对象，返回最近图片信息。
...
接口抛出错误码的详细介绍请参见[媒体库错误码](媒体库错误码.md)。
