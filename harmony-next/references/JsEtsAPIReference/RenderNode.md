...
参数名类型必填说明size[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)是将要设置的RenderNode的大小。
...
类型说明[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)获取当前RenderNode的大小，默认值宽度和高度为0。
...
参数名类型必填说明position[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)是将要设置的RenderNode的位置。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)获取当前RenderNode的位置，默认位置为{ x: 0, y: 0 }。
...
参数名类型必填说明frame[Frame](Graphics.md#ZH-CN_TOPIC_0000002529444761__frame)是将要设置的RenderNode的大小和位置。
...
参数名类型必填说明pivot[Pivot](Graphics.md#ZH-CN_TOPIC_0000002529444761__pivot)是将要设置的RenderNode的轴心。
...
类型说明[Pivot](Graphics.md#ZH-CN_TOPIC_0000002529444761__pivot)获取当前RenderNode的轴心，默认值为{ x: 0.5, y: 0.5}。
...
参数名类型必填说明scale[Scale](Graphics.md#ZH-CN_TOPIC_0000002529444761__scale)是将要设置的RenderNode的缩放比例。
...
类型说明[Scale](Graphics.md#ZH-CN_TOPIC_0000002529444761__scale)获取当前RenderNode的比例，默认值为{ x: 1, y: 1 }。
...
参数名类型必填说明translation[Translation](Graphics.md#ZH-CN_TOPIC_0000002529444761__translation)是将要设置的RenderNode的平移量。
...
类型说明[Translation](Graphics.md#ZH-CN_TOPIC_0000002529444761__translation)获取当前RenderNode的平移量，默认值为{ x: 0, y: 0 }。
...
参数名类型必填说明rotation[Rotation](Graphics.md#ZH-CN_TOPIC_0000002529444761__rotation)是将要设置的RenderNode的旋转角度。
...
类型说明[Rotation](Graphics.md#ZH-CN_TOPIC_0000002529444761__rotation)当前RenderNode的旋转角度。默认值为{ x: 0, y: 0, z: 0}。
...
参数名类型必填说明transform[Matrix4](Graphics.md#ZH-CN_TOPIC_0000002529444761__matrix4)是将要设置的RenderNode的变换矩阵。
...
类型说明[Matrix4](Graphics.md#ZH-CN_TOPIC_0000002529444761__matrix4)当前RenderNode的变换矩阵。
...
参数名类型必填说明offset[Offset](Graphics.md#ZH-CN_TOPIC_0000002529444761__offset)是将要设置的RenderNode的阴影偏移。
...
类型说明[Offset](Graphics.md#ZH-CN_TOPIC_0000002529444761__offset)当前RenderNode的阴影偏移，默认值为{ x: 0, y: 0 }。
...
该接口的[DrawContext](Graphics.md#ZH-CN_TOPIC_0000002529444761__drawcontext)中的Canvas是用于记录指令的临时Canvas，并非节点的真实Canvas。使用请参见[调整自定义绘制Canvas的变换矩阵](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-rendernode#调整自定义绘制canvas的变换矩阵)。
...
参数名类型必填说明context[DrawContext](Graphics.md#ZH-CN_TOPIC_0000002529444761__drawcontext)是图形绘制上下文。
...
参数名类型必填说明style[Edges](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)<[BorderStyle](枚举说明.md#ZH-CN_TOPIC_0000002529284967__borderstyle)>是RenderNode的边框样式。
...
类型说明[Edges](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)<[BorderStyle](枚举说明.md#ZH-CN_TOPIC_0000002529284967__borderstyle)>RenderNode的边框样式。
...
参数名类型必填说明width[Edges<number>](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)是RenderNode的边框宽度，单位为vp。
...
类型说明[Edges<number>](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)RenderNode的边框宽度，默认所有边框宽度为0vp。
...
参数名类型必填说明color[Edges<number>](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)是RenderNode的边框颜色。
...
类型说明[Edges<number>](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)RenderNode的边框颜色，默认所有边框颜色为0XFF000000。
...
参数名类型必填说明radius[BorderRadiuses](Graphics.md#ZH-CN_TOPIC_0000002529444761__borderradiuses12)是RenderNode的边框圆角，单位为vp。
...
类型说明[BorderRadiuses](Graphics.md#ZH-CN_TOPIC_0000002529444761__borderradiuses12)RenderNode的边框圆角，默认所有边框圆角为0vp。
...
参数名类型必填说明shapeMask[ShapeMask](Graphics.md#ZH-CN_TOPIC_0000002529444761__shapemask12)是RenderNode的遮罩。
...
类型说明[ShapeMask](Graphics.md#ZH-CN_TOPIC_0000002529444761__shapemask12)RenderNode的边框遮罩。
...
参数名类型必填说明shapeClip[ShapeClip](Graphics.md#ZH-CN_TOPIC_0000002529444761__shapeclip12)是RenderNode的裁剪形状。
...
类型说明[ShapeClip](Graphics.md#ZH-CN_TOPIC_0000002529444761__shapeclip12)RenderNode的裁剪形状。
...
参数名类型必填说明unit[LengthMetricsUnit](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetricsunit12)是设置RenderNode各个属性使用的单位。
...
类型说明[LengthMetricsUnit](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetricsunit12)获取RenderNode各个属性使用的单位，默认值为LengthMetricsUnit.DEFAULT。
