...
类型说明[_AbilityContext](UIAbilityContext.md)需要保存状态的UIAbility所对应的context，继承自[Context](Context (Stage模型的上下文基类).md)，提供UIAbility的相关配置信息以及操作UIAbility和ServiceExtensionAbility的方法。