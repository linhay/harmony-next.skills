...
不允许和其他滚动类组件，如：[ArcList](ArcList.md)、[List](List.md)、[Grid](Grid.md)、[Scroll](Scroll.md)和[WaterFlow](WaterFlow.md)绑定同一个滚动控制对象。
...
Grid组件使用通用属性[clip12+](形状裁剪.md#ZH-CN_TOPIC_0000002529284827__clip12)和通用属性[clip18+](形状裁剪.md#ZH-CN_TOPIC_0000002529284827__clip18)时默认值都为true。
...
参数名类型必填说明valuestring | [ItemFillPolicy](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__itemfillpolicy22)是当前网格组件布局列的数量。
...
- 此模式下GridItem交叉轴方向尺寸与网格一致，可以通过设置[constraintSize](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__constraintsize)中的maxWidth或maxHeight限制GridItem交叉轴方向尺寸小于网格。
...
参数名类型必填说明value[Color](枚举说明.md#ZH-CN_TOPIC_0000002529284967__color) | number | string是
...
设置缓存后会在Grid显示区域上下各缓存cachedCount*列数个GridItem。配合[裁剪](形状裁剪.md#ZH-CN_TOPIC_0000002529284827__clip12)或[内容裁剪](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__clipcontent14)属性可以显示出预加载节点。
...
设置是否开启鼠标框选。开启框选后，可以配合GridItem的selected属性和onSelect事件获取GridItem的选中状态，还可以设置[选中态样式](多态样式.md)（无默认选中样式）。
...
参数名类型必填说明value[EdgeEffect](枚举说明.md#ZH-CN_TOPIC_0000002529284967__edgeeffect)是

Grid组件的边缘滑动效果，支持弹簧效果和阴影效果。

默认值：EdgeEffect.None

options11+[EdgeEffectOptions](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__edgeeffectoptions11对象说明)否
...
参数名类型必填说明alignment[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[GridItemAlignment](#ZH-CN_TOPIC_0000002529444839__griditemalignment12枚举说明)>是
...
参数名类型必填说明mode[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[FocusWrapMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__focuswrapmode20)>是
...
由于拖拽检测也需要长按，且事件处理机制优先触发子组件事件，GridItem上绑定[LongPressGesture](LongPressGesture.md#ZH-CN_TOPIC_0000002529444825__longpressgesture-1)时无法触发拖拽。如有长按和拖拽同时使用的需求可以使用通用拖拽事件。
...
参数名类型必填说明event[ItemDragInfo](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__itemdraginfo对象说明)是拖拽点的信息。itemIndexnumber是被拖拽网格元素索引值。
...
参数名类型必填说明event[ItemDragInfo](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__itemdraginfo对象说明)是拖拽点的信息。
...
参数名类型必填说明event[ItemDragInfo](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__itemdraginfo对象说明)是拖拽点的信息。itemIndexnumber是拖拽起始位置。insertIndexnumber是拖拽插入位置。
...
参数名类型必填说明event[ItemDragInfo](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__itemdraginfo对象说明)是拖拽点的信息。itemIndexnumber是拖拽离开的网格元素索引值。
...
参数名类型必填说明event[ItemDragInfo](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__itemdraginfo对象说明)是拖拽点的信息。itemIndexnumber是拖拽起始位置。insertIndexnumber是拖拽插入位置。isSuccessboolean是
...
从API version 10开始支持，从API version 12开始废弃，建议使用[onDidScroll](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__ondidscroll12)替代。
...
UIGridEvent继承于[UIScrollableCommonEvent](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__uiscrollablecommonevent19)。
...
GridDataSource实现了LazyForEach数据源接口[IDataSource](LazyForEach.md#ZH-CN_TOPIC_0000002529444937__idatasource)，用于通过LazyForEach给Grid提供子组件。
...
通过[fadingEdge](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__fadingedge14)属性来设置边缘渐隐效果。
...
该示例通过[PanGesture](PanGesture.md#ZH-CN_TOPIC_0000002497604860__pangesture-1)接口，实现了Grid组件一边滑动一边选择的效果。
...
该示例通过[gesture](绑定手势方法.md#ZH-CN_TOPIC_0000002529284849__gesture)接口，实现了GridItem组件自定义拖拽效果。
