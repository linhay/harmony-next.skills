...
名称描述[avimage_generator.h](avimage_generator.h.md)定义AVImageGenerator接口。使用其C API从视频资源中获取指定时间点视频帧。[avimage_generator_base.h](avimage_generator_base.h.md)定义AVImageGenerator的枚举。