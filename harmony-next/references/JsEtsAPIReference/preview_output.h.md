...
名称typedef关键字描述[PreviewOutput_Callbacks](PreviewOutput_Callbacks.md)PreviewOutput_Callbacks用于预览输出的回调。[Camera_PreviewOutput](Camera_PreviewOutput.md)Camera_PreviewOutput
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput传递回调的预览输出实例。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput传递回调的预览输出实例。int32_t frameCount回调传递的帧计数。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput传递回调的预览输出实例。[Camera_ErrorCode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_errorcode) errorCode预览输出的错误码。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput预览输出实例。[PreviewOutput_Callbacks](PreviewOutput_Callbacks.md)* callback要注册的预览输出更改事件回调。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput预览输出实例。[PreviewOutput_Callbacks](PreviewOutput_Callbacks.md)* callback要注销的预览输出更改事件回调。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput要启动的预览输出实例。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput要停止的预览输出实例。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput要释放的预览输出实例。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput提供当前预览输出配置文件的预览输出实例。[Camera_Profile](Camera_Profile.md)** profile如果方法调用成功，将记录当前的预览输出配置文件。
...
参数项描述[Camera_Profile](Camera_Profile.md)* profile要被删除的预览配置文件实例。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput用于获取预览旋转角度的预览输出实例。int displayRotation当前显示的旋转角度。[Camera_ImageRotation](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_imagerotation)* imageRotation预览旋转角度结果。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput用于设置预览旋转角度的预览输出实例。[Camera_ImageRotation](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_imagerotation) previewRotation预览的显示旋转角度。bool isDisplayLockedSurface在屏幕旋转时是否锁定方向，未设置时默认取值为false，即不锁定方向。true表示锁定方向，false表示不锁定方向。详情请参考[SurfaceRotationOptions](XComponent.md#ZH-CN_TOPIC_0000002529444889__surfacerotationoptions12对象说明)
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput传递支持的帧率列表的预览输出实例。[Camera_FrameRateRange](Camera_FrameRateRange.md)** frameRateRange如果方法调用成功，将记录支持的预览输出帧率列表。uint32_t* size如果方法调用成功，将记录支持的预览输出帧率列表大小。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput预览输出实例。[Camera_FrameRateRange](Camera_FrameRateRange.md)* frameRateRange要删除的帧率列表。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput要设置帧率的预览输出实例。int32_t minFps要设置的最小值。int32_t maxFps要设置的最大值。
...
参数项描述[Camera_PreviewOutput](Camera_PreviewOutput.md)* previewOutput传递当前预览输出帧率的预览输出实例。[Camera_FrameRateRange](Camera_FrameRateRange.md)* frameRateRange如果方法调用成功，则将记录当前的[Camera_FrameRateRange](Camera_FrameRateRange.md)。
