...
参数名类型必填说明value[BadgeParamWithNumber](#ZH-CN_TOPIC_0000002529284897__badgeparamwithnumber对象说明)是数字标记组件参数。
...
参数名类型必填说明value[BadgeParamWithString](#ZH-CN_TOPIC_0000002529284897__badgeparamwithstring对象说明)是字符串标记组件参数。
...
名称类型只读可选说明position[BadgePosition](#ZH-CN_TOPIC_0000002529284897__badgeposition枚举说明)|[Position10+](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__position)否是
...
BadgePosition作为入参时，会跟随[Direction](枚举说明.md#ZH-CN_TOPIC_0000002529284967__direction)属性控制镜像显示。

style[BadgeStyle](#ZH-CN_TOPIC_0000002529284897__badgestyle对象说明)否否Badge组件可设置样式，支持设置文本颜色、尺寸、圆点颜色和尺寸。

#### BadgeParamWithNumber对象说明

BadgeParamWithNumber继承自[BadgeParam](#ZH-CN_TOPIC_0000002529284897__badgeparam对象说明)，具有BadgeParam的全部属性。
...
BadgeParamWithString继承自[BadgeParam](#ZH-CN_TOPIC_0000002529284897__badgeparam对象说明)，具有BadgeParam的全部属性。
...
名称值说明RightTop-圆点显示在右上角。Right-圆点显示在右侧纵向居中。Left-圆点显示在左侧纵向居中。
...
fontSizenumber | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是

文本大小。string类型仅支持number类型取值的字符串形式，可以附带单位，例如"10"、"10fp"。
...
badgeSizenumber | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
badgeColor[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
fontWeight10+number |[FontWeight](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontweight) | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
borderColor10+[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
borderWidth10+[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是
...
outerBorderColor22+[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
outerBorderWidth22+[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否是
...
enableAutoAvoidance22+boolean否是
...
该示例通过[BadgeParamWithNumber](#ZH-CN_TOPIC_0000002529284897__badgeparamwithnumber对象说明)的入参value、[BadgeParamWithString](#ZH-CN_TOPIC_0000002529284897__badgeparamwithstring对象说明)的入参count，实现了传入空值、字符、数字时标记组件展现不同的效果。
