...
名称类型必填装饰器类型说明contentItem[ContentItem](#ZH-CN_TOPIC_0000002497444976__contentitem)否@Prop

定义左侧以及中间元素。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

operateItem[OperateItem](#ZH-CN_TOPIC_0000002497444976__operateitem)否@Prop
...
名称类型只读可选说明iconStyle[IconType](#ZH-CN_TOPIC_0000002497444976__icontype)否是
...
primaryText[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
secondaryText[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
description[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
名称值说明BADGE1左侧图标为badge类型，图标大小为8*8vp。NORMAL_ICON2左侧图标为小图标类型，图标大小为16*16vp。SYSTEM_ICON3左侧图标为系统图标类型，图标大小为24*24vp。HEAD_SCULPTURE4左侧图标为头像类型，图标大小为40*40vp。APP_ICON5左侧图标为应用图标类型，图标大小为64*64vp。PREVIEW6左侧图标为预览图类型，图标大小为96*96vp。LONGITUDINAL7左侧图标为横向特殊比例（宽比高大），保持最长边为96vp。VERTICAL8左侧图标为竖向特殊比例（高比宽大），保持最长边为96vp。
...
名称类型只读可选说明arrow[OperateIcon](#ZH-CN_TOPIC_0000002497444976__operateicon)否是
...
icon[OperateIcon](#ZH-CN_TOPIC_0000002497444976__operateicon)否是
...
subIcon[OperateIcon](#ZH-CN_TOPIC_0000002497444976__operateicon)否是
...
button[OperateButton](#ZH-CN_TOPIC_0000002497444976__operatebutton)否是
...
switch[OperateCheck](#ZH-CN_TOPIC_0000002497444976__operatecheck)否是
...
checkbox[OperateCheck](#ZH-CN_TOPIC_0000002497444976__operatecheck)否是
...
radio[OperateCheck](#ZH-CN_TOPIC_0000002497444976__operatecheck)否是
...
image[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
