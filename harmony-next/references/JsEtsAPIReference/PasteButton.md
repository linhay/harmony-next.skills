...
参数名类型必填说明event[ClickEvent](点击事件.md#ZH-CN_TOPIC_0000002529284807__clickevent)是见ClickEvent对象说明。result[PasteButtonOnClickResult](#ZH-CN_TOPIC_0000002529444905__pastebuttononclickresult枚举说明)是剪贴板权限的授权结果，授权后可以读取当前剪贴板内容。error[BusinessError<void>](zh-cn_topic_0000002497445536.html#ZH-CN_TOPIC_0000002497445536__businesserror)否
...
在API10-17时，参数类型为：(event: [ClickEvent](点击事件.md#ZH-CN_TOPIC_0000002529284807__clickevent), result: [PasteButtonOnClickResult](#ZH-CN_TOPIC_0000002529444905__pastebuttononclickresult枚举说明)) => void。
