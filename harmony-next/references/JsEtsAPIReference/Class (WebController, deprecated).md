...
类型说明[HitTestType](Enums.md#ZH-CN_TOPIC_0000002497605218__hittesttypedeprecated)被点击区域的元素类型。
...
参数名类型必填说明urlstring | Resource是需要加载的 URL。headersArray<[Header](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__header)>否
