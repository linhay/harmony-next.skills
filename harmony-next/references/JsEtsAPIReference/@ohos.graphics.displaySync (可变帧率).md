...
参数名类型必填说明rateRange[ExpectedFrameRateRange](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__expectedframeraterange11)是设置DisplaySync期望的帧率。
...
因此可以使用UIContext的[runScopedTask](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__runscopedtask)接口来指定start函数执行的UI上下文。
