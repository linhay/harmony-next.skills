...
名称typedef关键字描述[DRM_MediaKeyRequestInfo](DRM_MediaKeyRequestInfo.md)DRM_MediaKeyRequestInfo媒体密钥请求信息。[DRM_MediaKeyRequest](DRM_MediaKeyRequest.md)DRM_MediaKeyRequest媒体密钥请求。[DRM_Statistics](DRM_Statistics.md)DRM_StatisticsMediaKeySystem的度量信息。[DRM_OfflineMediakeyIdArray](DRM_OfflineMediakeyIdArray.md)DRM_OfflineMediakeyIdArray离线媒体密钥ID数组。[DRM_KeysInfo](DRM_KeysInfo.md)DRM_KeysInfo媒体密钥信息。[DRM_MediaKeyStatus](DRM_MediaKeyStatus.md)DRM_MediaKeyStatus媒体密钥状态。[DRM_PsshInfo](DRM_PsshInfo.md)DRM_PsshInfoDRM内容保护系统专用头（Protection System Specific Header）信息。[DRM_MediaKeySystemInfo](DRM_MediaKeySystemInfo.md)DRM_MediaKeySystemInfo加密媒体内容的DRM信息。[DRM_MediaKeySystemDescription](DRM_MediaKeySystemDescription.md)DRM_MediaKeySystemDescriptionDRM解决方案名称及其UUID的列表。[MediaKeySystem](MediaKeySystem.md)MediaKeySystemMediaKeySystem结构。[MediaKeySession](MediaKeySession.md)MediaKeySessionMediaKeySession结构。
...
参数项描述[DRM_MediaKeySystemInfo](DRM_MediaKeySystemInfo.md) *mediaKeySystemInfo从媒体源获取的DRM信息。