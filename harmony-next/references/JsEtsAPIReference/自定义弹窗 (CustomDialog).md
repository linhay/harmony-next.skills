...
自定义弹窗的所有参数，不支持动态刷新，但可以通过设置customStyle为true，并在自定义组件上设置[背景色](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundcolor)、[背景模糊](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundblurstyle9)、[宽高](尺寸设置.md)等属性，通过属性绑定的状态变量来实现动态刷新的效果。
...
不支持在输入法类型窗口中使用子窗（showInSubwindow为true）的CustomDialog，详情见输入法框架的约束与限制说明[createPanel](@ohos.inputMethodEngine (输入法服务).md#ZH-CN_TOPIC_0000002529445255__createpanel10-1)。
...
类型说明[promptAction.CommonState](@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__commonstate20枚举说明)返回对应的弹窗状态。
...
maskColor10+[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
openAnimation10+[AnimateParam](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__animateparam对象说明)否是
...
closeAnimation10+[AnimateParam](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__animateparam对象说明)否是
...
cornerRadius10+[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [BorderRadiuses](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__borderradiuses9)否是
...
**说明**：自定义弹窗默认的背板圆角半径为32vp，如果需要使用cornerRadius属性，请和[borderRadius](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderradius)属性一起使用。
