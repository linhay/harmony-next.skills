...
从API version 9开始支持，从API version 18开始废弃，建议使用[createAnimator](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__createanimator)替代。

-

从API version 10开始，可以通过使用[UIContext](Class (UIContext).md)中的[createAnimator](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__createanimator)来明确UI的执行上下文。
...
推荐通过使用[UIContext](Class (UIContext).md)中的[createAnimator](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__createanimator)接口明确UI上下文。
...
参数名类型必填说明rateRange[ExpectedFrameRateRange](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__expectedframeraterange11)是设置期望的帧率范围。
...
fill(fillMode: [FillMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fillmode)): SimpleAnimatorOptions
...
参数名类型必填说明fillMode[FillMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fillmode)是
...
direction(direction: [PlayMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__playmode)): SimpleAnimatorOptions
...
参数名类型必填说明direction[PlayMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__playmode)是
