...
Promise<[AnimateResult](AnimateResult.md#section18741944605)>

Promise对象，返回[AnimateResult](AnimateResult.md#section18741944605)。
...
在指定的持续时间内以动画的形式更新相机状态，并更新指定的marker。使用Promise异步回调。相机移动过程中不能被打断，否则[AnimateResult](AnimateResult.md#section18741944605)的参数isCanceled返回值为true。
...
[mapCommon.CameraPosition](mapCommon（地图属性模型）.md#section105031244194712)
...
指定一个[mapCommon.LatLngBounds](mapCommon（地图属性模型）.md#section96341159111320)来约束相机目标，使用户移动地图时，相机目标不会移出此边界。当设置新的边界时，新边界将覆盖之前设置的边界。
...
[mapCommon.MyLocationStyle](mapCommon（地图属性模型）.md#section3713124215275)
...
[mapCommon.LogoAlignment](mapCommon（地图属性模型）.md#section892653673414)

是

地图Logo的对齐方式，默认值为[LogoAlignment](mapCommon（地图属性模型）.md#section892653673414).BOTTOM_START。
...
[mapCommon.MarkerOptions](mapCommon（地图属性模型）.md#section559041743210)
...
Promise<[Marker](Marker.md)>

Promise对象，返回[Marker](Marker.md)。
...
[mapCommon.MapCircleOptions](mapCommon（地图属性模型）.md#section5282124803117)
...
Promise<[MapCircle](MapCircle.md)>

Promise对象，返回[MapCircle](MapCircle.md)。
...
[mapCommon.MapPolylineOptions](mapCommon（地图属性模型）.md#section113246334153)
...
Promise<[MapPolyline](MapPolyline.md)>

Promise对象，返回[MapPolyline](MapPolyline.md)。
...
[mapCommon.MapPolygonOptions](mapCommon（地图属性模型）.md#section1615694815308)
...
Promise<[MapPolygon](MapPolygon.md)>

Promise对象，返回[MapPolygon](MapPolygon.md)。
...
[mapCommon.PointAnnotationParams](mapCommon（地图属性模型）.md#section161194598375)
...
Promise<[PointAnnotation](PointAnnotation.md)>

Promise对象，返回[PointAnnotation](PointAnnotation.md)。
...
[mapCommon.BubbleParams](mapCommon（地图属性模型）.md#section10348735114315)
...
Promise<[Bubble](Bubble.md)>

Promise对象，返回[Bubble](Bubble.md)。
...
[mapCommon.CustomMapStyleOptions](mapCommon（地图属性模型）.md#section13899143818719)
...
[mapCommon.DayNightMode](mapCommon（地图属性模型）.md#section634916281725)
...
[mapCommon.MapType](mapCommon（地图属性模型）.md#section18522846142615)
...
[mapCommon.ClusterOverlayParams](mapCommon（地图属性模型）.md#section693971514320)
...
Promise<[ClusterOverlay](ClusterOverlay.md)>

Promise对象，返回[ClusterOverlay](ClusterOverlay.md)。
...
[mapCommon.ImageOverlayParams](mapCommon（地图属性模型）.md#section12537418218)
...
Promise<[ImageOverlay](ImageOverlay.md)>

Promise对象，返回[ImageOverlay](ImageOverlay.md)。
...
[mapCommon.BuildingOverlayParams](mapCommon（地图属性模型）.md#section316117228284)
...
Promise<[BuildingOverlay](BuildingOverlay.md)>

Promise对象，返回[BuildingOverlay](BuildingOverlay.md)。
...
[mapCommon.TraceOverlayParams](mapCommon（地图属性模型）.md#section202444375510)
...
Promise<[TraceOverlay](TraceOverlay.md)>

Promise对象，返回[TraceOverlay](TraceOverlay.md)。
...
[mapCommon.MapArcParams](mapCommon（地图属性模型）.md#section943619551002)
...
Array<[mapCommon.MapElementType](mapCommon（地图属性模型）.md#section17215821103111)>

是

四类地图元素的显示顺序，默认顺序为[1, 2, 3, 4]。

入参的长度必须是4，且必须是[mapCommon.MapElementType](mapCommon（地图属性模型）.md#section17215821103111)的4个取值，如果不满足，则返回错误码401。
...
[mapCommon.HeatmapParams](mapCommon（地图属性模型）.md#section273113662417)
...
Promise<[Heatmap](Heatmap.md)>

Promise对象，返回[Heatmap](Heatmap.md)，热力图覆盖物。
...
[mapCommon.MvtOverlayParams](mapCommon（地图属性模型）.md#section17301232184)
...
使用在线下载方式添加矢量图层时（即使用[mapCommon.MvtOverlayParams](mapCommon（地图属性模型）.md#section17301232184)中[mapCommon.MvtSource](mapCommon（地图属性模型）.md#section877213310341)参数的tileUrl方式），需要申请访问网络的权限：ohos.permission.INTERNET。
...
[mapCommon.FlowFieldOverlayParams](mapCommon（地图属性模型）.md#section1920897172416)
...
Promise<[FlowFieldOverlay](FlowFieldOverlay.md)>
...
[mapCommon.MassPointOverlayParams](mapCommon（地图属性模型）.md#section1423475535919)
...
Promise<[MassPointOverlay](MassPointOverlay.md)>
...
该接口对[Marker](Marker.md)、[MapPolyline](MapPolyline.md)、[MapPolygon](MapPolygon.md)、[MapCircle](MapCircle.md)、[PointAnnotation](PointAnnotation.md)、[Bubble](Bubble.md)、[ImageOverlay](ImageOverlay.md)、[MapArc](MapArc.md)、[TraceOverlay](TraceOverlay.md)、底图[Poi](mapCommon（地图属性模型）.md#section1155919456273)生效。
...
[mapCommon.TileOverlayParams](mapCommon（地图属性模型）.md#section3168172982513) | [mapCommon.TileOverlayOptions](mapCommon（地图属性模型）.md#section849136102717)
...
从6.0.0(20)版本开始，params属性支持[mapCommon.TileOverlayOptions](mapCommon（地图属性模型）.md#section849136102717)类型。
...
建议使用[MapEventManager.on(type: 'cameraChange')](MapEventManager.md#section1488710318220)。
...
Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>

是

回调函数，返回[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)，监听地图相机状态变化事件。该回调不会在动画过程中触发，而是在动画结束时触发。
...
建议使用[MapEventManager.off(type: 'cameraChange')](MapEventManager.md#section1994982613283)。
...
建议使用[MapEventManager.on(type: 'cameraIdle')](MapEventManager.md#section1963201310319)。
...
建议使用[MapEventManager.off(type: 'cameraIdle')](MapEventManager.md#section1763512138315)。
...
建议使用[MapEventManager.on(type: 'cameraMoveCancel')](MapEventManager.md#section1322914471399)。
...
建议使用[MapEventManager.off(type: 'cameraMoveCancel')](MapEventManager.md#section10232124743913)。
...
建议使用[MapEventManager.on(type: 'cameraMove')](MapEventManager.md#section142347477396)。
...
建议使用[MapEventManager.off(type: 'cameraMove')](MapEventManager.md#section1823714753912)。
...
建议使用[MapEventManager.on(type: 'cameraMoveStart')](MapEventManager.md#section6240147113918)。
...
建议使用[MapEventManager.off(type: 'cameraMoveStart')](MapEventManager.md#section12243647133915)。
...
建议使用[MapEventManager.on(type: 'mapClick')](MapEventManager.md#section824544714394)。
...
回调函数，返回[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)。
...
建议使用[MapEventManager.off(type: 'mapClick')](MapEventManager.md#section02487472392)。
...
建议使用[MapEventManager.on(type: 'mapLoad')](MapEventManager.md#section19251144723913)。
...
建议使用[MapEventManager.off(type: 'mapLoad')](MapEventManager.md#section132541747133918)。
...
建议使用[MapEventManager.on(type: 'mapLongClick')](MapEventManager.md#section0257247133915)。
...
建议使用[MapEventManager.off(type: 'mapLongClick')](MapEventManager.md#section2261114753919)。
...
建议使用[MapEventManager.on(type: 'myLocationButtonClick')](MapEventManager.md#section9264124723916)。
...
建议使用[MapEventManager.off(type: 'myLocationButtonClick')](MapEventManager.md#section19268134715398)。
...
建议使用[MapEventManager.on(type: 'myLocationClick')](MapEventManager.md#section827144713394)。
...
建议使用[MapEventManager.off(type: 'myLocationClick')](MapEventManager.md#section10275247193911)。
...
建议使用[MapEventManager.on(type: 'poiClick')](MapEventManager.md#section0279247143911)。
...
Callback<[mapCommon.Poi](mapCommon（地图属性模型）.md#section1155919456273)>

是

回调函数，返回[mapCommon.Poi](mapCommon（地图属性模型）.md#section1155919456273)。
...
建议使用[MapEventManager.off(type: 'poiClick')](MapEventManager.md#section11283174743917)。
...
建议使用[MapEventManager.on(type: 'markerClick')](MapEventManager.md#section19286104716392)。
...
Callback<[Marker](Marker.md)>

是

回调函数，返回[Marker](Marker.md)。
...
建议使用[MapEventManager.off(type: 'markerClick')](MapEventManager.md#section929019470390)。
...
建议使用[MapEventManager.on(type: 'markerDragStart')](MapEventManager.md#section19294747123912)。
...
建议使用[MapEventManager.off(type: 'markerDragStart')](MapEventManager.md#section16298847183914)。
...
建议使用[MapEventManager.on(type: 'markerDrag')](MapEventManager.md#section103026476395)。
...
建议使用[MapEventManager.off(type: 'markerDrag')](MapEventManager.md#section13306124793916)。
...
建议使用[MapEventManager.on(type: 'markerDragEnd')](MapEventManager.md#section13310124719393)。
...
建议使用[MapEventManager.off(type: 'markerDragEnd')](MapEventManager.md#section2031414753918)。
...
建议使用[MapEventManager.on(type: 'circleClick')](MapEventManager.md#section83181474399)。
...
Callback<[MapCircle](MapCircle.md)>

是

回调函数，返回[MapCircle](MapCircle.md)。
...
建议使用[MapEventManager.off(type: 'circleClick')](MapEventManager.md#section1232294710392)。
...
建议使用[MapEventManager.on(type: 'polylineClick')](MapEventManager.md#section732614710394)。
...
Callback<[MapPolyline](MapPolyline.md)>

是

回调函数，返回[MapPolyline](MapPolyline.md)。
...
建议使用[MapEventManager.off(type: 'polylineClick')](MapEventManager.md#section1233024711397)。
...
建议使用[MapEventManager.on(type: 'polygonClick')](MapEventManager.md#section933411473395)。
...
Callback<[MapPolygon](MapPolygon.md)>

是

回调函数，返回[MapPolygon](MapPolygon.md)。
...
建议使用[MapEventManager.off(type: 'polygonClick')](MapEventManager.md#section133964753915)。
...
建议使用[MapEventManager.on(type: 'infoWindowClick')](MapEventManager.md#section12343194753919)。
...
建议使用[MapEventManager.off(type: 'infoWindowClick')](MapEventManager.md#section18348114710396)。
...
建议使用[MapEventManager.on(type: 'infoWindowClose')](MapEventManager.md#section10352194713912)。
...
建议使用[MapEventManager.off(type: 'infoWindowClose')](MapEventManager.md#section535624713394)。
...
建议使用[MapEventManager.on(type: 'pointAnnotationClick')](MapEventManager.md#section636111479397)。
...
Callback<[PointAnnotation](PointAnnotation.md)>

是

回调函数，返回[PointAnnotation](PointAnnotation.md)。
...
建议使用[MapEventManager.off(type: 'pointAnnotationClick')](MapEventManager.md#section5365154710393)。
...
建议使用[MapEventManager.on(type: 'bubbleClick')](MapEventManager.md#section10369124763915)。
...
Callback<[Bubble](Bubble.md)>

是

回调函数，返回[Bubble](Bubble.md)。
...
建议使用[MapEventManager.off(type: 'bubbleClick')](MapEventManager.md#section13374114733920)。
...
建议使用[MapEventManager.on(type: 'imageOverlayClick')](MapEventManager.md#section2379144743910)。
...
Callback<[ImageOverlay](ImageOverlay.md#section361333917368)>

是

回调函数，返回[ImageOverlay](ImageOverlay.md#section361333917368)。
...
建议使用[MapEventManager.off(type: 'imageOverlayClick')](MapEventManager.md#section123841147173920)。
...
回调函数，返回[ImageOverlay](ImageOverlay.md#section361333917368)，当不填时清除所有监听回调。
...
建议使用[MapEventManager.on(type: 'error')](MapEventManager.md#section19389184720396)。
...
建议使用[MapEventManager.off(type: 'error')](MapEventManager.md#section1439524793910)。
...
建筑物的ID。从[on('indoorMapEnter')](MapEventManager.md#section76731728143918)方法的回调函数中获得。
