...
该示例通过[SymbolGlyphModifier](#ZH-CN_TOPIC_0000002529444819__symbolglyphmodifier)和TextInput组件的[cancelButton](zh-cn_topic_0000002529444859.html#ZH-CN_TOPIC_0000002529444859__cancelbutton18)属性展示了自定义右侧symbol类型清除按钮样式的效果。
