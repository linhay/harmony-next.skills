...
类型说明[WebDownloadState](Enums.md#ZH-CN_TOPIC_0000002529445167__webdownloadstate11)下载的状态。
...
类型说明[WebDownloadErrorCode](Enums.md#ZH-CN_TOPIC_0000002529445167__webdownloaderrorcode11)下载发生错误的时候的错误码。
