...
FunctionalInput需要配合[functionalInputComponentManager](functionalInputComponentManager(场景化融合Input组件管理).md)一起使用，完成相应功能。
...
FunctionalInput组件需要配合[functionalInputComponentManager](functionalInputComponentManager(场景化融合Input组件管理).md)一起使用，完成相应功能。
...
functionalInputComponentManager.[FunctionalInputParams](functionalInputComponentManager(场景化融合Input组件管理).md#section19784874147)
...
functionalInputComponentManager.[FunctionalInputController](functionalInputComponentManager(场景化融合Input组件管理).md#section942719311715)
