...
参数项描述uint64_t deviceId设备ID，代表要操作的设备。uint8_t interfaceIndex接口索引，对应SCSI设备的接口。[ScsiPeripheral_Device](ScsiPeripheral_Device.md) **dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) **dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_TestUnitReadyRequest](ScsiPeripheral_TestUnitReadyRequest.md) *request逻辑单元检查命令（test unit ready）的请求信息，详情参见[ScsiPeripheral_TestUnitReadyRequest](ScsiPeripheral_TestUnitReadyRequest.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *response逻辑单元检查命令（test unit ready）的响应信息，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_InquiryRequest](ScsiPeripheral_InquiryRequest.md) *requestinquiry命令的请求信息，详情参见[ScsiPeripheral_InquiryRequest](ScsiPeripheral_InquiryRequest.md)。[ScsiPeripheral_InquiryInfo](ScsiPeripheral_InquiryInfo.md) *inquiryInfoinquiry命令返回的查询信息，详情参见[ScsiPeripheral_InquiryInfo](ScsiPeripheral_InquiryInfo.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *responseinquiry命令返回的原始响应信息，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_ReadCapacityRequest](ScsiPeripheral_ReadCapacityRequest.md) *requestread capacity命令的请求信息，详情参见[ScsiPeripheral_ReadCapacityRequest](ScsiPeripheral_ReadCapacityRequest.md)。[ScsiPeripheral_CapacityInfo](ScsiPeripheral_CapacityInfo.md) *capacityInforead capacity命令返回的容量信息，详情参见[ScsiPeripheral_CapacityInfo](ScsiPeripheral_CapacityInfo.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *responseread capacity命令返回的原始响应信息，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_RequestSenseRequest](ScsiPeripheral_RequestSenseRequest.md) *requestrequest sense命令的请求信息，详情参见[ScsiPeripheral_RequestSenseRequest](ScsiPeripheral_RequestSenseRequest.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *responserequest sense命令返回的响应信息，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_IORequest](ScsiPeripheral_IORequest.md) *requestread命令的请求信息，详情参见[ScsiPeripheral_IORequest](ScsiPeripheral_IORequest.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *responseread命令返回的响应信息，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_IORequest](ScsiPeripheral_IORequest.md) *requestwrite命令的请求信息，详情参见[ScsiPeripheral_IORequest](ScsiPeripheral_IORequest.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *responsewrite命令返回的响应信息，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_VerifyRequest](ScsiPeripheral_VerifyRequest.md) *requestverify命令的请求信息，详情参见[ScsiPeripheral_VerifyRequest](ScsiPeripheral_VerifyRequest.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *responseverify命令返回的响应信息，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。[ScsiPeripheral_Request](ScsiPeripheral_Request.md) *request请求，详情参见[ScsiPeripheral_Request](ScsiPeripheral_Request.md)。[ScsiPeripheral_Response](ScsiPeripheral_Response.md) *response响应，详情参见[ScsiPeripheral_Response](ScsiPeripheral_Response.md)。
...
参数项描述[ScsiPeripheral_Device](ScsiPeripheral_Device.md) *dev设备句柄，详情参见[ScsiPeripheral_Device](ScsiPeripheral_Device.md)。size_t size缓冲区的大小。[ScsiPeripheral_DeviceMemMap](ScsiPeripheral_DeviceMemMap.md) **devMmap创建的缓冲区通过该参数返回给调用者，详情参见[ScsiPeripheral_DeviceMemMap](ScsiPeripheral_DeviceMemMap.md)。
...
参数项描述[ScsiPeripheral_DeviceMemMap](ScsiPeripheral_DeviceMemMap.md) *devMmap待销毁的由[OH_ScsiPeripheral_CreateDeviceMemMap](#ZH-CN_TOPIC_0000002497605610__oh_scsiperipheral_createdevicememmap)创建的缓冲区，详情参见[ScsiPeripheral_DeviceMemMap](zh-cn_topic_0000002529285611.html)。
...
参数项描述uint8_t *senseData待解析的sense data。uint8_t senseDataLensense data长度。[ScsiPeripheral_BasicSenseInfo](ScsiPeripheral_BasicSenseInfo.md) *senseInfo用于保存解析后的基本信息，详情参见[ScsiPeripheral_BasicSenseInfo](ScsiPeripheral_BasicSenseInfo.md)。
