...
具体使用时,请根据实际采用的nfcTag技术，选择对应的方法，具体请参见[nfcTag](@ohos.nfc.tag (标准NFC-Tag).md)文档。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getTagInfo](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__taggettaginfo9)替代。
