...
UnionID、OpenID值可以通过使用[LoginWithHuaweiIDResponse](authentication (华为账号应用统一认证服务).md#section15454203811311)、[AuthorizationWithHuaweiIDResponse](authentication (华为账号应用统一认证服务).md#section10418450161620)、[LoginPanel](LoginPanel (华为账号Panel登录组件).md#section72281234181611)或[LoginWithHuaweiIDButton](LoginWithHuaweiIDButton (华为账号Button登录组件).md#section1624716107193)接口获取，具体方法参考其示例代码。
...
[1001600001](ArkTS错误码.md#section1211715201154)

网络不可用

ACCOUNT_NOT_LOGGED_IN

[1001600002](ArkTS错误码.md#section174914372610)

用户未登录华为账号

PACKAGE_FINGERPRINT_CHECK_ERROR

[1001600003](ArkTS错误码.md#section176803402816)

应用指纹证书校验失败

PERMISSION_CHECK_ERROR

[1001600004](ArkTS错误码.md#section1924781781013)

应用未申请对应permissions权限

USER_CANCELED

[1001600005](ArkTS错误码.md#section051982312124)

用户取消当前操作

VERIFICATION_FACTOR_UNAVAILABLE

[1001600006](ArkTS错误码.md#section1140794171313)

当前设备不支持此验证要素

INTERNAL_ERROR

[1001600007](ArkTS错误码.md#section7982145091511)
