...
点注释，继承[BasePriorityOverlay](BasePriorityOverlay.md)。在调用map.[MapComponentController](MapComponentController.md)类的[addPointAnnotation](MapComponentController.md#section1899064804520)方法时会返回该类型的实例。
