...
[1021400000](ArkTS API错误码.md#section184111958125913)

Internal error.

[1021400001](ArkTS API错误码.md#section8963194719118)

The knowledge source is not configured.

[1021400002](ArkTS API错误码.md#section18580829439)

The knowledge schema file is not found.

[1021400003](ArkTS API错误码.md#section581782218519)

The knowledge schema content is invalid.

[1021400004](ArkTS API错误码.md#section0678102120612)
...
RDB数据库配置。加工数据源为RDB数据库时配置，当前版本仅支持RDB数据源，若不填该参数，接口返回错误码[1021400001](ArkTS API错误码.md#section8963194719118)。
