...
参数名类型必填说明proxyConfig[ProxyConfig](Class (ProxyConfig).md)是对代理的配置。callback[OnProxyConfigChangeCallback](Types.md#ZH-CN_TOPIC_0000002497605202__onproxyconfigchangecallback15)是代理设置成功的回调。
...
参数名类型必填说明callback[OnProxyConfigChangeCallback](Types.md#ZH-CN_TOPIC_0000002497605202__onproxyconfigchangecallback15)是代理设置成功的回调。
