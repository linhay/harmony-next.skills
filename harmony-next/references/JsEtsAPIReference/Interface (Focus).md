...
Focus 继承自 [FocusQuery](Interface (FocusQuery).md)。
...
参数名类型必填说明afMode[FocusMode](Enums.md#ZH-CN_TOPIC_0000002497445814__focusmode)是指定的焦距模式。传参为null或者undefined，作为0处理，手动对焦模式。
...
类型说明[FocusMode](Enums.md#ZH-CN_TOPIC_0000002497445814__focusmode)获取当前设备的焦距模式。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
类型说明[Point](Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__point)用于获取当前的焦点。接口调用失败会返回相应错误码，错误码类型为[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
类型说明number用于获取当前焦距，单位mm。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
