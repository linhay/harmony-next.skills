...
参数名类型必填说明resourceType[ResourceType](Enums.md#ZH-CN_TOPIC_0000002529445919__resourcetype11)是所请求动态照片内容的资源类型。fileUristring是待写入动态照片内容的uri。
...
参数名类型必填说明resourceType[ResourceType](Enums.md#ZH-CN_TOPIC_0000002529445919__resourcetype11)是所请求动态照片内容的资源类型。
