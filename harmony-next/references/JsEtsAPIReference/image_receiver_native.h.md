...
名称typedef关键字描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md)OH_ImageReceiverNativeOH_ImageReceiverNative是native层封装的图片接收器结构体，OH_ImageReceiverNative结构体不可直接操作，而是采用函数调用方式创建、释放结构体以及操作具体字段。[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md)OH_ImageReceiverOptions用于定义OH_ImageReceiverOptions数据类型名称。
...
注意，此接口需要在[OH_ImageReceiver_OnCallback](#ZH-CN_TOPIC_0000002497605854__oh_imagereceiver_oncallback)回调后调用，才能正常的接收到数据。并且此接口返回的OH_ImageNative使用完毕后需要调用[OH_ImageNative_Release](zh-cn_topic_0000002529285843.html#ZH-CN_TOPIC_0000002529285843__oh_imagenative_release)方法释放，释放后才可以继续接收新的数据。
...
参数项描述[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md) **options表示作为获取结果的 OH_ImageReceiverOptions对象的指针。
...
参数项描述[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md)* options表示OH_ImageReceiverOptions对象的指针。[Image_Size](Image_Size.md)* size表示作为获取结果的Image_Size对象的指针。
...
参数项描述[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md)* options表示OH_ImageReceiverOptions对象的指针。[Image_Size](Image_Size.md) size表示Image_Size对象的指针。
...
参数项描述[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md)* options表示OH_ImageReceiverOptions对象的指针。int32_t* capacity表示作为获取结果的图片缓存容量对象的指针。
...
参数项描述[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md)* options表示OH_ImageReceiverOptions对象的指针。int32_t capacity表示图片缓存容量对象的指针。
...
参数项描述[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md)* options表示OH_ImageReceiverOptions对象的指针。
...
参数项描述[OH_ImageReceiverOptions](OH_ImageReceiverOptions.md)* options表示OH_ImageReceiverOptions对象的指针。[OH_ImageReceiverNative](OH_ImageReceiverNative.md)** receiver表示作为获取结果的OH_ImageReceiverNative对象的指针。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md)* receiver表示OH_ImageReceiverNative对象的指针。uint64_t* surfaceId表示作为获取结果的id对象的指针。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md)* receiver表示OH_ImageReceiverNative对象的指针。[OH_ImageNative](OH_ImageNative.md)** image获取到的应用层的OH_ImageNative指针对象。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md)* receiver表示OH_ImageReceiverNative对象的指针。[OH_ImageReceiver_OnCallback](#ZH-CN_TOPIC_0000002497605854__oh_imagereceiver_oncallback) callback表示OH_ImageReceiver_OnCallback事件的回调函数。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md)* receiver表示OH_ImageReceiverNative对象的指针。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md)* receiver表示OH_ImageReceiverNative对象的指针。[Image_Size](Image_Size.md)* size表示作为获取结果的Image_Size对象的指针。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md)* receiver表示OH_ImageReceiverNative对象的指针。int32_t* capacity表示作为获取结果的图片缓存容量对象的指针。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md) *receiver处理回调的OH_ImageReceiverNative对象。[OH_ImageReceiver_ImageArriveCallback](#ZH-CN_TOPIC_0000002497605854__oh_imagereceiver_imagearrivecallback) callback要注册的OH_ImageReceiver_ImageArriveCallback回调方法。void *userData用户自定义数据指针。
...
参数项描述[OH_ImageReceiverNative](OH_ImageReceiverNative.md) *receiver处理回调的OH_ImageReceiverNative对象。[OH_ImageReceiver_ImageArriveCallback](#ZH-CN_TOPIC_0000002497605854__oh_imagereceiver_imagearrivecallback) callback要注册的OH_ImageReceiver_ImageArriveCallback回调。
