...
参数名类型必填说明targetRationumber是目标值。通过[getZoomRatioRange](Interface (ZoomQuery).md#ZH-CN_TOPIC_0000002529445757__getzoomratiorange11)获取支持的变焦范围，如果设置超过支持范围的值，则只保留精度范围内数值。mode[SmoothZoomMode](Enums.md#ZH-CN_TOPIC_0000002497445814__smoothzoommode11)否平滑变焦模式。默认为0。
