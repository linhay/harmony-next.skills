...
取值为：[PayMercAuth](数据模型说明.md#section11744172016145)的JSON串
...
[PayerOut](数据模型说明.md#section796891012811)
...
(**resultCode**非400000的错误码请看[公共错误码说明](REST API错误码.md#section1187515498410))
