...
从API version 10开始，可以通过使用[UIContext](Class (UIContext).md)中的[showTimePickerDialog](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showtimepickerdialog)来明确UI的执行上下文。
...
参数名类型必填说明options[TimePickerDialogOptions](#ZH-CN_TOPIC_0000002497604936__timepickerdialogoptions对象说明)否配置时间选择器弹窗的参数。

#### TimePickerDialogOptions对象说明

时间选择器弹窗选项。

继承自[TimePickerOptions](TimePicker.md#ZH-CN_TOPIC_0000002497604888__timepickeroptions对象说明)。

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

**设备行为差异：** 该接口在Wearable设备上使用时，应用程序运行异常，异常信息中提示接口未定义，在其他设备中可正常调用。

名称类型只读可选说明useMilitaryTimeboolean否是
...
onAccept(value: [TimePickerResult](TimePicker.md#ZH-CN_TOPIC_0000002497604888__timepickerresult对象说明)) => void否是
...
onChange(value: [TimePickerResult](TimePicker.md#ZH-CN_TOPIC_0000002497604888__timepickerresult对象说明)) => void否是
...
dateTimeOptions12+[DateTimeOptions](@ohos.intl (国际化-Intl).md#ZH-CN_TOPIC_0000002497605316__datetimeoptionsdeprecated)否是
...
onEnterSelectedArea18+Callback<[TimePickerResult](TimePicker.md#ZH-CN_TOPIC_0000002497604888__timepickerresult对象说明)>否是
...
推荐通过使用[UIContext](Class (UIContext).md)中的[showTimePickerDialog](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showtimepickerdialog)来明确UI的执行上下文。
...
从API version 19开始，该示例通过配置[backgroundBlurStyleOptions](#ZH-CN_TOPIC_0000002497604936__timepickerdialogoptions对象说明)，实现自定义背景模糊效果。
...
从API version 19开始，该示例通过配置[backgroundEffect](#ZH-CN_TOPIC_0000002497604936__timepickerdialogoptions对象说明)，实现自定义背景效果。
