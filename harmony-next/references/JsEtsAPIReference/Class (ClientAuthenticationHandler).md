...
Web组件返回的SSL客户端证书请求事件的处理对象。示例代码参考[onClientAuthenticationRequest事件](事件.md#ZH-CN_TOPIC_0000002497445228__onclientauthenticationrequest9)。
...
参数名类型必填说明identitystring是用于识别凭据的唯一标识值。credentialTypeOrCertChainFile[CredentialType](Enums.md#ZH-CN_TOPIC_0000002497605218__credentialtype22) | string是类型为[CredentialType](Enums.md#ZH-CN_TOPIC_0000002497605218__credentialtype22)时，代表凭据类型；类型为string时，表示证书链文件路径。
