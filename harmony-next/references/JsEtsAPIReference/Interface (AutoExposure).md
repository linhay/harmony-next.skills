...
AutoExposure 继承自 [AutoExposureQuery](Interface (AutoExposureQuery).md)。
...
类型说明[ExposureMode](Enums.md#ZH-CN_TOPIC_0000002497445814__exposuremode)获取当前曝光模式。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
