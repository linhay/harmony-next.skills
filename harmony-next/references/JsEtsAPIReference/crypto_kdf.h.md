...
**相关模块：**[CryptoKdfApi](CryptoKdfApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoKdf](OH_CryptoKdf.md)OH_CryptoKdf定义密钥派生函数（KDF）结构。[OH_CryptoKdfParams](OH_CryptoKdfParams.md)OH_CryptoKdfParams定义密钥派生函数（KDF）参数结构。
...
[OH_CryptoKdfParams](OH_CryptoKdfParams.md) **paramsKDF参数。
...
参数项描述[OH_CryptoKdfParams](OH_CryptoKdfParams.md) *paramsKDF参数。[CryptoKdf_ParamType](#ZH-CN_TOPIC_0000002497605358__cryptokdf_paramtype) typeKDF参数类型。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *valueKDF参数值。
...
参数项描述[OH_CryptoKdfParams](OH_CryptoKdfParams.md) *paramsKDF参数。
...
参数项描述const char *algoNameKDF算法名称。[OH_CryptoKdf](OH_CryptoKdf.md) **ctxKDF实例。
...
参数项描述[OH_CryptoKdf](OH_CryptoKdf.md) *ctxKDF实例。[const OH_CryptoKdfParams](OH_CryptoKdfParams.md) *paramsKDF参数。int keyLen密钥派生长度。[Crypto_DataBlob](Crypto_DataBlob.md) *key派生出的密钥。
...
参数项描述[OH_CryptoKdf](OH_CryptoKdf.md) *ctxKDF实例。