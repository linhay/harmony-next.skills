...
创建DocumentViewPicker对象，推荐使用该构造函数，获取context参考[getHostContext](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__gethostcontext12)。
...
参数名类型必填说明contextContext是应用上下文（仅支持UIAbilityContext）。Stage模型的应用Context定义见[Context](Context (Stage模型的上下文基类).md)。
...
参数名类型必填说明contextContext是应用上下文（仅支持UIAbilityContext）。Stage模型的应用Context定义见[Context](Context (Stage模型的上下文基类).md)。window[window.Window](Interface (Window).md)是应用创建的窗口实例。
...
创建AudioViewPicker对象，推荐使用该构造函数，获取context参考[getHostContext](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__gethostcontext12)。
...
图库选择器对象，用来支撑选择图片/视频和保存图片/视频等用户场景。选择文件推荐使用[PhotoAccessHelper的PhotoViewPicker](Class (PhotoViewPicker).md)。在使用前，需要先创建PhotoViewPicker实例。

从API version 9开始支持，从API version 12开始废弃。建议使用[photoAccessHelper.PhotoViewPicker](Class (PhotoViewPicker).md)替代。
...
创建PhotoViewPicker对象，推荐使用该构造函数，获取context参考[getHostContext](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__gethostcontext12)。

从API version 12开始支持，从API version 18开始废弃。建议使用[photoAccessHelper.PhotoViewPicker](Class (PhotoViewPicker).md)替代。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[photoAccessHelper.PhotoViewPicker#select](Class (PhotoViewPicker).md#ZH-CN_TOPIC_0000002529445913__select)替代。
...
**注意**：此接口返回的PhotoSelectResult对象中的photoUris只能通过临时授权的方式调用[photoAccessHelper.getAssets接口](Interface (PhotoAccessHelper).md#ZH-CN_TOPIC_0000002529445917__getassets)去使用，具体使用方式参见用户文件uri介绍中的[媒体文件uri的使用方式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri的使用方式)。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[photoAccessHelper.PhotoViewPicker#select](Class (PhotoViewPicker).md#ZH-CN_TOPIC_0000002529445913__select-1)替代。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[photoAccessHelper.PhotoViewPicker#select](Class (PhotoViewPicker).md#ZH-CN_TOPIC_0000002529445913__select-2)替代。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[SaveButton](SaveButton.md)替代。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[photoAccessHelper.PhotoViewMIMETypes](Enums.md#ZH-CN_TOPIC_0000002529445919__photoviewmimetypes)替代。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[photoAccessHelper.PhotoSelectOptions](Classes (其他).md#ZH-CN_TOPIC_0000002497605950__photoselectoptions)替代。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[photoAccessHelper.PhotoSelectResult](Classes (其他).md#ZH-CN_TOPIC_0000002497605950__photoselectresult)替代。
...
返回图库选择后的媒体文件的uri数组。此uri数组只能通过临时授权的方式调用[photoAccessHelper.getAssets接口](Interface (PhotoAccessHelper).md#ZH-CN_TOPIC_0000002529445917__getassets)去使用，具体使用方式参见用户文件uri介绍中的[媒体文件uri的使用方式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri的使用方式)。
...
从API version 9开始支持，从API version 12开始废弃。建议使用[SaveButtonOptions](SaveButton.md#ZH-CN_TOPIC_0000002497604940__savebuttonoptions)替代。
