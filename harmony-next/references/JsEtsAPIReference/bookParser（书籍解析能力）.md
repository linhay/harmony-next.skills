...
书籍资源请求回调接口，在排版引擎渲染界面时调用，需配合ReaderComponentController的注册接口[on('resourceRequest')](readerCore（阅读核心能力）.md#section169541417131914)使用。如果有自定义背景及字体资源，需要在此返回对应资源。
...
[1017000999](ArkTS API错误码.md#section31031138161116)

Other error.

[1017010003](ArkTS API错误码.md#section1855956131312)

Book file format is unexpected.

[1017010004](ArkTS API错误码.md#section692725412147)
...
[1017000001](ArkTS API错误码.md#section1427915529104)
...
[1017010002](ArkTS API错误码.md#section1115195931210)
...
[1017010001](ArkTS API错误码.md#section19552151617126)
...
开发者通过此接口可获取书封资源。同时排版引擎获取书籍里的图片等资源时，会优先调用该方法，如果获取不到资源会继续调用[on('resourceRequest')](readerCore（阅读核心能力）.md#section169541417131914)获取资源。
