...
名称typedef关键字描述[Image_Size](Image_Size.md)Image_Size图像大小结构体。[Image_Region](Image_Region.md)Image_Region待解码的图像源区域结构体。[Image_PositionArea](Image_PositionArea.md)Image_PositionArea要读取或写入的图像像素区域。[Image_Scale](Image_Scale.md)Image_Scale图像缩放倍数。[Image_String](Image_String.md)Image_String/Image_MimeType字符串结构。[OH_PictureMetadata](OH_PictureMetadata.md)-声明用于Picture的元数据。
...
参数项描述[Image_MetadataType](#ZH-CN_TOPIC_0000002497445872__image_metadatatype) metadataType元数据的类型。[OH_PictureMetadata](zh-cn_topic_0000002497605870.html) **metadata被操作的OH_PictureMetadata指针。
...
参数项描述[OH_PictureMetadata](OH_PictureMetadata.md) *metadata被操作的OH_PictureMetadata指针。[Image_String](Image_String.md) *key属性的键。[Image_String](Image_String.md) *value属性的值。
...
参数项描述[OH_PictureMetadata](OH_PictureMetadata.md) *metadata将被操作的PictureMetadata指针。[Image_String](Image_String.md) *key属性键指针。[Image_String](Image_String.md) *value属性值指针。
...
参数项描述[OH_PictureMetadata](OH_PictureMetadata.md) *metadata被操作的OH_PictureMetadata指针。
...
参数项描述[OH_PictureMetadata](OH_PictureMetadata.md) *oldMetadata被操作的OH_PictureMetadata指针。[OH_PictureMetadata](OH_PictureMetadata.md) **newMetadata拷贝得到的OH_PictureMetadata指针。
