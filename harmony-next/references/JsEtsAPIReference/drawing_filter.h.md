...
类型说明[OH_Drawing_Filter](OH_Drawing_Filter.md)*返回创建的滤波器对象的指针。
...
参数项描述[OH_Drawing_Filter](OH_Drawing_Filter.md)* filter指示指向滤波器对象[OH_Drawing_Filter](OH_Drawing_Filter.md)的指针。[OH_Drawing_ImageFilter](OH_Drawing_ImageFilter.md)* imageFilter指示指向图像滤波器[OH_Drawing_ImageFilter](OH_Drawing_ImageFilter.md)对象的指针，为NULL表示清空滤波器对象中的图像滤波器效果。
...
参数项描述[OH_Drawing_Filter](OH_Drawing_Filter.md)* filter指示指向滤波器对象[OH_Drawing_Filter](OH_Drawing_Filter.md)的指针。[OH_Drawing_MaskFilter](OH_Drawing_MaskFilter.md)* maskFilter指示指向蒙版滤波器对象[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)的指针，为NULL表示清空滤波器对象中的蒙版滤波器效果。
...
参数项描述[OH_Drawing_Filter](OH_Drawing_Filter.md)* filter指示指向滤波器对象[OH_Drawing_Filter](OH_Drawing_Filter.md)的指针。[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)* colorFilter指示指向颜色滤波器对象[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)的指针，为NULL表示清空滤波器对象中的颜色滤波器效果。
...
参数项描述[OH_Drawing_Filter](OH_Drawing_Filter.md)* filter指示指向滤波器对象[OH_Drawing_Filter](OH_Drawing_Filter.md)的指针。[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)* colorFilter指示指向颜色滤波器对象[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)的指针。
...
参数项描述[OH_Drawing_Filter](OH_Drawing_Filter.md)* filter指示指向滤波器对象[OH_Drawing_Filter](OH_Drawing_Filter.md)的指针。