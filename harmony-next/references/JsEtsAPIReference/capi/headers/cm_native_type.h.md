...
**相关模块：**[CertManagerType](../../topics/security/CertManagerType.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CM_Blob](../../topics/misc/OH_CM_Blob.md)OH_CM_Blob定义存放数据的结构体类型。[OH_CM_Credential](../../topics/security/OH_CM_Credential.md)OH_CM_Credential定义证书凭据详情的结构体类型。[OH_CM_CredentialDetailList](../../topics/components/OH_CM_CredentialDetailList.md)OH_CM_CredentialDetailList定义证书凭据详情列表的结构体类型。[OH_CM_UkeyInfo](../../topics/misc/OH_CM_UkeyInfo.md)OH_CM_UkeyInfo定义USB证书凭据信息的结构体类型。
