...
**相关模块：**[effectKit](../../topics/misc/effectKit.md)
...
参数项描述[OH_PixelmapNative](../../topics/graphics/OH_PixelmapNative.md)* pixelmap创建滤镜的位图。[OH_Filter](../../topics/misc/OH_Filter.md)** filter用来接收滤镜的二级指针。
...
参数项描述[OH_Filter](../../topics/misc/OH_Filter.md)* filter被释放的对象指针。
...
参数项描述[OH_Filter](../../topics/misc/OH_Filter.md)* filter滤镜指针。float radius毛玻璃效果的模糊半径，单位为像素。
...
参数项描述[OH_Filter](../../topics/misc/OH_Filter.md)* filter滤镜指针。float radius毛玻璃效果的模糊半径，单位为像素。[EffectTileMode](effect_types.h.md#ZH-CN_TOPIC_0000002497606018__effecttilemode) tileMode着色器效果平铺模式，支持可选的具体模式可见[EffectTileMode](effect_types.h.md#ZH-CN_TOPIC_0000002497606018__effecttilemode)枚举。
...
参数项描述[OH_Filter](../../topics/misc/OH_Filter.md)* filter滤镜指针。float brightness提亮效果的亮度值，取值范围在0-1之间，取值为0时图像保持不变，取值为1时图像全白。
...
参数项描述[OH_Filter](../../topics/misc/OH_Filter.md)* filter滤镜指针。
...
参数项描述[OH_Filter](../../topics/misc/OH_Filter.md)* filter滤镜指针。[OH_Filter_ColorMatrix](../../topics/graphics/OH_Filter_ColorMatrix.md)* matrix用来创建滤镜的自定义矩阵[OH_Filter_ColorMatrix](../../topics/graphics/OH_Filter_ColorMatrix.md)。
...
参数项描述[OH_Filter](../../topics/misc/OH_Filter.md)* filter用来创建位图的滤镜指针。[OH_PixelmapNative](../../topics/graphics/OH_PixelmapNative.md)** pixelmap用来接收位图的二级指针。
