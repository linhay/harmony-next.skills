...
名称typedef关键字描述[OH_Drawing_GpuContextOptions](../../topics/graphics/OH_Drawing_GpuContextOptions.md)OH_Drawing_GpuContextOptions定义有关图形处理器上下文的选项。
...
参数项描述[OH_Drawing_GpuContextOptions](../../topics/graphics/OH_Drawing_GpuContextOptions.md) gpuContextOptions图形处理器上下文选项[OH_Drawing_GpuContextOptions](../../topics/graphics/OH_Drawing_GpuContextOptions.md)。

**返回：**

类型说明[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)*返回一个指针，指针指向创建的图形处理器上下文对象[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)。
...
参数项描述[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)* gpuContext指向图形处理器上下文对象的指针[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)。