...
**相关模块：**[CertManager](../../topics/security/CertManager.md)
...
参数项描述[const OH_CM_Blob](../../topics/misc/OH_CM_Blob.md) *keyUri存放USB证书凭据的唯一标识符（字符串格式）。[const OH_CM_UkeyInfo](../../topics/misc/OH_CM_UkeyInfo.md) *ukeyInfoUSB证书凭据属性信息。[OH_CM_CredentialDetailList](../../topics/components/OH_CM_CredentialDetailList.md) *certificateList获取到的USB证书凭据详情列表。
...
参数项描述[const OH_CM_Blob](../../topics/misc/OH_CM_Blob.md) *keyUri存放应用私有证书凭据的唯一标识符（字符串格式）。[OH_CM_Credential](../../topics/security/OH_CM_Credential.md) *certificate获取到的应用私有凭据的详情。
...
参数项描述[const OH_CM_Blob](../../topics/misc/OH_CM_Blob.md) *keyUri存放用户公共证书凭据的唯一标识符（字符串格式）。[OH_CM_Credential](../../topics/security/OH_CM_Credential.md) *certificate获取到的用户公共证书凭据的详情。
...
参数项描述[OH_CM_CredentialDetailList](../../topics/components/OH_CM_CredentialDetailList.md) *certificateList待销毁的证书凭据详细列表。
...
参数项描述[OH_CM_Credential](../../topics/security/OH_CM_Credential.md) *certificate待销毁的证书凭据详情。