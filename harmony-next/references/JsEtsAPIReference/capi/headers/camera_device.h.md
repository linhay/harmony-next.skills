...
参数项描述[Camera_Device](../../topics/system-services/Camera_Device.md)* camera用于获取属性的Camera_Device。uint32_t* orientation返回相机sensor角度属性。
...
参数项描述[Camera_Device](../../topics/system-services/Camera_Device.md)* camera用于获取属性的Camera_Device。char** hostDeviceName返回远程设备名称属性。
...
参数项描述[Camera_Device](../../topics/system-services/Camera_Device.md)* camera用于获取属性的Camera_Device。[Camera_HostDeviceType](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_hostdevicetype)* hostDeviceType远程设备类型属性。
