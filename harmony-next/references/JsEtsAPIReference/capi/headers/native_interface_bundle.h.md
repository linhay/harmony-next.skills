...
类型说明[OH_NativeBundle_ApplicationInfo](../../topics/system-services/OH_NativeBundle_ApplicationInfo.md)
...
类型说明[OH_NativeBundle_ElementName](../../topics/misc/OH_NativeBundle_ElementName.md)
...
类型说明[OH_NativeBundle_ModuleMetadata*](../../topics/system-services/OH_NativeBundle_ModuleMetadata.md)
...
参数项描述char* fileType表示待查询的特定文件类型，推荐使用[UTD类型](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uniform-data-type-descriptors)，比如：'general.plain-text'、'general.image'。目前也可以兼容使用[MIME type类型](https://www.iana.org/assignments/media-types/media-types.xhtml?utm_source=ld246.com)和文件后缀名称，如：'text/xml' 、 '.png'等。文件后缀与文件类型的映射关系参见[UTD预置列表](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uniform-data-type-list)。不支持传'*/*'。[OH_NativeBundle_AbilityResourceInfo](../../topics/system-services/OH_NativeBundle_AbilityResourceInfo.md)** abilityResourceInfo表示返回的组件资源信息列表。size_t* size表示返回的组件资源信息列表大小。
