...
参数项描述int32_t duration- 振动时长，单位：毫秒。[Vibrator_Attribute](../../topics/misc/Vibrator_Attribute.md) attribute- 振动属性，请参考VibrateAttribute。
...
参数项描述[Vibrator_FileDescription](../../topics/misc/Vibrator_FileDescription.md) fileDescription- 自定义振动效果文件描述符，请参阅 [Vibrator_FileDescription](../../topics/misc/Vibrator_FileDescription.md)。[Vibrator_Attribute](../../topics/misc/Vibrator_Attribute.md) vibrateAttribute- 振动属性，请参阅 [Vibrator_Attribute](../../topics/misc/Vibrator_Attribute.md)。
