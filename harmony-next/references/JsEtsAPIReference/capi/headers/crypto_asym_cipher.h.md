...
**相关模块：**[CryptoAsymCipherApi](../../topics/networking/CryptoAsymCipherApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoAsymCipher](../../topics/misc/OH_CryptoAsymCipher.md)OH_CryptoAsymCipher定义非对称加密结构。[OH_CryptoSm2CiphertextSpec](../../topics/graphics/OH_CryptoSm2CiphertextSpec.md)OH_CryptoSm2CiphertextSpec定义SM2密文规格结构。
...
[OH_CryptoAsymCipher](../../topics/misc/OH_CryptoAsymCipher.md) **ctx指向非对称加密上下文的指针。
...
参数项描述[OH_CryptoAsymCipher](../../topics/misc/OH_CryptoAsymCipher.md) *ctx非对称加密上下文。[Crypto_CipherMode](crypto_common.h.md#ZH-CN_TOPIC_0000002529285349__crypto_ciphermode) mode加密模式是加密还是解密。[OH_CryptoKeyPair](../../topics/misc/OH_CryptoKeyPair.md) *key非对称密钥。
...
参数项描述[OH_CryptoAsymCipher](../../topics/misc/OH_CryptoAsymCipher.md) *ctx非对称加密上下文。[const Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *in要加密或解密的数据。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *out最终加密或解密的数据。
...
参数项描述[OH_CryptoAsymCipher](../../topics/misc/OH_CryptoAsymCipher.md) *ctx非对称加密上下文。
...
参数项描述[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *sm2CiphertextSM2密文DER格式数据，如果为NULL则创建空的SM2密文规格。[OH_CryptoSm2CiphertextSpec](../../topics/graphics/OH_CryptoSm2CiphertextSpec.md) **spec输出的SM2密文规格。
...
参数项描述[OH_CryptoSm2CiphertextSpec](../../topics/graphics/OH_CryptoSm2CiphertextSpec.md) *specSM2密文规格。[CryptoSm2CiphertextSpec_item](#ZH-CN_TOPIC_0000002497605356__cryptosm2ciphertextspec_item) itemSM2密文规格项。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *out输出数据。
...
参数项描述[OH_CryptoSm2CiphertextSpec](../../topics/graphics/OH_CryptoSm2CiphertextSpec.md) *specSM2密文规格。[CryptoSm2CiphertextSpec_item](#ZH-CN_TOPIC_0000002497605356__cryptosm2ciphertextspec_item) itemSM2密文规格项。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *in输入数据。
...
参数项描述[OH_CryptoSm2CiphertextSpec](../../topics/graphics/OH_CryptoSm2CiphertextSpec.md) *specSM2密文规格。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *out输出数据。
...
参数项描述[OH_CryptoSm2CiphertextSpec](../../topics/graphics/OH_CryptoSm2CiphertextSpec.md) *specSM2密文规格。