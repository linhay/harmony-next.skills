...
名称typedef关键字描述[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)OH_Data_VBuckets定义OH_Data_VBuckets结构类型。
...
类型说明[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)

执行成功时返回指向[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)实例的指针。否则返回nullptr。
...
参数项描述[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md) *buckets表示指向[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)实例的指针。
...
参数项描述[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md) *buckets表示指向[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)实例的指针。const [OH_VBucket](../../topics/misc/OH_VBucket.md) *row表示指向[OH_VBucket](../../topics/misc/OH_VBucket.md)实例的指针。
...
参数项描述[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md) *buckets表示指向[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)实例的指针。const [OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md) *rows表示指向[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)实例的指针。
...
参数项描述[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md) *buckets表示指向[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)实例的指针。size_t *count一个输出参数，表示[OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md)中[OH_VBucket](../../topics/misc/OH_VBucket.md)的个数。
