...
类型说明[OH_Drawing_MaskFilter](../../topics/graphics/OH_Drawing_MaskFilter.md)*返回创建的蒙版滤波器对象的指针。
...
参数项描述[OH_Drawing_MaskFilter](../../topics/graphics/OH_Drawing_MaskFilter.md)* maskFilter表示指向蒙版滤波器对象的指针。