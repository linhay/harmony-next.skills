...
类型说明[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)*函数会返回一个指针，指针指向创建的矩阵对象。
...
参数项描述const [OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向用于拷贝的矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。

**返回：**

类型说明[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)*函数会返回一个指针，指针指向创建的新矩阵对象。
...
类型说明[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)*函数返回一个指针，指针指向创建的矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象的指针。float scaleX水平缩放系数。float skewX水平倾斜系数。float transX水平位移系数。float skewY垂直倾斜系数。float scaleY垂直缩放系数。float transY垂直位移系数。float persp0X轴透视系数。float persp1Y轴透视系数。float persp2透视缩放系数。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。const [OH_Drawing_Rect](../../topics/graphics/OH_Drawing_Rect.md)* src指向映射源的[OH_Drawing_Rect](../../topics/graphics/OH_Drawing_Rect.md)对象Rect的指针。const [OH_Drawing_Rect](../../topics/graphics/OH_Drawing_Rect.md)* dst指向要映射到的[OH_Drawing_Rect](../../topics/graphics/OH_Drawing_Rect.md)对象Rect的指针。[OH_Drawing_ScaleToFit](#ZH-CN_TOPIC_0000002497446024__oh_drawing_scaletofit) stf缩放方式，支持方式[OH_Drawing_ScaleToFit](drawing_matrix.h.md#ZH-CN_TOPIC_0000002497446024__oh_drawing_scaletofit)。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。float degree旋转角度，单位为度。正数表示顺时针旋转，负数表示逆时针旋转。float px旋转中心点的横坐标。float py旋转中心点的纵坐标。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。float sxx轴方向的缩放比例因子，为负数时可看作是先关于y = px作镜像翻转后再进行缩放，该参数为浮点数。float syy轴方向的缩放比例因子，为负数时可看作是先关于x = py作镜像翻转后再进行缩放，该参数为浮点数。float px缩放中心点的横坐标。float py缩放中心点的纵坐标。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。float dx表示在x轴方向上的平移距离，正数表示往x轴正方向平移，负数表示往x轴负方向平移，该参数为浮点数。float dy表示在y轴方向上的平移距离，正数表示往y轴正方向平移，负数表示往y轴负方向平移，该参数为浮点数。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* total指向最终的矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。const [OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* a指向矩阵对象a[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。const [OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* b指向矩阵对象b[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。value用于存储得到的矩阵元素值的数组。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。int index索引位置，范围0-8。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。float degree角度，单位为度。正数表示顺时针旋转，负数表示逆时针旋转。float pxx轴上坐标点。float pyy轴上坐标点。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。float dx水平方向平移距离，正数表示往x轴正方向平移，负数表示往x轴负方向平移，该参数为浮点数。float dy垂直方向平移距离，正数表示往y轴正方向平移，负数表示往y轴负方向平移，该参数为浮点数。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。float sx水平缩放因子，为负数时可看作是先关于y = px作镜像翻转后再进行缩放，该参数为浮点数。float sy垂直缩放因子，为负数时可看作是先关于x = py作镜像翻转后再进行缩放，该参数为浮点数。float pxx轴上坐标点。float pyy轴上坐标点。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* inverse指向逆矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针，开发者可调用[OH_Drawing_MatrixCreate](drawing_matrix.h.md#ZH-CN_TOPIC_0000002497446024__oh_drawing_matrixcreate)接口创建。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。const [OH_Drawing_Point2D](../../topics/graphics/OH_Drawing_Point2D.md)* src源点数组，为NULL时count应当为0。const [OH_Drawing_Point2D](../../topics/graphics/OH_Drawing_Point2D.md)* dst目标点数组，个数要与源点相等，为NULL时count应当为0。uint32_t count源点数组以及目标点数组的个数，为0时将矩阵对象设为单位矩阵。
...
参数项描述const [OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。const [OH_Drawing_Point2D](../../topics/graphics/OH_Drawing_Point2D.md)* src源点数组。[OH_Drawing_Point2D](../../topics/graphics/OH_Drawing_Point2D.md)* dst目标点数组，个数要与源点相等。int count源点数组以及目标点数组的个数。
...
参数项描述const [OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。const [OH_Drawing_Rect](../../topics/graphics/OH_Drawing_Rect.md)* src源矩形。[OH_Drawing_Rect](../../topics/graphics/OH_Drawing_Rect.md)* dst目标矩形。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向用于判断的其中一个矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* other指向用于判断的另一个矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* matrix指向矩阵对象的指针。
...
参数项描述[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* a指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)* b指向矩阵对象[OH_Drawing_Matrix](../../topics/graphics/OH_Drawing_Matrix.md)的指针。
