...
参数项描述[Telephony_NetworkState](../../topics/networking/Telephony_NetworkState.md) *state用户接收网络状态信息的结构体。
...
参数项描述int32_t slotId卡槽ID。[Telephony_NetworkState](../../topics/networking/Telephony_NetworkState.md) *state用户接收网络状态信息的结构体。
