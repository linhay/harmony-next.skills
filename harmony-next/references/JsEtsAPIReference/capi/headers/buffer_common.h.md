...
名称typedef关键字描述[OH_NativeBuffer_ColorXY](../../topics/graphics/OH_NativeBuffer_ColorXY.md)OH_NativeBuffer_ColorXY表示基色的X和Y坐标。[OH_NativeBuffer_Smpte2086](../../topics/misc/OH_NativeBuffer_Smpte2086.md)OH_NativeBuffer_Smpte2086表示smpte2086静态元数据。[OH_NativeBuffer_Cta861](../../topics/misc/OH_NativeBuffer_Cta861.md)OH_NativeBuffer_Cta861表示CTA-861.3静态元数据。[OH_NativeBuffer_StaticMetadata](../../topics/misc/OH_NativeBuffer_StaticMetadata.md)OH_NativeBuffer_StaticMetadata表示HDR静态元数据。
