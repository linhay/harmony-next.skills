...
类型说明[OH_Drawing_ShadowLayer](../../topics/graphics/OH_Drawing_ShadowLayer.md)*返回创建的阴影层对象的指针。
...
参数项描述[OH_Drawing_ShadowLayer](../../topics/graphics/OH_Drawing_ShadowLayer.md)* shadowLayer表示指向阴影层对象的指针。