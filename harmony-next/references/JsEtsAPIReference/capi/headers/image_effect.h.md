...
类型说明[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *返回一个指向OH_ImageEffect实例的指针，创建失败时返回空指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。const char *filterName滤镜名。

**返回：**

类型说明[OH_EffectFilter](../../topics/misc/OH_EffectFilter.md) *返回一个指向OH_EffectFilter实例的指针，滤镜名无效时返回空指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。[OH_EffectFilter](../../topics/misc/OH_EffectFilter.md) *filter滤镜指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。uint32_t index插入滤镜位置索引。const char *filterName滤镜名。

**返回：**

类型说明[OH_EffectFilter](../../topics/misc/OH_EffectFilter.md) *返回一个指向OH_EffectFilter实例的指针，参数无效时返回空指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。uint32_t index插入滤镜位置索引。[OH_EffectFilter](../../topics/misc/OH_EffectFilter.md) *filter滤镜指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。uint32_t index移除滤镜位置索引。
...
类型说明[OH_EffectFilter](../../topics/misc/OH_EffectFilter.md) *返回一个指向OH_EffectFilter实例的指针，替换失败时返回空指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。uint32_t index替换滤镜位置索引。const char *filterName滤镜名。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。uint32_t index待查询滤镜位置索引。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。const char *key配置参数。[const ImageEffect_Any](../../topics/graphics/ImageEffect_Any.md) *value配置参数值。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。OHNativeWindow *nativeWindow指向OHNativeWindow实例的指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。[OH_PixelmapNative](../../topics/graphics/OH_PixelmapNative.md) *pixelmap指向OH_PixelmapNative实例的指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。[OH_NativeBuffer](../../topics/misc/OH_NativeBuffer.md) *nativeBuffer指向OH_NativeBuffer实例的指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。[OH_NativeBuffer](../../topics/misc/OH_NativeBuffer.md) *nativeBuffer指向OH_NativeBuffer实例的指针，允许为空，当输入为空时渲染结果返回到输入的OH_NativeBuffer对象上。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。const char *uri图片URI（只支持Jpeg，Heif）。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。const char *uri图片URI。输出URI的格式和输入保持一致，如果不支持Heif编码能力，则进行Jpeg编码。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。[OH_PictureNative](../../topics/media/OH_PictureNative.md) *picture指向OH_PictureNative实例的指针。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。[OH_PictureNative](../../topics/media/OH_PictureNative.md) *picture指向OH_PictureNative实例的指针，允许为空，当输入为空时渲染结果返回到输入的OH_PictureNative对象上。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffectOH_ImageEffect结构体实例指针。int32_t textureId包含图片内容的纹理标识，纹理标识必须是有效的且绑定了GL_TEXTURE_2D类型的纹理。int32_t colorSpace图片对应的色彩空间。
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffectOH_ImageEffect结构体实例指针。int32_t textureId
...
参数项描述[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *imageEffect效果器指针。char **info指向char数组的指针，返回序列化JSON字符串。
...
类型说明[OH_ImageEffect](../../topics/graphics/OH_ImageEffect.md) *反序列化成功时返回OH_ImageEffect实例，否则返回空指针。