...
类型说明[struct WebSocket](../../topics/networking/WebSocket.md) *成功返回客户端指针，失败返回为NULL。
...
参数项描述[struct WebSocket](../../topics/networking/WebSocket.md) *client客户端指针。[struct WebSocket_Header](../../topics/networking/WebSocket_Header.md) headerHeader头信息。
...
参数项描述[struct WebSocket](../../topics/networking/WebSocket.md) *client客户端指针。const char *url客户端要连接到服务端的地址。[struct WebSocket_RequestOptions](../../topics/networking/WebSocket_RequestOptions.md) options发起连接的可选参数。
...
参数项描述[struct WebSocket](../../topics/networking/WebSocket.md) *client客户端。char *data客户端发送的数据。size_t length客户端发送的数据长度。
...
参数项描述[struct WebSocket](../../topics/networking/WebSocket.md) *client客户端。[struct WebSocket_CloseOption](../../topics/networking/WebSocket_CloseOption.md) options发起关闭连接的可选参数。
...
参数项描述[struct WebSocket](../../topics/networking/WebSocket.md) *client客户端。
