...
**相关模块：**[HuksKeyApi](../../topics/networking/HuksKeyApi.md)
...
参数项描述[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *sdkVersion用于存放获取到的版本信息（字符串格式）。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias给要生成的密钥的别名，需要保证业务所在进程内唯一，否则会发生覆盖。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSetIn生成密钥的属性信息的参数集。[struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSetOut生成密钥为临时类型时，存放着密钥数据；非临时类型可为空。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias待导入密钥的别名，需要保证业务所在进程内唯一，否则会发生覆盖。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet待导入密钥的属性参数。[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *key待导入密钥数据，需符合Huks的格式要求，具体见[native_huks_type.h](native_huks_type.h.md)。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias待导入密钥的别名，需要保证业务所在进程内唯一，否则会发生覆盖。[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *wrappingKeyAlias密钥别名，该对应密钥用于密钥协商出密钥解密待导入密钥。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet待导入加密密钥的属性参数。[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *wrappedKeyData需要导入的加密的密钥数据，需要符合Huks定义的格式，具体见[OH_Huks_AlgSuite](native_huks_type.h.md#ZH-CN_TOPIC_0000002529285393__oh_huks_algsuite)。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias待导出公钥的密钥别名，应与所用密钥生成时使用的别名相同。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet导出公钥需要的属性参数。[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *key存放导出的公钥。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias待删除密钥的别名，应与密钥生成时使用的别名相同。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet删除密钥需要属性参数（默认传空）。若不指定则默认要删除的密钥存储等级为[OH_HUKS_AUTH_STORAGE_LEVEL_CE](native_huks_type.h.md#ZH-CN_TOPIC_0000002529285393__oh_huks_authstoragelevel)。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias要获取参数集的密钥别名。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSetIn要获取参数集需要的属性TAG（默认传空）。[struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSetOut获取到的输出参数集。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias要查找的密钥的别名。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet查询密钥需要的属性TAG（默认传空）。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias要获取证书的密钥的别名。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet获取密钥证书需要的参数。[struct OH_Huks_CertChain](../../topics/security/OH_Huks_CertChain.md) *certChain存放输出的密钥证书链。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias操作的密钥的别名。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet初始化操作的密钥参数集合。[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *handle密钥会话的句柄，后续其他操作时传入该句柄，包括[OH_Huks_UpdateSession](#ZH-CN_TOPIC_0000002497605400__oh_huks_updatesession)，[OH_Huks_FinishSession](#ZH-CN_TOPIC_0000002497605400__oh_huks_finishsession)，[OH_Huks_AbortSession](#ZH-CN_TOPIC_0000002497605400__oh_huks_abortsession)。[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *token存放安全访问控制时传回的token。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *handle密钥会话句柄，通过[OH_Huks_InitSession](#ZH-CN_TOPIC_0000002497605400__oh_huks_initsession)接口生成。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet密钥操作对应的输入参数集。[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *inData要处理的输入数据，如果数据过大，可分片多次调用。[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *outData经过对应的密钥操作后输出的数据。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *handle密钥会话句柄，通过[OH_Huks_InitSession](#ZH-CN_TOPIC_0000002497605400__oh_huks_initsession)接口生成。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet密钥操作对应的输入参数集。[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *inData要处理的输入数据。[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *outData经过对应的密钥操作后输出的数据。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *handle密钥会话句柄，通过[OH_Huks_InitSession](#ZH-CN_TOPIC_0000002497605400__oh_huks_initsession)接口生成。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet取消密钥会话需要的输入参数集（默认传空）。
...
参数项描述[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet获取密钥别名集需要的输入参数集（默认传空）。[struct OH_Huks_KeyAliasSet](../../topics/misc/OH_Huks_KeyAliasSet.md) **outData经过对应的密钥操作后输出的数据。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias表示要导出的密钥别名。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet表示加密导出密钥的参数集。[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *wrappedKey表示要导出的封装好的密钥。
...
参数项描述[const struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *keyAlias表示要导入的密钥别名。在服务进程中，别名必须唯一。否则，密钥将被覆盖。[const struct OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md) *paramSet表示加密导入密钥的参数集。[struct OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md) *wrappedKey表示要导入的封装好的密钥。
