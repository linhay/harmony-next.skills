...
**相关模块：**[Vulkan](../../topics/media/Vulkan.md)

#### 汇总

#### 结构体

名称typedef关键字描述[VkSurfaceCreateInfoOHOS](../../topics/misc/VkSurfaceCreateInfoOHOS.md)VkSurfaceCreateInfoOHOS包含创建Vulkan Surface时必要的参数。[VkNativeBufferUsageOHOS](../../topics/misc/VkNativeBufferUsageOHOS.md)VkNativeBufferUsageOHOS提供HarmonyOS NativeBuffer用途的说明。[VkNativeBufferPropertiesOHOS](../../topics/misc/VkNativeBufferPropertiesOHOS.md)VkNativeBufferPropertiesOHOS包含了NativeBuffer的属性。[VkNativeBufferFormatPropertiesOHOS](../../topics/misc/VkNativeBufferFormatPropertiesOHOS.md)VkNativeBufferFormatPropertiesOHOS包含了NativeBuffer的一些格式属性。[VkImportNativeBufferInfoOHOS](../../topics/misc/VkImportNativeBufferInfoOHOS.md)VkImportNativeBufferInfoOHOS包含了OH_NativeBuffer结构体的指针。[VkMemoryGetNativeBufferInfoOHOS](../../topics/misc/VkMemoryGetNativeBufferInfoOHOS.md)VkMemoryGetNativeBufferInfoOHOS用于从Vulkan内存中获取OH_NativeBuffer。[VkExternalFormatOHOS](../../topics/misc/VkExternalFormatOHOS.md)VkExternalFormatOHOS表示外部定义的格式标识符。[NativeWindow](../../topics/misc/NativeWindow.md)OHNativeWindow本地窗口。[OH_NativeBuffer](../../topics/misc/OH_NativeBuffer.md)-OH_NativeBuffer结构体声明。
...
参数项描述VkDevice deviceVkDevice对象。const [struct OH_NativeBuffer](../../topics/misc/OH_NativeBuffer.md)* bufferOH_NativeBuffer结构体指针。[VkNativeBufferPropertiesOHOS](../../topics/misc/VkNativeBufferPropertiesOHOS.md)* pProperties用于接收OH_NativeBuffer属性的结构体。
...
参数项描述VkDevice deviceVkDevice对象。[const VkMemoryGetNativeBufferInfoOHOS](../../topics/misc/VkMemoryGetNativeBufferInfoOHOS.md)* pInfoVkMemoryGetNativeBufferInfoOHOS结构体对象。[struct OH_NativeBuffer](../../topics/misc/OH_NativeBuffer.md)** pBuffer用于接收获取到的OH_NativeBuffer。
