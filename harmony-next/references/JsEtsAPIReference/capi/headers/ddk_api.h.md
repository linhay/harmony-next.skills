...
**相关模块：**[BaseDdk](../../topics/misc/BaseDdk.md)
...
参数项描述const uint8_t *name指向要创建的共享内存的指针。uint32_t size共享内存对应的缓冲区大小。[DDK_Ashmem](../../topics/misc/DDK_Ashmem.md) **ashmem指向创建的共享内存的指针。
...
参数项描述[DDK_Ashmem](../../topics/misc/DDK_Ashmem.md) *ashmem要映射的共享内存指针。const uint8_t ashmemMapType共享内存的保护权限值。
...
参数项描述[DDK_Ashmem](../../topics/misc/DDK_Ashmem.md) *ashmem要取消映射的共享内存指针。
...
参数项描述[DDK_Ashmem](../../topics/misc/DDK_Ashmem.md) *ashmem要销毁的共享内存指针。
