...
**相关模块：**[HuksTypeApi](../../topics/networking/HuksTypeApi.md)

#### 汇总

#### 结构体

名称描述[OH_Huks_Result](../../topics/misc/OH_Huks_Result.md)表示状态返回数据，包括返回码和消息。[OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md)定义存放数据的结构体类型。[OH_Huks_Param](../../topics/media/OH_Huks_Param.md)定义参数集中的参数结构体类型。[OH_Huks_ParamSet](../../topics/media/OH_Huks_ParamSet.md)定义参数集的结构体类型。[OH_Huks_CertChain](../../topics/security/OH_Huks_CertChain.md)定义证书链的结构体类型。[OH_Huks_KeyInfo](../../topics/misc/OH_Huks_KeyInfo.md)定义密钥信息的结构体类型。[OH_Huks_PubKeyInfo](../../topics/misc/OH_Huks_PubKeyInfo.md)定义公钥信息的结构体类型。[OH_Huks_KeyMaterialRsa](../../topics/misc/OH_Huks_KeyMaterialRsa.md)定义Rsa密钥的结构体类型。[OH_Huks_KeyMaterialEcc](../../topics/misc/OH_Huks_KeyMaterialEcc.md)定义Ecc密钥的结构体类型。[OH_Huks_KeyMaterialDsa](../../topics/misc/OH_Huks_KeyMaterialDsa.md)定义Dsa密钥的结构体类型。[OH_Huks_KeyMaterialDh](../../topics/misc/OH_Huks_KeyMaterialDh.md)定义Dh密钥的结构体类型。[OH_Huks_KeyMaterial25519](../../topics/misc/OH_Huks_KeyMaterial25519.md)定义25519类型密钥的结构体类型。[OH_Huks_KeyAliasSet](../../topics/misc/OH_Huks_KeyAliasSet.md)定义密钥别名集的结构体类型。
...
枚举项描述OH_HUKS_TAG_TYPE_INVALID = 0 << 28非法的Tag类型。OH_HUKS_TAG_TYPE_INT = 1 << 28该Tag的数据类型为int32_t类型。OH_HUKS_TAG_TYPE_UINT = 2 << 28该Tag的数据类型为uin32_t类型。OH_HUKS_TAG_TYPE_ULONG = 3 << 28该Tag的数据类型为uin64_t类型。OH_HUKS_TAG_TYPE_BOOL = 4 << 28该Tag的数据类型为bool类型。OH_HUKS_TAG_TYPE_BYTES = 5 << 28该Tag的数据类型为[OH_Huks_Blob](../../topics/misc/OH_Huks_Blob.md)类型。

**参考：**

[OH_Huks_Param](../../topics/media/OH_Huks_Param.md)
