...
创建一个新的[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md)实例。
...
类型说明[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md) *

如果创建成功，返回一个指向新创建的[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md)实例的指针。
...
销毁一个[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md)实例。

**起始版本：** 12

**参数：**

参数项描述[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md) *cursorInfo表示指向即将被销毁的[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md)实例的指针。
...
参数项描述[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md) *cursorInfo表示指向[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md)实例的指针。double left光标靠左点与物理屏幕左侧距离的绝对值，单位px。double top光标顶点与物理屏幕上侧距离的绝对值，单位px。double width宽度，单位px。double height高度，单位px。
...
参数项描述[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md) *cursorInfo表示指向[InputMethod_CursorInfo](../../topics/input/InputMethod_CursorInfo.md)实例的指针。double *left靠左点与物理屏幕左侧距离的绝对值，单位px。double *top顶点与物理屏幕上侧距离的绝对值，单位px。double *width宽度，单位px。double *height高度，单位px。
