...
名称typedef关键字描述[OH_AVCodecAsyncCallback](../../topics/misc/OH_AVCodecAsyncCallback.md)OH_AVCodecAsyncCallbackOH_AVCodec中所有异步回调函数指针的集合。将该结构体的实例注册到OH_AVCodec实例中，并处理回调上报的信息，以保证OH_AVCodec的正常运行。(API11废弃)[OH_AVCodecCallback](../../topics/misc/OH_AVCodecCallback.md)OH_AVCodecCallbackOH_AVCodec中所有异步回调函数指针的集合。将该结构体的实例注册到OH_AVCodec实例中，并处理回调上报的信息，以保证OH_AVCodec的正常运行。[OH_AVDataSource](../../topics/misc/OH_AVDataSource.md)OH_AVDataSource用户自定义数据源。[OH_AVDataSourceExt](../../topics/misc/OH_AVDataSourceExt.md)OH_AVDataSourceExt用户自定义数据源，回调支持通过userData传递用户自定义数据。[NativeWindow](../../topics/misc/NativeWindow.md)OHNativeWindow为图形接口定义native层对象。[OH_AVCodec](../../topics/misc/OH_AVCodec.md)OH_AVCodec为音视频编解码接口定义native层对象。
...
编码档次，值类型为int32_t，请参见[OH_AVCProfile](#ZH-CN_TOPIC_0000002529445703__oh_avcprofile)、[OH_HEVCProfile](#ZH-CN_TOPIC_0000002529445703__oh_hevcprofile)、[OH_AACProfile](#ZH-CN_TOPIC_0000002529445703__oh_aacprofile)。可以通过能力查询接口[OH_AVCapability_GetSupportedProfiles](native_avcapability.h.md#ZH-CN_TOPIC_0000002497445758__oh_avcapability_getsupportedprofiles)来获取支持的档次。
...
表示当前帧编码块的平均qp值，随[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md)输出。
...
表示当前帧编码块的MSE统计值，随[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md)输出。
...
参数项描述[OH_AVCodec](../../topics/misc/OH_AVCodec.md) *codecOH_AVCodec实例。int32_t errorCode特定错误代码。void *userData开发者执行回调所依赖的数据。
...
参数项描述[OH_AVCodec](../../topics/misc/OH_AVCodec.md) *codecOH_AVCodec实例。[OH_AVFormat](../../topics/misc/OH_AVFormat.md) *format新输出流描述信息。void *userData开发者执行回调所依赖的数据。
...
参数项描述[OH_AVCodec](../../topics/misc/OH_AVCodec.md) *codecOH_AVCodec实例。uint32_t index与新可用的输入缓冲区相对应的索引。[OH_AVMemory](../../topics/misc/OH_AVMemory.md) *data新的可用输入缓冲区。void *userData开发者执行回调所依赖的数据。
...
参数项描述[OH_AVCodec](../../topics/misc/OH_AVCodec.md) *codecOH_AVCodec实例。uint32_t index与新输出缓冲区对应的索引。[OH_AVMemory](../../topics/misc/OH_AVMemory.md) *data包含新输出数据的缓冲区。[OH_AVCodecBufferAttr](../../topics/misc/OH_AVCodecBufferAttr.md) *attr新输出缓冲区的说明。void *userData开发者执行回调所依赖的数据。
...
参数项描述[OH_AVCodec](../../topics/misc/OH_AVCodec.md) *codecOH_AVCodec实例。uint32_t index与新可用的输入缓冲区相对应的索引。[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md) *buffer新的可用输入缓冲区。void *userData开发者执行回调所依赖的数据。
...
参数项描述[OH_AVCodec](../../topics/misc/OH_AVCodec.md) *codecOH_AVCodec实例。uint32_t index与新输出缓冲区对应的索引。[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md) *buffer包含新输出数据的缓冲区。void *userData开发者执行回调所依赖的数据。
...
参数项描述[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md) *data要填充的缓冲区。int32_t length要读取的数据长度。int64_t pos从偏移量位置读取。
...
参数项描述[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md) *data要填充的缓冲区。int32_t length要读取的数据长度。int64_t pos从偏移量位置读取。void *userData用户自定义数据。
