...
名称typedef关键字描述[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)OH_RDB_TransOptions定义[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)结构类型。[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)OH_Rdb_Transaction定义[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)结构类型。
...
类型说明[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)

执行成功时返回指向[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)实例的指针。否则返回nullptr。
...
参数项描述[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md) *options表示指向[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)实例的指针。
...
参数项描述[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md) *options表示指向[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)实例的指针。[OH_RDB_TransType](#ZH-CN_TOPIC_0000002529444669__oh_rdb_transtype) type表示关系型数据库事务类型。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const char *table表示目标表。const [OH_VBucket](../../topics/misc/OH_VBucket.md) *row表示要插入到表中的数据行。int64_t *rowId输出参数，表示插入后返回的行号。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const char *table表示目标表名称。const [OH_VBucket](../../topics/misc/OH_VBucket.md) *row表示要插入到表中的数据。Rdb_ConflictResolution resolution表示发生冲突时的解决策略。int64_t *rowId输出参数，表示插入成功后返回的行号。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const char *table表示目标表。const [OH_Data_VBuckets](../../topics/misc/OH_Data_VBuckets.md) *rows表示要插入到表中的一组数据。Rdb_ConflictResolution resolution表示发生冲突时的解决策略。int64_t *changes输出参数，表示插入成功的次数。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const [OH_VBucket](../../topics/misc/OH_VBucket.md) *row表示要更新到表中的数据行。const [OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示[OH_Predicates](../../topics/misc/OH_Predicates.md)指定的更新条件。int64_t *changes输出参数，表示更新成功的次数。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const [OH_VBucket](../../topics/misc/OH_VBucket.md) *row表示要更新到表中的数据。const [OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示[OH_Predicates](../../topics/misc/OH_Predicates.md)指定的更新条件。Rdb_ConflictResolution resolution表示发生冲突时的解决策略。int64_t *changes输出参数，表示更新成功的行数。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const [OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示[OH_Predicates](../../topics/misc/OH_Predicates.md)指定的删除条件。int64_t *changes表示删除成功的次数。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const [OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示[OH_Predicates](../../topics/misc/OH_Predicates.md)指定的查询条件。const char *columns[]表示要查询的列，如果传入空值，则查询适用于所有列。int len表示列中元素的个数。

**返回：**

类型说明[OH_Cursor](../../topics/input/OH_Cursor.md)如果执行成功，则返回指向[OH_Cursor](../../topics/input/OH_Cursor.md)实例的指针。如果数据库已关闭或数据库没有响应，则返回空。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const char *sql表示要执行的SQL语句。const [OH_Data_Values](../../topics/misc/OH_Data_Values.md) *args表示指向[OH_Data_Values](../../topics/misc/OH_Data_Values.md)的指针。
...
参数项描述[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) *trans表示指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。const char *sql表示要执行的SQL语句。const [OH_Data_Values](../../topics/misc/OH_Data_Values.md) *argsSQL语句中包含的参数。OH_Data_Value **result执行成功时指向[OH_Data_Value](../../topics/misc/OH_Data_Value.md)实例的指针。使用完成后，必须通过[OH_Value_Destroy](oh_data_value.h.md#ZH-CN_TOPIC_0000002529284693__oh_value_destroy)接口释放内存。
