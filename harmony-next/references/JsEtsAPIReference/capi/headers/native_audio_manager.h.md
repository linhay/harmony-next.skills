...
名称typedef关键字描述[OH_AudioManager](../../topics/media/OH_AudioManager.md)OH_AudioManager声明音频管理器。用于音频管理相关功能。

#### 函数

名称typedef关键字描述[typedef void (*OH_AudioManager_OnAudioSceneChangeCallback)(void *userData, OH_AudioScene scene)](#ZH-CN_TOPIC_0000002529285701__oh_audiomanager_onaudioscenechangecallback)OH_AudioManager_OnAudioSceneChangeCallback音频场景变化回调函数的原型定义，用于传递给[OH_AudioManager_RegisterAudioSceneChangeCallback](native_audio_manager.h.md#ZH-CN_TOPIC_0000002529285701__oh_audiomanager_registeraudioscenechangecallback)。[OH_AudioCommon_Result OH_GetAudioManager(OH_AudioManager **audioManager)](#ZH-CN_TOPIC_0000002529285701__oh_getaudiomanager)-
...
参数项描述[OH_AudioManager](../../topics/media/OH_AudioManager.md) **audioManager指向[OH_AudioManager](../../topics/media/OH_AudioManager.md)用于接收创建的音频管理器实例。
...
参数项描述[OH_AudioManager](../../topics/media/OH_AudioManager.md)* manager指向[OH_GetAudioManager](native_audio_manager.h.md#ZH-CN_TOPIC_0000002529285701__oh_getaudiomanager)创建的音频管理器实例：[OH_AudioManager](../../topics/media/OH_AudioManager.md)。[OH_AudioScene](native_audio_common.h.md#ZH-CN_TOPIC_0000002497605712__oh_audioscene) *scene指向[OH_AudioScene](native_audio_common.h.md#ZH-CN_TOPIC_0000002497605712__oh_audioscene)用于接收返回的音频场景模式。
