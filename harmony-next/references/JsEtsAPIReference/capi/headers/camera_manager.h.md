...
在[CameraManager_Callbacks](../../topics/media/CameraManager_Callbacks.md)中被调用的相机管理器状态回调。

**起始版本：** 11

**参数：**

参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager传递回调的Camera_Manager。[Camera_StatusInfo](../../topics/media/Camera_StatusInfo.md)* status每个相机设备的状态信息。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager传递回调的Camera_Manager。[Camera_TorchStatusInfo](../../topics/media/Camera_TorchStatusInfo.md)* status手电筒的状态信息。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager传递回调的Camera_Manager。[Camera_FoldStatusInfo](../../topics/media/Camera_FoldStatusInfo.md)* foldStatusInfo设备的折叠状态信息。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[CameraManager_Callbacks](../../topics/media/CameraManager_Callbacks.md)* callback要注册的相机设备状态回调。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[CameraManager_Callbacks](../../topics/media/CameraManager_Callbacks.md)* callback要注销的相机设备状态回调。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[OH_CameraManager_TorchStatusCallback](#ZH-CN_TOPIC_0000002529445763__oh_cameramanager_torchstatuscallback) torchStatusCallback要注册的手电筒状态变化回调。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[OH_CameraManager_TorchStatusCallback](#ZH-CN_TOPIC_0000002529445763__oh_cameramanager_torchstatuscallback) torchStatusCallback要注销的手电筒状态变化回调。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[OH_CameraManager_OnFoldStatusInfoChange](#ZH-CN_TOPIC_0000002529445763__oh_cameramanager_onfoldstatusinfochange) foldStatusInfoCallback要注册的折叠状态信息变更事件回调。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[OH_CameraManager_OnFoldStatusInfoChange](#ZH-CN_TOPIC_0000002529445763__oh_cameramanager_onfoldstatusinfochange) foldStatusInfoCallback要注销的折叠状态信息变更事件回调。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_Device](../../topics/system-services/Camera_Device.md)** cameras如果方法调用成功，将记录支持的Camera_Device列表。uint32_t* size如果方法调用成功，将记录支持的Camera_Device列表的大小。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_Device](../../topics/system-services/Camera_Device.md)* cameras要删除的Camera_Device列表。uint32_t size要删除的相机设备数量。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_Device](../../topics/system-services/Camera_Device.md)* camera要查询的Camera_Device。[Camera_OutputCapability](../../topics/system-services/Camera_OutputCapability.md)** cameraOutputCapability如果方法调用成功，将记录支持的Camera_OutputCapability。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_Device](../../topics/system-services/Camera_Device.md)* camera要查询的Camera_Device。[Camera_SceneMode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_scenemode) sceneMode指定相机模式。[Camera_OutputCapability](../../topics/system-services/Camera_OutputCapability.md)** cameraOutputCapability如果方法调用成功，将记录支持的Camera_OutputCapability列表。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_OutputCapability](../../topics/system-services/Camera_OutputCapability.md)* cameraOutputCapability要删除的Camera_OutputCapability。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。bool* isCameraMuted如果方法调用成功，将返回相机是否静音的结果。返回true表示相机已静音，返回false表示未静音。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_CaptureSession](../../topics/media/Camera_CaptureSession.md)** captureSession如果方法调用成功，将创建Camera_CaptureSession。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_Device](../../topics/system-services/Camera_Device.md)* camera用于创建Camera_Input实例的Camera_Device。[Camera_Input](../../topics/input/Camera_Input.md)** cameraInput如果方法调用成功，将创建Camera_Input实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_Profile](../../topics/media/Camera_Profile.md)* profile用于创建Camera_PreviewOutput实例的相机流配置文件。const char* surfaceId用于创建Camera_PreviewOutput实例的surfaceId。[Camera_PreviewOutput](../../topics/media/Camera_PreviewOutput.md)** previewOutput如果方法调用成功，将创建Camera_PreviewOutput实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const char* surfaceId用于创建Camera_PreviewOutput实例的surfaceId。[Camera_PreviewOutput](../../topics/media/Camera_PreviewOutput.md)** previewOutput如果方法调用成功，将创建Camera_PreviewOutput实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_Profile](../../topics/media/Camera_Profile.md)* profile用于创建Camera_PhotoOutput实例的相机流配置文件。const char* surfaceId用于创建Camera_PhotoOutput实例的surfaceId。[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)** photoOutput如果方法调用成功，将创建Camera_PhotoOutput实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const char* surfaceId用于创建Camera_PhotoOutput实例的surfaceId。[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)** photoOutput如果方法调用成功，将创建Camera_PhotoOutput实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md) *cameraManager相机管理器实例。const [Camera_Profile](../../topics/media/Camera_Profile.md) *profile用于创建Camera_PhotoOutput实例的相机流配置文件。[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md) **photoOutput如果方法调用成功，将创建Camera_PhotoOutput实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_VideoProfile](../../topics/media/Camera_VideoProfile.md)* profile用于创建Camera_VideoOutput实例的录像配置文件。const char* surfaceId用于创建Camera_VideoOutput实例的surfaceId。[Camera_VideoOutput](../../topics/media/Camera_VideoOutput.md)** videoOutput如果方法调用成功，将创建Camera_VideoOutput实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const char* surfaceId用于创建Camera_VideoOutput实例的surfaceId。[Camera_VideoOutput](../../topics/media/Camera_VideoOutput.md)** videoOutput如果方法调用成功，将创建Camera_VideoOutput实例。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_MetadataObjectType](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_metadataobjecttype)* profile用于创建Camera_MetadataOutput实例的元数据对象类型。[Camera_MetadataOutput](../../topics/media/Camera_MetadataOutput.md)** metadataOutput如果方法调用成功，将创建Camera_MetadataOutput实例。
...
参数项描述[Camera_Device](../../topics/system-services/Camera_Device.md)* camera要查询的Camera_Device。[Camera_SceneMode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_scenemode)** sceneModes如果方法调用成功，将记录支持的场景模式列表。uint32_t* size如果方法调用成功，将记录支持的场景模式列表大小。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_SceneMode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_scenemode)* sceneModes要删除的场景模式列表。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。bool* isTorchSupported设备是否支持手电筒。返回true表示设备支持手电筒，返回false表示不支持。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_TorchMode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_torchmode) torchMode要检查的相机手电筒模式。bool* isTorchSupported设备是否支持指定的手电筒模式。返回true表示设备支持该模式，返回false表示不支持。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_TorchMode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_torchmode) torchMode要设置的相机手电筒模式。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。[Camera_Position](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_position) position要查询的相机位置。[Camera_Type](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_type) type要查询的相机类型。[Camera_Device](../../topics/system-services/Camera_Device.md)* camera要查询的Camera_Device。
...
参数项描述[Camera_Manager](../../topics/media/Camera_Manager.md)* cameraManager相机管理器实例。const [Camera_Device](../../topics/system-services/Camera_Device.md)* camera用于查询的Camera_Device相机设备列表，推荐设置为包含[OH_CameraManager_GetCameraDevice](#ZH-CN_TOPIC_0000002529445763__oh_cameramanager_getcameradevice)获取的前置与后置两个相机设备的相机设备列表。uint32_t deviceSize用于查询的相机设备列表长度, 必须设置为2（表示前置与后置两个用于并发的相机设备）。[Camera_ConcurrentInfo](../../topics/media/Camera_ConcurrentInfo.md)** cameraConcurrentInfo
