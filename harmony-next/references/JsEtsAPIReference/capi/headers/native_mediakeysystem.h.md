...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[DRM_EventType](native_drm_common.h.md#ZH-CN_TOPIC_0000002529445793__drm_eventtype) eventType事件类型。uint8_t *info事件信息。int32_t infoLen事件信息长度。char *extra增量信息。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[OH_MediaKeySystem_Callback](#ZH-CN_TOPIC_0000002529285821__oh_mediakeysystem_callback) callback回调函数。
...
参数项描述[DRM_MediaKeySystemDescription](../../topics/system-services/DRM_MediaKeySystemDescription.md) *infosDRM解决方案名称和唯一标识的列表。uint32_t *countDRM解决方案名称和唯一标识的列表长度。
...
参数项描述const char *nameDRM解决方案名称。[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) **mediaKeySystemMediaKeySystem实例。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。const char *configName字符串类型配置属性名，不能为空，具体支持的属性名由设备上DRM解决方案决定。const char *value字符串类型配置属性值，不能为空，具体支持的属性值由设备上DRM解决方案决定。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。const char *configName字符串类型配置名。char *value字符串类型配置值。int32_t valueLen字符串类型配置值长度。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。const char *configName字符数组类型配置属性名，不能为空，具体支持的属性名由设备上DRM解决方案决定。uint8_t *value字符数组类型配置属性值，不能为空，具体支持的属性值由设备上DRM解决方案决定。int32_t valueLen字符数组类型配置属性值长度。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。const char *configName字符数组类型配置属性名称，不能为空，具体支持的属性名由设备上DRM解决方案决定。uint8_t *value字符数组类型配置属性。int32_t *valueLen字符数组类型配置属性长度。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[DRM_Statistics](../../topics/misc/DRM_Statistics.md) *statistics度量记录。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[DRM_ContentProtectionLevel](native_drm_common.h.md#ZH-CN_TOPIC_0000002529445793__drm_contentprotectionlevel) *contentProtectionLevel内容保护级别。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[MediaKeySystem_Callback](#ZH-CN_TOPIC_0000002529285821__mediakeysystem_callback) callback回调函数。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[DRM_ContentProtectionLevel](native_drm_common.h.md#ZH-CN_TOPIC_0000002529445793__drm_contentprotectionlevel) *level内容保护级别。[MediaKeySession](../../topics/media/MediaKeySession.md) **mediaKeySessionMediaKeySession实例。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。uint8_t *request设备DRM证书请求。int32_t *requestLen设备DRM证书请求的长度。char *defaultUrl设备DRM证书服务的URL。int32_t defaultUrlLen设备DRM证书服务的URL长度。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。uint8_t *response设备DRM证书请求响应。int32_t responseLen设备DRM证书请求响应长度。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[DRM_OfflineMediakeyIdArray](../../topics/graphics/DRM_OfflineMediakeyIdArray.md) *offlineMediaKeyIds离线媒体密钥的媒体密钥标识列表。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。uint8_t *offlineMediaKeyId离线媒体密钥标识。int32_t offlineMediaKeyIdLen离线媒体密钥标识长度。[DRM_OfflineMediaKeyStatus](native_drm_common.h.md#ZH-CN_TOPIC_0000002529445793__drm_offlinemediakeystatus) *status媒体密钥状态。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。uint8_t *offlineMediaKeyId离线媒体密钥标识。int32_t offlineMediaKeyIdLen离线媒体密钥标识长度。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。[DRM_CertificateStatus](native_drm_common.h.md#ZH-CN_TOPIC_0000002529445793__drm_certificatestatus) *certStatus设备DRM证书状态值。
...
参数项描述[MediaKeySystem](../../topics/system-services/MediaKeySystem.md) *mediaKeySystemMediaKeySystem实例。
