...
名称typedef关键字描述[OH_Preferences](../../topics/misc/OH_Preferences.md)OH_Preferences定义Preferences对象类型。
...
参数项描述void *context应用上下文的指针。const [OH_PreferencesPair](../../topics/misc/OH_PreferencesPair.md) *pairs发生变更的KV数据的指针。uint32_t count发生变更的KV数据的数量。
...
参数项描述[OH_PreferencesOption](../../topics/misc/OH_PreferencesOption.md) *option指向Preferences配置选项[OH_PreferencesOption](../../topics/misc/OH_PreferencesOption.md)的指针。int *errCode
...
类型说明[OH_Preferences](../../topics/misc/OH_Preferences.md)当操作成功时，返回指向打开的Preferences对象[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针，失败返回空指针。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向需要关闭的Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。const char *key需要获取的Key的指针。int *value该参数作为出参使用，表示指向获取到的整型值的指针。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。const char *key需要获取的Key的指针。bool *value该参数作为出参使用，表示指向获取到的布尔值的指针。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。const char *key需要获取的Key的指针。char **value该参数作为出参使用，表示指向获取到的字符串的二级指针，使用完毕后需要调用释放函数[OH_Preferences_FreeString](oh_preferences.h.md#ZH-CN_TOPIC_0000002497604698__oh_preferences_freestring)释放内存。uint32_t *valueLen该参数作为出参使用，表示获取到的字符串长度的指针。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。const char *key指向需要设置的Key的指针。int value需要设置的整型值。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。const char *key指向需要设置的Key的指针。bool value需要设置的布尔值。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。const char *key指向需要设置的Key的指针。const char *value指向需要设置的字符串指针。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。const char *key指向需要删除的Key的指针。
...
参数项描述[OH_Preferences](../../topics/misc/OH_Preferences.md) *preference指向目标Preferences[OH_Preferences](../../topics/misc/OH_Preferences.md)实例对象的指针。void *context应用上下文的指针。[OH_PreferencesDataObserver](#ZH-CN_TOPIC_0000002497604698__oh_preferencesdataobserver) observer订阅数据变更关联的回调函数[OH_PreferencesDataObserver](oh_preferences.h.md#ZH-CN_TOPIC_0000002497604698__oh_preferencesdataobserver)。const char *keys[]需要订阅的Key数组。uint32_t keyCount需要订阅的Key的数量。
