...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。
...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。uint32_t* streamId指向一个用来接收音频流ID的变量。
...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。int32_t* rate指向一个用来接收音频流采样率的变量。
...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。int32_t* channelCount指向一个用来接收音频流通道数的变量。
...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。int32_t* frameSize指向将为帧大小设置的变量的指针。
...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。int64_t* frames指向将为帧计数设置的变量的指针。
...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。uint32_t* count指向一个用来接收音频流过载数的变量的指针。
...
参数项描述[OH_AudioCapturer](../../topics/media/OH_AudioCapturerStruct.md)* capturer指向[OH_AudioStreamBuilder_GenerateCapturer](native_audiostreambuilder.h.md#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_generatecapturer)创建的音频流实例。void* userData指向应用自定义的数据存储区域。void* audioData指向录制数据存储区域，用于应用读取录制数据。int32_t audioDataSize录制数据的长度。
