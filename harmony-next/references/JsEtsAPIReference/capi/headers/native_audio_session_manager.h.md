...
名称typedef关键字描述[OH_AudioSession_Strategy](../../topics/media/OH_AudioSession_Strategy.md)OH_AudioSession_Strategy音频会话策略。[OH_AudioSession_DeactivatedEvent](../../topics/media/OH_AudioSession_DeactivatedEvent.md)OH_AudioSession_DeactivatedEvent音频会话已停用事件。[OH_AudioSession_StateChangedEvent](../../topics/media/OH_AudioSession_StateChangedEvent.md)OH_AudioSession_StateChangedEvent音频会话状态变更事件。[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md)OH_AudioSessionManager声明音频会话管理器。用于管理音频会话相关功能。
...
参数项描述[OH_AudioSession_StateChangedEvent](../../topics/media/OH_AudioSession_StateChangedEvent.md) event音频会话状态变更事件。
...
参数项描述[OH_AudioDevice_ChangeType](native_audio_device_base.h.md#ZH-CN_TOPIC_0000002497445734__oh_audiodevice_changetype) type设备连接状态类型，已连接或断开。[OH_AudioDeviceDescriptorArray](../../topics/system-services/OH_AudioDeviceDescriptorArray.md) *audioDeviceDescriptorArray
...
参数项描述[OH_AudioDeviceDescriptorArray](../../topics/system-services/OH_AudioDeviceDescriptorArray.md) *devices
...
参数项描述[OH_AudioSession_DeactivatedEvent](../../topics/media/OH_AudioSession_DeactivatedEvent.md) event音频会话已停用事件。
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) **audioSessionManager音频会话管理器实例。
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。const [OH_AudioSession_Strategy](../../topics/media/OH_AudioSession_Strategy.md) *strategy指向[OH_AudioSession_Strategy](../../topics/media/OH_AudioSession_Strategy.md)，用于设置音频会话策略。
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。
...
- 本接口允许在[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md)创建后随时调用。系统记录应用设置的默认本机内置发声设备，但只有激活AudioSession后才能生效。
- 应用启动播放时，若外接设备如蓝牙耳机或有线耳机已接入，系统优先从外接设备发声；否则，系统遵循应用设置的默认本机内置发声设备。
- 本接口优先级低于[AVCastPicker](../../modules/ohos/@ohos.multimedia.avCastPicker (投播组件).md#ZH-CN_TOPIC_0000002529445731__avcastpicker)。如果使用AVCastPicker切换过发声设备，再次调用本接口切换设备将不生效。

**起始版本：** 20

**参数：**

参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。[OH_AudioDevice_Type](native_audio_device_base.h.md#ZH-CN_TOPIC_0000002497445734__oh_audiodevice_type) deviceType
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。[OH_AudioDeviceDescriptorArray](../../topics/system-services/OH_AudioDeviceDescriptorArray.md) *audioDeviceDescriptorArray需要释放的音频设备描述符数组。
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。[OH_AudioDevice_Usage](native_audio_device_base.h.md#ZH-CN_TOPIC_0000002497445734__oh_audiodevice_usage) deviceUsage用于设置要获取的设备种类。[OH_AudioDeviceDescriptorArray](../../topics/system-services/OH_AudioDeviceDescriptorArray.md) **audioDeviceDescriptorArray
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。[OH_AudioDeviceDescriptor](../../topics/system-services/OH_AudioDeviceDescriptor.md) *deviceDescriptor
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。[OH_AudioDeviceDescriptor](../../topics/system-services/OH_AudioDeviceDescriptor.md) **audioDeviceDescriptor
...
参数项描述[OH_AudioSessionManager](../../topics/media/OH_AudioSessionManager.md) *audioSessionManager指向[OH_AudioManager_GetAudioSessionManager](#ZH-CN_TOPIC_0000002497605710__oh_audiomanager_getaudiosessionmanager)创建的音频会话管理实例。[OH_AudioDeviceDescriptor](../../topics/system-services/OH_AudioDeviceDescriptor.md) *audioDeviceDescriptor需要被释放的音频设备描述符对象。
