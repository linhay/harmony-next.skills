...
名称typedef关键字描述[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md)MediaLibrary_RequestId
...
[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)OH_MediaAssetManager
...
[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)OH_MediaAssetChangeRequest

定义媒体资产更改请求。

此结构体提供了处理媒体资产更改请求的能力。

[OH_MovingPhoto](../../topics/misc/OH_MovingPhoto.md)OH_MovingPhoto

定义动态照片。

此结构体提供了获取关于动态照片的信息的能力。

[OH_MediaAsset](../../topics/media/OH_MediaAsset.md)OH_MediaAsset

定义媒体资产。

此结构体提供了封装文件资源属性的能力。

[MediaLibrary_RequestOptions](../../topics/media/MediaLibrary_RequestOptions.md)MediaLibrary_RequestOptions
...
枚举项描述MEDIA_LIBRARY_COMPRESSED = 1普通图片格式，如JPEG、HEIC、GIF。MEDIA_LIBRARY_PICTURE_OBJECT = 2图片解码后的PixelMap、GainMap和图片元数据信息一起封装的对象，方便应用进行编辑和显示。此对象的操作详见[OH_PictureNative](../../topics/media/OH_PictureNative.md)。
...
参数项描述[MediaLibrary_ErrorCode](#ZH-CN_TOPIC_0000002497605962__medialibrary_errorcode) result处理所请求资源的结果[MediaLibrary_ErrorCode](#ZH-CN_TOPIC_0000002497605962__medialibrary_errorcode)。[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md) requestId请求的[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md)。[MediaLibrary_MediaQuality](#ZH-CN_TOPIC_0000002497605962__medialibrary_mediaquality) mediaQuality请求源的[MediaLibrary_MediaQuality](#ZH-CN_TOPIC_0000002497605962__medialibrary_mediaquality)。[MediaLibrary_MediaContentType](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_mediacontenttype) type请求源的[MediaLibrary_MediaContentType](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_mediacontenttype)。[OH_ImageSourceNative](../../topics/graphics/OH_ImageSourceNative.md)* imageSourceNative当请求的图像源准备就绪时获取[OH_ImageSourceNative](../../topics/graphics/OH_ImageSourceNative.md)。
...
参数项描述[MediaLibrary_ErrorCode](#ZH-CN_TOPIC_0000002497605962__medialibrary_errorcode) result处理所请求资源的结果[MediaLibrary_ErrorCode](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_errorcode)。[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md) requestId请求的[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md)。[MediaLibrary_MediaQuality](#ZH-CN_TOPIC_0000002497605962__medialibrary_mediaquality) mediaQuality请求资源的[MediaLibrary_MediaQuality](#ZH-CN_TOPIC_0000002497605962__medialibrary_mediaquality)。[MediaLibrary_MediaContentType](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_mediacontenttype) type请求资源的[MediaLibrary_MediaContentType](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_mediacontenttype)。[OH_MovingPhoto](../../topics/misc/OH_MovingPhoto.md)* movingPhoto当请求的动态图片准备就绪时获取[OH_MovingPhoto](../../topics/misc/OH_MovingPhoto.md)。