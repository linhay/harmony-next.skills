...
**相关模块：**[CryptoDigestApi](../../topics/networking/CryptoDigestApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoDigest](../../topics/misc/OH_CryptoDigest.md)OH_CryptoDigest定义摘要结构体。
...
[OH_CryptoDigest](../../topics/misc/OH_CryptoDigest.md) **ctx指向摘要实例的指针。
...
参数项描述[OH_CryptoDigest](../../topics/misc/OH_CryptoDigest.md) *ctx指向摘要实例。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *in传入的消息。
...
参数项描述[OH_CryptoDigest](../../topics/misc/OH_CryptoDigest.md) *ctx指向摘要实例。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *out返回的Md的计算结果。
...
参数项描述[OH_CryptoDigest](../../topics/misc/OH_CryptoDigest.md) *ctx指向摘要实例。
