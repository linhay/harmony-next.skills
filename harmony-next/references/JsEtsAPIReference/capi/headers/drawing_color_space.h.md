...
类型说明[OH_Drawing_ColorSpace](../../topics/graphics/OH_Drawing_ColorSpace.md)*函数返回一个指针，指针指向创建的颜色空间对象[OH_Drawing_ColorSpace](../../topics/graphics/OH_Drawing_ColorSpace.md)。
...
参数项描述[OH_Drawing_ColorSpace](../../topics/graphics/OH_Drawing_ColorSpace.md)* colorSpace指向颜色空间对象[OH_Drawing_ColorSpace](../../topics/graphics/OH_Drawing_ColorSpace.md)的指针。