...
创建一个画刷对象副本[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)，用于拷贝一个已有画刷对象。
...
为画刷设置滤波器[OH_Drawing_Filter](../../topics/graphics/OH_Drawing_Filter.md)。滤波器是一个容器，可以承载蒙版滤波器和颜色滤波器。
...
从画刷获取滤波器[OH_Drawing_Filter](../../topics/graphics/OH_Drawing_Filter.md)。滤波器是一个容器，可以承载蒙版滤波器和颜色滤波器。
...
类型说明[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)*函数会返回一个指针，指针指向创建的画刷对象。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。

**返回：**

类型说明[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)*函数会返回一个指针，指针指向创建的画刷对象副本[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)。如果对象返回NULL，表示创建失败；可能的原因是可用内存为空，或者是brush为NULL。
...
参数项描述const [OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。bool antiAlias真为抗锯齿，假则不做抗锯齿处理。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。uint32_t color描述颜色的32位（ARGB）变量。
...
参数项描述const [OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush表示指向画刷对象的指针。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。uint8_t alpha表示要设置的透明度值，是一个8位变量。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。[OH_Drawing_ShaderEffect](../../topics/graphics/OH_Drawing_ShaderEffect.md)* shaderEffect表示指向着色器对象的指针，为NULL表示清空画刷的着色器效果。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。[OH_Drawing_ShadowLayer](../../topics/graphics/OH_Drawing_ShadowLayer.md)* shadowLayer表示指向阴影层的指针，为NULL表示清空画刷的阴影层效果。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象的指针。[OH_Drawing_Filter](../../topics/graphics/OH_Drawing_Filter.md)* filter表示指向滤波器对象的指针，为NULL表示清空画刷滤波器。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)的指针。[OH_Drawing_Filter](../../topics/graphics/OH_Drawing_Filter.md)* filter表示指向滤波器对象[OH_Drawing_Filter](../../topics/graphics/OH_Drawing_Filter.md)的指针。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)的指针。[OH_Drawing_BlendMode](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_blendmode) blendMode混合模式枚举类型[OH_Drawing_BlendMode](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_blendmode)。
...
参数项描述[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush指向画刷对象[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)的指针。
...
参数项描述const [OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush表示指向[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)对象的指针。float* a表示颜色的透明度，范围为0.0 ~ 1.0的浮点数。
...
参数项描述const [OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush表示指向[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)对象的指针。float* r表示颜色中的红色分量，范围为0.0 ~ 1.0的浮点数。
...
参数项描述const [OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush表示指向[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)对象的指针。float* g表示颜色中的绿色分量，范围为0.0 ~ 1.0的浮点数。
...
参数项描述const [OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)* brush表示指向[OH_Drawing_Brush](../../topics/graphics/OH_Drawing_Brush.md)对象的指针。float* b表示颜色中的蓝色分量，范围为0.0 ~ 1.0的浮点数。
