...
**相关模块：**[OH_Scan](../../topics/misc/OH_Scan.md)

#### 汇总

#### 结构体

名称typedef关键字描述[Scan_ScannerDevice](../../topics/system-services/Scan_ScannerDevice.md)Scan_ScannerDevice表示扫描仪设备信息[Scan_PictureScanProgress](../../topics/components/Scan_PictureScanProgress.md)Scan_PictureScanProgress表示扫描仪扫描图片的进度[Scan_ScannerOptions](../../topics/misc/Scan_ScannerOptions.md)Scan_ScannerOptions表示一个扫描仪的所有参数选项
...
参数项描述[Scan_ScannerDevice](../../topics/system-services/Scan_ScannerDevice.md)** devices所有发现的扫描仪设备列表int32_t deviceCount发现的扫描仪数量
...
参数项描述const char* scannerId用于获取扫描仪参数的IDint32_t* errorCode如果执行成功，errorCode返回[SCAN_ERROR_NONE](#ZH-CN_TOPIC_0000002529285525__scan_errorcode)，否则返回特定的错误码，参考[Print_ErrorCode](ohprint.h.md#ZH-CN_TOPIC_0000002497445554__print_errorcode)

**返回：**

类型说明[Scan_ScannerOptions*](../../topics/misc/Scan_ScannerOptions.md)
...
参数项描述const char* scannerId此ID用于设置特定扫描仪的选项const int32_t option要设置的选项编号。取值范围从0到 optionCount - 1，从[Scan_ScannerOptions](../../topics/misc/Scan_ScannerOptions.md)获取const char* value要设置的选项值，有效值从ranges获取，从[Scan_ScannerOptions](../../topics/misc/Scan_ScannerOptions.md)获取
...
参数项描述const char* scannerId用于查询扫描仪图像扫描进度的ID[Scan_PictureScanProgress](../../topics/components/Scan_PictureScanProgress.md)* prog扫描图片的[Scan_PictureScanProgress](../../topics/components/Scan_PictureScanProgress.md)，必须为非空值
