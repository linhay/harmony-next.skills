...
参数项描述[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)* gpuContext指向图形处理器上下文对象的指针[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)。bool flag用于控制内存分配是否计入缓存预算。true则计入高速缓存预算，false则不计入高速缓存预算。[OH_Drawing_Image_Info](../../topics/graphics/OH_Drawing_Image_Info.md) imageInfo图片信息[OH_Drawing_Image_Info](../../topics/graphics/OH_Drawing_Image_Info.md)结构体。

**返回：**

类型说明[OH_Drawing_Surface](../../topics/graphics/OH_Drawing_Surface.md)*返回一个指针，指针指向创建的surface对象[OH_Drawing_Surface](../../topics/graphics/OH_Drawing_Surface.md)。
...
参数项描述[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)* gpuContext

指向图形处理器上下文对象的指针[OH_Drawing_GpuContext](../../topics/graphics/OH_Drawing_GpuContext.md)。
...
[OH_Drawing_Image_Info](../../topics/graphics/OH_Drawing_Image_Info.md) imageInfo图片信息[OH_Drawing_Image_Info](../../topics/graphics/OH_Drawing_Image_Info.md)结构体。void* window指向屏幕窗口对象的指针。
...
参数项描述[OH_Drawing_Surface](../../topics/graphics/OH_Drawing_Surface.md)* surface指向创建的surface对象的指针。

**返回：**

类型说明[OH_Drawing_Canvas](../../topics/graphics/OH_Drawing_Canvas.md)*返回一个指针，指针指向创建的画布对象[OH_Drawing_Canvas](../../topics/graphics/OH_Drawing_Canvas.md)。返回的指针不需要由调用者管理。
...
参数项描述[OH_Drawing_Surface](../../topics/graphics/OH_Drawing_Surface.md)* surface指向创建的surface对象的指针[OH_Drawing_Surface](../../topics/graphics/OH_Drawing_Surface.md)。该surface对象必须由[OH_Drawing_SurfaceCreateOnScreen](drawing_surface.h.md#ZH-CN_TOPIC_0000002497606012__oh_drawing_surfacecreateonscreen)创建，否则该接口调用将没有任何效果。
