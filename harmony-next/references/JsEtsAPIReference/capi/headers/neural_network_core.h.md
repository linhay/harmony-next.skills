...
创建[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)类型的编译实例。
...
离线模型是由硬件供应商提供的模型转换器离线编译的模型类型，所以离线模型只能在指定的设备上使用，但离线模型的编译时间通常远小于构图实例[OH_NNModel](../../topics/misc/OH_NNModel.md)的编译时间。
...
返回的[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例只将**modelBuffer**指针保存在里面，而不是复制其数据。在销毁[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例之前，不应释放**modelBuffer**。
...
从模型缓存恢复的时间少于使用[OH_NNModel](../../topics/misc/OH_NNModel.md)进行编译的时间。
...
创建一个[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例。

[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)描述了各种张量属性，如名称/数据类型/形状/格式等。

可以调用以下接口，基于传入的[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例创建[NN_Tensor](../../topics/misc/NN_Tensor.md)实例：
...
该接口会将[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例复制到[NN_Tensor](../../topics/misc/NN_Tensor.md)中，因此您可以创建多个[NN_Tensor](../../topics/misc/NN_Tensor.md)个实例，并持有相同的[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例。当[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例不再使用时，您应该调用[OH_NNTensorDesc_Destroy](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensordesc_destroy)接口销毁它。

[OH_NN_ReturnCode OH_NNTensorDesc_Destroy(NN_TensorDesc **tensorDesc)](#ZH-CN_TOPIC_0000002529286139__oh_nntensordesc_destroy)

释放一个[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例。

当[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例不再使用时，需要调用该接口销毁，否则将发生内存泄漏。
...
设置[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的名称。

[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例创建完成后，调用该接口设置张量的名称，***name**的值是以**'\0'**结尾的C风格字符串。
...
获取[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的名称。

调用该接口获取指定[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的名称，***name**的值是以**'\0'*
...
设置[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的数据类型。

[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例创建完成后，调用该接口设置张量数据类型。
...
获取[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的数据类型。

调用该接口获取指定[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的数据类型。
...
设置[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的数据形状。

[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例创建完成后，调用该接口设置张量形状。
...
获取[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的形状。

调用该接口获取指定[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的形状。
...
设置[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的数据布局。

[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例创建完成后，调用该接口设置张量的数据布局[OH_NN_Format](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_format)。
...
获取[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的数据布局。

调用该接口获取指定[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的数据布局[OH_NN_Format](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_format)。
...
获取[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的元素个数。

调用该接口获取指定[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的元素个数。如果需要获取张量数据的字节大小，请调用[OH_NNTensorDesc_GetByteSize](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensordesc_getbytesize)。
...
获取基于[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的形状和数据类型计算的数据占用字节数。

调用该接口可基于[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)的形状和数据类型计算得到的数据占用字节数。
...
从[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)创建一个[NN_Tensor](../../topics/misc/NN_Tensor.md)实例。
...
该接口会将**tensorDesc**复制到[NN_Tensor](../../topics/misc/NN_Tensor.md)中，因此当**tensorDesc**不再使用时，您应该调用[OH_NNTensorDesc_Destroy](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensordesc_destroy)接口销毁它。
...
当[NN_Tensor](../../topics/misc/NN_Tensor.md)实例不再使用时，需要调用[OH_NNTensor_Destroy](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensor_destroy)销毁它。
...
按照指定内存大小和[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)创建[NN_Tensor](../../topics/misc/NN_Tensor.md)实例。
...
按照指定共享内存的文件描述符和[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)创建[NN_Tensor](../../topics/misc/NN_Tensor.md)实例。

该接口复用文件描述符**fd**对应的共享内存，**fd**可能来自另一个[NN_Tensor](../../topics/misc/NN_Tensor.md)实例。当调用[OH_NNTensor_Destroy](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensor_destroy)接口销毁该接口创建的张量时，不会释放该张量数据的内存。
...
销毁一个[NN_Tensor](../../topics/misc/NN_Tensor.md)实例。

当不再使用[NN_Tensor](../../topics/misc/NN_Tensor.md)实例时，需要调用该接口销毁该实例，否则将发生内存泄漏。
...
获取[NN_Tensor](../../topics/misc/NN_Tensor.md)的[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例。

调用该接口获取指定[NN_Tensor](../../topics/misc/NN_Tensor.md)实例的内部[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例指针。

您可以从返回的[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例中获取各种类型的张量属性，例如名称/数据布局/数据类型/形状等。

您不应销毁返回的[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例，因为它指向了[NN_Tensor](../../topics/misc/NN_Tensor.md)的内部实例，否则一旦调用[OH_NNTensor_Destroy](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensor_destroy)将会发生双重释放的内存崩溃。
...
获取[NN_Tensor](../../topics/misc/NN_Tensor.md)数据的内存地址。
...
获取[NN_Tensor](../../topics/misc/NN_Tensor.md)数据所在共享内存的文件描述符。

文件描述符**fd**对应了一块设备共享内存，可以通过[OH_NNTensor_CreateWithFd](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensor_createwithfd)被另外一个[NN_Tensor](../../topics/misc/NN_Tensor.md)使用。
...
获取[NN_Tensor](../../topics/misc/NN_Tensor.md)数据所在共享内存的大小。
...
获取[NN_Tensor](../../topics/misc/NN_Tensor.md)数据所在共享内存上的偏移量。

**offset**是张量数据在对应共享内存上的偏移量，可以通过[OH_NNTensor_CreateWithFd](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nntensor_createwithfd)接口，连同共享内存文件描述符、共享内存总大小一起被另外的[NN_Tensor](../../topics/misc/NN_Tensor.md)使用。
...
创建[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)执行器实例。

该接口接受一个[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例，构造一个与硬件关联的模型推理执行器。通过[OH_NNExecutor_SetInput](neural_network_runtime.h.md#ZH-CN_TOPIC_0000002529446113__oh_nnexecutor_setinput)设置模型输入数据，设置输入数据后，调用[OH_NNExecutor_Run](neural_network_runtime.h.md#ZH-CN_TOPIC_0000002529446113__oh_nnexecutor_run)接口执行推理，最后通过[OH_NNExecutor_SetOutput](neural_network_runtime.h.md#ZH-CN_TOPIC_0000002529446113__oh_nnexecutor_setoutput)获取计算结果。 通过[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例创建一个[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例后，如果不再使用[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例创建其他[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例，就可以销毁[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例了。
...
该接口接受一个[OH_NNModel](../../topics/misc/OH_NNModel.md)实例，创建出[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例；通过[OH_NNCompilation_SetDevice](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nncompilation_setdevice)接口，设置编译的设备，最后调用[OH_NNCompilation_Build](neural_network_core.h.md#ZH-CN_TOPIC_0000002529286139__oh_nncompilation_build)完成编译。
...
调用该接口创建[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)后，[OH_NNModel](../../topics/misc/OH_NNModel.md)实例就可以释放了。

**起始版本：** 9

**参数：**

参数项描述[const OH_NNModel](../../topics/misc/OH_NNModel.md) *model指向[OH_NNModel](../../topics/misc/OH_NNModel.md)实例的指针。

**返回：**

类型说明[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针，如果创建失败就返回NULL。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。const void *buffer指向给定内存的指针。size_t length内存长度。size_t *modelSize模型缓存的字节大小。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。const void *buffer指向给定内存的指针。size_t modelSize模型缓存的字节大小。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。const char *configName配置名称。const void *configValue保存配置值的地址。const size_t configValueSize配置值的字节大小。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。size_t deviceID指定的硬件ID。如果为0，则默认使用当前设备列表中的第1台设备。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。const char *cachePath模型缓存文件目录，该接口在cachePath目录下为不同的硬件创建模型缓存目录。建议每个模型使用单独的模型缓存目录。uint32_t version模型缓存版本。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。[OH_NN_PerformanceMode](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_performancemode) performanceMode指定性能模式，可选的性能模式参考[OH_NN_PerformanceMode](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_performancemode)。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。[OH_NN_Priority](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_priority) priority指定优先级，可选的优先级参考[OH_NN_Priority](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_priority)。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。bool enableFloat16Float16低精度计算标志位。设置为true时，执行Float16推理；设置为false时，执行float32推理。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) *compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的指针。
...
参数项描述[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md) **compilation指向[OH_NNCompilation](../../topics/misc/OH_NNCompilation.md)实例的二级指针。编译实例销毁后，该接口将*compilation主动设置为空指针。
...
类型说明[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针，如果创建失败就返回NULL。
...
参数项描述[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) **tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的二级指针。
...
参数项描述[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。const char *name需要设置的张量名称。
...
调用该接口获取指定[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的名称，***name**的值是以**'\0'**结尾的C风格字符串。
...
参数项描述[const NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。const char **name返回的张量名称。
...
参数项描述[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。[OH_NN_DataType](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_datatype) dataType需要设置的张量数据类型。
...
参数项描述[const NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。[OH_NN_DataType](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_datatype) *dataType指向返回的张量数据类型的指针，作为出参使用。
...
参数项描述[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。const int32_t *shape需要设置的张量形状列表。size_t shapeLength需要设置的张量形状列表长度。
...
参数项描述[const NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。int32_t **shape返回的张量形状列表。size_t *shapeLength返回的形状列表长度。
...
参数项描述[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。[OH_NN_Format](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_format) format需要设置的张量数据布局。
...
参数项描述[const NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。[OH_NN_Format](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__oh_nn_format) *format返回的张量数据布局。
...
参数项描述[const NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。size_t *elementCount张量返回的元素个数。
...
参数项描述[const NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。size_t *byteSize返回的数据字节数。
...
参数项描述size_t deviceID设备 ID。如果为0，则默认使用当前设备列表中的第1台设备。[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。

**返回：**

类型说明[NN_Tensor](../../topics/misc/NN_Tensor.md) *指向[NN_Tensor](../../topics/misc/NN_Tensor.md)实例的指针，如果创建失败就返回NULL。
...
参数项描述size_t deviceID设备ID。如果为0，则默认使用当前设备列表中的第1台设备。[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。size_t size需要分配的张量数据的大小。
...
参数项描述size_t deviceID设备ID，如果为0，则默认使用当前设备列表中的第1台设备。[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md) *tensorDesc指向[NN_TensorDesc](../../topics/misc/NN_TensorDesc.md)实例的指针。int fd要使用的共享内存的文件描述符。size_t size要使用的共享内存的大小。size_t offset要使用的共享内存的偏移量。
...
参数项描述[NN_Tensor](../../topics/misc/NN_Tensor.md) **tensor指向[NN_Tensor](../../topics/misc/NN_Tensor.md)实例的二级指针。
...
参数项描述[const NN_Tensor](../../topics/misc/NN_Tensor.md) *tensor指向[NN_Tensor](../../topics/misc/NN_Tensor.md)实例的指针。
...
参数项描述[const NN_Tensor](../../topics/misc/NN_Tensor.md) *tensor指向[NN_Tensor](../../topics/misc/NN_Tensor.md)实例的指针。int *fd返回的共享内存文件描述符。
...
参数项描述[const NN_Tensor](../../topics/misc/NN_Tensor.md) *tensor指向[NN_Tensor](../../topics/misc/NN_Tensor.md)实例的指针。size_t *size返回的数据所在共享内存的大小。
...
参数项描述[const NN_Tensor](../../topics/misc/NN_Tensor.md) *tensor指向[NN_Tensor](../../topics/misc/NN_Tensor.md)实例的指针。size_t *offset返回的张量内存fd的偏移量。
...
类型说明[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针，如果创建失败就返回NULL。
...
参数项描述[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) **executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的二级指针。
...
参数项描述[const OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。size_t *inputCount返回的输入张量数量。
...
参数项描述[const OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。size_t *outputCount返回的输出张量数量。
...
参数项描述[const OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。size_t index输入张量的索引值。
...
参数项描述[const OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。size_t index输出张量的索引值。
...
参数项描述[const OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。size_t index输入张量的索引值。size_t **minInputDims返回的数组的指针，保存了指定输入张量的最小维度（维度数与形状匹配）。size_t **maxInputDims返回的数组的指针，保存了指定输入张量的最大维度（维度数与形状匹配）。size_t *shapeLength返回的输入张量的维度数量，与形状一致。
...
参数项描述[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。[NN_OnRunDone](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__nn_onrundone) onRunDone回调函数句柄[NN_OnRunDone](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__nn_onrundone)。
...
参数项描述[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。[NN_OnServiceDied](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__nn_onservicedied) onServiceDied回调函数句柄[NN_OnServiceDied](neural_network_runtime_type.h.md#ZH-CN_TOPIC_0000002497606150__nn_onservicedied)。
...
参数项描述[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。[NN_Tensor](../../topics/misc/NN_Tensor.md) *inputTensor[]输入张量的数组。size_t inputCount输入张量的数量。[NN_Tensor](../../topics/misc/NN_Tensor.md) *outputTensor[]输出张量的数组。size_t outputCount输出张量的数量。
...
参数项描述[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md) *executor指向[OH_NNExecutor](../../topics/misc/OH_NNExecutor.md)实例的指针。[NN_Tensor](../../topics/misc/NN_Tensor.md) *inputTensor[]输入张量的数组。size_t inputCount输入张量的数量。[NN_Tensor](../../topics/misc/NN_Tensor.md) *outputTensor[]输出张量的数组。size_t outputCount输出张量的数量。int32_t timeout异步推理的超时时间（单位ms），例如1000。void *userData异步执行的标识符。
