...
**相关模块：**[CryptoMacApi](../../topics/networking/CryptoMacApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md)OH_CryptoMac定义MAC结构。
...
[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md) **ctxMAC实例。
...
参数项描述[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md) *ctxMAC实例。[CryptoMac_ParamType](#ZH-CN_TOPIC_0000002529285351__cryptomac_paramtype) typeMAC参数类型。[const Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *valueMAC参数。
...
参数项描述[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md) *ctxMAC实例。[const OH_CryptoSymKey](../../topics/misc/OH_CryptoSymKey.md) *key对称密钥。
...
参数项描述[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md) *ctxMAC实例。[const Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *in需要更新的数据。
...
参数项描述[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md) *ctxMAC实例。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *outMAC值。
...
参数项描述[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md) *ctxMAC实例。uint32_t *lengthMAC长度。
...
参数项描述[OH_CryptoMac](../../topics/misc/OH_CryptoMac.md) *ctxMAC实例。