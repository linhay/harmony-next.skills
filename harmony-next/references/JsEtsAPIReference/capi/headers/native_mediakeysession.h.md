...
名称typedef关键字描述[MediaKeySession_Callback](../../topics/media/MediaKeySession_Callback.md)MediaKeySession_CallbackMediaKeySession_Callback结构体，用于监听密钥过期、密钥更改等事件，不返回媒体密钥会话实例，适用于单媒体密钥会话解密场景。[OH_MediaKeySession_Callback](../../topics/media/OH_MediaKeySession_Callback.md)OH_MediaKeySession_CallbackOH_MediaKeySession_Callback结构体，用于监听密钥过期、密钥更改等事件，返回媒体密钥会话实例，适用多个媒体密钥会话解密场景。
...
参数项描述[DRM_KeysInfo](../../topics/misc/DRM_KeysInfo.md) *keysInfo密钥信息。bool newKeysAvailable新密钥是否可用。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySession会话实例。[DRM_EventType](native_drm_common.h.md#ZH-CN_TOPIC_0000002529445793__drm_eventtype) eventType事件类型。uint8_t *info事件信息。int32_t infoLen事件信息长度。char *extra增量信息。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySession媒体密钥会话实例。[DRM_KeysInfo](../../topics/misc/DRM_KeysInfo.md) *keysInfo密钥信息。bool newKeysAvailable新密钥是否可用，true表示可用，false表示不可用。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。[DRM_MediaKeyRequestInfo](../../topics/media/DRM_MediaKeyRequestInfo.md) *info媒体密钥请求信息。[DRM_MediaKeyRequest](../../topics/media/DRM_MediaKeyRequest.md) *mediaKeyRequest媒体密钥请求。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。uint8_t *response媒体密钥请求响应。int32_t responseLen媒体密钥请求响应长度。uint8_t *offlineMediaKeyId离线媒体密钥标识。int32_t *offlineMediaKeyIdLen离线媒体密钥标识的长度。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。[DRM_MediaKeyStatus](../../topics/media/DRM_MediaKeyStatus.md) *mediaKeyStatus媒体密钥状态。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。uint8_t *offlineMediaKeyId离线媒体密钥标识。int32_t *releaseRequestLen离线媒体密钥标识长度。uint8_t *releaseRequest离线媒体密钥释放请求。int32_t *releaseRequestLen离线媒体密钥释放请求长度。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。uint8_t *offlineMediaKeyId离线媒体密钥标识。int32_t offlineMediaKeyIdLen离线媒体密钥标识长度。uint8_t *releaseResponse媒体密钥释放请求响应。int32_t releaseResponseLen媒体密钥释放请求响应长度。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。uint8_t *offlineMediaKeyId离线媒体密钥标识。int32_t offlineMediaKeyIdLen离线媒体密钥标识长度。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。[DRM_ContentProtectionLevel](native_drm_common.h.md#ZH-CN_TOPIC_0000002529445793__drm_contentprotectionlevel) *contentProtectionLevel内容保护级别。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。const char *mimeType媒体类型，支持的媒体类型取决于DRM解决方案，如：video/avc、video/hev。bool *status安全解码模块状态。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。[MediaKeySession_Callback](../../topics/media/MediaKeySession_Callback.md) *callbackMediaKeySession的回调。
...
参数项描述[MediaKeySession](../../topics/media/MediaKeySession.md) *mediaKeySessionMediaKeySession实例。[OH_MediaKeySession_Callback](../../topics/media/OH_MediaKeySession_Callback.md) *callbackMediaKeySession的回调。
