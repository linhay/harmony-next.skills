...
参数项描述[const RawFile](../../topics/misc/rawfile.md) *rawFile表示指向[RawFile](../../topics/misc/rawfile.md)的指针。void *buf用于接收读取数据的缓冲区指针。size_t length读取数据的字节长度。
...
参数项描述[const RawFile](../../topics/misc/rawfile.md) *rawFile表示指向[RawFile](../../topics/misc/rawfile.md)的指针。long offset表示指定的偏移量。int whence
...
参数项描述[RawFile](../../topics/misc/rawfile.md) *rawFile表示指向[RawFile](../../topics/misc/rawfile.md)的指针。
...
参数项描述[const RawFile](../../topics/misc/rawfile.md) *rawFile表示指向[RawFile](../../topics/misc/rawfile.md)的指针。
...
关闭已打开的[RawFile](../../topics/misc/rawfile.md) 以及释放所有相关联的资源。
...
参数项描述[const RawFile](../../topics/misc/rawfile.md) *rawFile表示指向[RawFile](../../topics/misc/rawfile.md)的指针。RawFileDescriptor &descriptor显示rawfile文件描述符，以及在HAP包中的起始位置和长度。
...
参数项描述[const RawFile](../../topics/misc/rawfile.md) *rawFile表示指向[RawFile](../../topics/misc/rawfile.md)的指针。[RawFileDescriptor](../../topics/misc/RawFileDescriptor.md) *descriptor显示rawfile文件描述符，以及在HAP包中的起始位置和长度。
...
参数项描述[ const RawFileDescriptor](../../topics/misc/RawFileDescriptor.md) &descriptor包含rawfile文件描述符，以及在HAP包中的起始位置和长度。
...
参数项描述[const RawFile64](../../topics/misc/RawFile64.md) *rawFile表示指向[RawFile64](../../topics/misc/RawFile64.md)的指针。void *buf用于接收读取数据的缓冲区指针。int64_t length读取数据的字节长度。
...
参数项描述[const RawFile64](../../topics/misc/RawFile64.md) *rawFile表示指向[RawFile64](../../topics/misc/RawFile64.md)的指针。int64_t offset表示指定的偏移量。int whence
...
参数项描述[RawFile64](../../topics/misc/RawFile64.md) *rawFile表示指向[RawFile64](../../topics/misc/RawFile64.md)的指针。
...
参数项描述[const RawFile64](../../topics/misc/RawFile64.md) *rawFile表示指向[RawFile64](../../topics/misc/RawFile64.md)的指针。
...
关闭已打开的[RawFile64](../../topics/misc/RawFile64.md) 以及释放所有相关联的资源。
...
参数项描述[const RawFile64](../../topics/misc/RawFile64.md) *rawFile表示指向[RawFile64](../../topics/misc/RawFile64.md)的指针。[RawFileDescriptor64](../../topics/misc/RawFileDescriptor64.md) *descriptor显示rawfile文件描述符，以及在HAP包中的起始位置和长度。
...
参数项描述[const RawFileDescriptor64](../../topics/misc/RawFileDescriptor64.md) *descriptor包含rawfile文件描述符，以及在HAP包中的起始位置和长度。
