...
名称typedef关键字描述[DateTimeRule](../../topics/misc/DateTimeRule.md)DateTimeRule时间日期规则。[InitialTimeZoneRule](../../topics/misc/InitialTimeZoneRule.md)InitialTimeZoneRule起始时区规则。[TimeArrayTimeZoneRule](../../topics/media/TimeArrayTimeZoneRule.md)TimeArrayTimeZoneRule起始时间戳数组定义的时区规则。[AnnualTimeZoneRule](../../topics/misc/AnnualTimeZoneRule.md)AnnualTimeZoneRule每年生效的时区规则。[TimeZoneRules](../../topics/misc/TimeZoneRules.md)TimeZoneRules完整的时区规则。[TimeZoneRuleQuery](../../topics/misc/TimeZoneRuleQuery.md)TimeZoneRuleQuery用于传入查询的信息，并接收查询的结果。
...
参数项描述const char* timeZoneID时区ID，例如“Asia/Shanghai”。[TimeZoneRules](../../topics/misc/TimeZoneRules.md)* rules与时区ID对应的完整时区规则[TimeZoneRules](../../topics/misc/TimeZoneRules.md)。
...
参数项描述[TimeArrayTimeZoneRule](../../topics/media/TimeArrayTimeZoneRule.md)* rule起始时间戳数组定义的时区规则[TimeArrayTimeZoneRule](../../topics/media/TimeArrayTimeZoneRule.md)。[TimeZoneRuleQuery](../../topics/misc/TimeZoneRuleQuery.md)* query用于传入查询的信息，并接收查询的结果。
...
参数项描述[AnnualTimeZoneRule](../../topics/misc/AnnualTimeZoneRule.md)* rule每年生效的时区规则[AnnualTimeZoneRule](../../topics/misc/AnnualTimeZoneRule.md)。[TimeZoneRuleQuery](../../topics/misc/TimeZoneRuleQuery.md)* query用于传入查询的信息，并接收查询的结果。
...
参数项描述[TimeArrayTimeZoneRule](../../topics/media/TimeArrayTimeZoneRule.md)* rule起始时间戳数组定义的时区规则[TimeArrayTimeZoneRule](../../topics/media/TimeArrayTimeZoneRule.md)。int32_t index起始时间的索引。double* result规则生效的起始时间。
...
参数项描述[AnnualTimeZoneRule](../../topics/misc/AnnualTimeZoneRule.md)* rule每年生效的时区规则[AnnualTimeZoneRule](../../topics/misc/AnnualTimeZoneRule.md)。int32_t year查询的年份。[TimeZoneRuleQuery](../../topics/misc/TimeZoneRuleQuery.md)* query用于传入查询的信息，并接收查询的结果。
