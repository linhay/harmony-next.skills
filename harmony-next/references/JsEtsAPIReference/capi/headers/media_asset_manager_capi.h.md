...
类型说明[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)*返回一个指向OH_MediaAssetManager实例的指针。
...
参数项描述[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)* manager指向OH_MediaAssetManager实例的指针。const char* uri请求的图像资源的uri。[MediaLibrary_RequestOptions](../../topics/media/MediaLibrary_RequestOptions.md) requestOptions请求策略模式配置项。const char* destPath请求资源的目标地址。[OH_MediaLibrary_OnDataPrepared](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__oh_medialibrary_ondataprepared) callback媒体资源处理器，当所请求的媒体资源准备完成时会触发回调。

**返回：**

类型说明[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md)返回请求Id。
...
参数项描述[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)* manager指向OH_MediaAssetManager实例的指针。const char* uri请求的视频资源的uri。[MediaLibrary_RequestOptions](../../topics/media/MediaLibrary_RequestOptions.md) requestOptions请求策略模式配置项。const char* destPath请求资源的目标地址。[OH_MediaLibrary_OnDataPrepared](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__oh_medialibrary_ondataprepared) callback媒体资源处理器，当所请求的媒体资源准备完成时会触发回调。
...
参数项描述[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)* manager指向OH_MediaAssetManager实例的指针。const [MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md) requestId待取消的请求Id。
...
参数项描述[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)* manager[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)实例指针。[OH_MediaAsset](../../topics/media/OH_MediaAsset.md)* mediaAsset要请求的媒体文件对象的[OH_MediaAsset](../../topics/media/OH_MediaAsset.md)实例。[MediaLibrary_RequestOptions](../../topics/media/MediaLibrary_RequestOptions.md) requestOptions用于图像请求策略模式的[MediaLibrary_RequestOptions](../../topics/media/MediaLibrary_RequestOptions.md)。[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md)* requestId请求的[MediaLibrary_RequestId](../../topics/media/MediaLibrary_RequestId.md)，出参。[OH_MediaLibrary_OnMovingPhotoDataPrepared](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__oh_medialibrary_onmovingphotodataprepared) callback当请求的动态照片准备就绪时调用[OH_MediaLibrary_OnMovingPhotoDataPrepared](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__oh_medialibrary_onmovingphotodataprepared)。
...
释放[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)实例。

**起始版本：** 13

**参数：**

参数项描述[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)* manager要释放的[OH_MediaAssetManager](../../topics/media/OH_MediaAssetManager.md)实例。
