...
**相关模块：**[NativeWindow](../../topics/misc/NativeWindow.md)

#### 汇总

#### 结构体

名称typedef关键字描述[Region](../../topics/misc/Region.md)Region表示本地窗口OHNativeWindow需要更新内容的矩形区域（脏区）。[Rect](../../topics/misc/Rect.md)-如果rects是空指针nullptr，默认Buffer大小为脏区。[OHHDRMetaData](../../topics/misc/OHHDRMetaData.md)OHHDRMetaDataHDR元数据结构体定义。[OHExtDataHandle](../../topics/misc/OHExtDataHandle.md)OHExtDataHandle扩展数据句柄结构体定义。[OHIPCParcel](../../topics/components/OHIPCParcel.md)OHIPCParcel提供对IPC序列化对象的访问功能。[NativeWindow](../../topics/misc/NativeWindow.md)OHNativeWindow提供对OHNativeWindow的访问功能。[NativeWindowBuffer](../../topics/misc/NativeWindowBuffer.md)OHNativeWindowBuffer提供对OHNativeWindowBuffer的访问功能。
...
**替代方案：** 使用[OH_NativeWindow_GetBufferHandleFromNative](#ZH-CN_TOPIC_0000002497606020__oh_nativewindow_getbufferhandlefromnative)接口获取BufferHandle实例，从[BufferHandle](../../topics/misc/BufferHandle.md)实例中获取stride值。
...
类型说明[OHNativeWindow](../../topics/misc/NativeWindow.md)*返回一个指针，指向OHNativeWindow的结构体实例。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md)* window一个OHNativeWindow的结构体实例的指针。
...
参数项描述[OHNativeWindowBuffer](../../topics/misc/NativeWindowBuffer.md)* buffer一个OHNativeWindowBuffer的结构体实例的指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。[OHNativeWindowBuffer](../../topics/misc/NativeWindowBuffer.md) **buffer
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。[OHNativeWindowBuffer](../../topics/misc/NativeWindowBuffer.md) *buffer一个OHNativeWindowBuffer的结构体实例的指针。int fenceFd
...
[Region](../../topics/misc/Region.md) region一个Region结构体，表示一块脏区域，该区域有内容更新。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。[OHNativeWindowBuffer](../../topics/misc/NativeWindowBuffer.md) **buffer一个OHNativeWindowBuffer结构体指针的指针。int *fenceFd一个文件描述符的指针。matrix表示检索到的44变换矩阵。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。[OHNativeWindowBuffer](../../topics/misc/NativeWindowBuffer.md) *buffer一个OHNativeWindowBuffer的结构体实例的指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。int code表示操作码，详见[NativeWindowOperation](#ZH-CN_TOPIC_0000002497606020__nativewindowoperation)。...可变参数，必须与操作码对应的数据类型保持一致，且入参数量严格按照操作码提示传入，否则会存在未定义行为。
...
类型说明[BufferHandle](../../topics/misc/BufferHandle.md)BufferHandle 返回一个指针，指向[BufferHandle](../../topics/misc/BufferHandle.md)的结构体实例。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。uint32_t sequence生产缓冲区的序列。[OHScalingMode](#ZH-CN_TOPIC_0000002497606020__ohscalingmode) scalingMode枚举值OHScalingMode。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。uint32_t sequence生产缓冲区的序列。int32_t sizeOHHDRMetaData数组的大小。metaData指向OHHDRMetaData数组的指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。uint32_t sequence生产缓冲区的序列。[OHHDRMetadataKey](#ZH-CN_TOPIC_0000002497606020__ohhdrmetadatakey) key枚举值OHHDRMetadataKey。int32_t sizeuint8_t向量的大小。metaDate指向uint8_t向量的指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。const [OHExtDataHandle](../../topics/misc/OHExtDataHandle.md) *handle指向OHExtDataHandle的指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个OHNativeWindow的结构体实例的指针。uint64_t *surfaceId一个surface对应ID的指针。
...
参数项描述uint64_t surfaceId一个surface对应的ID。[OHNativeWindow](../../topics/misc/NativeWindow.md) **window一个OHNativeWindow的结构体实例的二级指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md)* window一个OHNativeWindow的结构体实例的指针。[OHScalingModeV2](#ZH-CN_TOPIC_0000002497606020__ohscalingmodev2) scalingMode一个OHScalingModeV2类型的枚举值。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个[OHNativeWindow](../../topics/misc/NativeWindow.md)的结构体实例的指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个指向[OHNativeWindow](../../topics/misc/NativeWindow.md)的结构体实例的指针。[OHIPCParcel](../../topics/components/OHIPCParcel.md) *parcel一个指向[OHIPCParcel](../../topics/components/OHIPCParcel.md)的结构体实例的指针。
...
参数项描述[OHIPCParcel](../../topics/components/OHIPCParcel.md) *parcel一个指向[OHIPCParcel](../../topics/components/OHIPCParcel.md)的结构体实例的指针。[OHNativeWindow](../../topics/misc/NativeWindow.md) **window一个指向[OHNativeWindow](../../topics/misc/NativeWindow.md)的结构体实例的二级指针。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个指向[OHNativeWindow](../../topics/misc/NativeWindow.md)的结构体实例的指针。[OH_NativeBuffer_ColorSpace](buffer_common.h.md#ZH-CN_TOPIC_0000002529285985__oh_nativebuffer_colorspace) colorSpace为OHNativeWindow设置的颜色空间，其值从[OH_NativeBuffer_ColorSpace](buffer_common.h.md#ZH-CN_TOPIC_0000002529285985__oh_nativebuffer_colorspace)获取。
...
参数项描述[OHNativeWindow](../../topics/misc/NativeWindow.md) *window一个指向[OHNativeWindow](../../topics/misc/NativeWindow.md)的结构体实例的指针。
