...
名称描述[OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md)张量数组结构体，用于存储张量数组指针和张量数组长度。[OH_AI_ShapeInfo](../../topics/graphics/OH_AI_ShapeInfo.md)形状维度大小，预留最大维度是32，当前实际支持的最大维度是8。[OH_AI_CallBackParam](../../topics/media/OH_AI_CallBackParam.md)回调函数中传入的算子信息。[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md)指向模型对象的指针。[OH_AI_TrainCfgHandle](../../topics/misc/OH_AI_TrainCfgHandle.md)指向训练配置对象的指针。
...
从内存缓冲区加载并编译MindSpore Lite模型。
 ...
 注意，同一个[OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md)对象仅能传递给[OH_AI_ModelBuild](model.h.md#ZH-CN_TOPIC_0000002529286129__oh_ai_modelbuild)或者[OH_AI_ModelBuildFromFile](model.h.md#ZH-CN_TOPIC_0000002529286129__oh_ai_modelbuildfromfile)一次，如果多次调用该函数需要创建多个不同的[OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md)。
...
参数项描述const [OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md) inputs模型输入对应的张量数组结构体。const [OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md) outputs模型输出对应的张量数组结构体。const [OH_AI_CallBackParam](../../topics/media/OH_AI_CallBackParam.md) kernel_Info当前算子的信息。
...
类型说明OH_AI_API [OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md)模型对象指针。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) *model模型对象指针。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。const void *model_data内存中已经加载的模型数据地址。size_t data_size模型数据的长度。[OH_AI_ModelType](types.h.md#ZH-CN_TOPIC_0000002497446160__oh_ai_modeltype) model_type模型文件类型，具体见[OH_AI_ModelType](types.h.md#ZH-CN_TOPIC_0000002497446160__oh_ai_modeltype)。const [OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md) model_context模型运行时的上下文环境，具体见 [OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md)。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。const char *model_path模型文件路径。字符串长度限制跟随文件系统。[OH_AI_ModelType](types.h.md#ZH-CN_TOPIC_0000002497446160__oh_ai_modeltype) model_type模型文件类型，具体见[OH_AI_ModelType](types.h.md#ZH-CN_TOPIC_0000002497446160__oh_ai_modeltype)。const [OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md) model_context模型运行时的上下文环境，具体见 [OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md)。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。[const OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md) inputs模型输入对应的张量数组结构体。[OH_AI_ShapeInfo](../../topics/graphics/OH_AI_ShapeInfo.md) *shape_infos输入形状信息数组，按模型输入顺序排列的由形状信息组成的数组，模型会按顺序依次调整张量形状。size_t shape_info_num形状信息数组的长度。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。[const OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md) inputs模型输入对应的张量数组结构体。[OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md) *outputs模型输出对应的张量数组结构体的指针。[const OH_AI_KernelCallBack](model.h.md#ZH-CN_TOPIC_0000002529286129__oh_ai_kernelcallback) before模型推理前执行的回调函数。[const OH_AI_KernelCallBack](model.h.md#ZH-CN_TOPIC_0000002529286129__oh_ai_kernelcallback) after模型推理后执行的回调函数。
...
参数项描述const [OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。

**返回：**

类型说明OH_AI_API [OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md)模型输入对应的张量数组结构体。
...
类型说明OH_AI_API [OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md)模型输出对应的张量数组结构体。
...
参数项描述const [OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。const char *tensor_name张量名称。字符串长度跟随系统限制。

**返回：**

类型说明OH_AI_API [OH_AI_TensorHandle](../../topics/misc/OH_AI_TensorHandle.md)tensor_name所对应的输入张量的张量指针，如果输入中没有该张量则返回空。
...
类型说明OH_AI_API [OH_AI_TensorHandle](../../topics/misc/OH_AI_TensorHandle.md)tensor_name所对应的输入张量的张量指针，如果输出中没有该张量则返回空。
...
类型说明OH_AI_API [OH_AI_TrainCfgHandle](../../topics/misc/OH_AI_TrainCfgHandle.md)训练配置对象指针。
...
参数项描述[OH_AI_TrainCfgHandle](../../topics/misc/OH_AI_TrainCfgHandle.md) *train_cfg训练配置对象指针。
...
参数项描述[OH_AI_TrainCfgHandle](../../topics/misc/OH_AI_TrainCfgHandle.md) train_cfg训练配置对象指针。size_t *num损失函数数量。
...
参数项描述[OH_AI_TrainCfgHandle](../../topics/misc/OH_AI_TrainCfgHandle.md) train_cfg训练配置对象指针。const char **loss_name损失函数的名称列表。size_t num损失函数数量。
...
参数项描述[OH_AI_TrainCfgHandle](../../topics/misc/OH_AI_TrainCfgHandle.md) train_cfg训练配置对象指针。[OH_AI_OptimizationLevel](types.h.md#ZH-CN_TOPIC_0000002497446160__oh_ai_optimizationlevel) level优化等级。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。const void *model_data指向存储读入模型文件缓冲区的指针。size_t data_size缓冲区大小。[OH_AI_ModelType](types.h.md#ZH-CN_TOPIC_0000002497446160__oh_ai_modeltype) model_type模型文件类型，具体见[OH_AI_ModelType](types.h.md#ZH-CN_TOPIC_0000002497446160__oh_ai_modeltype)。const [OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md) model_context模型运行时的上下文环境，具体见 [OH_AI_ContextHandle](../../topics/graphics/OH_AI_ContextHandle.md)。const [OH_AI_TrainCfgHandle](../../topics/misc/OH_AI_TrainCfgHandle.md) train_cfg训练配置对象指针。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。[const OH_AI_KernelCallBack](model.h.md#ZH-CN_TOPIC_0000002529286129__oh_ai_kernelcallback) before模型推理前执行的回调函数。[const OH_AI_KernelCallBack](model.h.md#ZH-CN_TOPIC_0000002529286129__oh_ai_kernelcallback) after模型推理后执行的回调函数。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。float learning_rate学习率。
...
类型说明OH_AI_API [OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md)模型的所有权重Tensor。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。[const OH_AI_TensorHandleArray](../../topics/media/OH_AI_TensorHandleArray.md) new_weights要更新的权重Tensor。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。bool train是否为训练模式。true表示是训练模式，false表示不是训练模式。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。int virtual_batch_multiplier虚拟batch乘法器，当设置值小于1时，表示禁用虚拟batch。长度跟随系统限制。float lr学习率，默认为-1.0f。float momentum动量，默认为-1.0f。
...
参数项描述[OH_AI_ModelHandle](../../topics/misc/OH_AI_ModelHandle.md) model模型对象指针。const char *config_path配置文件路径。字符串长度限制跟随文件系统。
