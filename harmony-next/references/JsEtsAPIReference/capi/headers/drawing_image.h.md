...
类型说明[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)*函数返回一个指针，指针指向创建的图片对象[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)。
...
参数项描述[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)* image指向图片对象[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)的指针。
...
参数项描述[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)* image指向图片对象[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)的指针。[OH_Drawing_Bitmap](../../topics/graphics/OH_Drawing_Bitmap.md)* bitmap指向位图对象[OH_Drawing_Bitmap](../../topics/graphics/OH_Drawing_Bitmap.md)的指针。
...
参数项描述[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)* image指向图片对象[OH_Drawing_Image](../../topics/graphics/OH_Drawing_Image.md)的指针。[OH_Drawing_Image_Info](../../topics/graphics/OH_Drawing_Image_Info.md)* imageInfo指向图片信息对象[OH_Drawing_Image_Info](../../topics/graphics/OH_Drawing_Image_Info.md)的指针，开发者可调用[OH_Drawing_Image_Info](../../topics/graphics/OH_Drawing_Image_Info.md)创建。