...
**相关模块：**[CryptoSymCipherApi](../../topics/networking/CryptoSymCipherApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoSymCipher](../../topics/misc/OH_CryptoSymCipher.md)OH_CryptoSymCipher定义对称加解密结构体。[OH_CryptoSymCipherParams](../../topics/media/OH_CryptoSymCipherParams.md)OH_CryptoSymCipherParams定义对称加解密参数结构体。
...
参数项描述[OH_CryptoSymCipherParams](../../topics/media/OH_CryptoSymCipherParams.md) **params指向对称加解密参数实例的指针。
...
参数项描述[OH_CryptoSymCipherParams](../../topics/media/OH_CryptoSymCipherParams.md) *params指向对称密钥加解密参数实例。[CryptoSymCipher_ParamsType](#ZH-CN_TOPIC_0000002497445382__cryptosymcipher_paramstype) paramsType设置对称密钥加解密参数类型。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *value设置的参数值。
...
参数项描述[OH_CryptoSymCipherParams](../../topics/media/OH_CryptoSymCipherParams.md) *params指向对称密钥加解密参数实例。
...
[OH_CryptoSymCipher](../../topics/misc/OH_CryptoSymCipher.md) **ctx指向对称密钥加密实例的指针。
...
参数项描述[OH_CryptoSymCipher](../../topics/misc/OH_CryptoSymCipher.md) *ctx对称密钥加密实例。[Crypto_CipherMode](crypto_common.h.md#ZH-CN_TOPIC_0000002529285349__crypto_ciphermode) mod加解密模式。[OH_CryptoSymKey](../../topics/misc/OH_CryptoSymKey.md) *key对称密钥。[OH_CryptoSymCipherParams](../../topics/media/OH_CryptoSymCipherParams.md) *params指向对称密钥参数实例。
...
参数项描述[OH_CryptoSymCipher](../../topics/misc/OH_CryptoSymCipher.md) *ctx指向对称密钥加解密实例。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *in加密或者解密的数据。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *out更新的结果。
...
参数项描述[OH_CryptoSymCipher](../../topics/misc/OH_CryptoSymCipher.md) *ctx对称密钥加密实例。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *in要加密或解密的数据。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *out返回剩余数据的加/解密结果。
...
参数项描述[OH_CryptoSymCipher](../../topics/misc/OH_CryptoSymCipher.md) *ctx指向对称密钥加解密实例。
