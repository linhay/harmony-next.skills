...
**相关模块：**[CryptoKeyAgreementApi](../../topics/networking/CryptoKeyAgreementApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoKeyAgreement](../../topics/misc/OH_CryptoKeyAgreement.md)OH_CryptoKeyAgreement定义密钥协商结构。
...
[OH_CryptoKeyAgreement](../../topics/misc/OH_CryptoKeyAgreement.md) **ctx密钥协商实例。
...
参数项描述[OH_CryptoKeyAgreement](../../topics/misc/OH_CryptoKeyAgreement.md) *ctx密钥协商实例。[OH_CryptoPrivKey](../../topics/misc/OH_CryptoPrivKey.md) *privkey私钥。[OH_CryptoPubKey](../../topics/misc/OH_CryptoPubKey.md) *pubkey公钥。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *secret秘密值。
...
参数项描述[OH_CryptoKeyAgreement](../../topics/misc/OH_CryptoKeyAgreement.md) *ctx密钥协商实例。