...
参数项描述[RawDir](../../topics/misc/RawDir.md) *rawDir表示指向[RawDir](../../topics/misc/RawDir.md)的指针。int index表示文件在[RawDir](../../topics/misc/RawDir.md)中的索引位置。
...
获取[RawDir](../../topics/misc/RawDir.md)中的rawfile数量。通过此方法可以获取[OH_ResourceManager_GetRawFileName](raw_dir.h.md#ZH-CN_TOPIC_0000002529285315__oh_resourcemanager_getrawfilename)中可用的索引。

**起始版本：** 8

**参数：**

参数项描述[RawDir](../../topics/misc/RawDir.md) *rawDir表示指向[RawDir](../../topics/misc/RawDir.md)的指针。
