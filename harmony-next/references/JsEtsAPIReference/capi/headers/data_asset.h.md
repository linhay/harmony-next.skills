...
名称typedef关键字描述[Data_Asset](../../topics/misc/Data_Asset.md)Data_Asset
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。const char *name表示要设置的名称。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。const char *uri表示要设置的URI。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。const char *path表示要设置的相对路径。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。int64_t createTime表示要设置的创建时间。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。int64_t modifyTime表示要设置的最后修改的时间。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。size_t size表示要设置的占用空间的大小。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。[Data_AssetStatus](#ZH-CN_TOPIC_0000002497604700__data_assetstatus) status表示需要设置的状态码。详细信息可以查看[Data_AssetStatus](data_asset.h.md#ZH-CN_TOPIC_0000002497604700__data_assetstatus)。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。char *name该参数是输出参数，资产类型数据的名称会以字符串形式写入该变量。size_t *length表示name的长度。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。char *uri参数是输出参数，资产类型数据的绝对路径会以字符串形式写入该变量。size_t *length表示uri的长度。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。char *path参数是输出参数，资产类型数据的相对路径会以字符串形式写入该变量。size_t *length表示path的长度。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。int64_t *createTime参数是输出参数，资产类型数据的创建时间会以int64_t形式写入该变量。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。int64_t *modifyTime参数是输出参数，资产类型数据的最后修改时间会以int64_t形式写入该变量。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。size_t *size参数是输出参数，资产类型数据的占用空间大小会以size_t形式写入该变量。
...
参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。[Data_AssetStatus](#ZH-CN_TOPIC_0000002497604700__data_assetstatus) *status参数是输出参数，资产类型数据的状态码会以[Data_AssetStatus](data_asset.h.md#ZH-CN_TOPIC_0000002497604700__data_assetstatus)形式写入该变量。
...
创建一个[Data_Asset](../../topics/misc/Data_Asset.md)类型实例。

**起始版本：** 11

**返回：**

类型说明[Data_Asset](../../topics/misc/Data_Asset.md)创建成功则返回一个指向[Data_Asset](../../topics/misc/Data_Asset.md)结构体实例的指针，否则返回NULL。
...
销毁[Data_Asset](../../topics/misc/Data_Asset.md) 对象并回收该对象占用的内存。

**起始版本：** 11

**参数：**

参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) *asset表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。
...
创建指定数量的[Data_Asset](../../topics/misc/Data_Asset.md)类型实例。
...
销毁多个[Data_Asset](../../topics/misc/Data_Asset.md) 对象并回收该对象占用的内存。

**起始版本：** 11

**参数：**

参数项描述[Data_Asset](../../topics/misc/Data_Asset.md) **assets表示指向[Data_Asset](../../topics/misc/Data_Asset.md)实例的指针。uint32_t count代表需要销毁的[Data_Asset](../../topics/misc/Data_Asset.md)类型对象的数量。
