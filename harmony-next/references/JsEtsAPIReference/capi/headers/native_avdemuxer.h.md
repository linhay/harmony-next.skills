...
**相关模块：**[AVDemuxer](../../topics/media/AVDemuxer.md)
...
名称typedef关键字描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md)OH_AVDemuxer为OH_AVDemuxer接口定义native层对象。[DRM_MediaKeySystemInfo](../../topics/system-services/DRM_MediaKeySystemInfo.md)DRM_MediaKeySystemInfo为DRM_MediaKeySystemInf接口定义native层对象。
...
通过source实例创建OH_AVDemuxer实例。
 ...
 source的创建、销毁及使用，详情请参考[OH_AVSource](../../topics/misc/AVSource.md)。
...
类型说明[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。uint32_t trackIndex需选择的轨道的索引。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。uint32_t trackIndex需取消选择的轨道的索引。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。uint32_t trackIndex本次读取压缩帧的轨道的索引。[OH_AVMemory](../../topics/misc/OH_AVMemory.md) *sample指向OH_AVMemory实例的指针，用于储存压缩帧数据。[OH_AVCodecBufferAttr](../../topics/misc/OH_AVCodecBufferAttr.md) *info指向OH_AVCodecBufferAttr实例的指针，用于储存压缩帧的相关信息。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。uint32_t trackIndex本次读取压缩帧的轨道的索引。.OH_AVBuffer *sample指向OH_AVBuffer实例的指针，用于储存压缩帧数据以及相关信息。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。int64_t millisecond期望跳转位置对应的时间，单位为毫秒，该时间戳是相对文件开始的位置。[OH_AVSeekMode](native_avcodec_base.h.md#ZH-CN_TOPIC_0000002529445703__oh_avseekmode) mode跳转的模式。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。[DRM_MediaKeySystemInfoCallback](#ZH-CN_TOPIC_0000002497445764__drm_mediakeysysteminfocallback) callback回调函数。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。[Demuxer_MediaKeySystemInfoCallback](#ZH-CN_TOPIC_0000002497445764__demuxer_mediakeysysteminfocallback) callback回调函数。
...
参数项描述[OH_AVDemuxer](../../topics/media/OH_AVDemuxer.md) *demuxer指向OH_AVDemuxer实例的指针。[DRM_MediaKeySystemInfo](../../topics/system-services/DRM_MediaKeySystemInfo.md) *mediaKeySystemInfo指向DRM信息的指针。
