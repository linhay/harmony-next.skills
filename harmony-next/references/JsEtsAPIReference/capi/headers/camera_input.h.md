...
在[CameraInput_Callbacks](../../topics/input/CameraInput_Callbacks.md)中被调用的相机输入错误回调。

**起始版本：** 11

**参数：**

参数项描述const [Camera_Input](../../topics/input/Camera_Input.md)* cameraInput传递回调的Camera_Input。[Camera_ErrorCode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_errorcode) errorCode相机输入的Camera_ErrorCode。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInputCamera_Input实例。[CameraInput_Callbacks](../../topics/input/CameraInput_Callbacks.md)* callback要注册的相机输入更改事件回调。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInputCamera_Input实例。[CameraInput_Callbacks](../../topics/input/CameraInput_Callbacks.md)* callback要注销的相机输入更改事件回调。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInput要打开的Camera_Input实例。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInput要打开的Camera_Input实例。uint64_t* secureSeqId表示安全摄像头的序列值。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInput要打开的Camera_Input实例。[Camera_ConcurrentType](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_concurrenttype) type指定并发类型。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInput要关闭的Camera_Input实例。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInput要释放的Camera_Input实例。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInputCamera_Input实例。bool* isVariable查询设备不同折叠状态下，相机物理镜头角度是否可变。true表示可变，false表示不可变。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInputCamera_Input实例。uint32_t* orientation如果方法调用成功，将返回设备当前折叠状态下的物理镜头角度。
...
参数项描述[Camera_Input](../../topics/input/Camera_Input.md)* cameraInputCamera_Input实例。bool isUsed选择是否使用物理镜头角度。true表示使用，false表示不使用。
