...
名称typedef关键字描述[Hid_EmitItem](../../topics/components/Hid_EmitItem.md)Hid_EmitItem事件信息。[Hid_Device](../../topics/system-services/Hid_Device.md)Hid_Device设备基本信息。[Hid_EventTypeArray](../../topics/media/Hid_EventTypeArray.md)Hid_EventTypeArray事件类型编码数组。[Hid_KeyCodeArray](../../topics/media/Hid_KeyCodeArray.md)Hid_KeyCodeArray键值属性数组。[Hid_AbsAxesArray](../../topics/media/Hid_AbsAxesArray.md)Hid_AbsAxesArray绝对坐标属性数组。[Hid_RelAxesArray](../../topics/media/Hid_RelAxesArray.md)Hid_RelAxesArray相对坐标属性数组。[Hid_MscEventArray](../../topics/media/Hid_MscEventArray.md)Hid_MscEventArray其它特殊事件属性数组。[Hid_EventProperties](../../topics/misc/Hid_EventProperties.md)Hid_EventProperties设备关注事件属性。[Hid_RawDevInfo](../../topics/misc/Hid_RawDevInfo.md)Hid_RawDevInfo原始设备信息定义。[Hid_DeviceHandle](../../topics/system-services/Hid_DeviceHandle.md)Hid_DeviceHandle不透明的USB HID设备结构。
