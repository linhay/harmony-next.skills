...
名称描述[MediaLibrary_ErrorCode OH_MediaAccessHelper_ApplyChanges(OH_MediaAssetChangeRequest* changeRequest)](#ZH-CN_TOPIC_0000002529445925__oh_mediaaccesshelper_applychanges)发起应用资产或相册的更改请求。
...
参数项描述[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)* changeRequest变更请求实例。
