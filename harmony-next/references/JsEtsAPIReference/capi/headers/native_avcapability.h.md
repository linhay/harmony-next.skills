...
**相关模块：**[AVCapability](../../topics/system-services/AVCapability.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_AVRange](../../topics/misc/OH_AVRange.md)OH_AVRange范围包含最小值和最大值。[OH_AVCapability](../../topics/system-services/OH_AVCapability.md)OH_AVCapability为OH_AVCapability接口定义native层对象。
...
类型说明[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *如果现有编解码器匹配，则返回能力实例，如果指定的MIME类型与任何现有编解码器不匹配，则返回NULL。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编解码能力指针。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) *bitrateRange输出参数。编码器码率范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。[OH_BitrateMode](native_avcodec_base.h.md#ZH-CN_TOPIC_0000002529445703__oh_bitratemode) bitrateMode比特率模式。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) *qualityRange输出参数。编码器质量范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) *complexityRange输出参数。编码器复杂度范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability音频编解码能力指针。如果给的是视频编解码器能力指针，会导致未定义行为。const int32_t **sampleRates输出参数。指向采样率数组的指针。uint32_t *sampleRateNum输出参数。采样率数组的元素数目。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability音频编解码能力指针。如果给的是视频编解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) **sampleRateRanges输出参数。指向采样率范围数组的指针。uint32_t *rangesNum输出参数。采样率范围数组的元素数目。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability音频编解码能力指针。如果给的是视频编解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) *channelCountRange输出参数。音频通道计数范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。int32_t *widthAlignment输出参数。视频宽度对齐。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。int32_t *heightAlignment输出参数。视频高度对齐。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。int32_t height视频垂直像素数。[OH_AVRange](../../topics/misc/OH_AVRange.md) *widthRange输出参数。视频宽度范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。int32_t width视频水平像素数。[OH_AVRange](../../topics/misc/OH_AVRange.md) *heightRange输出参数。视频高度范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) *widthRange输出参数。视频宽度范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) *heightRange输出参数。视频高度范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。int32_t width视频水平像素数。int32_t height视频垂直像素数。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。[OH_AVRange](../../topics/misc/OH_AVRange.md) *frameRateRange输出参数。视频帧率范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。int32_t width视频水平像素数。int32_t height视频垂直像素数。[OH_AVRange](../../topics/misc/OH_AVRange.md) *frameRateRange输出参数。视频帧率范围。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。int32_t width视频水平像素数。int32_t height视频垂直像素数。int32_t frameRate每秒帧数。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。const int32_t **pixelFormats输出参数。指向视频像素格式数组的指针。uint32_t *pixelFormatNum输出参数。像素格式数组的元素数目。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability视频编解码能力指针。const [OH_NativeBuffer_Format](buffer_common.h.md#ZH-CN_TOPIC_0000002529285985__oh_nativebuffer_format) **nativeBufferFormats输出参数。指向OH_NativeBuffer_Format数组的指针。uint32_t *nativeBufferFormatNum输出参数。OH_NativeBuffer_Format数组的元素数目。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编解码能力指针。const int32_t **profiles输出参数。指向档次数组的指针。uint32_t *profileNum输出参数。档次数组的元素数目。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编解码能力指针。int32_t profile编解码器档次。const int32_t **levels输出参数。指向级别数组的指针。uint32_t *levelNum输出参数。级别数组的元素数目。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编解码能力指针。int32_t profile编解码器档次。int32_t level编解码器级别。
...
参数项描述[OH_AVCapability](../../topics/system-services/OH_AVCapability.md) *capability编解码能力指针。[OH_AVCapabilityFeature](#ZH-CN_TOPIC_0000002497445758__oh_avcapabilityfeature) feature编解码特性。
...
类型说明[OH_AVFormat](../../topics/misc/OH_AVFormat.md) *返回指向OH_AVFormat实例的指针。