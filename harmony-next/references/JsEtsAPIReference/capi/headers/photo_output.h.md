...
名称typedef关键字描述[PhotoOutput_Callbacks](../../topics/misc/PhotoOutput_Callbacks.md)PhotoOutput_Callbacks拍照输出的回调。[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)Camera_PhotoOutput
...
在[PhotoOutput_Callbacks](../../topics/misc/PhotoOutput_Callbacks.md)中被调用的拍照输出帧启动回调。

**起始版本：** 11

**参数：**

参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。
...
在[PhotoOutput_Callbacks](../../topics/misc/PhotoOutput_Callbacks.md)中被调用的拍照输出帧快门回调。

**起始版本：** 11

**参数：**

参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。[Camera_FrameShutterInfo](../../topics/components/Camera_FrameShutterInfo.md)* info回调传递的帧快门回调信息。
...
在[PhotoOutput_Callbacks](../../topics/misc/PhotoOutput_Callbacks.md)中被调用的拍照输出帧结束回调。

**起始版本：** 11

**参数：**

参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。int32_t frameCount回调传递的帧计数。
...
在[PhotoOutput_Callbacks](../../topics/misc/PhotoOutput_Callbacks.md)中被调用的拍照输出错误回调。

**起始版本：** 11

**参数：**

参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。[Camera_ErrorCode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_errorcode) errorCode拍照输出的错误码。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。int32_t frameCount回调传递的帧数。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。[Camera_CaptureStartInfo](../../topics/networking/Camera_CaptureStartInfo.md)* Info回调传递的拍照开始信息。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。int64_t duration回调传递的预计拍照时间，单位毫秒。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。[OH_PhotoNative](../../topics/misc/OH_PhotoNative.md)* photo回调传递的OH_PhotoNative。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递回调的拍照输出实例。[OH_MediaAsset](../../topics/media/OH_MediaAsset.md)* photoAsset回调传递的媒体资源。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[PhotoOutput_Callbacks](../../topics/misc/PhotoOutput_Callbacks.md)* callback要注册的拍照输出更改事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[PhotoOutput_Callbacks](../../topics/misc/PhotoOutput_Callbacks.md)* callback要注销的拍照输出更改事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_CaptureStartWithInfo](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_capturestartwithinfo) callback要注册的拍照开始事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput用于获取照片旋转角度的拍照输出实例。int deviceDegree当前设备旋转角度。[Camera_ImageRotation](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_imagerotation)* imageRotation照片旋转角度的结果。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_CaptureStartWithInfo](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_capturestartwithinfo) callback要注销的拍照开始事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_CaptureEnd](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_captureend) callback要注册的拍照结束事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_CaptureEnd](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_captureend) callback要注销的拍照结束事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_OnFrameShutterEnd](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_onframeshutterend) callback要注册的拍照曝光结束事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_OnFrameShutterEnd](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_onframeshutterend) callback要注销的拍照曝光结束事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_CaptureReady](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_captureready) callback要注册的拍照就绪事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_CaptureReady](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_captureready) callback要注销的拍照就绪事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_EstimatedCaptureDuration](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_estimatedcaptureduration) callback要注册的预计拍照时间事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_EstimatedCaptureDuration](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_estimatedcaptureduration) callback要注销的预计拍照时间事件回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_PhotoAvailable](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_photoavailable) callback要注册的输出照片可用回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_PhotoAvailable](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_photoavailable) callback要注销的输出照片可用回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_PhotoAssetAvailable](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_photoassetavailable) callback要注册的输出照片资源可用回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例。[OH_PhotoOutput_PhotoAssetAvailable](#ZH-CN_TOPIC_0000002529445765__oh_photooutput_photoassetavailable) callback要注销的输出照片资源可用回调。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput用于捕获拍照的拍照输出实例。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput用于捕获拍照的拍照输出实例。[Camera_PhotoCaptureSetting](../../topics/media/Camera_PhotoCaptureSetting.md) setting用于捕获拍照的[Camera_PhotoCaptureSetting](../../topics/media/Camera_PhotoCaptureSetting.md)。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput要释放的拍照输出实例。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例，用于检查是否支持镜像。bool* isSupported是否支持镜像的结果。true表示支持镜像，false表示不支持。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput拍照输出实例，用于确认是否启用镜像拍照。bool enabled是否启用动态照片镜像拍照的结果，true为开启动态照片镜像拍照，false为关闭动态照片镜像拍照。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput传递当前配置文件的拍照输出实例。[Camera_Profile](../../topics/media/Camera_Profile.md)** profile如果方法调用成功，将记录照片输出配置文件。
...
参数项描述[Camera_Profile](../../topics/media/Camera_Profile.md)* profile要被删除的照片配置文件实例。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput用于检查是否支持动态照片的拍照输出实例。bool* isSupported是否支持动态照片的结果。true表示支持动态照片，false表示不支持。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput用于启用或禁用动态照片的拍照输出实例。bool enabled是否启用动态照片。true表示启用动态照片，false表示不启用。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput用于获取是否支持拍照画质优先策略的拍照输出实例。[Camera_PhotoQualityPrioritization](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_photoqualityprioritization) qualityPrioritization要检查的拍照画质优先策略。bool* isSupported是否支持指定的拍照画质优先策略。true表示支持，false表示不支持。
...
参数项描述[Camera_PhotoOutput](../../topics/media/Camera_PhotoOutput.md)* photoOutput用于设置拍照画质优先策略的拍照输出实例。[Camera_PhotoQualityPrioritization](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_photoqualityprioritization) qualityPrioritization要设置的拍照画质优先策略。
