...
**相关模块：**[OH_CommonEvent](../../topics/misc/OH_CommonEvent.md)

#### 汇总

#### 结构体

名称typedef关键字描述[CommonEvent_SubscribeInfo](../../topics/misc/CommonEvent_SubscribeInfo.md)CommonEvent_SubscribeInfo提供CommonEvent_SubscribeInfo订阅者信息结构体声明。[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)CommonEvent_PublishInfo发布公共事件时使用的公共事件属性对象。[CommonEvent_RcvData](../../topics/misc/CommonEvent_RcvData.md)CommonEvent_RcvData提供CommonEvent_RcvData公共事件回调数据结构体声明。
...
参数项描述const [CommonEvent_RcvData](../../topics/misc/CommonEvent_RcvData.md) *data公共事件回调数据。
...
类型说明[CommonEvent_SubscribeInfo](../../topics/misc/CommonEvent_SubscribeInfo.md)*成功则返回订阅者信息,失败则返回NULL。
...
参数项描述[CommonEvent_SubscribeInfo](../../topics/misc/CommonEvent_SubscribeInfo.md)* info订阅者信息。const char* permission权限名称。
...
参数项描述[CommonEvent_SubscribeInfo](../../topics/misc/CommonEvent_SubscribeInfo.md)* info订阅者信息。const char* bundleName包名称。
...
参数项描述[CommonEvent_SubscribeInfo](../../topics/misc/CommonEvent_SubscribeInfo.md)* info订阅者信息。
...
参数项描述const [CommonEvent_SubscribeInfo](../../topics/misc/CommonEvent_SubscribeInfo.md)* info订阅者信息。[CommonEvent_ReceiveCallback](#ZH-CN_TOPIC_0000002529445495__commonevent_receivecallback) callback公共事件回调函数
...
参数项描述const [CommonEvent_RcvData](../../topics/misc/CommonEvent_RcvData.md)* rcvData公共事件回调数据。
...
类型说明[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)*创建的公共事件属性对象，创建失败时，返回null。
...
参数项描述[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)* info要销毁的公共事件属性对象。
...
参数项描述[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)* info公共事件属性对象。const char* bundleName设置的订阅者包名称。
...
参数项描述[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)* info公共事件属性对象。const char* permissions[]订阅者权限名称数组，生效数量为num与permissions数组长度的最小值。int32_t num权限的数量。
...
参数项描述[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)* info公共事件属性对象。int32_t code公共事件传递的数据，整数类型。
...
参数项描述[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)* info公共事件属性对象。const char* data公共事件传递的数据，字符串类型，实际有效数据长度为length和data字符串长度的最小值。size_t length结果数据的长度。
...
参数项描述[CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)* info公共事件属性对象。CommonEvent_Parameters* param设置的附加信息。
...
参数项描述const char* event公共事件名称。const [CommonEvent_PublishInfo](../../topics/misc/CommonEvent_PublishInfo.md)* info设置的公共事件属性。
