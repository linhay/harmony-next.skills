...
名称typedef关键字描述[OH_Rdb_Config](../../topics/misc/OH_Rdb_Config.md)-管理关系数据库配置。[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)OH_Rdb_Store表示数据库类型。[Rdb_DistributedConfig](../../topics/misc/Rdb_DistributedConfig.md)Rdb_DistributedConfig记录表的分布式配置信息。[Rdb_KeyInfo](../../topics/misc/Rdb_KeyInfo.md)Rdb_KeyInfo描述发生变化的行的主键或者行号。[Rdb_KeyData](../../topics/misc/Rdb_KeyData.md)-存放变化的具体数据。[Rdb_ChangeInfo](../../topics/misc/Rdb_ChangeInfo.md)Rdb_ChangeInfo记录端云同步过程详情。[Rdb_SubscribeCallback](../../topics/misc/Rdb_SubscribeCallback.md)Rdb_SubscribeCallback表示回调函数。[Rdb_DataObserver](../../topics/misc/Rdb_DataObserver.md)Rdb_DataObserver表示数据观察者。[Rdb_Statistic](../../topics/misc/Rdb_Statistic.md)Rdb_Statistic描述数据库表的端云同步过程的统计信息。[Rdb_TableDetails](../../topics/components/Rdb_TableDetails.md)Rdb_TableDetails描述数据库表执行端云同步任务上传和下载的统计信息。[Rdb_ProgressDetails](../../topics/components/Rdb_ProgressDetails.md)Rdb_ProgressDetails描述数据库整体执行端云同步任务上传和下载的统计信息。[Rdb_ProgressObserver](../../topics/components/Rdb_ProgressObserver.md)Rdb_ProgressObserver端云同步进度观察者。[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)OH_Rdb_ConfigV2管理关系数据库配置，与[OH_Rdb_Config](../../topics/misc/OH_Rdb_Config.md)的区别是该结构体成员变量不对外暴露，使用一系列方法配置该结构体的属性，支持向量数据库。
...
名称typedef关键字描述[OH_Rdb_ConfigV2 *OH_Rdb_CreateConfig()](#ZH-CN_TOPIC_0000002529444671__oh_rdb_createconfig)-创建一个[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)实例，并返回指向该实例的指针。[int OH_Rdb_DestroyConfig(OH_Rdb_ConfigV2 *config)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_destroyconfig)-销毁由[OH_Rdb_CreateConfig](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__oh_rdb_createconfig)创建的[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象。[int OH_Rdb_SetDatabaseDir(OH_Rdb_ConfigV2 *config, const char *databaseDir)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setdatabasedir)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库文件路径。[int OH_Rdb_SetStoreName(OH_Rdb_ConfigV2 *config, const char *storeName)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setstorename)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库名称。[int OH_Rdb_SetBundleName(OH_Rdb_ConfigV2 *config, const char *bundleName)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setbundlename)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置应用包名。[int OH_Rdb_SetModuleName(OH_Rdb_ConfigV2 *config, const char *moduleName)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setmodulename)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置应用模块名。[int OH_Rdb_SetEncrypted(OH_Rdb_ConfigV2 *config, bool isEncrypted)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setencrypted)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库是否加密。[int OH_Rdb_SetSecurityLevel(OH_Rdb_ConfigV2 *config, int securityLevel)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setsecuritylevel)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库安全级别[OH_Rdb_SecurityLevel](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__oh_rdb_securitylevel)。[int OH_Rdb_SetArea(OH_Rdb_ConfigV2 *config, int area)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setarea)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库安全区域等级[Rdb_SecurityArea](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_securityarea)。[int OH_Rdb_SetDbType(OH_Rdb_ConfigV2 *config, int dbType)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setdbtype)-给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库类型[Rdb_DBType](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_dbtype)。[int OH_Rdb_SetCustomDir(OH_Rdb_ConfigV2 *config, const char *customDir)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setcustomdir)-设置数据库的自定义目录。[int OH_Rdb_SetReadOnly(OH_Rdb_ConfigV2 *config, bool readOnly)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setreadonly)-设置关系型数据库是否为只读模式。[int OH_Rdb_SetPlugins(OH_Rdb_ConfigV2 *config, const char **plugins, int32_t length)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setplugins)-设置具有特定功能（如全文检索）的动态库。[int OH_Rdb_SetCryptoParam(OH_Rdb_ConfigV2 *config, const OH_Rdb_CryptoParam *cryptoParam)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setcryptoparam)-设置自定义加密参数。[int OH_Rdb_IsTokenizerSupported(Rdb_Tokenizer tokenizer, bool *isSupported)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_istokenizersupported)-判断当前平台是否支持传入的分词器。[int OH_Rdb_SetTokenizer(OH_Rdb_ConfigV2 *config, Rdb_Tokenizer tokenizer)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_settokenizer)-给指定的数据库文件配置设置分词器类型。[int OH_Rdb_SetPersistent(OH_Rdb_ConfigV2 *config, bool isPersistent)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_setpersistent)-指定数据库是否需要持久化。[const int *OH_Rdb_GetSupportedDbType(int *typeCount)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_getsupporteddbtype)-获得支持的数据库类型[Rdb_DBType](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_dbtype)。[OH_VObject *OH_Rdb_CreateValueObject()](#ZH-CN_TOPIC_0000002529444671__oh_rdb_createvalueobject)-创建[OH_VObject](../../topics/misc/OH_VObject.md)实例。[OH_VBucket *OH_Rdb_CreateValuesBucket()](#ZH-CN_TOPIC_0000002529444671__oh_rdb_createvaluesbucket)-创建[OH_VBucket](../../topics/misc/OH_VBucket.md)实例。[OH_Predicates *OH_Rdb_CreatePredicates(const char *table)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_createpredicates)-创建[OH_Predicates](../../topics/misc/OH_Predicates.md)实例。[OH_Rdb_Store *OH_Rdb_GetOrOpen(const OH_Rdb_Config *config, int *errCode)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_getoropen)-获得一个相关的[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例，操作关系型数据库。[OH_Rdb_Store *OH_Rdb_CreateOrOpen(const OH_Rdb_ConfigV2 *config, int *errCode)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_createoropen)-使用指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，获得一个对应的[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例，用来操作关系型数据库。[int OH_Rdb_CloseStore(OH_Rdb_Store *store)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_closestore)-销毁[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)对象，并回收该对象占用的内存。[int OH_Rdb_DeleteStore(const OH_Rdb_Config *config)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_deletestore)-使用指定的数据库文件配置删除数据库。[int OH_Rdb_DeleteStoreV2(const OH_Rdb_ConfigV2 *config)](#ZH-CN_TOPIC_0000002529444671__oh_rdb_deletestorev2)-

使用指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)删除数据库。
...
参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)实例的指针。bool enableSemanticIndex
...
创建一个[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)实例，并返回指向该实例的指针。

**起始版本：** 14

**返回：**

类型说明[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)返回一个指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)实例的指针。
...
销毁由[OH_Rdb_CreateConfig](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__oh_rdb_createconfig)创建的[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库文件路径。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。const char *dataBaseDir表示数据库文件路径。包含数据库名称在内的全路径长度不超过1024个字符。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库名称。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。const char *storeName表示数据库名称。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置应用包名。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。const char *bundleName表示数据库应用包名。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置应用模块名。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。const char *moduleName表示数据库应用模块名。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库是否加密。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。bool isEncrypted表示数据库是否加密。true表示加密，false表示不加密。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库安全级别[OH_Rdb_SecurityLevel](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__oh_rdb_securitylevel)。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。int securityLevel表示数据库安全级别[OH_Rdb_SecurityLevel](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__oh_rdb_securitylevel)。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库安全区域等级[Rdb_SecurityArea](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_securityarea)。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。int area表示数据库安全区域等级[Rdb_SecurityArea](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_securityarea)。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，设置数据库类型[Rdb_DBType](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_dbtype)。

**起始版本：** 14

**参数：**

参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。int dbType表示数据库的数据库类型[Rdb_DBType](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_dbtype)。
...
参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示此关系型数据库相关的数据库配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)的指针。const char *customDir表示数据库的自定义目录，目录长度不能超过128字节。
...
参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示此关系型数据库相关的数据库配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)的指针。bool readOnly表示关系型数据库存储是否为只读模式，true表示设置为只读模式，false表示设置为读写模式。
...
参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示此关系型数据库相关的数据库配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)的指针。const char **plugins表示动态库的名称数组。int32_t length表示插件数组的大小，最大值为16。
...
参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示此关系型数据库相关的数据库配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)的指针。const [OH_Rdb_CryptoParam](../../topics/media/OH_Rdb_CryptoParam.md) *cryptoParam表示自定义加密参数。
...
参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向此RDB存储相关的数据库配置的指针。[Rdb_Tokenizer](#ZH-CN_TOPIC_0000002529444671__rdb_tokenizer) tokenizer表示数据库的分词器类型。
...
参数项描述[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config

表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)实例的指针。
...
创建[OH_VObject](../../topics/misc/OH_VObject.md)实例。

**起始版本：** 10

**返回：**

类型说明[OH_VObject](../../topics/misc/OH_VObject.md)创建成功则返回一个指向[OH_VObject](../../topics/misc/OH_VObject.md)结构体实例的指针，否则返回NULL。
...
创建[OH_VBucket](../../topics/misc/OH_VBucket.md)实例。

**起始版本：** 10

**返回：**

类型说明[OH_VBucket](../../topics/misc/OH_VBucket.md)创建成功则返回一个指向[OH_VBucket](../../topics/misc/OH_VBucket.md)结构体实例的指针，否则返回NULL。
...
创建[OH_Predicates](../../topics/misc/OH_Predicates.md)实例。
...
类型说明[OH_Predicates](../../topics/misc/OH_Predicates.md)创建成功则返回一个指向[OH_Predicates](../../topics/misc/OH_Predicates.md)结构体实例的指针，否则返回NULL。
...
获得一个相关的[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例，操作关系型数据库。

**起始版本：** 10

**参数：**

参数项描述const [OH_Rdb_Config](../../topics/misc/OH_Rdb_Config.md) *config表示指向[OH_Rdb_Config](../../topics/misc/OH_Rdb_Config.md)实例的指针，与此RDB存储相关的数据库配置。int *errCode表示函数执行状态, 作为出参使用。

**返回：**

类型说明[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)

创建成功则返回一个指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)结构体实例的指针，否则返回NULL。
...
使用指定的数据库文件配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)，获得一个对应的[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例，用来操作关系型数据库。

**起始版本：** 14

**参数：**

参数项描述const [OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。int *errCode表示函数执行状态，作为出参使用。
...
销毁[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)对象，并回收该对象占用的内存。

**起始版本：** 10

**参数：**

参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。
...
参数项描述const [OH_Rdb_Config](../../topics/misc/OH_Rdb_Config.md) *config表示数据库的配置。
...
参数项描述const [OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示数据库的配置。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *table表示指定的目标表名。[OH_VBucket](../../topics/misc/OH_VBucket.md) *valuesBucket表示要插入到表中的数据行[OH_VBucket](../../topics/misc/OH_VBucket.md)。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *table表示目标表的名称。[OH_VBucket](../../topics/misc/OH_VBucket.md) *row表示要插入到表中的数据。[Rdb_ConflictResolution](oh_rdb_types.h.md#ZH-CN_TOPIC_0000002497604704__rdb_conflictresolution) resolution表示发生冲突时的解决策略。int64_t *rowId表示插入成功后返回的行号。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *tables要设置的分布式数据库表表名。const [OH_Data_VBuckets *rows](../../topics/misc/OH_Data_VBuckets.md)表示要插入到表中的一组数据。[Rdb_ConflictResolution](oh_rdb_types.h.md#ZH-CN_TOPIC_0000002497604704__rdb_conflictresolution) resolution表示发生冲突时的解决策略。int64_t *changes输出参数，表示插入成功的次数。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[OH_VBucket](../../topics/misc/OH_VBucket.md) *valuesBucket表示要更新到表中的数据行[OH_VBucket](../../topics/misc/OH_VBucket.md)。[OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示指向[OH_Predicates](../../topics/misc/OH_Predicates.md)实例的指针，指定更新条件。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[OH_VBucket](../../topics/misc/OH_VBucket.md) *row表示要更新到表中的数据行。[OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示指向[OH_Predicates](../../topics/misc/OH_Predicates.md)实例的指针，指定更新条件。[Rdb_ConflictResolution](oh_rdb_types.h.md#ZH-CN_TOPIC_0000002497604704__rdb_conflictresolution) resolution表示发生冲突时的解决策略。int64_t *changes输出参数，表示成功更新的行数。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示指向[OH_Predicates](../../topics/misc/OH_Predicates.md)实例的指针，指定删除条件。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示指向[OH_Predicates](../../topics/misc/OH_Predicates.md)实例的指针，指定查询条件。const char *const *columnNames表示要查询的列。如果值为空，则查询应用于所有列。int length该参数为输入参数，表示开发者传入的columnNames数组的长度。若length大于columnNames数组的实际长度，则会访问越界。

**返回：**

类型说明[OH_Cursor](../../topics/input/OH_Cursor.md) *如果查询成功则返回一个指向[OH_Cursor](../../topics/input/OH_Cursor.md)结构体实例的指针，否则返回NULL。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *sql指定要执行的SQL语句。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *sql指定要执行的SQL语句。const [OH_Data_Values](../../topics/misc/OH_Data_Values.md) *args可选参数，表示指向[OH_Data_Values](../../topics/misc/OH_Data_Values.md)实例的指针。[OH_Data_Value](../../topics/misc/OH_Data_Value.md) **result执行成功时指向[OH_Data_Value](../../topics/misc/OH_Data_Value.md)实例的指针，作为出参使用。使用完成后，必须通过[OH_Value_Destroy](oh_data_value.h.md#ZH-CN_TOPIC_0000002529284693__oh_value_destroy)接口释放内存。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示一个指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) 实例的指针。int64_t trxId调用[OH_Rdb_BeginTransWithTrxId](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__oh_rdb_begintranswithtrxid)获得的事务ID，当设置为0时，表示不启用事务。const char *sql指定要执行的SQL语句。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *sql指定要执行的SQL语句。const OH_Data_Values *args可选参数，表示指向[OH_Data_Values](../../topics/misc/OH_Data_Values.md)实例的指针。

**返回：**

类型说明[OH_Cursor](../../topics/input/OH_Cursor.md) *

如果查询成功则返回一个指向[OH_Cursor](../../topics/input/OH_Cursor.md)结构体实例的指针，使用完成后及时释放[OH_Cursor](../../topics/input/OH_Cursor.md)。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示一个指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。int64_t *trxId事务ID，作为出参使用。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示一个指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。int64_t trxId表示需要回滚的事务的ID。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示一个指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。int64_t trxId表示需要提交的事务的ID。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *databasePath指定数据库的备份文件路径。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。int *version表示版本号，作为出参使用。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。int version表示版本号。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *tables[]要设置的分布式数据库表表名。uint32_t count要设置的分布式数据库表的数量。[Rdb_DistributedType](#ZH-CN_TOPIC_0000002529444671__rdb_distributedtype) type表的分布式类型[Rdb_DistributedType](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_distributedtype)。const [Rdb_DistributedConfig](../../topics/misc/Rdb_DistributedConfig.md) *config表的分布式配置信息[Rdb_DistributedConfig](../../topics/misc/Rdb_DistributedConfig.md)。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *tableName要查找的分布式数据库表表名。const char *columnName指定要查询的数据库表的列名。[OH_VObject](../../topics/misc/OH_VObject.md) *values指定要查询的行的主键。如果数据库表无主键，参数columnName需传入"rowid"，此时values为要查询的数据库表的行号。

**返回：**

类型说明[OH_Cursor](../../topics/input/OH_Cursor.md)如果操作成功则返回一个指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)结构体实例的指针，否则返回NULL。
...
参数项描述void *context表示数据观察者的上下文。const [Rdb_ChangeInfo](../../topics/misc/Rdb_ChangeInfo.md) **changeInfo表示已更改表的信息[Rdb_ChangeInfo](../../topics/misc/Rdb_ChangeInfo.md)。uint32_t count表示更改的表的数量。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[Rdb_SubscribeType](#ZH-CN_TOPIC_0000002529444671__rdb_subscribetype) type表示在[Rdb_SubscribeType](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_subscribetype)中定义的订阅类型。如果其值为RDB_SUBSCRIBE_TYPE_LOCAL_DETAILS，则在本地数据库中的数据更改时调用回调。const [Rdb_DataObserver](../../topics/misc/Rdb_DataObserver.md) *observer数据库中更改事件的观察者[Rdb_DataObserver](../../topics/misc/Rdb_DataObserver.md)。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针[Rdb_SubscribeType](#ZH-CN_TOPIC_0000002529444671__rdb_subscribetype) type表示在[Rdb_SubscribeType](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_subscribetype)中定义的订阅类型。const [Rdb_DataObserver](../../topics/misc/Rdb_DataObserver.md) *observer数据库中更改事件的观察者[Rdb_DataObserver](../../topics/misc/Rdb_DataObserver.md)。如果这是nullptr，表示删除该类型的所有观察者。
...
参数项描述[Rdb_ProgressDetails](../../topics/components/Rdb_ProgressDetails.md) *progress表示指向[OH_ProgressDetails](../../topics/components/Rdb_ProgressDetails.md)实例的指针。int32_t version表示当前[Rdb_ProgressDetails](../../topics/components/Rdb_ProgressDetails.md)的版本。

**返回：**

类型说明[Rdb_TableDetails](../../topics/components/Rdb_TableDetails.md)如果操作成功，会返回一个[Rdb_TableDetails](../../topics/components/Rdb_TableDetails.md)结构体的指针，否则返回NULL。
...
参数项描述void *context回调数据的上下文。[Rdb_ProgressDetails](../../topics/components/Rdb_ProgressDetails.md) *progressDetails端云同步进度的详细信息。
...
参数项描述[Rdb_ProgressDetails](../../topics/components/Rdb_ProgressDetails.md) *progressDetails数据库端云同步的统计信息。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[Rdb_SyncMode](#ZH-CN_TOPIC_0000002529444671__rdb_syncmode) mode表示同步过程的类型[Rdb_SyncMode](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_syncmode).const char *tables[]表示需要同步的表名。uint32_t count同步的表的数量，如果传入的值为0，同步数据库的所有表。const [Rdb_ProgressObserver](../../topics/components/Rdb_ProgressObserver.md) *observer端云同步进度的观察者[Rdb_ProgressObserver](../../topics/components/Rdb_ProgressObserver.md)。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向目标[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const [Rdb_ProgressObserver](../../topics/components/Rdb_ProgressObserver.md) *observer用于自动同步进度的观察者[Rdb_ProgressObserver](../../topics/components/Rdb_ProgressObserver.md)。表示调用返回自动同步进度的回调。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向目标[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const [Rdb_ProgressObserver](../../topics/components/Rdb_ProgressObserver.md) *observer表示自动同步进度的观察者[Rdb_ProgressObserver](../../topics/components/Rdb_ProgressObserver.md)。如果是空指针，则自动同步进程的所有回调都将被取消注册。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示指向[OH_Predicates](../../topics/misc/OH_Predicates.md)实例的指针，指定锁定条件。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[OH_Predicates](../../topics/misc/OH_Predicates.md) *predicates表示指向[OH_Predicates](../../topics/misc/OH_Predicates.md)实例的指针，指定解锁条件。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const [OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md) *options表示指向[OH_RDB_TransOptions](../../topics/misc/OH_RDB_TransOptions.md)实例的指针。[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md) **trans

输出参数，表示执行成功时指向[OH_Rdb_Transaction](../../topics/misc/OH_Rdb_Transaction.md)实例的指针。否则返回nullptr。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const [OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向与此RDB存储相关的数据库配置[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)的指针。const char *attachName表示数据库的别名。int64_t waitTime表示附加数据库的最大允许时间，范围为1到300，单位为秒。size_t *attachedNumber表示已附加的数据库数量，作为输出参数。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *attachName表示数据库的别名。int64_t waitTime表示分离数据库的最大允许时间，范围为1到300，单位为秒。size_t *attachedNumber表示已附加的数据库数量，作为输出参数。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。const char *locale与语言相关的区域设置，例如 zh。该值符合 ISO 639 标准。
...
参数项描述[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针。[OH_Rdb_CryptoParam](../../topics/media/OH_Rdb_CryptoParam.md) *param表示指向[OH_Rdb_CryptoParam](../../topics/media/OH_Rdb_CryptoParam.md)实例的指针。
...
参数项描述void *context表示数据异常处理的上下文，生命周期由业务自身管理。[ OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置，不可在回调函数外部使用。[ OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md) *store表示指向[OH_Rdb_Store](../../topics/misc/OH_Rdb_Store.md)实例的指针，该指针由系统产生，回调函数结束后即刻释放，不可在回调函数外部使用。
...
参数项描述[const OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md) *config表示指向[OH_Rdb_ConfigV2](../../topics/misc/OH_Rdb_ConfigV2.md)对象的指针，即与此RDB存储相关的数据库配置。void *context表示数据异常处理的上下文。[const Rdb_CorruptedHandler](relational_store.h.md#ZH-CN_TOPIC_0000002529444671__rdb_corruptedhandler) handler数据库异常处理的回调函数。
