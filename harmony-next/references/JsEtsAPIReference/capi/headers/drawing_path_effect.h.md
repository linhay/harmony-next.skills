...
参数项描述[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)* outer表示组合路径效果中外部路径效果[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)的指针。[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)* inner表示组合路径效果中内部路径效果[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)的指针。

**返回：**

类型说明[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)*

函数返回一个指针，指针指向创建的路径效果对象[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)。
...
类型说明[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)*函数返回一个指针，指针指向创建的路径效果对象[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)。
...
参数项描述const [OH_Drawing_Path](../../topics/graphics/OH_Drawing_Path.md)* path表示虚线样式的路径对象[OH_Drawing_Path](../../topics/graphics/OH_Drawing_Path.md)的指针。float advance表示虚线段的步长。float phase表示虚线段内图形在虚线步长范围内的偏移量。[OH_Drawing_PathDashStyle](#ZH-CN_TOPIC_0000002497606006__oh_drawing_pathdashstyle) type表示虚线路径效果样式。
...
参数项描述[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)* firstPathEffect指向路径对象[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)的指针。[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)* secondPathEffect指向路径对象[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)的指针。
...
参数项描述[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)* pathEffect指向路径效果对象[OH_Drawing_PathEffect](../../topics/graphics/OH_Drawing_PathEffect.md)的指针。