...
名称typedef关键字描述[OH_Drawing_SystemFontType](#ZH-CN_TOPIC_0000002529445977__oh_drawing_systemfonttype)OH_Drawing_SystemFontType字体类型的枚举。[OH_Drawing_FontFullDescriptorAttributeId](#ZH-CN_TOPIC_0000002529445977__oh_drawing_fontfulldescriptorattributeid)OH_Drawing_FontFullDescriptorAttributeId字体描述符属性的枚举。不同类型的字体描述符属性，请使用对应类型的接口获取属性。如字体描述符属性FULL_DESCRIPTOR_ATTR_I_WEIGHT为int类型，需使用[OH_Drawing_GetFontFullDescriptorAttributeInt](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_getfontfulldescriptorattributeint)接口获取其属性值。
...
枚举项描述FULL_DESCRIPTOR_ATTR_S_PATH = 0字体文件的路径，[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)类型。FULL_DESCRIPTOR_ATTR_S_POSTSCRIPT_NAME = 1唯一标识字体的名称，[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)类型。FULL_DESCRIPTOR_ATTR_S_FULL_NAME = 2字体的名称，[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)类型。FULL_DESCRIPTOR_ATTR_S_FAMILY_NAME = 3字体家族的名称，[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)类型。FULL_DESCRIPTOR_ATTR_S_SUB_FAMILY_NAME = 4子字体家族的名称，[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)类型。FULL_DESCRIPTOR_ATTR_I_WEIGHT = 5字体的字重，int类型。FULL_DESCRIPTOR_ATTR_I_WIDTH = 6字体的宽窄风格属性，int类型。FULL_DESCRIPTOR_ATTR_I_ITALIC = 7字体是否倾斜，int类型。1表示字体倾斜，0表示字体非倾斜。FULL_DESCRIPTOR_ATTR_B_MONO = 8字体是否紧凑，bool类型。true表示字体紧凑，false表示字体非紧凑。FULL_DESCRIPTOR_ATTR_B_SYMBOLIC = 9字体是否支持符号字体，bool类型。true表示支持符号字体，false表示不支持符号字体。
...
参数项描述[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)* desc

指针。

建议使用[OH_Drawing_CreateFontDescriptor](drawing_text_typography.h.md#ZH-CN_TOPIC_0000002497606016__oh_drawing_createfontdescriptor)获得有效的[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)实例。

如果自己创建[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)实例，请确保不用于匹配的字段是默认值。

size_t* num表示返回值数组的成员个数。

**返回：**

类型说明[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)*[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)数组，释放时请使用[OH_Drawing_DestroyFontDescriptors](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_destroyfontdescriptors)。
...
释放字体描述符[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)数组。
...
参数项描述[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)* descriptors数组。size_t num[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)数组的成员个数。
...
参数项描述const [OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)* fullName表示指向字体名称字符串[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)的指针。[OH_Drawing_SystemFontType](#ZH-CN_TOPIC_0000002529445977__oh_drawing_systemfonttype) fontType表示字体类型的枚举值[OH_Drawing_SystemFontType](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_systemfonttype)。

**返回：**

类型说明[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)*指向字体描述符对象[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)的指针，不再需要[OH_Drawing_FontDescriptor](../../topics/graphics/OH_Drawing_FontDescriptor.md)时，请使用[OH_Drawing_DestroyFontDescriptor](drawing_text_typography.h.md#ZH-CN_TOPIC_0000002497606016__oh_drawing_destroyfontdescriptor)接口释放该对象的指针。
...
参数项描述[OH_Drawing_SystemFontType](#ZH-CN_TOPIC_0000002529445977__oh_drawing_systemfonttype) fontType表示字体类型的枚举值[OH_Drawing_SystemFontType](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_systemfonttype)。

**返回：**

类型说明[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)*返回对应字体类型的字体名称数组[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)的指针，不再需要[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)时，请使用[OH_Drawing_DestroySystemFontFullNames](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_destroysystemfontfullnames)接口释放该对象的指针。
...
参数项描述[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)* fullNameArray表示字体名称数组[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)的指针。size_t index数组的索引。

**返回：**

类型说明const [OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)*返回对应索引的字体名称[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)的指针。
...
参数项描述[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)* fullNameArray表示字体名称数组[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)的指针。
...
类型说明[OH_Drawing_Array*](../../topics/graphics/OH_Drawing_Array.md)

返回指向对应字体文件的字体描述符数组[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)的指针，不再需要OH_Drawing_Array时，请使用[OH_Drawing_DestroyFontFullDescriptors](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_destroyfontfulldescriptors)接口释放该对象的指针。
...
参数项描述[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)* descriptorArray表示指向字体描述符数组[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)的指针。size_t index数组的索引，索引值从0开始。

**返回：**

类型说明const [OH_Drawing_FontFullDescriptor](../../topics/graphics/OH_Drawing_FontFullDescriptor.md)*

返回指向指定索引处字体描述符对象[OH_Drawing_FontFullDescriptor](../../topics/graphics/OH_Drawing_FontFullDescriptor.md)的指针。
...
参数项描述[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)* descriptorArray表示指向字体描述符数组[OH_Drawing_Array](../../topics/graphics/OH_Drawing_Array.md)的指针。
...
参数项描述const [OH_Drawing_FontFullDescriptor](../../topics/graphics/OH_Drawing_FontFullDescriptor.md)* descriptor指向字体描述符对象[OH_Drawing_FontFullDescriptor](../../topics/graphics/OH_Drawing_FontFullDescriptor.md)的指针。[OH_Drawing_FontFullDescriptorAttributeId](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_fontfulldescriptorattributeid) id字体描述符属性id。从[OH_Drawing_FontFullDescriptorAttributeId](drawing_text_font_descriptor.h.md#ZH-CN_TOPIC_0000002529445977__oh_drawing_fontfulldescriptorattributeid)中可获取字体描述符属性。[OH_Drawing_String](../../topics/graphics/OH_Drawing_String.md)* str指向OH_Drawing_String类型属性的指针。作为出参使用。
