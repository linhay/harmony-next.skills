...
**相关模块：**[NetConnection](../../topics/networking/NetConnection.md)

#### 汇总

#### 结构体

名称typedef关键字描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md)NetConn_NetHandle存放网络ID。[NetConn_NetCapabilities](../../topics/networking/NetConn_NetCapabilities.md)NetConn_NetCapabilities网络能力集。[NetConn_NetAddr](../../topics/networking/NetConn_NetAddr.md)NetConn_NetAddr网络地址。[NetConn_Route](../../topics/networking/NetConn_Route.md)NetConn_Route路由配置信息。[NetConn_HttpProxy](../../topics/networking/NetConn_HttpProxy.md)NetConn_HttpProxy代理配置信息。[NetConn_ConnectionProperties](../../topics/networking/NetConn_ConnectionProperties.md)NetConn_ConnectionProperties网络链接信息。[NetConn_NetHandleList](../../topics/components/NetConn_NetHandleList.md)NetConn_NetHandleList网络列表。[NetConn_NetSpecifier](../../topics/networking/NetConn_NetSpecifier.md)NetConn_NetSpecifier网络的特征集。[NetConn_NetConnCallback](../../topics/networking/NetConn_NetConnCallback.md)NetConn_NetConnCallback网络状态监听回调集合。[NetConn_ProbeResultInfo](../../topics/networking/NetConn_ProbeResultInfo.md)NetConn_ProbeResultInfo定义探测结果信息。[NetConn_TraceRouteOption](../../topics/networking/NetConn_TraceRouteOption.md)NetConn_TraceRouteOption定义网络跟踪路由选项。[NetConn_TraceRouteInfo](../../topics/networking/NetConn_TraceRouteInfo.md)NetConn_TraceRouteInfo定义跟踪路由信息。
...
参数项描述[NetConn_HttpProxy](../../topics/networking/NetConn_HttpProxy.md) *proxy变化的代理配置信息,可能是空指针。
...
参数项描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle网络句柄。
...
参数项描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle网络句柄。[NetConn_NetCapabilities](../../topics/networking/NetConn_NetCapabilities.md) *netCapabilities网络能力集。
...
参数项描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle网络句柄。[NetConn_ConnectionProperties](../../topics/networking/NetConn_ConnectionProperties.md) *connConnetionProperties网络连接属性。
...
参数项描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle网络句柄。bool blocked指示网络是否将被阻塞的标志。