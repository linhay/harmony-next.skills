...
参数项描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle存放网络ID。
...
参数项描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle存放网络ID。[NetConn_ConnectionProperties](../../topics/networking/NetConn_ConnectionProperties.md) *prop存放链路信息。
...
参数项描述[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle存放网络ID。[NetConn_NetCapabilities](../../topics/networking/NetConn_NetCapabilities.md) *netCapabilities存放能力集。
...
参数项描述[NetConn_HttpProxy](../../topics/networking/NetConn_HttpProxy.md) *httpProxy存放代理配置信息。
...
参数项描述[NetConn_NetHandleList](../../topics/components/NetConn_NetHandleList.md) *netHandleList网络信息列表。
...
参数项描述int32_t socketFd由用户构造的套接字。[NetConn_NetHandle](../../topics/networking/NetConn_NetHandle.md) *netHandle指针类型，指向包含网络ID的网络句柄。
...
参数项描述[NetConn_HttpProxy](../../topics/networking/NetConn_HttpProxy.md) *httpProxy需要设置的http代理配置信息。
...
参数项描述char *destination目的地址。int32_t duration探测持续时间。单位：秒。[NetConn_ProbeResultInfo](../../topics/networking/NetConn_ProbeResultInfo.md) *probeResultInfo丢包率和往返时间（RTT）。
...
参数项描述char *destination目的地址。[NetConn_TraceRouteOption](../../topics/networking/NetConn_TraceRouteOption.md) *option路由参数选项。[NetConn_TraceRouteInfo](../../topics/networking/NetConn_TraceRouteInfo.md) *traceRouteInfo路由结果。需传入数组指针，数组大小代表路由跳数，默认30跳。若自定义跳数，则需保证数组大小与option字段中的maxJumpNumber数值保持一致。
