...
名称typedef关键字描述[OH_AVTranscoder](../../topics/misc/OH_AVTranscoder.md)OH_AVTranscoder初始化AVTranscoder。[OH_AVTranscoder_Config](../../topics/misc/OH_AVTranscoder_Config.md)OH_AVTranscoder_Config初始化AVTranscoder_Config。
...
参数项描述[OH_AVTranscoder](../../topics/misc/OH_AVTranscoder.md) *transcoderOH_AVTranscoder实例的指针。[OH_AVTranscoder_State](#ZH-CN_TOPIC_0000002529285907__oh_avtranscoder_state) state转码状态，详细说明请参见[OH_AVTranscoder_State](#ZH-CN_TOPIC_0000002529285907__oh_avtranscoder_state)。void *userData用户特定数据的指针。
...
参数项描述[OH_AVTranscoder](../../topics/misc/OH_AVTranscoder.md) *transcoderOH_AVTranscoder实例的指针。int32_t errorCode
...
参数项描述[OH_AVTranscoder](../../topics/misc/OH_AVTranscoder.md) *transcoderOH_AVTranscoder实例的指针。int32_t progress转码进度。void *userData用户特定数据的指针。