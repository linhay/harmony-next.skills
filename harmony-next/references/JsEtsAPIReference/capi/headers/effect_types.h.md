...
名称typedef关键字描述[OH_Filter_ColorMatrix](../../topics/graphics/OH_Filter_ColorMatrix.md)-定义一个用来创建滤镜效果的矩阵。[OH_Filter](../../topics/misc/OH_Filter.md)OH_Filter滤镜结构体，用来生成滤镜位图。[OH_PixelmapNative](../../topics/graphics/OH_PixelmapNative.md)OH_PixelmapNative定义一个位图。
