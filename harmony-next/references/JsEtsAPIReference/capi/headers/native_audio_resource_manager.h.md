...
名称typedef关键字描述[OH_AudioResourceManager](../../topics/system-services/OH_AudioResourceManager.md)OH_AudioResourceManager声明音频资源管理器。用于管理音频资源相关功能。[OH_AudioWorkgroup](../../topics/media/OH_AudioWorkgroup.md)OH_AudioWorkgroup声明音频工作组。将音频关键线程进行分组管理。
...
参数项描述[OH_AudioResourceManager](../../topics/system-services/OH_AudioResourceManager.md) **resourceManager指向OH_AudioResourceManager用于接收创建的音频资源管理器实例。
...
参数项描述[OH_AudioResourceManager](../../topics/system-services/OH_AudioResourceManager.md) *resourceManager指向[OH_AudioManager_GetAudioResourceManager](native_audio_resource_manager.h.md#ZH-CN_TOPIC_0000002529285705__oh_audiomanager_getaudioresourcemanager)创建的音频资源管理器实例OH_AudioResourceManager。const char *name要创建的音频工作组的名称。[OH_AudioWorkgroup](../../topics/media/OH_AudioWorkgroup.md) **group指向OH_AudioWorkgroup用于接收返回的音频工作组实例的指针。
...
参数项描述[OH_AudioWorkgroup](../../topics/media/OH_AudioWorkgroup.md) *group指向[OH_AudioResourceManager_CreateWorkgroup](native_audio_resource_manager.h.md#ZH-CN_TOPIC_0000002529285705__oh_audioresourcemanager_createworkgroup)创建的音频工作组实例OH_AudioWorkgroup。int32_t *tokenId用于接收加入音频工作组的线程号。
...
参数项描述[OH_AudioWorkgroup](../../topics/media/OH_AudioWorkgroup.md) *group指向[OH_AudioResourceManager_CreateWorkgroup](native_audio_resource_manager.h.md#ZH-CN_TOPIC_0000002529285705__oh_audioresourcemanager_createworkgroup)创建的音频工作组实例OH_AudioWorkgroup。int32_t tokenId要从音频工作组中移除的线程号。
...
参数项描述[OH_AudioWorkgroup](../../topics/media/OH_AudioWorkgroup.md) *group指向[OH_AudioResourceManager_CreateWorkgroup](native_audio_resource_manager.h.md#ZH-CN_TOPIC_0000002529285705__oh_audioresourcemanager_createworkgroup)创建的音频工作组实例OH_AudioWorkgroup。uint64_t startTime当前音频工作组启动的时间点。uint64_t deadlineTime当前音频工作组预期完成的时间。
...
参数项描述[OH_AudioWorkgroup](../../topics/media/OH_AudioWorkgroup.md) *group指向[OH_AudioResourceManager_CreateWorkgroup](native_audio_resource_manager.h.md#ZH-CN_TOPIC_0000002529285705__oh_audioresourcemanager_createworkgroup)创建的音频工作组实例OH_AudioWorkgroup。
