...
类型说明[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)*函数会返回一个指针，指针指向创建的区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)。
...
参数项描述const [OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* region指向用于拷贝的区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针。

**返回：**

类型说明[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)*函数会返回一个指针，指针指向创建的新区域对象。
...
参数项描述[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* region指向区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针。int32_t x表示指定坐标点的x轴坐标。int32_t y表示指定坐标点的y轴坐标。
...
参数项描述[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* region指向区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针，操作完成后的区域结果将会保存在此区域对象中。const [OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* other指向区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针。[OH_Drawing_RegionOpMode](#ZH-CN_TOPIC_0000002529285999__oh_drawing_regionopmode) op区域操作枚举类型，支持可选的具体模式可见[OH_Drawing_RegionOpMode](drawing_region.h.md#ZH-CN_TOPIC_0000002529285999__oh_drawing_regionopmode)枚举。
...
参数项描述[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* region指向区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针。const [OH_Drawing_Rect](../../topics/graphics/OH_Drawing_Rect.md)* rect指向矩形对象的指针。
...
参数项描述[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* region指向区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针。const [OH_Drawing_Path](../../topics/graphics/OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](../../topics/graphics/OH_Drawing_Path.md)的指针。const [OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* clip指向区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针。
...
参数项描述[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)* region指向区域对象[OH_Drawing_Region](../../topics/graphics/OH_Drawing_Region.md)的指针。
