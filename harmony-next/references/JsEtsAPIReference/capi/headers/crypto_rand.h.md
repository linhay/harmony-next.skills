...
**相关模块：**[CryptoRandApi](../../topics/networking/CryptoRandApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoRand](../../topics/misc/OH_CryptoRand.md)OH_CryptoRand定义随机数生成器结构。
...
参数项描述[OH_CryptoRand](../../topics/misc/OH_CryptoRand.md) **ctx指向随机数生成器实例的指针。
...
参数项描述[OH_CryptoRand](../../topics/misc/OH_CryptoRand.md) *ctx随机数生成器实例。int len表示生成随机数的长度，单位为byte，范围在[1, INT_MAX]。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *out用于获取随机数的指针。
...
参数项描述[OH_CryptoRand](../../topics/misc/OH_CryptoRand.md) *ctx指向随机数生成器实例。
...
参数项描述[OH_CryptoRand](../../topics/misc/OH_CryptoRand.md) *ctx随机数生成器实例。[Crypto_DataBlob](../../topics/components/Crypto_DataBlob.md) *seed种子数据。
...
参数项描述[OH_CryptoRand](../../topics/misc/OH_CryptoRand.md) *ctx随机数生成器实例。
