...
**相关模块：**[AssetApi](../../topics/networking/AssetApi.md)
...
参数项描述const [Asset_Attr](../../topics/misc/Asset_Attr.md) *attributes待新增关键资产的属性集合。uint32_t attrCnt待新增关键资产的属性数量。
...
参数项描述const [Asset_Attr](../../topics/misc/Asset_Attr.md) *query待删除关键资产的搜索条件。uint32_t queryCnt待删除关键资产搜索条件的个数。
...
参数项描述const [Asset_Attr](../../topics/misc/Asset_Attr.md) *query待更新关键资产的搜索条件。uint32_t queryCnt待更新关键资产搜索条件的个数。const [Asset_Attr](../../topics/misc/Asset_Attr.md) *attributesToUpdate待更新关键资产的属性集合。uint32_t updateCnt待更新关键资产的属性数量。
...
参数项描述const [Asset_Attr](../../topics/misc/Asset_Attr.md) *query关键资产的查询条件。uint32_t queryCnt关键资产查询条件的个数。[Asset_Blob](../../topics/misc/Asset_Blob.md) *challenge挑战值，在后续调用[OH_Asset_Query](#ZH-CN_TOPIC_0000002497605340__oh_asset_query)时使用。
...
参数项描述const [Asset_Attr](../../topics/misc/Asset_Attr.md) *query关键资产的查询条件。uint32_t queryCnt关键资产查询条件的个数。[Asset_ResultSet](../../topics/misc/Asset_ResultSet.md) *resultSet查询结果列表。
...
参数项描述const [Asset_Attr](../../topics/misc/Asset_Attr.md) *handle待处理的查询句柄，当前包含[OH_Asset_PreQuery](#ZH-CN_TOPIC_0000002497605340__oh_asset_prequery)执行成功返回的挑战值。uint32_t handleCnt句柄属性集合中元素的个数。
...
参数项描述const [Asset_Attr](../../topics/misc/Asset_Attr.md) *query关键资产同步结果的查询条件。uint32_t queryCnt关键资产同步结果的查询条件个数。[Asset_SyncResult](../../topics/misc/Asset_SyncResult.md) *syncResult查询到的关键资产同步结果。
...
参数项描述const [Asset_Result](../../topics/misc/Asset_Result.md) *result从[OH_Asset_Query](#ZH-CN_TOPIC_0000002497605340__oh_asset_query)中获取的查询结果。[Asset_Tag](asset_type.h.md#ZH-CN_TOPIC_0000002497445362__asset_tag) tag待获取的属性标签。

**返回：**

类型说明[Asset_Attr](../../topics/misc/Asset_Attr.md)如果操作成功，则以Asset_Attr的形式返回属性，该属性不需要业务进行释放；否则返回NULL。
...
参数项描述[Asset_Blob](../../topics/misc/Asset_Blob.md) *blob从[OH_Asset_PreQuery](#ZH-CN_TOPIC_0000002497605340__oh_asset_prequery)获取的挑战值。
...
参数项描述[Asset_ResultSet](../../topics/misc/Asset_ResultSet.md) *resultSet从[OH_Asset_Query](#ZH-CN_TOPIC_0000002497605340__oh_asset_query)得到的查询结果列表。