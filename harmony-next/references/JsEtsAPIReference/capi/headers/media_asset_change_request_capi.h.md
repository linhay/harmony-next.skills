...
创建[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)实例。
...
类型说明[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)*
...
参数项描述[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)* changeRequest[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)实例。int32_t* fd临时文件写句柄。
...
参数项描述[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)* changeRequest[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)实例。[MediaLibrary_ImageFileType](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_imagefiletype) imageFileType要保存的照片的图像文件类型。
...
参数项描述[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)* changeRequest[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)实例。
...
释放[OH_MediaAssetChangeRequest](../../topics/media/OH_MediaAssetChangeRequest.md)实例。
