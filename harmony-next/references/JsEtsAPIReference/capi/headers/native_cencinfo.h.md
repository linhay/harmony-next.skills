...
**相关模块：**[Multimedia_Drm](../../topics/media/Multimedia_Drm.md)

#### 汇总

#### 结构体

名称typedef关键字描述[DrmSubsample](../../topics/misc/DrmSubsample.md)DrmSubsampleSubsample结构类型定义。[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md)OH_AVBufferAVBuffer结构。[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md)OH_AVCencInfoAVCencInfo结构。
...
类型说明[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md) *
...
参数项描述[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md) *cencInfo指向OH_AVCencInfo实例的指针。
...
参数项描述[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md) *cencInfo指向OH_AVCencInfo实例的指针。[enum DrmCencAlgorithm](#ZH-CN_TOPIC_0000002497605744__drmcencalgorithm) algo加密算法模式。
...
参数项描述[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md) *cencInfo指向OH_AVCencInfo实例的指针。uint8_t *keyIdKey标识。uint32_t keyIdLenKey标识长度。uint8_t *iv初始化向量。uint32_t ivLen初始化向量长度。
...
参数项描述[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md) *cencInfo指向OH_AVCencInfo实例的指针。uint32_t encryptedBlockCount加密块的数量。uint32_t skippedBlockCount不加密块的数量。uint32_t firstEncryptedOffset第一个加密有效负载的偏移量。uint32_t subsampleCountSubsample数量。[DrmSubsample](../../topics/misc/DrmSubsample.md) *subsamplesSubsample内容集。
...
参数项描述[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md) *cencInfo指向OH_AVCencInfo实例的指针。[enum DrmCencInfoMode](#ZH-CN_TOPIC_0000002497605744__drmcencinfomode) modecencInfo模式，指示是否设置了keyId/iv/subsample。
...
参数项描述[OH_AVCencInfo](../../topics/misc/OH_AVCencInfo.md) *cencInfo指向OH_AVCencInfo实例的指针。[OH_AVBuffer](../../topics/misc/OH_AVBuffer.md) *buffer携带数据的帧buffer。
