...
参数项描述[OH_LowPowerAudioSink](../../topics/media/OH_LowPowerAudioSink.md)* sink指向OH_LowPowerAudioSink实例的指针。[OH_AVErrCode](native_averrors.h.md#ZH-CN_TOPIC_0000002497605740__oh_averrcode) errorCode发生错误时上报的错误码。const char* errorMsg错误描述信息。void* userData用户自定义数据。
...
参数项描述[OH_LowPowerAudioSink](../../topics/media/OH_LowPowerAudioSink.md)* sink指向OH_LowPowerAudioSink实例的指针。int64_t currentPosition返回服务当前播放的进度值。void* userData用户自定义数据。
...
参数项描述[OH_LowPowerAudioSink](../../topics/media/OH_LowPowerAudioSink.md)* sink指向OH_LowPowerAudioSink实例的指针。[OH_AVSamplesBuffer](../../topics/misc/OH_AVSamplesBuffer.md)* samples即将写入的AVSamplesBuffer实例。void* userData用户自定义数据。
...
参数项描述[OH_LowPowerAudioSink](../../topics/media/OH_LowPowerAudioSink.md)* sink指向OH_LowPowerAudioSink实例的指针。[OH_AudioStream_DeviceChangeReason](native_audiostream_base.h.md#ZH-CN_TOPIC_0000002529445679__oh_audiostream_devicechangereason) reason输出设备发生变化的原因。void* userData用户自定义数据。
...
LowPowerAudioSink播放完成时调用该方法，包含在[OH_LowPowerAudioSinkCallback](../../topics/media/OH_LowPowerAudioSinkCallback.md)中。

**起始版本：** 20

**参数：**

参数项描述[OH_LowPowerAudioSink](../../topics/media/OH_LowPowerAudioSink.md)* sink指向OH_LowPowerAudioSink实例的指针。void* userData用户自定义数据。