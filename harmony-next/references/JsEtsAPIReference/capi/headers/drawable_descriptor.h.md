...
名称typedef关键字描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)ArkUI_DrawableDescriptor定义DrawableDescriptor对象。[OH_PixelmapNative*](../../topics/graphics/OH_PixelmapNative_.md)OH_PixelmapNativeHandle定义OH_PixelmapNative对象指针类型。[ArkUI_Node*](../../topics/components/ArkUI_Node_.md)ArkUI_NodeHandle定义ArkUI native组件实例对象指针定义。[ArkUI_DrawableDescriptor_AnimationController](../../topics/graphics/ArkUI_DrawableDescriptor_AnimationController.md)ArkUI_DrawableDescriptor_AnimationController定义DrawableDescriptor动图控制器对象。
...
参数项描述[OH_PixelmapNativeHandle](../../topics/graphics/OH_PixelmapNative_.md) pixelMapPixelMap对象指针。

**返回：**

类型说明[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)*返回DrawableDescriptor对象指针。
...
参数项描述[OH_PixelmapNativeHandle](../../topics/graphics/OH_PixelmapNative_.md)* arrayPixelMap图片数组对象指针。int32_t sizePixelMap图片数组大小。
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。
...
类型说明[OH_PixelmapNativeHandle](../../topics/graphics/OH_PixelmapNative_.md)PixelMap对象指针。
...
类型说明[OH_PixelmapNativeHandle](../../topics/graphics/OH_PixelmapNative_.md)*PixelMap图片数组指针。
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。int32_t duration播放总时长，单位毫秒。
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。int32_t iteration播放次数。
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。uint32_t* durations
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。uint32_t* durations动图中的单帧播放时间数组。size_t* size数组大小。
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。uint32_t autoPlay
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。uint32_t* autoPlay是否自动播放。
...
参数项描述[ArkUI_DrawableDescriptor](../../topics/graphics/ArkUI_DrawableDescriptor.md)* drawableDescriptorDrawableDescriptor对象指针。[ArkUI_NodeHandle](../../topics/components/ArkUI_Node_.md) node组件节点指针。[ArkUI_DrawableDescriptor_AnimationController](../../topics/graphics/ArkUI_DrawableDescriptor_AnimationController.md)** controllerDrawableDescriptor动图控制器对象指针。
...
参数项描述[ArkUI_DrawableDescriptor_AnimationController](../../topics/graphics/ArkUI_DrawableDescriptor_AnimationController.md)* controllerDrawableDescriptor动图控制器对象指针。
...
参数项描述[ArkUI_DrawableDescriptor_AnimationController](../../topics/graphics/ArkUI_DrawableDescriptor_AnimationController.md)* controllerDrawableDescriptor动图控制器对象指针。[DrawableDescriptor_AnimationStatus](#ZH-CN_TOPIC_0000002497445096__drawabledescriptor_animationstatus)* statusDrawableDescriptor动图的播放状态。
