...
类型说明[OH_Drawing_Path](OH_Drawing_Path.md)*函数会返回一个指针，指针指向创建的路径对象。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。

**返回：**

类型说明[OH_Drawing_Path](OH_Drawing_Path.md)*函数返回一个指针，指针指向创建的路径对象副本[OH_Drawing_Path](OH_Drawing_Path.md)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象的指针。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_Path](OH_Drawing_Path.md)* other用于设置的路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。bool* isEmpty表示路径对象是否为空。true表示路径对象为空，false表示路径对象不为空。作为出参使用。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_Rect](OH_Drawing_Rect.md)* rect指向矩形对象[OH_Drawing_Rect](OH_Drawing_Rect.md)的指针，作为出参使用，可以为空。bool* isRect表示路径是否构成矩形。true表示构成矩形，false表示不构成矩形。作为出参使用。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象的指针。float x起始点的横坐标。float y起始点的纵坐标。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象的指针。float x目标点的横坐标。float y目标点的纵坐标。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象的指针。float x1包围椭圆的矩形左上角点位置的横坐标。float y1包围椭圆的矩形左上角点位置的纵坐标。float x2包围椭圆的矩形右下角点位置的横坐标。float y2包围椭圆的矩形右下角点位置的纵坐标。float startDeg起始的角度。角度的起始方向（0°）为x轴正方向。float sweepDeg扫描的度数，为正数时顺时针扫描，为负数时逆时针扫描。实际扫描的度数为该入参对360取模的结果。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象的指针。float ctrlX控制点位置的横坐标。float ctrlY控制点位置的纵坐标。float endX目标点位置的横坐标。float endY目标点位置的纵坐标。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float ctrlX控制点位置的横坐标。float ctrlY控制点位置的纵坐标。float endX结束点位置的横坐标。float endY结束点位置的纵坐标。float weight
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象的指针。float ctrlX1第一个控制点位置的横坐标。float ctrlY1第一个控制点位置的纵坐标。float ctrlX2第二个控制点位置的横坐标。float ctrlY2第二个控制点位置的纵坐标。float endX目标点位置的横坐标。float endY目标点位置的纵坐标。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float x相对于当前路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移。float y相对于当前路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float x相对于当前路径终点的x轴偏移量，用于指定目标点的横坐标。float y相对于当前路径终点的y轴偏移量，用于指定目标点的纵坐标。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float ctrlX相对于路径终点的x轴偏移量，用于指定控制点的横坐标。float ctrlY相对于路径终点的y轴偏移量，用于指定控制点的纵坐标。float endX相对于路径终点的x轴偏移量，用于指定目标点的横坐标。float endY相对于路径终点的y轴偏移量，用于指定目标点的纵坐标。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float ctrlX相对于路径终点的x轴偏移量，用于指定控制点的横坐标。float ctrlY相对于路径终点的y轴偏移量，用于指定控制点的纵坐标。float endX相对于路径终点的x轴偏移量，用于指定目标点的横坐标。float endY相对于路径终点的y轴偏移量，用于指定目标点的纵坐标。float weight
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float ctrlX1相对于路径终点的x轴偏移量，用于指定第一个控制点的横坐标。float ctrlY1相对于路径终点的y轴偏移量，用于指定第一个控制点的纵坐标。float ctrlX2相对于路径终点的x轴偏移量，用于指定第二个控制点的横坐标。float ctrlY2相对于路径终点的y轴偏移量，用于指定第二个控制点的纵坐标。float endX相对于路径终点的x轴偏移量，用于指定目标点的横坐标。float endY相对于路径终点的y轴偏移量，用于指定目标点的纵坐标。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float left矩形左上角的x轴坐标。float top矩形左上角的y轴坐标。float right矩形右下角的x轴坐标。float bottom矩形右下角的y轴坐标。[OH_Drawing_PathDirection](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection) pathDirection路径方向[OH_Drawing_PathDirection](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Rect](OH_Drawing_Rect.md)* rect指向矩形对象[OH_Drawing_Rect](OH_Drawing_Rect.md)的指针。OH_Drawing_PathDirection表示绘制方向[OH_Drawing_PathDirection](drawing_path.h.md#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection)。uint32_t start起始点的位置，表示从矩形的哪个角开始绘制路径。0：左上角，1：右上角，2：右下角，3：左下角。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_RoundRect](OH_Drawing_RoundRect.md)* roundRect指向圆角矩形对象[OH_Drawing_RoundRect](OH_Drawing_RoundRect.md)的指针。[OH_Drawing_PathDirection](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection) pathDirection路径方向[OH_Drawing_PathDirection](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Rect](OH_Drawing_Rect.md)* rect指向矩形对象[OH_Drawing_Rect](OH_Drawing_Rect.md)的指针。uint32_t start表示椭圆初始点的索引。[OH_Drawing_PathDirection](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection) pathDirection表示绘制方向[OH_Drawing_PathDirection](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Rect](OH_Drawing_Rect.md)* rect指向矩形对象[OH_Drawing_Rect](OH_Drawing_Rect.md)的指针。[OH_Drawing_PathDirection](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection) pathDirection路径方向[OH_Drawing_PathDirection](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathdirection)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Rect](OH_Drawing_Rect.md)* rect指向矩形对象[OH_Drawing_Rect](OH_Drawing_Rect.md)的指针。float startAngle弧的起始角度，单位为度。float sweepAngle扫描的度数，为正数时顺时针扫描，为负数时逆时针扫描。实际扫描的度数为该入参对360取模的结果。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向当前路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Path](OH_Drawing_Path.md)* src指向源路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Matrix](OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](OH_Drawing_Matrix.md)的指针，为NULL时表示单位矩阵。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向当前路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Path](OH_Drawing_Path.md)* src指向源路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Matrix](OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](OH_Drawing_Matrix.md)的指针，为NULL表示单位矩阵。[OH_Drawing_PathAddMode](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathaddmode) pathAddMode路径添加模式[OH_Drawing_PathAddMode](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathaddmode)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向当前路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Path](OH_Drawing_Path.md)* src指向源路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_PathAddMode](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathaddmode) pathAddMode路径添加模式[OH_Drawing_PathAddMode](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathaddmode)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向当前路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Path](OH_Drawing_Path.md)* src指向源路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float dx添加到目标路径横坐标的偏移量。float dy添加到目标路径纵坐标的偏移量。[OH_Drawing_PathAddMode](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathaddmode) pathAddMode路径添加模式[OH_Drawing_PathAddMode](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathaddmode)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向当前路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Point2D](OH_Drawing_Point2D.md)* points表示多边形的顶点坐标数组。uint32_t count表示多边形顶点坐标数组的大小。bool isClosed是否添加连接起始点和终止点的线，true表示添加，false表示不添加。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const char* str表示SVG字符串。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float xx轴上坐标点。float yy轴上坐标点。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Matrix](OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](OH_Drawing_Matrix.md)的指针。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* src指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。const [OH_Drawing_Matrix](OH_Drawing_Matrix.md)* matrix指向矩阵对象[OH_Drawing_Matrix](OH_Drawing_Matrix.md)的指针。[OH_Drawing_Path](OH_Drawing_Path.md)* dst指向目标路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。bool applyPerspectiveClip表示变换路径是否应用透视裁剪。true表示应用透视裁剪，false表示不用透视裁剪。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_PathFillType](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathfilltype) pathFillType路径填充规则[OH_Drawing_PathFillType](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathfilltype)。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_PathFillType](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathfilltype)* pathFillType指向路径填充规则[OH_Drawing_PathFillType](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathfilltype)的指针。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。bool forceClosed表示是否按照闭合路径测量。true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_Rect](OH_Drawing_Rect.md)* rect指向矩形对象[OH_Drawing_Rect](OH_Drawing_Rect.md)的指针。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向当前路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_Path](OH_Drawing_Path.md)* dst指向目标路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针，为NULL时会将结果存储到当前路径对象中。float dxx轴方向的偏移量。float dyy轴方向的偏移量。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。bool forceClosed表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。float distance表示距离起始点的距离，小于0时会被视为0处理，大于路径长度时会被视为路径长度处理。[OH_Drawing_Point2D](OH_Drawing_Point2D.md)* position表示距路径起始点指定距离的坐标点。[OH_Drawing_Point2D](OH_Drawing_Point2D.md)* tangent表示距路径起始点指定距离的切线值，tangent.x表示该点切线的余弦值，tangent.y表示该点切线的正弦值。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。bool forceClosed表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。float start表示与路径起始点的距离，距离路径起始点start距离的位置即为截取路径片段的起始点，小于0时会被视作0，大于等于stop时会截取失败。float stop表示与路径起始点的距离，距离路径起始点stop距离的位置即为截取路径片段的终点，小于等于start时会截取失败，大于路径长度时会被视作路径长度。bool startWithMoveTo表示是否在目标路径执行[OH_Drawing_PathMoveTo](drawing_path.h.md#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathmoveto)移动到截取路径片段的起始点位置。true表示执行，false表示不执行。[OH_Drawing_Path](OH_Drawing_Path.md)* dst指向目标路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针，截取成功时会将得到的路径片段追加到目标路径上，截取失败时不做改变。bool* result返回是否成功截取路径片段的结果。true表示截取成功，false表示截取失败。作为出参使用。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针，操作完成后的路径结果将会保存在此路径对象中。const [OH_Drawing_Path](OH_Drawing_Path.md)* other指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_PathOpMode](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathopmode) op路径操作枚举类型，支持可选的具体模式可见[OH_Drawing_PathOpMode](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathopmode)枚举。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。bool forceClosed表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。float distance表示距离起始点的距离，小于0时会被视为0处理，大于路径长度时会被视为路径长度处理。[OH_Drawing_Matrix](OH_Drawing_Matrix.md)* matrix表示要获取的变换矩阵。[OH_Drawing_PathMeasureMatrixFlags](#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathmeasurematrixflags) flag矩阵信息维度枚举，支持可选的具体模式可见[OH_Drawing_PathMeasureMatrixFlags](zh-cn_topic_0000002529445969.html#ZH-CN_TOPIC_0000002529445969__oh_drawing_pathmeasurematrixflags)枚举。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float acceptableError
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_Path](OH_Drawing_Path.md)* other指向用于插值的另一条路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。float weight表示插值权重，范围为[0, 1]。bool* success表示插值是否成功。true表示插值成功，false表示插值失败。作为出参使用。[OH_Drawing_Path](OH_Drawing_Path.md)* interpolatedPath指向用于存储插值结果的路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。
...
参数项描述[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。[OH_Drawing_Path](OH_Drawing_Path.md)* other指向另一条路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针。bool* result
