...
参数名类型必填说明vsMode[VideoStabilizationMode](Enums.md#ZH-CN_TOPIC_0000002497445814__videostabilizationmode)是视频防抖模式。

**返回值：**

类型说明boolean返回视频防抖模式是否支持。true表示支持，false表示不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
