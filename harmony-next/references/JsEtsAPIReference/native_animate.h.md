...
名称typedef关键字描述[ArkUI_ExpectedFrameRateRange](ArkUI_ExpectedFrameRateRange.md)ArkUI_ExpectedFrameRateRange设置动画的期望帧率。[ArkUI_AnimateCompleteCallback](ArkUI_AnimateCompleteCallback.md)ArkUI_AnimateCompleteCallback动画播放结束回调类型。[ArkUI_NativeAnimateAPI_1](ArkUI_NativeAnimateAPI_1.md)ArkUI_NativeAnimateAPI_1ArkUI提供的Native侧动画接口集合。[ArkUI_AnimateOption](ArkUI_AnimateOption.md)ArkUI_AnimateOption设置动画效果相关参数。[ArkUI_Curve](ArkUI_Curve.md)ArkUI_Curve提供曲线的插值对象定义。[ArkUI_CurveHandle](ArkUI_Curve_.md)ArkUI_Curve*定义曲线的插值对象指针定义。[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)ArkUI_KeyframeAnimateOption定义关键帧动画参数对象。[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)ArkUI_AnimatorOption定义animator动画参数对象。[ArkUI_AnimatorHandle](ArkUI_Animator_.md)ArkUI_Animator*定义animator动画对象指针。[ArkUI_AnimatorEvent](ArkUI_AnimatorEvent.md)ArkUI_AnimatorEvent定义animator回调事件对象。[ArkUI_AnimatorOnFrameEvent](ArkUI_AnimatorOnFrameEvent.md)ArkUI_AnimatorOnFrameEvent定义animator接收到帧时回调对象。[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)ArkUI_TransitionEffect定义transition属性配置转场参数对象。
...
类型说明[ArkUI_AnimateOption](ArkUI_AnimateOption.md)*新的动画效果参数指针。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。
...
类型说明[ArkUI_ExpectedFrameRateRange](ArkUI_ExpectedFrameRateRange.md)*动画的期望帧率，单位为帧/秒（fps）。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。int32_t value持续时间，单位为ms（毫秒）。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。float value动画播放速度。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。[ArkUI_AnimationCurve](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_animationcurve) value动画曲线。默认值：ARKUI_CURVE_LINEAR。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。int32_t value动画延迟播放时间，单位为ms（毫秒）。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。int32_t value动画播放次数。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。[ArkUI_AnimationPlayMode](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_animationplaymode) value动画播放模式。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option动画效果参数。[ArkUI_ExpectedFrameRateRange](ArkUI_ExpectedFrameRateRange.md)* value动画的期望帧率，单位为帧/秒（fps）。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* optionanimator动画参数。[ArkUI_CurveHandle](ArkUI_Curve_.md) value动画曲线参数。
...
参数项描述[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* optionanimator动画参数。

**返回：**

类型说明[ArkUI_CurveHandle](ArkUI_Curve_.md)动画的动画曲线。参数option异常时返回NULL。
...
类型说明[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)*关键帧动画参数对象。size小于0时返回NULL。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数对象。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。int32_t value延时时间, 单位为ms（毫秒）。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。int32_t value动画播放次数。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。void* userData用户自定义对象指针。void (*onFinish)(void* userData)
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。[ArkUI_ExpectedFrameRateRange](ArkUI_ExpectedFrameRateRange.md)* frameRate关键帧动画的期望帧率。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。int32_t value持续时间，单位为ms（毫秒）。int32_t index状态索引值。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。[ArkUI_CurveHandle](ArkUI_Curve_.md) value该关键帧使用的动画曲线。默认值：EASE_IN_OUT。int32_t index状态索引值。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。void* userData用户定义对象指针。void (*event)(void* userData)闭包函数。int32_t index状态索引值。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。
...
类型说明[ArkUI_ExpectedFrameRateRange](ArkUI_ExpectedFrameRateRange.md)*关键帧动画参数的期望帧率。
...
参数项描述[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。int32_t index状态索引值。
...
类型说明[ArkUI_CurveHandle](ArkUI_Curve_.md)动画曲线。函数参数异常时返回NULL。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。int32_t value播放的时长，单位毫秒。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。int32_t value延时播放时长，单位为ms（毫秒）。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。int32_t value动画播放次数。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。[ArkUI_AnimationFillMode](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_animationfillmode) value动画执行后是否恢复到初始状态。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。[ArkUI_AnimationDirection](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_animationdirection) value动画播放方向。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。[ArkUI_CurveHandle](ArkUI_Curve_.md) value动画插值曲线。默认值：ARKUI_CURVE_LINEAR。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。float value动画插值起点。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。float value动画插值终点。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。[ArkUI_ExpectedFrameRateRange](ArkUI_ExpectedFrameRateRange.md)* value期望的帧率范围对象。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。float time关键帧时间。取值范围：[0, 1], 必须是递增。float value关键帧数值。int32_t index关键帧的索引值。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。[ArkUI_CurveHandle](ArkUI_Curve_.md) value动画插值曲线。int32_t index关键帧的索引值。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画参数。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画动画参数。
...
类型说明[ArkUI_CurveHandle](ArkUI_Curve_.md)动画插值曲线。
...
类型说明[ArkUI_ExpectedFrameRateRange](ArkUI_ExpectedFrameRateRange.md)*期望的帧率范围对象指针。函数参数异常时返回NULL。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画对象参数。int32_t index关键帧的索引值。
...
类型说明[ArkUI_CurveHandle](ArkUI_Curve_.md)动画插值曲线。函数参数异常时返回NULL。
...
参数项描述[ArkUI_AnimatorEvent](ArkUI_AnimatorEvent.md)* event动画事件对象。
...
参数项描述[ArkUI_AnimatorOnFrameEvent](ArkUI_AnimatorOnFrameEvent.md)* event动画事件对象。
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画参数。void* userData用户自定义参数。void (*callback)(ArkUI_AnimatorOnFrameEvent* event)
...
参数项描述[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画参数。void* userData用户自定义参数。void (*callback)(ArkUI_AnimatorEvent* event)
...
参数项描述[ArkUI_AnimatorHandle](ArkUI_Animator_.md) animatorHandleanimator动画对象。[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画参数。
...
参数项描述[ArkUI_AnimatorHandle](ArkUI_Animator_.md) animatorHandleanimator动画对象。
...
类型说明[ArkUI_CurveHandle](ArkUI_Curve_.md)曲线的插值对象指针。如果参数异常返回NULL。
...
参数项描述[ArkUI_CurveHandle](ArkUI_Curve_.md) curveHandle曲线的插值对象指针。
...
类型说明[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)*组件转场时的透明度效果对象。
...
参数项描述[ArkUI_TranslationOptions](ArkUI_TranslationOptions.md)* translate组件转场时的平移参数对象。

**返回：**

类型说明[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)*组件转场时的平移效果对象。如果参数异常返回NULL。
...
参数项描述[ArkUI_ScaleOptions](ArkUI_ScaleOptions.md)* scale组件转场时的缩放参数对象。

**返回：**

类型说明[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)*组件转场时的缩放效果对象。如果参数异常返回NULL。
...
参数项描述[ArkUI_RotationOptions](ArkUI_RotationOptions.md)* rotate组件转场时的旋转参数对象。

**返回：**

类型说明[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)*组件转场时的旋转效果对象。如果参数异常返回NULL。
...
参数项描述[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)* appear出现的转场效果。[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)* disappear消失的转场效果。

**返回：**

类型说明[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)*非对称的转场效果对象。如果参数异常返回NULL。
...
参数项描述[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)* effect转场效果对象。
...
参数项描述[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)* firstEffect转场效果。[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)* secondEffect需要链式转场效果。
...
参数项描述[ArkUI_TransitionEffect](ArkUI_TransitionEffect.md)* effect转场效果。[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* animation属性显示动画效果相关参数。
