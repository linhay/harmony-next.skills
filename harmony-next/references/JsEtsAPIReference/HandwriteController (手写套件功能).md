...
矩形左侧的位置。单位：手写套件组件[HandwriteComponent](HandwriteComponent（手写套件组件）.md)宽度的1/1000。

top

number

矩形顶部的位置。单位：手写套件组件[HandwriteComponent](HandwriteComponent（手写套件组件）.md)宽度的1/1000。

right

number

矩形右侧的位置。单位：手写套件组件[HandwriteComponent](HandwriteComponent（手写套件组件）.md)宽度的1/1000。

bottom

number

矩形底部的位置。单位：手写套件组件[HandwriteComponent](HandwriteComponent（手写套件组件）.md)宽度的1/1000。
