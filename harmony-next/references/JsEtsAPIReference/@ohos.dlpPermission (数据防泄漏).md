...
以下错误码的详细介绍请参见[DLP服务错误码](DLP服务错误码.md)。
...
参数名类型必填说明context[common.UIAbilityContext](UIAbilityContext.md)是当前窗口UIAbility上下文。want[Want](@ohos.app.ability.Want (Want).md)是请求对象。
...
以下错误码的详细介绍请参见[通用错误码说明文档](通用错误码.md)和[DLP服务错误码](DLP服务错误码.md)。
...
名称类型只读可选说明authAccountstring否否表示被授权用户账号。不超过255字节。authAccountType[AccountType](#ZH-CN_TOPIC_0000002497605376__accounttype21)否否表示被授权用户账号类型。dlpFileAccess[DLPFileAccess](zh-cn_topic_0000002497605376.html#ZH-CN_TOPIC_0000002497605376__dlpfileaccess)否否表示被授予的权限。permExpiryTimenumber否否表示授权到期时间。
