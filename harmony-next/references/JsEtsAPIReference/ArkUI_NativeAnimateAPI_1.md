...
参数项描述[ArkUI_ContextHandle](ArkUI_Context_.md) contextUIContext实例。[ArkUI_AnimateOption](ArkUI_AnimateOption.md)* option设置动画效果相关参数。[ArkUI_ContextCallback](ArkUI_ContextCallback.md)* update指定动效的闭包函数，在闭包函数中导致的状态变化系统会自动插入过渡动画。[ArkUI_AnimateCompleteCallback](ArkUI_AnimateCompleteCallback.md)* complete设置动画播放完成回调参数。
...
参数项描述[ArkUI_ContextHandle](ArkUI_Context_.md) contextUIContext实例。[ArkUI_KeyframeAnimateOption](ArkUI_KeyframeAnimateOption.md)* option关键帧动画参数。
...
参数项描述[ArkUI_ContextHandle](ArkUI_Context_.md) contextUIContext实例。[ArkUI_AnimatorOption](ArkUI_AnimatorOption.md)* optionanimator动画参数。

**返回：**

类型说明[ArkUI_AnimatorHandle](ArkUI_Animator_.md)animator动画对象指针。函数参数异常时返回NULL。
