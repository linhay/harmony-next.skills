...
[Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<string | [Subject](#section242033555713)[]>
...
[ImageAnalyzerVisibility](#section7314173721119)
...
要选中的主体id列表。通过[getSubject](#section7245340164614)获取，只有图片识别结果中包含的主体id才有效。
...
Promise<[Subject](#section242033555713)[] | null>
...
struct ImageDemo {
  private visionImageAnalyzerController: visionImageAnalyzer.VisionImageAnalyzerController =
    new visionImageAnalyzer.VisionImageAnalyzerController()
  getSelectedSubjects() {
    this.visionImageAnalyzerController.getSelectedSubjects().then((subjects: visionImageAnalyzer.Subject[] | null) => {
...
根据点位获取对应位置的主体。使用Promise异步回调。调用此接口前需先调用[startSubjectAnalyzer](#section2238839144418)开启主体识别。
...
[visionBase.Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#section1465431712919)
...
struct ImageDemo {
  ...
  getSelectedSubjects() {
    ...
    this.visionImageAnalyzerController.getSubject(searchPoint).then((subjects: visionImageAnalyzer.Subject | null) => {
...
主体id列表。通过[getSubject](#section7245340164614)获取。
...
Promise<[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | null>
...
Promise<[ImageAnalyzerUIStatus](#section1079155235910)>
...
视觉搜索若在[Swiper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper)容器切换图场景下无法生效，则需要在图片切换的[onAnimationStart](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onanimationstart9)中置空一下当前选中图片的index，再由[onAnimationEnd](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onanimationend9)时将当前选中index置成当前index，以此实现overlay跟随图片变动而变动。
...
[Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[AIButtonStatus](#section1612865961116)>
...
[Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[ImageAnalyzerVisibility](#section7314173721119)>
...
[Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[Subject](#section242033555713)[]>
...
[Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[ObjectSearchPanelVisibility](#section7671145547)>
...
[Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<void>
