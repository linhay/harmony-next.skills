...
不支持在CustomBuilder中使用bindMenu和bindContextMenu弹出多级菜单。对此，可以使用[Menu组件](Menu.md)来实现多级菜单。
...
仅支持使用[Menu组件](Menu.md)且子组件包含[MenuItem](MenuItem.md)或[MenuItemGroup](MenuItemGroup.md)的场景。
...
参数名类型必填说明contentArray<[MenuElement](#ZH-CN_TOPIC_0000002497604848__menuelement)> | [CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)是配置菜单项图标和文本的数组，或者自定义组件。options[MenuOptions](#ZH-CN_TOPIC_0000002497604848__menuoptions10)否配置弹出菜单的参数。
...
contentArray<[MenuElement](#ZH-CN_TOPIC_0000002497604848__menuelement)> | [CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)是配置菜单项图标和文本的数组，或者自定义组件。options[MenuOptions](#ZH-CN_TOPIC_0000002497604848__menuoptions10)否配置弹出菜单的参数。
...
不支持在输入法类型窗口中使用bindContextMenu(默认子窗实现)，详情见输入法框架的约束与限制说明[createPanel](@ohos.inputMethodEngine (输入法服务).md#ZH-CN_TOPIC_0000002529445255__createpanel10-1)。
...
参数名类型必填说明content[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是自定义菜单内容构造器。responseType[ResponseType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__responsetype8)是菜单弹出条件，长按或者右键点击。不支持鼠标长按。options[ContextMenuOptions](#ZH-CN_TOPIC_0000002497604848__contextmenuoptions10)否配置弹出菜单的参数。
...
preview11+[MenuPreviewMode](#ZH-CN_TOPIC_0000002497604848__menupreviewmode11) | [CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)否是
...
名称值说明AUTO0预览图根据[Placement](枚举说明.md#ZH-CN_TOPIC_0000002529284967__placement8)自动调整预览图宽高及缩放。CONSTANT1预览图不缩放，大小保持不变。最终仍会受到安全区的限制而出现压缩、裁剪。MAINTAIN2预览图缩放时保持宽高比。
