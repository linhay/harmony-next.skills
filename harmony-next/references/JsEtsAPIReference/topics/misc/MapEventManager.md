...
on(type: 'cameraChange', callback: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>): void
...
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 是 | 回调函数，返回mapCommon.LatLng，监听地图相机状态变化事件。该回调不会在动画过程中触发，而是在动画结束时触发。 |
...
off(type: 'cameraChange', callback?: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'cameraChange'：监听地图相机状态变化事件。 |
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 否 | 回调函数，返回mapCommon.LatLng，取消监听地图相机状态变化事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'mapClick', callback: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>): void
...
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 是 | 回调函数，返回mapCommon.LatLng，监听地图点击事件。 |
...
off(type: 'mapClick', callback?: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#ZH-CN_TOPIC_0000002522082416__latlng)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapClick'：监听地图点击事件。 |
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 否 | 回调函数，返回mapCommon.LatLng，取消监听地图点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'mapLongClick', callback: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>): void
...
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 是 | 回调函数，返回mapCommon.LatLng，监听地图长按事件。 |
...
off(type: 'mapLongClick', callback?: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapLongClick'：监听地图长按事件。 |
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 否 | 回调函数，返回mapCommon.LatLng，取消监听地图长按事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'myLocationClick', callback: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>): void
...
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 是 | 回调函数，返回mapCommon.LatLng，监听我的位置点击事件。 |
...
off(type: 'myLocationClick', callback?: Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'myLocationClick'：监听我的位置点击事件。 |
| callback | Callback<[mapCommon.LatLng](mapCommon（地图属性模型）.md#section20691173773810)> | 否 | 回调函数，返回mapCommon.LatLng，取消监听我的位置点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'poiClick', callback: Callback<[mapCommon.Poi](mapCommon（地图属性模型）.md#section1155919456273)>): void
...
| callback | Callback<[mapCommon.Poi](mapCommon（地图属性模型）.md#section1155919456273)> | 是 | 回调函数，返回mapCommon.Poi，监听POI点击事件。 |
...
off(type: 'poiClick', callback?: Callback<[mapCommon.Poi](mapCommon（地图属性模型）.md#section1155919456273)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'poiClick'：监听POI点击事件。 |
| callback | Callback<[mapCommon.Poi](mapCommon（地图属性模型）.md#section1155919456273)> | 否 | 回调函数，返回mapCommon.Poi，取消监听POI点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'markerClick', callback: Callback<[Marker](Marker.md)>): void
...
| callback | Callback<[Marker](Marker.md)> | 是 | 回调函数，返回Marker，监听标记点击事件。 |
...
off(type: 'markerClick', callback?: Callback<[Marker](Marker.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerClick'：监听标记点击事件。 |
| callback | Callback<[Marker](Marker.md)> | 否 | 回调函数，返回Marker，取消监听标记点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'markerDragStart', callback: Callback<[Marker](Marker.md)>): void
...
| callback | Callback<[Marker](Marker.md)> | 是 | 回调函数，返回Marker，监听标记开始拖拽事件。 |
...
off(type: 'markerDragStart', callback?: Callback<[Marker](Marker.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDragStart'：监听标记开始拖拽事件。 |
| callback | Callback<[Marker](Marker.md)> | 否 | 回调函数，返回Marker，取消监听标记开始拖拽事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'markerDrag', callback: Callback<[Marker](Marker.md)>): void
...
| callback | Callback<[Marker](Marker.md)> | 是 | 回调函数，返回Marker，监听标记拖拽事件。 |
...
off(type: 'markerDrag', callback?: Callback<[Marker](Marker.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDrag'：监听标记拖拽事件。 |
| callback | Callback<[Marker](Marker.md)> | 否 | 回调函数，返回Marker，取消监听标记拖拽事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'markerDragEnd', callback: Callback<[Marker](Marker.md)>): void
...
| callback | Callback<[Marker](Marker.md)> | 是 | 回调函数，返回Marker，监听标记拖拽结束事件。 |
...
off(type: 'markerDragEnd', callback?: Callback<[Marker](Marker.md)>): void
...
| callback | Callback<[Marker](Marker.md)> | 否 | 回调函数，返回Marker，取消监听标记拖拽结束事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'circleClick', callback: Callback<[MapCircle](MapCircle.md)>): void
...
| callback | Callback<[MapCircle](MapCircle.md)> | 是 | 回调函数，返回MapCircle，监听圆点击事件。 |
...
off(type: 'circleClick', callback?: Callback<[MapCircle](MapCircle.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'circleClick'：监听圆点击事件。 |
| callback | Callback<[MapCircle](MapCircle.md)> | 否 | 回调函数，返回MapCircle，取消监听圆点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'polylineClick', callback: Callback<[MapPolyline](MapPolyline.md)>): void
...
| callback | Callback<[MapPolyline](MapPolyline.md)> | 是 | 回调函数，返回MapPolyline，监听折线点击事件。 |
...
off(type: 'polylineClick', callback?: Callback<[MapPolyline](MapPolyline.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'polylineClick'：监听折线点击事件。 |
| callback | Callback<[MapPolyline](MapPolyline.md)> | 否 | 回调函数，返回MapPolyline，取消监听折线点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'polygonClick', callback: Callback<[MapPolygon](MapPolygon.md)>): void
...
| callback | Callback<[MapPolygon](MapPolygon.md)> | 是 | 回调函数，返回MapPolygon，监听多边形点击事件。 |
...
off(type: 'polygonClick', callback?: Callback<[MapPolygon](MapPolygon.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'polygonClick'：监听多边形点击事件。 |
| callback | Callback<[MapPolygon](MapPolygon.md)> | 否 | 回调函数，返回MapPolygon，取消监听多边形点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'infoWindowClick', callback: Callback<[Marker](Marker.md)>): void
...
| callback | Callback<[Marker](Marker.md)> | 是 | 回调函数，返回Marker，监听信息窗点击事件。 |
...
off(type: 'infoWindowClick', callback?: Callback<[Marker](Marker.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClick'：监听信息窗点击事件。 |
| callback | Callback<[Marker](Marker.md)> | 否 | 回调函数，返回Marker，取消监听信息窗点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'infoWindowClose', callback: Callback<[Marker](Marker.md)>): void
...
| callback | Callback<[Marker](Marker.md)> | 是 | 回调函数，返回Marker，监听信息窗关闭事件。 |
...
off(type: 'infoWindowClose', callback?: Callback<[Marker](Marker.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClose'：监听信息窗关闭事件。 |
| callback | Callback<[Marker](Marker.md)> | 否 | 回调函数，返回Marker，取消监听信息窗关闭事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'pointAnnotationClick', callback: Callback<[PointAnnotation](PointAnnotation.md)>): void
...
| callback | Callback<[PointAnnotation](PointAnnotation.md)> | 是 | 回调函数，返回PointAnnotation，监听点注释点击事件。 |
...
off(type: 'pointAnnotationClick', callback?: Callback<[PointAnnotation](PointAnnotation.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'pointAnnotationClick'：监听点注释点击事件。 |
| callback | Callback<[PointAnnotation](PointAnnotation.md)> | 否 | 回调函数，返回PointAnnotation，取消监听点注释点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'bubbleClick', callback: Callback<[Bubble](Bubble.md)>): void
...
| callback | Callback<[Bubble](Bubble.md)> | 是 | 回调函数，返回Bubble，监听气泡点击事件。 |
...
off(type: 'bubbleClick', callback?: Callback<[Bubble](Bubble.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'bubbleClick'：监听气泡点击事件。 |
| callback | Callback<[Bubble](Bubble.md)> | 否 | 回调函数，返回Bubble，取消监听气泡点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'imageOverlayClick', callback: Callback<[ImageOverlay](../../types/interfaces/ImageOverlay.md)>): void
...
| callback | Callback<[ImageOverlay](../../types/interfaces/ImageOverlay.md)> | 是 | 回调函数，返回ImageOverlay，监听覆盖物点击事件。 |
...
off(type: 'imageOverlayClick', callback?: Callback<[ImageOverlay](../../types/interfaces/ImageOverlay.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'imageOverlayClick'：监听覆盖物点击事件。 |
| callback | Callback<[ImageOverlay](../../types/interfaces/ImageOverlay.md)> | 否 | 回调函数，返回ImageOverlay，取消监听覆盖物点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
...
on(type: 'indoorMapEnter', callback: Callback<[IndoorMapInfo](../../types/interfaces/IndoorMapInfo.md)>): void
...
| callback | Callback<[IndoorMapInfo](../../types/interfaces/IndoorMapInfo.md)> | 是 | 回调函数，返回IndoorMapInfo，监听室内图进入事件。 |
...
off(type: 'indoorMapEnter', callback?: Callback<[IndoorMapInfo](../../types/interfaces/IndoorMapInfo.md)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'indoorMapEnter'：监听室内图进入事件。 |
| callback | Callback<[IndoorMapInfo](../../types/interfaces/IndoorMapInfo.md)> | 否 | 回调函数，返回IndoorMapInfo，取消监听室内图进入事件。 |
...
on(type: 'massPointOverlayClick', callback: [MassPointOverlayCallback](MassPointOverlayCallback.md)): void
...
| callback | [MassPointOverlayCallback](MassPointOverlayCallback.md) | 是 | 回调函数，无返回结果的回调函数，监听海量点图层点击事件。 |
...
off(type: 'massPointOverlayClick', callback?: [MassPointOverlayCallback](MassPointOverlayCallback.md)): void
...
| callback | [MassPointOverlayCallback](MassPointOverlayCallback.md) | 否 | 回调函数，无返回结果的回调函数，取消监听海量点图层点击事件。 - callback为空：取消所有callback回调。 - callback非空：取消指定的callback回调。 |
