...
设置组件的不透明度。与[opacity](#ZH-CN_TOPIC_0000002529444799__opacity)相比，opacity参数新增了对undefined类型的支持。
...
参数名类型必填说明opacityOptional<number | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)>是
...
该示例主要显示通过[opacity](#ZH-CN_TOPIC_0000002529444799__opacity)设置组件的不透明度。
