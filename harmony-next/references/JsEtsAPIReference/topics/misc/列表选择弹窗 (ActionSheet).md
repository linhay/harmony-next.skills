...
名称类型只读可选说明titlestring | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否否
...
subtitle10+[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
messagestring | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否否
...
confirm[ActionSheetButtonOptions](#ZH-CN_TOPIC_0000002497604934__actionsheetbuttonoptions18对象说明)否是

确认Button的使能状态、默认焦点、按钮风格、文本内容和点击回调。在弹窗获焦且未进行tab键走焦时，该按钮默认响应Enter键。多重弹窗情况下，可自动获焦并连续响应。默认响应Enter键能力在defaultFocus为true时不生效。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

cancel[VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否是

点击遮障层关闭dialog时的回调。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

alignment[DialogAlignment](../components/警告弹窗 (AlertDialog).md#ZH-CN_TOPIC_0000002529444899__dialogalignment枚举说明)否是
...
offset[ActionSheetOffset](#ZH-CN_TOPIC_0000002497604934__actionsheetoffset18对象说明)否是
...
sheetsArray<[SheetInfo](#ZH-CN_TOPIC_0000002497604934__sheetinfo对象说明)>否否

设置选项内容，每个选择项支持设置图片、文本和选中的回调。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

maskRect10+[Rectangle](../components/警告弹窗 (AlertDialog).md#ZH-CN_TOPIC_0000002529444899__rectangle8类型说明)否是
...
onWillDismiss12+Callback<[DismissDialogAction](#ZH-CN_TOPIC_0000002497604934__dismissdialogaction12)>否是
...
cornerRadius12+[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [BorderRadiuses](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__borderradiuses9) | [LocalizedBorderRadiuses](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedborderradiuses12)否是
...
borderWidth12+[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [EdgeWidths](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__edgewidths9) | [LocalizedEdgeWidths](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizededgewidths12)否是
...
borderColor12+[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [EdgeColors](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__edgecolors9) | [LocalizedEdgeColors](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizededgecolors12)否是
...
borderStyle12+[BorderStyle](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__borderstyle) | [EdgeStyles](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__edgestyles9)否是
...
levelMode15+[LevelMode](#ZH-CN_TOPIC_0000002497604934__levelmode15)否是
...
设置页面级弹窗需要显示的层级下的[节点 uniqueId](../components/FrameNode.md#ZH-CN_TOPIC_0000002529284787__getuniqueid12)。
...
immersiveMode15+[ImmersiveMode](#ZH-CN_TOPIC_0000002497604934__immersivemode15)否是
...
levelOrder18+[LevelOrder](../../modules/ohos/@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__levelorder18)否是
...
iconstring | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是

选项的图标，默认无图标显示。

string格式可用于加载网络图片和本地图片，常用于加载网络图片。当使用相对路径引用本地图片时，例如Image("common/test.jpg")。

action[VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否否选项选中的回调。
...
类型说明[LevelMode](../../modules/ohos/@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__levelmode15枚举说明)设置弹窗的显示层级。
...
类型说明[ImmersiveMode](../../modules/ohos/@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__immersivemode15枚举说明)设置页面内弹窗的蒙层效果。
...
value8+string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否否
...
action8+[VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否否
...
名称类型只读可选说明dxnumber | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否否
...
dynumber | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否否
...
从API version 8开始支持，从API version 18开始废弃，建议使用[showActionSheet](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showactionsheet)替代。showActionSheet需先获取[UIContext](../../types/classes/Class (UIContext).md)实例后再进行调用。

从API version 10开始，可以通过使用[UIContext](../../types/classes/Class (UIContext).md)中的[showActionSheet](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showactionsheet)来明确UI的执行上下文。
...
参数名类型必填说明value[ActionSheetOptions](#ZH-CN_TOPIC_0000002497604934__actionsheetoptions对象说明)是配置列表选择弹窗的参数。

#### 示例

直接使用ActionSheet可能导致实例不明确的问题，建议使用getUIContext()获取[UIContext](../../types/classes/Class (UIContext).md)实例，并使用[showActionSheet](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showactionsheet)调用绑定实例的ActionSheet.show()。
...
从API version 19开始，该示例通过配置[backgroundBlurStyleOptions](#ZH-CN_TOPIC_0000002497604934__actionsheetoptions对象说明)，实现自定义背景模糊效果。
...
从API version 19开始，该示例通过配置[backgroundEffect](#ZH-CN_TOPIC_0000002497604934__actionsheetoptions对象说明)，实现自定义背景效果。
