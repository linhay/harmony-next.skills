...
名称类型必填装饰器类型说明itemsArray<[IconItemOptions](#ZH-CN_TOPIC_0000002497604954__iconitemoptions) | [SymbolGlyphModifier](动态属性设置.md) | [ SymbolItemOptions](#ZH-CN_TOPIC_0000002497604954__symbolitemoptions14)>是@Require @Prop自定义builder items。
...
Chip大小是ChipSize.NORMAL时，suffix默认值：{width: 24,height: 24}。
 ...
 如果想动态修改size，那么必须在引入[IconGroupSuffix](#ZH-CN_TOPIC_0000002497604954__icongroupsuffix)时，使用[SymbolGlyphModifier](动态属性设置.md)类型。
...
名称类型只读可选说明src[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否否图标图片或图片地址引用请参考[Image](../graphics/Image.md#ZH-CN_TOPIC_0000002497444922__image-1)。size[SizeOptions](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__sizeoptions)否是
