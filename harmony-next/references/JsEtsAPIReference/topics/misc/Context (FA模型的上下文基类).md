...
Context对象是在featureAbility中创建实例，并通过featureAbility的[getContext](@ohos.ability.featureAbility (FeatureAbility模块).md#ZH-CN_TOPIC_0000002522240548__featureabilitygetcontext)接口返回，因此在使用Context时，必须导入@ohos.ability.featureAbility库。示例如下：
