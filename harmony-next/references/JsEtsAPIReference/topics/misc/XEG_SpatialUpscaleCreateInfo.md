...
VkExtent2D [inputSize](#ZH-CN_TOPIC_0000002328159352__inputsize)

超分输入图像的尺寸，必须与超分输入图像的VkimageView的尺寸一致，否则会导致未定义问题，如超分失败、程序崩溃等。

VkRect2D [inputRegion](#ZH-CN_TOPIC_0000002328159352__inputregion)
...
VkExtent2D [outputSize](#ZH-CN_TOPIC_0000002328159352__outputsize)

超分输出图像的尺寸，必须与超分结果VkimageView的尺寸一致，否则会导致未定义问题，如超分失败、程序崩溃等。

VkRect2D [outputRegion](#ZH-CN_TOPIC_0000002328159352__outputregion)
...
VkFormat [format](#ZH-CN_TOPIC_0000002328159352__format)

超分输入图像的格式。

float [sharpness](#ZH-CN_TOPIC_0000002328159352__sharpness)
