...
通用属性仅支持[aspectRatio](布局约束.md#ZH-CN_TOPIC_0000002529444795__aspectratio)、[backdropBlur](背景设置.md#ZH-CN_TOPIC_0000002529444791__backdropblur)、[backgroundColor](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundcolor)、[bindContentCover](全屏模态转场.md#ZH-CN_TOPIC_0000002529444815__bindcontentcover)、[bindContextMenu](菜单控制.md#ZH-CN_TOPIC_0000002497604848__bindcontextmenu8)、[bindMenu ](菜单控制.md#ZH-CN_TOPIC_0000002497604848__bindmenu)、[bindSheet](半模态转场.md#ZH-CN_TOPIC_0000002497604850__bindsheet)、[borderColor](边框设置.md#ZH-CN_TOPIC_0000002497604832__bordercolor)、[borderRadius](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderradius)、[borderStyle](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderstyle)、[borderWidth](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderwidth)、[clip](形状裁剪.md#ZH-CN_TOPIC_0000002529284827__clip12)、[constraintSize](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__constraintsize)、[defaultFocus](焦点控制.md#ZH-CN_TOPIC_0000002529444807__defaultfocus9)、[focusable](焦点控制.md#ZH-CN_TOPIC_0000002529444807__focusable)、[tabIndex](焦点控制.md#ZH-CN_TOPIC_0000002529444807__tabindex9)、[groupDefaultFocus](焦点控制.md#ZH-CN_TOPIC_0000002529444807__groupdefaultfocus9)、[displayPriority](布局约束.md#ZH-CN_TOPIC_0000002529444795__displaypriority)、[enabled](禁用控制.md#ZH-CN_TOPIC_0000002529284833__enabled)、[flexBasis](Flex布局.md#ZH-CN_TOPIC_0000002497604830__flexbasis)、[flexShrink](Flex布局.md#ZH-CN_TOPIC_0000002497604830__flexshrink)、[layoutWeight](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__layoutweight)、[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)、[gridOffset](栅格设置.md#ZH-CN_TOPIC_0000002529284971__属性)、[gridSpan](栅格设置.md#ZH-CN_TOPIC_0000002529284971__属性)、[useSizeType](栅格设置.md#ZH-CN_TOPIC_0000002529284971__属性)、[height](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__height)、[touchable](点击控制.md#ZH-CN_TOPIC_0000002497445000__touchabledeprecated)、[margin](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__margin)、[markAnchor](位置设置.md#ZH-CN_TOPIC_0000002529284821__markanchor)、[offset](位置设置.md#ZH-CN_TOPIC_0000002529284821__offset)、[width](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__width)、[zIndex](Z序控制.md#ZH-CN_TOPIC_0000002497444848__zindex)、[visibility](显隐控制.md#ZH-CN_TOPIC_0000002529284817__visibility)、[scale](图形变换.md#ZH-CN_TOPIC_0000002497604834__scale)、[translate](图形变换.md#ZH-CN_TOPIC_0000002497604834__translate)、[responseRegion](触摸热区设置.md#ZH-CN_TOPIC_0000002497604844__responseregion)、[size](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__size)、[opacity](透明度设置.md#ZH-CN_TOPIC_0000002529444799__opacity)、[shadow](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadow)、[sharedTransition](../media/共享元素转场 (sharedTransition).md)、[transition](组件内转场 (transition).md)、[position](位置设置.md#ZH-CN_TOPIC_0000002529284821__position)、[direction](位置设置.md#ZH-CN_TOPIC_0000002529284821__direction)。
...
参数名类型必填说明domStorageAccessboolean是
...
此接口只支持注册一个对象，若需要注册多个对象请使用[registerJavaScriptProxy9+](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__registerjavascriptproxy)。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明javaScriptProxy[JavaScriptProxy](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__javascriptproxy12)是
...
参数名类型必填说明javaScriptAccessboolean是
...
参数名类型必填说明mode[OverScrollMode](Enums.md#ZH-CN_TOPIC_0000002497605218__overscrollmode11)是
...
参数名类型必填说明mixedMode[MixedMode](Enums.md#ZH-CN_TOPIC_0000002497605218__mixedmode)是
...
参数名类型必填说明onlineImageAccessboolean是
...
参数名类型必填说明overviewModeAccessboolean是
...
参数名类型必填说明databaseAccessboolean是
...
参数名类型必填说明geolocationAccessboolean是
...
使能多窗口权限时，需要实现onWindowNew事件，示例代码参考[onWindowNew事件](事件.md#ZH-CN_TOPIC_0000002497445228__onwindownew9)。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明multiWindowboolean是
...
- 通过@State变量控制横向滚动条的隐藏/显示后，需要调用[controller.refresh()](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__refresh)生效。
...
参数名类型必填说明horizontalScrollBarboolean是
...
参数名类型必填说明verticalScrollBarboolean是
...
参数名类型必填说明cacheMode[CacheMode](Enums.md#ZH-CN_TOPIC_0000002497605218__cachemode)是
...
1. 若minLogicalFontSize和minFontSize同时设置时，对于未指定font-size样式元素，将采用两者中的较大值。
...
当深色模式开启时，Web将启用媒体查询prefers-color-scheme中网页所定义的深色样式，若网页未定义深色样式，则保持原状。如需开启强制深色模式，建议配合[forceDarkAccess](#ZH-CN_TOPIC_0000002497605206__forcedarkaccess9)使用。深色模式具体用法可参考[Web深色模式适配](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-set-dark-mode)。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明mode[WebDarkMode](Enums.md#ZH-CN_TOPIC_0000002497605218__webdarkmode9)是设置Web的深色模式为关闭、开启或跟随系统。
...
设置网页是否开启强制深色模式。该属性仅在[darkMode](#ZH-CN_TOPIC_0000002497605206__darkmode9)开启深色模式时生效。当属性没有显式调用时，默认网页不开启强制深色模式。
...
- 该属性仅在[javaScriptAccess](#ZH-CN_TOPIC_0000002497605206__javascriptaccess)开启时生效。
- 该属性在[multiWindowAccess](#ZH-CN_TOPIC_0000002497605206__multiwindowaccess9)开启时打开新窗口，关闭时打开本地窗口。
...
- 该媒体播放策略将同时管控有声视频。
- 建议为所有Web组件设置相同的[audioExclusive](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__webmediaoptions10)值。
...
参数名类型必填说明options[WebMediaOptions](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__webmediaoptions10)是
...
该脚本按照字典序执行，非数组本身顺序，若需数组本身顺序，建议使用[runJavaScriptOnDocumentStart](#ZH-CN_TOPIC_0000002497605206__runjavascriptondocumentstart15)接口。

-

不建议与[runJavaScriptOnDocumentStart](#ZH-CN_TOPIC_0000002497605206__runjavascriptondocumentstart15)同时使用。
...
参数名类型必填说明scriptsArray<[ScriptItem](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__scriptitem11)>是
...
不建议与[runJavaScriptOnDocumentEnd](#ZH-CN_TOPIC_0000002497605206__runjavascriptondocumentend15)同时使用。
...
不建议与[javaScriptOnDocumentStart](#ZH-CN_TOPIC_0000002497605206__javascriptondocumentstart11)同时使用。
...
不建议与[javaScriptOnDocumentEnd](#ZH-CN_TOPIC_0000002497605206__javascriptondocumentend11)同时使用。
...
参数名类型必填说明mode[WebLayoutMode](Enums.md#ZH-CN_TOPIC_0000002497605218__weblayoutmode11)是
...
2、指明layoutMode为WebLayoutMode.FIT_CONTENT模式，为避免嵌套滚动场景下，Web滚动到边缘时会优先触发过滚动的过界回弹效果影响用户体验，建议指定[overScrollMode](#ZH-CN_TOPIC_0000002497605206__overscrollmode11)为OverScrollMode.NEVER。
...
- 支持嵌套滚动的容器：[Grid](../components/Grid.md)、[List](../components/list.md)、[Scroll](../components/Scroll.md)、[Swiper](swiper.md)、[Tabs](../components/tabs.md)、[WaterFlow](WaterFlow.md)、[Refresh](refresh.md)、[bindSheet](半模态转场.md#ZH-CN_TOPIC_0000002497604850__bindsheet)。
- 支持嵌套滚动的输入事件：使用手势、鼠标、触控板。
- 嵌套滚动场景下，由于Web滚动到边缘时会优先触发过滚动的过界回弹效果，建议设置[overScrollMode](#ZH-CN_TOPIC_0000002497605206__overscrollmode11)为OverScrollMode.NEVER，避免影响此场景的用户体验。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明value[NestedScrollOptions](滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__nestedscrolloptions10对象说明) | [NestedScrollOptionsExt](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nestedscrolloptionsext14)14+是

可滚动组件滚动时的嵌套滚动选项。

value为NestedScrollOptions（向前、向后两个方向）类型时，scrollForward、scrollBackward默认滚动选项为[NestedScrollMode.SELF_FIRST](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__nestedscrollmode10)。
...
参数名类型必填说明condition[WebBypassVsyncCondition](Enums.md#ZH-CN_TOPIC_0000002497605218__webbypassvsynccondition20)是
...
参数名类型必填说明tagstring是标签名。typestring是标签类型，内核使用前缀匹配此参数。
...
参数名类型必填说明textEncodingFormatstring是
...
参数名类型必填说明textAutosizingboolean是
...
参数名类型必填说明config[NativeMediaPlayerConfig](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativemediaplayerconfig12)是
...
参数名类型必填说明callback[OnAdsBlockedCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onadsblockedcallback12)是广告过滤的回调。
...
当UIContext设置的键盘避让模式为[KeyboardAvoidMode.RESIZE](Enums.md#ZH-CN_TOPIC_0000002497604786__keyboardavoidmode11)模式时，该接口功能不生效。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明mode[WebKeyboardAvoidMode](Enums.md#ZH-CN_TOPIC_0000002497605218__webkeyboardavoidmode12)是
...
在[onCreateMenu](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__oncreatemenu12)中，可以修改、增加、删除菜单选项，如果希望不显示文本菜单，需要返回空数组。

在[onMenuItemClick](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__onmenuitemclick12)中，可以自定义菜单选项的回调函数。该函数在菜单选项被点击后触发，并根据返回值决定是否执行系统默认的回调。返回true不执行系统回调，返回false继续执行系统回调。

在[onPrepareMenu20+](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__属性-1)中，当文本选择区域变化后显示菜单之前触发该回调，可在该回调中进行修改、增加、删除菜单选项，实现动态更新菜单。

本接口在与[selectionMenuOptions(deprecated)](#ZH-CN_TOPIC_0000002497605206__selectionmenuoptionsdeprecated)同时使用时，会使selectionMenuOptions(deprecated)不生效。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明editMenu[EditMenuOptions](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__editmenuoptions)是

Web自定义文本菜单选项。

菜单项数量，及菜单的content大小、icon图标尺寸，与ArkUI [Menu](../components/menu.md)组件保持一致。

菜单中系统自带的id枚举值（[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)）在Web中仅支持CUT、COPY、PASTE、SELECT_ALL、TRANSLATE、SEARCH、AI_WRITER七项。
...
参数名类型必填说明elementType[WebElementType](Enums.md#ZH-CN_TOPIC_0000002497605218__webelementtype13)是菜单的类型。content[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是菜单的内容。responseType[WebResponseType](Enums.md#ZH-CN_TOPIC_0000002497605218__webresponsetype13)是菜单的响应类型。options[SelectionMenuOptionsExt](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__selectionmenuoptionsext13)否菜单的选项。
...
参数名类型必填说明mode[BlurOnKeyboardHideMode](Enums.md#ZH-CN_TOPIC_0000002497605218__bluronkeyboardhidemode14)是设置当软键盘收起时Web元素失焦关闭或开启。默认值：BlurOnKeyboardHideMode.SILENT。
...
参数名类型必填说明optimizeParserBudgetboolean是
...
设置同层渲染相关配置，该属性仅在[enableNativeEmbedMode](#ZH-CN_TOPIC_0000002497605206__enablenativeembedmode11)开启时生效，不支持动态修改。当属性没有显式调用时，默认为{supportDefaultIntrinsicSize: false}。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明options[EmbedOptions](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__embedoptions16)否
...
当enableDataDetector设置为true，同时不设置[dataDetectorConfig](#ZH-CN_TOPIC_0000002497605206__datadetectorconfig20)属性时，默认识别所有类型的实体，所识别实体的color和decoration会被更改为如下样式：
...
当enableDataDetector设置为true且[copyOptions](#ZH-CN_TOPIC_0000002497605206__copyoptions11)设置为CopyOptions.LocalDevice时，AI菜单功能将被激活。此时，在网页中选中文本后，文本选择菜单能够展示对应的AI菜单项，包括[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)中的url（打开连接）、email（新建邮件）、phoneNumber（呼叫）、address（导航至该位置）、dateTime（新建日程提醒）。

AI菜单生效时，需在选中范围内，包括一个完整的AI实体，才能展示对应的选项。该菜单项与[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)中的askAI菜单项不同时出现。
...
需配合[enableDataDetector](#ZH-CN_TOPIC_0000002497605206__enabledatadetector20)一起使用，设置enableDataDetector为true时，dataDetectorConfig的配置才能生效。
...
[copyOptions](#ZH-CN_TOPIC_0000002497605206__copyoptions11)设置为CopyOptions.None时，TextDataDetectorConfig中的enablePreviewMenu配置项无效。
...
AI菜单功能启用时，在网页中选中文本后，文本选择菜单能够展示对应的AI菜单项，包括[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)中的url（打开连接）、email（新建邮件）、phoneNumber（呼叫）、address（导航前往）、dateTime（新建日程）。
...
当enableSelectedDataDetector未配置或设置为true时，将遵循[dataDetectorConfig](#ZH-CN_TOPIC_0000002497605206__datadetectorconfig20)中types的配置；若[dataDetectorConfig](#ZH-CN_TOPIC_0000002497605206__datadetectorconfig20)也未配置，则默认识别所有类型。
...
参数名类型必填说明mode[GestureFocusMode](Enums.md#ZH-CN_TOPIC_0000002497605218__gesturefocusmode20)是设置Web组件手势获焦模式。传入undefined或null时为GestureFocusMode.DEFAULT。
...
参数名类型必填说明effect[WebRotateEffect](Enums.md#ZH-CN_TOPIC_0000002497605218__webrotateeffect22)是设置Web组件旋转时，宽高动画过程中组件内容的填充方式。
...
- 根据detectConfig的配置，在网页加载后检测到白屏或者近似白屏现象，可触发回调[onDetectedBlankScreen](事件.md#ZH-CN_TOPIC_0000002497445228__ondetectedblankscreen22)。
- 设置后下次导航生效。
...
参数名类型必填说明detectConfig[BlankScreenDetectionConfig](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__blankscreendetectionconfig22)是白屏检测的策略配置。
...
从API version 8开始支持，从API version 9开始废弃,建议使用[textZoomRatio9+](#ZH-CN_TOPIC_0000002497605206__textzoomratio9)代替。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明textZoomAtionumber是
...
从API version 8开始支持，从API version 10开始废弃。建议使用[setCustomUserAgent](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__setcustomuseragent10)10+替代。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明userAgentstring是要设置的用户代理。
...
参数名类型必填说明wideViewModeAccessboolean是
...
从API version 12开始支持，从API version 20开始废弃。建议使用[editMenuOptions12+](#ZH-CN_TOPIC_0000002497605206__editmenuoptions12)替代。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明expandedMenuOptionsArray<[ExpandedMenuItemOptions](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__expandedmenuitemoptionsdeprecated)>是

扩展菜单选项。

菜单项数量，及菜单的content大小、startIcon图标尺寸，与ArkUI [Menu](../components/menu.md)组件保持一致。
...
参数名类型必填说明zoomControlAccessboolean是设置是否支持组合按键的默认缩放行为。true表示支持，false表示不支持。传入null或undefined时为false。
