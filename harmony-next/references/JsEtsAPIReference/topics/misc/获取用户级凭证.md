...
当“grant_type”为“authorization_code”时，此参数必选。获取方式详见[LoginWithHuaweiIDResponse](../security/authentication (华为账号应用统一认证服务).md#section15454203811311)或[AuthorizationWithHuaweiIDResponse](../security/authentication (华为账号应用统一认证服务).md#section10418450161620)。
...
ID Token（JWT格式），详细信息请参见[验证ID Token有效性](../security/验证ID Token有效性.md)中ID Token描述。
