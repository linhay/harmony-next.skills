...
继承： HuaweiIDProvider继承自[AuthenticationProvider](#ZH-CN_TOPIC_0000002553202245__authenticationprovider)。
...
以下错误码的详细介绍请参见[账号管理错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-account)和[ArkTS错误码](ArkTS错误码.md)。
...
继承： LoginWithHuaweiIDRequest继承自[AuthenticationRequest](#ZH-CN_TOPIC_0000002553202245__authenticationrequest)。
...
继承： LoginWithHuaweiIDResponse继承自[AuthenticationResponse](#ZH-CN_TOPIC_0000002553202245__authenticationresponse)。
...
继承： AuthorizationWithHuaweiIDRequest继承自[AuthenticationRequest](#ZH-CN_TOPIC_0000002553202245__authenticationrequest)。
...
该类封装[AuthorizationWithHuaweiIDRequest](#ZH-CN_TOPIC_0000002553202245__authorizationwithhuaweiidrequest)授权请求对象获取的用户信息结果。作为华为账号授权成功的返回结果，用于获取或关联华为账号用户信息。
...
继承： AuthorizationWithHuaweiIDResponse继承自[AuthenticationResponse](#ZH-CN_TOPIC_0000002553202245__authenticationresponse)。
...
继承： CancelAuthorizationRequest继承自[AuthenticationRequest](#ZH-CN_TOPIC_0000002553202245__authenticationrequest)。
...
继承： CancelAuthorizationResponse继承自[AuthenticationResponse](#ZH-CN_TOPIC_0000002553202245__authenticationresponse)。
...
该类为获取华为账号登录状态请求对象，作为[getHuaweiIDState](#ZH-CN_TOPIC_0000002553202245__gethuaweiidstate)传参。
