...
节点标识，根据子类[PageDataInfo](#section1064382518239).resourceIndex、[PageDataInfo](#section1064382518239).pageOffset字段自动生成。
...
内容分页信息，继承[PageDatabaseBean](#section393123711811)。
...
书脊内容节点索引[SpineItem](../media/bookParser（书籍解析能力）.md#section1029864651619).index。
...
在智慧多窗等场景，文本缩放因子发生变化时，开发者需要调用ReaderComponentController组件控制器的[setPageConfig](#section6297758718)接口更新该属性。
...
[ReadPageComponent](../components/ReadPageComponent（阅读页组件）.md#section3730195311450)组件控制器，需要配合ReadPageComponent组件一起使用。
...
[1016910004](../../errors/ArkTS API错误码.md#section11556619102)
...
registerBookParser接口需要在[startPlay](#section3667128165411)接口之前调用，否则将会抛出异常。
...
bookParser.[BookParserHandler](../media/bookParser（书籍解析能力）.md#section59035422210)
...
[1016900002](../../errors/ArkTS API错误码.md#section174762013118)

Read Page Component is not initialized.

[1016900003](../../errors/ArkTS API错误码.md#section16343120935)

Invalid request.

[1016900999](../../errors/ArkTS API错误码.md#section14689171516514)
...
[ReaderSetting](#section13615732174218)
...
startPlay接口需在[registerBookParser](#section181215815104)事件成功触发后，才能调用。
...
内容资源索引[SpineItem](../media/bookParser（书籍解析能力）.md#section1029864651619).index。
...
[1016910001](../../errors/ArkTS API错误码.md#section13763141364)

Invalid spine item.

[1016910002](../../errors/ArkTS API错误码.md#section15116730175)

Unexpected spine item resource data.

[1016910003](../../errors/ArkTS API错误码.md#section216871194)
...
触发[ReadPageComponent](../components/ReadPageComponent（阅读页组件）.md#section3730195311450)组件进行翻页。
...
Callback<[PageDataInfo](#section1064382518239)>
...
回调函数，需要传“on('pageShow')”同样的回调函数，若不传则注销所有的回调函数。
...
bookParser.[CallbackRes](../media/bookParser（书籍解析能力）.md#section174676520576)<string, ArrayBuffer>
