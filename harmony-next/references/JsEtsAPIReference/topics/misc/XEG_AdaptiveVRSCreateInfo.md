# [XEG_AdaptiveVRS](XEngine.md#ZH-CN_TOPIC_0000002328319196__xeg_adaptivevrs)CreateInfo

#### 概述

此结构体描述创建[XEG_AdaptiveVRS](XEngine.md#ZH-CN_TOPIC_0000002553202223__xeg_adaptivevrs)对象的参数信息，当结构体中的信息变化时，需要创建新的[XEG_AdaptiveVRS](XEngine.md#ZH-CN_TOPIC_0000002553202223__xeg_adaptivevrs)对象。

**起始版本：** 5.0.0(12)

**相关模块： **[XEngine](XEngine.md)

所在头文件： [xeg_vulkan_adaptive_vrs.h](xeg_vulkan_adaptive_vrs.h.md)
