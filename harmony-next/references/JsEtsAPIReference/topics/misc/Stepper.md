...
名称类型默认值描述indexnumber0设置步骤导航器步骤显示第几个stepper-item子组件，默认显示第一个stepper-item。[]()[]()

#### 样式

支持[通用样式](../components/通用样式 (js-components-common-styles).md)。
