...
云存储的实例，提供云存储的上传、下载等相关能力，通过[bucket](#ZH-CN_TOPIC_0000002522082328__bucket)初始化。
...
完整的元数据信息，继承自[MetadataUpdatable](#ZH-CN_TOPIC_0000002522082328__metadataupdatable)。
