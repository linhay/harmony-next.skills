...
流场图层管理对象。在调用map.[MapComponentController](../components/MapComponentController.md)类的[addFlowFieldOverlay](../components/MapComponentController.md#section7516202017439)方法时会返回该类型的实例，继承[BaseOverlay](BaseOverlay.md)。
