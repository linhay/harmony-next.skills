...
参数名类型必填说明effect[VisualEffect](#ZH-CN_TOPIC_0000002529444803__visualeffect-1)是非滤镜视觉效果。
...
参数名类型必填说明filter[Filter](#ZH-CN_TOPIC_0000002529444803__filter)是背景滤镜视觉效果。
...
参数名类型必填说明filter[Filter](#ZH-CN_TOPIC_0000002529444803__filter)是前景滤镜（内容）视觉效果。
...
参数名类型必填说明filter[Filter](#ZH-CN_TOPIC_0000002529444803__filter)是合成滤镜视觉效果。
...
类型说明[Filter](../../modules/ohos/@ohos.graphics.uiEffect (效果级联).md#ZH-CN_TOPIC_0000002497446008__filter)用于将相应的效果添加到指定的组件上。
...
类型说明[VisualEffect](../../modules/ohos/@ohos.graphics.uiEffect (效果级联).md#ZH-CN_TOPIC_0000002497446008__visualeffect)用于将相应的效果添加到指定的组件上。
