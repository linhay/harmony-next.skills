...
进程数据的对象定义。使用接口[appManager.on('applicationState')](@ohos.app.ability.appManager (应用管理).md#ZH-CN_TOPIC_0000002522080556__appmanageronapplicationstate14)注册生命周期变化监听后，当应用或组件的生命周期变化时，系统通过[ApplicationStateObserver](ApplicationStateObserver.md)的[onProcessCreated](ApplicationStateObserver.md#ZH-CN_TOPIC_0000002522240570__applicationstateobserveronprocesscreated)等方法回调给开发者。
