...
assetDownloadManager提供的接口仅支持调用如下方法：
  ...
  - [assetDownloadManager.fetchManifestUrl](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerfetchmanifesturl)

  - [assetDownloadManager.removeAssetDownloadTask](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerremoveassetdownloadtask)

  - [assetDownloadManager.fetchAllAssetDownloadTasks](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerfetchallassetdownloadtasks)

  - [assetDownloadManager.removeAllAssetDownloadTasks](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerremoveallassetdownloadtasks)

  - [assetDownloadManager.fetchGroupAssetDownloadTasks](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerfetchgroupassetdownloadtasks)

  - [assetDownloadManager.removeGroupAssetDownloadTasks](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerremovegroupassetdownloadtasks)

  - [assetDownloadManager.limitDownloadTaskSpeed](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerlimitdownloadtaskspeed)

  - [assetDownloadManager.reportDownloadProgress](assetDownloadManager（资源包下载管理）.md#ZH-CN_TOPIC_0000002553202195__assetdownloadmanagerreportdownloadprogress)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| maxBackgroundDownloadSize | number | 是 | 否 | 最大的资源大小，单位：字节。只有当用户设备剩余存储空间大于maxBackgroundDownloadSize的三倍时，资源加速ExtensionAbility才会使能。 默认值：0。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | AssetAccelerationExtensionContext | 否 | 否 | AssetAccelerationExtensionAbility的上下文环境，继承自ExtensionContext。 |
