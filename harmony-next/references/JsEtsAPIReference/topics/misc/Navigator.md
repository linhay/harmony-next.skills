...
参数名类型必填说明valueobject是跳转时要同时传递到目标页面的数据，可在目标页面使用[router.getParams()](../../modules/ohos/@ohos.router (页面路由)(不推荐).md#ZH-CN_TOPIC_0000002529444757__routergetparamsdeprecated)获得。
