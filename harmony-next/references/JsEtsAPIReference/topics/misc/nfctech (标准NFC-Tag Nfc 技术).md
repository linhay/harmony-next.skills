...
getNdefRecords(): [tag.NdefRecord](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__ndefrecord9)[]
...
**类型****说明**[tag.NdefRecord](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__ndefrecord9)[]NDEF标签的Record列表，详见NDEF技术规范《NFCForum-TS-NDEF_1.0》。
...
getNdefTagType(): [tag.NfcForumType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__nfcforumtype9)
...
**类型****说明**[tag.NfcForumType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__nfcforumtype9)NDEF标签类型，包括NFC FORUM TYPE 1/2/3/4等。
...
getNdefTagTypeString(type: [tag.NfcForumType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__nfcforumtype9)): string
...
参数名类型必填说明type[tag.NfcForumType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__nfcforumtype9)是NDEF标签类型，包括NFC FORUM TYPE 1/2/3/4等。
...
getType(): [tag.MifareClassicType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__mifareclassictype9)
...
**类型****说明**[tag.MifareClassicType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__mifareclassictype9)MifareClassic标签的类型。
...
获取标签的存储空间大小，具体请参见[MifareClassicSize](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__mifareclassicsize9)。
...
**类型****说明**number标签的大小，单位为字节，请参见[MifareClassicSize](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__mifareclassicsize9)。
...
getType(): [tag.MifareUltralightType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__mifareultralighttype9)
...
**类型****说明**[tag.MifareUltralightType](../../modules/ohos/@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002529445389__mifareultralighttype9)MIFARE Ultralight标签的类型。
