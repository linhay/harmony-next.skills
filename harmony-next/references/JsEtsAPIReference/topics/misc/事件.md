...
通用事件仅支持[onAppear](挂载卸载事件.md#ZH-CN_TOPIC_0000002529284813__onappear)、[onDisAppear](挂载卸载事件.md#ZH-CN_TOPIC_0000002529284813__ondisappear)、[onBlur](焦点事件.md#ZH-CN_TOPIC_0000002497604816__onblur)、[onFocus](焦点事件.md#ZH-CN_TOPIC_0000002497604816__onfocus)、[onDragEnd](拖拽事件.md#ZH-CN_TOPIC_0000002529444781__ondragend10)、[onDragEnter](拖拽事件.md#ZH-CN_TOPIC_0000002529444781__ondragenter)、[onDragStart](拖拽事件.md#ZH-CN_TOPIC_0000002529444781__ondragstart)、[onDragMove](拖拽事件.md#ZH-CN_TOPIC_0000002529444781__ondragmove)、[onDragLeave](拖拽事件.md#ZH-CN_TOPIC_0000002529444781__ondragleave)、[onDrop](拖拽事件.md#ZH-CN_TOPIC_0000002529444781__ondrop)、[onHover](悬浮事件.md#ZH-CN_TOPIC_0000002497444838__onhover)、[onMouse](鼠标事件.md#ZH-CN_TOPIC_0000002497604812__onmouse)、[onKeyEvent](按键事件.md#ZH-CN_TOPIC_0000002529284805__onkeyevent)、[onTouch](触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)、[onVisibleAreaChange](组件可见区域变化事件.md#ZH-CN_TOPIC_0000002497444844__onvisibleareachange)。
...
网页触发alert()告警弹窗时触发回调。若不调用[handleCancel](../../types/classes/Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlecancel)或[handleConfirm](../../types/classes/Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handleconfirm)接口，会造成render进程阻塞。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnAlertEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onalertevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnBeforeUnloadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onbeforeunloadevent12), boolean>是
...
网页调用confirm()告警时触发此回调。若不调用[handleCancel](../../types/classes/Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlecancel)或[handleConfirm](../../types/classes/Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handleconfirm)接口，会造成render进程阻塞。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnConfirmEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconfirmevent12), boolean>是
...
网页调用prompt()告警时触发此回调。若不调用[handleCancel](../../types/classes/Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlecancel)或[handlePromptConfirm](../../types/classes/Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlepromptconfirm9)接口，会造成render进程阻塞。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnPromptEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpromptevent12), boolean>是

网页调用prompt()告警时触发。

返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认、取消和输入），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终处理结果。当回调返回false时，弹窗的处理结果会被视为取消。
...
参数名类型必填说明callbackCallback<[OnConsoleEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconsoleevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnDownloadStartEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondownloadstartevent12)>是开始下载时触发。
...
网页加载遇到错误时触发该回调。主资源与子资源出错都会回调该接口，可以通过[isMainFrame](../../types/classes/Class (WebResourceRequest).md#ZH-CN_TOPIC_0000002497445238__ismainframe)来判断是否是主资源报错。出于性能考虑，建议此回调中尽量执行简单逻辑。在无网络的情况下，触发此回调。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnErrorReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onerrorreceiveevent12)>是网页收到 Web 资源加载错误时触发。
...
参数名类型必填说明callbackCallback<[OnHttpErrorReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttperrorreceiveevent12)>是网页收到加载资源返回HTTP错误码时触发。
...
参数名类型必填说明callbackCallback<[OnPageBeginEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagebeginevent12)>是网页加载开始时触发。
...
参数名类型必填说明callbackCallback<[OnPageEndEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpageendevent12)>是网页加载结束时触发。
...
参数名类型必填说明callbackCallback<[OnLoadStartedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadstartedevent20)>是网页加载开始时触发。
...
参数名类型必填说明callbackCallback<[OnLoadFinishedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadfinishedevent20)>是网页加载结束时触发。
...
参数名类型必填说明callbackCallback<[OnProgressChangeEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onprogresschangeevent12)>是页面加载进度变化时触发的回调。
...
参数名类型必填说明callbackCallback<[OnTitleReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ontitlereceiveevent12)>是页面文档标题发生变更时触发。
...
参数名类型必填说明callbackCallback<[OnRefreshAccessedHistoryEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrefreshaccessedhistoryevent12)>是在导航完成时触发。
...
应用处理该回调时，可以调用绑定的webviewController相关接口来恢复页面。例如[refresh](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__refresh)、[loadUrl](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__loadurl)等。
...
参数名类型必填说明callbackCallback<[OnRenderExitedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrenderexitedevent12)>是渲染过程退出时触发。
...
只要网页进程一直无响应，此回调仍可能会持续触发，直到网页进程再次响应，此时[onRenderProcessResponding](#ZH-CN_TOPIC_0000002497445228__onrenderprocessresponding12)将会触发。

应用可以通过WebviewController接口[terminateRenderProcess](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__terminaterenderprocess12)来终止关联的渲染进程，这可能会影响同一渲染进程的其他Web组件。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback[OnRenderProcessNotRespondingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onrenderprocessnotrespondingcallback12)是渲染进程无响应时触发的回调。
...
参数名类型必填说明callback[OnRenderProcessRespondingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onrenderprocessrespondingcallback12)是渲染进程由无响应状态变回正常运行状态时触发的回调。
...
参数名类型必填说明callbackCallback<[OnShowFileSelectorEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onshowfileselectorevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnResourceLoadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onresourceloadevent12)>是加载url时触发。
...
参数名类型必填说明callbackCallback<[OnScaleChangeEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscalechangeevent12)>是当页面显示比例发生变化时，触发该回调。
...
当Web组件加载URL之前触发该回调，用于拦截URL并返回响应数据。onInterceptRequest可拦截所有跳转请求并返回响应数据，但无法访问POST请求体（Body）内容，且不支持分片缓冲（buffer）类型数据获取。此类场景需改用[WebSchemeHandler](../../types/classes/Class (WebSchemeHandler).md)实现，依据具体业务需求进行判断。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnInterceptRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oninterceptrequestevent12), [WebResourceResponse](../../types/classes/Class (WebResourceResponse).md)>是

当Web组件加载url之前触发。

返回值[WebResourceResponse](../../types/classes/Class (WebResourceResponse).md)。返回响应数据则按照响应数据加载，无响应数据则返回null表示按照原来的方式加载。
...
参数名类型必填说明callbackCallback<[OnHttpAuthRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttpauthrequestevent12), boolean>是
...
如果需要支持子资源，请使用[OnSslErrorEvent](事件.md#ZH-CN_TOPIC_0000002497445228__onsslerrorevent12)接口。

- 主资源：浏览器加载网页的入口文件，通常是HTML文档。
- 子资源：主资源中引用的依赖文件，由主资源解析过程中遇到特定标签时触发加载。
- 应用程序需要调用[handler.handleCancel()](../../types/classes/Class (SslErrorHandler).md#ZH-CN_TOPIC_0000002529445179__handlecancel9)或[handler.handleConfirm()](../../types/classes/Class (SslErrorHandler).md#ZH-CN_TOPIC_0000002529445179__handleconfirm9)处理该回调，如果没有处理该回调则默认取消资源加载。handleConfirm()或者handleCancel()的行为可能会被记录下来，以便为将来的SSL错误做出响应。
...
参数名类型必填说明callbackCallback<[OnSslErrorEventReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onsslerroreventreceiveevent12)>是当网页收到SSL错误时触发。
...
通知用户加载资源（主资源+子资源）时发生SSL错误，如果只想处理主资源的SSL错误，请用[isMainFrame](../../types/classes/Class (WebResourceRequest).md#ZH-CN_TOPIC_0000002497445238__ismainframe)字段进行区分。
...
参数名类型必填说明callback[OnSslErrorEventCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onsslerroreventcallback12)是通知用户加载资源时发生SSL错误。
...
- Web组件有三种响应方式：[ClientAuthenticationHandler.confirm](../../types/classes/Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002529285199__confirm10)（继续）、[ClientAuthenticationHandler.cancel](../../types/classes/Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002529285199__cancel9)（取消）或[ClientAuthenticationHandler.ignore](../../types/classes/Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002529285199__ignore9)（忽略）。
...
参数名类型必填说明callbackCallback<[OnClientAuthenticationEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onclientauthenticationevent12)>是当需要用户提供的SSL客户端证书时触发的回调。
...
参数名类型必填说明callback[OnVerifyPinCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onverifypincallback22)是当需要用户进行PIN码认证时触发的回调。
...
参数名类型必填说明callbackCallback<[OnPermissionRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpermissionrequestevent12)>是通知收到获取权限请求触发。
...
参数名类型必填说明callbackCallback<[OnContextMenuShowEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oncontextmenushowevent12), boolean>是
...
参数名类型必填说明callback[OnContextMenuHideCallback](Types.md#ZH-CN_TOPIC_0000002497445240__oncontextmenuhidecallback11)是菜单相关回调。
...
参数名类型必填说明callbackCallback<[OnScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscrollevent12)>是当页面滑动到指定位置时触发。
...
参数名类型必填说明callbackCallback<[OnGeolocationShowEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ongeolocationshowevent12)>是回调函数，请求显示地理位置权限时触发，返回地理位置信息请求对象。
...
通知用户先前被调用[onGeolocationShow](#ZH-CN_TOPIC_0000002497445228__ongeolocationshow)时收到地理位置信息获取请求已被取消。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback() => void是地理位置信息获取请求已被取消的回调函数。
...
参数名类型必填说明callback[OnFullScreenEnterCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onfullscreenentercallback12)是Web组件进入全屏时的回调信息。
...
参数名类型必填说明callback() => void是退出全屏模式时的回调函数。
...
若不调用[setWebController](../../types/classes/Class (ControllerHandler).md#ZH-CN_TOPIC_0000002497605208__setwebcontroller9)接口，会造成render进程阻塞。

如果没有创建新窗口，调用[setWebController](../../types/classes/Class (ControllerHandler).md#ZH-CN_TOPIC_0000002497605208__setwebcontroller9)接口时设置成null，通知Web没有创建新窗口。
...
参数名类型必填说明callbackCallback<[OnWindowNewEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onwindownewevent12)>是网页要求用户创建窗口时触发的回调。
...
当Web页面触发window.open(url, name)时，会根据name查找是否存在已绑定的Web实例。若存在，该实例将收到此回调以通知应用需将其展示至前端；若不存在，则通过[onWindowNew](#ZH-CN_TOPIC_0000002497445228__onwindownew9)通知应用创建新Web实例。

- 通过name绑定Web实例‌：需在[onWindowNew](#ZH-CN_TOPIC_0000002497445228__onwindownew9)回调中调用event.handler.setWebController方法，并传入新Web实例的controller，以完成绑定。
...
参数名类型必填说明callbackCallback<void>是再次在原页面触发window.open后，在已打开的新页面触发该回调。
...
通知用户窗口关闭请求。和[onWindowNew](#ZH-CN_TOPIC_0000002497445228__onwindownew9)一样，从安全角度讲，应用应该确保用户可以知道他们交互的页面已关闭。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback() => void是窗口请求关闭的回调函数。
...
参数名类型必填说明callbackCallback<[OnSearchResultReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onsearchresultreceiveevent12)>是通知调用方网页页内查找的结果。
...
参数名类型必填说明callbackCallback<[OnDataResubmittedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondataresubmittedevent12)>是网页表单可以重新提交时触发。
...
参数名类型必填说明callbackCallback<[OnPageVisibleEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagevisibleevent12)>是旧页面不再呈现，新页面即将可见时触发的回调函数。
...
参数名类型必填说明callback(event:[KeyEvent](按键事件.md#ZH-CN_TOPIC_0000002529284805__keyevent对象说明)) => boolean是

触发的KeyEvent事件。

返回值为boolean类型，true表示将该KeyEvent传入Webview内核，false表示不将该KeyEvent传入ArkWeb内核。
...
参数名类型必填说明callbackCallback<[OnTouchIconUrlReceivedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ontouchiconurlreceivedevent12)>是接收到的apple-touch-icon url地址时触发。
...
参数名类型必填说明callbackCallback<[OnFaviconReceivedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfaviconreceivedevent12)>是当前页面接收到新的favicon时触发。
...
参数名类型必填说明callbackCallback<[OnAudioStateChangedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onaudiostatechangedevent12)>是网页上的音频播放状态发生改变时触发。
...
参数名类型必填说明callbackCallback<[OnFirstContentfulPaintEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfirstcontentfulpaintevent12)>是网页首次内容绘制回调函数。
...
onFirstMeaningfulPaint(callback: [OnFirstMeaningfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onfirstmeaningfulpaintcallback12))
...
参数名类型必填说明callback[OnFirstMeaningfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onfirstmeaningfulpaintcallback12)是网页绘制页面主要内容度量信息的回调。
...
onLargestContentfulPaint(callback: [OnLargestContentfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onlargestcontentfulpaintcallback12))
...
参数名类型必填说明callback[OnLargestContentfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onlargestcontentfulpaintcallback12)是网页绘制页面最大内容度量信息的回调。
...
参数名类型必填说明callbackCallback<[OnLoadInterceptEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadinterceptevent12), boolean>是
...
参数名类型必填说明callback() => void是当网页获取焦点时触发的回调。
...
参数名类型必填说明callbackCallback<[OnScreenCaptureRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscreencapturerequestevent12)>是通知收到屏幕捕获请求。
...
参数名类型必填说明callbackCallback<[OnOverScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onoverscrollevent12)>是网页过度滚动时触发。
...
因该回调调用时网页还未加载，无法在回调中使用有关操作网页的接口，例如[zoomIn](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__zoomin)、[zoomOut](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__zoomout)等，可以使用[loadUrl](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__loadurl)、[getWebId](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__getwebid)等操作网页不相关的接口。
...
参数名类型必填说明callback() => void是当ArkWeb控制器初始化成功时触发的回调。
...
onNavigationEntryCommitted(callback: [OnNavigationEntryCommittedCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnavigationentrycommittedcallback11))
...
参数名类型必填说明callback[OnNavigationEntryCommittedCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnavigationentrycommittedcallback11)是网页跳转提交时触发的回调。
...
参数名类型必填说明callback[OnSafeBrowsingCheckResultCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onsafebrowsingcheckresultcallback11)是收到网站安全风险检查结果时触发的回调。
...
参数名类型必填说明callback(event: [NativeEmbedDataInfo](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembeddatainfo11)) => void是同层标签生命周期变化时触发该回调。
...
参数名类型必填说明callback(event: [NativeEmbedTouchInfo](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembedtouchinfo11)) => void是手指触摸到同层标签时触发该回调。
...
参数名类型必填说明callback[OnIntelligentTrackingPreventionCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onintelligenttrackingpreventioncallback12)是智能防跟踪功能使能时，当追踪者cookie被拦截时触发的回调。
...
参数名类型必填说明callback[OnOverrideUrlLoadingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onoverrideurlloadingcallback12)是
...
参数名类型必填说明callback[OnViewportFitChangedCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onviewportfitchangedcallback12)是网页meta中viewport-fit配置项更改时触发的回调。
...
参数名类型必填说明callback[WebKeyboardCallback](Types.md#ZH-CN_TOPIC_0000002497445240__webkeyboardcallback12)是拦截网页拉起软键盘回调。
...
当网页中同层标签（例如<embed>标签或<object>标签）在视口内的可见性发生变化时，将触发该回调。同层标签默认不可见，若在页面首次加载时已可见，则会上报；若不可见，则不会上报。同层标签全部不可见才视为不可见，部分可见或全部可见则视为可见。若要获取因同层标签CSS属性（包括visibility、display以及尺寸变化）导致的可见状态变化，需配置[nativeEmbedOptions](属性.md#ZH-CN_TOPIC_0000002497605206__nativeembedoptions16)，并将[EmbedOptions](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__embedoptions16)中的supportCssDisplayChange参数设为true。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback[OnNativeEmbedVisibilityChangeCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnativeembedvisibilitychangecallback12)是同层标签可见性变化时触发该回调。
...
参数名类型必填说明callback[MouseInfoCallback](Types.md#ZH-CN_TOPIC_0000002497445240__mouseinfocallback20)是当鼠标/触摸板点击到同层标签时触发该回调。
...
参数名类型必填说明callback[OnNativeEmbedObjectParamChangeCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnativeembedobjectparamchangecallback21)是增加、修改或删除同层渲染object标签内嵌param元素时触发此回调。
...
此外，该功能需通过调用[setErrorPageEnabled](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__seterrorpageenabled20)接口启用默认错误页后，才会生效。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback[OnOverrideErrorPageCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onoverrideerrorpagecallback20)是网页加载遇到错误时触发。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[onSslErrorEventReceive9+](#ZH-CN_TOPIC_0000002497445228__onsslerroreventreceive9)替代。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback(event?: { handler: Function, error: object }) => void是当网页检测到SSL错误时触发的回调。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[onShowFileSelector9+](#ZH-CN_TOPIC_0000002497445228__onshowfileselector9)替代。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback(event?: { callback: Function, fileSelector: object }) => void是当触发文件选择器时需要执行的回调。
...
API version 8开始支持，从API version 10开始废弃，建议使用[onLoadIntercept10+](#ZH-CN_TOPIC_0000002497445228__onloadintercept10)代替。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback(event?: { data:string | [WebResourceRequest](../../types/classes/Class (WebResourceRequest).md) }) => boolean是
...
参数名类型必填说明callbackCallback<[OnPdfLoadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfloadevent20)>是当PDF加载成功或失败时，会触发回调，通知用户PDF页面加载状态。
...
参数名类型必填说明callbackCallback<[OnPdfScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfscrollevent20)>是当PDF滚动到垂直方向底部时，会触发回调，通知用户PDF页面已滚动到底。
...
- 需配合[blankScreenDetectionConfig](属性.md#ZH-CN_TOPIC_0000002497605206__blankscreendetectionconfig22)使用。否则，默认关闭白屏检测功能，不会返回检测到白屏时的回调函数。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback[OnDetectBlankScreenCallback](Types.md#ZH-CN_TOPIC_0000002497445240__ondetectblankscreencallback22)是设置Web组件的检测到白屏时的回调函数。
...
应用处理该回调时，可以调用绑定的WebViewController接口来恢复页面。例如[refresh](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__refresh)、[loadUrl](../../types/classes/Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__loadurl)等。

详情可参考[Web组件的生命周期](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-event-sequence)。

从API version 8开始支持，从API version 9开始废弃，建议使用[onRenderExited9+](#ZH-CN_TOPIC_0000002497445228__onrenderexited9)代替。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callback(event?: { detail: object }) => boolean是渲染过程退出时触发。