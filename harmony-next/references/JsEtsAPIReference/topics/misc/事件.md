...
通用事件仅支持[onAppear](挂载卸载事件.md#ZH-CN_TOPIC_0000002522240770__onappear)、[onDisAppear](挂载卸载事件.md#ZH-CN_TOPIC_0000002522240770__ondisappear)、[onBlur](焦点事件.md#ZH-CN_TOPIC_0000002522080766__onblur)、[onFocus](焦点事件.md#ZH-CN_TOPIC_0000002522080766__onfocus)、[onDragEnd](拖拽事件.md#ZH-CN_TOPIC_0000002553200729__ondragend10)、[onDragEnter](拖拽事件.md#ZH-CN_TOPIC_0000002553200729__ondragenter)、[onDragStart](拖拽事件.md#ZH-CN_TOPIC_0000002553200729__ondragstart)、[onDragMove](拖拽事件.md#ZH-CN_TOPIC_0000002553200729__ondragmove)、[onDragLeave](拖拽事件.md#ZH-CN_TOPIC_0000002553200729__ondragleave)、[onDrop](拖拽事件.md#ZH-CN_TOPIC_0000002553200729__ondrop)、[onHover](悬浮事件.md#ZH-CN_TOPIC_0000002553360691__onhover)、[onMouse](鼠标事件.md#ZH-CN_TOPIC_0000002522080762__onmouse)、[onKeyEvent](按键事件.md#ZH-CN_TOPIC_0000002522240762__onkeyevent)、[onTouch](触摸事件.md#ZH-CN_TOPIC_0000002553200725__ontouch)、[onVisibleAreaChange](组件可见区域变化事件.md#ZH-CN_TOPIC_0000002553360697__onvisibleareachange)。
...
onAlert(callback: Callback<[OnAlertEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onalertevent12), boolean>)

网页触发alert()告警弹窗时触发回调。若不调用[handleCancel](Class (JsResult).md#ZH-CN_TOPIC_0000002553201139__handlecancel)或[handleConfirm](Class (JsResult).md#ZH-CN_TOPIC_0000002553201139__handleconfirm)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnAlertEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onalertevent12), boolean> | 是 | 网页触发alert()告警弹窗时触发。 返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终确认结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
onBeforeUnload(callback: Callback<[OnBeforeUnloadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onbeforeunloadevent12), boolean>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnBeforeUnloadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onbeforeunloadevent12), boolean> | 是 | 即将完成页面刷新或关闭当前页面时触发。 返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终是否离开当前页面。当回调返回false时，函数中绘制的自定义弹窗无效。 |
...
onConfirm(callback: Callback<[OnConfirmEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconfirmevent12), boolean>)

网页调用confirm()告警时触发此回调。若不调用[handleCancel](Class (JsResult).md#ZH-CN_TOPIC_0000002553201139__handlecancel)或[handleConfirm](Class (JsResult).md#ZH-CN_TOPIC_0000002553201139__handleconfirm)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnConfirmEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconfirmevent12), boolean> | 是 | 网页调用confirm()告警时触发。 返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终确认结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
onPrompt(callback: Callback<[OnPromptEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpromptevent12), boolean>)

网页调用prompt()告警时触发此回调。若不调用[handleCancel](Class (JsResult).md#ZH-CN_TOPIC_0000002553201139__handlecancel)或[handlePromptConfirm](Class (JsResult).md#ZH-CN_TOPIC_0000002553201139__handlepromptconfirm9)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPromptEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpromptevent12), boolean> | 是 | 网页调用prompt()告警时触发。 返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认、取消和输入），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终处理结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
onConsole(callback: Callback<[OnConsoleEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconsoleevent12), boolean>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnConsoleEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconsoleevent12), boolean> | 是 | 网页收到JavaScript控制台消息时触发。 返回值boolean。当返回true时，该条消息将不会再打印至hilog日志，返回false时仍会打印至hilog日志。 |
...
onDownloadStart(callback: Callback<[OnDownloadStartEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondownloadstartevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnDownloadStartEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondownloadstartevent12)> | 是 | 开始下载时触发。 |
...
onErrorReceive(callback: Callback<[OnErrorReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onerrorreceiveevent12)>)

网页加载遇到错误时触发该回调。主资源与子资源出错都会回调该接口，可以通过[isMainFrame](Class (WebResourceRequest).md#ZH-CN_TOPIC_0000002522081180__ismainframe)来判断是否是主资源报错。出于性能考虑，建议此回调中尽量执行简单逻辑。在无网络的情况下，触发此回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnErrorReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onerrorreceiveevent12)> | 是 | 网页收到 Web 资源加载错误时触发。 |
...
onHttpErrorReceive(callback: Callback<[OnHttpErrorReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttperrorreceiveevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnHttpErrorReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttperrorreceiveevent12)> | 是 | 网页收到加载资源返回HTTP错误码时触发。 |
...
onPageBegin(callback: Callback<[OnPageBeginEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagebeginevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPageBeginEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagebeginevent12)> | 是 | 网页加载开始时触发。 |
...
onPageEnd(callback: Callback<[OnPageEndEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpageendevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPageEndEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpageendevent12)> | 是 | 网页加载结束时触发。 |
...
onLoadStarted(callback: Callback<[OnLoadStartedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadstartedevent20)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnLoadStartedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadstartedevent20)> | 是 | 网页加载开始时触发。 |
...
onLoadFinished(callback: Callback<[OnLoadFinishedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadfinishedevent20)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnLoadFinishedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadfinishedevent20)> | 是 | 网页加载结束时触发。 |
...
onProgressChange(callback: Callback<[OnProgressChangeEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onprogresschangeevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnProgressChangeEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onprogresschangeevent12)> | 是 | 页面加载进度变化时触发的回调。 |
...
onTitleReceive(callback: Callback<[OnTitleReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ontitlereceiveevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnTitleReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ontitlereceiveevent12)> | 是 | 页面文档标题发生变更时触发。 |
...
onRefreshAccessedHistory(callback: Callback<[OnRefreshAccessedHistoryEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrefreshaccessedhistoryevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnRefreshAccessedHistoryEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrefreshaccessedhistoryevent12)> | 是 | 在导航完成时触发。 |
...
onRenderExited(callback: Callback<[OnRenderExitedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrenderexitedevent12)>)

应用渲染进程异常退出时触发该回调。

多个Web组件可能共享单个渲染进程，每个受影响的Web组件都会触发该回调。

应用处理该回调时，可以调用绑定的webviewController相关接口来恢复页面。例如[refresh](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__refresh)、[loadUrl](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__loadurl)等。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnRenderExitedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrenderexitedevent12)> | 是 | 渲染过程退出时触发。 |
...
onRenderProcessNotResponding(callback: [OnRenderProcessNotRespondingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onrenderprocessnotrespondingcallback12))

渲染进程无响应时触发该回调函数。如果Web组件无法处理输入事件，或者无法在合理的时间范围内导航到新的URL，则认为网页进程无响应，并将触发该回调。

只要网页进程一直无响应，此回调仍可能会持续触发，直到网页进程再次响应，此时[onRenderProcessResponding](#ZH-CN_TOPIC_0000002522081170__onrenderprocessresponding12)将会触发。

应用可以通过WebviewController接口[terminateRenderProcess](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__terminaterenderprocess12)来终止关联的渲染进程，这可能会影响同一渲染进程的其他Web组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnRenderProcessNotRespondingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onrenderprocessnotrespondingcallback12) | 是 | 渲染进程无响应时触发的回调。 |
...
onRenderProcessResponding(callback: [OnRenderProcessRespondingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onrenderprocessrespondingcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnRenderProcessRespondingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onrenderprocessrespondingcallback12) | 是 | 渲染进程由无响应状态变回正常运行状态时触发的回调。 |
...
onShowFileSelector(callback: Callback<[OnShowFileSelectorEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onshowfileselectorevent12), boolean>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnShowFileSelectorEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onshowfileselectorevent12), boolean> | 是 | 用于通知Web组件文件选择的结果。 返回值boolean。当返回值为true时，用户可以调用系统提供的弹窗能力。当返回值为false时，函数中绘制的自定义弹窗无效。 |
...
onResourceLoad(callback: Callback<[OnResourceLoadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onresourceloadevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnResourceLoadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onresourceloadevent12)> | 是 | 加载url时触发。 |
...
onScaleChange(callback: Callback<[OnScaleChangeEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscalechangeevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnScaleChangeEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscalechangeevent12)> | 是 | 当页面显示比例发生变化时，触发该回调。 |
...
onInterceptRequest(callback: Callback<[OnInterceptRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oninterceptrequestevent12), WebResourceResponse>)

当Web组件加载URL之前触发该回调，用于拦截URL并返回响应数据。onInterceptRequest可拦截所有跳转请求并返回响应数据，但无法访问POST请求体（Body）内容，且不支持分片缓冲（buffer）类型数据获取。此类场景需改用[WebSchemeHandler](Class (WebSchemeHandler).md)实现，依据具体业务需求进行判断。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnInterceptRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oninterceptrequestevent12), WebResourceResponse> | 是 | 当Web组件加载url之前触发。 返回值WebResourceResponse。返回响应数据则按照响应数据加载，无响应数据则返回null表示按照原来的方式加载。 |
...
onHttpAuthRequest(callback: Callback<[OnHttpAuthRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttpauthrequestevent12), boolean>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnHttpAuthRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttpauthrequestevent12), boolean> | 是 | 当浏览器需要用户的凭据时触发。 返回值boolean。返回true表示http auth认证成功，返回false表示http auth认证失败。 |
...
onSslErrorEventReceive(callback: Callback<[OnSslErrorEvent](事件.md#ZH-CN_TOPIC_0000002497445228__onsslerrorevent12)ReceiveEvent>)

通知用户加载资源时发生SSL错误，只支持主资源。

如果需要支持子资源，请使用[OnSslErrorEvent](事件.md#ZH-CN_TOPIC_0000002522081170__onsslerrorevent12)接口。


- 主资源：浏览器加载网页的入口文件，通常是HTML文档。
- 子资源：主资源中引用的依赖文件，由主资源解析过程中遇到特定标签时触发加载。

- 应用程序需要调用[handler.handleCancel()](Class (SslErrorHandler).md#ZH-CN_TOPIC_0000002522241174__handlecancel9)或[handler.handleConfirm()](Class (SslErrorHandler).md#ZH-CN_TOPIC_0000002522241174__handleconfirm9)处理该回调，如果没有处理该回调则默认取消资源加载。handleConfirm()或者handleCancel()的行为可能会被记录下来，以便为将来的SSL错误做出响应。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnSslErrorEvent](事件.md#ZH-CN_TOPIC_0000002497445228__onsslerrorevent12)ReceiveEvent> | 是 | 当网页收到SSL错误时触发。 |
...
onSslErrorEvent(callback: [OnSslErrorEvent](事件.md#ZH-CN_TOPIC_0000002497445228__onsslerrorevent12)Callback)

通知用户加载资源（主资源+子资源）时发生SSL错误，如果只想处理主资源的SSL错误，请用[isMainFrame](Class (WebResourceRequest).md#ZH-CN_TOPIC_0000002522081180__ismainframe)字段进行区分。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnSslErrorEvent](事件.md#ZH-CN_TOPIC_0000002497445228__onsslerrorevent12)Callback | 是 | 通知用户加载资源时发生SSL错误。 |
...
onClientAuthenticationRequest(callback: Callback<[OnClientAuthenticationEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onclientauthenticationevent12)>)

通知用户收到SSL客户端证书请求事件。


- Web组件有三种响应方式：[ClientAuthenticationHandler.confirm](Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002553361095__confirm10)（继续）、[ClientAuthenticationHandler.cancel](Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002553361095__cancel9)（取消）或[ClientAuthenticationHandler.ignore](Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002553361095__ignore9)（忽略）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnClientAuthenticationEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onclientauthenticationevent12)> | 是 | 当需要用户提供的SSL客户端证书时触发的回调。 |
...
onVerifyPin(callback: [OnVerifyPinCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onverifypincallback22))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnVerifyPinCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onverifypincallback22) | 是 | 当需要用户进行PIN码认证时触发的回调。 |
...
onPermissionRequest(callback: Callback<[OnPermissionRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpermissionrequestevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPermissionRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpermissionrequestevent12)> | 是 | 通知收到获取权限请求触发。 |
...
onContextMenuShow(callback: Callback<[OnContextMenuShowEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oncontextmenushowevent12), boolean>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnContextMenuShowEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oncontextmenushowevent12), boolean> | 是 | 调用时触发的回调，以允许自定义显示上下文菜单。 返回值boolean。返回true表示触发自定义菜单，返回false表示触发的自定义菜单无效。 |
...
onContextMenuHide(callback: [OnContextMenuHideCallback](Types.md#ZH-CN_TOPIC_0000002497445240__oncontextmenuhidecallback11))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnContextMenuHideCallback](Types.md#ZH-CN_TOPIC_0000002497445240__oncontextmenuhidecallback11) | 是 | 菜单相关回调。 |
...
onScroll(callback: Callback<[OnScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscrollevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscrollevent12)> | 是 | 当页面滑动到指定位置时触发。 |
...
onGeolocationShow(callback: Callback<[OnGeolocationShowEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ongeolocationshowevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnGeolocationShowEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ongeolocationshowevent12)> | 是 | 回调函数，请求显示地理位置权限时触发，返回地理位置信息请求对象。 |
...
通知用户先前被调用[onGeolocationShow](#ZH-CN_TOPIC_0000002522081170__ongeolocationshow)时收到地理位置信息获取请求已被取消。
...
onFullScreenEnter(callback: [OnFullScreenEnterCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onfullscreenentercallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFullScreenEnterCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onfullscreenentercallback12) | 是 | Web组件进入全屏时的回调信息。 |
...
onWindowNew(callback: Callback<[OnWindowNewEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onwindownewevent12)>)

使能multiWindowAccess情况下，通知用户新建窗口请求。

若不调用[setWebController](Class (ControllerHandler).md#ZH-CN_TOPIC_0000002553201133__setwebcontroller9)接口，会造成render进程阻塞。

如果没有创建新窗口，调用[setWebController](Class (ControllerHandler).md#ZH-CN_TOPIC_0000002553201133__setwebcontroller9)接口时设置成null，通知Web没有创建新窗口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnWindowNewEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onwindownewevent12)> | 是 | 网页要求用户创建窗口时触发的回调。 |
...
在启用[multiWindowAccess](属性.md#ZH-CN_TOPIC_0000002553201131__multiwindowaccess9)的情况下，通知用户新建窗口请求。
...
若未创建新窗口，调用[setWebController](Class (ControllerHandler).md#ZH-CN_TOPIC_0000002553201133__setwebcontroller9)接口并设置成null，通知Web未创建新窗口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<OnWindowNewExtEvent> | 是 | 网页要求用户创建窗口时触发的回调。 |
...
当Web页面触发window.open(url, name)时，会根据name查找是否存在已绑定的Web实例。若存在，该实例将收到此回调以通知应用需将其展示至前端；若不存在，则通过[onWindowNew](#ZH-CN_TOPIC_0000002522081170__onwindownew9)通知应用创建新Web实例。


- 通过name绑定Web实例‌：需在[onWindowNew](#ZH-CN_TOPIC_0000002522081170__onwindownew9)回调中调用event.handler.setWebController方法，并传入新Web实例的controller，以完成绑定。
...
通知用户窗口关闭请求。和[onWindowNew](#ZH-CN_TOPIC_0000002522081170__onwindownew9)一样，从安全角度讲，应用应该确保用户可以知道他们交互的页面已关闭。
...
onSearchResultReceive(callback: Callback<[OnSearchResultReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onsearchresultreceiveevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnSearchResultReceiveEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onsearchresultreceiveevent12)> | 是 | 通知调用方网页页内查找的结果。 |
...
onDataResubmitted(callback: Callback<[OnDataResubmittedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondataresubmittedevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnDataResubmittedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondataresubmittedevent12)> | 是 | 网页表单可以重新提交时触发。 |
...
onPageVisible(callback: Callback<[OnPageVisibleEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagevisibleevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPageVisibleEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagevisibleevent12)> | 是 | 旧页面不再呈现，新页面即将可见时触发的回调函数。 |
...
#### onIntercept[KeyEvent](../components/按键事件.md#ZH-CN_TOPIC_0000002529284805__keyevent对象说明)9+

onIntercept[KeyEvent](../components/按键事件.md#ZH-CN_TOPIC_0000002529284805__keyevent对象说明)(callback: (event: KeyEvent) => boolean)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event:[KeyEvent](../components/按键事件.md#ZH-CN_TOPIC_0000002529284805__keyevent对象说明)) => boolean | 是 | 触发的KeyEvent事件。 返回值为boolean类型，true表示将该KeyEvent传入Webview内核，false表示不将该KeyEvent传入ArkWeb内核。 |
...
#### [onTouch](../components/触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)IconUrlReceived9+

[onTouch](../components/触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)IconUrlReceived(callback: Callback<OnTouchIconUrlReceivedEvent>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnTouchIconUrlReceivedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ontouchiconurlreceivedevent12)> | 是 | 接收到的apple-touch-icon url地址时触发。 |
...
onFaviconReceived(callback: Callback<[OnFaviconReceivedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfaviconreceivedevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnFaviconReceivedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfaviconreceivedevent12)> | 是 | 当前页面接收到新的favicon时触发。 |
...
onAudioStateChanged(callback: Callback<[OnAudioStateChangedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onaudiostatechangedevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnAudioStateChangedEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onaudiostatechangedevent12)> | 是 | 网页上的音频播放状态发生改变时触发。 |
...
onFirstContentfulPaint(callback: Callback<[OnFirstContentfulPaintEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfirstcontentfulpaintevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnFirstContentfulPaintEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfirstcontentfulpaintevent12)> | 是 | 网页首次内容绘制回调函数。 |
...
onFirstMeaningfulPaint(callback: [OnFirstMeaningfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002522081182__onfirstmeaningfulpaintcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFirstMeaningfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onfirstmeaningfulpaintcallback12) | 是 | 网页绘制页面主要内容度量信息的回调。 |
...
onLargestContentfulPaint(callback: [OnLargestContentfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002522081182__onlargestcontentfulpaintcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnLargestContentfulPaintCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onlargestcontentfulpaintcallback12) | 是 | 网页绘制页面最大内容度量信息的回调。 |
...
onLoadIntercept(callback: Callback<[OnLoadInterceptEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadinterceptevent12), boolean>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnLoadInterceptEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadinterceptevent12), boolean> | 是 | 导航触发时的回调包括iframe导航，在回调中可以选择允许或者取消此次导航。 返回值为boolean类型。返回true表示取消此次导航，false表示允许此次导航。 返回undefined或null时为false。 |
...
onScreenCaptureRequest(callback: Callback<[OnScreenCaptureRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscreencapturerequestevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnScreenCaptureRequestEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscreencapturerequestevent12)> | 是 | 通知收到屏幕捕获请求。 |
...
onOverScroll(callback: Callback<[OnOverScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onoverscrollevent12)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnOverScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onoverscrollevent12)> | 是 | 网页过度滚动时触发。 |
...
因该回调调用时网页还未加载，无法在回调中使用有关操作网页的接口，例如[zoomIn](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__zoomin)、[zoomOut](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__zoomout)等，可以使用[loadUrl](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__loadurl)、[getWebId](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__getwebid)等操作网页不相关的接口。
...
onNavigationEntryCommitted(callback: [OnNavigationEntryCommittedCallback](Types.md#ZH-CN_TOPIC_0000002522081182__onnavigationentrycommittedcallback11))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNavigationEntryCommittedCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnavigationentrycommittedcallback11) | 是 | 网页跳转提交时触发的回调。 |
...
onSafeBrowsingCheckResult(callback: [OnSafeBrowsingCheckResultCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onsafebrowsingcheckresultcallback11))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnSafeBrowsingCheckResultCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onsafebrowsingcheckresultcallback11) | 是 | 收到网站安全风险检查结果时触发的回调。 |
...
onSafeBrowsingCheckFinish(callback: [OnSafeBrowsingCheckResultCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onsafebrowsingcheckresultcallback11))
...
onNativeEmbedLifecycleChange(callback: (event: [NativeEmbedDataInfo](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembeddatainfo11)) => void)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event: [NativeEmbedDataInfo](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembeddatainfo11)) => void | 是 | 同层标签生命周期变化时触发该回调。 |
...
onNativeEmbedGestureEvent(callback: (event: [NativeEmbedTouchInfo](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembedtouchinfo11)) => void)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event: [NativeEmbedTouchInfo](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembedtouchinfo11)) => void | 是 | 手指触摸到同层标签时触发该回调。 |
...
onIntelligentTrackingPreventionResult(callback: [OnIntelligentTrackingPreventionCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onintelligenttrackingpreventioncallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnIntelligentTrackingPreventionCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onintelligenttrackingpreventioncallback12) | 是 | 智能防跟踪功能使能时，当追踪者cookie被拦截时触发的回调。 |
...
onOverrideUrlLoading(callback: [OnOverrideUrlLoadingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onoverrideurlloadingcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnOverrideUrlLoadingCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onoverrideurlloadingcallback12) | 是 | onOverrideUrlLoading的回调。 返回值boolean。返回true表示中止加载URL，返回false表示继续在Web中加载URL。 |
...
onViewportFitChanged(callback: [OnViewportFitChangedCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onviewportfitchangedcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnViewportFitChangedCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onviewportfitchangedcallback12) | 是 | 网页meta中viewport-fit配置项更改时触发的回调。 |
...
onInterceptKeyboardAttach(callback: [WebKeyboardCallback](Types.md#ZH-CN_TOPIC_0000002497445240__webkeyboardcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [WebKeyboardCallback](Types.md#ZH-CN_TOPIC_0000002497445240__webkeyboardcallback12) | 是 | 拦截网页拉起软键盘回调。 |
...
onNativeEmbedVisibilityChange(callback: [OnNativeEmbedVisibilityChangeCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnativeembedvisibilitychangecallback12))

当网页中同层标签（例如<embed>标签或<object>标签）在视口内的可见性发生变化时，将触发该回调。同层标签默认不可见，若在页面首次加载时已可见，则会上报；若不可见，则不会上报。同层标签全部不可见才视为不可见，部分可见或全部可见则视为可见。若要获取因同层标签CSS属性（包括visibility、display以及尺寸变化）导致的可见状态变化，需配置[nativeEmbedOptions](属性.md#ZH-CN_TOPIC_0000002553201131__nativeembedoptions16)，并将[EmbedOptions](Interfaces（其他）.md#ZH-CN_TOPIC_0000002522241178__embedoptions16)中的supportCssDisplayChange参数设为true。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNativeEmbedVisibilityChangeCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnativeembedvisibilitychangecallback12) | 是 | 同层标签可见性变化时触发该回调。 |
...
onNativeEmbedMouseEvent(callback: [MouseInfoCallback](Types.md#ZH-CN_TOPIC_0000002497445240__mouseinfocallback20))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [MouseInfoCallback](Types.md#ZH-CN_TOPIC_0000002497445240__mouseinfocallback20) | 是 | 当鼠标/触摸板点击到同层标签时触发该回调。 |
...
onNativeEmbedObjectParamChange(callback: [OnNativeEmbedObjectParamChangeCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnativeembedobjectparamchangecallback21))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNativeEmbedObjectParamChangeCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onnativeembedobjectparamchangecallback21) | 是 | 增加、修改或删除同层渲染object标签内嵌param元素时触发此回调。 |
...
onOverrideErrorPage(callback: [OnOverrideErrorPageCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onoverrideerrorpagecallback20))

网页加载遇到错误时触发，只有主资源出错才会回调该接口，可以使用该接口自定义错误展示页。


该功能需通过调用[setErrorPageEnabled](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__seterrorpageenabled20)接口启用默认错误页后，才会生效。

通过[errorPageEvent.error.getErrorCode()](Class (WebResourceError).md#ZH-CN_TOPIC_0000002553201143__geterrorcode)获取的错误码大于0代表http协议错误，小于0代表网络错误。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnOverrideErrorPageCallback](Types.md#ZH-CN_TOPIC_0000002497445240__onoverrideerrorpagecallback20) | 是 | 网页加载遇到错误时触发。 |
...
从API version 8开始支持，从API version 9开始废弃。建议使用[onSslErrorEventReceive9+](#ZH-CN_TOPIC_0000002522081170__onsslerroreventreceive9)替代。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[onShowFileSelector9+](#ZH-CN_TOPIC_0000002522081170__onshowfileselector9)替代。
...
API version 8开始支持，从API version 10开始废弃，建议使用[onLoadIntercept10+](#ZH-CN_TOPIC_0000002522081170__onloadintercept10)代替。
...
onPdfLoadEvent(callback: Callback<[OnPdfLoadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfloadevent20)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPdfLoadEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfloadevent20)> | 是 | 当PDF加载成功或失败时，会触发回调，通知用户PDF页面加载状态。 |
...
onPdfScrollAtBottom(callback: Callback<[OnPdfScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfscrollevent20)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPdfScrollEvent](../../types/interfaces/Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfscrollevent20)> | 是 | 当PDF滚动到垂直方向底部时，会触发回调，通知用户PDF页面已滚动到底。 |
...
onDetectedBlankScreen(callback: [OnDetectBlankScreenCallback](Types.md#ZH-CN_TOPIC_0000002497445240__ondetectblankscreencallback22))

Web组件检测到白屏时触发此回调。


- 需配合[blankScreenDetectionConfig](属性.md#ZH-CN_TOPIC_0000002553201131__blankscreendetectionconfig22)使用。否则，默认关闭白屏检测功能，不会返回检测到白屏时的回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnDetectBlankScreenCallback](Types.md#ZH-CN_TOPIC_0000002497445240__ondetectblankscreencallback22) | 是 | Web组件检测到白屏时的回调函数。 |
...
应用处理该回调时，可以调用绑定的WebViewController接口来恢复页面。例如[refresh](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__refresh)、[loadUrl](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__loadurl)等。

详情可参考[Web组件的生命周期](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-event-sequence)。


从API version 8开始支持，从API version 9开始废弃，建议使用[onRenderExited9+](#ZH-CN_TOPIC_0000002522081170__onrenderexited9)代替。
...
可以通过startCamera，stopCamera，closeCamera这三个接口来切换摄像头的状态。这三个接口分别对应开启，暂停，停止摄像头功能。示例使用场景详见[startCamera](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__startcamera12)。
...
可以通过resumeMicrophone，pauseMicrophone，stopMicrophone这三个接口来切换麦克风的状态。这三个接口功能分别对应解除暂停，暂停，停止麦克风。示例使用场景详见[网页中麦克风的使用](Class (WebviewController).md#ZH-CN_TOPIC_0000002553201117__resumemicrophone23)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | TextSelectionChangeCallback | 是 | 回调函数，所选区域文本内容改变时触发。 |
