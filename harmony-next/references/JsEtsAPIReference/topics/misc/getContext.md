...
直接使用getContext可能导致[UI上下文不明确](../../types/classes/Class (UIContext).md)的问题，建议使用getUIContext()获取[UIContext](Class (UIContext).md)实例，并使用[getHostContext](Class (UIContext).md#ZH-CN_TOPIC_0000002522240732__gethostcontext12)调用绑定实例的getContext。
