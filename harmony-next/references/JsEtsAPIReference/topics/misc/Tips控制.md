...
参数名类型必填说明message[TipsMessageType](#ZH-CN_TOPIC_0000002529444813__tipsmessagetype)是弹窗信息内容。options[TipsOptions](#ZH-CN_TOPIC_0000002529444813__tipsoptions类型说明)否
...
名称类型只读可选说明appearingTimenumber否是
...
appearingTimeWithContinuousOperationnumber否是
...
disappearingTimeWithContinuousOperationnumber否是
...
showAtAnchor20+[TipsAnchorType](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__tipsanchortype20)否是
...
类型说明[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)字符串类型，用于描述字符串入参可以使用的类型。[StyledString](属性字符串.md#ZH-CN_TOPIC_0000002497444920__styledstring)属性字符串。
