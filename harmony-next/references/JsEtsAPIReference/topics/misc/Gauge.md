...
参数名类型必填说明options[GaugeOptions](#ZH-CN_TOPIC_0000002497444928__gaugeoptions18对象说明)是数据量规图表组件参数。
...
参数类型为[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)，则圆环类型为单色环。

参数类型为[LinearGradient](../components/DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10)，则圆环类型为渐变环。
...
参数名类型必填说明colors[ResourceColor11+](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [LinearGradient11+](../components/DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10) | Array<[[ResourceColor10+](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [LinearGradient11+](../components/DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10) , number]>是
...
参数名类型必填说明length[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)是
...
参数名类型必填说明value[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是
...
参数名类型必填说明value[GaugeShadowOptions](#ZH-CN_TOPIC_0000002497444928__gaugeshadowoptions11对象说明)是
...
参数名类型必填说明value[GaugeIndicatorOptions](#ZH-CN_TOPIC_0000002497444928__gaugeindicatoroptions11对象说明)是
...
参数名类型必填说明isPrivacySensitiveModeOptional<boolean>是
...
参数名类型必填说明modifier[ContentModifier<GaugeConfiguration>](#ZH-CN_TOPIC_0000002497444928__gaugeconfiguration12对象说明)是
...
GaugeShadowOptions继承自[MultiShadowOptions](信息展示公共接口.md#ZH-CN_TOPIC_0000002497444932__multishadowoptions)，具有MultiShadowOptions的全部属性。
...
space[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10)否是
...
名称类型只读可选说明valuenumber否否当前数据值。minnumber否否当前数据段最小值。maxnumber否否当前数据段最大值。

#### 示例

#### 示例1（设置多色量规图）

该示例通过[colors](#ZH-CN_TOPIC_0000002497444928__colors)接口，实现了多色量规图效果。
...
该示例通过[colors](#ZH-CN_TOPIC_0000002497444928__colors)接口，实现了单色量规图效果。
...
该示例通过[description](#ZH-CN_TOPIC_0000002497444928__description11)接口，实现了说明区的设置功能。
...
该示例通过设置[GaugeOptions](#ZH-CN_TOPIC_0000002497444928__gaugeoptions18对象说明)的min、max属性，实现了量规图的最大最小值设置的功能。
...
该示例通过[indicator](#ZH-CN_TOPIC_0000002497444928__indicator11)接口，实现了设置量规图的指针的功能。
...
该示例通过[startAngle](#ZH-CN_TOPIC_0000002497444928__startangle)和[endAngle](#ZH-CN_TOPIC_0000002497444928__endangle)接口，实现了量规图起止角度设置的功能。
...
该示例通过[contentModifier](#ZH-CN_TOPIC_0000002497444928__contentmodifier12)接口，实现了定制量规图内容区的功能。
...
该示例通过[privacySensitive](#ZH-CN_TOPIC_0000002497444928__privacysensitive12)接口，实现了隐私隐藏效果，效果展示需要卡片框架支持
...
该示例通过[indicator](#ZH-CN_TOPIC_0000002497444928__indicator11)接口，实现了自定义指针功能，开发者导入svg类型的图片以替换默认指针。
