...
border-[top|bottom]-[left|right]-radius<length>-分别设置左上，右上，右下和左下四个角的圆角半径。background<linear-gradient>-仅支持设置[渐变样式](渐变样式.md)，与background-color、background-image不兼容。background-color<color>-设置背景颜色。background-imagestring-
