...
拍照会话类，保存一次相机运行所需要的所有资源[CameraInput](../../types/interfaces/Interface (CameraInput).md)、[CameraOutput](../../types/interfaces/Interface (CameraOutput).md)，并向相机设备申请完成相机功能(录像，拍照)。

从 API version 10开始支持，从API version 11开始废弃。建议使用[PhotoSession](../../types/interfaces/Interface (PhotoSession).md)、[VideoSession](../../types/interfaces/Interface (VideoSession).md)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.beginConfig](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__beginconfig11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.commitConfig](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__commitconfig11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.commitConfig](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__commitconfig11-1)替代。
...
把[CameraInput](../../types/interfaces/Interface (CameraInput).md)加入到会话。

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.addInput](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__addinput11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明cameraInput[CameraInput](../../types/interfaces/Interface (CameraInput).md)是需要添加的CameraInput实例。
...
移除[CameraInput](../../types/interfaces/Interface (CameraInput).md)。

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.removeInput](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__removeinput11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明cameraInput[CameraInput](../../types/interfaces/Interface (CameraInput).md)是需要移除的CameraInput实例。
...
把[CameraOutput](../../types/interfaces/Interface (CameraOutput).md)加入到会话。

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.addOutput](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__addoutput11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明cameraOutput[CameraOutput](../../types/interfaces/Interface (CameraOutput).md)是需要添加的CameraOutput实例。
...
从会话中移除[CameraOutput](../../types/interfaces/Interface (CameraOutput).md)。

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.removeOutput](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__removeoutput11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明cameraOutput[CameraOutput](../../types/interfaces/Interface (CameraOutput).md)是需要移除的CameraOutput实例。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.start](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__start11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.start](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__start11-1)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.stop](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__stop11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.stop](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__stop11-1)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.release](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__release11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.release](../../types/interfaces/Interface (Session).md#ZH-CN_TOPIC_0000002529445753__release11-1)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.hasFlash](../../types/interfaces/Interface (FlashQuery).md#ZH-CN_TOPIC_0000002497605782__hasflash11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.isFlashModeSupported](../../types/interfaces/Interface (FlashQuery).md#ZH-CN_TOPIC_0000002497605782__isflashmodesupported11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.setFlashMode](../../types/interfaces/Interface (Flash).md#ZH-CN_TOPIC_0000002529445747__setflashmode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.getFlashMode](../../types/interfaces/Interface (Flash).md#ZH-CN_TOPIC_0000002529445747__getflashmode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.isExposureModeSupported](../../types/interfaces/Interface (AutoExposureQuery).md#ZH-CN_TOPIC_0000002529445743__isexposuremodesupported11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getExposureMode](../../types/interfaces/Interface (AutoExposure).md#ZH-CN_TOPIC_0000002529285769__getexposuremode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.setExposureMode](../../types/interfaces/Interface (AutoExposure).md#ZH-CN_TOPIC_0000002529285769__setexposuremode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getMeteringPoint](../../types/interfaces/Interface (AutoExposure).md#ZH-CN_TOPIC_0000002529285769__getmeteringpoint11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**返回值：**

类型说明[Point](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__point)获取当前曝光点。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.setMeteringPoint](../../types/interfaces/Interface (AutoExposure).md#ZH-CN_TOPIC_0000002529285769__setmeteringpoint11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明point[Point](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__point)是曝光点，x,y设置范围应在[0,1]之内，超过范围，如果小于0设置0，大于1设置1。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getExposureBiasRange](../../types/interfaces/Interface (AutoExposureQuery).md#ZH-CN_TOPIC_0000002529445743__getexposurebiasrange11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.setExposureBias](../../types/interfaces/Interface (AutoExposure).md#ZH-CN_TOPIC_0000002529285769__setexposurebias11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明exposureBiasnumber是曝光补偿，[getExposureBiasRange](../../types/interfaces/Interface (AutoExposureQuery).md#ZH-CN_TOPIC_0000002529445743__getexposurebiasrange11)查询支持的范围，如果设置超过支持范围的值，自动匹配到就近临界点。曝光补偿存在步长，如步长为0.5。则设置1.2时，获取到实际生效曝光补偿为1.0。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。传参为null或者undefined，作为0处理，曝光补偿设置0。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getExposureValue](../../types/interfaces/Interface (AutoExposure).md#ZH-CN_TOPIC_0000002529285769__getexposurevalue11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.isFocusModeSupported](../../types/interfaces/Interface (FocusQuery).md#ZH-CN_TOPIC_0000002529285775__isfocusmodesupported11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.setFocusMode](../../types/interfaces/Interface (Focus).md#ZH-CN_TOPIC_0000002497445804__setfocusmode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.getFocusMode](../../types/interfaces/Interface (Focus).md#ZH-CN_TOPIC_0000002497445804__getfocusmode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.setFocusPoint](../../types/interfaces/Interface (Focus).md#ZH-CN_TOPIC_0000002497445804__setfocuspoint11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明point[Point](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__point)是焦点。x,y设置范围应在[0,1]之内，超过范围，如果小于0设置0，大于1设置1。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.getFocusPoint](../../types/interfaces/Interface (Focus).md#ZH-CN_TOPIC_0000002497445804__getfocuspoint11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**返回值：**

类型说明[Point](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__point)用于获取当前焦点。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.getFocalLength](../../types/interfaces/Interface (Focus).md#ZH-CN_TOPIC_0000002497445804__getfocallength11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Zoom.getZoomRatioRange](../../types/interfaces/Interface (ZoomQuery).md#ZH-CN_TOPIC_0000002529445757__getzoomratiorange11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Zoom.setZoomRatio](../../types/interfaces/Interface (Zoom).md#ZH-CN_TOPIC_0000002529285783__setzoomratio11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明zoomRationumber是可变焦距比，通过[getZoomRatioRange](../../types/interfaces/Interface (ZoomQuery).md#ZH-CN_TOPIC_0000002529445757__getzoomratiorange11)获取支持的变焦范围，如果设置超过支持范围的值，则只保留精度范围内数值。传参为null或者undefined，作为0处理，变焦设置最小值。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Zoom.getZoomRatio](../../types/interfaces/Interface (Zoom).md#ZH-CN_TOPIC_0000002529285783__getzoomratio11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Stabilization.isVideoStabilizationModeSupported](../../types/interfaces/Interface (StabilizationQuery).md#ZH-CN_TOPIC_0000002497445810__isvideostabilizationmodesupported11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Stabilization.getActiveVideoStabilizationMode](../../types/interfaces/Interface (Stabilization).md#ZH-CN_TOPIC_0000002497605790__getactivevideostabilizationmode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Stabilization.setVideoStabilizationMode](../../types/interfaces/Interface (Stabilization).md#ZH-CN_TOPIC_0000002497605790__setvideostabilizationmode11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.on('focusStateChange')](../../types/interfaces/Interface (VideoSession).md#ZH-CN_TOPIC_0000002529445755__onfocusstatechange11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.off('focusStateChange')](../../types/interfaces/Interface (VideoSession).md#ZH-CN_TOPIC_0000002529445755__offfocusstatechange11)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.on('error')](../../types/interfaces/Interface (VideoSession).md#ZH-CN_TOPIC_0000002529445755__onerror11)替代。

**系统能力：** SystemCapability.Multimedia.Camera.Core

**参数：**

参数名类型必填说明typestring是监听事件，固定为'error'，session创建成功之后可监听该接口。session调用相关接口出现错误时会触发该事件，比如调用[beginConfig](#ZH-CN_TOPIC_0000002529285785__beginconfigdeprecated)，[commitConfig](#ZH-CN_TOPIC_0000002529285785__commitconfigdeprecated-1)，[addInput](#ZH-CN_TOPIC_0000002529285785__addinputdeprecated)等接口发生错误时返回错误信息。callback[ErrorCallback](../../modules/ohos/@ohos.base (公共回调信息).md#ZH-CN_TOPIC_0000002497445536__errorcallback)是回调函数，用于获取错误信息。返回错误码，错误码类型[CameraErrorCode](Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.off('error')](../../types/interfaces/Interface (VideoSession).md#ZH-CN_TOPIC_0000002529445755__offerror11)替代。
