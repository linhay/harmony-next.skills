...
弧线。继承[BaseOverlay](BaseOverlay.md)。在调用map.[MapComponentController](MapComponentController.md)类的[addArc](MapComponentController.md#ZH-CN_TOPIC_0000002553362311__addarc)方法时会返回该类型的实例。
