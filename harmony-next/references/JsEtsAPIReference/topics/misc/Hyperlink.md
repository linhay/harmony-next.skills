...
可以包含[Image](../graphics/Image.md)子组件。
...
参数名类型必填说明value[Color](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__color) | number | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)是
