...
使用OffscreenCanvasRenderingContext2D在[OffscreenCanvas对象](OffscreenCanvas对象.md)上进行绘制，绘制对象可以是矩形、文本、图片等。

**属性**

除支持与[CanvasRenderingContext2D对象](CanvasRenderingContext2D对象.md)相同的属性外，还支持如下属性：
...
![image](public_sys-resources/zh-cn_image_0000002553365423.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522245500.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553205463.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085510.webp)