...
FormExtensionContext模块是[FormExtensionAbility](@ohos.app.form.FormExtensionAbility (FormExtensionAbility).md)的上下文环境，继承自[ExtensionContext](ExtensionContext.md)。
...
FormExtensionContext模块是[FormExtensionAbility](@ohos.app.form.FormExtensionAbility (FormExtensionAbility).md)的上下文环境。
