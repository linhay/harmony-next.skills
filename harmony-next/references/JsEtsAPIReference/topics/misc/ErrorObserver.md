...
定义异常监听，可以作为[ErrorManager.on](../../modules/ohos/@ohos.app.ability.errorManager (错误管理模块).md#ZH-CN_TOPIC_0000002497604610__errormanageronerror)的入参监听当前应用发生的异常。
...
参数名类型必填说明errMsgstring是有关异常的消息和错误堆栈跟踪。
...
参数名类型必填说明errObjectError是有关异常事件名字、消息和错误堆栈信息的对象。
