...
类型说明[UIContext](#ZH-CN_TOPIC_0000002497444970__uicontext)返回UIContext实例对象。在异步调用的回调方法中使用该接口，或者该接口的起始调用不在当前页面时，可能导致接口调用发生在自定义组件销毁之后，返回 undefined。
...
类型说明[UIContext](../../types/classes/Class (UIContext).md)返回UIContext实例对象。
...
类型说明number返回当前Component的UniqueId。
...
类型说明[NavDestinationInfo](#ZH-CN_TOPIC_0000002497444970__navdestinationinfo) | undefined返回NavDestinationInfo实例对象。
...
参数名类型必填说明isInner[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<boolean>是
...
类型说明[NavDestinationInfo](../../modules/ohos/@ohos.arkui.observer (无感监听).md#ZH-CN_TOPIC_0000002529444737__navdestinationinfo)返回NavDestinationInfo实例对象。
...
类型说明[NavigationInfo](#ZH-CN_TOPIC_0000002497444970__navigationinfo12) | undefined返回NavigationInfo实例对象。
...
类型说明[NavigationInfo](../../modules/ohos/@ohos.arkui.observer (无感监听).md#ZH-CN_TOPIC_0000002529444737__navigationinfo12)返回NavigationInfo实例对象。
...
类型说明[RouterPageInfo](#ZH-CN_TOPIC_0000002497444970__routerpageinfo12) | undefined返回RouterPageInfo实例对象。
...
类型说明[RouterPageInfo](../../modules/ohos/@ohos.arkui.observer (无感监听).md#ZH-CN_TOPIC_0000002529444737__routerpageinfo)返回RouterPageInfo实例对象。
...
类型说明[PromptActionDialogController](#ZH-CN_TOPIC_0000002497444970__promptactiondialogcontroller18) | undefined返回PromptActionDialogController实例对象。
...
自定义弹窗控制器，可以控制当前自定义弹窗，具体控制能力包括关闭弹窗等，详见[promptAction.DialogController](../../modules/ohos/@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__dialogcontroller18)。

**元服务API：** 从API version 18开始，该接口支持在元服务中使用。

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

类型说明[promptAction.DialogController](../../modules/ohos/@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__dialogcontroller18)表示对象类型为promptAction.DialogController实例对象。