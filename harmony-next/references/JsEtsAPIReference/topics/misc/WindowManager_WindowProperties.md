...
| 名称 | 描述 |
| --- | --- |
| [WindowManager_Rect](WindowManager_Rect.md) windowRect | 窗口的位置和尺寸。 |
| [WindowManager_Rect](WindowManager_Rect.md) drawableRect | 窗口内可绘制区域的尺寸。 |
| [WindowManager_WindowType](oh_window_comm.h.md#ZH-CN_TOPIC_0000002529285075__windowmanager_windowtype) type | 窗口类型。 |
