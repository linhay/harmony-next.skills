...
![image](public_sys-resources/zh-cn_image_0000002522244718.webp)
...
使用[ColorSpace](枚举说明.md#ZH-CN_TOPIC_0000002553200889__colorspace20)和rgba格式颜色实例化ColorMetrics类。仅部分属性支持在display-p3色彩空间中设置颜色。
...
![image](public_sys-resources/zh-cn_image_0000002553204679.webp)
