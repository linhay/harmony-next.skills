...
折线，继承[BaseOverlay](BaseOverlay.md)。在调用map.[MapComponentController](MapComponentController.md)类的[addPolyline](MapComponentController.md#ZH-CN_TOPIC_0000002553362311__addpolyline)方法时会返回该类型的实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| patterns | Array<mapCommon.PatternItem> | 是 | PatternItem对象的集合。 |
