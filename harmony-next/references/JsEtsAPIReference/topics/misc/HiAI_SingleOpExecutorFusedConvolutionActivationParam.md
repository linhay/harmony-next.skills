...
[HMS_HiAISingleOpExecutor_CreateFusedConvolutionActivation](CANN.md#ZH-CN_TOPIC_0000002553362477__hms_hiaisingleopexecutor_createfusedconvolutionactivation)输入参数。
...
| HiAI_SingleOpDescriptor * convOpDesc | 指卷积算子对应的HiAI_SingleOpDescriptor对象的指针。该值不能为空指针，否则接口调用失败。 |
...
指向激活算子对应的[HiAI_SingleOpDescriptor](CANN.md#ZH-CN_TOPIC_0000002553362477__hiai_singleopdescriptor)对象的指针。该值不能为空指针，否则接口调用失败。
...
指卷积算子对应的[HiAI_SingleOpDescriptor](CANN.md#ZH-CN_TOPIC_0000002553362477__hiai_singleopdescriptor)对象的指针。该值不能为空指针，否则接口调用失败。
