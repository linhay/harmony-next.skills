...
从API version 9开始，该模块不再维护，推荐使用新组件[GridCol](../components/GridCol.md)、[GridRow](../components/GridRow.md)替代。
...
名称参数类型描述useSizeType(deprecated)
...
该属性从API version 9开始废弃，推荐使用新组件[GridCol](../components/GridCol.md)、[GridRow](../components/GridRow.md)。

gridSpan(deprecated) number
...
该属性从API version 14开始废弃，推荐使用新组件[GridCol](../components/GridCol.md)、[GridRow](../components/GridRow.md)。

gridOffset(deprecated) number
