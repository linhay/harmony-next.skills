...
设置自定义选择菜单。自定义菜单超长时，建议内部嵌套[Scroll](../components/Scroll.md)组件使用，避免键盘被遮挡。
...
content[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是菜单的内容。responseType[ResponseType](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__responsetype8) | [RichEditorResponseType](#ZH-CN_TOPIC_0000002497604894__richeditorresponsetype11)是
...
参数名类型必填说明state[BarState](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__barstate)是
...
参数名类型必填说明color[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[ColorMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)>是
...
textBackgroundStyle18+[TextBackgroundStyle](../components/span.md#ZH-CN_TOPIC_0000002529284887__textbackgroundstyle11对象说明)否是
...
fontWeightnumber | [FontWeight](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontweight) | string否否
...
名称类型只读可选说明spanPosition[RichEditorSpanPosition](#ZH-CN_TOPIC_0000002497604894__richeditorspanposition)否否Span位置。valuePixelMap[PixelMap](../../types/interfaces/Interface (PixelMap).md)否是图片内容。valueResourceStr[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是图片资源id。imageStyle[RichEditorImageSpanStyleResult](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanstyleresult)否否图片样式。offsetInSpan[number, number]否否Span里图片的起始和结束位置。
...
verticalAlign[ImageSpanAlignment](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagespanalignment10)否否

图片垂直对齐方式。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

objectFit[ImageFit](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagefit)否否
...
参数名类型必填说明value[PixelMap](../../types/interfaces/Interface (PixelMap).md) | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是图片内容。options[RichEditorImageSpanOptions](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanoptions)否图片选项。
...
以下错误码的详细介绍请参考[通用错误码](../../errors/通用错误码.md)。
...
名称类型只读可选说明textAlign[TextAlign](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__textalign)否是
...
wordBreak12+[WordBreak](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__wordbreak11)否是
...
lineBreakStrategy12+[LineBreakStrategy](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__linebreakstrategy12)否是
...
名称类型只读可选说明pixelMap[PixelMap](../../types/interfaces/Interface (PixelMap).md)否否
...
设置字体列表。默认字体'HarmonyOS Sans'，当前支持'HarmonyOS Sans'字体和[注册自定义字体](../../modules/ohos/@ohos.font (注册自定义字体).md)。
...
verticalAlign[ImageSpanAlignment](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagespanalignment10)否是
...
objectFit[ImageFit](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagefit)否是
...
参数名类型必填说明enterKey[EnterKeyType](../graphics/TextInput.md#ZH-CN_TOPIC_0000002529444859__enterkeytype枚举说明)是软键盘输入法回车键类型。具体类型见EnterKeyType枚举说明。event[SubmitEvent](../graphics/TextInput.md#ZH-CN_TOPIC_0000002529444859__submitevent11)是当提交的时候，提供保持组件编辑状态的方法。EnterKeyType指定为NEW_LINE时，默认保持编辑态。
...
名称类型只读可选说明spanPosition[RichEditorSpanPosition](#ZH-CN_TOPIC_0000002497604894__richeditorspanposition)否否Span位置。value[PixelMap](../../types/interfaces/Interface (PixelMap).md) | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否否图片内容。imageStyle[RichEditorImageSpanStyle](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanstyle)否是图片样式。
...
通过[getLayoutManager](#ZH-CN_TOPIC_0000002497604894__getlayoutmanager12)接口获取布局管理器对象，通过[getLineCount](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__getlinecount12)接口获取组件内容或[placeholder](#ZH-CN_TOPIC_0000002497604894__placeholder12)的总行数，通过[getGlyphPositionAtCoordinate](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__getglyphpositionatcoordinate12)接口获取较为接近给定坐标的字形的位置信息，通过[getLineMetrics](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__getlinemetrics12)接口获取指定行的行信息、文本样式信息、以及字体属性信息。
