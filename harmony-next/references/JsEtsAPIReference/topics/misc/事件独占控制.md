...
2、如果开发者通过[parallelGesture](绑定手势方法.md#ZH-CN_TOPIC_0000002529284849__parallelgesture)绑定了与子组件同时触发的手势，如[PanGesture](../input/PanGesture.md)，子组件设置了独占控制且首个响应事件，则父组件的手势不会响应。
