...
此结构体描述创建具有DDGI特性的[XEG_RTGI](XEngine.md#ZH-CN_TOPIC_0000002553202223__xeg_rtgi)对象的信息，当结构体中的信息变化时，需要创建新的[XEG_RTGI](XEngine.md#ZH-CN_TOPIC_0000002553202223__xeg_rtgi)对象。
...
| 名称 | 描述 |
| --- | --- |
| [XEG_StructureType](XEngine.md#ZH-CN_TOPIC_0000002328319196__xeg_structuretype) sType | 识别此结构的XEG_StructureType值，必须是XEG_STRUCTURE_TYPE_DDGI_CREATE_INFO。 |
...
识别此结构的[XEG_StructureType](XEngine.md#ZH-CN_TOPIC_0000002553202223__xeg_structuretype)值，必须是XEG_STRUCTURE_TYPE_DDGI_CREATE_INFO。
