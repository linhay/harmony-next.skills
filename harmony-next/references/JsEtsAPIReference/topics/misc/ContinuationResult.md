...
ContinuationManager的[on](../../modules/ohos/@ohos.continuation.continuationManager (流转_协同管理).md#ZH-CN_TOPIC_0000002497604644__continuationmanagerondeviceselecteddeprecated)接口返回此对象表示流转管理入口返回的设备信息。
