...
参数名类型必填说明value[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [ColoringStrategy](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__coloringstrategy10)是设置组件的前景颜色或者根据智能取色策略设置前景颜色。不支持属性动画。
...
设置组件的前景色。当组件未设置前景色，默认继承父组件。与[foregroundColor](#ZH-CN_TOPIC_0000002497604836__foregroundcolor)相比，color参数新增了对undefined类型的支持。
...
参数名类型必填说明colorOptional<[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [ColoringStrategy](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__coloringstrategy10)>是

设置组件的前景颜色或者根据智能取色策略设置前景颜色。不支持属性动画。

当color的值为undefined时，维持之前取值或组件默认取值，具体行为不同组件可能会有差异，建议开发者使用确定颜色或[ColoringStrategy](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__coloringstrategy10)。
