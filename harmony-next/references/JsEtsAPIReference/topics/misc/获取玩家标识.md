...
Content-Length: 717
// **所有****请求参数****值**均需要urlencode编码后再进行拼接
...
[LoginAcctInfo](#ZH-CN_TOPIC_0000002506511029__li1628913126415)
...
[BindPlayerInfo](#ZH-CN_TOPIC_0000002506511029__li0462806435)
...
[PlayerAcct](#ZH-CN_TOPIC_0000002506511029__li137107744415)
...
兼容类型。
    ...
    - 0：gamePlayerId与openId、playerId不兼容，即调用[getLocalPlayer](gamePlayer（基础游戏服务）.md#section17453143012584)接口时，玩家首次登录游戏生成的玩家标识；teamPlayerId与unionId不兼容，即调用[unionLogin](gamePlayer（基础游戏服务）.md#section157848375136)接口时，玩家首次登录游戏未选择转移APK游戏数据生成的玩家标识。
