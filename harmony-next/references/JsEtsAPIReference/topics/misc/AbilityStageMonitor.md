...
本模块提供监听指定[AbilityStage](@ohos.app.ability.AbilityStage (AbilityStage组件管理器).md)对象的能力。开发者可以将AbilityStageMonitor作为[abilityDelegator.waitAbilityStageMonitor](AbilityDelegator.md#ZH-CN_TOPIC_0000002522241804__waitabilitystagemonitor9)的入参来注册监听。
