...
用于在屏幕坐标和经纬度之间进行转换，在调用map.[MapComponentController](../components/MapComponentController.md)类的[getProjection](../components/MapComponentController.md#section8132133414720)方法时会返回该类型的实例。
