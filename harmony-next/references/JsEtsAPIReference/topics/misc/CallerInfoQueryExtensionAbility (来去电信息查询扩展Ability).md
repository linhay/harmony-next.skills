...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | CallerInfoQueryExtensionContext | 否 | 否 | CallerInfoQueryExtensionContext的上下文环境，继承自ExtensionContext。 |

**onQueryCallerInfo**

onQueryCallerInfo(phoneNumber: string):Promise<[CallerInfo](#ZH-CN_TOPIC_0000002522082324__callerinfo)>
