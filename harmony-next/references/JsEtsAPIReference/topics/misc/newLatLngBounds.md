...
newLatLngBounds(bounds: [mapCommon.LatLngBounds](mapCommon（地图属性模型）.md#section96341159111320), padding?: number): CameraUpdate
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](mapCommon（地图属性模型）.md#section96341159111320) | 是 | 地图显示经纬度范围。 |
...
| 类型 | 说明 |
| --- | --- |
| [CameraUpdate](CameraUpdate.md) | 描述地图状态将要发生的变化。 |
...
newLatLngBounds(bounds: [mapCommon.LatLngBounds](mapCommon（地图属性模型）.md#section96341159111320), width: number, height: number, padding: number): CameraUpdate
...
newLatLngBounds(bounds: [mapCommon.LatLngBounds](mapCommon（地图属性模型）.md#section96341159111320), padding: mapCommon.Padding): CameraUpdate
...
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](mapCommon（地图属性模型）.md#section96341159111320) | 是 | 地图显示经纬度范围。 |
| padding | [mapCommon.Padding](mapCommon（地图属性模型）.md#section144591344648) | 是 | 地图区域和边界之间的距离，单位：px，默认值为0。 说明： - 地图组件高度减去padding的top值和bottom值，结果需要大于等于100px。 - 地图组件宽度减去padding的left值和right值，结果需要大于等于100px。 |
