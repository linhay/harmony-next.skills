...
名称描述int64_t size数据源的总大小。[OH_AVDataSourceReadAtExt](../../capi/headers/native_avcodec_base.h.md#ZH-CN_TOPIC_0000002529445703__oh_avdatasourcereadatext) readAt数据源的数据回调。