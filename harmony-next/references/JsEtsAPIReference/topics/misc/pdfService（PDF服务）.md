...
对PDF文件进行编辑操作后，需要调用[saveDocument](#ZH-CN_TOPIC_0000002553362427__savedocument)接口将PDF文件保存，确保编辑操作生效。
...
![image](public_sys-resources/zh-cn_image_0000002553366085.webp)
...
PDF页面的文本批注类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的链接类型注释的信息，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的自由文本类型注释的信息，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的方块类型标注信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的椭圆型标注的信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的多边形批注信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的线型标注信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的折线类型标注的信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的高亮类型标注信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的下划线类型标注的信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的删除线类型批注的信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的墨水类型注释信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
PDF页面的图章类型注释的信息类，继承[PdfAnnotationInfo](#ZH-CN_TOPIC_0000002553362427__pdfannotationinfo)。
...
删除指定的[GraphicsObject](#ZH-CN_TOPIC_0000002553362427__graphicsobject)类型对象。
...
文本对象的类型，继承[GraphicsObject](#ZH-CN_TOPIC_0000002553362427__graphicsobject)。
...
图片对象的类型，继承[GraphicsObject](#ZH-CN_TOPIC_0000002553362427__graphicsobject)。
...
文本水印类的相关属性，继承[WatermarkInfo](#ZH-CN_TOPIC_0000002553362427__watermarkinfo)。
...
图片水印类的相关属性，继承[WatermarkInfo](#ZH-CN_TOPIC_0000002553362427__watermarkinfo)。
...
页面内的跳转，继承[PdfAction](#ZH-CN_TOPIC_0000002553362427__pdfaction)。
...
超链接跳转，继承[PdfAction](#ZH-CN_TOPIC_0000002553362427__pdfaction)。
