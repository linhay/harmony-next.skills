...
在[应用开发准备](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-dev-overview)中得到的OAuth 2.0客户端ID，对于AppGallery Connect类应用，该值为应用的Client ID
...
在[应用开发准备](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-dev-overview)中给客户端ID分配的密钥，对于AppGallery Connect类应用，该值为应用的Client Secret。
...
[申请钥匙卡片](数字车钥匙接口.md#section129511211195)时linkDevicePass参数中的token值，用于校验该请求是否合法。
...
[创建Wallet Kit服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-preparations#li69221528123212)时注册的服务号，需要开发者到华为AGC网站申请。
...
DK业务管理服务使用[创建Wallet Kit服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-preparations#li69221528123212)步骤5生成的私钥对publicKey进行签名后返回。
...
在[设备认证](#section113578586311)接口返回的certificate的签名。

DK业务管理服务使用[创建Wallet Kit服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-preparations#li69221528123212)步骤5生成的私钥对Applet的身份公钥签名信息。
...
在[设备认证](#section113578586311)接口返回的certificate里的Applet的身份公钥。
...
[获取个人化数据Token](#section257714144308)返回的token值，用于校验该请求是否合法。
...
Applet的身份私钥对requestBody的Hash值的签名。[获取个人化数据Token](#section257714144308)作为其中requestbody一个key参与Hash值计算。
...
DK业务管理服务使用[创建Wallet Kit服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-preparations#li69221528123212)步骤5生成的私钥对response的Hash值进行签名。
