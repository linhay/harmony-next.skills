...
参数名类型必填说明modifier[GestureModifier](#ZH-CN_TOPIC_0000002529444817__gesturemodifier-1)是
...
参数名类型必填说明event[UIGestureEvent](设置组件绑定的手势.md#ZH-CN_TOPIC_0000002529444823__uigestureevent)是UIGestureEvent对象，用于设置组件需要绑定的手势。
