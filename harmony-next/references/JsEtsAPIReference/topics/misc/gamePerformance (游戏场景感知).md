...
游戏包信息类，继承[BaseGameInfo](#ZH-CN_TOPIC_0000002522242342__basegameinfo)。
...
游戏配置信息类，继承[BaseGameInfo](#ZH-CN_TOPIC_0000002522242342__basegameinfo)。
...
游戏场景信息类，继承[BaseGameInfo](#ZH-CN_TOPIC_0000002522242342__basegameinfo)。
...
游戏网络信息类，继承[BaseGameInfo](#ZH-CN_TOPIC_0000002522242342__basegameinfo)。
...
游戏玩家信息类，继承[BaseGameInfo](#ZH-CN_TOPIC_0000002522242342__basegameinfo)。
...
错误码的详细介绍请参见[ArkTS API错误码]([ArkTS API错误码](../../errors/ArkTS API错误码.md).md)。
