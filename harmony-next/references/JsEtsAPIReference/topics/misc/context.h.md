...
| OH_AI_API void OH_AI_DestroyAllNNRTDeviceDescs(NNRTDeviceDesc **desc) | 销毁从OH_AI_GetAllNNRTDeviceDescs获取的NNRt描述信息实例数组。 |
...
| OH_AI_API OH_AI_Priority OH_AI_DeviceInfoGetPriority(const OH_AI_DeviceInfoHandle device_info) | 获取NNRt任务优先级，仅NNRt设备可用。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_AI_API OH_AI_ContextHandle | 指向上下文信息的OH_AI_ContextHandle。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_AI_ContextHandle *context | 指向OH_AI_ContextHandle的二级指针，上下文销毁后会对context置为空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_AI_ContextHandle context | 指向上下文信息实例的OH_AI_ContextHandle。 |
...
| 参数项 | 描述 |
| --- | --- |
| const OH_AI_ContextHandle context | 指向上下文信息实例的OH_AI_ContextHandle。 |
...
设置运行时线程绑定CPU核心的列表。
 ...
 如果对于同一个上下文对象，调用了[OH_AI_ContextSetThreadAffinityMode](context.h.md#ZH-CN_TOPIC_0000002553362501__oh_ai_contextsetthreadaffinitymode)和[OH_AI_ContextSetThreadAffinityCoreList](context.h.md#ZH-CN_TOPIC_0000002553362501__oh_ai_contextsetthreadaffinitycorelist)。

 这两个函数，则仅[OH_AI_ContextSetThreadAffinityCoreList](context.h.md#ZH-CN_TOPIC_0000002553362501__oh_ai_contextsetthreadaffinitycorelist)的core_list参数生效，而[OH_AI_ContextSetThreadAffinityMode](context.h.md#ZH-CN_TOPIC_0000002553362501__oh_ai_contextsetthreadaffinitymode)的mode参数不生效。
...
| 类型 | 说明 |
| --- | --- |
| OH_AI_API const int32_t * | CPU绑核列表。此列表对象由OH_AI_ContextHandle管理，调用者无须手动释放。 |
...
| --- | --- |
| OH_AI_ContextHandle context | 指向上下文信息实例的OH_AI_ContextHandle。 |
| OH_AI_DeviceInfoHandle device_info | 指向设备信息实例的OH_AI_DeviceInfoHandle。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_AI_DeviceType device_type | 设备类型，具体见OH_AI_DeviceType。 |

返回：

| 类型 | 说明 |
| --- | --- |
| OH_AI_API OH_AI_DeviceInfoHandle | 指向设备信息实例的OH_AI_DeviceInfoHandle。 |
...
| 参数项 | 描述 |
| --- | --- |
| const OH_AI_DeviceInfoHandle device_info | 指向设备信息实例的OH_AI_DeviceInfoHandle。 |
...
销毁从[OH_AI_GetAllNNRTDeviceDescs](context.h.md#ZH-CN_TOPIC_0000002553362501__oh_ai_getallnnrtdevicedescs)获取的NNRt描述信息实例数组。
...
| 类型 | 说明 |
| --- | --- |
| OH_AI_API OH_AI_Priority | OH_AI_Priority NNRt任务优先级。 |
