...
参数名类型必填说明reasonsArray<[ObscuredReasons](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__obscuredreasons10)>是

设置组件内容的遮罩类型。

默认值：[]

仅支持[Image](../graphics/Image.md)组件、[Text](../graphics/Text.md)组件的隐私遮罩处理。

**说明：**

如需在图片加载过程中显示隐私遮罩，需要设置Image组件的宽度和高度。

Text组件设置子组件或设置[属性字符串](属性字符串.md)时，不支持隐私遮罩。
