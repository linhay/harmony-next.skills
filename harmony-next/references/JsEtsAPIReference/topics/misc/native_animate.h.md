...
| uint32_t OH_ArkUI_AnimateOption_GetDuration(ArkUI_AnimateOption* option) | 获取动画持续时间，单位为ms（毫秒）。 |
...
| void OH_ArkUI_AnimateOption_SetDuration(ArkUI_AnimateOption* option, int32_t value) | 设置动画持续时间，单位为ms（毫秒）。 |
...
| void OH_ArkUI_AnimateOption_SetDelay(ArkUI_AnimateOption* option, int32_t value) | 设置动画延迟播放时间，单位为ms（毫秒）。 |
...
| int32_t OH_ArkUI_KeyframeAnimateOption_GetDelay(ArkUI_KeyframeAnimateOption* option) | 获取关键帧整体延时时间，单位为ms（毫秒）。 |
...
| int32_t OH_ArkUI_KeyframeAnimateOption_GetDuration(ArkUI_KeyframeAnimateOption* option, int32_t index) | 获取关键帧动画某段状态持续时间，单位为ms（毫秒）。 |
...
| int32_t OH_ArkUI_AnimatorOption_SetDuration(ArkUI_AnimatorOption* option, int32_t value) | 设置animator动画播放的时长，单位为ms（毫秒）。 |
| int32_t OH_ArkUI_AnimatorOption_SetDelay(ArkUI_AnimatorOption* option, int32_t value) | 设置animator动画延时播放时长，单位为ms（毫秒）。 |
...
| ArkUI_AnimationFillMode OH_ArkUI_AnimatorOption_GetFill(ArkUI_AnimatorOption* option) | 获取animator动画执行后是否恢复到初始状态。 |
...
| float OH_ArkUI_AnimatorOption_GetKeyframeTime(ArkUI_AnimatorOption* option, int32_t index) | 获取animator动画关键帧时间，单位为ms（毫秒）。 |
...
| int32_t OH_ArkUI_Animator_ResetAnimatorOption(ArkUI_AnimatorHandle animatorHandle, ArkUI_AnimatorOption* option) | 更新animator动画。 |
| int32_t OH_ArkUI_Animator_Play(ArkUI_AnimatorHandle animatorHandle) | 启动animator动画。 |
| int32_t OH_ArkUI_Animator_Finish(ArkUI_AnimatorHandle animatorHandle) | 结束animator动画。 |
| int32_t OH_ArkUI_Animator_Pause(ArkUI_AnimatorHandle animatorHandle) | 暂停animator动画。 |
| int32_t OH_ArkUI_Animator_Cancel(ArkUI_AnimatorHandle animatorHandle) | 取消animator动画。 |
| int32_t OH_ArkUI_Animator_Reverse(ArkUI_AnimatorHandle animatorHandle) | 以相反的顺序播放animator动画。 |
...
| ArkUI_TransitionEffect* OH_ArkUI_CreateMovementTransitionEffect(ArkUI_TransitionEdge edge) | 创建组件平移效果对象。 |
...
| void OH_ArkUI_TransitionEffect_Dispose(ArkUI_TransitionEffect* effect) | 销毁转场效果对象。 |
| int32_t OH_ArkUI_TransitionEffect_Combine(ArkUI_TransitionEffect* firstEffect, ArkUI_TransitionEffect* secondEffect) | 设置转场效果链式组合，以形成包含多种转场效果的TransitionEffect。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_AnimateOption* option | 动画效果参数。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_AnimationPlayMode | 动画播放模式。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_ExpectedFrameRateRange* | 动画的期望帧率，单位为帧/秒（fps）。 |
...
| --- | --- |
| ArkUI_AnimateOption* option | 动画效果参数。 |
| ArkUI_AnimationCurve value | 动画曲线。默认值：ARKUI_CURVE_LINEAR。 |
...
| --- | --- |
| ArkUI_AnimateOption* option | 动画效果参数。 |
| ArkUI_AnimationPlayMode value | 动画播放模式。 |
...
| --- | --- |
| ArkUI_AnimateOption* option | 动画效果参数。 |
| ArkUI_ExpectedFrameRateRange* value | 动画的期望帧率，单位为帧/秒（fps）。 |
...
此方法优先于[OH_ArkUI_AnimateOption_SetCurve](#ZH-CN_TOPIC_0000002522081028__oh_arkui_animateoption_setcurve)生效。
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_AnimateOption* option | animator动画参数。 |
| ArkUI_CurveHandle value | 动画曲线参数。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_KeyframeAnimateOption* | 关键帧动画参数对象。size小于0时返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_KeyframeAnimateOption* option | 关键帧动画参数对象。 |
...
| void (*onFinish)(void* userData) | 回调方法。 - userData：回调函数的入参，用户自定义对象指针。 |
...
| --- | --- |
| ArkUI_KeyframeAnimateOption* option | 关键帧动画参数。 |
| ArkUI_ExpectedFrameRateRange* frameRate | 关键帧动画的期望帧率。 |
...
| --- | --- |
| ArkUI_KeyframeAnimateOption* option | 关键帧动画参数。 |
| ArkUI_CurveHandle value | 该关键帧使用的动画曲线。默认值：EASE_IN_OUT。 |
| int32_t index | 状态索引值。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_ExpectedFrameRateRange* | 关键帧动画参数的期望帧率。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_CurveHandle | 动画曲线。函数参数异常时返回NULL。 |
...
| --- | --- |
| ArkUI_AnimatorOption* option | animator动画对象参数。 |
| ArkUI_AnimationFillMode value | 动画执行后是否恢复到初始状态。 |
...
| --- | --- |
| ArkUI_AnimatorOption* option | animator动画对象参数。 |
| ArkUI_AnimationDirection value | 动画播放方向。 |
...
| --- | --- |
| ArkUI_AnimatorOption* option | animator动画对象参数。 |
| ArkUI_CurveHandle value | 动画插值曲线。默认值：ARKUI_CURVE_LINEAR。 |
...
| --- | --- |
| ArkUI_AnimatorOption* option | animator动画对象参数。 |
| ArkUI_ExpectedFrameRateRange* value | 期望的帧率范围对象。 |
...
| --- | --- |
| ArkUI_AnimatorOption* option | animator动画对象参数。 |
| ArkUI_CurveHandle value | 动画插值曲线。 |
| int32_t index | 关键帧的索引值。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_AnimatorOption* option | animator动画动画参数。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_AnimationFillMode | 执行后是否恢复到初始状态。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_AnimationDirection | 动画播放方向。 |
