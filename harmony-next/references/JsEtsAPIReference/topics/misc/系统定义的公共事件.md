...
公共事件类型定义在[ohos.commonEventManager模块的Support枚举](@ohos.commonEventManager (公共事件模块).md#ZH-CN_TOPIC_0000002553201561__support)中。
...
与这个公共事件相关的接口：setOsAccountName、setOsAccountProfilePhoto, 这些为系统API，setOsAccountDistributedInfo为公共API，具体参看[系统账号接口文档](@ohos.account.osAccount (系统账号管理).md)、[分布式账号接口文档](@ohos.account.distributedAccount (分布式账号管理).md)。
...
与这个公共事件相关的接口：setOsAccountDistributedInfo、updateOsAccountDistributedInfo(已废弃)，这些为公共API，setOsAccountDistributedInfoByLocalId为系统API，具体参看[分布式账号接口文档](@ohos.account.distributedAccount (分布式账号管理).md)。
...
从API Version 10开始废弃，替代接口为[COMMON_EVENT_SCREEN_UNLOCKED](#ZH-CN_TOPIC_0000002522241594__common_event_screen_unlocked)。
...
**COMMON_EVENT_BLUETOOTH_HOST_SCAN_MODE_CHANGE23+**
...
**COMMON_EVENT_TABLET_MODE_CHANGED23+**
...
**COMMON_EVENT_LID_STATE_CHANGED23+**
...
从API version 9 开始支持，从API version 20 开始废弃，建议使用[COMMON_EVENT_BLUETOOTH_HANDSFREE_AG_CONNECT_STATE_CHANGE](#ZH-CN_TOPIC_0000002522241594__common_event_bluetooth_handsfree_ag_connect_state_change20)替代。
...
从API version 9 开始支持，从API version 20 开始废弃，建议使用[COMMON_EVENT_BLUETOOTH_A2DPSOURCE_CONNECT_STATE_CHANGE](#ZH-CN_TOPIC_0000002522241594__common_event_bluetooth_a2dpsource_connect_state_change20)替代。
...
从API version 9 开始支持，从API version 20 开始废弃，建议使用[COMMON_EVENT_BLUETOOTH_A2DPSOURCE_AVRCP_CONNECT_STATE_CHANGE](#ZH-CN_TOPIC_0000002522241594__common_event_bluetooth_a2dpsource_avrcp_connect_state_change20)替代。
...
从API version 9 开始支持，从API version 20 开始废弃，建议使用[COMMON_EVENT_BLUETOOTH_A2DPSOURCE_CODEC_VALUE_CHANGE](#ZH-CN_TOPIC_0000002522241594__common_event_bluetooth_a2dpsource_codec_value_change20)替代。
...
从API version 9 开始支持，从API version 20 开始废弃，建议使用[COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_ACL_STATE_CHANGE](#ZH-CN_TOPIC_0000002522241594__common_event_bluetooth_remotedevice_acl_state_change20)替代。
...
从API version 9 开始支持，从API version 20 开始废弃，建议使用[COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_PAIR_STATE_CHANGE](#ZH-CN_TOPIC_0000002522241594__common_event_bluetooth_remotedevice_pair_state_change20)替代。
