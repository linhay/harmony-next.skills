...
初始化后，动态修改[margin](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__margin)、[border](边框设置.md#ZH-CN_TOPIC_0000002497604832__border)、[padding](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__padding)通用属性导致子组件宽度大于相邻分割线间距的异常情况下，不支持拖动分割线改变子组件的宽度。
...
RowSplit组件[通用属性clip](形状裁剪.md)的默认值为true。
