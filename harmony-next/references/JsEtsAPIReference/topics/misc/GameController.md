...
名称描述[game_controller_type.h](../../capi/headers/game_controller_type.h.md)定义GameController模块的通用枚举类型。[game_device.h](../../capi/headers/game_device.h.md)定义游戏设备的接口。[game_device_event.h](../../capi/headers/game_device_event.h.md)定义游戏设备事件的接口。[game_pad.h](../../capi/headers/game_pad.h.md)定义游戏手柄的接口。[game_pad_event.h](../../capi/headers/game_pad_event.h.md)定义游戏手柄事件的接口。
