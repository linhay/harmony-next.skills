...
定义DataAbility数据操作结果，通过[executeBatch](DataAbilityHelper.md#ZH-CN_TOPIC_0000002553360489__dataabilityhelperexecutebatch)操作数据库时，操作结果使用DataAbilityResult对象返回。
