...
此结构体描述创建超帧上下文实例[FG_Context_VK](GraphicsAccelerate.md#ZH-CN_TOPIC_0000002522242234__fg_context_vk)所需的属性信息。
...
Vulkan逻辑设备句柄，需在[FG_Context_VK](GraphicsAccelerate.md#ZH-CN_TOPIC_0000002522242234__fg_context_vk)的整个生命周期内有效。
...
Vulkan实例, 需在[FG_Context_VK](GraphicsAccelerate.md#ZH-CN_TOPIC_0000002522242234__fg_context_vk)的整个生命周期内有效。
...
Vulkan物理设备句柄, 需在[FG_Context_VK](GraphicsAccelerate.md#ZH-CN_TOPIC_0000002522242234__fg_context_vk)的整个生命周期内有效。