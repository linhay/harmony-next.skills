...
设置aspectRatio属性后，组件宽高会受父组件内容区大小限制，[constraintSize](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__constraintsize)的优先级高于aspectRatio。
...
仅在[Row](Row.md)/[Column](Column.md)/[Flex(单行)](Flex.md)容器组件中生效。
