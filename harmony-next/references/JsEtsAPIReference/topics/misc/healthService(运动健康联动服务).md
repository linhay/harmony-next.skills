...
SampleReal<K extends Record<string, [healthStore.HealthValueType](healthStore(运动健康数据服务).md#ZH-CN_TOPIC_0000002522082354__healthvaluetype)> = Record<string, [healthStore.HealthValueType](healthStore(运动健康数据服务).md#ZH-CN_TOPIC_0000002522082354__healthvaluetype)>>
...
上述接口调用前，需先使用[init](healthStore(运动健康数据服务).md#ZH-CN_TOPIC_0000002522082354__healthstoreinit)方法进行初始化。
