...
可以通过[acquireDataAbilityHelper](@ohos.ability.featureAbility (FeatureAbility模块).md#ZH-CN_TOPIC_0000002522240548__featureabilityacquiredataabilityhelper7)接口获取DataAbilityHelper对象。
...
insert(uri: string, valuesBucket: [rdb.ValuesBucket](@ohos.data.rdb (关系型数据库).md#ZH-CN_TOPIC_0000002522080640__valuesbucket), callback: AsyncCallback<number>): void
...
insert(uri: string, valuesBucket: [rdb.ValuesBucket](@ohos.data.rdb (关系型数据库).md#ZH-CN_TOPIC_0000002522080640__valuesbucket)): Promise<number>
