...
[CloudOptions](#section6286921112312)
...
云函数业务免鉴权，开发云函数无需获取用户凭据。开发云存储或云数据库业务则需要获取用户凭据。获取用户凭据有两种方式，以下代码仅以通过AGC认证服务SDK获取为例，更多信息可参考[AuthProvider](#section136610231214)。
...
[CloudRegion](#section10763191910114)
...
[AuthProvider](#section136610231214)
...
[FunctionOptions](#section11284175361211)
...
[StorageOptions](#section1772621115138)
...
[DatabaseOptions](#section2817232171313)
...
```
  ...
  1. 使用手机、邮箱或华为账号进行[登录认证](https://developer.huawei.com/consumer/cn/doc/app/agc-help-auth-login-0000002271496189)。
  1. 认证成功后获取AuthProvider。
