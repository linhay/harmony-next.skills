...
NfcATag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
NfcBTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
NfcFTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
NfcVTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
IsoDepTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
getNdefRecords(): [tag.NdefRecord](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002553361371__ndefrecord9)[]
...
NdefTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。

以下是NdefTag的独有接口。

**NdefTag.getNdefTagType9+**

getNdefTagType(): [tag.NfcForumType](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002553361371__nfcforumtype9)
...
getNdefMessage(): [NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9)
...
readNdef(): Promise<[NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9)>
...
readNdef(callback: AsyncCallback<[NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9)>): void
...
writeNdef(msg: [NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9)): Promise<void>
...
writeNdef(msg: [NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9), callback: AsyncCallback<void>): void
...
getNdefTagTypeString(type: [tag.NfcForumType](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002553361371__nfcforumtype9)): string
...
MifareClassicTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
getType(): [tag.MifareClassicType](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002553361371__mifareclassictype9)
...
获取标签的存储空间大小，具体请参见[MifareClassicSize](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002553361371__mifareclassicsize9)。
...
MifareUltralightTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
getType(): [tag.MifareUltralightType](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002553361371__mifareultralighttype9)
...
NdefFormatableTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。

以下是NdefFormatableTag的独有接口。

**NdefFormatableTag.format9+**

format(message: [NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9)): Promise<void>
...
format(message: [NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9), callback: AsyncCallback<void>): void
...
formatReadOnly(message: [NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9)): Promise<void>
...
formatReadOnly(message: [NdefMessage](#ZH-CN_TOPIC_0000002553361375__ndefmessage9), callback: AsyncCallback<void>): void
...
BarcodeTag获取方式请参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
