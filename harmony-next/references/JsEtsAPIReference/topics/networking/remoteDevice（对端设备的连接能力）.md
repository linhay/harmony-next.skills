...
type PairingState = [constant.PairingState](constant（星闪公共常量定义）.md#ZH-CN_TOPIC_0000002553201439__pairingstate)
...
type ConnectionState = [constant.ConnectionState](constant（星闪公共常量定义）.md#ZH-CN_TOPIC_0000002553201439__connectionstate)
...
type DeviceClass = [constant.DeviceClass](constant（星闪公共常量定义）.md#ZH-CN_TOPIC_0000002553201439__deviceclass)
...
type AcbState = [constant.AcbState](constant（星闪公共常量定义）.md#ZH-CN_TOPIC_0000002553201439__acbstate)
...
提供远端设备的操作方法，使用前需要使用[remoteDevice.createRemoteDevice](#ZH-CN_TOPIC_0000002522241468__createremotedevice)方法创建一个远端设备[RemoteDevice](#ZH-CN_TOPIC_0000002522241468__remotedevice)实例。一个设备只需要创建一次，无需多次创建。
