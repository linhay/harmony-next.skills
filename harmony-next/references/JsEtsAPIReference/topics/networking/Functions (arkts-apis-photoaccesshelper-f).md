...
参数名类型必填说明context[Context](../graphics/Context (Stage模型的上下文基类).md)是传入Ability实例的上下文。

**返回值：**

类型说明[PhotoAccessHelper](../../types/interfaces/Interface (PhotoAccessHelper).md)相册管理模块的实例。
