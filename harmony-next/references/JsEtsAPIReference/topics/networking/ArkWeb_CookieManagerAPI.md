...
定义了ArkWeb的CookieManager接口。在调用接口之前，建议使用[ARKWEB_MEMBER_MISSING](../../capi/headers/arkweb_type.h.md#ZH-CN_TOPIC_0000002529445189__宏定义)检查函数结构体是否有对应的函数指针，避免SDK与设备ROM不匹配导致崩溃。CookieManager相关接口需在UI线程中调用OH_ArkWeb_GetNativeAPI方法获取。
...
[ARKWEB_SUCCESS](../../capi/headers/arkweb_error_code.h.md#ZH-CN_TOPIC_0000002529445187__arkweb_errorcode) 获取cookie成功。

[ARKWEB_INVALID_URL](../../capi/headers/arkweb_error_code.h.md#ZH-CN_TOPIC_0000002529445187__arkweb_errorcode) 设置的URL无效。

[ARKWEB_INVALID_PARAM](../../capi/headers/arkweb_error_code.h.md#ZH-CN_TOPIC_0000002529445187__arkweb_errorcode) cookieValue参数无效。
