...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getTagInfo](@ohos.nfc.tag (标准NFC-Tag).md#ZH-CN_TOPIC_0000002553361371__taggettaginfo9)替代。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.connect](#ZH-CN_TOPIC_0000002522241448__connect9)替代。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.resetConnection](#ZH-CN_TOPIC_0000002522241448__resetconnection9)替代。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.isConnected](#ZH-CN_TOPIC_0000002522241448__isconnected9)替代。
...
检查是否已与标签建立连接。如果返回未连接，则需要先调用[tagSession.connect](#ZH-CN_TOPIC_0000002522241448__connect9)建立连接。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.getMaxTransmitSize](#ZH-CN_TOPIC_0000002522241448__getmaxtransmitsize9)替代。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.getTimeout](#ZH-CN_TOPIC_0000002522241448__gettimeout9)替代。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.setTimeout](#ZH-CN_TOPIC_0000002522241448__settimeout9)替代。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.transmit](#ZH-CN_TOPIC_0000002522241448__transmit9)替代。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tagSession.transmit](#ZH-CN_TOPIC_0000002522241448__transmit9-1)替代。
