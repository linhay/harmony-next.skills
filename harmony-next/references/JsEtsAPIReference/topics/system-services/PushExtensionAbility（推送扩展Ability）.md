...
推送扩展Ability目前为预留能力，暂未开放使用。若您的应用有拉起应用的子进程，在子进程中自行处理业务的诉求，请参考[推送通知扩展消息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/push-extend-noti)。
...
[PushExtensionContext](../graphics/PushExtensionContext（推送扩展Context）.md)

否

否

PushExtensionAbility的上下文环境，继承自[ExtensionContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-extensioncontext)。
