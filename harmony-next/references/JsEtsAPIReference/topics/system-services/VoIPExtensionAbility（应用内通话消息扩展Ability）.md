...
[VoIPExtensionContext](../graphics/VoIPExtensionContext（应用内通话消息扩展Context）.md#section4636115714125)

否

否

VoIPExtensionAbility的上下文环境，继承自[UIExtensionContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiextensioncontext)。
...
pushCommon.[VoIPInfo](../misc/pushCommon（推送服务公共信息）.md#section3437161814585)
