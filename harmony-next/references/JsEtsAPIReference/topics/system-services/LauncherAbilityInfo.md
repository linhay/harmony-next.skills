...
桌面应用的Ability信息，可以通过[getLauncherAbilityInfoSync](../../modules/ohos/@ohos.bundle.launcherBundleManager (launcherBundleManager模块).md#ZH-CN_TOPIC_0000002529444579__launcherbundlemanagergetlauncherabilityinfosync)获取。
