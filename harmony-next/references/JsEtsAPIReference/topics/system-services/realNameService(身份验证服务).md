...
预验证ID。获取方式请参考[实名信息预验证](../misc/实名信息预验证.md)。
...
Promise对象。返回实名信息验证ID，用于[实名信息验证结果查询](../misc/实名信息验证结果查询.md)。
...
Promise对象。返回实名信息授权ID，用于[实名信息授权结果查询](../misc/实名信息授权结果查询.md)。
...
预验证ID。获取方式请参考[人脸核身实人预验证](../misc/人脸核身实人预验证.md)。
...
Promise对象。返回验证结果ID，用于[人脸核身实人验证结果查询](../misc/人脸核身实人验证结果查询.md)。
