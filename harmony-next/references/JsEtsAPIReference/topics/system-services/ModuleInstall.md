...
[module_install.h](../../capi/headers/module_install.h.md)
...
typedef struct [ModuleInstall_InstalledModule](#ZH-CN_TOPIC_0000002459017220__osaccount_errcode)[ModuleInstall_InstalledModule](#ZH-CN_TOPIC_0000002459017220__osaccount_errcode)

安装模块信息。

typedef struct [ModuleInstall_FetchModulesResult](#section115389533615)[ModuleInstall_FetchModulesResult](#section115389533615)

安装模块结果。

typedef struct [ModuleInstall_StatusCallback](#section48269177812)[ModuleInstall_StatusCallback](#section48269177812)

模块安装状态回调。

typedef void (*[ModuleInstall_OnStatusCallback](#section9881414171010))(char *bundleName, char *eventInfo)
...
[ModuleInstall_ErrCode](#ZH-CN_TOPIC_0000002459017220__osaccount_errcode-1)

枚举错误码。

[ModuleInstall_InstallStatus](#section19925459265)

枚举安装状态。

[ModuleInstall_RequestCode](#section10742174163618)

枚举请求码。

[ModuleInstall_TaskStatus](#section14463723193715)
...
[HMS_ModuleInstall_GetInstalledModule](#ZH-CN_TOPIC_0000002459017220__oh_osaccount_getname)

查询模块是否安装。

[HMS_ModuleInstall_GetInstalledModuleName](#section19475184213526)

获取模块名。

[HMS_ModuleInstall_GetInstalledModuleType](#section39341746155513)

获取模块类型。

[HMS_ModuleInstall_GetModuleInstallStatus](#section84699521566)

获取模块安装状态。

[HMS_ModuleInstall_FetchModules](#section1533121613581)

请求下载模块。

[HMS_ModuleInstall_GetFetchModulesRequestCode](#section191414113614)

获取模块下载请求码。

[HMS_ModuleInstall_GetFetchModulesTaskStatus](#section142448141910)

获取模块下载任务状态。

[HMS_ModuleInstall_GetFetchModulesTaskId](#section979412409101)

获取模块下载任务id。

[HMS_ModuleInstall_GetFetchModulesDesc](#section762681812121)

获取模块下载描述。

[HMS_ModuleInstall_GetFetchModules](#section55521545111313)

获取模块下载模块名。

[HMS_ModuleInstall_GetFetchModulesTotalSize](#section1071043411515)

获取模块下载总大小。

[HMS_ModuleInstall_GetFetchModulesDownloadedSize](#section04641118168)

获取模块下载已下载大小。

[HMS_ModuleInstall_CancelTask](#section1177619221712)

取消下载任务。

[HMS_ModuleInstall_ShowCellularDataConfirmation](#section1897653081720)

展示流量弹窗。

[HMS_ModuleInstall_CreateStatusCallback](#section1710031151816)

创建下载进度监听回调。

[HMS_ModuleInstall_On](#section18492123951816)

下载进度监听。

[HMS_ModuleInstall_ReleaseStatusCallback](#section1541418516194)

释放下载进度监听回调。

[HMS_ModuleInstall_Off](#section1260162551917)
...
未与[HMS_ModuleInstall_On](#section18492123951816)接口共同使用。
...
[HMS_ModuleInstall_ShowCellularDataConfirmation](#section1897653081720)接口，提醒用户确认是否使用流量下载。
...
[ModuleInstall_InstalledModule](#ZH-CN_TOPIC_0000002459017220__osaccount_errcode) **installedModule
...
返回模块类型, 取值参考：[bundleManager.ModuleType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager#moduletype)。当[ModuleInstall_InstallStatus](#section19925459265)=1时，默认返回0。
...
模块安装状态，取值参考：[ModuleInstall_InstallStatus](#section19925459265)。
...
nt moduleNamesLength

模块名数组长度，最大长度512。

[ModuleInstall_FetchModulesResult](#section115389533615) **fetchModulesResult
...
按需下载模块请求码，取值参考: [ModuleInstall_RequestCode](#section10742174163618)。
...
模块下载任务状态，取值参考：[ModuleInstall_TaskStatus](#section14463723193715)。
...
[ModuleInstall_OnStatusCallback](#section9881414171010) *onStatusCallback
...
[ModuleInstall_StatusCallback](#section48269177812) **callback
...
[ModuleInstall_StatusCallback](#section48269177812) *statusCallback
