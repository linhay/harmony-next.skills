...
[TimeGuardExtensionContext](../graphics/TimeGuardExtensionContext（屏幕时间守护扩展Context）.md)

否

否

[TimeGuardExtensionContext](../graphics/TimeGuardExtensionContext（屏幕时间守护扩展Context）.md)上下文环境，继承自[ExtensionContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-extensioncontext)。
...
当用户在设置-健康使用设备-授权管理中授予应用授权时，应用接收该回调。
...
当用户在设置-健康使用设备-授权管理中撤销应用授权时，应用接收该回调。
