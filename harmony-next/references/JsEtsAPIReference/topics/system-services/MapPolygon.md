...
多边形，继承[BaseOverlay](../misc/BaseOverlay.md)。多边形可以是凸面或凹面，它可以跨越180子午线并且可以具有未填充的孔。在调用map.[MapComponentController](../components/MapComponentController.md)类的[addPolygon](../components/MapComponentController.md#section1825517119280)方法时会返回该类型的实例。
...
Array<Array<[mapCommon.LatLng](../misc/mapCommon（地图属性模型）.md#section20691173773810)>>

多边形的空心洞数组，其中空心洞是[LatLng](../misc/mapCommon（地图属性模型）.md#section20691173773810)数组。
...
空心洞数组，其中空心洞是[LatLng](../misc/mapCommon（地图属性模型）.md#section20691173773810)数组。
...
顶点样式，默认值为[JointType](../misc/mapCommon（地图属性模型）.md#section73559613164).DEFAULT。
...
[PatternItem](../misc/mapCommon（地图属性模型）.md#section917314511192)对象的数组。默认的边框样式为实心。
