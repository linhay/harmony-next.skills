...
名称描述[video_processing.h](../../capi/headers/video_processing.h.md)声明视频处理函数。提供视频处理能力，包括颜色空间转换、元数据生成和视频缩放。[video_processing_types.h](../../capi/headers/video_processing_types.h.md)视频处理类型定义。