...
[AttestOptions](#section18297145185618)
...
以下错误码的详细介绍请参见[ArkTS API错误码](../../errors/ArkTS API错误码 (devicesecurity-arktsapi-errcode).md)**。**
...
[createAttestKey](#section81796536265)接口的请求参数。
...
Array<[AttestParam](#section0633210102)>
...
[AttestOptions](#section18297145185618)配置信息的内容条目。
...
[AttestTag](#section1427551613315)
...
1）tag为ATTEST_TAG_ALGORITHM，其值为[AttestKeyAlg](#section17268105152417)类型。

2）tag为ATTEST_TAG_KEY_SIZE，其值为[AttestKeySize](#section932031292912)类型。

3）tag为ATTEST_TAG_DEVICE_TYPE，其值为[AttestType](#section8803148183419)类型。

**bigint：**

tag为ATTEST_TAG_DEVICE_ID，其值为设备ID，取值范围int64类型的随机值。
...
配置信息标签类型，使用[AttestTagType](#section18511411417)扩展定义。
...
Promise<[AttestReturnResult](#section1348925811317)>
...
[initializeAttestContext](#section166716269293)接口的返回值。
...
[LocatingPriority](#section6450421300)
...
Promise<[SecureLocation](#section168048435326)>
...
[SecImageProcParamsArray](#section1429553183618)
...
Promise<[SecImageBuffer](#section147282975418)>
...
[procSecImageTransform](#section4271646181318)接口的请求参数。
...
Array<[SecImageProcParams](#section152961316368)>
...
[SecImageProcParamsArray](#section1429553183618)配置信息的内容条目。
...
[SecImageProcTag](#section918018974416)
...
number | [CropRegion](#section5236627181910)
...
，其值为[SecImageProcParamsArray](#section1429553183618)类型；

2）tag为SECIMAGE_TAG_PROC_OPERATION，其值为[SecImageProcOperation](#section118088168584)类型；

3）tag为SECIMAGE_TAG_COMPRESSION_QUALITY，其值为1到100之间；

**CropRegion：**

tag为SECIMAGE_TAG_CROP_REGION，其值为[CropRegion](#section5236627181910)类型。

[]()[]()

#### SecImageProcTag

安全图像压缩、裁剪处理的配置信息标签类型，使用[AttestTagType](#section18511411417)扩展定义。
