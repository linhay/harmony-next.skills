...
名称类型只读可选说明namestring否否名称，没有特殊格式要求。resourceType[SceneResourceType](#ZH-CN_TOPIC_0000002529286067__sceneresourcetype)是否场景资源类型，默认值为undefined。uri[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是是需要加载的资源，默认值为undefined。
...
名称类型只读可选说明inputsRecord<string, number | [Vec2](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec2) | [Vec3](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec3) | [Vec4](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec4) | Image>是否着色器输入。
...
名称类型只读可选说明image[Image](#ZH-CN_TOPIC_0000002529286067__image) | null否否基于物理渲染（PBR）属性纹理贴图，用于表达材质的纹理信息。factor[Vec4](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec4)否否基于物理渲染（PBR）属性因子，不同属性不同含义。sampler[Sampler](#ZH-CN_TOPIC_0000002529286067__sampler20)否是纹理贴图采样器，默认使用放大、缩小和mipmap过滤模式为线性过滤（LINEAR），纹理贴图U、V、W方向的寻址模式为重复（REPEAT）。
...
名称类型只读可选说明namestring否否名称，没有特殊格式要求。material[Material](#ZH-CN_TOPIC_0000002529286067__material)否否材质。aabb[Aabb](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__aabb)是否轴对齐边界盒。
...
名称类型只读可选说明subMeshes[SubMesh](#ZH-CN_TOPIC_0000002529286067__submesh)[]是否子网格数组。aabb[Aabb](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__aabb)是否轴对齐包围盒。materialOverride[Material](#ZH-CN_TOPIC_0000002529286067__material)否是材质，默认为空。
...
名称类型只读可选说明backgroundType[EnvironmentBackgroundType](#ZH-CN_TOPIC_0000002529286067__environmentbackgroundtype)否否环境背景类型。indirectDiffuseFactor[Vec4](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec4)否否间接散射系数。indirectSpecularFactor[Vec4](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec4)否否间接反射系数。environmentMapFactor[Vec4](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec4)否否环境地图系数。environmentImage[Image](#ZH-CN_TOPIC_0000002529286067__image) | null否是环境图片，默认为undefined。radianceImage[Image](#ZH-CN_TOPIC_0000002529286067__image) | null否是辐射图片，默认为undefined。irradianceCoefficients[Vec3](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec3)[]否是辐射系数，默认为undefined。
