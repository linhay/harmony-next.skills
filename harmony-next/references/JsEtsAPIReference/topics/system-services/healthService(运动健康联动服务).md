...
SampleReal<K extends Record<string, [healthStore.HealthValueType](../misc/healthStore(运动健康数据服务).md#section14966196131311)> = Record<string, [healthStore.HealthValueType](../misc/healthStore(运动健康数据服务).md#section14966196131311)>>
...
[healthStore.DataType](../misc/healthStore(运动健康数据服务).md#section136147472298)
...
运动类型，参见[锻炼记录类型常量](../misc/exerciseSequenceHelper(锻炼记录类型常量).md)子数据类型id。
...
[1009104003](../../errors/ArkTS API错误码.md#section2796145134414)

Illegal command. Called when workout not in stoped or idle state.

[1009104999](../../errors/ArkTS API错误码.md#section358195916206)

System internal error.

上述接口调用前，需先使用[init](../misc/healthStore(运动健康数据服务).md#section1571935817328)方法进行初始化。
...
[1009104001](../../errors/ArkTS API错误码.md#section9399145163817)

Sport service busy. Workout is already started by other application.

[1009104002](../../errors/ArkTS API错误码.md#section1492831113409)
...
[1009104004](../../errors/ArkTS API错误码.md#section5369132174419)
...
[14500101](../../errors/ArkTS API错误码.md#section6671152405412)
