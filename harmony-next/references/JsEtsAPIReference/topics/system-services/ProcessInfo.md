...
定义进程信息，可以通过[getProcessInfo](../graphics/Context (FA模型的上下文基类).md#ZH-CN_TOPIC_0000002529444569__contextgetprocessinfo7)获取当前Ability运行的进程信息。
...
名称类型只读可选说明pidnumber否否进程ID。processNamestring否否进程名称。
