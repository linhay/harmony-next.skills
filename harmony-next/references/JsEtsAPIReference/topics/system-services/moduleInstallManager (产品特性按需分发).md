...
[bundleManager.ModuleType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager#moduletype)
...
[InstallStatus](#section45163241117)
...
[RequestErrorCode](#section320243191414)
...
[TaskStatus](#section1138541061512)
...
当前使用的是流量，开发者需要调用[showCellularDataConfirmation](#section104451223191616)接口，提醒用户确认是否使用流量下载。
...
[InstalledModule](#section1518175355911)
...
实现按需加载的方法，提供创建按需加载请求对象能力，继承[InstallProvider](#section65611296515)。
...
[common.UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | [common.ExtensionContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-extensioncontext)
...
[ModuleInstallRequest](#section5451648162618)
...
按需下载请求对象，继承[InstallRequest](#section7993755494)。
...
Promise<[ModuleInstallSessionState](#section1535385414136)>
...
Callback<[ModuleInstallSessionState](#section1535385414136)>
...
注册监听允许的最大监听时间，默认30分钟（即30*60s），且最大超过30分钟也是按30分钟算。
