...
运行进程信息，可以通过appManager中[getProcessRunningInfos](../../modules/ohos/@ohos.application.appManager (appManager).md#ZH-CN_TOPIC_0000002497604642__appmanagergetprocessrunninginfosdeprecated)方法来获取运行进程信息。
