...
文件类型对应的UTD-ID，详见[图标格式说明](../../guides/图标格式说明.md)
...
Promise<string | [Resource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resource)>

文件图标的Base64编码或资源对象。使用Promise异步回调。
