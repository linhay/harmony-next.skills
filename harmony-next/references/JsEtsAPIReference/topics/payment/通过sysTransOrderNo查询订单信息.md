...
| [PayMercAuth](数据模型说明.md#section11744172016145) | 是 | String | 取值为：PayMercAuth的JSON字符串 |
...
| promotionDetail | 否 | List<[PromotionItem](数据模型说明.md#section11685193853815)> | 营销信息，订单参与营销活动时才会返回。 |
...
| payer | 否 | [PayerOut](数据模型说明.md#section796891012811) | 用户支付时客户端信息。 |
...
resultCode非400000的错误码请查看[公共错误码说明](REST API错误码.md#ZH-CN_TOPIC_0000002522082504__[公共错误码说明](../../errors/REST API错误码.md#section1187515498410))。
