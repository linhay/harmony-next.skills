...
名称描述[avrecorder.h](../../capi/headers/avrecorder.h.md)定义AVRecorder接口。应用可使用媒体AVRecorder提供的接口录制媒体数据。[avrecorder_base.h](../../capi/headers/avrecorder_base.h.md)定义了媒体AVRecorder的结构体和枚举。