...
https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/contract/sign/merc-contracts/{mercContractCode}
...
商户签约协议号。商户请求签约时传入的签约协议号，商户侧须唯一。最大长度64。
