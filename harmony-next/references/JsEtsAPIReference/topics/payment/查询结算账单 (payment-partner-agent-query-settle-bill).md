...
1. 账单下载后，建议遍历附件目录以获取csv后缀的文件进行解析。
...
**result_code**非400000的错误码请查看[公共错误码说明](../../errors/REST API错误码 (payment-error-code-rest).md#section1187515498410)。
...
请检查并[打开账单开关](#section14244533142816)。
