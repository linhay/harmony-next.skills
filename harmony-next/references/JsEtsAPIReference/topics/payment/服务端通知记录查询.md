...
| notificationType | 否 | String | 通知主类型，不传查所有通知类型。通知主类型，具体请参见表NotificationType说明 |
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| responseCode | 是 | String | 返回码。 0：成功 失败，具体请参见错误码 |
| responseMessage | 否 | String | 响应描述。 |
| notificationHistory | 否 | List<Object> | 历史通知记录信息。具体请参见NotificationHistory说明。 |
