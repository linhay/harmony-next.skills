...
https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/contract/unsign
...
委托代扣协议ID，签约成功后回调接口中返回。与mercContractCode参数必选其一，同时传递则以contractId为准。
...
商户签约协议号。与contractId参数必选其一，同时传递则以contractId为准。
