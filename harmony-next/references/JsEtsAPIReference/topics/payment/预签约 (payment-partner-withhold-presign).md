...
https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/contract/presign/app

 说明：

元服务预签约接口请使用以下URL：

https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/contract/presign/fa
...
取值为：[PayMercAuth](../../guides/数据模型说明.md#section11744172016145)的JSON串
...
(**resultCode**非400000的错误码请看[公共错误码说明](../../errors/REST API错误码 (payment-error-code-rest).md#section1187515498410))
