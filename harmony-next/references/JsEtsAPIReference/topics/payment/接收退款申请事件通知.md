...
如果开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)申请支付服务时提前[配置通知接收地址](../../guides/（可选）配置应用内购买服务参数.md#配置订单订阅通知接收地址)，并且通知版本设置为v3，用户申请对已支付订单进行退款时，IAP服务器会调用此接口通知已配置的服务器。
...
![image](public_sys-resources/zh-cn_image_0000002553366077.webp)
