...
1. 账单下载后，建议遍历附件目录以获取“.csv”后缀的文件进行解析。
1. 解析表单内容时，需考虑表单更新，如新增列等场景。
...
https://petalpay-developer.cloud.huawei.com.cn/api/v1/bill/settle-bill/downloadInfo?billDate=xxxxxx
...
[BillDownloadParam](../../guides/数据模型说明.md#section580851813465)
...
请检查并[打开账单开关](查询结算账单 (payment-partner-agent-query-settle-bill).md#section14244533142816)。
