...
Pixelmap使用的HDR元数据值，和OH_Pixelmap_HdrMetadataKey关键字相对应。用于[OH_PixelmapNative_SetMetadata](pixelmap_native.h.md#ZH-CN_TOPIC_0000002522241982__oh_pixelmapnative_setmetadata)及[OH_PixelmapNative_GetMetadata](pixelmap_native.h.md#ZH-CN_TOPIC_0000002522241982__oh_pixelmapnative_getmetadata)，有相应[OH_Pixelmap_HdrMetadataKey](pixelmap_native.h.md#ZH-CN_TOPIC_0000002522241982__oh_pixelmap_hdrmetadatakey)关键字作为入参时，设置或获取到本结构体中相对应的元数据类型的值。
