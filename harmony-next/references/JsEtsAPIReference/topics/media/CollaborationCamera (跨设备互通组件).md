...
该模块提供了组件[createCollaborationCameraMenuItems](#section1633482912443)和[CollaborationCameraStateDialog](#section158671330145417)，两者需要配合使用，完成分布式跨端能力，如在2in1端跨端调用手机端拍照。

通过[createCollaborationCameraMenuItems](#section1633482912443)组件，可以获取组网内具有对应能力的设备列表。用户选择对应的设备后，拉起应用。调用[CollaborationCameraStateDialog](#section158671330145417)，应用将弹出提示框，提示对端应用状态。

**废弃说明：**从5.0.0(12)开始废弃，建议使用[CollaborationService](../system-services/CollaborationService (跨设备互通组件).md)替代。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[createCollaborationServiceMenuItems](../system-services/CollaborationService (跨设备互通组件).md#section1633482912443)替代。
...
Array<[CollaborationCameraBusinessFilter](#section12639651397)>
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[CollaborationServiceFilter](../system-services/CollaborationService (跨设备互通组件).md#section12639651397)替代。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[CollaborationServiceStateDialog](../system-services/CollaborationService (跨设备互通组件).md#section158671330145417)替代。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[onState](../system-services/CollaborationService (跨设备互通组件).md#section33027582114)替代。
...
以下错误码的详细介绍请参见[ArkTS 错误码](../../errors/ArkTS 错误码.md)。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[build](../system-services/CollaborationService (跨设备互通组件).md#section41032414617)替代。
