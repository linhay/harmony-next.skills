...
| OH_AVErrCode OH_LowPowerAudioSinkCallback_SetDataNeededListener(OH_LowPowerAudioSinkCallback* callback, OH_LowPowerAudioSink_OnDataNeeded onDataNeeded, void* userData) | 为LowPowerAudioSinkCallback设置需要数据监听。 |
| OH_AVErrCode OH_LowPowerAudioSinkCallback_SetErrorListener(OH_LowPowerAudioSinkCallback* callback, OH_LowPowerAudioSink_OnError onError, void* userData) | 为LowPowerAudioSinkCallback设置错误监听。 |
| OH_AVErrCode OH_LowPowerAudioSinkCallback_SetInterruptListener(OH_LowPowerAudioSinkCallback* callback, OH_LowPowerAudioSink_OnInterrupted onInterrupted, void* userData) | 为LowPowerAudioSinkCallback设置音频焦点打断监听。 |
| OH_AVErrCode OH_LowPowerAudioSinkCallback_SetDeviceChangeListener(OH_LowPowerAudioSinkCallback* callback, OH_LowPowerAudioSink_OnDeviceChanged onDeviceChanged, void* userData) | 为LowPowerAudioSinkCallback设置音频设备切换监听。 |
| OH_AVErrCode OH_LowPowerAudioSinkCallback_SetEosListener(OH_LowPowerAudioSinkCallback callback, OH_LowPowerAudioSink_OnEos onEos, void userData) | 为LowPowerAudioSinkCallback设置播放完成监听。 |
...
配置LowPowerAudioSink，需要在[OH_LowPowerAudioSink_Prepare](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_prepare)前完成。
...
为LowPowerAudioSink设置参数，支持[OH_LowPowerAudioSink_Prepare](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_prepare)后动态设置。
...
准备LowPowerAudioSink的解码、渲染资源，在[OH_LowPowerAudioSink_Configure](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_configure)后调用。

 调用此接口前必须调用LowPowerVideoSink的[OH_LowPowerVideoSink_SetSyncAudioSink](lowpower_video_sink.h.md#ZH-CN_TOPIC_0000002522082054__oh_lowpowervideosink_setsyncaudiosink)方法。
...
启动低功耗音频接收器，此接口必须在[OH_LowPowerAudioSink_Prepare](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_prepare)成功后调用。

 启动成功后，LowPowerAudioSink将开始上报[OH_LowPowerAudioSink_OnDataNeeded](lowpower_audio_sink_base.h.md#ZH-CN_TOPIC_0000002522242048__oh_lowpoweraudiosink_ondataneeded)事件。
...
暂停LowPowerAudioSink，在[OH_LowPowerAudioSink_Start](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_start)或[OH_LowPowerAudioSink_Resume](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_resume)后调用。

 暂停成功后，LowPowerAudioSink将暂停[OH_LowPowerAudioSink_OnDataNeeded](lowpower_audio_sink_base.h.md#ZH-CN_TOPIC_0000002522242048__oh_lowpoweraudiosink_ondataneeded)事件的上报。
...
恢复LowPowerAudioSink，在[OH_LowPowerAudioSink_Pause](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_pause)后调用。

 恢复成功后，LowPowerAudioSink将恢复[OH_LowPowerAudioSink_OnDataNeeded](lowpower_audio_sink_base.h.md#ZH-CN_TOPIC_0000002522242048__oh_lowpoweraudiosink_ondataneeded)事件的上报。
...
清除LowPowerAudioSink中所有解码器和渲染缓存的输入输出数据。
 ...
 此接口不建议在[OH_LowPowerAudioSink_Start](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_start)或[OH_LowPowerAudioSink_Resume](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_resume)之后调用。
...
重置LowPowerAudioSink。
 ...
 如果要重新使用该实例，需要调用[OH_LowPowerAudioSink_Configure](lowpower_audio_sink.h.md#ZH-CN_TOPIC_0000002553361973__oh_lowpoweraudiosink_configure)完成配置。
...
| --- | --- |
| OH_LowPowerAudioSinkCallback* callback | 指向OH_LowPowerAudioSinkCallback实例的指针。 |
| OH_LowPowerAudioSink_OnPositionUpdated onPositionUpdated | OH_LowPowerAudioSink_OnPositionUpdated方法，在PositionUpdate事件触发时调用。 |
...
| --- | --- |
| OH_LowPowerAudioSinkCallback* callback | 指向OH_LowPowerAudioSinkCallback实例的指针。 |
| OH_LowPowerAudioSink_OnDataNeeded onDataNeeded | OH_LowPowerAudioSink_OnDataNeeded方法，在DataNeeded事件触发时调用。 |
| void* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| OH_LowPowerAudioSinkCallback* callback | 指向OH_LowPowerAudioSinkCallback实例的指针。 |
| OH_LowPowerAudioSink_OnError onError | OH_LowPowerAudioSink_OnError方法，在Error事件触发时调用。 |
| void* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| OH_LowPowerAudioSinkCallback* callback | 指向OH_LowPowerAudioSinkCallback实例的指针。 |
| OH_LowPowerAudioSink_OnInterrupted onInterrupted | OH_LowPowerAudioSink_OnInterrupted方法，在Interrupted事件触发时调用。 |
| void* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| OH_LowPowerAudioSinkCallback* callback | 指向OH_LowPowerAudioSinkCallback实例的指针。 |
| OH_LowPowerAudioSink_OnDeviceChanged onDeviceChanged | OH_LowPowerAudioSink_OnDeviceChanged方法，在DeviceChanged事件触发时调用。 |
| void* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| OH_LowPowerAudioSinkCallback *callback | 指向OH_LowPowerAudioSinkCallback实例的指针。 |
| OH_LowPowerAudioSink_OnEos onEos | OH_LowPowerAudioSink_OnEos方法，在Eos事件触发时调用。 |
| void* userData | 用户执行回调所依赖的数据。 |
