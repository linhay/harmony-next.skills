...
| 名称 | 描述 |
| --- | --- |
| [Camera_MetadataObjectType](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_metadataobjecttype) type | 元数据对象类型。 |
| int64_t timestamp | 元数据对象时间戳，单位为纳秒（ns）。 |
| [Camera_Rect](Camera_Rect.md)* boundingBox | 检测到的元数据对象的轴对齐边界框。 |
