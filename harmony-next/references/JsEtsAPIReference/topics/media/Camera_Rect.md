...
实际预览流的宽高指的是相机输出流的分辨率，请参考[profile](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__profile)中的size。
...
名称描述int32_t topLeftX左上角的X坐标，范围[0, 1]。int32_t topLeftY左上角的Y坐标，范围[0, 1]。int32_t width矩形宽度，范围[0, 1]。int32_t height矩形高度，范围[0, 1]。