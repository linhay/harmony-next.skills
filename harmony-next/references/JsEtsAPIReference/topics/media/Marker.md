...
标记，继承[BaseOverlay](../misc/BaseOverlay.md)。在调用map.[MapComponentController](../components/MapComponentController.md)类的[addMarker](../components/MapComponentController.md#section0810361284)方法时会返回该类型的实例。
...
设置标记的动画，不支持[FontSizeAnimation](../misc/FontSizeAnimation.md)。
