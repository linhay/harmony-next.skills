...
创建PackingOptions结构体的对象使用[OH_PackingOptions_Create](image_packer_native.h.md#ZH-CN_TOPIC_0000002522241980__oh_packingoptions_create)函数。

释放OH_PackingOptions对象使用[OH_PackingOptions_Release](image_packer_native.h.md#ZH-CN_TOPIC_0000002522241980__oh_packingoptions_release)函数。
