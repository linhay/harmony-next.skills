...
[OH_AVCodecOnNeedInputData](native_avcodec_base.h.md#ZH-CN_TOPIC_0000002553201823__oh_avcodeconneedinputdata)回调将报告可用的输入缓冲区和相应的索引值。一旦具有指定索引的缓冲区提交到音频解码器，则无法再次访问此缓冲区，直到再次收到[OH_AVCodecOnNeedInputData](native_avcodec_base.h.md#ZH-CN_TOPIC_0000002553201823__oh_avcodeconneedinputdata)回调，收到相同索引时此缓冲区才可使用。
