...
名称类型只读可选说明namestring否否要创建资源的名称，可由开发者自定填写，用于标识该场景资源。uri[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是3D场景所需的资源文件路径。默认值为undefined。
...
名称类型只读可选说明node[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)否否被射线击中的3D场景节点，可通过该节点操作目标物体（如移动、旋转、隐藏）。centerDistancenumber否否命中物体包围盒中心到摄像机中心的距离，取值范围大于0。hitPosition[Position3](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__position3)否否射线与物体碰撞点的精确世界坐标（{x: number, y: number, z: number}）。
...
名称类型只读可选说明rootNode[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)否是限定检测范围：仅检测该节点及其子节点。未设置时检测全场景。
...
类型说明Promise<[Shader](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__shader)>Promise对象，返回创建的着色器对象。
...
类型说明Promise<[Image](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__image)>Promise对象，返回创建的图像对象。
...
参数名类型必填说明params[SceneResourceParameters](#ZH-CN_TOPIC_0000002529446039__sceneresourceparameters)是创建网格资源的参数。geometry[GeometryDefinition](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__geometrydefinition18)是几何形状定义，描述要创建的网格形状。

**返回值：**

类型说明Promise<[MeshResource](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__meshresource18)>Promise对象，返回创建的网格资源对象。
...
类型说明Promise<[Sampler](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__sampler20)>Promise对象，返回创建的采样器对象。
...
参数名类型必填说明uri[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否创建场景使用的资源路径，如果未传入资源路径，则默认创建一个空场景。
...
名称类型只读可选说明msaa22+boolean否是相机是否使能MSAA，true表示使能MSAA，false表示不使能MSAA。默认值为false。renderingPipeline21+[RenderingPipelineType](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__renderingpipelinetype21)否是选择初始渲染管线类型，默认为轻量级前向渲染管线类型。
...
类型说明Promise<[Camera](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__camera)>Promise对象，返回相机对象。
...
参数名类型必填说明params[SceneNodeParameters](#ZH-CN_TOPIC_0000002529446039__scenenodeparameters)是场景结点参数。lightType[LightType](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__lighttype)是灯光类型。

**返回值：**

类型说明Promise<[Light](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__light)>Promise对象，返回灯光对象。
...
类型说明Promise<[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)>Promise对象，返回结点对象。
...
参数名类型必填说明params[SceneResourceParameters](#ZH-CN_TOPIC_0000002529446039__sceneresourceparameters)是场景资源参数。materialType[MaterialType](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__materialtype)是材质类型。

**返回值：**

类型说明Promise<[Material](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__material)>Promise对象，返回材质对象。
...
类型说明Promise<[Environment](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__environment)>Promise对象，返回环境对象。
...
参数名类型必填说明params[SceneNodeParameters](#ZH-CN_TOPIC_0000002529446039__scenenodeparameters)是场景结点参数。mesh[MeshResource](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__meshresource18)是网格数据参数。

**返回值：**

类型说明Promise<[Geometry](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__geometry)>Promise对象，返回几何对象。
...
类型说明Promise<[Effect](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__effect21)>Promise对象，返回特效对象。
...
名称类型只读可选说明namestring否否要创建场景组件的名称，可由开发者自定填写，用于标识场景组件。propertyRecord<string, string | number | [Vec2](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec2) | [Vec3](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec3) | [Vec4](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec4) | [SceneResource](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__sceneresource-1) | boolean | number[] | string[] | [SceneResource](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__sceneresource-1)[] | [Vec2](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec2)[] | [Vec3](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec3)[] | [Vec4](../networking/SceneType.md#ZH-CN_TOPIC_0000002497446096__vec4)[] | null | undefined>是否组件的属性集合，以键值对形式存储。支持多种基础类型和复杂类型，用于描述场景组件的各种属性。
...
名称类型只读可选说明environment[Environment](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__environment)否否环境对象。animations[Animation](../system-services/SceneResource.md#ZH-CN_TOPIC_0000002529286067__animation)[]是否动画数组，用于保存3D场景中的动画对象。root[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node) | null是否3D场景树根结点。
...
参数名类型必填说明uri[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否待加载的模型文件资源路径，默认值为undefined。
...
参数名类型必填说明pathstring是场景结点层次中的路径。每层之间使用'/'符号进行分割。type[NodeType](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__nodetype)否预期返回的结点类型。默认值为空。

**返回值：**

类型说明[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node) | null返回请求结点的实例，如果没有找到或者找到的节点类型与传入的参数不相符则返回空。
...
参数名类型必填说明namestring是导入结点后的名称，由开发者自定义，无特殊要求。node[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)是被导入的结点。parent[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node) | null是被导入结点在新场景中的父结点。

**返回值：**

类型说明[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)被导入的结点。
...
参数名类型必填说明namestring是导入场景的根结点名称，由开发者自定义，无特殊要求。scene[Scene](#ZH-CN_TOPIC_0000002529446039__scene-1)是被导入的场景。parent[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node) | null是被导入场景在新场景中的父结点。

**返回值：**

类型说明[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)被导入场景的根结点。
...
参数名类型必填说明node[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)是组件需要附加到的节点。namestring是要创建的组件名称，由各插件定义有效名称。
...
参数名类型必填说明node[Node](../components/SceneNode.md#ZH-CN_TOPIC_0000002497606076__node)是组件附加的节点。namestring是需要获取的组件名称，必须为系统预定义或已注册的自定义组件名称，且需符合命名规范。
