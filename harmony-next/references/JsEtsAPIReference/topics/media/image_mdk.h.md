...
[OH_Image_Release](#ZH-CN_TOPIC_0000002553201949__oh_image_release)
...
ImageNative对象所存储的数据是预览流还是拍照流，取决于应用将receiver中的surfaceId传给相机的previewOutput还是captureOutput。相机预览与拍照最佳实践请参考[预览流二次处理(C/C++)](../../guides/预览流二次处理（C-C++）.md)与[拍照(C/C++)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/native-camera-shooting)。
...
这个方法无法释放JavaScript Native API Image对象，而是释放被[OH_Image_InitImageNative](image_mdk.h.md#ZH-CN_TOPIC_0000002553201949__oh_image_initimagenative)解析的ImageNative native对象。
...
[OH_Image_InitImageNative](#ZH-CN_TOPIC_0000002553201949__oh_image_initimagenative)