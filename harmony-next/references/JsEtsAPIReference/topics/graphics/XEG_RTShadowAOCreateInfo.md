...
此结构体描述创建支持光线追踪阴影和环境光遮蔽效果[XEG_RTVisibleMask](../misc/XEngine.md#ZH-CN_TOPIC_0000002328319196__xeg_rtvisiblemask)实例的初始化信息。当结构体中的信息变化时，需要创建新的[XEG_RTVisibleMask](../misc/XEngine.md#ZH-CN_TOPIC_0000002328319196__xeg_rtvisiblemask)对象。
...
识别此结构的[XEG_StructureType](../misc/XEngine.md#ZH-CN_TOPIC_0000002328319196__xeg_structuretype)值，必须是XEG_STRUCTURE_TYPE_RT_SHADOWAO_CREATE_INFO。
