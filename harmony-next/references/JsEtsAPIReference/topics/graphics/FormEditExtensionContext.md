...
FormEditExtensionContext是[FormEditExtensionAbility](../../modules/ohos/@ohos.app.form.FormEditExtensionAbility (FormEditExtensionAbility).md)的上下文，继承自[UIExtensionContext](UIExtensionContext.md)。
...
startSecondPage(want: Want): Promise<[AbilityResult](../system-services/AbilityResult.md)>
...
参数名类型必填说明want[Want](../../modules/ohos/@ohos.app.ability.Want (Want).md)是第三方应用需要被桌面拉起的编辑页面信息。

**返回值：**

类型说明Promise<[AbilityResult](../system-services/AbilityResult.md)>Promise对象，返回AbilityResult。
