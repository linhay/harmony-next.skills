...
识别此结构的[XEG_StructureType](../misc/XEngine.md#ZH-CN_TOPIC_0000002328319196__xeg_structuretype)值，必须是XEG_STRUCTURE_TYPE_RT_SHADOWAO_DESCRIPTION。
...
const [XEG_RTAOParameters](../media/XEG_RTAOParameters.md) * [pRtAOParameters](#ZH-CN_TOPIC_0000002362157661__prtaoparameters)
