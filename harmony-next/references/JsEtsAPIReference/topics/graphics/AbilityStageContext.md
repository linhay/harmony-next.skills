...
名称类型只读可选说明currentHapModuleInfo[HapModuleInfo](../system-services/HapModuleInfo.md)否否AbilityStage对应的ModuleInfo对象。config[Configuration](../../modules/ohos/@ohos.app.ability.Configuration (环境变量).md)否否环境变量。
