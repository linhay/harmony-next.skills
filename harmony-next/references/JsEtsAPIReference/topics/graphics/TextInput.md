...
名称类型只读可选说明placeholder[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是设置无输入时的提示文本。text[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
除支持[通用属性](../misc/通用属性.md)，还支持以下属性：

默认情况下，通用属性[padding](../misc/尺寸设置.md#ZH-CN_TOPIC_0000002497444850__padding)的默认值为：
...
当输入框设置padding为0时，可设置[borderRadius](../misc/边框设置.md#ZH-CN_TOPIC_0000002497604832__borderradius)为0避免光标被截断。当光标在文本框边缘显示异常时，请检查是否是padding、borderRadius属性影响造成。

从API version 10开始，单行输入框可设置.width('auto')使组件宽度自适应文本宽度，自适应时组件宽度受constraintSize属性以及父容器传递的最大最小宽度限制，其余使用方式参考[尺寸设置](../misc/尺寸设置.md)。
...
参数名类型必填说明value[Font](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font)否

placeholder文本样式。

Wearable设备上默认值为：18fp

推荐使用[loadFontSync](../../modules/ohos/@ohos.graphics.text (文本模块).md#ZH-CN_TOPIC_0000002497605988__loadfontsync)注册自定义字体。
...
参数名类型必填说明value[TextInputStyle](#ZH-CN_TOPIC_0000002529444859__textinputstyle9枚举说明) | [TextContentStyle](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__textcontentstyle10)是
...
可通过[align](../misc/位置设置.md#ZH-CN_TOPIC_0000002529284821__align)属性控制文本段落在垂直方向上的位置。此组件中不可使用align属性控制文本段落在水平方向上的位置。
...
参数名类型必填说明value[CaretStyle](../misc/文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__caretstyle10)是光标的风格。
...
参数名类型必填说明value[CustomBuilder](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是文本输入时，文本框的显示单位。
...
参数名类型必填说明value[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | undefined否
...
参数名类型必填说明value[BarState](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__barstate)是
...
参数名类型必填说明value[CustomBuilder](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8) | [ComponentContent](../components/ComponentContent.md#ZH-CN_TOPIC_0000002497444816__componentcontent-1)22+ | undefined22+是自定义键盘。设定值为undefined时，关闭自定义键盘。options12+[KeyboardOptions](../misc/RichEditor.md#ZH-CN_TOPIC_0000002497604894__keyboardoptions12)否设置自定义键盘是否支持避让功能。
...
参数名类型必填说明options[CancelButtonOptions](../components/search.md#ZH-CN_TOPIC_0000002497444916__cancelbuttonoptions12对象说明)是
...
options[InputCounterOptions](../misc/输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__inputcounteroptions11对象说明)否计数器的配置项。
...
参数名类型必填说明value[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [UnderlineColor](#ZH-CN_TOPIC_0000002529444859__underlinecolor12对象说明) | undefined是
...
参数名类型必填说明value[WordBreak](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__wordbreak11)是
...
参数名类型必填说明value[TextOverflow](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__textoverflow)是
...
参数名类型必填说明value[TextHeightAdaptivePolicy](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__textheightadaptivepolicy10)是
...
参数名类型必填说明strategy[LineBreakStrategy](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__linebreakstrategy12)是
...
参数名类型必填说明width[Optional](../misc/自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)>是
...
参数名类型必填说明symbolOptions[CancelButtonSymbolOptions](../components/search.md#ZH-CN_TOPIC_0000002497444916__cancelbuttonsymboloptions12对象说明)是
...
参数名类型必填说明mode[Optional](../misc/自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[EllipsisMode](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__ellipsismode11)>是
...
名称类型只读可选说明onIconSrcstring | [Resource](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是

密码输入模式时，能够切换密码可见时显示的图标。

string格式可用于加载网络图片和本地图片。

offIconSrcstring | [Resource](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是
...
参数名类型必填说明selectionStartnumber是文本选择区域起始位置，文本框中文字的起始位置为0。selectionEndnumber是文本选择区域结束位置。当selectionEnd<0时，按照0处理；当selectionEnd大于文本长度时，按照文本长度处理。options12+[SelectionOptions](../misc/输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__selectionoptions12对象说明)否
...
名称类型只读可选说明typing[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是键入时下划线颜色。不填写、undefined、null、无效值时恢复默认。normal[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是非特殊状态时下划线颜色。不填写、undefined、null、无效值时恢复默认。error[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是错误时下划线颜色。不填写、undefined、null、无效值时恢复默认。此选项会修改showCounter属性中达到最大字符数时的颜色。disable[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | undefined否是禁用时下划线颜色。不填写、undefined、null、无效值时恢复默认。
...
参数名类型必填说明contentstring是粘贴的文本内容。event[PasteEvent](../misc/RichEditor.md#ZH-CN_TOPIC_0000002497604894__pasteevent11)是用户自定义的粘贴事件。
...
该示例通过[customKeyboard](#ZH-CN_TOPIC_0000002529444859__customkeyboard10)（从API version 10开始）属性分别将value中的入参类型设置为[CustomBuilder](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)和[ComponentContent](../components/ComponentContent.md#ZH-CN_TOPIC_0000002497444816__componentcontent-1)，实现了自定义键盘的功能。

从API version 22开始[customKeyboard](#ZH-CN_TOPIC_0000002529444859__customkeyboard10)属性新增了入参类型[ComponentContent](../components/ComponentContent.md#ZH-CN_TOPIC_0000002497444816__componentcontent-1)。
...
该示例通过[customKeyboard](#ZH-CN_TOPIC_0000002529444859__customkeyboard10)（从API version 10开始）属性配置[KeyboardOptions](../misc/RichEditor.md#ZH-CN_TOPIC_0000002497604894__keyboardoptions12)（从API version 12开始）接口实现了自定义键盘避让的效果。
...
从API version 12开始，该示例通过[editMenuOptions](#ZH-CN_TOPIC_0000002529444859__editmenuoptions12)接口实现了文本设置自定义菜单扩展项的文本内容、图标以及回调的功能，同时，可以在[onPrepareMenu](../misc/文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__属性-1)（从API version 20开始）回调中，进行菜单数据的设置。
