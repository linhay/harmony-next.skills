...
以下错误码的详细介绍请参见[SOTER免密认证错误码](SOTER (onlineauthentication-error-code-soter).md)。
...
[SignedResult](#section13572542154913)
...
Promise<[SignedResult](#section13572542154913)>
