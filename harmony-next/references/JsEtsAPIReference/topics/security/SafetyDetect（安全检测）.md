...
checkSysIntegrity(req: [SysIntegrityRequest](#ZH-CN_TOPIC_0000002522241360__sysintegrityrequest)): Promise<[SysIntegrityResponse](#ZH-CN_TOPIC_0000002522241360__sysintegrityresponse)>
...
以下错误码的详细介绍请参见[ArkTS API错误码](SafetyDetect（安全检测）.md)。
...
checkUrlThreat(req: [UrlCheckRequest](#ZH-CN_TOPIC_0000002522241360__urlcheckrequest)): Promise<[UrlCheckResponse](#ZH-CN_TOPIC_0000002522241360__urlcheckresponse)>
...
checkSysIntegrityEnhanced(req: [SysIntegrityRequest](#ZH-CN_TOPIC_0000002522241360__sysintegrityrequest)): Promise<[SysIntegrityResponse](#ZH-CN_TOPIC_0000002522241360__sysintegrityresponse)>
