...
如果函数执行成功，则返回FIDO2_SUCCESS；如果函数执行失败，则返回特定的错误代码。详细信息请参见[FIDO2_ErrorCode](#ZH-CN_TOPIC_0000002553361315__fido2_errorcode)。
...
如果函数执行成功，则返回FIDO2_SUCCESS； 如果函数执行失败，则返回错误代码。详细信息请参见[FIDO2_ErrorCode](#ZH-CN_TOPIC_0000002553361315__fido2_errorcode)。
