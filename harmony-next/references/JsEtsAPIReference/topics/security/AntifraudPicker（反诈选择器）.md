...
selectFraudMessage(context: common.Context, options?: [AntifraudMessageOptions](#ZH-CN_TOPIC_0000002522241362__antifraudmessageoptions)): Promise<[AntifraudMessageResult](#ZH-CN_TOPIC_0000002522241362__antifraudmessageresult)>
...
以下错误码的详细介绍请参见[ArkTS API错误码](AntifraudPicker（反诈选择器）.md) 。
...
selectFraudCallLog(context: common.Context, options?: [AntifraudCallLogOptions](#ZH-CN_TOPIC_0000002522241362__antifraudcalllogoptions)): Promise<[AntifraudCallLogResult](#ZH-CN_TOPIC_0000002522241362__antifraudcalllogresult)>
...
selectFraudApp(context: common.Context, options?: [AntifraudAppOptions](#ZH-CN_TOPIC_0000002522241362__antifraudappoptions)): Promise<[AntifraudAppResult](#ZH-CN_TOPIC_0000002522241362__antifraudappresult)>
