...
| [OH_CM_Blob](OH_CM_Blob.md) credData | 表示凭据二进制数据，最大长度为20480字节。 |
| [OH_CM_CertificatePurpose](cm_native_type.h.md#ZH-CN_TOPIC_0000002529445353__oh_cm_certificatepurpose) certPurpose | 表示证书凭据的用途。 |
