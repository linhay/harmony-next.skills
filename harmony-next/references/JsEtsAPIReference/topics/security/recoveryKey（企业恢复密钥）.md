...
更新企业公钥证书流程，需要先调[getAuthChallenge](#ZH-CN_TOPIC_0000002522241380__getauthchallenge)接口获取挑战值并[签名](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/recoverykey-signature)。
...
删除企业恢复密钥相关数据，需要先调[getAuthChallenge](#ZH-CN_TOPIC_0000002522241380__getauthchallenge)接口获取挑战值并[签名](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/recoverykey-signature)。
...
导出用于重置锁屏密码的企业恢复密钥。先需要调用[verifyUserIdentityEnterprise](#ZH-CN_TOPIC_0000002522241380__verifyuseridentityenterprise)接口验证身份，并在30秒内调用此接口。
