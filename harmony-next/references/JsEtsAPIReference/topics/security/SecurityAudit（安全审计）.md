...
on(type: 'auditEventOccur', auditEventInfo: [AuditEventInfo](#ZH-CN_TOPIC_0000002553361289__auditeventinfo), callback: Callback<[AuditEvent](#ZH-CN_TOPIC_0000002553361289__auditevent)>): void
...
以下错误码的详细介绍请参见[ArkTS API错误码](SecurityAudit（安全审计）.md)。
...
off(type: 'auditEventOccur', auditEventInfo: [AuditEventInfo](#ZH-CN_TOPIC_0000002553361289__auditeventinfo), callback?: Callback<[AuditEvent](#ZH-CN_TOPIC_0000002553361289__auditevent)>): void
...
需要通过[newClient](#ZH-CN_TOPIC_0000002553361289__newclient)构造实例。
...
newClient(callback: Callback<[AuditEvent](#ZH-CN_TOPIC_0000002553361289__auditevent)>): Client
...
需要通过[newAuthClient](#ZH-CN_TOPIC_0000002553361289__newauthclient)构造实例。
...
newAuthClient(callback: Callback<[AuditEvent](#ZH-CN_TOPIC_0000002553361289__auditevent)>): AuthClient
