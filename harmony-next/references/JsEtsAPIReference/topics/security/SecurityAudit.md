...
| 名称 | 描述 |
| --- | --- |
| [security_audit.h](security_audit.h.md) | 文件中定义了与安全审计相关的函数。 |

#### 结构体

| 名称 | 描述 |
| --- | --- |
| struct [SecurityAudit_Event](SecurityAudit_Event.md) | 定义审计事件信息。 |
| struct [SecurityAudit_Filter](SecurityAudit_Filter.md) | 提供过滤条件。 |

#### 类型定义

| 名称 | 描述 |
| --- | --- |
| typedef void(* SecurityAudit_Handler) (const [SecurityAudit_Event](SecurityAudit_Event.md) *events, uint64_t count) | 定义事件处理函数。 |
...
| int32_t HMS_SecurityAudit_AddFilter (const SecurityAudit_Client *client, SecurityAudit_Notify_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) *filter) | 为通知事件添加过滤条件。 |
| int32_t HMS_SecurityAudit_RemoveFilter (const SecurityAudit_Client *client, SecurityAudit_Notify_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) *filter) | 删除通知事件的过滤条件。 |
...
| int32_t HMS_SecurityAudit_AddAuthEventFilter (const SecurityAudit_AuthClient *client, SecurityAudit_Auth_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) *filter) | 为阻断类事件添加过滤条件。 |
| int32_t HMS_SecurityAudit_RemoveAuthEventFilter (const SecurityAudit_AuthClient *client, SecurityAudit_Auth_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) *filter) | 删除阻断类事件的过滤条件。 |
| int32_t HMS_SecurityAudit_Auth (const SecurityAudit_AuthClient *client, const [SecurityAudit_Event](SecurityAudit_Event.md) *event, SecurityAudit_AuthResult authResult) | 设置审计事件的阻断结果。 |
...
#### [SecurityAudit_Filter](SecurityAudit_Filter.md)Type
...
```ets
int32_t HMS_SecurityAudit_AddAuthEventFilter (const SecurityAudit_AuthClient * client, SecurityAudit_Auth_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) * filter )
```
...
```ets
int32_t HMS_SecurityAudit_AddFilter (const SecurityAudit_Client * client, SecurityAudit_Notify_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) * filter )
```
...
```ets
int32_t HMS_SecurityAudit_Auth (const SecurityAudit_AuthClient * client, const [SecurityAudit_Event](SecurityAudit_Event.md) * event, SecurityAudit_AuthResult authResult )
```
...
```ets
int32_t HMS_SecurityAudit_RemoveAuthEventFilter (const SecurityAudit_AuthClient * client, SecurityAudit_Auth_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) * filter )
```
...
```ets
int32_t HMS_SecurityAudit_RemoveFilter (const SecurityAudit_Client * client, SecurityAudit_Notify_Event event, const [SecurityAudit_Filter](SecurityAudit_Filter.md) * filter )
```
