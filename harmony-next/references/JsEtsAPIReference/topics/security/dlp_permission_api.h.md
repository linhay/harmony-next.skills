...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| DLP_ErrCode | DLP_ErrCode | DLP错误码的枚举。 |
| DLP_FileAccess | DLP_FileAccess | DLP文件授权类型的枚举。 |
...
| 参数项 | 描述 |
| --- | --- |
| DLP_FileAccess *dlpFileAccess | 表示DLP文件针对用户的授权类型，例如：只读。 |
...
| 类型 | 说明 |
| --- | --- |
| DLP_ErrCode | 0 - 操作成功。  19100001 - 入参错误。  19100006 - 非DLP沙箱应用。  19100011 - 系统服务工作异常。  19100012 - 内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| DLP_ErrCode | 0 - 操作成功。  19100001 - 入参错误。  19100012 - 内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| DLP_ErrCode | 0 - 操作成功。  19100011 - 系统服务工作异常。  19100012 - 内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| DLP_ErrCode | 0 - 操作成功。  19100001 - 入参错误。  19100007 - DLP沙箱应用不允许调用此接口。  19100011 - 系统服务工作异常。  19100018 - 应用未授权。 |
...
| 类型 | 说明 |
| --- | --- |
| DLP_ErrCode | 0 - 操作成功。  19100011 - 系统服务工作异常。  19100012 - 内存申请失败。  19100018 - 应用未授权。 |
...
| 类型 | 说明 |
| --- | --- |
| DLP_ErrCode | 0 - 操作成功。  19100007 - DLP沙箱应用不允许调用此接口。  19100011 - 系统服务工作异常。  19100018 - 应用未授权。 |