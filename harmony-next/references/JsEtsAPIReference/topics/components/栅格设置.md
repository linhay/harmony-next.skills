...
从API version 9开始，该模块不再维护，推荐使用新组件[GridCol](GridCol.md)、[GridRow](GridRow.md)替代。
...
![image](public_sys-resources/zh-cn_image_0000002522085438.webp)

图2 设备宽度为MD

![image](public_sys-resources/zh-cn_image_0000002553365353.webp)

图3 设备宽度为LG

![image](public_sys-resources/zh-cn_image_0000002522245430.webp)

图4 单独设置gridSpan和gridOffset在特定屏幕大小下的效果与useSizeType效果一致

![image](public_sys-resources/zh-cn_image_0000002553205393.webp)