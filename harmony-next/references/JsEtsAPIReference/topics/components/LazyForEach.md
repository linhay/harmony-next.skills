...
开发者指南见：[LazyForEach开发者指南](LazyForEach.md)。
...
从API version 8开始，建议使用[onDataAdd](#ZH-CN_TOPIC_0000002522080924__ondataadd8)。
...
从API version 8开始，建议使用[onDataMove](#ZH-CN_TOPIC_0000002522080924__ondatamove8)。
...
从API version 8开始，建议使用[onDataDelete](#ZH-CN_TOPIC_0000002522080924__ondatadelete8)。
...
从API version 8开始，建议使用[onDataChange](#ZH-CN_TOPIC_0000002522080924__ondatachange8)。
