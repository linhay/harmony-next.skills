...
| selected7+ | number | 否 | 否 | 初始选中项索引值，若超出索引值范围，则取默认值0。 该参数支持$$双向绑定变量。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |

**属性**

[width](尺寸设置.md#ZH-CN_TOPIC_0000002553360703__width)属性设置"auto"时表示自适应宽度，宽度会随索引项最大宽度变化。

[padding](尺寸设置.md#ZH-CN_TOPIC_0000002553360703__padding)属性默认为4vp。

文本最大的字体缩放倍数[maxFontScale](Text.md#ZH-CN_TOPIC_0000002553360767__maxfontscale12)和最小的字体缩放倍数[minFontScale](Text.md#ZH-CN_TOPIC_0000002553360767__minfontscale12)皆为1，不跟随系统字体大小调节变化。
...
从API version 7开始支持，从API version 8开始废弃，建议使用[onSelect](#ZH-CN_TOPIC_0000002522080856__onselect8)替代。
...
[usingPopup](#ZH-CN_TOPIC_0000002522080856__usingpopup)设置值为true，索引项被选中时触发的事件。
...
通过[onRequestPopupData](#ZH-CN_TOPIC_0000002522080856__onrequestpopupdata8)事件自定义提示弹窗显示文本内容。
...
![image](public_sys-resources/zh-cn_image_0000002553365085.webp)

**示例2（开启自适应折叠模式）**

通过[autoCollapse](#ZH-CN_TOPIC_0000002522080856__autocollapse11)属性开启自适应折叠模式。
...
![image](public_sys-resources/zh-cn_image_0000002522245162.webp)

**示例3（设置提示弹窗背景模糊材质）**

通过[popupBackgroundBlurStyle](#ZH-CN_TOPIC_0000002522080856__popupbackgroundblurstyle12)属性实现提示弹窗的背景模糊效果。
...
![image](public_sys-resources/zh-cn_image_0000002553205123.webp)