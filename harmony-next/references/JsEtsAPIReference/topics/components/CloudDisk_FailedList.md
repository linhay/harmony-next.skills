...
名称描述[CloudDisk_PathInfo](../graphics/CloudDisk_PathInfo.md) pathInfo失败文件的绝对路径信息。[CloudDisk_ErrorReason](../../capi/headers/oh_cloud_disk_manager.h.md#ZH-CN_TOPIC_0000002497445290__clouddisk_errorreason) errorReason文件同步失败的原因。