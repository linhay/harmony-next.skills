...
从API version 10开始，可以通过使用[UIContext](../../types/classes/Class (UIContext).md)中的[showTimePickerDialog](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showtimepickerdialog)来明确UI的执行上下文。
...
推荐通过使用[UIContext](../../types/classes/Class (UIContext).md)中的[showTimePickerDialog](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showtimepickerdialog)来明确UI的执行上下文。
