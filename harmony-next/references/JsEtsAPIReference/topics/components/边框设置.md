...
| T | 返回当前组件。 |
 ...
 color、radius缺省时，为了保证[borderColor](#ZH-CN_TOPIC_0000002522080782__bordercolor)、[borderRadius](#ZH-CN_TOPIC_0000002522080782__borderradius)生效，需要将[borderColor](#ZH-CN_TOPIC_0000002522080782__bordercolor)、[borderRadius](#ZH-CN_TOPIC_0000002522080782__borderradius)设置在[border](#ZH-CN_TOPIC_0000002522080782__border)后。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Length | BorderRadiuses9+ | LocalizedBorderRadiuses12+ | 是 | 设置元素的边框圆角半径，支持百分比，百分比依据组件宽度，最大值为组件宽或高的一半。设置圆角后，可搭配clip属性进行裁剪，避免子组件超出组件自身。 |
...
![image](public_sys-resources/zh-cn_image_0000002553364685.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522244766.webp)

从右至左显示语言示例图

![image](public_sys-resources/zh-cn_image_0000002553204727.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522084774.webp)