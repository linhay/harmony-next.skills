...
设置组件由缩放大小或位移变化引起的运动过程中的动态模糊效果。需要与动画的[AnimateParam](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002553360803__animateparam对象说明)的onFinish参数配合使用。
...
在当前组件由缩放大小或位移变化引起的运动过程中，增加动态模糊效果。与[motionBlur](#ZH-CN_TOPIC_0000002553360713__motionblur)相比，motionBlur参数新增了对undefined类型的支持。
...
![image](public_sys-resources/zh-cn_image_0000002522084794.webp)