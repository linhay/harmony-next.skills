...
参数名类型必填说明isLunar[Optional](../misc/自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<boolean>是
...
用于穿戴设备圆形屏幕使用。组件响应[表冠事件](../misc/表冠事件.md)，需要先获取焦点。
...
参数名类型必填说明callback[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<Date>是返回选中的时间，年、月、日为选中的日期，时、分取决于当前系统时间的时、分，秒恒为00。
