...
为了使isShow参数值与半模态界面的状态同步，建议使用[$$](../../guides/$$语法：系统组件双向同步.md)双向绑定isShow参数。从API version 18开始，该参数支持[!!](../../guides/!!语法：双向绑定.md#系统组件参数双向绑定)双向绑定变量。
...
SIDE样式的半模态width的默认值规格：
  ...
  - [断点](../../guides/栅格布局 (GridRow-GridCol).md#栅格容器断点)为md的场景，默认宽度为窗口的1/2。

  - [断点](../../guides/栅格布局 (GridRow-GridCol).md#栅格容器断点)大于md的场景，默认宽度400vp。
