...
一个Object对象，使用[createPattern](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002553360789__createpattern)方法创建，通过指定图像和重复方式创建图片填充的模板。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transform | Matrix2D | 否 | 转换矩阵。 异常值undefined和null按无效值处理。 默认值：null |
...
![image](public_sys-resources/zh-cn_image_0000002522085198.webp)