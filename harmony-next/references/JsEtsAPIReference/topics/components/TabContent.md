...
string | [Resource](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) |

[CustomBuilder](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)8+|
...
[CustomBuilder](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)|
...
名称类型只读可选说明icon7+string | [Resource](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是

页签内的图片内容。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

text7+string | [Resource](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是
...
参数名类型必填说明content[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是页签内的文字内容。
...
参数名类型必填说明content[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | [ComponentContent](ComponentContent.md)是
...
设置选中子页签的下划线风格。与[indicator](#ZH-CN_TOPIC_0000002497444904__indicator10)相比，新增了图片格式的下划线风格，图片的显示效果参照[ImageFit.Cover](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagefit)。子页签的下划线风格仅在水平模式下有效。
...
参数名类型必填说明value[Padding](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding) | [Dimension](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10)是
...
参数名类型必填说明padding[LocalizedPadding](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12)是
...
设置子页签的[id](../misc/组件标识.md#ZH-CN_TOPIC_0000002497604824__id)。
...
参数名类型必填说明valuestring是子页签的[id](../misc/组件标识.md#ZH-CN_TOPIC_0000002497604824__id)。
...
borderRadius[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是
...
marginTop[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是
...
支持[DrawableDescriptor](../../modules/ohos/@ohos.arkui.drawableDescriptor (DrawableDescriptor).md#ZH-CN_TOPIC_0000002497604770__drawabledescriptor)、[PixelMapDrawableDescriptor](../../modules/ohos/@ohos.arkui.drawableDescriptor (DrawableDescriptor).md#ZH-CN_TOPIC_0000002497604770__pixelmapdrawabledescriptor12)、[LayeredDrawableDescriptor](../../modules/ohos/@ohos.arkui.drawableDescriptor (DrawableDescriptor).md#ZH-CN_TOPIC_0000002497604770__layereddrawabledescriptor)和[AnimatedDrawableDescriptor](../../modules/ohos/@ohos.arkui.drawableDescriptor (DrawableDescriptor).md#ZH-CN_TOPIC_0000002497604770__animateddrawabledescriptor12)类型。当传入无效图源时将显示默认的实线型下划线。
...
名称类型只读可选说明borderRadius[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是
...
名称类型只读可选说明overflow[TextOverflow](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__textoverflow)否是
...
minFontSizenumber | [ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
maxFontSizenumber | [ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
heightAdaptivePolicy[TextHeightAdaptivePolicy](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__textheightadaptivepolicy10)否是
...
unselectedColor12+[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
selectedColor12+[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
参数名类型必填说明icon[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | [TabBarSymbol12+](#ZH-CN_TOPIC_0000002497444904__tabbarsymbol12对象说明)是页签内的图片内容。text[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是页签内的文字内容。
...
参数名类型必填说明value[Padding](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding) | [Dimension](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [LocalizedPadding12+](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12)是
...
参数名类型必填说明value[VerticalAlign](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__verticalalign)是
...
参数名类型必填说明valuestring是设置底部页签的[id](../misc/组件标识.md#ZH-CN_TOPIC_0000002497604824__id)。
...
名称类型只读可选说明normal[SymbolGlyphModifier](../misc/动态属性设置.md)否否
...
selected[SymbolGlyphModifier](../misc/动态属性设置.md)否是
...
名称类型只读可选说明unselectedColor[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
selectedColor[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
参数名类型必填说明event[VoidCallback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是TabContent将要显示的回调函数。
...
参数名类型必填说明event[VoidCallback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是TabContent将要隐藏的回调函数。
