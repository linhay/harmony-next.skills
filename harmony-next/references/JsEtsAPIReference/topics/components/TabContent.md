...
该组件默认设置了[clip](形状裁剪.md#ZH-CN_TOPIC_0000002522240784__clip12)属性的值为true，若需要扩展内容区到组件外显示，需先关闭clip属性。

#### 子组件

支持单个子组件。

可内置系统组件和自定义组件，支持渲染控制类型（[if/else](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-ifelse)、[ForEach](ForEach.md)和[LazyForEach](LazyForEach.md)）。
...
tabBar(options: string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) | CustomBuilder | TabBarOptions)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) | [CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)8+| TabBarOptions18+ | 是 | TabBar上显示内容。 CustomBuilder： 构造器，内部可以传入组件（API version 8版本以上适用）。 |
...
子页签（[SubTabBarStyle](#ZH-CN_TOPIC_0000002553360757__subtabbarstyle9)）样式：通常为文字+下划线，文字+背板的页签风格，允许设置文本样式，建议放置在顶部或者底部使用。切换页签时默认支持动画跳转效果。适用于资讯类应用的顶部分类（如"关注、视频、数码"）、功能模块的二级导航场景。

-

底部页签/侧边页签（[BottomTabBarStyle](#ZH-CN_TOPIC_0000002553360757__bottomtabbarstyle9)）样式：无下划线和背板效果，页签样式通常为图标+文字的组合方式。切换页签时默认无动画跳转效果。底部页签通常用于应用主导航（如首页、发现、推荐）。侧边页签适用于宽屏场景，可设置vertical(true)启用纵向布局，让页签在侧边显示，默认左侧显示。
...
tabBar(content: ComponentContent | SubTabBarStyle | BottomTabBarStyle | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) | CustomBuilder | TabBarOptions)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../misc/ComponentContent.md) | SubTabBarStyle |BottomTabBarStyle | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) | [CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)| TabBarOptions | 是 | TabBar上显示内容。 ComponentContent： 组件内容的实体封装，可以设置自定义内容。 SubTabBarStyle： 子页签样式。 BottomTabBarStyle： 底部页签和侧边页签样式，底部样式没有下划线效果。 string： 字符串类型。 Resource： 资源引用类型，引入系统资源或者应用资源中的字符串。 CustomBuilder： 构造器，内部可以传入组件。 TabBarOptions： 设置页签内的图片和文字内容。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon7+ | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) | 否 | 是 | 页签内的图片内容。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
| text7+ | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) | 否 | 是 | 页签内的文字内容。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
...
constructor(content: [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | 是 | 页签内的文字内容。 |

#### constructor12+

constructor(content: [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Str | ComponentContent)

SubTabBarStyle的构造函数。支持[ComponentContent](../misc/ComponentContent.md)设置自定义内容。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | [ComponentContent](../misc/ComponentContent.md) | 是 | 页签内的内容。 说明： 1.自定义内容不支持labelStyle属性。 2.自定义内容超出页签范围，则不显示超出部分。 3.自定义内容小于页签范围，则会居中对齐。 4.自定义内容异常或无可用显示组件，则显示空白。 |

#### of10+

static of(content: [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)): SubTabBarStyle
...
static of(content: [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Str | ComponentContent): SubTabBarStyle

SubTabBarStyle的静态构造函数。支持[ComponentContent](../misc/ComponentContent.md)设置自定义内容。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | [ComponentContent](../misc/ComponentContent.md) | 是 | 页签内的内容。支持ComponentContent设置自定义内容。 说明： 1.自定义内容不支持labelStyle属性。 2.自定义内容超出页签范围，则不显示超出部分。 3.自定义内容小于页签范围，则会居中对齐。 4.自定义内容异常或无可用显示组件，则显示空白。 |
...
设置选中子页签的下划线风格。与[indicator](#ZH-CN_TOPIC_0000002553360757__indicator10)相比，新增了图片格式的下划线风格，图片的显示效果参照[ImageFit.Cover](枚举说明.md#ZH-CN_TOPIC_0000002553200889__imagefit)。子页签的下划线风格仅在水平模式下有效。
...
padding(value: [Padding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding) | Dimension): SubTabBarStyle

设置子页签的内边距属性（不支持百分比设置）。使用[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10)时，四个方向内边距同时生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Padding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding) | [Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | 是 | 子页签的内边距属性。 默认值：{left:8.0vp,right:8.0vp,top:17.0vp,bottom:18.0vp} |
...
padding(padding: [LocalizedPadding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12)): SubTabBarStyle
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| padding | [LocalizedPadding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12) | 是 | 子页签的内边距属性。 默认值：{start:LengthMetrics.vp(8),end:LengthMetrics.vp(8), top:LengthMetrics.vp(17),bottom:LengthMetrics.vp(18)} |
...
#### [id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)11+

[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)(value: string): SubTabBarStyle

设置子页签的[id](组件标识.md#ZH-CN_TOPIC_0000002522080774__[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id))。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | 是 | 子页签的[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | 否 | 是 | 下划线的颜色和背板颜色。 默认值：#FF007DFF |
| height | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 是 | 下划线的高度（不支持百分比设置）。 默认值：2.0 单位：vp 取值范围：[0, +∞)。 |
| w[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)th | Length | 否 | 是 | 下划线的宽度（不支持百分比设置）。 默认值：0.0 单位：vp 取值范围：[0, +∞)。 说明： 宽度设置为0时，按页签文本宽度显示。 |
| borderRadius | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 是 | 下划线的圆角半径（不支持百分比设置）。 默认值：0.0 单位：vp 取值范围：[0, +∞)。 |
| marginTop | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 是 | 下划线与文字的间距（不支持百分比设置）。 默认值：8.0 单位：vp 取值范围：[0, +∞)。 |
...
| height | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 是 | 下划线的高度（不支持百分比设置）。 默认值：2.0 单位：vp 取值范围：[0, +∞) |
| w[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)th | Length | 否 | 是 | 下划线的宽度（不支持百分比设置）。 默认值：0.0 单位：vp 取值范围：[0, +∞) 宽度设置为0时，按页签文本宽度显示。 |
| borderRadius | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 是 | 下划线的圆角半径（不支持百分比设置）。 默认值：0.0 单位：vp 取值范围：[0, +∞) |
| marginTop | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 是 | 下划线与文字的间距（不支持百分比设置）。 默认值：8.0 单位：vp 取值范围：[0, +∞) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderRadius | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 是 | 背板的圆角半径（不支持百分比设置）。 默认值：8.0 单位：vp 取值范围：[0, +∞)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| overflow | [TextOverflow](枚举说明.md#ZH-CN_TOPIC_0000002529284967__textoverflow) | 否 | 是 | 设置Label文本超长时的显示方式。默认值是省略号截断。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
...
| min[Font](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font)Size | number | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | 否 | 是 | 设置Label文本最小显示字号（不支持百分比设置）。需配合maxFontSize以及maxLines或布局大小限制使用。自适应文本大小生效后，font.size不生效。默认值是0.0fp，即默认自适应文本大小不生效。 取值范围：(0, +∞)。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
| maxFontSize | number | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Str | 否 | 是 | 设置Label文本最大显示字号（不支持百分比设置）。需配合minFontSize以及maxLines或布局大小限制使用。自适应文本大小生效后，font.size不生效。默认值是0.0fp，即默认自适应文本大小不生效。 取值范围：[minFontSize, +∞)。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
| heightAdaptivePolicy | [TextHeightAdaptivePolicy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__textheightadaptivepolicy10) | 否 | 是 | 设置Label文本自适应高度的方式。默认值是最大行数优先。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
| font | [Font](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font) | 否 | 是 | 设置Label文本字体样式。 当页签为子页签时，默认值是字体大小16.0fp、字体类型'HarmonyOS Sans'，字体风格正常，选中时字重中等，未选中时字重正常。 当页签为底部页签时，默认值是字体大小10.0fp、字体类型'HarmonyOS Sans'，字体风格正常，字重中等。 从API version 12开始，底部页签内容左右排布时默认字体大小为12.0fp。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
| unselectedColor12+ | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | 否 | 是 | 设置Label文本字体未选中时的颜色。 默认值：#99182431 元服务API： 从API version 12开始，该接口支持在元服务中使用。 |
| selectedColor12+ | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Color | 否 | 是 | 设置Label文本字体选中时的颜色。 默认值：#FF007DFF 元服务API： 从API version 12开始，该接口支持在元服务中使用。 |
...
constructor(icon: [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Str | TabBarSymbol, text: ResourceStr)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | TabBarSymbol12+ | 是 | 页签内的图片内容。 |
| text | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Str | 是 | 页签内的文字内容。 |

#### of10+

static of(icon: [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Str | TabBarSymbol, text: ResourceStr): BottomTabBarStyle
...
padding(value: [Padding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding) | Dimension | LocalizedPadding): BottomTabBarStyle

设置底部页签的内边距属性（不支持百分比设置）。使用[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10)时，四个方向内边距同时生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Padding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding) | [Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [LocalizedPadding12+](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12) | 是 | 底部页签的内边距。 默认值：{left:4.0vp,right:4.0vp,top:0.0vp,bottom:0.0vp} 使用LocalizedPadding时，支持镜像能力。 默认值：{start:LengthMetrics.vp(4),end:LengthMetrics.vp(4), top:LengthMetrics.vp(0),bottom:LengthMetrics.vp(0)} |
...
verticalAlign(value: [VerticalAlign](枚举说明.md#ZH-CN_TOPIC_0000002529284967__verticalalign)): BottomTabBarStyle
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [VerticalAlign](枚举说明.md#ZH-CN_TOPIC_0000002529284967__verticalalign) | 是 | 底部页签的图片、文字在垂直方向上的对齐格式。 默认值：VerticalAlign.Center |
...
[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)(value: string): BottomTabBarStyle

设置底部页签的[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | 是 | 设置底部页签的[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| normal | [SymbolGlyphModifier](动态属性设置.md) | 否 | 否 | 页签内symbol图标普通态样式。 默认值： fontColor：#66182431 renderingStrategy：SymbolRenderingStrategy.MULTIPLE_OPACITY fontSize：24vp |
| selected | [SymbolGlyphModifier](动态属性设置.md) | 否 | 是 | 页签内symbol图标选中态样式。 默认值： fontColor：#ff007dff renderingStrategy：SymbolRenderingStrategy.MULTIPLE_OPACITY fontSize：24vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| unselectedColor | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | 否 | 是 | 设置Label图标未选中时的颜色。 默认值：#33182431 说明： 仅对svg图源生效，设置后会替换svg图片的填充颜色。 |
| selectedColor | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)Color | 否 | 是 | 设置Label图标选中时的颜色。 默认值：#FF007DFF 说明： 仅对svg图源生效，设置后会替换svg图片的填充颜色。 |
...
onWillShow(event: [VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12) | 是 | TabContent将要显示的回调函数。 |

#### onWillH[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)e12+

onWillHide(event: [VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12) | 是 | TabContent将要隐藏的回调函数。 |
...
该示例实现了通过[ComponentContent](../misc/ComponentContent.md)设置SubTabBarStyle。
...
#### 示例10（通过[ComponentContent](../misc/ComponentContent.md)设置TabBar）

该示例实现了通过[ComponentContent](../misc/ComponentContent.md)封装组件内容，设置TabBar。通过ComponentContent的update函数更新TabBar。
...
#### 示例11（通过[ComponentContent](../misc/ComponentContent.md)预加载子节点）

该示例实现了通过[ComponentContent](../misc/ComponentContent.md)设置TabBar，使用TabsController的preloadItems预加载子节点。
...
![image](public_sys-resources/zh-cn_image_0000002553204915.webp)
