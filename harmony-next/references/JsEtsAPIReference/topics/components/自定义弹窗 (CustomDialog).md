...
若尝试在CustomDialog中传入多个其他的Controller，以实现在CustomDialog中打开另一个或另一些CustomDialog，那么此处需要将指向自己的controller放在所有controller的后面。详细用法可参考[示例1弹出嵌套弹窗](#ZH-CN_TOPIC_0000002497444956__示例1弹出嵌套弹窗)。
...
自定义弹窗的所有参数，不支持动态刷新，但可以通过设置customStyle为true，并在自定义组件上设置[背景色](../misc/背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundcolor)、[背景模糊](../misc/背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundblurstyle9)、[宽高](../misc/尺寸设置.md)等属性，通过属性绑定的状态变量来实现动态刷新的效果。
...
参数名类型必填说明value[CustomDialogControllerOptions](#ZH-CN_TOPIC_0000002497444956__customdialogcontrolleroptions对象说明)是配置自定义弹窗的参数。
...
不支持在输入法类型窗口中使用子窗（showInSubwindow为true）的CustomDialog，详情见输入法框架的约束与限制说明[createPanel](../../modules/ohos/@ohos.inputMethodEngine (输入法服务).md#ZH-CN_TOPIC_0000002529445255__createpanel10-1)。
...
类型说明[PromptActionCommonState](#ZH-CN_TOPIC_0000002497444956__promptactioncommonstate20)返回对应的弹窗状态。
...
类型说明[promptAction.CommonState](../../modules/ohos/@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__commonstate20枚举说明)返回对应的弹窗状态。
...
名称类型只读可选说明builder[CustomDialog](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-custom-dialog)否否
...
maskColor10+[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
openAnimation10+[AnimateParam](../misc/显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__animateparam对象说明)否是
...
closeAnimation10+[AnimateParam](../misc/显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__animateparam对象说明)否是
...
cornerRadius10+[Dimension](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [BorderRadiuses](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__borderradiuses9)否是
...
**说明**：自定义弹窗默认的背板圆角半径为32vp，如果需要使用cornerRadius属性，请和[borderRadius](../misc/边框设置.md#ZH-CN_TOPIC_0000002497604832__borderradius)属性一起使用。
...
onWillDismiss12+Callback<[DismissDialogAction](#ZH-CN_TOPIC_0000002497444956__dismissdialogaction12)>否是
...
borderWidth12+[Dimension](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [EdgeWidths](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__edgewidths9)否是
...
borderColor12+[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [EdgeColors](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__edgecolors9)否是
...
backgroundBlurStyle12+[BlurStyle](../misc/背景设置.md#ZH-CN_TOPIC_0000002529444791__blurstyle9)否是
...
keyboardAvoidMode12+[KeyboardAvoidMode](../misc/Popup控制.md#ZH-CN_TOPIC_0000002529284839__keyboardavoidmode12枚举说明)否是
...
keyboardAvoidDistance15+[LengthMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否是
...
从API version 19开始，该示例通过配置[backgroundBlurStyleOptions](#ZH-CN_TOPIC_0000002497444956__customdialogcontrolleroptions对象说明)，实现自定义背景模糊效果。
...
从API version 19开始，该示例通过配置[backgroundEffect](#ZH-CN_TOPIC_0000002497444956__customdialogcontrolleroptions对象说明)，实现自定义背景效果。
