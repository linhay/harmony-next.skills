...
如果ToolBarV2设置[通用属性](../misc/通用属性.md)和[通用事件](../misc/通用事件.md)，编译工具链会额外生成节点__Common__，并将通用属性或通用事件挂载在__Common__上，而不是直接应用到ToolBarV2本身。这可能导致开发者设置的通用属性或通用事件不生效或不符合预期，因此，不建议ToolBarV2设置通用属性和通用事件。
...
dividerModifier[DividerModifier](../misc/动态属性设置.md#ZH-CN_TOPIC_0000002529284843__自定义modifier)否@Param
...
color[ColorMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否是
...
activatedColor[ColorMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否是
...
名称类型只读可选说明text[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否否工具栏子项的文本。color[ColorMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否是
...
名称类型只读可选说明src[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否否工具栏子项的图标。color[ColorMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否是
...
参数名类型必填说明backgroundColor[ColorMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)是
...
参数名类型必填说明padding[LengthMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)是
...
参数名类型必填说明height[LengthMetrics](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)是
...
名称类型只读可选说明normal[SymbolGlyphModifier](../misc/动态SymbolGlyphModifier属性设置.md#ZH-CN_TOPIC_0000002529444819__symbolglyphmodifier)否否

工具栏symbol图标普通态样式。

装饰器类型：@Trace

activated[SymbolGlyphModifier](../misc/动态SymbolGlyphModifier属性设置.md#ZH-CN_TOPIC_0000002529444819__symbolglyphmodifier)否是
...
名称类型只读可选说明normal[SymbolGlyphModifier](../misc/动态SymbolGlyphModifier属性设置.md#ZH-CN_TOPIC_0000002529444819__symbolglyphmodifier)否否工具栏symbol图标普通态样式。activated[SymbolGlyphModifier](../misc/动态SymbolGlyphModifier属性设置.md#ZH-CN_TOPIC_0000002529444819__symbolglyphmodifier)否是
