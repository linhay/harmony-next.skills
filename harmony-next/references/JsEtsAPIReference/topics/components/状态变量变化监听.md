...
@Watch装饰器用于状态管理V1中对状态变量变化的监听。@Watch的详细使用方式见[@Watch装饰器：状态变量更改通知](状态变量变化监听.md)。
...
@Monitor装饰器用于状态管理V2中对状态变量变化的监听。@Monitor相关内容的详细使用方式见[@Monitor装饰器：状态变量修改异步监听](状态变量变化监听.md)。
...
以下错误码的详细介绍请参见[状态管理错误码](状态管理错误码.md#ZH-CN_TOPIC_0000002522081142__130001-addmonitorclearmonitor非法路径)。
