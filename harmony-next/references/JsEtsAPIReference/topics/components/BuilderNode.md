...
RENDER_TYPE_TEXTURE类型目前仅在[BuilderNode](#ZH-CN_TOPIC_0000002497604794__buildernode-1)持有组件树的根节点为自定义组件时以及[XComponentNode](XComponentNode.md)中设置生效。

-

在[BuilderNode](#ZH-CN_TOPIC_0000002497604794__buildernode-1)的情况下，目前在作为根节点的自定义组件中支持纹理导出的有以下组件：[Badge](badge.md)、[Blank](../misc/Blank.md)、[Button](Button.md)、[CanvasGradient](../graphics/CanvasGradient.md)、[CanvasPattern](../graphics/CanvasPattern.md)、[CanvasRenderingContext2D](CanvasRenderingContext2D.md)、[Canvas](../graphics/Canvas.md)、[CheckboxGroup](CheckboxGroup.md)、[Checkbox](Checkbox.md)、[Circle](../misc/circle.md)、[ColumnSplit](../misc/ColumnSplit.md)、[Column](../misc/Column.md)、[ContainerSpan](ContainerSpan.md)、[Counter](../misc/Counter.md)、[DataPanel](DataPanel.md)、[Divider](../misc/divider.md)、[Ellipse](../misc/Ellipse.md)、[Flex](../misc/Flex.md)、[Gauge](../misc/Gauge.md)、[Hyperlink](../misc/Hyperlink.md)、[ImageBitmap](../graphics/ImageBitmap.md)、[ImageData](../graphics/ImageData.md)、[Image](../graphics/Image.md)、[Line](../graphics/Line.md)、[LoadingProgress](LoadingProgress.md)、[Marquee](../media/marquee.md)、[Matrix2D](../graphics/Matrix2D.md)、[OffscreenCanvasRenderingContext2D](OffscreenCanvasRenderingContext2D.md)、[OffscreenCanvas](../graphics/OffscreenCanvas.md)、[Path2D](../graphics/Path2D.md)、[Path](../graphics/path.md)、[PatternLock](../graphics/PatternLock.md)、[Polygon](../misc/Polygon.md)、[Polyline](../graphics/Polyline.md)、[Progress](progress.md)、[QRCode](../misc/qrcode.md)、[Radio](Radio.md)、[Rating](../misc/rating.md)、[Rect](../misc/Rect.md)、[RelativeContainer](RelativeContainer.md)、[RowSplit](../misc/RowSplit.md)、[Row](../misc/Row.md)、[Shape](../graphics/Shape.md)、[Slider](slider.md)、[Span](span.md)、[Stack](../misc/Stack.md)、[TextArea](../graphics/TextArea.md)、[TextClock](../graphics/TextClock.md)、[TextInput](../graphics/TextInput.md)、[TextTimer](../graphics/TextTimer.md)、[Text](../graphics/Text.md)、[Toggle](../misc/toggle.md)、[Video](../media/Video.md)（不含全屏播放能力）、[Web](../misc/组件描述.md)、[XComponent](XComponent.md)。

-

从API version 12开始，新增以下组件支持纹理导出：[DatePicker](DatePicker.md)、[ForEach](../misc/ForEach.md)、[Grid](Grid.md)、[IfElse](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-ifelse)、[LazyForEach](../misc/LazyForEach.md)、[List](list.md)、[Scroll](Scroll.md)、[Swiper](../misc/swiper.md)、[TimePicker](TimePicker.md)、[@Component](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-create-custom-components#component)修饰的自定义组件、[NodeContainer](NodeContainer.md)以及[NodeContainer](NodeContainer.md)下挂载的[FrameNode](FrameNode.md)和[RenderNode](RenderNode.md)。
...
名称类型只读可选说明selfIdealSize[Size](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__size)否是
...
纹理接收方的surfaceId。纹理接收方一般为[OH_NativeImage](../graphics/OH_NativeImage.md)。
...
参数名类型必填说明uiContext[UIContext](../../types/classes/Class (UIContext).md)是UI上下文，获取方式可参考[UIContext获取方法](../../modules/ohos/@ohos.arkui.node.md#ZH-CN_TOPIC_0000002529284763__uicontext获取方法)。options[RenderOptions](#ZH-CN_TOPIC_0000002497604794__renderoptions)否
...
OffsetA为buildNode相对于父组件的偏移量，可以通过FrameNode中的[getPositionToParent](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getpositiontoparent12)获取。OffsetB为point点相对于buildNode的偏移量，可以通过[TouchEvent](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明) 获取。OffsetC为OffsetA与OffsetB的和，是传给postTouchEvent的最终结果。
...
在[webview](../../guides/模块描述.md)中，内部已经处理过坐标系变换，可以将TouchEvent事件直接下发。
...
参数名类型必填说明event[TouchEvent](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)是触摸事件。
...
参数名类型必填说明paramObject否用于复用BuilderNode的参数。该参数将直接用于BuilderNode中所有顶层自定义组件的复用，应该包含每个自定义组件的构造函数参数所需内容，否则，会导致未定义行为。调用此方法将同步触发内部自定义组件的[aboutToReuse](../misc/自定义组件的生命周期.md#ZH-CN_TOPIC_0000002529444913__abouttoreuse10)生命周期回调，并将该参数作为回调的入参。默认值为undefined，此时BuilderNode中的自定义组件将直接使用构造时的数据源。
...
传递[系统环境变化](../../modules/ohos/@ohos.app.ability.Configuration (环境变量).md)事件，触发节点的全量更新。
...
鼠标左键点击事件将转换为触摸事件，转发时应注意不在外层同时绑定触摸事件与鼠标事件，否则可能导致坐标偏移。这是由于在事件转换过程中，SourceType不会发生变化，规格可查看[onTouch](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)。

-

注入事件为[轴事件](../misc/轴事件.md#ZH-CN_TOPIC_0000002497444834__axisevent)时，由于轴事件中缺少旋转轴信息，因此注入的事件无法触发[rotate旋转手势](../input/RotationGesture.md)。
...
如果是开发者构造的事件，必填字段必须赋值，比如触摸事件的touches字段，轴事件的scrollStep字段。要保证事件的完整，比如触摸事件的[TouchType](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__touchtype)中DOWN和UP字段都要有，防止出现未定义行为。

-

[webview](../../guides/模块描述.md)已经处理过坐标系变换，可以将事件直接下发。
...
参数名类型必填说明uiContext[UIContext](../../types/classes/Class (UIContext).md)是UI上下文，获取方式可参考[UIContext获取方法](../../modules/ohos/@ohos.arkui.node.md#ZH-CN_TOPIC_0000002529284763__uicontext获取方法)。uiContext需要为一个有效的值，即UI上下文正确，如果传入非法值或者未设置，会导致创建失败。options[RenderOptions](BuilderNode.md#ZH-CN_TOPIC_0000002497604794__renderoptions)否
...
传递[系统环境变化](../../modules/ohos/@ohos.app.ability.Configuration (环境变量).md)事件，触发节点的全量更新。可用于通知对象更新，是否更新所使用的系统环境由应用当前的系统环境变化决定。
...
鼠标左键点击事件将转换为触摸事件，转发时应注意不在外层且绑定触摸事件与鼠标事件，否则可能导致坐标偏移。这是由于在事件转换过程中，SourceType不会发生变化，规格可查看[onTouch](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)。

注入事件为[轴事件](../misc/轴事件.md#ZH-CN_TOPIC_0000002497444834__axisevent)时，由于轴事件中缺少旋转轴信息，因此注入的事件无法触发[rotate旋转手势](../input/RotationGesture.md)。

转发的事件会在被分发到的目标组件所在的子树里做触摸测试（TouchTest），并触发对应手势，原始事件也会触发当前组件所在组件树中的手势。不保证两类手势的竞争结果。

如果是开发者构造的事件，必填字段必须赋值，比如触摸事件的touches字段、轴事件的scrollStep字段，同时要保证事件的完整，比如触摸事件的[TouchType](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__touchtype)中DOWN和UP字段都要有，防止出现未定义行为。
...
该示例演示了在自定义组件中截获鼠标事件并进行坐标转换的完整流程。组件通过[onMouse](../misc/鼠标事件.md#ZH-CN_TOPIC_0000002497604812__onmouse)回调读取本地x/y，再结合FrameNode.[getPositionToParent](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getpositiontoparent12)()得到的偏移量，调用vp2px将相对坐标转换为像素坐标，更新[MouseEvent](../misc/鼠标事件.md#ZH-CN_TOPIC_0000002497604812__mouseevent对象说明)的windowX/windowY、displayX/displayY。最后通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)(event)将转换后的鼠标事件分发给子节点进行处理。
...
该示例演示了在自定义组件中截获触摸事件并对触点坐标进行转换的完整流程。在[onTouch](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)回调中，遍历[TouchEvent](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)的changedTouches和touches数组，对每个触点的x/y加上组件偏移量并调用vp2px转换为像素，更新各自的windowX/windowY、displayX/displayY。最后同样通过rootNode.postInputEvent(event)将转换后的触摸事件分发给子节点处理。
...
该示例演示了在自定义组件中截获滚轮或触控板轴事件并进行坐标转换的完整流程。在[onAxisEvent](../misc/轴事件.md#ZH-CN_TOPIC_0000002497444834__onaxisevent)回调中，先获取事件的相对x/y，再加上组件偏移量后调用vp2px转换为像素，更新AxisEvent的windowX/windowY、displayX/displayY，最后通过rootNode.postInputEvent(event)将转换后的轴事件分发给子节点进行处理。
...
该示例演示了如何在BuilderNode通过build方法传入外部[localStorage](../misc/应用级变量的状态管理.md#ZH-CN_TOPIC_0000002529284961__localstorage9)，此时挂载在BuilderNode的所有自定义组件共享该localStorage。
...
该示例演示了在自定义组件中截获鼠标事件并进行坐标转换的完整流程。组件通过[onMouse](../misc/鼠标事件.md#ZH-CN_TOPIC_0000002497604812__onmouse)回调读取本地x/y坐标，再结合FrameNode.[getPositionToParent](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getpositiontoparent12)()得到的偏移量，调用[vp2px](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__vp2px12)将相对坐标转换为像素坐标，更新[MouseEvent](../misc/鼠标事件.md#ZH-CN_TOPIC_0000002497604812__mouseevent对象说明)的windowX/windowY、displayX/displayY。最后通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)将转换后的鼠标事件分发给子节点进行处理。
...
该示例演示了在自定义组件中截获触摸事件并对触点坐标进行转换的完整流程。在[onTouch](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)回调中，遍历[TouchEvent](../misc/触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)的changedTouches和touches数组，对每个触点的x/y坐标加上组件偏移量并调用[vp2px](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__vp2px12)转换为像素，更新各自的windowX/windowY、displayX/displayY。最后同样通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)将转换后的触摸事件分发给子节点处理。
...
该示例演示了在自定义组件中截获滚轮或触控板轴事件并进行坐标转换的完整流程。在[onAxisEvent](../misc/轴事件.md#ZH-CN_TOPIC_0000002497444834__onaxisevent)回调中，先获取事件的相对x/y坐标，再加上组件偏移量后调用[vp2px](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__vp2px12)转换为像素，更新AxisEvent的windowX/windowY、displayX/displayY，最后通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)将转换后的轴事件分发给子节点进行处理。
