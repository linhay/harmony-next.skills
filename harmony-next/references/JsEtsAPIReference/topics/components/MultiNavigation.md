...
MultiNavigation组件遵循默认的左起右清栈规则，这意味着从左侧主页点击时，会触发详情页的加载并同时清除右侧所有其他详情页，确保右侧仅展示最新加载的详情页。然而，若在右侧的详情页上再次执行详情页加载操作，系统将不会执行清栈动作。效果可参见[主页跳转详情页效果演示](#ZH-CN_TOPIC_0000002553200795__示例)。
...
当调用[keepBottomPage](#ZH-CN_TOPIC_0000002553200795__keepbottompage)接口并设置为true时，会保留栈底页面。
...
![image](public_sys-resources/zh-cn_image_0000002553364859.webp)

主页跳转详情页效果演示：

![image](public_sys-resources/zh-cn_image_0000002522244938.webp)

全屏类型页面效果演示：

![image](public_sys-resources/zh-cn_image_0000002553204899.webp)