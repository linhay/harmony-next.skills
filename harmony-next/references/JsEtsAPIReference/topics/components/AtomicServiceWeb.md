...
访问在线网页时需添加网络权限：ohos.permission.INTERNET，具体申请方式请参考[声明权限](../../guides/声明权限.md)。
...
按照历史栈，前进一个页面。一般结合[accessForward](#ZH-CN_TOPIC_0000002553200857__accessforward)一起使用。
...
按照历史栈，后退一个页面。一般结合[accessBackward](#ZH-CN_TOPIC_0000002553200857__accessbackward)一起使用。
