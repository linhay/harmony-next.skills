...
设置组件的自定义属性。[自定义组件](自定义组件.md)不支持设置自定义属性。
...
在[Column](Column.md)组件上设置自定义属性，并在其对应的[FrameNode](FrameNode.md#ZH-CN_TOPIC_0000002522240744__framenode-1)上获取所设置的自定义属性。
