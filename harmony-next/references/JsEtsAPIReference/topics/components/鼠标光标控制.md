...
直接使用cursorControl可能导致[UI上下文不明确](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-global-interface#ui上下文不明确)的问题，建议使用getUIContext()获取[UIContext](Class (UIContext).md)实例，并使用[getCursorController](Class (UIContext).md#ZH-CN_TOPIC_0000002522240732__getcursorcontroller12)获取绑定实例的cursorControl。
...
![image](public_sys-resources/zh-cn_image_0000002553364727.webp)

当鼠标悬浮在绿色区域时，显示：向东箭头光标样式。

![image](public_sys-resources/zh-cn_image_0000002522244808.webp)