...
PatternLock组件设置了通用属性宽高比[aspectRatio](布局约束.md#ZH-CN_TOPIC_0000002553200743__aspectratio)，且不等于1时（组件尺寸被设定为长方形），九宫格依然绘制为正方形（超出组件范围）。
...
onDotConnect(callback: [Callback](@ohos.base (公共回调信息).md#ZH-CN_TOPIC_0000002553201565__callback)<number>)
...
![image](public_sys-resources/zh-cn_image_0000002522245174.webp)

**示例2（判断密码是否正确）**

该示例通过[sideLength](#ZH-CN_TOPIC_0000002522080860__sidelength)属性设置九宫格的大小、[circleRadius](#ZH-CN_TOPIC_0000002522080860__circleradius)属性设置宫格圆点样式、[onPatternComplete](#ZH-CN_TOPIC_0000002522080860__onpatterncomplete)属性设置密码输入时的回调。
...
![image](public_sys-resources/zh-cn_image_0000002553205137.webp)