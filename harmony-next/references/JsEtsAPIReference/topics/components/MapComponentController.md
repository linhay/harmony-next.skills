...
Promise<[AnimateResult](../misc/AnimateResult.md#section18741944605)>

Promise对象，返回[AnimateResult](../misc/AnimateResult.md#section18741944605)。
...
在指定的持续时间内以动画的形式更新相机状态，并更新指定的marker。使用Promise异步回调。相机移动过程中不能被打断，否则[AnimateResult](../misc/AnimateResult.md#section18741944605)的参数isCanceled返回值为true。
...
指定一个[mapCommon.LatLngBounds](../misc/mapCommon（地图属性模型）.md#section96341159111320)来约束相机目标，使用户移动地图时，相机目标不会移出此边界。当设置新的边界时，新边界将覆盖之前设置的边界。
...
[mapCommon.LatLngBounds](../misc/mapCommon（地图属性模型）.md#section96341159111320)
...
[mapCommon.MapPoint](../misc/mapCommon（地图属性模型）.md#section123881566186)
...
[geoLocationManager.Location](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#location)
...
[mapCommon.MyLocationStyle](../misc/mapCommon（地图属性模型）.md#section3713124215275)
...
如果displayType使用FOLLOW_ROTATE需应用申请传感器权限：ohos.permission.ACCELEROMETER。
...
- 启用状态，用户可以使用以下手势缩放相机：
  ...
  1. 双指张合，实现放大缩小。
  1. 单指双击实现单指缩放，第二次点时按住，然后上划缩小，或下划放大。
...
[mapCommon.LogoAlignment](../misc/mapCommon（地图属性模型）.md#section892653673414)

是

地图Logo的对齐方式，默认值为[LogoAlignment](../misc/mapCommon（地图属性模型）.md#section892653673414).BOTTOM_START。
...
[mapCommon.Padding](../misc/mapCommon（地图属性模型）.md#section144591344648)
...
[mapCommon.MarkerOptions](../misc/mapCommon（地图属性模型）.md#section559041743210)
...
Promise<[Marker](../media/Marker.md)>

Promise对象，返回[Marker](../media/Marker.md)。
...
[mapCommon.MapCircleOptions](../misc/mapCommon（地图属性模型）.md#section5282124803117)
...
Promise<[MapCircle](../misc/MapCircle.md)>

Promise对象，返回[MapCircle](../misc/MapCircle.md)。
...
[mapCommon.MapPolylineOptions](../misc/mapCommon（地图属性模型）.md#section113246334153)
...
Promise<[MapPolyline](../graphics/MapPolyline.md)>

Promise对象，返回[MapPolyline](../graphics/MapPolyline.md)。
...
[mapCommon.MapPolygonOptions](../misc/mapCommon（地图属性模型）.md#section1615694815308)
...
Promise<[MapPolygon](../system-services/MapPolygon.md)>

Promise对象，返回[MapPolygon](../system-services/MapPolygon.md)。
...
[mapCommon.PointAnnotationParams](../misc/mapCommon（地图属性模型）.md#section161194598375)
...
Promise<[PointAnnotation](../misc/PointAnnotation.md)>

Promise对象，返回[PointAnnotation](../misc/PointAnnotation.md)。
...
[mapCommon.BubbleParams](../misc/mapCommon（地图属性模型）.md#section10348735114315)
...
Promise<[Bubble](../misc/Bubble.md)>

Promise对象，返回[Bubble](../misc/Bubble.md)。
...
[Projection](../misc/Projection.md)

[Projection](../misc/Projection.md)对象。
...
[mapCommon.CustomMapStyleOptions](../misc/mapCommon（地图属性模型）.md#section13899143818719)
...
```ets
// styleId需要替换为您自己的样式ID，样式ID可在[Petal Maps Studio](https://developer.petalmaps.com/console/studio/)平台上创建
...
[mapCommon.DayNightMode](../misc/mapCommon（地图属性模型）.md#section634916281725)
...
[mapCommon.MapType](../misc/mapCommon（地图属性模型）.md#section18522846142615)
...
[mapCommon.ClusterOverlayParams](../misc/mapCommon（地图属性模型）.md#section693971514320)
...
Promise<[ClusterOverlay](../misc/ClusterOverlay.md)>

Promise对象，返回[ClusterOverlay](../misc/ClusterOverlay.md)。
...
[mapCommon.ImageOverlayParams](../misc/mapCommon（地图属性模型）.md#section12537418218)
...
Promise<[ImageOverlay](../graphics/ImageOverlay.md)>

Promise对象，返回[ImageOverlay](../graphics/ImageOverlay.md)。
...
Promise对象，返回[image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)。
...
[mapCommon.BuildingOverlayParams](../misc/mapCommon（地图属性模型）.md#section316117228284)
...
Promise<[BuildingOverlay](../misc/BuildingOverlay.md)>

Promise对象，返回[BuildingOverlay](../misc/BuildingOverlay.md)。
...
[mapCommon.TraceOverlayParams](../misc/mapCommon（地图属性模型）.md#section202444375510)
...
Promise<[TraceOverlay](../misc/TraceOverlay.md)>

Promise对象，返回[TraceOverlay](../misc/TraceOverlay.md)。
...
[mapCommon.MapArcParams](../misc/mapCommon（地图属性模型）.md#section943619551002)
...
[MapEventManager](../misc/MapEventManager.md)
...
Array<[mapCommon.MapElementType](../misc/mapCommon（地图属性模型）.md#section17215821103111)>

是

四类地图元素的显示顺序，默认顺序为[1, 2, 3, 4]。

入参的长度必须是4，且必须是[mapCommon.MapElementType](../misc/mapCommon（地图属性模型）.md#section17215821103111)的4个取值，如果不满足，则返回错误码401。
...
[mapCommon.HeatmapParams](../misc/mapCommon（地图属性模型）.md#section273113662417)
...
Promise<[Heatmap](../misc/Heatmap.md)>

Promise对象，返回[Heatmap](../misc/Heatmap.md)，热力图覆盖物。
...
[mapCommon.MvtOverlayParams](../misc/mapCommon（地图属性模型）.md#section17301232184)
...
使用在线下载方式添加矢量图层时（即使用[mapCommon.MvtOverlayParams](../misc/mapCommon（地图属性模型）.md#section17301232184)中[mapCommon.MvtSource](../misc/mapCommon（地图属性模型）.md#section877213310341)参数的tileUrl方式），需要申请访问网络的权限：ohos.permission.INTERNET。
...
[mapCommon.FlowFieldOverlayParams](../misc/mapCommon（地图属性模型）.md#section1920897172416)
...
Promise<[FlowFieldOverlay](../misc/FlowFieldOverlay.md)>
...
[mapCommon.MassPointOverlayParams](../misc/mapCommon（地图属性模型）.md#section1423475535919)
...
Promise<[MassPointOverlay](../misc/MassPointOverlay.md)>
...
地图语言。语种取值请参见[地图组件支持语言](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-language#section105361721671)列表。
...
该接口对[Marker](../media/Marker.md)、[MapPolyline](../graphics/MapPolyline.md)、[MapPolygon](../system-services/MapPolygon.md)、[MapCircle](../misc/MapCircle.md)、[PointAnnotation](../misc/PointAnnotation.md)、[Bubble](../misc/Bubble.md)、[ImageOverlay](../graphics/ImageOverlay.md)、[MapArc](MapArc.md)、[TraceOverlay](../misc/TraceOverlay.md)、底图[Poi](../misc/mapCommon（地图属性模型）.md#section1155919456273)生效。
...
[mapCommon.TileOverlayParams](../misc/mapCommon（地图属性模型）.md#section3168172982513) | [mapCommon.TileOverlayOptions](../misc/mapCommon（地图属性模型）.md#section849136102717)
...
从6.0.0(20)版本开始，params属性支持[mapCommon.TileOverlayOptions](../misc/mapCommon（地图属性模型）.md#section849136102717)类型。
...
[TileOverlay](../misc/TileOverlay.md)
...
建议使用[MapEventManager.on(type: 'cameraChange')](../misc/MapEventManager.md#section1488710318220)。
...
Callback<[mapCommon.LatLng](../misc/mapCommon（地图属性模型）.md#section20691173773810)>

是

回调函数，返回[mapCommon.LatLng](../misc/mapCommon（地图属性模型）.md#section20691173773810)，监听地图相机状态变化事件。该回调不会在动画过程中触发，而是在动画结束时触发。
...
建议使用[MapEventManager.off(type: 'cameraChange')](../misc/MapEventManager.md#section1994982613283)。
...
建议使用[MapEventManager.on(type: 'cameraIdle')](../misc/MapEventManager.md#section1963201310319)。
...
建议使用[MapEventManager.off(type: 'cameraIdle')](../misc/MapEventManager.md#section1763512138315)。
...
建议使用[MapEventManager.on(type: 'cameraMoveCancel')](../misc/MapEventManager.md#section1322914471399)。
...
建议使用[MapEventManager.off(type: 'cameraMoveCancel')](../misc/MapEventManager.md#section10232124743913)。
...
建议使用[MapEventManager.on(type: 'cameraMove')](../misc/MapEventManager.md#section142347477396)。
...
建议使用[MapEventManager.off(type: 'cameraMove')](../misc/MapEventManager.md#section1823714753912)。
...
建议使用[MapEventManager.on(type: 'cameraMoveStart')](../misc/MapEventManager.md#section6240147113918)。
...
建议使用[MapEventManager.off(type: 'cameraMoveStart')](../misc/MapEventManager.md#section12243647133915)。
...
建议使用[MapEventManager.on(type: 'mapClick')](../misc/MapEventManager.md#section824544714394)。
...
回调函数，返回[mapCommon.LatLng](../misc/mapCommon（地图属性模型）.md#section20691173773810)。
...
建议使用[MapEventManager.off(type: 'mapClick')](../misc/MapEventManager.md#section02487472392)。
...
建议使用[MapEventManager.on(type: 'mapLoad')](../misc/MapEventManager.md#section19251144723913)。
...
建议使用[MapEventManager.off(type: 'mapLoad')](../misc/MapEventManager.md#section132541747133918)。
...
建议使用[MapEventManager.on(type: 'mapLongClick')](../misc/MapEventManager.md#section0257247133915)。
...
建议使用[MapEventManager.off(type: 'mapLongClick')](../misc/MapEventManager.md#section2261114753919)。
...
建议使用[MapEventManager.on(type: 'myLocationButtonClick')](../misc/MapEventManager.md#section9264124723916)。
...
'myLocationButtonClick'：监听“我的位置”按钮点击事件。
...
建议使用[MapEventManager.off(type: 'myLocationButtonClick')](../misc/MapEventManager.md#section19268134715398)。
...
建议使用[MapEventManager.on(type: 'myLocationClick')](../misc/MapEventManager.md#section827144713394)。
...
建议使用[MapEventManager.off(type: 'myLocationClick')](../misc/MapEventManager.md#section10275247193911)。
...
建议使用[MapEventManager.on(type: 'poiClick')](../misc/MapEventManager.md#section0279247143911)。
...
Callback<[mapCommon.Poi](../misc/mapCommon（地图属性模型）.md#section1155919456273)>

是

回调函数，返回[mapCommon.Poi](../misc/mapCommon（地图属性模型）.md#section1155919456273)。
...
建议使用[MapEventManager.off(type: 'poiClick')](../misc/MapEventManager.md#section11283174743917)。
...
建议使用[MapEventManager.on(type: 'markerClick')](../misc/MapEventManager.md#section19286104716392)。
...
Callback<[Marker](../media/Marker.md)>

是

回调函数，返回[Marker](../media/Marker.md)。
...
建议使用[MapEventManager.off(type: 'markerClick')](../misc/MapEventManager.md#section929019470390)。
...
建议使用[MapEventManager.on(type: 'markerDragStart')](../misc/MapEventManager.md#section19294747123912)。
...
建议使用[MapEventManager.off(type: 'markerDragStart')](../misc/MapEventManager.md#section16298847183914)。
...
建议使用[MapEventManager.on(type: 'markerDrag')](../misc/MapEventManager.md#section103026476395)。
...
建议使用[MapEventManager.off(type: 'markerDrag')](../misc/MapEventManager.md#section13306124793916)。
...
建议使用[MapEventManager.on(type: 'markerDragEnd')](../misc/MapEventManager.md#section13310124719393)。
...
建议使用[MapEventManager.off(type: 'markerDragEnd')](../misc/MapEventManager.md#section2031414753918)。
...
建议使用[MapEventManager.on(type: 'circleClick')](../misc/MapEventManager.md#section83181474399)。
...
Callback<[MapCircle](../misc/MapCircle.md)>

是

回调函数，返回[MapCircle](../misc/MapCircle.md)。
...
建议使用[MapEventManager.off(type: 'circleClick')](../misc/MapEventManager.md#section1232294710392)。
...
建议使用[MapEventManager.on(type: 'polylineClick')](../misc/MapEventManager.md#section732614710394)。
...
Callback<[MapPolyline](../graphics/MapPolyline.md)>

是

回调函数，返回[MapPolyline](../graphics/MapPolyline.md)。
...
建议使用[MapEventManager.off(type: 'polylineClick')](../misc/MapEventManager.md#section1233024711397)。
...
建议使用[MapEventManager.on(type: 'polygonClick')](../misc/MapEventManager.md#section933411473395)。
...
Callback<[MapPolygon](../system-services/MapPolygon.md)>

是

回调函数，返回[MapPolygon](../system-services/MapPolygon.md)。
...
建议使用[MapEventManager.off(type: 'polygonClick')](../misc/MapEventManager.md#section133964753915)。
...
建议使用[MapEventManager.on(type: 'infoWindowClick')](../misc/MapEventManager.md#section12343194753919)。
...
建议使用[MapEventManager.off(type: 'infoWindowClick')](../misc/MapEventManager.md#section18348114710396)。
...
建议使用[MapEventManager.on(type: 'infoWindowClose')](../misc/MapEventManager.md#section10352194713912)。
...
建议使用[MapEventManager.off(type: 'infoWindowClose')](../misc/MapEventManager.md#section535624713394)。
...
建议使用[MapEventManager.on(type: 'pointAnnotationClick')](../misc/MapEventManager.md#section636111479397)。
...
Callback<[PointAnnotation](../misc/PointAnnotation.md)>

是

回调函数，返回[PointAnnotation](../misc/PointAnnotation.md)。
...
建议使用[MapEventManager.off(type: 'pointAnnotationClick')](../misc/MapEventManager.md#section5365154710393)。
...
建议使用[MapEventManager.on(type: 'bubbleClick')](../misc/MapEventManager.md#section10369124763915)。
...
Callback<[Bubble](../misc/Bubble.md)>

是

回调函数，返回[Bubble](../misc/Bubble.md)。
...
建议使用[MapEventManager.off(type: 'bubbleClick')](../misc/MapEventManager.md#section13374114733920)。
...
建议使用[MapEventManager.on(type: 'imageOverlayClick')](../misc/MapEventManager.md#section2379144743910)。
...
Callback<[ImageOverlay](../graphics/ImageOverlay.md#section361333917368)>

是

回调函数，返回[ImageOverlay](../graphics/ImageOverlay.md#section361333917368)。
...
建议使用[MapEventManager.off(type: 'imageOverlayClick')](../misc/MapEventManager.md#section123841147173920)。
...
回调函数，返回[ImageOverlay](../graphics/ImageOverlay.md#section361333917368)，当不填时清除所有监听回调。
...
建议使用[MapEventManager.on(type: 'error')](../misc/MapEventManager.md#section19389184720396)。
...
建议使用[MapEventManager.off(type: 'error')](../misc/MapEventManager.md#section1439524793910)。
...
建筑物的ID。从[on('indoorMapEnter')](../misc/MapEventManager.md#section76731728143918)方法的回调函数中获得。
