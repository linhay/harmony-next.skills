...
Menu组件需和[bindMenu](../misc/菜单控制.md#ZH-CN_TOPIC_0000002497604848__bindmenu)或[bindContextMenu](../misc/菜单控制.md#ZH-CN_TOPIC_0000002497604848__bindcontextmenu8)方法配合使用，不支持作为普通组件单独使用。
...
布局过程中，期望每个菜单项的宽度一致。若子组件设置了宽度，则以[尺寸计算规则](../misc/尺寸设置.md#ZH-CN_TOPIC_0000002497444850__constraintsize)为准。
...
参数名类型必填说明value[Font](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font)是
...
参数名类型必填说明value[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)是Menu中所有文本的颜色。[]()[]()
...
参数名类型必填说明value[Dimension](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [BorderRadiuses](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__borderradiuses9)是
...
参数名类型必填说明options[DividerStyleOptions](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dividerstyleoptions12) | undefined是
...
参数名类型必填说明mode[SubMenuExpandingMode](#ZH-CN_TOPIC_0000002529444891__submenuexpandingmode12枚举说明)是
...
参数名类型必填说明symbol[SymbolGlyphModifier](../misc/动态SymbolGlyphModifier属性设置.md)是
...
从API version 9开始支持，从API version 10开始废弃，建议使用[font](#ZH-CN_TOPIC_0000002529444891__font10)代替。

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

**参数：**

参数名类型必填说明value[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)是Menu中所有文本的尺寸，Length为number类型时，使用fp单位。不支持设置百分比。[]()[]()
...
名称值说明SIDE_EXPAND0默认展开样式，子菜单位于同一平面侧边展开。EMBEDDED_EXPAND1直接展开样式，子菜单嵌于主菜单内展开。STACK_EXPAND2堆叠样式，子菜单浮于主菜单上方展开。[]()[]()
