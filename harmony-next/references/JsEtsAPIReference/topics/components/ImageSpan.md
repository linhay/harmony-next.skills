...
[Text](../graphics/Text.md)、[ContainerSpan](ContainerSpan.md)组件的子组件，用于显示行内图片。
...
参数名类型必填说明value[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | [PixelMap](../../types/interfaces/Interface (PixelMap).md)是
...
属性继承自[BaseSpan](span.md#ZH-CN_TOPIC_0000002529284887__basespan)，通用属性方法支持[尺寸设置](../misc/尺寸设置.md)、[背景设置](../misc/背景设置.md)、[边框设置](../misc/边框设置.md)。
...
参数名类型必填说明value[ImageSpanAlignment](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagespanalignment10)是
...
参数名类型必填说明value[PixelMap](../../types/interfaces/Interface (PixelMap).md)是

设置图片加载过程中显示的占位图，支持[PixelMap](../../types/interfaces/Interface (PixelMap).md)类型。
...
参数名类型必填说明filter[ColorFilter](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__colorfilter9) | [DrawingColorFilter](../graphics/Image.md#ZH-CN_TOPIC_0000002497444922__drawingcolorfilter12)是
...
控制是否开启[SVG标签解析能力增强功能](../misc/SVG标签解析能力增强.md)。
...
通用事件仅支持[点击事件](../misc/点击控制.md)。还支持以下事件：
...
参数名类型必填说明callback[ImageErrorCallback](../graphics/Image.md#ZH-CN_TOPIC_0000002497444922__imageerrorcallback9)是图片加载异常时触发的回调。
...
从API version 22开始，该示例通过设置[supportSvg2](#ZH-CN_TOPIC_0000002529444861__supportsvg222)属性，使[SVG标签解析能力增强功能](../misc/SVG标签解析能力增强.md#ZH-CN_TOPIC_0000002529284895__svg易用性提升)的SVG易用性提升能力生效。
