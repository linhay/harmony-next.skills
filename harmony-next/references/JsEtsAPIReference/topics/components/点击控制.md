...
从API version 7开始支持，从API version 9开始废弃，建议使用[hitTestBehavior](触摸测试控制.md#ZH-CN_TOPIC_0000002553360719__hittestbehavior)替代。
...
![image](public_sys-resources/zh-cn_image_0000002553205391.webp)