...
路径对象，支持通过对象的接口进行路径的描述，并通过Canvas的stroke接口或者fill接口进行绘制。
 ...
 Path2D对象的方法无法对[CanvasRenderingContext2D](CanvasRenderingContext2D.md)和[OffscreenCanvasRenderingContext2D](OffscreenCanvasRenderingContext2D.md)对象中设置的路径生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unit | LengthMetricsUnit | 是 | 用来配置Path2D对象的单位模式，配置后无法动态更改，配置方法同CanvasRenderingContext2D。 异常值NaN和Infinity按默认值处理。 默认值：DEFAULT |
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002522085268.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553365185.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002522245262.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553205225.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002522085270.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553365187.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002522245264.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553205227.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002522085272.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553365189.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553365137.webp)