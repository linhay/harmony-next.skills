...
继承自[GestureInterface<T>](手势公共接口.md#ZH-CN_TOPIC_0000002522080814__gestureinterfacet11)，设置旋转手势事件。
...
设置旋转手势事件。与[RotationGesture](#ZH-CN_TOPIC_0000002522240810__rotationgesture-1)相比，options参数新增了isFingerCountLimited参数，表示是否检查触摸屏幕的手指数量。
...
Rotation手势识别成功，接收到触摸取消事件触发的回调。与[onActionCancel](#ZH-CN_TOPIC_0000002522240810__onactioncancel)相比，该回调返回手势事件信息。
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002522084854.webp)