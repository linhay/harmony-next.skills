...
configBadgeConfig-否设置新事件标记相关配置属性。label6+string-否
...
名称类型默认值必填描述badgeColor<color>#fa2a2d否新事件标记背景色。textColor<color>#ffffff否数字标记的数字文本颜色。textSize<length>10px否数字标记的数字文本大小。badgeSize<length>6px否圆点标记的默认大小。[]()[]()
