...
| value | FlexAlign | 是 | 子组件在垂直方向上的对齐格式。 默认值：FlexAlign.Start |
 ...
 Column布局时若子组件不设置[flexShrink](Flex布局.md#ZH-CN_TOPIC_0000002522080780__flexshrink)则默认不会压缩子组件，即所有子组件主轴大小累加可超过容器主轴，此时FlexAlign.Center和FlexAlign.End会失效。
...
![image](public_sys-resources/zh-cn_image_0000002553204817.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522084864.webp)