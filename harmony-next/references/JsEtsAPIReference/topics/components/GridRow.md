...
栅格容器组件，仅可以和栅格子组件([GridCol](GridCol.md))在栅格布局场景中使用。
...
参数名类型必填说明option[GridRowOptions](#ZH-CN_TOPIC_0000002497604868__gridrowoptions对象说明)否栅格布局子组件参数。
...
名称类型只读可选说明columnsnumber | [GridRowColumnOption](#ZH-CN_TOPIC_0000002497604868__gridrowcolumnoption)否是
...
gutter[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | [GutterOption](#ZH-CN_TOPIC_0000002497604868__gutteroption)否是
...
breakpoints[BreakPoints](#ZH-CN_TOPIC_0000002497604868__breakpoints)否是
...
direction[GridRowDirection](#ZH-CN_TOPIC_0000002497604868__gridrowdirection枚举说明)否是
...
名称类型只读可选说明x[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | [GridRowSizeOption](#ZH-CN_TOPIC_0000002497604868__gridrowsizeoption)否是栅格子组件水平方向间距。y[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | [GridRowSizeOption](#ZH-CN_TOPIC_0000002497604868__gridrowsizeoption)否是栅格子组件竖直方向间距。
...
名称类型只读可选说明xs[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在最小宽度类型设备上，栅格子组件的间距。

默认值：0vp

sm[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在小宽度类型设备上，栅格子组件的间距。

默认值：0vp

md[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在中等宽度类型设备上，栅格子组件的间距。

默认值：0vp

lg[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在大宽度类型设备上，栅格子组件的间距。

默认值：0vp

xl[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是

在特大宽度类型设备上，栅格子组件的间距。

默认值：0vp

xxl[Length](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是
...
名称类型只读可选说明valueArray<string>否是
...
reference[BreakpointsReference](#ZH-CN_TOPIC_0000002497604868__breakpointsreference枚举说明)否是
...
名称说明WindowSize以窗口为参照。ComponentSize以容器为参照。
...
名称值说明Row0栅格元素按照行方向排列。RowReverse1栅格元素按照逆序行方向排列。
...
设置GridRow中的GridCol垂直主轴方向对齐方式。GridCol本身也可通过alignSelf([ItemAlign](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__itemalign))设置自身对齐方式。当上述两种对齐方式都设置时，以GridCol自身设置为准。
...
参数名类型必填说明value[ItemAlign](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__itemalign)是

GridRow中的GridCol垂直主轴方向对齐方式。
...
参数名类型必填说明callback(breakpoints: string) => void是breakpoints取值为"xs"、"sm"、"md"、"lg"、"xl"、"xxl"。
