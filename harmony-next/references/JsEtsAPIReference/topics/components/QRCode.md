...
该示例展示了QRCode组件的基本使用方法，通过[color](#ZH-CN_TOPIC_0000002522240858__color)属性设置二维码颜色、[backgroundColor](#ZH-CN_TOPIC_0000002522240858__backgroundcolor)属性设置二维码背景颜色、[contentOpacity](#ZH-CN_TOPIC_0000002522240858__contentopacity11)属性设置二维码不透明度。
...
![image](public_sys-resources/zh-cn_image_0000002553365103.webp)

**示例2（设置背景颜色为透明）**

该示例通过[backgroundColor](#ZH-CN_TOPIC_0000002522240858__backgroundcolor)属性设置二维码背景颜色为透明，从而实现二维码内容与背景融合。
...
![image](public_sys-resources/zh-cn_image_0000002522245180.webp)