...
imageRes[ResourceStr12+](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | [PixelMap12+](../../types/interfaces/Interface (PixelMap).md)是-

展示的图片。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

imageSize[SizeOptions](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__sizeoptions)否-
...
title[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否-
...
content[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否-
...
checkTips[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否-
...
onCheckedChange12+[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<boolean>否-
...
theme12+[Theme](../../modules/ohos/@ohos.arkui.theme(主题换肤).md#ZH-CN_TOPIC_0000002529284765__theme) | [CustomTheme](../../modules/ohos/@ohos.arkui.theme(主题换肤).md#ZH-CN_TOPIC_0000002529284765__customtheme)否-

主题信息，可以是CustomTheme或从onWillApplyTheme中获取的Theme实例。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

themeColorMode12+[ThemeColorMode](../misc/组件内容模糊.md#ZH-CN_TOPIC_0000002497604838__themecolormode枚举说明)否-
...
radioContentArray<[SheetInfo](../misc/列表选择弹窗 (ActionSheet).md#ZH-CN_TOPIC_0000002497604934__sheetinfo对象说明)>是
...
primaryTitle12+[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否
...
secondaryTitle12+[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否
...
contentBuilder() => void是@BuilderParam弹出框内容。primaryTitle[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否-
...
secondaryTitle[ResourceStr](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否-
...
localizedContentAreaPadding[LocalizedPadding](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12)否-弹出框内容区内边距。contentAreaPadding[Padding](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding)否-弹出框内容区内边距。设置了localizedContentAreaPadding属性时该属性不生效。buttons[ButtonOptions](#ZH-CN_TOPIC_0000002529284929__buttonoptions)[]否-弹出框操作区按钮，最多支持4个按钮。theme[Theme](../../modules/ohos/@ohos.arkui.theme(主题换肤).md#ZH-CN_TOPIC_0000002529284765__theme) | [CustomTheme](../../modules/ohos/@ohos.arkui.theme(主题换肤).md#ZH-CN_TOPIC_0000002529284765__customtheme)否-主题信息，可以是CustomTheme或从onWillApplyTheme中获取的Theme实例。themeColorMode[ThemeColorMode](../misc/组件内容模糊.md#ZH-CN_TOPIC_0000002497604838__themecolormode枚举说明)否-
...
配置跟手弹出框的参数。targetBuilder[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<void>是
...
background[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
