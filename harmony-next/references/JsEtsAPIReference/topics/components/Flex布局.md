...
仅[Flex](Flex.md)、[Column](Column.md)或[Row](Row.md)支持下述四种属性，[GridRow](GridRow.md)仅支持设置[alignSelf](#ZH-CN_TOPIC_0000002522080780__alignself)。
...
设置父容器压缩尺寸分配给此属性所在组件的比例。当父容器为Column、Row时，需设置主轴方向的尺寸。
 ...
 使用[getInspectorByKey](组件标识.md#ZH-CN_TOPIC_0000002522080774__getinspectorbykey9)获取flexShrink属性时，如果该节点未设置flexShrink属性，默认返回1。
...
![image](public_sys-resources/zh-cn_image_0000002522084766.webp)