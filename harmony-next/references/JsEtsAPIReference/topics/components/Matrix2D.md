...
| translateY | number | 否 | 是 | 垂直平移距离，取值范围无限制。 异常值undefined按无效值处理，NaN和Infinity会导致Matrix2D异常。  默认单位：vp |
 ...
 可使用[px2vp](Class (UIContext).md#ZH-CN_TOPIC_0000002522240732__px2vp12)接口进行单位转换。
...
![image](public_sys-resources/zh-cn_image_0000002553205195.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085240.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553365157.webp)
...
该接口从API version 10开始废弃，推荐使用[rotate](#ZH-CN_TOPIC_0000002553360791__rotate10)。
...
![image](public_sys-resources/zh-cn_image_0000002522245234.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553205197.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085242.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553365159.webp)