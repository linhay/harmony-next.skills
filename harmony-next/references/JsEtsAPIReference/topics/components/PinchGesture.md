...
继承自[GestureInterface<T>](手势公共接口.md#ZH-CN_TOPIC_0000002522080814__gestureinterfacet11)，设置捏合手势事件。
...
设置捏合手势事件。与[PinchGesture](#ZH-CN_TOPIC_0000002553360735__pinchgesture-1)相比，options参数新增isFingerCountLimited，表示是否检查触摸屏幕的手指数量。
...
**事件**
 ...
 在[GestureEvent](手势公共接口.md#ZH-CN_TOPIC_0000002522080814__gestureevent对象说明)的fingerList元素中，手指索引编号与位置相对应，即fingerList[index]的id为index。对于先按下但未参与当前手势触发的手指，fingerList中对应的位置为空。建议开发者优先使用fingerInfos。
...
Pinch手势识别成功并接收到触摸取消事件的回调。与[onActionCancel](#ZH-CN_TOPIC_0000002553360735__onactioncancel)相比，该回调返回手势事件信息。
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002522244846.webp)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553204807.webp)