...
设置组件的前景色。当组件未设置前景色，默认继承父组件。与[foregroundColor](#ZH-CN_TOPIC_0000002522080786__foregroundcolor)相比，color参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional<ResourceColor | ColoringStrategy> | 是 | 设置组件的前景颜色或者根据智能取色策略设置前景颜色。不支持属性动画。 当color的值为undefined时，维持之前取值或组件默认取值，具体行为不同组件可能会有差异，建议开发者使用确定颜色或ColoringStrategy。 |
...
![image](public_sys-resources/zh-cn_image_0000002522244782.webp)

**示例2（设置前景色为组件背景色反色）**

该示例通过[ColoringStrategy](枚举说明.md#ZH-CN_TOPIC_0000002553200889__coloringstrategy10).INVERT将前景色设置为背景色反色。
...
![image](public_sys-resources/zh-cn_image_0000002553204743.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522084790.webp)