...
ArcList子组件[visibility](../misc/显隐控制.md#ZH-CN_TOPIC_0000002529284817__visibility)属性设置为Hidden或None依然会计算索引值。
...
参数名类型必填说明sensitivity[Optional<CrownSensitivity>](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__crownsensitivity18)是
...
参数名类型必填说明space[Optional<LengthMetrics>](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)是

列表子项之间的间距。

默认值：LengthMetrics.vp(0)

ArcList子组件的[visibility](../misc/显隐控制.md#ZH-CN_TOPIC_0000002529284817__visibility)属性设置为None时不显示，但该子组件上下的space还会生效。
...
参数名类型必填说明status[Optional<BarState>](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__barstate)是
...
链式动效生效需要满足前提条件：ArcList边缘效果为[EdgeEffect.Spring](../../guides/枚举说明.md#ZH-CN_TOPIC_0000002529284967__edgeeffect)类型。
...
fadingEdge生效时，组件会裁剪到边界，设置组件的[clip](../misc/形状裁剪.md#ZH-CN_TOPIC_0000002529284827__clip12)属性为false不生效。
...
参数名类型必填说明width[Optional<LengthMetrics>](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)是
...
参数名类型必填说明color[Optional<ColorMetrics>](../graphics/Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)是
...
参数名类型必填说明handler[Optional<VoidCallback>](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是列表到达起始位置时触发。
...
参数名类型必填说明handler[Optional<VoidCallback>](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是列表到达末尾位置时触发。
...
参数名类型必填说明handler[Optional<VoidCallback>](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是列表滑动开始时触发。
...
参数名类型必填说明handler[Optional<VoidCallback>](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是列表滑动停止时触发。
...
参数名类型必填说明handler[Optional<OnWillScrollCallback>](../misc/滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__onwillscrollcallback12)是列表滑动时每帧开始前触发的回调。
...
参数名类型必填说明handler[Optional<OnScrollCallback>](../misc/滚动组件通用接口.md#ZH-CN_TOPIC_0000002529284871__onscrollcallback12)是列表滑动时触发的回调。
