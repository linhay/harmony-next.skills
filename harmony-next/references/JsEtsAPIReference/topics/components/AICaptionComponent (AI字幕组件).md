...
[AICaptionController](#section816451553012)
...
[AICaptionOptions](#section15787428226)
...
用于创建对象[AICaptionComponent](#section7266241469)的构造函数。
...
写入音频数据。音频流信息格式从[getAudioInfo](#section16367173452)方法获取（调用此方法会停止自动获取应用音频生成字幕，以写入的音频流为准）。
...
[AudioData](#section1869988122518)
...
audio.[AudioSamplingRate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#audiosamplingrate8)
...
audio.[AudioChannel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#audiochannel8)
