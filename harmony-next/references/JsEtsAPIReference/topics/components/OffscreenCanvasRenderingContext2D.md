# Offscreen[CanvasRenderingContext2D](CanvasRenderingContext2D.md)

使用Offscreen[CanvasRenderingContext2D](CanvasRenderingContext2D.md)在Canvas上进行离屏绘制，绘制对象可以是形状、文本、图片等。离屏绘制是指将需要绘制的内容先绘制在缓存区，然后将其转换成图片，一次性绘制到Canvas上。离屏绘制使用CPU进行绘制，绘制速度较慢，对绘制速度有要求的场景应避免使用离屏绘制。
 ...
 [beginPath](#ZH-CN_TOPIC_0000002553200831__beginpath)、[moveTo](#ZH-CN_TOPIC_0000002553200831__moveto)、[lineTo](#ZH-CN_TOPIC_0000002553200831__lineto)、[closePath](#ZH-CN_TOPIC_0000002553200831__closepath)、[bezierCurveTo](#ZH-CN_TOPIC_0000002553200831__beziercurveto)、[quadraticCurveTo](#ZH-CN_TOPIC_0000002553200831__quadraticcurveto)、[arc](#ZH-CN_TOPIC_0000002553200831__arc)、[arcTo](#ZH-CN_TOPIC_0000002553200831__arcto)、[ellipse](#ZH-CN_TOPIC_0000002553200831__ellipse)、[rect](#ZH-CN_TOPIC_0000002553200831__rect)和[roundRect](#ZH-CN_TOPIC_0000002553200831__roundrect20)接口只能对OffscreenCanvasRenderingContext2D中的路径生效，无法对[CanvasRenderingContext2D](CanvasRenderingContext2D.md)和[Path2D](Path2D.md)对象中设置的路径生效。

#### 构造函数

#### constructor

constructor(width: number, height: number, settings?: [RenderingContextSettings](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__renderingcontextsettings))

构造离屏Canvas画布对象，支持配置画布宽高和Offscreen[CanvasRenderingContext2D](CanvasRenderingContext2D.md)对象的参数。
...
| settings | [RenderingContextSettings](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__renderingcontextsettings) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的参数，见RenderingContextSettings接口描述。 异常值undefined按RenderingContextSettings的默认值处理。 默认值：null |

#### constructor12+

constructor(width: number, height: number, settings?: [RenderingContextSettings](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__renderingcontextsettings), unit?: [LengthMetrics](../misc/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)Unit)

构造离屏Canvas画布对象，支持配置画布宽高、Offscreen[CanvasRenderingContext2D](CanvasRenderingContext2D.md)对象的参数和单位模式。
...
| width | number | 是 | 离屏画布的宽度，默认单位：vp 异常值NaN和Infinity按无效值处理。 |
| height | number | 是 | 离屏画布的高度，默认单位：vp 异常值NaN和Infinity按无效值处理。 |
| settings | [RenderingContextSettings]([CanvasRenderingContext2D](CanvasRenderingContext2D.md).md#ZH-CN_TOPIC_0000002497444936__renderingcontextsettings) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的参数，见RenderingContextSettings接口描述。 异常值undefined按RenderingContextSettings的默认值处理。 默认值：null |
| unit | [LengthMetricsUnit](../misc/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetricsunit12) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的单位模式，配置后无法动态更改，配置方法同CanvasRenderingContext2D。 异常值undefined、NaN和Infinity按默认值处理。 默认值：DEFAULT |
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| string |number10+ |[CanvasGradient](CanvasGradient.md) | CanvasPattern | 否 | 否 | - 类型为string时，表示设置填充区域的颜色，颜色格式参考ResourceColor中string类型说明。 - 类型为number时，表示设置填充区域的颜色，不支持设置全透明色，颜色格式参考ResourceColor中number类型说明。 - 类型为CanvasGradient时，表示渐变对象，使用createLinearGradient方法创建。 - 类型为CanvasPattern时，使用createPattern方法创建。 默认值：'#000000'（黑色） 异常值设置无效。 |
...
![image](public_sys-resources/zh-cn_image_0000002553205201.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085246.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| string |number10+ |[CanvasGradient](CanvasGradient.md) | CanvasPattern | 否 | 否 | - 类型为string时，表示设置线条使用的颜色，颜色格式参考ResourceColor中string类型说明。 - 类型为number时，表示设置线条使用的颜色，不支持设置全透明色，颜色格式参考ResourceColor中number类型说明。 - 类型为CanvasGradient时，表示渐变对象，使用createLinearGradient方法创建。 - 类型为CanvasPattern时，使用createPattern方法创建。 默认值：'#000000'（黑色） 异常值设置无效。 |
...
![image](public_sys-resources/zh-cn_image_0000002553365163.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasLineCap](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvaslinecap类型说明) | 否 | 否 | 默认值：'butt' |
...
![image](public_sys-resources/zh-cn_image_0000002522245240.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasLineJoin](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvaslinejoin类型说明) | 否 | 否 | 默认值：'miter' |
...
![image](public_sys-resources/zh-cn_image_0000002553205203.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085248.webp)
...
从API version 20开始，支持通过该接口设置注册过的自定义字体（只能在主线程使用，不支持在worker线程中使用；DevEco Studio的预览器不支持显示自定义字体）。自定义字体注册有以下两种方式。一种是通过ArkUI的异步接口this.uiContext.getFont().[registerFont](Class (Font).md#ZH-CN_TOPIC_0000002553200691__registerfont)注册，调用后立即绘制可能会导致自定义字体不生效。另一种是直接调用字体引擎的fontCollection.[loadFontSync](@ohos.graphics.text (文本模块).md#ZH-CN_TOPIC_0000002553362061__loadfontsync)接口来注册自定义字体到字体引擎。在直接调用字体引擎接口注册自定义字体时，fontCollection的实例需要是text.FontCollection.getGlobalInstance()，因为组件默认会从该实例加载字体。如果使用其他实例，可能会导致自定义字体不生效。
...
![image](public_sys-resources/zh-cn_image_0000002553365165.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasTextAlign](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvastextalign类型说明) | 否 | 否 | ltr布局模式下'start'和'left'一致，rtl布局模式下'start'和'right'一致。 默认值：'left' |
...
![image](public_sys-resources/zh-cn_image_0000002522245242.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasTextBaseline](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvastextbaseline类型说明) | 否 | 否 | 默认值：'alphabetic' |
...
![image](public_sys-resources/zh-cn_image_0000002522245196.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553205205.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085250.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553365167.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522245244.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| string | 否 | 否 | 颜色格式参考[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)中string类型说明。 默认值：透明黑色 |
...
![image](public_sys-resources/zh-cn_image_0000002553205207.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085252.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553365169.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522245246.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [ImageSmoothingQuality](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__imagesmoothingquality类型说明) | 否 | 否 | 默认值："low" |
...
![image](public_sys-resources/zh-cn_image_0000002522245202.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| [CanvasDirection](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvasdirection类型说明) | 否 | 否 | 默认值："inherit" |
...
![image](public_sys-resources/zh-cn_image_0000002553205165.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085210.webp)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| string | LengthMetrics | 否 | 否 | 当使用LengthMetrics时： 字间距按照指定的单位设置； 不支持FP、PERCENT和LPX（按无效值处理）； 支持负数和小数，设为小数时字间距不四舍五入。 当使用string时： 不支持设置百分比（按无效值处理）； 支持负数和小数，设为小数时字间距不四舍五入； 若letterSpacing的赋值未指定单位（例如：letterSpacing='10'），且未指定[LengthMetricsUnit](../misc/Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetricsunit12)时，默认单位设置为vp； 指定LengthMetricsUnit为px时，默认单位设置为px； 当letterSpacing的赋值指定单位时（例如：letterSpacing='10vp'），字间距按照指定的单位设置。 默认值：0（输入无效值时，字间距设为默认值） 注：推荐使用LengthMetrics，性能更好。 |
...
![image](public_sys-resources/zh-cn_image_0000002553365127.webp)
...
measureText(text: string): [TextMetrics](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__textmetrics)
...
| 类型 | 说明 |
| --- | --- |
| [TextMetrics](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__textmetrics) | 文本的尺寸信息。 传入异常值undefined或null时按"undefined"或"null"计算。 |
...
stroke(path: [Path2D](Path2D.md)): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](Path2D.md) | 是 | 需要绘制的Path2D。 异常值undefined或null按无效值处理，不进行绘制。 |
...
createPattern(image: ImageBitmap, repetition: string | null): [CanvasPattern](CanvasPattern.md) | null
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](../../types/interfaces/ImageBitmap.md) | 是 | 图源对象，具体参考ImageBitmap对象。 异常值undefined或null按无效值处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [CanvasPattern](CanvasPattern.md) | null | 通过指定图像和重复方式创建图片填充的模板对象。 |
...
![image](public_sys-resources/zh-cn_image_0000002522085258.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553365175.webp)
...
以下错误码的详细介绍请参见[Canvas组件错误码]([Canvas组件错误码](../../errors/Canvas组件错误码.md).md)。
...
fill(fillRule?: [CanvasFillRule](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvasfillrule类型说明)): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvasfillrule类型说明) | 否 | 指定要填充对象的规则。 可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。 默认值："nonzero" |
...
fill(path: [Path2D](Path2D.md), fillRule?: CanvasFillRule): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](Path2D.md) | 是 | Path2D填充路径。 异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvasfillrule类型说明) | 否 | 指定要填充对象的规则。 可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。 默认值："nonzero" |
...
clip(fillRule?: [CanvasFillRule](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvasfillrule类型说明)): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvasfillrule类型说明) | 否 | 指定要剪切对象的规则。 可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。 默认值："nonzero" |
...
clip(path: [Path2D](Path2D.md), fillRule?: CanvasFillRule): void
...
| 参数名 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| path | [Path2D](Path2D.md) | 是 | Path2D剪切路径。 异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](CanvasRenderingContext2D.md#ZH-CN_TOPIC_0000002497444936__canvasfillrule类型说明) | 否 | 指定要剪切对象的规则。 可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。 默认值："nonzero" |
...
将Offscreen[CanvasRenderingContext2D](CanvasRenderingContext2D.md)重置为其默认状态，清除后台缓冲区、绘制状态栈、绘制路径和样式。
...
setTransform(transform?: [Matrix2D](Matrix2D.md)): void

以[Matrix2D](Matrix2D.md)对象为模板重置现有的变换矩阵并创建新的变换矩阵。
...
| 参数名 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| transform | [Matrix2D](Matrix2D.md) | 否 | 变换矩阵。 异常值undefined或null按无效值处理。 默认值：null |
...
getTransform(): [Matrix2D](Matrix2D.md)
...
| 类型 | 说明 |
| --- | --- |
| [Matrix2D](Matrix2D.md) | 当前被应用到上下文的转换矩阵。 |
...
drawImage(image: [ImageBitmap](../../types/interfaces/ImageBitmap.md) | PixelMap, dx: number, dy: number): void
...
| 参数 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](../../types/interfaces/ImageBitmap.md) | PixelMap | 是 | 图片资源，请参考ImageBitmap或PixelMap。 异常值undefined或null按无效值处理，不进行绘制。 |
...
drawImage(image: [ImageBitmap](../../types/interfaces/ImageBitmap.md) | PixelMap, dx: number, dy: number, dw: number, dh: number): void
...
drawImage(image: [ImageBitmap](../../types/interfaces/ImageBitmap.md) | PixelMap, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number): void
...
| --- | --- | --- | --- |
| image | [ImageBitmap](../../types/interfaces/ImageBitmap.md) | PixelMap | 是 | 图片资源，请参考ImageBitmap或PixelMap。 异常值undefined或null按无效值处理，不进行绘制。 |
| sx | number | 是 | 裁切源图像时距离源图像左上角的x坐标值。 异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 image类型为[ImageBitmap](../../types/interfaces/ImageBitmap.md)时，默认单位：vp image类型为PixelMap时，API version 18前，默认单位：px；API version 18及以后，默认单位：vp |
| sy | number | 是 | 裁切源图像时距离源图像左上角的y坐标值。 异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 image类型为[ImageBitmap](../../types/interfaces/ImageBitmap.md)时，默认单位：vp image类型为PixelMap时，API version 18前，默认单位：px；API version 18及以后，默认单位：vp |
| sw | number | 是 | 裁切源图像时需要裁切的宽度。 负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 image类型为[ImageBitmap](../../types/interfaces/ImageBitmap.md)时，默认单位：vp image类型为PixelMap时，API version 18前，默认单位：px；API version 18及以后，默认单位：vp |
| sh | number | 是 | 裁切源图像时需要裁切的高度。 负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 image类型为[ImageBitmap](../../types/interfaces/ImageBitmap.md)时，默认单位：vp image类型为PixelMap时，API version 18前，默认单位：px；API version 18及以后，默认单位：vp |
| dx | number | 是 | 绘制区域左上角在x轴的位置。 异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 默认单位：vp |
| dy | number | 是 | 绘制区域左上角在y轴的位置。 异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 默认单位：vp |
| dw | number | 是 | 绘制区域的宽度。 负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 默认单位：vp |
| dh | number | 是 | 绘制区域的高度。 负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。 默认单位：vp |
...
#### create[ImageData](../../types/interfaces/ImageData.md)

create[ImageData](../../types/interfaces/ImageData.md)(sw: number, sh: number): ImageData

根据当前[ImageData](../../types/interfaces/ImageData.md)对象重新创建一个宽、高相同的ImageData对象，请参考[ImageData](ImageData.md)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同putImageData。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sw | number | 是 | [ImageData](../../types/interfaces/ImageData.md)的宽度。 异常值undefined、null、NaN和Infinity按0处理。 默认单位：vp |
| sh | number | 是 | [ImageData](../../types/interfaces/ImageData.md)的高度。 异常值undefined、null、NaN和Infinity按0处理。 默认单位：vp |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ImageData](../../types/interfaces/ImageData.md) | 新的ImageData对象。 |

#### create[ImageData](../../types/interfaces/ImageData.md)

create[ImageData](../../types/interfaces/ImageData.md)(imageData: ImageData): ImageData

根据已创建的[ImageData](../../types/interfaces/ImageData.md)对象创建新的ImageData对象（不会复制图像数据），请参考[ImageData](ImageData.md)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同putImageData。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](../../types/interfaces/ImageData.md) | 是 | 被复制的ImageData对象。 异常值undefined和null按width和height为0的ImageData处理。 |
...
#### get[ImageData](../../types/interfaces/ImageData.md)

get[ImageData](../../types/interfaces/ImageData.md)(sx: number, sy: number, sw: number, sh: number): ImageData

以当前canvas指定区域内的像素创建[ImageData]([ImageData](../../types/interfaces/ImageData.md).md)对象，该接口存在内存拷贝行为，高耗时，应避免频繁使用。
...
#### put[ImageData](../../types/interfaces/ImageData.md)

put[ImageData](../../types/interfaces/ImageData.md)(imageData: ImageData, dx: number | string, dy: number | string): void

使用[ImageData]([ImageData](../../types/interfaces/ImageData.md).md)数据填充新的矩形区域。
...
| 参数名 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| imageData | [ImageData](../../types/interfaces/ImageData.md) | 是 | 包含像素值的ImageData对象。 异常值undefined或null按无效值处理，不进行绘制。 |
...
put[ImageData](../../types/interfaces/ImageData.md)(imageData: ImageData, dx: number | string, dy: number | string, dirtyX: number | string, dirtyY: number | string, dirtyWidth?: number | string, dirtyHeight: number | string): void

使用[ImageData]([ImageData](../../types/interfaces/ImageData.md).md)数据裁剪后填充至新的矩形区域。
...
#### transferTo[ImageBitmap](../../types/interfaces/ImageBitmap.md)

transferTo[ImageBitmap](../../types/interfaces/ImageBitmap.md)(): ImageBitmap

在离屏画布最近渲染的图像上创建一个[ImageBitmap](../../types/interfaces/ImageBitmap.md)对象。
...
| 类型 | 说明 |
| --- | --- |
| [ImageBitmap](../../types/interfaces/ImageBitmap.md) | 存储离屏画布上渲染的像素数据。 |
...
当restore()次数未超出save()次数时，从栈中弹出存储的绘制状态并恢复[CanvasRenderingContext2D](CanvasRenderingContext2D.md)对象的属性、剪切路径和变换矩阵的值。
...
createLinearGradient(x0: number, y0: number, x1: number, y1: number): [CanvasGradient](CanvasGradient.md)
...
| 类型 | 说明 |
| --- | --- |
| [CanvasGradient](CanvasGradient.md) | 新的CanvasGradient对象，用于在offscreenCanvas上创建渐变效果。 |
...
createRadialGradient(x0: number, y0: number, r0: number, x1: number, y1: number, r1: number): [CanvasGradient](CanvasGradient.md)
...
createConicGradient(startAngle: number, x: number, y: number): [CanvasGradient](CanvasGradient.md)
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553365151.webp)
