...
是否对子组件超出当前组件范围外的区域进行裁剪。不设置该接口时，默认不对子组件超出当前组件范围外的区域进行裁剪。与[clip12+](#ZH-CN_TOPIC_0000002522240784__clip12)相比，新增了对undefined类型的支持。
...
从API version 7开始支持，从API version 12开始废弃，建议使用[clipShape](#ZH-CN_TOPIC_0000002522240784__clipshape12)替代。
...
形状中的[fill](@ohos.arkui.shape (形状).md#ZH-CN_TOPIC_0000002522080722__fill)属性对clipShape接口不生效。
...
按指定的形状（形状中可包含位置信息）对当前组件进行裁剪。与[clipShape12+](#ZH-CN_TOPIC_0000002522240784__clipshape12)相比，新增了对undefined类型的支持。
...
为组件上添加可调节进度的遮罩。与[mask12+](#ZH-CN_TOPIC_0000002522240784__mask12)相比，新增了对undefined类型的支持。
...
从API version 7开始支持，从API version 12开始废弃，建议使用[maskShape](#ZH-CN_TOPIC_0000002522240784__maskshape12)替代。
...
为组件上添加指定形状的遮罩。与[maskShape12+](#ZH-CN_TOPIC_0000002522240784__maskshape12)相比，新增了对undefined类型的支持。
...
该示例通过[clipShape](#ZH-CN_TOPIC_0000002522240784__clipshape12)、[clip](#ZH-CN_TOPIC_0000002522240784__clip12)、[maskShape](#ZH-CN_TOPIC_0000002522240784__maskshape12)实现图片的裁剪和遮罩。
...
![image](public_sys-resources/zh-cn_image_0000002553364699.webp)

**示例2（实现组件遮罩）**

该示例通过[mask](#ZH-CN_TOPIC_0000002522240784__mask12)实现图片的遮罩。
...
![image](public_sys-resources/zh-cn_image_0000002522244780.webp)