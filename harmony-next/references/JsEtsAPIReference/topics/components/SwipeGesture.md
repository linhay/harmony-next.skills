...
继承自[GestureInterface<T>](手势公共接口.md#ZH-CN_TOPIC_0000002522080814__gestureinterfacet11)，设置快滑手势事件。
...
设置快滑手势事件。与[SwipeGesture](#ZH-CN_TOPIC_0000002553200775__swipegesture-1)相比，options参数新增了isFingerCountLimited，表示是否检查触摸屏幕的手指数量。
...
```
 ...
 ![image](public_sys-resources/zh-cn_image_0000002553364769.webp)