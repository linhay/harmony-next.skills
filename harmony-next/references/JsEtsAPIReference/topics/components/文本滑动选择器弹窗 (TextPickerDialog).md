...
从API version 10开始，可以通过使用[UIContext](../../types/classes/Class (UIContext).md)中的[showTextPickerDialog](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showtextpickerdialog)来明确UI的执行上下文。
...
onScrollStop14+[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<[TextPickerResult](#ZH-CN_TOPIC_0000002497444958__textpickerresult对象说明)>否是
...
设置为true时，滑动过程中无字号、字重、字体颜色等变化动效，且文本均显示为defaultTextStyle属性设置的样式。如未设置defaultTextStyle，则显示为[Text](../graphics/Text.md)组件默认样式。
...
onAccept[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<[TextPickerResult](#ZH-CN_TOPIC_0000002497444958__textpickerresult对象说明)>否是点击弹窗中的“确定”按钮时触发该回调。onCancel[VoidCallback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否是点击弹窗中的“取消”按钮时触发该回调。onChange[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<[TextPickerResult](#ZH-CN_TOPIC_0000002497444958__textpickerresult对象说明)>否是

滑动弹窗中的选择器后，选项归位至选中项位置时，触发该回调。

回调会在滑动动画结束后触发，如果需要快速获取索引值变化，建议使用onEnterSelectedArea接口。

onScrollStop[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<[TextPickerResult](#ZH-CN_TOPIC_0000002497444958__textpickerresult对象说明)>否是滑动弹窗中的选择器的选择列停止时，触发该回调。backgroundColor[ResourceColor](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
backgroundBlurStyleOptions[BackgroundBlurStyleOptions](../misc/背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundblurstyleoptions10对象说明)否是

背景模糊效果。

**元服务API：** 从API version 20开始，该接口支持在元服务中使用。

backgroundEffect[BackgroundEffectOptions](../misc/背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundeffectoptions11)否是背景效果参数。onDidAppear[VoidCallback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否是
...
onDidDisappear[VoidCallback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否是
...
onWillAppear[VoidCallback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否是
...
onWillDisappear[VoidCallback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)否是
...
shadow[ShadowOptions](../misc/图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowoptions对象说明) | [ShadowStyle](../misc/图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowstyle10枚举说明)否是
...
hoverModeArea[HoverModeAreaType](../misc/半模态转场.md#ZH-CN_TOPIC_0000002497604850__hovermodeareatype14)否是
...
onEnterSelectedArea[Callback](../misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<[TextPickerResult](#ZH-CN_TOPIC_0000002497444958__textpickerresult对象说明)>否是
...
推荐通过使用[UIContext](../../types/classes/Class (UIContext).md)中的[showTextPickerDialog](../../types/classes/Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__showtextpickerdialog)来明确UI的执行上下文。
