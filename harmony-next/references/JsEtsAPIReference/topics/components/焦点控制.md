...
设置当前组件是否为当前[层级页面](焦点事件.md)上的默认焦点。当未设置defaultFocus时，组件默认不为当前层级页面的默认焦点。
...
该示例通过配置[defaultFocus](#ZH-CN_TOPIC_0000002553200755__defaultfocus9)可以使绑定的组件成为[层级页面](焦点事件.md)创建后首次获焦的焦点，配置[groupDefaultFocus](#ZH-CN_TOPIC_0000002553200755__groupdefaultfocus9)可以使绑定的组件成为tabIndex容器创建后首次获焦的焦点，配置[focusOnTouch](#ZH-CN_TOPIC_0000002553200755__focusontouch9)可以使绑定的组件点击后立即获焦。
