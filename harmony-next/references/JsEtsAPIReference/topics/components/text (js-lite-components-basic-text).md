...
名称类型默认值必填描述color<color>#ffffff否设置文本的颜色。font-size<length>30px否

设置文本的尺寸。

letter-spacing<length>2px否设置文本的字符间距。text-alignstringleft否
...
font-familystringSourceHanSansSC-Regular否字体。目前仅支持SourceHanSansSC-Regular 字体。width<length> | <percentage>5+0px否
...
height<length> | <percentage>5+0px否
