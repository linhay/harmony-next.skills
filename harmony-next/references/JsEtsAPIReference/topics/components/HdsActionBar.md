...
HdsActionBar({ primaryButton?: ActionBarButton, primaryButtonBuilder?: CustomBuilder, primaryButtonBuilderWidth?: LengthMetrics, startButtons?: Array<ActionBarButton>, endButtons?: Array<ActionBarButton>, actionBarStyle?: ActionBarStyle, isExpand?: boolean, $isExpand?: Callback<boolean>, blurStrategy?: [BlurStrategy](HdsNavigation.md#section1086755971212)})
...
| blurStrategy | [BlurStrategy](HdsNavigation.md#section1086755971212) | 否 | @Param | HdsActionBar的模糊生效策略。 默认值：BlurStrategy.ADAPTIVE。 |
...
| id | string | 否 | 是 | @Trace | 圆形按钮的id，用于openPopup绑定的id。 |
...
| id | string | 否 | 是 | 圆形按钮的id，用于openPopup绑定的id。 |
...
| margin | LengthMetrics | 否 | 是 | @Trace | HdsActionBar的上下边距。 起始版本： 6.1.0(23)。 |
...
| margin | LengthMetrics | 否 | 是 | HdsActionBar的上下边距。 起始版本： 6.1.0(23)。 |
