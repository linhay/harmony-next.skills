...
- 当ArcListItem配合[LazyForEach](LazyForEach.md)使用时，ArcListItem子组件在ArcListItem创建时创建。配合[if/else](../../guides/if-else：条件渲染.md)、[ForEach](ForEach.md)使用时，或父组件为[ArcList](ArcList.md)时，ArcListItem子组件在ArcListItem布局时创建。
