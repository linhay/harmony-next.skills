...
弧线。继承[BaseOverlay](../misc/BaseOverlay.md)。在调用map.[MapComponentController](MapComponentController.md)类的[addArc](MapComponentController.md#section123390488448)方法时会返回该类型的实例。
