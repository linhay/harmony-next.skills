...
[Text](../graphics/Text.md)组件的子组件，用于统一管理多个[Span](span.md)、[ImageSpan](ImageSpan.md)的背景色及圆角弧度。
...
参数名类型必填说明modifier[AttributeModifier](../misc/动态属性设置.md#ZH-CN_TOPIC_0000002529284843__attributemodifiert)<ContainerSpanAttribute>是动态设置组件的属性。
