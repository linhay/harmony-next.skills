...
提供XComponent节点XComponentNode，表示组件树中的[XComponent](XComponent.md)组件，用于[EGL](../misc/EGL.md)/[OpenGLES](../misc/OpenGL ES.md)和媒体数据写入，并支持动态修改节点渲染类型。
