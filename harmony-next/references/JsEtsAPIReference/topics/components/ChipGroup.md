...
继承自[IconOptions](#ZH-CN_TOPIC_0000002553360829__iconoptions)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| symbol | SymbolGlyphModifier | 否 | 否 | 尾部图标属性。 |
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| items | Array<IconItemOptions | SymbolGlyphModifier |  SymbolItemOptions> | 是 | @Require @Prop | 自定义builder items。 |

   ![image](public_sys-resources/note_3.0-zh-cn.webp)

传参SymbolGlyphModifier时，不支持使用symbolEffect修改动效类型和[effectStrategy](SymbolGlyph.md#ZH-CN_TOPIC_0000002522240846__effectstrategy)设置动效。
...
![image](public_sys-resources/zh-cn_image_0000002553365283.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522245360.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553205323.webp)
