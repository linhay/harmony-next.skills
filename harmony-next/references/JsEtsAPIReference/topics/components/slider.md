...
| direction8+ | [Axis](枚举说明.md#ZH-CN_TOPIC_0000002529284967__axis) | 否 | 是 | 设置滑动条滑动方向为水平或竖直方向。 默认值：Axis.Horizontal |
...
- 当Slider为水平滑动条时，默认高度为40vp，宽度为父容器的宽度，滑动条居中显示，当滑动条的style为SliderStyle.OutSet时，左右间距分别为9vp，即为[blockSize](#ZH-CN_TOPIC_0000002522080842__blocksize10)宽度的一半，当滑动条的style为SliderStyle.InSet时，左右间距分别为6vp，若设置padding，padding不会覆盖左右间距。
...
支持除触摸热区以外的[通用属性](通用属性.md)。

#### blockColor

blockColor(value: [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | 是 | 滑块的颜色。 默认值：$r('sys.color.ohos_id_color_foreground_contrary') |

#### blockColor21+

blockColor(value: [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | LinearGradient)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [LinearGradient](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10) | 是 | 滑块的颜色。 默认值：$r('sys.color.ohos_id_color_foreground_contrary') |

#### trackColor

trackColor(value: [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | LinearGradient)

设置滑轨的背景颜色。

从API version 12开始支持利用[LinearGradient](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10)设置滑轨的渐变色。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [LinearGradient12+](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10) | 是 | 滑轨的背景颜色。 默认值：$r('sys.color.ohos_id_color_component_normal') 说明： 1. 设置渐变色时，如果颜色断点颜色值为非法值或渐变色断点为空，渐变色将不起效果。 2. 该接口中的LinearGradient类型不支持在元服务中使用。 |

**trackColorMetrics23+**

trackColorMetrics(color: ColorMetrics[LinearGradient](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | ColorMetrics[LinearGradient](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10) | 是 | 滑轨轨道的线性渐变背景颜色。 设置渐变色时，如果color的值为undefined，渐变色设置无效，轨道背景颜色默认取值为：$r('sys.color.ohos_id_color_component_normal')。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | 是 | 滑轨的已滑动部分颜色。 默认值：$r('sys.color.ohos_id_color_emphasize') |

#### selectedColor18+

selectedColor(selectedColor: [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | LinearGradient)

设置滑轨的已滑动部分颜色。与[selectedColor](#ZH-CN_TOPIC_0000002522080842__selectedcolor)相比，新增了LinearGradient类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selectedColor | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | [LinearGradient](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10) | 是 | 滑轨的已滑动部分颜色。 默认值：$r('sys.color.ohos_id_color_emphasize') 说明： 设置渐变色时，若颜色断点颜色值为非法值或者渐变色断点为空时，渐变色不起效果。 |
...
showTips(value: boolean, content?: [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr))

设置滑动时是否显示气泡提示。

当direction的值为[Axis](枚举说明.md#ZH-CN_TOPIC_0000002529284967__axis).Horizontal时，tip显示在滑块上方，如果上方空间不够，则在下方显示。当值为Axis.Vertical时，tip显示在滑块左边，如果左边空间不够，则在右边显示。当不设置周边边距或者周边边距比较小时，tip会被截断。
...
| content10+ | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | 否 | 气泡提示的文本内容，默认显示当前百分比。 |

#### trackThickness8+

trackThickness(value: [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length))

设置滑轨的粗细。设置小于等于0的值时，取默认值。

为保证滑块和滑轨的[SliderStyle](#ZH-CN_TOPIC_0000002522080842__sliderstyle枚举说明)样式，[blockSize](#ZH-CN_TOPIC_0000002522080842__blocksize10)跟随trackThickness同比例增减。

当style为[SliderStyle](#ZH-CN_TOPIC_0000002522080842__sliderstyle枚举说明).OutSet时，trackThickness ：[blockSize](#ZH-CN_TOPIC_0000002522080842__blocksize10) = 1 ：4，当style为[SliderStyle](#ZH-CN_TOPIC_0000002522080842__sliderstyle枚举说明).InSet时，trackThickness ：[blockSize](#ZH-CN_TOPIC_0000002522080842__blocksize10) = 5 ：3。

trackThickness或[blockSize](#ZH-CN_TOPIC_0000002522080842__blocksize10)的大小超过Slider组件的宽度或高度时，取默认值。

当[SliderStyle](#ZH-CN_TOPIC_0000002522080842__sliderstyle枚举说明)设置为OutSet时，尽管trackThickness的大小没超过Slider组件的宽度或高度，但是[blockSize](#ZH-CN_TOPIC_0000002522080842__blocksize10)超过了，取默认值。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 是 | 滑轨的粗细。 默认值：当参数style的值设置SliderStyle.OutSet 时为 4.0vp，SliderStyle.InSet时为20.0vp。 |

#### blockBorderColor10+

blockBorderColor(value: [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | 是 | 滑块描边颜色。 默认值：'#00000000' |

#### blockBorderWidth10+

blockBorderWidth(value: [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 是 | 滑块描边粗细。 说明： 设置string类型时，不支持百分比。 |

#### stepColor10+

stepColor(value: [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor) | 是 | 刻度颜色。 默认值： $r('sys.color.ohos_id_color_foreground')混合 $r('sys.color.ohos_id_alpha_normal_bg')透明度的颜色 |

#### trackBorderRadius10+

trackBorderRadius(value: [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 是 | 底板圆角半径。 默认值： style值为SliderStyle.OutSet时默认值为'2vp'。 style值为SliderStyle.InSet时默认值为'10vp'。 说明： 设定值小于0时取默认值。 |

#### selectedBorderRadius12+

selectedBorderRadius(value: [Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | 是 | 已选择部分的圆角半径。 默认值：当style值为SliderStyle.InSet或SliderStyle.OutSet时，跟随底板圆角；当style值为SliderStyle.NONE时，为0。 说明： 不支持Percentage类型。设定值小于0时取默认值。 |

#### blockSize10+

blockSize(value: [SizeOptions](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__sizeoptions))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SizeOptions](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__sizeoptions) | 是 | 滑块大小。 默认值：当参数style的值设置为SliderStyle.OutSet时为{width: 18, height: 18}，当参数style的值设置为SliderStyle.InSet时为{width: 12, height: 12}，当参数style的值设置为SliderStyle.NONE时为，此字段不生效。 当设置的blockSize的宽高值不相等时，取较小值的尺寸，当设置的宽高值中有一个或两个都小于等于0的时候，取默认值。 |
...
stepSize(value: [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 是 | 刻度大小（直径）。 默认值：'4vp' 取值范围：[0, trackThickness) |
...
contentModifier(modifier: [ContentModifier](自定义内容.md)<SliderConfiguration>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](自定义内容.md)<SliderConfiguration> | 是 | 在Slider组件上，定制内容区的方法。 ContentModifier：内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sensitivity | [Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)[<CrownSensitivity>](枚举说明.md#ZH-CN_TOPIC_0000002529284967__crownsensitivity18) | 是 | 旋转表冠的灵敏度。 默认值：CrownSensitivity.MEDIUM |

#### prefix20+

prefix(content: [ComponentContent](../misc/ComponentContent.md), options?: SliderPrefixOptions)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../misc/ComponentContent.md) | 是 | 自定义组件内容，用于定义滑块前缀的可视化内容，该内容会显示在滑块的起始位置。 |
| options | SliderPrefixOptions | 否 | 滑块前缀的配置选项，用于设置与无障碍功能相关的属性。 |

#### suffix20+

suffix(content: [ComponentContent](../misc/ComponentContent.md), options?: SliderSuffixOptions)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../misc/ComponentContent.md) | 是 | 自定义组件内容，用于定义滑块后缀的可视化内容，该内容会显示在滑块的结束位置。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用min替代。min是[SliderOptions](#ZH-CN_TOPIC_0000002522080842__slideroptions对象说明)中的属性。
...
从API version 7开始支持，从API version 9开始废弃，建议使用max替代。max是[SliderOptions](#ZH-CN_TOPIC_0000002522080842__slideroptions对象说明)中的属性。
...
**ColorMetrics[LinearGradient](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10)23+**
...
ColorMetrics[LinearGradient](DataPanel.md#ZH-CN_TOPIC_0000002497604906__lineargradient10)的构造函数。
...
| offset | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | 否 | 否 | 线性渐变颜色断点的断点值，取值为0~1之间的比例值，如果数据值小于0则置为0，如果数据值大于1则置为1。 说明： 如果传入字符串类型且内容为数字，则转换为对应的数值。例如'10vp'转换为10，'10%'转换为0.1。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| accessibilityText | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | 否 | 是 | 用于提供辅助功能的文本，供屏幕阅读器等工具读取，增强无障碍功能。 默认值："" |
| accessibilityDescription | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | 否 | 是 | 用于提供辅助功能的详细描述，描述滑块前缀或后缀的功能或用途，供屏幕阅读器等工具使用。 默认值为“单指双击即可执行”。 |
...
提供前缀组件的无障碍信息，继承自[SliderCustomContentOptions](#ZH-CN_TOPIC_0000002522080842__slidercustomcontentoptions20)。
...
提供后缀组件的无障碍信息，继承自[SliderCustomContentOptions](#ZH-CN_TOPIC_0000002522080842__slidercustomcontentoptions20)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| text | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | 否 | 是 | 用于提供辅助功能的文本，供屏幕阅读器等工具读取，增强无障碍功能。 默认值："" |
...
| image | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr) | 否 | 是 | 设置滑块图片资源。 图片显示区域大小由blockSize属性控制，请勿输入尺寸过大的图片。 |
| shape | [Circle](../misc/circle.md) | [Ellipse](../misc/Ellipse.md) | [Path](../misc/path.md) | Rect | 否 | 是 | 设置滑块使用的自定义形状。 |
...
![image](public_sys-resources/zh-cn_image_0000002522244990.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553204951.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522084998.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553364913.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522244992.webp)

#### 示例6（滑动条设置刻度点无障碍文本）

该示例实现了Slider组件通过[showSteps](#ZH-CN_TOPIC_0000002522080842__showsteps20)属性设置刻度点的无障碍文本信息。设置后，屏幕阅读器将以设置的无障碍内容进行朗读。从API version 20开始，新增[showSteps](#ZH-CN_TOPIC_0000002522080842__showsteps20)属性。
...
![image](public_sys-resources/zh-cn_image_0000002553204953.webp)
...
![image](public_sys-resources/zh-cn_image_0000002522085000.webp)
...
![image](public_sys-resources/zh-cn_image_0000002553364915.webp)

**示例9（设置滑轨的背景颜色）**

该示例通过[trackColorMetrics](#ZH-CN_TOPIC_0000002522080842__trackcolormetrics23)设置指定色域的渐变断点值，包括偏移和颜色。示例中的colorSpace使用了ColorSpace.DISPLAY_P3类型，需要对应窗口调用setWindowColorSpace接口，将当前窗口设置为广色域模式，设置窗口色域模式为广色域参照方法[setWindowColorSpace](Interface (Window).md#ZH-CN_TOPIC_0000002522080752__setwindowcolorspace9)。
...
![image](public_sys-resources/zh-cn_image_0000002522244994.webp)
