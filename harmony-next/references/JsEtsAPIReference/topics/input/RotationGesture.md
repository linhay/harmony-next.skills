...
继承自[GestureInterface<T>](../misc/手势公共接口.md#ZH-CN_TOPIC_0000002497604864__gestureinterfacet11)，设置旋转手势事件。
...
参数名类型必填说明options[RotationGestureHandlerOptions](../misc/手势处理器.md#ZH-CN_TOPIC_0000002497604858__rotationgesturehandleroptions)否旋转手势处理器配置参数。
