...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| InputEvent_AxisType | InputEvent_AxisType | 输入设备的轴类型。 |
| InputEvent_AxisEventType | InputEvent_AxisEventType | 输入设备的轴事件类型。 |
| InputEvent_AxisAction | InputEvent_AxisAction | 轴事件动作。 |
