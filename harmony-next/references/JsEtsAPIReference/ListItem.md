...
设置当前ListItem选中状态。该属性支持[$$](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-two-way-sync)双向绑定变量。该属性需要在设置[选中态样式](zh-cn_topic_0000002497604846.md)前使用才能生效选中态样式。
...
名称类型只读可选说明start[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8) | [SwipeActionItem](#ZH-CN_TOPIC_0000002529444837__swipeactionitem10对象说明)否是

ListItem向右划动时item左边的组件（List垂直布局时）或ListItem向下划动时item上方的组件（List水平布局时）。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

end[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8) | [SwipeActionItem](#ZH-CN_TOPIC_0000002529444837__swipeactionitem10对象说明)否是
...
名称类型只读可选说明actionAreaDistance[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是
