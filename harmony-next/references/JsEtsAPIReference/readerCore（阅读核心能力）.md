...
书脊内容节点索引[SpineItem](bookParser（书籍解析能力）.md#section1029864651619).index。
...
[ReadPageComponent](ReadPageComponent（阅读页组件）.md#section3730195311450)组件控制器，需要配合ReadPageComponent组件一起使用。
...
[1016910004](ArkTS API错误码.md#section11556619102)
...
bookParser.[BookParserHandler](bookParser（书籍解析能力）.md#section59035422210)
...
[1016900002](ArkTS API错误码.md#section174762013118)

Read Page Component is not initialized.

[1016900003](ArkTS API错误码.md#section16343120935)

Invalid request.

[1016900999](ArkTS API错误码.md#section14689171516514)
...
内容资源索引[SpineItem](bookParser（书籍解析能力）.md#section1029864651619).index。
...
[1016910001](ArkTS API错误码.md#section13763141364)

Invalid spine item.

[1016910002](ArkTS API错误码.md#section15116730175)

Unexpected spine item resource data.

[1016910003](ArkTS API错误码.md#section216871194)
...
触发[ReadPageComponent](ReadPageComponent（阅读页组件）.md#section3730195311450)组件进行翻页。
...
bookParser.[CallbackRes](bookParser（书籍解析能力）.md#section174676520576)<string, ArrayBuffer>
