...
为指定的浏览器设置浏览器策略，成功后会发布系统公共事件[COMMON_EVENT_MANAGED_BROWSER_POLICY_CHANGED](系统定义的公共事件.md#ZH-CN_TOPIC_0000002497605510__common_event_managed_browser_policy_changed)。
