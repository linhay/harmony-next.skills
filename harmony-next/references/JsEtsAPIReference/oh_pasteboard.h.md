...
**相关模块：**[Pasteboard](Pasteboard.md)

#### 汇总

#### 结构体

名称typedef关键字描述[Pasteboard_ProgressInfo](Pasteboard_ProgressInfo.md)Pasteboard_ProgressInfo定义进度上报的数据结构。[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)Pasteboard_GetDataParams表示从剪贴板获取粘贴数据和进度时需要写入的参数。[OH_PasteboardObserver](OH_PasteboardObserver.md)OH_PasteboardObserver定义剪贴板数据变更观察者。[OH_Pasteboard](OH_Pasteboard.md)OH_Pasteboard定义剪贴板对象，用以操作系统剪贴板。
...
名称typedef关键字描述[typedef void (*OH_Pasteboard_ProgressListener)(Pasteboard_ProgressInfo* progressInfo)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_progresslistener)OH_Pasteboard_ProgressListener用于在不使用系统默认进度显示时，通知应用拷贝粘贴任务进度。[typedef void (*Pasteboard_Notify)(void* context, Pasteboard_NotifyType type)](#ZH-CN_TOPIC_0000002497445552__pasteboard_notify)Pasteboard_Notify定义剪贴板内容变更时触发的回调函数。[typedef void (*Pasteboard_Finalize)(void* context)](#ZH-CN_TOPIC_0000002497445552__pasteboard_finalize)Pasteboard_Finalize定义用于释放上下文的回调函数，剪贴板数据变更观察者对象销毁时触发。[OH_PasteboardObserver* OH_PasteboardObserver_Create()](#ZH-CN_TOPIC_0000002497445552__oh_pasteboardobserver_create)-创建一个剪贴板数据变更观察者[OH_PasteboardObserver](zh-cn_topic_0000002529285529.html)指针及实例对象。[int OH_PasteboardObserver_Destroy(OH_PasteboardObserver* observer)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboardobserver_destroy)-销毁剪贴板数据变更观察者[OH_PasteboardObserver](zh-cn_topic_0000002529285529.html)指针指向的实例对象。[int OH_PasteboardObserver_SetData(OH_PasteboardObserver* observer, void* context,const Pasteboard_Notify callback, const Pasteboard_Finalize finalize)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboardobserver_setdata)-向剪贴板数据变更观察者设置回调函数。[OH_Pasteboard* OH_Pasteboard_Create()](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_create)-创建剪贴板[OH_Pasteboard](zh-cn_topic_0000002529445503.html)指针及实例对象。[void OH_Pasteboard_Destroy(OH_Pasteboard* pasteboard)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_destroy)-销毁剪贴板[OH_Pasteboard](zh-cn_topic_0000002529445503.html)实例对象。[int OH_Pasteboard_Subscribe(OH_Pasteboard* pasteboard, int type, const OH_PasteboardObserver* observer)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_subscribe)-订阅剪贴板的数据变更事件。[int OH_Pasteboard_Unsubscribe(OH_Pasteboard* pasteboard, int type, const OH_PasteboardObserver* observer)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_unsubscribe)-取消对剪贴板数据变更事件的订阅。[bool OH_Pasteboard_IsRemoteData(OH_Pasteboard* pasteboard)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_isremotedata)-判断剪贴板中的数据是否来自远端设备。[int OH_Pasteboard_GetDataSource(OH_Pasteboard* pasteboard, char* source, unsigned int len)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdatasource)-获取剪贴板中数据的数据源。[bool OH_Pasteboard_HasType(OH_Pasteboard* pasteboard, const char* type)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_hastype)-判断剪贴板中是否有指定类型的数据。[bool OH_Pasteboard_HasData(OH_Pasteboard* pasteboard)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_hasdata)-判断剪贴板中是否有数据。[OH_UdmfData* OH_Pasteboard_GetData(OH_Pasteboard* pasteboard, int* status)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdata)-获取剪贴板中的数据。[int OH_Pasteboard_SetData(OH_Pasteboard* pasteboard, OH_UdmfData* data)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_setdata)-将统一数据对象数据写入剪贴板。[int OH_Pasteboard_ClearData(OH_Pasteboard* pasteboard)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_cleardata)-清空剪贴板中的数据。[char **OH_Pasteboard_GetMimeTypes(OH_Pasteboard *pasteboard, unsigned int *count)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getmimetypes)-获取剪贴板中的MIME类型。[Pasteboard_GetDataParams *OH_Pasteboard_GetDataParams_Create(void)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdataparams_create)-创建剪贴板[Pasteboard_GetDataParams](zh-cn_topic_0000002497445558.html)指针及实例对象。[void OH_Pasteboard_GetDataParams_Destroy(Pasteboard_GetDataParams* params)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdataparams_destroy)-销毁剪贴板[Pasteboard_GetDataParams](zh-cn_topic_0000002497445558.html)指针指向的实例对象。[void OH_Pasteboard_GetDataParams_SetProgressIndicator(Pasteboard_GetDataParams* params,Pasteboard_ProgressIndicator progressIndicator)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdataparams_setprogressindicator)-向剪贴板[Pasteboard_GetDataParams](zh-cn_topic_0000002497445558.html)设置进度条指示选项，可选择是否采用系统默认进度显示。[void OH_Pasteboard_GetDataParams_SetDestUri(Pasteboard_GetDataParams* params, const char* destUri, uint32_t destUriLen)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdataparams_setdesturi)-向剪贴板[Pasteboard_GetDataParams](zh-cn_topic_0000002497445558.html)设置拷贝文件时目标路径。若不支持文件处理，则不需要设置此参数；若应用涉及复杂文件处理策略或需要区分文件多路径存储，建议不设置此参数，由应用自行完成文件copy处理。[void OH_Pasteboard_GetDataParams_SetFileConflictOptions(Pasteboard_GetDataParams* params,Pasteboard_FileConflictOptions option)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdataparams_setfileconflictoptions)-向剪贴板[Pasteboard_GetDataParams](zh-cn_topic_0000002497445558.html)设置文件冲突选项。[void OH_Pasteboard_GetDataParams_SetProgressListener(Pasteboard_GetDataParams* params,const OH_Pasteboard_ProgressListener listener)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdataparams_setprogresslistener)-向剪贴板[Pasteboard_GetDataParams](zh-cn_topic_0000002497445558.html)设置进度上报回调函数。[int OH_Pasteboard_ProgressInfo_GetProgress(Pasteboard_ProgressInfo* progressInfo)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_progressinfo_getprogress)-从[Pasteboard_ProgressInfo](zh-cn_topic_0000002497605536.html)获取粘贴进度。[void OH_Pasteboard_ProgressCancel(Pasteboard_GetDataParams* params)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_progresscancel)-定义取消函数，用于在获取粘贴数据时取消正在进行的粘贴动作。[OH_UdmfData* OH_Pasteboard_GetDataWithProgress(OH_Pasteboard* pasteboard, Pasteboard_GetDataParams* params,int* status)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getdatawithprogress)-获取剪贴板的数据以及粘贴进度，不支持对文件夹的拷贝。[uint32_t OH_Pasteboard_GetChangeCount(OH_Pasteboard *pasteboard)](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_getchangecount)-获取剪贴板内容的变化次数。[void OH_Pasteboard_SyncDelayedDataAsync(OH_Pasteboard* pasteboard, void (*callback)(int errorCode))](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_syncdelayeddataasync)-通知剪贴板从应用同步所有延迟数据，与延迟复制接口[OH_UdmfRecordProvider_SetData](zh-cn_topic_0000002497444728.html#ZH-CN_TOPIC_0000002497444728__oh_udmfrecordprovider_setdata)搭配使用。当应用使用延迟复制功能复制时，仅将应用支持的数据类型写入剪贴板。应用应在退出时，重新调用[OH_Pasteboard_SetData](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_setdata)接口主动提交所有复制数据或调用此接口通知剪贴板获取全量数据，等待数据同步完成再继续退出，否则可能导致其他应用粘贴获取不到数据。
...
参数项描述[Pasteboard_ProgressInfo](Pasteboard_ProgressInfo.md)* progressInfo定义进度上报的数据结构，且仅当进度指示选项[Pasteboard_ProgressInfo](Pasteboard_ProgressInfo.md)设置为NONE时才会上报此信息。
...
创建一个剪贴板数据变更观察者[OH_PasteboardObserver](OH_PasteboardObserver.md)指针及实例对象。

**起始版本：** 13

**返回：**

类型说明[OH_PasteboardObserver](OH_PasteboardObserver.md)*

执行成功时返回一个指向剪贴板数据变更观察者[OH_PasteboardObserver](OH_PasteboardObserver.md)实例对象的指针，否则返回空指针。
...
销毁剪贴板数据变更观察者[OH_PasteboardObserver](OH_PasteboardObserver.md)指针指向的实例对象。

**起始版本：** 13

**参数：**

参数项描述[OH_PasteboardObserver](OH_PasteboardObserver.md)* observer表示指向剪贴板数据变更观察者[OH_PasteboardObserver](OH_PasteboardObserver.md)实例的指针。
...
创建剪贴板[OH_Pasteboard](OH_Pasteboard.md)指针及实例对象。

**起始版本：** 13

**返回：**

类型说明[OH_Pasteboard](OH_Pasteboard.md)*执行成功则返回一个指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例对象的指针，否则返回nullptr。
...
销毁剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例对象。

**起始版本：** 13

**参数：**

参数项描述[OH_Pasteboard](OH_Pasteboard.md)* pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md)* pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。int type表示订阅的剪贴板数据变更类型，详见：[Pasteboard_NotifyType](oh_pasteboard.h.md#ZH-CN_TOPIC_0000002497445552__pasteboard_notifytype)。const [OH_PasteboardObserver](OH_PasteboardObserver.md)* observer表示指向剪贴板数据变更观察者[OH_PasteboardObserver](OH_PasteboardObserver.md)实例的指针。它指定了剪贴板数据变更时触发的回调函数，详见：[OH_PasteboardObserver](OH_PasteboardObserver.md)。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md)* pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。char* source表示用于存放剪贴板数据源实例的指针，开发者需在调用接口前申请指针指向的内存。unsigned int len表示source指针对应的内存长度，当内存长度不足时调用接口会失败，建议长度：128。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md)* pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。const char* type表示要检查的数据类型。包含剪贴板基础数据类型与自定义数据类型，其中剪贴板基础数据类型有："text/plain"、"text/html"、"text/uri"、"text/want"和"pixelMap"。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md)* pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。int* status该参数是输出参数，表示执行的错误码。错误码定义详见[PASTEBOARD_ErrCode](oh_pasteboard_err_code.h.md#ZH-CN_TOPIC_0000002529285523__pasteboard_errcode)。

**返回：**

类型说明[OH_UdmfData](OH_UdmfData.md)*执行成功时返回统一数据对象[OH_UdmfData](OH_UdmfData.md)实例的指针。否则返回空指针。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md)* pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。[OH_UdmfData](OH_UdmfData.md)* data表示指向统一数据对象[OH_UdmfData](OH_UdmfData.md)实例的指针。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md) *pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。unsigned int *count该参数是输出参数，结果集中的类型数量会写入该变量。
...
创建剪贴板[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)指针及实例对象。

**起始版本：** 15

**返回：**

类型说明[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)

执行成功时返回一个指向剪贴板[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)实例对象的指针，否则返回空指针。
...
销毁剪贴板[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)指针指向的实例对象。

**起始版本：** 15

**参数：**

参数项描述[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)* params表示指向剪贴板OH_Pasteboard_GetDataParams的指针。
...
向剪贴板[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)设置进度条指示选项，可选择是否采用系统默认进度显示。

**起始版本：** 15

**参数：**

参数项描述[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)* params表示指向剪贴板OH_Pasteboard_GetDataParams的指针。[Pasteboard_ProgressIndicator](#ZH-CN_TOPIC_0000002497445552__pasteboard_progressindicator) progressIndicator定义进度条指示选项。
...
参数项描述[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)* params表示指向剪贴板OH_Pasteboard_GetDataParams的指针。const char* destUri定义拷贝文件目标路径。uint32_t destUriLen定义拷贝文件目标路径长度。
...
向剪贴板[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)设置文件冲突选项。

**起始版本：** 15

**参数：**

参数项描述[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)* params表示指向剪贴板OH_Pasteboard_GetDataParams的指针。[Pasteboard_FileConflictOptions](#ZH-CN_TOPIC_0000002497445552__pasteboard_fileconflictoptions) option定义文件拷贝冲突时的选项，默认为PASTEBOARD_OVERWRITE。
...
向剪贴板[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)设置进度上报回调函数。

**起始版本：** 15

**参数：**

参数项描述[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)* params表示指向剪贴板OH_Pasteboard_GetDataParams的指针。const [OH_Pasteboard_ProgressListener](#ZH-CN_TOPIC_0000002497445552__oh_pasteboard_progresslistener) listener表示进度上报回调函数。
...
从[Pasteboard_ProgressInfo](Pasteboard_ProgressInfo.md)获取粘贴进度。

**起始版本：** 15

**参数：**

参数项描述[Pasteboard_ProgressInfo](Pasteboard_ProgressInfo.md)* progressInfo表示指向剪贴板[Pasteboard_ProgressInfo](Pasteboard_ProgressInfo.md)的指针。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md)* pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。[Pasteboard_GetDataParams](Pasteboard_GetDataParams.md)* params表示指向剪贴板OH_Pasteboard_GetDataParams的指针。int* status该参数是输出参数，表示执行的错误码。错误码定义详见[PASTEBOARD_ErrCode](oh_pasteboard_err_code.h.md#ZH-CN_TOPIC_0000002529285523__pasteboard_errcode)。

**返回：**

类型说明[OH_UdmfData](OH_UdmfData.md)*执行成功时返回统一数据对象OH_PasteData实例的指针。否则返回空指针。
...
参数项描述[OH_Pasteboard](OH_Pasteboard.md) *pasteboard表示指向剪贴板[OH_Pasteboard](OH_Pasteboard.md)实例的指针。void (*callback)(int errorCode)数据同步完成后调用的回调函数指针，errorCode表示同步任务的结果，错误码定义详见[PASTEBOARD_ErrCode](oh_pasteboard_err_code.h.md#ZH-CN_TOPIC_0000002529285523__pasteboard_errcode)。