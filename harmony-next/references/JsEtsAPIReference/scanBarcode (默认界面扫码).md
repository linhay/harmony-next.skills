...
scanCore.[ScanSource](scanCore (扫码公共信息).md#section152115548134)
...
自定义界面扫码返回的坐标单位与传入参数[ViewControl](customScan (自定义界面扫码).md#section8604949165313)中width、height单位一致。
...
Array<scanCore.[ScanType](scanCore (扫码公共信息).md#section113371139123212)>
