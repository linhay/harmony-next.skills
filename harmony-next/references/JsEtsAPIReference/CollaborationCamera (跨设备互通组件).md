...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[createCollaborationServiceMenuItems](CollaborationService (跨设备互通组件).md#section1633482912443)替代。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[CollaborationServiceFilter](CollaborationService (跨设备互通组件).md#section12639651397)替代。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[CollaborationServiceStateDialog](CollaborationService (跨设备互通组件).md#section158671330145417)替代。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[onState](CollaborationService (跨设备互通组件).md#section33027582114)替代。
...
**废弃说明：**从5.0.0(12) 开始废弃，建议使用[build](CollaborationService (跨设备互通组件).md#section41032414617)替代。
