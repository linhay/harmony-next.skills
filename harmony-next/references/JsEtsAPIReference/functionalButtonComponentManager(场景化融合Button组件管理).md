...
[CredentialType](#section881533513510)
...
[HoverClassType](#section163586294246)
...
[ButtonConfig](#section8718135610381)
...
当styleConfig和[StyleOption](#section1554712981118)中定义的样式冲突时，最终以styleConfig的为准。
...
[StyleOption](#section1554712981118)
...
[RealNameAuthenticationInfo](#section19784874147)
...
[SubscribeLiveViewParam](#section178853283132)
...
[ButtonModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-modifier#自定义modifier)
...
[LoadingProgressModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-modifier#自定义modifier)
...
可通过临时登录凭证获取真实手机号，临时登录凭证时效5分钟，具体操作可参考“[服务端开发](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/account-get-phonenumber#section380015370555)”章节。
...
**设备行为差异：**该接口在Phone、Tablet中可正常调用，在其他设备类型中返回1001500003错误码。
...
1. 参数不能为空。
1. 0<=startTime-alertTime。
1. startTime和alertTime晚于当前时间。
1. startTime-alertTime <= 3600000(可在push侧配置)。
...
Array<abilityAccessCtrl.[GrantStatus](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#grantstatus)>
...
**设备行为差异：**该接口在Phone、Tablet、2in1、TV中可正常调用，在其他设备类型中返回801错误码。
...
AsyncCallback<[GetPhoneNumberResult](#section593445861420)>
...
[FunctionalButtonController](#section942719311715)

[FunctionalButton](FunctionalButton（Button组件）.md#section1753203873911)组件控制器。
...
AsyncCallback<[GetRealtimePhoneNumberResult](#section1617620229162)>
...
AsyncCallback<[OpenSettingResult](#section750885218179)>
...
AsyncCallback<[ChooseAvatarResult](#section129411307195)>
...
AsyncCallback<[ChooseAddressResult](#section176651720152015)>
...
AsyncCallback<[ChooseInvoiceTitleResult](#section14091035153411)>
...
AsyncCallback<[RealNameAuthenticationResult](#section446611264318)>
...
AsyncCallback<[FaceAuthenticationResult](#section955010367519)>
...
AsyncCallback<[FaceVerificationResult](#section10953282537)>
...
AsyncCallback<[ChooseLocationResult](#section1621025974410)>
...
AsyncCallback<[SubscribeLiveViewResult](#section2060311821615)>
...
AsyncCallback<[PermissionSettingResult](#section1624725342)>
...
该接口在元服务中可正常使用，在其他场景中返回10006、10008错误码。
...
AsyncCallback<[RequestSubscribeMessageResult](#section2076213310277)>
...
Callback<[GetPhoneNumberAndRiskLevelResult](#section1611417519399)>
...
[ButtonType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttontype枚举说明)
...
[FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#fontstyle)
...
string | [Resource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#ZH-CN_TOPIC_0000001930676685__resource)

是

设置字体列表。默认字体'HarmonyOS Sans'，当前支持'[HarmonyOS Sans](https://developer.huawei.com/consumer/cn/doc/design-guides/font-0000001828772001#section51091561209)'字体和[注册自定义字体](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-font)。
...
[ConstraintSizeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#constraintsizeoptions)
...
[Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | [Padding](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#padding)
...
[ImageRepeat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#imagerepeat)
...
[SizeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#sizeoptions) | [ImageSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#imagesize)
...
[Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#position) | [Alignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#alignment)
...
number | [Resource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#ZH-CN_TOPIC_0000001930676685__resource)
...
[BorderStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#borderstyle) | [EdgeStyles](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#edgestyles9)
...
[Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | [EdgeWidths](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#edgewidths9)
...
[ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | [EdgeColors](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#edgecolors9)
...
[Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | [BorderRadiuses](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#borderradiuses9)
...
[ScaleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#scaleoptions对象说明)
...
[Alignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#alignment)
...
[Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#position)
...
[LoadingProgress](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-loadingprogress)图标始终保持正方形，在显示时边长会取loadingWidth和[loadingHeight](#section08531112317)中的最小值。
...
[LoadingProgress](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-loadingprogress)图标始终保持正方形，在显示时边长会取[loadingWidth](#section1804853172119)和loadingHeight中的最小值。
