...
类型说明[Filter](@ohos.graphics.uiEffect (效果级联).md#ZH-CN_TOPIC_0000002497446008__filter)用于将相应的效果添加到指定的组件上。
...
类型说明[VisualEffect](@ohos.graphics.uiEffect (效果级联).md#ZH-CN_TOPIC_0000002497446008__visualeffect)用于将相应的效果添加到指定的组件上。
