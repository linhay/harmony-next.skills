...
[CallerInfoQueryExtensionContext](CallerInfoQueryExtensionContext (来去电信息查询扩展Context).md)

否

否

[CallerInfoQueryExtensionContext](CallerInfoQueryExtensionContext (来去电信息查询扩展Context).md#section414112373819)的上下文环境，继承自[ExtensionContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-extensioncontext)。
