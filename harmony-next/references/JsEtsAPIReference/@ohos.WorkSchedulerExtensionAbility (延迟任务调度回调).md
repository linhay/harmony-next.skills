...
类型说明[_WorkSchedulerExtensionContext](WorkSchedulerExtensionContext.md)WorkSchedulerExtension的上下文环境。
...
名称类型只读可选说明context10+[WorkSchedulerExtensionContext](WorkSchedulerExtensionContext.md)否否WorkSchedulerExtension的上下文环境，继承自ExtensionContext。
