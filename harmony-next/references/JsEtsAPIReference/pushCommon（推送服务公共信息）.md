...
应用可以通过[receiveMessage](pushService（推送服务基础能力）.md#section125883044911)()获取场景化消息数据的参数定义。
...
- type为 'ALERT'时，无需额外配置data字段：  notification完整字段参考AlertPayload 通知消息中 [Notification](请求体参数说明.md#section17371529101117)结构体。
...
继承自[PushPayload](#section16335431712)，表示传递给[RemoteNotificationExtensionAbility](zh-cn_topic_0000002402225713.html)的消息类型。
...
继承自[PushPayload](#section16335431712)，表示传递给[RemoteNotificationExtensionAbility](zh-cn_topic_0000002402225713.html)的数据。
...
继承自[PushPayload](#section16335431712)，表示传递给[VoIPExtensionAbility](zh-cn_topic_0000002402305833.html)的消息类型。
...
继承自[PushPayload](#section16335431712)，表示传递给[VoIPExtensionAbility](zh-cn_topic_0000002402305833.html)的数据。