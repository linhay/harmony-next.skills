...
参数名类型必填说明value[RichEditorOptions](#ZH-CN_TOPIC_0000002497604894__richeditoroptions)是富文本组件初始化选项。
...
参数名类型必填说明options[RichEditorStyledStringOptions](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringoptions12)是富文本组件初始化选项。
...
- 不支持[borderImage](图片边框设置.md#ZH-CN_TOPIC_0000002497444854__borderimage)属性。
...
参数名类型必填说明value[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是自定义键盘。options12+[KeyboardOptions](#ZH-CN_TOPIC_0000002497604894__keyboardoptions12)否设置自定义键盘是否支持避让功能。
...
设置自定义选择菜单。自定义菜单超长时，建议内部嵌套[Scroll](Scroll.md)组件使用，避免键盘被遮挡。
...
参数名类型必填说明spanType[RichEditorSpanType](#ZH-CN_TOPIC_0000002497604894__richeditorspantype)是
...
content[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是菜单的内容。responseType[ResponseType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__responsetype8) | [RichEditorResponseType](#ZH-CN_TOPIC_0000002497604894__richeditorresponsetype11)是
...
options[SelectionMenuOptions](#ZH-CN_TOPIC_0000002497604894__selectionmenuoptions)否菜单的选项。
...
设置RichEditor组件的属性字符串时，请参考属性字符串[toHtml](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string14)接口文档，以了解支持转换为HTML的范围。
...
参数名类型必填说明value[CopyOptions](枚举说明.md#ZH-CN_TOPIC_0000002529284967__copyoptions9)是
...
当enableDataDetector设置为true且未指定[dataDetectorConfig](#ZH-CN_TOPIC_0000002497604894__datadetectorconfig11)属性时，系统将默认识别所有类型的实体，并将这些实体的color和decoration更改为预设样式：
...
当enableDataDetector设置为true，并且[copyOptions](#ZH-CN_TOPIC_0000002497604894__copyoptions)设置为CopyOptions.LocalDevice或CopyOptions.CROSS_DEVICE，组件在非编辑态选中内容，选中区包含单个AI实体时，根据AI实体的类型，在文本选择菜单中显示AI菜单选项。

AI菜单选项包括[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)中的url（打开链接）、email（新建邮件）、phoneNumber（呼叫）、address（导航至该位置）、dateTime（新建日程提醒）。

从API version 20开始，组件文本选择菜单支持显示问问小艺。

组件在编辑态下，[copyOptions](#ZH-CN_TOPIC_0000002497604894__copyoptions)设置为CopyOptions.LocalDevice或CopyOptions.CROSS_DEVICE，组件内选中任意文本内容时，文本选择菜单与鼠标右键菜单中都可以显示问问小艺选项。组件在非编辑态下，enableDataDetector设置为true，并且[copyOptions](#ZH-CN_TOPIC_0000002497604894__copyoptions)设置为CopyOptions.LocalDevice或CopyOptions.CROSS_DEVICE，组件内选中文本，文本选择菜单与鼠标右键菜单中不显示其他AI菜单时，显示问问小艺选项。
...
需配合[enableDataDetector](#ZH-CN_TOPIC_0000002497604894__enabledatadetector11)一起使用，设置enableDataDetector为true时，dataDetectorConfig的配置才能生效。
...
参数名类型必填说明config[TextDataDetectorConfig](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textdatadetectorconfig11对象说明)是文本识别配置。
...
AI菜单功能启用时，在组件中选中文本后，文本选择菜单能够展示对应的AI菜单项，包括[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)中的url（打开连接）、email（新建邮件）、phoneNumber（呼叫）、address（导航前往）、dateTime（新建日程）。

AI菜单生效时，选中范围内需包括且仅包括一个完整的AI实体，才能展示对应的选项。该菜单项与[TextMenuItemId](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textmenuitemid12)中的askAI菜单项不同时出现。

本功能仅在[copyOptions](#ZH-CN_TOPIC_0000002497604894__copyoptions)为CopyOptions.LocalDevice或CopyOptions.CROSS_DEVICE时生效。
...
参数名类型必填说明value[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是无输入时的提示文本。style[PlaceholderStyle](#ZH-CN_TOPIC_0000002497604894__placeholderstyle12)否
...
调用[disableMenuItems](Class (TextMenuController).md#ZH-CN_TOPIC_0000002529284775__disablemenuitems20)或[disableSystemServiceMenuItems](Class (TextMenuController).md#ZH-CN_TOPIC_0000002529284775__disablesystemservicemenuitems20)接口屏蔽文本选择菜单内的系统服务菜单项时，editMenuOptions接口内回调方法[onCreateMenu](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__oncreatemenu12)的入参列表中不包含被屏蔽的菜单选项。
...
参数名类型必填说明editMenu[EditMenuOptions](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__editmenuoptions)是扩展菜单选项。
...
参数名类型必填说明value[EnterKeyType](TextInput.md#ZH-CN_TOPIC_0000002529444859__enterkeytype枚举说明)是
...
参数名类型必填说明state[BarState](枚举说明.md#ZH-CN_TOPIC_0000002529284967__barstate)是
...
参数名类型必填说明maxLength[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<number>是
...
参数名类型必填说明maxLines[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<number>是
...
参数名类型必填说明appearance[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[KeyboardAppearance](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__keyboardappearance15枚举说明)>是
...
参数名类型必填说明isStopped[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<boolean>是
...
使用[RichEditorStyledStringOptions](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringoptions12)构建RichEditor组件时，撤销还原时默认保留原内容样式，不受该接口设置的属性影响。
...
参数名类型必填说明style[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[UndoStyle](#ZH-CN_TOPIC_0000002497604894__undostyle20-1)>是撤销还原是否保留原样式选项。默认值：UndoStyle.CLEAR_STYLE
...
除支持[通用事件](通用事件.md)外，还支持[OnDidChangeCallback](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__ondidchangecallback12)、[StyledStringChangedListener](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__styledstringchangedlistener12)、[StyledStringChangeValue](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__styledstringchangevalue12)和以下事件：
...
参数名类型必填说明callbackCallback<void>是订阅富文本组件初始化完成的回调。

#### onSelect

onSelect(callback:Callback<[RichEditorSelection](#ZH-CN_TOPIC_0000002497604894__richeditorselection)>)
...
需要实时感知选中区变化的场景和使用[RichEditorStyledStringOptions](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringoptions12)构建的RichEditor组件，请使用onSelectionChange接口。
...
参数名类型必填说明callbackCallback<[RichEditorSelection](#ZH-CN_TOPIC_0000002497604894__richeditorselection)>是

[RichEditorSelection](#ZH-CN_TOPIC_0000002497604894__richeditorselection)为选中的所有span信息。

选择时触发的回调。

#### aboutToIMEInput

aboutToIMEInput(callback:Callback<[RichEditorInsertValue](#ZH-CN_TOPIC_0000002497604894__richeditorinsertvalue), boolean>)

输入法输入内容前触发回调。

使用[RichEditorStyledStringOptions](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringoptions12)构建的RichEditor组件不支持该回调。
...
参数名类型必填说明callbackCallback<[RichEditorInsertValue](#ZH-CN_TOPIC_0000002497604894__richeditorinsertvalue), boolean>是

[RichEditorInsertValue](#ZH-CN_TOPIC_0000002497604894__richeditorinsertvalue)为输入法将要输入内容信息。
...
参数名类型必填说明callbackCallback<[TextRange](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textrange12)>是
...
onIMEInputComplete(callback:Callback<[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult)>)

输入法输入完成后，触发回调。

该接口仅支持返回一个文本span的信息，当编辑操作涉及返回多个文本span信息时，建议使用[onDidIMEInput](#ZH-CN_TOPIC_0000002497604894__ondidimeinput12)接口。
...
参数名类型必填说明callbackCallback<[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult)>是

[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult)为输入法完成输入后的文本Span信息。

输入法完成输入后的回调。

#### aboutToDelete

aboutToDelete(callback:Callback<[RichEditorDeleteValue](#ZH-CN_TOPIC_0000002497604894__richeditordeletevalue), boolean>)
...
参数名类型必填说明callbackCallback<[RichEditorDeleteValue](#ZH-CN_TOPIC_0000002497604894__richeditordeletevalue), boolean>是

[RichEditorDeleteValue](#ZH-CN_TOPIC_0000002497604894__richeditordeletevalue)为准备删除的内容所在的文本或者图片Span信息。
...
参数名类型必填说明callbackCallback<void>是订阅输入法完成删除内容的回调。

#### onPaste11+

onPaste(callback: [PasteEventCallback](#ZH-CN_TOPIC_0000002497604894__pasteeventcallback12) )
...
参数名类型必填说明callback[PasteEventCallback](#ZH-CN_TOPIC_0000002497604894__pasteeventcallback12)是订阅粘贴时的回调。

#### onSelectionChange12+

onSelectionChange(callback:Callback<[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)>)
...
参数名类型必填说明callbackCallback<[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)>是

[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)为所有内容的选择区域起始和终止位置。
...
参数名类型必填说明callbackCallback<boolean>是true表示编辑态，false表示非编辑态。
...
参数名类型必填说明callback[SubmitCallback](#ZH-CN_TOPIC_0000002497604894__submitcallback12)是订阅事件的回调。

#### onWillChange12+

onWillChange(callback: Callback<[RichEditorChangeValue](#ZH-CN_TOPIC_0000002497604894__richeditorchangevalue12) , boolean>)
...
参数名类型必填说明callbackCallback<[RichEditorChangeValue](#ZH-CN_TOPIC_0000002497604894__richeditorchangevalue12) , boolean>是[RichEditorChangeValue](#ZH-CN_TOPIC_0000002497604894__richeditorchangevalue12)为图文变化信息；boolean表示当前图文是否允许被更改，true：允许图文被更改；false：不允许图文被更改。
...
参数名类型必填说明callback[OnDidChangeCallback](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__ondidchangecallback12)是图文变化前后的内容范围。
...
使用[RichEditorStyledStringOptions](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringoptions12)构建的RichEditor组件，默认支持图文的剪切。
...
参数名类型必填说明callbackCallback<[CutEvent](#ZH-CN_TOPIC_0000002497604894__cutevent12)>是定义用户剪切事件。
...
使用[RichEditorStyledStringOptions](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringoptions12)构建的RichEditor组件，默认支持图文的复制。
...
参数名类型必填说明callbackCallback<[CopyEvent](#ZH-CN_TOPIC_0000002497604894__copyevent12)>是定义用户复制事件。
...
调用[IMEClient](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__imeclient20对象说明)的[setExtraConfig](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__setextraconfig22)方法设置输入法扩展信息。在绑定输入法成功后，输入法会收到扩展信息，输入法可以依据此信息实现自定义功能。
...
参数名类型必填说明callbackCallback<[IMEClient](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__imeclient20对象说明)> | undefined是
...
名称类型只读可选说明insertOffsetnumber否否
...
名称类型只读可选说明offsetnumber否否删除内容的偏移位置。direction[RichEditorDeleteDirection](#ZH-CN_TOPIC_0000002497604894__richeditordeletedirection)否否删除操作的方向。lengthnumber否否删除内容长度。richEditorDeleteSpansArray<[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult) | [RichEditorImageSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanresult)>否否删除的文本或图片Span的信息。
...
名称类型只读可选说明spanPosition[RichEditorSpanPosition](#ZH-CN_TOPIC_0000002497604894__richeditorspanposition)否否
...
textStyle[RichEditorTextStyleResult](#ZH-CN_TOPIC_0000002497604894__richeditortextstyleresult)否否

文本Span样式信息。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

offsetInSpan[number, number]否否

文本Span内容里有效内容的起始和结束位置。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

valueResource11+[Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是

组件SymbolSpan内容。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

symbolSpanStyle11+[RichEditorSymbolSpanStyle](#ZH-CN_TOPIC_0000002497604894__richeditorsymbolspanstyle11)否是

组件SymbolSpan样式信息。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

paragraphStyle12+[RichEditorParagraphStyle](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphstyle11)否是
...
urlStyle19+[RichEditorUrlStyle](#ZH-CN_TOPIC_0000002497604894__richeditorurlstyle19)否是
...
名称类型只读可选说明spanIndexnumber否否Span索引值。spanRange[number, number]否否Span内容在RichEditor内的起始和结束位置。
...
名称值说明CLEAR_STYLE0撤销还原内容不保留原样式。KEEP_STYLE1撤销还原内容保留原样式。
...
名称类型只读可选说明fontColor[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否否
...
fontStyle[FontStyle](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontstyle)否否
...
decoration[DecorationStyleResult](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__decorationstyleresult12)否否

文本装饰线样式信息。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

textShadow12+Array<[ShadowOptions](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowoptions对象说明)>否是
...
lineHeight12+number否是

文本行高，默认单位为fp。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

letterSpacing12+number否是

文本字符间距，默认单位为fp。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

fontFeature12+string否是

文字特性效果。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

halfLeading18+boolean否是
...
textBackgroundStyle18+[TextBackgroundStyle](Span.md#ZH-CN_TOPIC_0000002529284887__textbackgroundstyle11对象说明)否是
...
RichEditorTextStyle中的fontWeightRichEditorTextStyleResult中的fontWeight100020013002400350046005700680079008Lighter12Normal10Regular14Medium13Bold9Bolder11
...
名称类型只读可选说明fontColorArray<[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)>否否

SymbolSpan组件颜色。

默认值：不同渲染策略下默认值不同。

fontSizenumber | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否否

SymbolSpan组件大小，默认单位为fp。

默认值：跟随主题。

fontWeightnumber | [FontWeight](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontweight) | string否否
...
renderingStrategy[SymbolRenderingStrategy](SymbolGlyph.md#ZH-CN_TOPIC_0000002529284889__symbolrenderingstrategy11枚举说明)否否

SymbolSpan组件渲染策略。

默认值：SymbolRenderingStrategy.SINGLE。

effectStrategy[SymbolEffectStrategy](SymbolGlyph.md#ZH-CN_TOPIC_0000002529284889__symboleffectstrategy11枚举说明)否否
...
名称类型只读可选说明spanPosition[RichEditorSpanPosition](#ZH-CN_TOPIC_0000002497604894__richeditorspanposition)否否Span位置。valuePixelMap[PixelMap](zh-cn_topic_0000002497605846.html)否是图片内容。valueResourceStr[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是图片资源id。imageStyle[RichEditorImageSpanStyleResult](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanstyleresult)否否图片样式。offsetInSpan[number, number]否否Span里图片的起始和结束位置。
...
名称类型只读可选说明size[number, number]否否
...
verticalAlign[ImageSpanAlignment](枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagespanalignment10)否否

图片垂直对齐方式。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

objectFit[ImageFit](枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagefit)否否

图片缩放类型。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

layoutStyle12+[RichEditorLayoutStyle](#ZH-CN_TOPIC_0000002497604894__richeditorlayoutstyle11)否是
...
名称类型只读可选说明margin[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [Margin](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__margin)否是

外边距类型，用于描述组件不同方向的外边距。

参数为Dimension类型时，四个方向外边距同时生效。

borderRadius[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [BorderRadiuses](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__borderradiuses9)否是
...
名称类型只读可选说明controller[RichEditorController](#ZH-CN_TOPIC_0000002497604894__richeditorcontroller)否否富文本控制器。
...
名称类型只读可选说明controller[RichEditorStyledStringController](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringcontroller12)否否富文本控制器。
...
名称类型只读可选说明rangeBefore[TextRange](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textrange12)否否即将被替换内容的开始和结束索引。replacedSpansArray<[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult)>否否替换后文本Span的具体信息。replacedImageSpansArray<[RichEditorImageSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanresult)>否否替换后ImageSpan的具体信息。replacedSymbolSpansArray<[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult)>否否替换后SymbolSpan的具体信息。
...
类型说明[RichEditorTextStyle](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)用户预设样式。
...
参数名类型必填说明value[RichEditorTextStyle](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)是预设样式。
...
参数名类型必填说明style[RichEditorParagraphStyle](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphstyle11)是预设段落样式。
...
参数名类型必填说明selectionStartnumber是选中开始位置。selectionEndnumber是选中结束位置。options12+[SelectionOptions](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__selectionoptions12对象说明)否选择项配置。
...
类型说明[PreviewText](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__previewtext12)预上屏信息。
...
类型说明[RectResult](自定义事件分发.md#ZH-CN_TOPIC_0000002497444840__rectresult) | undefined当前光标与RichEditor的相对位置。

#### RichEditorController

RichEditor组件的控制器，继承自[RichEditorBaseController](#ZH-CN_TOPIC_0000002497604894__richeditorbasecontroller12)。

当内容的长度超过组件显示区域的高度时，调用插入接口（例如[addTextSpan](#ZH-CN_TOPIC_0000002497604894__addtextspan)、[addImageSpan](#ZH-CN_TOPIC_0000002497604894__addimagespan)、[addBuilderSpan](#ZH-CN_TOPIC_0000002497604894__addbuilderspan11)、[addSymbolSpan](#ZH-CN_TOPIC_0000002497604894__addsymbolspan11)），组件会自动滚动内容使得插入内容末尾可见。
...
参数名类型必填说明content[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是

文本内容。

从API version 20开始，支持Resource类型。

options[RichEditorTextSpanOptions](#ZH-CN_TOPIC_0000002497604894__richeditortextspanoptions)否文本选项。

**返回值：**

类型说明number添加完成的TextSpan在所有Span中的索引位置。
...
参数名类型必填说明value[PixelMap](Interface (PixelMap).md) | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是图片内容。options[RichEditorImageSpanOptions](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanoptions)否图片选项。

**返回值：**

类型说明number添加完成的ImageSpan在所有Span中的索引位置。
...
- 可通过[RichEditorBuilderSpanOptions](#ZH-CN_TOPIC_0000002497604894__richeditorbuilderspanoptions11)设置此builder在RichEditor中的index（一个文字为一个单位）。
- 此占位Span不可获焦，支持拖拽，支持部分通用属性，占位、删除等能力等同于ImageSpan，长度视为一个文字。
- 支持通过[bindSelectionMenu](#ZH-CN_TOPIC_0000002497604894__bindselectionmenu)设置自定义菜单。
- 不支持通过[getSpans](#ZH-CN_TOPIC_0000002497604894__getspans)，[getSelection](#ZH-CN_TOPIC_0000002497604894__getselection11)，[onSelect](#ZH-CN_TOPIC_0000002497604894__onselect)，[aboutToDelete](#ZH-CN_TOPIC_0000002497604894__abouttodelete)获取builderSpan信息。
- 不支持通过[updateSpanStyle](#ZH-CN_TOPIC_0000002497604894__updatespanstyle)，[updateParagraphStyle](#ZH-CN_TOPIC_0000002497604894__updateparagraphstyle11)等方式更新builder。
...
通用属性仅支持[size](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__size)、[padding](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__padding)、[margin](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__margin)、[aspectRatio](布局约束.md#ZH-CN_TOPIC_0000002529444795__aspectratio)、[borderStyle](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderstyle)、[borderWidth](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderwidth)、[borderColor](边框设置.md#ZH-CN_TOPIC_0000002497604832__bordercolor)、[borderRadius](边框设置.md#ZH-CN_TOPIC_0000002497604832__borderradius)、[backgroundColor](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundcolor)、[backgroundBlurStyle](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundblurstyle9)、[opacity](透明度设置.md)、[blur](图像效果.md#ZH-CN_TOPIC_0000002497444856__blur)、[backdropBlur](背景设置.md#ZH-CN_TOPIC_0000002529444791__backdropblur)、[shadow](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadow)、[grayscale](图像效果.md#ZH-CN_TOPIC_0000002497444856__grayscale)、[brightness](图像效果.md#ZH-CN_TOPIC_0000002497444856__brightness)、[saturate](图像效果.md#ZH-CN_TOPIC_0000002497444856__saturate)、[contrast](图像效果.md#ZH-CN_TOPIC_0000002497444856__contrast)、[invert](图像效果.md#ZH-CN_TOPIC_0000002497444856__invert)、[sepia](图像效果.md#ZH-CN_TOPIC_0000002497444856__sepia)、[hueRotate](图像效果.md#ZH-CN_TOPIC_0000002497444856__huerotate)、[colorBlend](图像效果.md#ZH-CN_TOPIC_0000002497444856__colorblend)、[linearGradientBlur](图像效果.md#ZH-CN_TOPIC_0000002497444856__lineargradientblur12)、[clip](形状裁剪.md#ZH-CN_TOPIC_0000002529284827__clip12)、[mask](形状裁剪.md#ZH-CN_TOPIC_0000002529284827__mask12)、[foregroundBlurStyle](组件内容模糊.md#ZH-CN_TOPIC_0000002497604838__foregroundblurstyle)、[accessibilityGroup](无障碍属性.md#ZH-CN_TOPIC_0000002497444870__accessibilitygroup)、[accessibilityText](无障碍属性.md#ZH-CN_TOPIC_0000002497444870__accessibilitytext)、[accessibilityDescription](无障碍属性.md#ZH-CN_TOPIC_0000002497444870__accessibilitydescription)、[accessibilityLevel](无障碍属性.md#ZH-CN_TOPIC_0000002497444870__accessibilitylevel)、[sphericalEffect](图像效果.md#ZH-CN_TOPIC_0000002497444856__sphericaleffect12)、[lightUpEffect](图像效果.md#ZH-CN_TOPIC_0000002497444856__lightupeffect12)、[pixelStretchEffect](图像效果.md#ZH-CN_TOPIC_0000002497444856__pixelstretcheffect12)。
...
参数名类型必填说明value[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是自定义组件。options[RichEditorBuilderSpanOptions](#ZH-CN_TOPIC_0000002497604894__richeditorbuilderspanoptions11)否builder选项。

**返回值：**

类型说明number添加完成的builderSpan在所有Span中的索引位置。
...
参数名类型必填说明value[Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)是symbol资源信息。options[RichEditorSymbolSpanOptions](#ZH-CN_TOPIC_0000002497604894__richeditorsymbolspanoptions11)否symbol选项。

**返回值：**

类型说明number添加完成的SymbolSpan在所有Span中的索引位置。
...
参数名类型必填说明value[RichEditorUpdateTextSpanStyleOptions](#ZH-CN_TOPIC_0000002497604894__richeditorupdatetextspanstyleoptions) | [RichEditorUpdateImageSpanStyleOptions](#ZH-CN_TOPIC_0000002497604894__richeditorupdateimagespanstyleoptions) | [RichEditorUpdateSymbolSpanStyleOptions](#ZH-CN_TOPIC_0000002497604894__richeditorupdatesymbolspanstyleoptions11)是文本、图片或SymbolSpan的样式选项信息。
...
参数名类型必填说明value[RichEditorParagraphStyleOptions](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphstyleoptions11)是段落的样式选项信息。
...
参数名类型必填说明value[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)否需要获取span范围。

**返回值：**

类型说明Array<[RichEditorImageSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanresult) | [RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult)>文本和图片Span信息。
...
参数名类型必填说明value[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)否删除范围。省略时，删除所有文本和图片。
...
参数名类型必填说明value[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)否需要获取段落的范围。

**返回值：**

类型说明Array<[RichEditorParagraphResult](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphresult11)>选中段落的信息。
...
类型说明[RichEditorSelection](#ZH-CN_TOPIC_0000002497604894__richeditorselection)选中内容信息。
...
参数名类型必填说明value[StyledString](属性字符串.md#ZH-CN_TOPIC_0000002497444920__styledstring)是转换前的属性字符串。

**返回值：**

类型说明Array<[RichEditorSpan](#ZH-CN_TOPIC_0000002497604894__richeditorspan12)>文本和图片Span信息。

**错误码：**

以下错误码的详细介绍请参考[通用错误码](通用错误码.md)。

错误码ID错误信息401The parameter check failed.
...
参数名类型必填说明value[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)是需要获取的范围。

**返回值：**

类型说明[StyledString](属性字符串.md#ZH-CN_TOPIC_0000002497444920__styledstring)转换后的属性字符串
...
使用属性字符串构建的RichEditor组件的控制器，继承自[RichEditorBaseController](#ZH-CN_TOPIC_0000002497604894__richeditorbasecontroller12)。
...
类型说明[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)选中区域范围。
...
注册文本内容变化回调，该回调仅在后端程序导致文本内容变更时触发，调用[setStyledString](#ZH-CN_TOPIC_0000002497604894__setstyledstring12)时不会触发。
...
参数名类型必填说明listener[StyledStringChangedListener](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__styledstringchangedlistener12)是文本内容变化回调监听器。
...
名称类型只读可选说明selection[number, number]否否选中范围。spansArray<[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult) | [RichEditorImageSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanresult)>否否span信息。
...
名称类型只读可选说明startnumber否是需要更新样式的文本起始位置，省略或者设置负值时表示从0开始。endnumber否是需要更新样式的文本结束位置，省略或者超出文本范围时表示无穷大。

#### RichEditorSpanStyleOptions

文本样式选项。

继承自[RichEditorRange](#ZH-CN_TOPIC_0000002497604894__richeditorrange)。
...
继承自[RichEditorSpanStyleOptions](#ZH-CN_TOPIC_0000002497604894__richeditorspanstyleoptions)。

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

名称类型只读可选说明textStyle[RichEditorTextStyle](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)否否
...
名称类型只读可选说明imageStyle[RichEditorImageSpanStyle](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanstyle)否否图片样式。
...
名称类型只读可选说明symbolStyle[RichEditorSymbolSpanStyle](#ZH-CN_TOPIC_0000002497604894__richeditorsymbolspanstyle11)否否组件样式。
...
名称类型只读可选说明style[RichEditorParagraphStyle](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphstyle11)否否段落样式。
...
名称类型只读可选说明textAlign[TextAlign](枚举说明.md#ZH-CN_TOPIC_0000002529284967__textalign)否是

设置文本段落在水平方向的对齐方式。默认值：TextAlign.START

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

leadingMargin[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10) | [LeadingMarginPlaceholder](#ZH-CN_TOPIC_0000002497604894__leadingmarginplaceholder11)否是

设置文本段落缩进，当段落仅存在ImageSpan或BuilderSpan时，此属性值不生效。参数为Dimension类型时，不支持以Percentage形式设置。默认值：{"size":["0.00px","0.00px"]}

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

wordBreak12+[WordBreak](枚举说明.md#ZH-CN_TOPIC_0000002529284967__wordbreak11)否是
...
lineBreakStrategy12+[LineBreakStrategy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__linebreakstrategy12)否是
...
textVerticalAlign20+[TextVerticalAlign](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__textverticalalign20)否是
...
名称类型只读可选说明pixelMap[PixelMap](Interface (PixelMap).md)否否

图片内容。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

size[[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10), [Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10)]否否
...
名称类型只读可选说明style[RichEditorParagraphStyle](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphstyle11)否否段落样式。range[number, number]否否段落起始和结束位置。
...
style[RichEditorTextStyle](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)否是

文本样式信息。省略时，使用系统默认文本信息。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

paragraphStyle11+[RichEditorParagraphStyle](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphstyle11)否是

段落样式。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

gesture11+[RichEditorGesture](#ZH-CN_TOPIC_0000002497604894__richeditorgesture11)否是
...
名称类型只读可选说明fontColor[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
...
fontSize[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | number否是

设置字体大小，Length为number类型时，使用fp单位。字体默认大小16。不支持设置百分比字符串。字体大小设置为0时，显示默认字体大小。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

fontStyle[FontStyle](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontstyle)否是
...
fontFamily[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是

设置字体列表。默认字体'HarmonyOS Sans'，当前支持'HarmonyOS Sans'字体和[注册自定义字体](@ohos.font (注册自定义字体).md)。

默认字体:'HarmonyOS Sans'。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

decoration[DecorationStyleInterface](属性字符串.md#ZH-CN_TOPIC_0000002497444920__decorationstyleinterface)否是
...
textShadow11+[ShadowOptions](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowoptions对象说明) | Array<[ShadowOptions](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowoptions对象说明)>否是
...
lineHeight12+number | string | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是

设置文本的文本行高，设置值不大于0时，不限制文本行高，自适应字体大小。number类型时单位为fp，不支持设置百分比字符串。

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

letterSpacing12+number | string否是
...
Font Feature当前支持的属性见 [fontFeature属性列表](Text.md#ZH-CN_TOPIC_0000002497444914__fontfeature12)。
...
名称类型只读可选说明font[Font](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font)否是
...
imageStyle[RichEditorImageSpanStyle](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanstyle)否是
...
onHover14+[OnHoverCallback](#ZH-CN_TOPIC_0000002497604894__onhovercallback14)否是
...
名称类型只读可选说明size[[Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10), [Dimension](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__dimension10)]否是
...
verticalAlign[ImageSpanAlignment](枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagespanalignment10)否是
...
objectFit[ImageFit](枚举说明.md#ZH-CN_TOPIC_0000002529284967__imagefit)否是
...
layoutStyle11+[RichEditorLayoutStyle](#ZH-CN_TOPIC_0000002497604894__richeditorlayoutstyle11)否是
...
style[RichEditorSymbolSpanStyle](#ZH-CN_TOPIC_0000002497604894__richeditorsymbolspanstyle11)否是组件样式信息。省略时，使用系统默认样式信息。
...
名称类型只读可选说明offsetnumber否是添加builder的位置。省略或者为异常值时，添加到所有内容的最后。
...
类型说明[RichEditorImageSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanresult)后端返回的图片信息。[RichEditorTextSpanResult](#ZH-CN_TOPIC_0000002497604894__richeditortextspanresult)后端返回的文本信息。
...
名称类型只读可选说明onAppear[MenuOnAppearCallback](#ZH-CN_TOPIC_0000002497604894__menuonappearcallback12)否是

自定义选择菜单弹出时回调。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

onDisappearCallback<void>否是

自定义选择菜单关闭时回调。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

menuType13+[MenuType](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__menutype13枚举说明)否是
...
onMenuShow15+[MenuCallback](#ZH-CN_TOPIC_0000002497604894__menucallback15)否是

自定义选择菜单显示时回调。

**元服务API：** 从API version 15开始，该接口支持在元服务中使用。

onMenuHide15+[MenuCallback](#ZH-CN_TOPIC_0000002497604894__menucallback15)否是

自定义选择菜单隐藏时回调。

**元服务API：** 从API version 15开始，该接口支持在元服务中使用。

previewMenuOptions18+[PreviewMenuOptions](#ZH-CN_TOPIC_0000002497604894__previewmenuoptions18)否是
...
名称类型只读可选说明hapticFeedbackMode[HapticFeedbackMode](菜单控制.md#ZH-CN_TOPIC_0000002497604848__hapticfeedbackmode18)否是
...
名称类型只读可选说明preventDefaultCallback<void>否是阻止系统默认粘贴事件。
...
名称类型只读可选说明preventDefaultCallback<void>否是阻止系统默认剪切事件。
...
名称类型只读可选说明preventDefaultCallback<void>否是阻止组件的默认复制操作。
...
名称类型只读可选说明onClickCallback<[ClickEvent](点击事件.md#ZH-CN_TOPIC_0000002529284807__clickevent)>否是

[ClickEvent](点击事件.md#ZH-CN_TOPIC_0000002529284807__clickevent)为用户点击事件。

点击完成时回调事件。

双击时，第一次点击触发回调事件。

onLongPressCallback<[GestureEvent](手势公共接口.md#ZH-CN_TOPIC_0000002497604864__gestureevent对象说明)>否是

[GestureEvent](手势公共接口.md#ZH-CN_TOPIC_0000002497604864__gestureevent对象说明)为用户长按事件。
...
名称类型只读可选说明supportAvoidanceboolean否是设置自定义键盘是否支持避让功能。默认值为 false，表示不支持避让；true 表示支持避让。
...
参数名类型必填说明enterKey[EnterKeyType](TextInput.md#ZH-CN_TOPIC_0000002529444859__enterkeytype枚举说明)是软键盘输入法回车键类型。具体类型见EnterKeyType枚举说明。event[SubmitEvent](TextInput.md#ZH-CN_TOPIC_0000002529444859__submitevent11)是当提交的时候，提供保持组件编辑状态的方法。EnterKeyType指定为NEW_LINE时，默认保持编辑态。
...
参数名类型必填说明startnumber是选中内容的起始位置。endnumber是选中内容的终止位置。
...
参数名类型必填说明event[PasteEvent](#ZH-CN_TOPIC_0000002497604894__pasteevent11)否定义用户粘贴事件。
...
参数名类型必填说明statusboolean是表示鼠标是否悬浮在组件上，鼠标进入组件时为true，离开组件时为false。event[HoverEvent](悬浮事件.md#ZH-CN_TOPIC_0000002497444838__hoverevent10对象说明)是设置悬浮事件。
...
名称类型只读可选说明spanPosition[RichEditorSpanPosition](#ZH-CN_TOPIC_0000002497604894__richeditorspanposition)否否Span位置。valuestring否否文本Span内容。textStyle[RichEditorTextStyle](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)否是文本Span样式信息。
...
名称类型只读可选说明spanPosition[RichEditorSpanPosition](#ZH-CN_TOPIC_0000002497604894__richeditorspanposition)否否Span位置。value[PixelMap](zh-cn_topic_0000002497605846.html) | [ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否否图片内容。imageStyle[RichEditorImageSpanStyle](#ZH-CN_TOPIC_0000002497604894__richeditorimagespanstyle)否是图片样式。
...
名称类型只读可选说明url[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
通过[updateSpanStyle](#ZH-CN_TOPIC_0000002497604894__updatespanstyle)接口更新已有文本样式，更改样式后，使用[getSpans](#ZH-CN_TOPIC_0000002497604894__getspans)获取文本新的样式信息。
...
通过[customKeyboard](#ZH-CN_TOPIC_0000002497604894__customkeyboard)给组件绑定自定义键盘。
...
通过[bindSelectionMenu](#ZH-CN_TOPIC_0000002497604894__bindselectionmenu)给组件绑定自定义菜单。
...
通过[updateSpanStyle](#ZH-CN_TOPIC_0000002497604894__updatespanstyle)接口更新图片样式。
...
为Span绑定[gesture](#ZH-CN_TOPIC_0000002497604894__richeditorgesture11)回调。
...
通过[updateParagraphStyle](#ZH-CN_TOPIC_0000002497604894__updateparagraphstyle11)接口更新段落样式，通过[getParagraphs](#ZH-CN_TOPIC_0000002497604894__getparagraphs11)接口获取指定范围段落的信息。
...
通过[setTypingStyle](#ZH-CN_TOPIC_0000002497604894__settypingstyle11)接口更新文本预设样式，通过[updateParagraphStyle](#ZH-CN_TOPIC_0000002497604894__updateparagraphstyle11)接口设置段落缩进。
...
通过[updateParagraphStyle](#ZH-CN_TOPIC_0000002497604894__updateparagraphstyle11)接口设置文本字重与阴影。
...
通过[addBuilderSpan](#ZH-CN_TOPIC_0000002497604894__addbuilderspan11)接口添加用户自定义布局Span。
...
通过[addBuilderSpan](#ZH-CN_TOPIC_0000002497604894__addbuilderspan11)接口添加的自定义布局Span，[getSpans](#ZH-CN_TOPIC_0000002497604894__getspans)、[onWillChange](#ZH-CN_TOPIC_0000002497604894__onwillchange12)等API不会返回BuilderSpan内部的信息。开发者需要自行维护BuilderSpan的状态，并且在组件内容发生变化时同步更新。
...
设置[enableDataDetector](#ZH-CN_TOPIC_0000002497604894__enabledatadetector11)为true时，通过[dataDetectorConfig](#ZH-CN_TOPIC_0000002497604894__datadetectorconfig11)接口设置文本识别配置。
...
通过[caretColor](#ZH-CN_TOPIC_0000002497604894__caretcolor12)属性设置输入框光标、手柄颜色，通过[selectedBackgroundColor](#ZH-CN_TOPIC_0000002497604894__selectedbackgroundcolor12)属性设置文本选中底板颜色。
...
通过[updateSpanStyle](#ZH-CN_TOPIC_0000002497604894__updatespanstyle)接口配置文本行高（[lineHeight](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)）和字符间距（[letterSpacing](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)）。
...
为组件添加[onPaste](#ZH-CN_TOPIC_0000002497604894__onpaste11)事件，通过[PasteEvent](#ZH-CN_TOPIC_0000002497604894__pasteevent11)自定义用户粘贴事件。
...
通过[addTextSpan](#ZH-CN_TOPIC_0000002497604894__addtextspan)接口设置文字特性效果（[fontFeature](#ZH-CN_TOPIC_0000002497604894__richeditortextstyle)）。当添加“ss01”特性的FontFeature属性时，数字“0”由原来的椭圆形改变为带有倒圆角形。
...
通过[customKeyboard](#ZH-CN_TOPIC_0000002497604894__customkeyboard)属性绑定自定义键盘，通过参数[KeyboardOptions](#ZH-CN_TOPIC_0000002497604894__keyboardoptions12)设置自定义键盘是否支持避让功能。
...
通过[isEditing](#ZH-CN_TOPIC_0000002497604894__isediting12)接口获取当前富文本的编辑状态。为组件添加[onEditingChange](#ZH-CN_TOPIC_0000002497604894__oneditingchange12)事件，可通过打印日志，获取当前组件是否在编辑态。
...
为组件添加[onWillChange](#ZH-CN_TOPIC_0000002497604894__onwillchange12)事件，能够在组件执行增删操作前，触发回调。
...
通过[enterKeyType](#ZH-CN_TOPIC_0000002497604894__enterkeytype12)属性设置软键盘输入法回车键类型。
...
通过[updateParagraphStyle](#ZH-CN_TOPIC_0000002497604894__updateparagraphstyle11)接口设置折行类型（[lineBreakStrategy](#ZH-CN_TOPIC_0000002497604894__richeditorparagraphstyle11)），通过[getParagraphs](#ZH-CN_TOPIC_0000002497604894__getparagraphs11)接口获取当前段落的折行类型。
...
从API version 20开始，该示例中[属性字符串](属性字符串.md)通过[RichEditorStyledStringController](#ZH-CN_TOPIC_0000002497604894__richeditorstyledstringcontroller12)中的[setStyledString](#ZH-CN_TOPIC_0000002497604894__setstyledstring12)方法与RichEditor组件绑定。通过[getStyledString](#ZH-CN_TOPIC_0000002497604894__getstyledstring12)接口获取富文本组件显示的属性字符串。
...
通过[getLayoutManager](#ZH-CN_TOPIC_0000002497604894__getlayoutmanager12)接口获取布局管理器对象，通过[getLineCount](zh-cn_topic_0000002529444865.html#ZH-CN_TOPIC_0000002529444865__getlinecount12)接口获取组件内容或[placeholder](#ZH-CN_TOPIC_0000002497604894__placeholder12)的总行数，通过[getGlyphPositionAtCoordinate](zh-cn_topic_0000002529444865.html#ZH-CN_TOPIC_0000002529444865__getglyphpositionatcoordinate12)接口获取较为接近给定坐标的字形的位置信息，通过[getLineMetrics](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__getlinemetrics12)接口获取指定行的行信息、文本样式信息、以及字体属性信息。
...
从API version 20开始，该示例通过[editMenuOptions](#ZH-CN_TOPIC_0000002497604894__editmenuoptions12)属性设置系统默认菜单的扩展项，允许配置扩展项的文本内容、图标和回调方法。
...
从API version 18开始，该示例通过[barState](#ZH-CN_TOPIC_0000002497604894__barstate13)属性设置组件滚动条的显示模式。通过[enableKeyboardOnFocus](#ZH-CN_TOPIC_0000002497604894__enablekeyboardonfocus12)属性设置组件通过点击以外的方式获焦时，是否主动拉起软键盘。通过[enableHapticFeedback](#ZH-CN_TOPIC_0000002497604894__enablehapticfeedback13)属性设置组件是否支持触感反馈。通过[getPreviewText](#ZH-CN_TOPIC_0000002497604894__getpreviewtext12)接口获取组件预上屏信息。通过[stopBackPress](#ZH-CN_TOPIC_0000002497604894__stopbackpress18)属性设置是否阻止返回键向其它组件或应用侧传递。

从API version 21开始，该示例通过[scrollBarColor](#ZH-CN_TOPIC_0000002497604894__scrollbarcolor21)属性设置RichEditor组件滚动条颜色。
...
从API version 18开始，该示例通过RichEditorBaseController的[getCaretRect](#ZH-CN_TOPIC_0000002497604894__getcaretrect18)方法来获取当前光标相对于组件位置的Rect。
...
从API version 18开始，该示例通过[maxLength](#ZH-CN_TOPIC_0000002497604894__maxlength18)设置可输入的最大字符数，通过[maxLines](#ZH-CN_TOPIC_0000002497604894__maxlines18)设置可输入的最大行数。
...
从API version 19开始，该示例通过在addTextSpan和UpdateSpanStyle接口中加入[UrlStyle](#ZH-CN_TOPIC_0000002497604894__richeditorurlstyle19)，来实现文本点击时跳转到指定链接的功能。
...
从API version 20开始，该示例对于不使用属性字符串的富文本组件，可以通过配置[undoStyle](#ZH-CN_TOPIC_0000002497604894__undostyle20)属性为UndoStyle.KEEP_STYLE，以支持撤销还原时保留原内容的样式。
...
从API version 20开始，该示例通过[setTypingParagraphStyle](#ZH-CN_TOPIC_0000002497604894__settypingparagraphstyle20)接口设置预设段落样式。
...
从API version 20开始，该示例通过[thicknessScale](属性字符串.md#ZH-CN_TOPIC_0000002497444920__decorationstyle)设置装饰线粗细，通过[enableMultiType](属性字符串.md#ZH-CN_TOPIC_0000002497444920__decorationoptions20)设置多装饰线。
...
从API version 20开始，该示例通过[enableAutoSpacing](#ZH-CN_TOPIC_0000002497604894__enableautospacing20)属性设置中西文自动间距。
...
从API version 22开始，该示例通过[enableSelectedDataDetector](#ZH-CN_TOPIC_0000002497604894__enableselecteddatadetector22)，配置文本选择AI菜单功能。
...
从API version 22开始，该示例通过[onWillAttachIME](#ZH-CN_TOPIC_0000002497604894__onwillattachime22)事件监听输入法绑定事件。
