...
名称typedef关键字描述[OH_NativeBuffer_Config](OH_NativeBuffer_Config.md)OH_NativeBuffer_ConfigOH_NativeBuffer的属性配置，用于申请新的OH_NativeBuffer实例或查询现有实例的相关属性。[OH_NativeBuffer_Plane](OH_NativeBuffer_Plane.md)OH_NativeBuffer_Plane单个图像平面格式信息。[OH_NativeBuffer_Planes](OH_NativeBuffer_Planes.md)OH_NativeBuffer_PlanesOH_NativeBuffer的图像平面格式信息。[OH_NativeBuffer](OH_NativeBuffer.md)OH_NativeBuffer提供OH_NativeBuffer结构体声明。
...
参数项描述const [OH_NativeBuffer_Config](OH_NativeBuffer_Config.md)* config一个指向OH_NativeBuffer_Config类型的指针。
...
参数项描述[OH_NativeBuffer](OH_NativeBuffer.md) *buffer一个指向OH_NativeBuffer实例的指针。
...
参数项描述[OH_NativeBuffer](OH_NativeBuffer.md) *buffer一个指向OH_NativeBuffer实例的指针。[OH_NativeBuffer_Config](OH_NativeBuffer_Config.md)* config一个指向OH_NativeBuffer_Config的指针，用于接收OH_NativeBuffer的属性。
...
参数项描述[OH_NativeBuffer](OH_NativeBuffer.md) *buffer一个指向OH_NativeBuffer实例的指针。void **virAddr一个二级指针，二级指针指向映射到当前进程的虚拟内存的地址。
...
参数项描述[OH_NativeBuffer](OH_NativeBuffer.md) *buffer一个指向OH_NativeBuffer实例的指针。void **virAddr一个二级指针，二级指针指向映射到当前进程的虚拟内存的地址。[OH_NativeBuffer_Planes](OH_NativeBuffer_Planes.md) *outPlanes一个指向所有图像平面格式信息的指针。
...
参数项描述[OHNativeWindowBuffer](NativeWindowBuffer.md) *nativeWindowBuffer一个指向[OHNativeWindowBuffer](NativeWindowBuffer.md)实例的指针。[OH_NativeBuffer](OH_NativeBuffer.md) **buffer一个指向OH_NativeBuffer实例的指针。
...
参数项描述[OH_NativeBuffer](OH_NativeBuffer.md) *buffer一个指向OH_NativeBuffer实例的指针。[OH_NativeBuffer_ColorSpace](buffer_common.h.md#ZH-CN_TOPIC_0000002529285985__oh_nativebuffer_colorspace) *colorSpace为[OH_NativeBuffer](OH_NativeBuffer.md)设置的颜色空间，其值从[OH_NativeBuffer_ColorSpace](buffer_common.h.md#ZH-CN_TOPIC_0000002529285985__oh_nativebuffer_colorspace)获取。
...
参数项描述[OH_NativeBuffer](OH_NativeBuffer.md) *buffer一个指向[OH_NativeBuffer](OH_NativeBuffer.md)实例的指针。int32_t fenceFd指向文件描述符句柄，用于并发同步控制。void **virAddr一个二级指针，二级指针指向映射到当前进程的虚拟内存的地址。
