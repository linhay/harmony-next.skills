...
加载动效在组件不可见时停止，组件的可见状态基于[onVisibleAreaChange](组件可见区域变化事件.md#ZH-CN_TOPIC_0000002497444844__onvisibleareachange)处理，可见阈值ratios大于0即视为可见状态。
...
设置LoadingProgress动画是否显示。LoadingProgress动画不显示时，该组件依旧占位。通用属性[Visibility.Hidden](显隐控制.md#ZH-CN_TOPIC_0000002529284817__visibility)隐藏的是包括[border](边框设置.md#ZH-CN_TOPIC_0000002497604832__border)、[padding](尺寸设置.md#ZH-CN_TOPIC_0000002497444850__padding)等整个组件范围，而enableLoading=false只隐藏LoadingProgress本身动画内容，不包括border等。
