...
直接使用MeasureText可能导致[UI上下文不明确](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-global-interface#ui上下文不明确)的问题，推荐通过[UIContext](Class (UIContext).md)中的[getMeasureUtils](Class (UIContext).md#ZH-CN_TOPIC_0000002522240732__getmeasureutils12)方法获取当前UI上下文关联的[MeasureUtils](Class (MeasureUtils).md)实例。
