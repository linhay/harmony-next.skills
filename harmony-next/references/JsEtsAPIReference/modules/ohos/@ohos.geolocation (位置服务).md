...
开发者可以在应用配置文件中声明所需要的权限，具体可参考[向用户申请授权](../../guides/向用户申请授权.md)。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.on('locationChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageronlocationchange)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.off('locationChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagerofflocationchange)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.on('locationEnabledChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageronlocationenabledchange)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.off('locationEnabledChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagerofflocationenabledchange)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.on('cachedGnssLocationsChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageroncachedgnsslocationschange)替代。
...
| callback | Callback<Array<Location>> | 是 | 回调函数，返回GNSS缓存位置。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.off('cachedGnssLocationsChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageroffcachedgnsslocationschange)替代。
...
| --- | --- | --- | --- |
| type | string | 是 | 设置事件类型。type为“cachedGnssLocationsReporting”，表示GNSS缓存定位结果上报。 |
| callback | Callback<Array<Location>> | 否 | 需要取消订阅的回调函数。该回调函数需要与on接口传入的回调函数保持一致。若无此参数，则取消当前类型的所有订阅。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.on('satelliteStatusChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageronsatellitestatuschange)替代。
...
| callback | Callback<SatelliteStatusInfo> | 是 | 回调函数，返回GNSS卫星状态信息。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.off('satelliteStatusChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageroffsatellitestatuschange)替代。
...
| --- | --- | --- | --- |
| type | string | 是 | 设置事件类型。type为“gnssStatusChange”，表示订阅GNSS卫星状态信息上报。 |
| callback | Callback<SatelliteStatusInfo> | 否 | 需要取消订阅的回调函数。该回调函数需要与on接口传入的回调函数保持一致。若无此参数，则取消当前类型的所有订阅。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.on('nmeaMessage')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageronnmeamessage)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.off('nmeaMessage')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageroffnmeamessage)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.on('gnssFenceStatusChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagerongnssfencestatuschange)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.off('gnssFenceStatusChange')](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanageroffgnssfencestatuschange)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetcurrentlocation)替代。
...
| callback | AsyncCallback<Location> | 是 | 回调函数，返回当前位置信息。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetcurrentlocation-2)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getLastLocation](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetlastlocation)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Location> | 是 | 回调函数，返回上次位置信息。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.isLocationEnabled](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagerislocationenabled)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.isGeocoderAvailable](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagerisgeocoderavailable)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocation](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetaddressesfromlocation)替代。
...
| callback | AsyncCallback<Array<GeoAddress>> | 是 | 回调函数，返回逆地理编码结果。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocation](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetaddressesfromlocation-1)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocationName](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetaddressesfromlocationname)替代。
...
| callback | AsyncCallback<Array<GeoAddress>> | 是 | 回调函数，返回地理编码结果。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocationName](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetaddressesfromlocationname-1)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.getCachedGnssLocationsSize](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetcachedgnsslocationssize)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.getCachedGnssLocationsSize](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagergetcachedgnsslocationssize-1)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.flushCachedGnssLocations](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagerflushcachedgnsslocations)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.flushCachedGnssLocations](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagerflushcachedgnsslocations-1)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.sendCommand](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geolocationmanagersendcommand)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.ReverseGeoCodeRequest](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__reversegeocoderequest)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.GeoCodeRequest](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geocoderequest)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.GeoAddress](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geoaddress)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationRequest](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__locationrequest)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| priority | LocationRequestPriority | 否 | 是 | 表示优先级信息。取值范围见LocationRequestPriority的定义。 |
| scenario | LocationRequestScenario | 否 | 是 | 表示场景信息。取值范围见LocationRequestScenario的定义。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.CurrentLocationRequest](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__currentlocationrequest)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.SatelliteStatusInfo](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__satellitestatusinfo)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.CachedGnssLocationsRequest](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__cachedgnsslocationsrequest)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.Geofence](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geofence)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.GeofenceRequest](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__geofencerequest)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| priority | LocationRequestPriority | 否 | 否 | 表示位置信息优先级。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationCommand](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__locationcommand)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.Location](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__location)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationRequestPriority](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__locationrequestpriority)替代。
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| UNSET | 0x200 | 表示未设置优先级，表示LocationRequestPriority无效。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationRequestScenario](@ohos.geoLocationManager (位置服务).md#ZH-CN_TOPIC_0000002553202339__locationrequestscenario)替代。
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| UNSET | 0x300 | 表示未设置场景信息。 表示LocationRequestScenario字段无效。 |
