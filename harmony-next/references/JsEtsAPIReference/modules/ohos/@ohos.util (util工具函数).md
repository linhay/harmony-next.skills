...
该模块主要提供常用的工具函数，实现字符串编解码（[TextEncoder](#ZH-CN_TOPIC_0000002522240702__textencoder)，[TextDecoder](#ZH-CN_TOPIC_0000002522240702__textdecoder)）、有理数运算（[RationalNumber8+](#ZH-CN_TOPIC_0000002522240702__rationalnumber8)）、缓冲区管理（[LRUCache9+](#ZH-CN_TOPIC_0000002522240702__lrucache9)）、范围判断（[ScopeHelper9+](#ZH-CN_TOPIC_0000002522240702__scopehelper9)）、Base64编解码（[Base64Helper9+](#ZH-CN_TOPIC_0000002522240702__base64helper9)）、内置对象类型检查（[types8+](#ZH-CN_TOPIC_0000002522240702__types8)）、对方法进行插桩和替换（[Aspect11+](#ZH-CN_TOPIC_0000002522240702__aspect11)）等功能。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[util.format9+](#ZH-CN_TOPIC_0000002522240702__utilformat9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[util.errnoToString9+](#ZH-CN_TOPIC_0000002522240702__utilerrnotostring9)替代。
...
从API version 7开始支持，从API version 9开始废弃，此接口不可用，建议使用[util.promisify9+](#ZH-CN_TOPIC_0000002522240702__utilpromisify9)替代。
...
| options | TextDecoderOptions | 否 | 解码相关选项参数，存在两个属性fatal和ignoreBOM。 |
...
从API version 9开始支持，从API version 12开始废弃，建议使用[decodeToString12+](#ZH-CN_TOPIC_0000002522240702__decodetostring12)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[create9+](#ZH-CN_TOPIC_0000002522240702__create9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[decodeToString12+](#ZH-CN_TOPIC_0000002522240702__decodetostring12)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[encodeIntoUint8Array9+](#ZH-CN_TOPIC_0000002522240702__encodeintouint8array9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[encodeInto9+](#ZH-CN_TOPIC_0000002522240702__encodeinto9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[parseRationalNumber9+](#ZH-CN_TOPIC_0000002522240702__parserationalnumber9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[compare9+](#ZH-CN_TOPIC_0000002522240702__compare9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getCommonFactor9+](#ZH-CN_TOPIC_0000002522240702__getcommonfactor9)替代。
...
返回键对应的值。当键不在缓冲区中时，通过[createDefault9+](#ZH-CN_TOPIC_0000002522240702__createdefault9)接口创建，若createDefault创建的值不为undefined时，此时会调用[afterRemoval9+](#ZH-CN_TOPIC_0000002522240702__afterremoval9)接口，返回createDefault创建的值。
...
删除值后执行后续操作，这些操作由开发者自行实现。本接口会在删除操作时被调用，如[get9+](#ZH-CN_TOPIC_0000002522240702__get9)、[put9+](#ZH-CN_TOPIC_0000002522240702__put9)、[remove9+](#ZH-CN_TOPIC_0000002522240702__remove9)、[clear9+](#ZH-CN_TOPIC_0000002522240702__clear9)、[updateCapacity9+](#ZH-CN_TOPIC_0000002522240702__updatecapacity9)接口。


若此回调方法在[clear9+](#ZH-CN_TOPIC_0000002522240702__clear9)、[updateCapacity9+](#ZH-CN_TOPIC_0000002522240702__updatecapacity9)接口调用之后触发执行，传入的key和value参数类型为MapIterator，可参照示例二进行后续操作。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[LRUCache9+](#ZH-CN_TOPIC_0000002522240702__lrucache9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[LRUCache.constructor9+](#ZH-CN_TOPIC_0000002522240702__constructor9-3)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[LRUCache