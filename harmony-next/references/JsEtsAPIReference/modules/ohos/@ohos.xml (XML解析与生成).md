...
- [XmlSerializer](#ZH-CN_TOPIC_0000002553200675__xmlserializer)：适用于已知XML文本大小的情况

- [XmlDynamicSerializer20+](#ZH-CN_TOPIC_0000002553200675__xmldynamicserializer20)：适用于未知XML文本大小的情况。
...
调用该接口后须调用[endElement](#ZH-CN_TOPIC_0000002553200675__endelement)写入元素结束标记，以确保节点正确闭合。
...
调用该接口前必须先调用[startElement](#ZH-CN_TOPIC_0000002553200675__startelement)接口写入元素开始标记。
...
从API version 8开始支持，从API version 14开始废弃，建议使用[parseXml14+](#ZH-CN_TOPIC_0000002553200675__parsexml14)替代。
