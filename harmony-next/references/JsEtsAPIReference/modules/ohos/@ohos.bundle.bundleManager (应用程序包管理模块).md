...
本模块提供应用信息的查询能力，支持应用包信息[BundleInfo](BundleInfo.md)、应用程序信息[ApplicationInfo](ApplicationInfo.md)、UIAbility组件信息[AbilityInfo](AbilityInfo.md)、ExtensionAbility组件信息[ExtensionAbilityInfo]([ExtensionAbilityInfo](../../topics/misc/ExtensionAbilityInfo.md).md)等信息的查询。
...
| GET_BUNDLE_INFO_WITH_METADATA | 0x00000020 | 用于获取applicationInfo、moduleInfo、abilityInfo和extension[AbilityInfo](../../topics/misc/AbilityInfo.md)中包含的metadata。单独使用不生效，它需要与GET_BUNDLE_INFO_WITH_APPLICATION、GET_BUNDLE_INFO_WITH_HAP_MODULE、GET_BUNDLE_INFO_WITH_ABILITY、GET_BUNDLE_INFO_WITH_EXTENSION_ABILITY配合使用，其中： - 获取applicationInfo中包含的metadata，需要与GET_BUNDLE_INFO_WITH_APPLICATION一起使用。 - 获取moduleInfo中包含的metadata，需要与GET_BUNDLE_INFO_WITH_HAP_MODULE一起使用。 - 获取abilityInfo中包含的metadata，需要与GET_BUNDLE_INFO_WITH_HAP_MODULE、GET_BUNDLE_INFO_WITH_ABILITY一起使用。 - 获取extensionAbilityInfo中包含的metadata，需要与GET_BUNDLE_INFO_WITH_HAP_MODULE、GET_BUNDLE_INFO_WITH_EXTENSION_ABILITY一起使用。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
| GET_BUNDLE_INFO_WITH_DISABLE | 0x00000040 | 用于获取application被禁用的[BundleInfo](../../topics/misc/BundleInfo.md)和被禁用的Ability信息。获取的bundleInfo不包含signatureInfo、applicationInfo、hapModuleInfo、ability、extensionAbility和permission的信息。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
...
| ENTERPRISE_ADMIN | 11 | [EnterpriseAdminExtensionAbility](@ohos.enterprise.EnterpriseAdminExtensionAbility（企业设备管理扩展能力）.md)：企业设备管理扩展能力，提供企业管理时处理管理事件的能力，比如设备上应用安装事件、锁屏密码输入错误次数过多事件等。 |
...
| DISTRIBUTED20+ | 28 | DistributedExtensionAbility：提供分布式相关扩展能力，提供分布式创建、销毁、连接的生命周期回调。 |
...
| PARTNER_AGENT23+ | 36 | PartnerAgentExtensionAbility：基于蓝牙通信技术，提供设备发现与设备下线的通知功能。 模型约束：此接口仅可在Stage模型下使用。 |
| UNSPECIFIED | 255 | 不指定类型。 |
| CALLER_INFO_QUERY19+ | 25 | CallerInfoQueryExtensionAbility：为开发者提供来去电信息查询能力。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| GET_ABILITY_INFO_DEFAULT | 0x00000000 | 获取默认[AbilityInfo](../../topics/misc/AbilityInfo.md)，获取的AbilityInfo不包含permissions、metadata、被禁用Ability对应的AbilityInfo。 |
| GET_ABILITY_INFO_WITH_PERMISSION | 0x00000001 | 获取包含permissions的[AbilityInfo](../../topics/misc/AbilityInfo.md)。 |
| GET_ABILITY_INFO_WITH_APPLICATION | 0x00000002 | 获取包含applicationInfo的[AbilityInfo](../../topics/misc/AbilityInfo.md)。 |
| GET_ABILITY_INFO_WITH_METADATA | 0x00000004 | 获取包含metadata的[AbilityInfo](../../topics/misc/AbilityInfo.md)。 |
| GET_ABILITY_INFO_WITH_DISABLE | 0x00000008 | 获取被禁用Ability对应的[AbilityInfo](../../topics/misc/AbilityInfo.md)。 |
| GET_ABILITY_INFO_ONLY_SYSTEM_APP | 0x00000010 | 获取系统应用对应的[AbilityInfo](../../topics/misc/AbilityInfo.md)。 |
| GET_ABILITY_INFO_WITH_APP_LINKING | 0x00000040 | 获取通过域名校验筛选的[AbilityInfo](../../topics/misc/AbilityInfo.md)。 |
| GET_ABILITY_INFO_WITH_SKILL | 0x00000080 | 获取包含skills的[AbilityInfo](../../topics/misc/AbilityInfo.md)。 |

#### bundleManager.get[BundleInfo](../../topics/misc/BundleInfo.md)ForSelf

get[BundleInfo](../../topics/misc/BundleInfo.md)ForSelf(bundleFlags: number): Promise<BundleInfo>

根据给定的bundleFlags获取当前应用的[BundleInfo](../../topics/misc/BundleInfo.md)。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bundleFlags | number | 是 | 指定返回的[BundleInfo](../../topics/misc/BundleInfo.md)所包含的信息。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[BundleInfo](../../topics/misc/BundleInfo.md)> | Promise对象，返回当前应用的BundleInfo。 |
...
get[BundleInfo](../../topics/misc/BundleInfo.md)ForSelf(bundleFlags: number, callback: AsyncCallback<BundleInfo>): void

根据给定的bundleFlags获取当前应用的[BundleInfo](../../topics/misc/BundleInfo.md)。使用callback异步回调。
...
| --- | --- | --- | --- |
| bundleFlags | number | 是 | 指定返回的[BundleInfo](../../topics/misc/BundleInfo.md)所包含的信息。 |
| callback | AsyncCallback<[BundleInfo](../../topics/misc/BundleInfo.md)> | 是 | 回调函数，当获取成功时，err为null，data为获取到的当前应用的BundleInfo；否则为错误对象。 |
...
#### bundleManager.get[BundleInfo](../../topics/misc/BundleInfo.md)ForSelfSync10+

get[BundleInfo](../../topics/misc/BundleInfo.md)ForSelfSync(bundleFlags: number): BundleInfo

以同步方法根据给定的bundleFlags获取当前应用的[BundleInfo](../../topics/misc/BundleInfo.md)。
...
| 类型 | 说明 |
| --- | --- |
| [BundleInfo](../../topics/misc/BundleInfo.md) | 返回BundleInfo对象。 |
...
#### bundleManager.get[BundleInfo](../../topics/misc/BundleInfo.md)14+

get[BundleInfo](../../topics/misc/BundleInfo.md)(bundleName: string, bundleFlags: number, userId: number, callback: AsyncCallback<BundleInfo>): void
...
| callback | AsyncCallback<[BundleInfo](../../topics/misc/BundleInfo.md)> | 是 | 回调函数，当获取成功时，err为null，data为获取到的bundleInfo；否则为错误对象。 |
...
根据给定的bundleName和bundleFlags获取[BundleInfo](../../topics/misc/BundleInfo.md)。使用callback异步回调。
...
get[BundleInfo](../../topics/misc/BundleInfo.md)(bundleName: string, bundleFlags: number, userId?: number): Promise<BundleInfo>

根据给定的bundleName、bundleFlags和userId获取[BundleInfo](../../topics/misc/BundleInfo.md)。使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[BundleInfo](../../topics/misc/BundleInfo.md)> | Promise对象，返回BundleInfo。 |
...
#### bundleManager.get[BundleInfo](../../topics/misc/BundleInfo.md)Sync14+

get[BundleInfo](../../topics/misc/BundleInfo.md)Sync(bundleName: string, bundleFlags: number, userId: number): BundleInfo

以同步方法根据给定的bundleName、bundleFlags和userId获取[BundleInfo](../../topics/misc/BundleInfo.md)。
...
get[BundleInfo](../../topics/misc/BundleInfo.md)Sync(bundleName: string, bundleFlags: number): BundleInfo

以同步方法根据给定的bundleName、bundleFlags获取调用方所在用户下的[BundleInfo](../../topics/misc/BundleInfo.md)。
...
#### bundleManager.get[AppCloneIdentity](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__appcloneidentity14)14+

get[AppCloneIdentity](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__appcloneidentity14)(uid: number): Promise<AppCloneIdentity>;
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AppCloneIdentity](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__appcloneidentity14)> | Promise对象，返回<AppCloneIdentity>。 |
...
#### bundleManager.get[SignatureInfo](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo)18+

get[SignatureInfo](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo)(uid: number): SignatureInfo

根据给定的uid获取对应应用的[签名信息](BundleInfo.md#ZH-CN_TOPIC_0000002553360505__signatureinfo)。
...
| 类型 | 说明 |
| --- | --- |
| [SignatureInfo](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo) | 返回SignatureInfo对象。 |
...
#### bundleManager.get[AbilityInfo](../../topics/misc/AbilityInfo.md)20+

get[AbilityInfo](../../topics/misc/AbilityInfo.md)(uri: string, abilityFlags: number): Promise<Array<AbilityInfo>>
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[AbilityInfo](../../topics/misc/AbilityInfo.md)>> | Promise对象，返回获取到的Ability信息数组。 |
...
#### [ApplicationInfo](../../topics/misc/ApplicationInfo.md)

type [ApplicationInfo](../../topics/misc/ApplicationInfo.md) = [_ApplicationInfo](../../topics/misc/ApplicationInfo.md#ZH-CN_TOPIC_0000002497444654__applicationinfo-1)
...
| 类型 | 说明 |
| --- | --- |
| _[ApplicationInfo](../../topics/misc/ApplicationInfo.md) | 应用程序信息。 |

#### ModuleMetadata10+

type ModuleMetadata = [_ModuleMetadata](../../topics/misc/ApplicationInfo.md#ZH-CN_TOPIC_0000002497444654__modulemetadata10)
...
| 类型 | 说明 |
| --- | --- |
| [_ModuleMetadata](../../topics/misc/ApplicationInfo.md#ZH-CN_TOPIC_0000002497444654__modulemetadata10) | 模块的元数据信息。 |

#### Metadata

type Metadata = [_Metadata](../../topics/misc/Metadata.md#ZH-CN_TOPIC_0000002529444601__metadata-1)
...
| 类型 | 说明 |
| --- | --- |
| [_Metadata](../../topics/misc/Metadata.md#ZH-CN_TOPIC_0000002529444601__metadata-1) | 元数据信息。 |

#### [BundleInfo](../../topics/misc/BundleInfo.md)

type [BundleInfo](../../topics/misc/BundleInfo.md) = [_BundleInfo.BundleInfo](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__bundleinfo-1)
...
| 类型 | 说明 |
| --- | --- |
| _[BundleInfo](../../topics/misc/BundleInfo.md).BundleInfo | 应用包信息。 |

#### UsedScene

type UsedScene = _[BundleInfo](../../topics/misc/BundleInfo.md).UsedScene
...
| 类型 | 说明 |
| --- | --- |
| _[BundleInfo](../../topics/misc/BundleInfo.md).UsedScene | 权限使用的场景和时机。 |

#### ReqPermissionDetail

type ReqPermissionDetail = _[BundleInfo](../../topics/misc/BundleInfo.md).ReqPermissionDetail
...
| 类型 | 说明 |
| --- | --- |
| _[BundleInfo](../../topics/misc/BundleInfo.md).ReqPermissionDetail | 应用运行时需向系统申请的权限集合的详细信息。 |

#### [SignatureInfo](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo)

type SignatureInfo = _[BundleInfo](../../topics/misc/BundleInfo.md).SignatureInfo

应用包的[签名信息](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__signatureinfo)。
...
| 类型 | 说明 |
| --- | --- |
| _[BundleInfo](../../topics/misc/BundleInfo.md).SignatureInfo | 应用包的签名信息。 |

#### HapModuleInfo

type HapModuleInfo = [_HapModuleInfo.HapModuleInfo](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__hapmoduleinfo-1)
...
| 类型 | 说明 |
| --- | --- |
| [_HapModuleInfo.HapModuleInfo](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__hapmoduleinfo-1) | 模块信息。 |

#### PreloadItem

type PreloadItem = [_HapModuleInfo.PreloadItem](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__preloaditem)
...
| 类型 | 说明 |
| --- | --- |
| [_HapModuleInfo.PreloadItem](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__preloaditem) | 元服务中模块的预加载模块信息。 |

#### Dependency

type Dependency = [_HapModuleInfo.Dependency](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__dependency)
...
| 类型 | 说明 |
| --- | --- |
| [_HapModuleInfo.Dependency](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__dependency) | 模块所依赖的动态共享库信息。 |

#### RouterItem12+

type RouterItem = [_HapModuleInfo.RouterItem](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__routeritem12)
...
| 类型 | 说明 |
| --- | --- |
| [_HapModuleInfo.RouterItem](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__routeritem12) | 模块配置的路由表信息。 |

#### DataItem12+

type DataItem = [_HapModuleInfo.DataItem](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__dataitem12)
...
| 类型 | 说明 |
| --- | --- |
| [_HapModuleInfo.DataItem](../../topics/misc/HapModuleInfo.md#ZH-CN_TOPIC_0000002497444656__dataitem12) | 模块配置的路由表中的自定义数据。 |

#### [AbilityInfo](../../topics/misc/AbilityInfo.md)

type [AbilityInfo](../../topics/misc/AbilityInfo.md) = [_AbilityInfo.AbilityInfo](../../topics/misc/AbilityInfo.md#ZH-CN_TOPIC_0000002497604632__abilityinfo-1)
...
| 类型 | 说明 |
| --- | --- |
| _[AbilityInfo](../../topics/misc/AbilityInfo.md).AbilityInfo | Ability信息。 |

#### WindowSize

type WindowSize = _[AbilityInfo](../../topics/misc/AbilityInfo.md).WindowSize
...
| 类型 | 说明 |
| --- | --- |
| _[AbilityInfo](../../topics/misc/AbilityInfo.md).WindowSize | 窗口尺寸。 |

#### Extension[AbilityInfo](../../topics/misc/AbilityInfo.md)

type Extension[AbilityInfo](../../topics/misc/AbilityInfo.md) = [_ExtensionAbilityInfo.ExtensionAbilityInfo](../../topics/misc/ExtensionAbilityInfo.md#ZH-CN_TOPIC_0000002497604634__extensionabilityinfo-1)
...
| 类型 | 说明 |
| --- | --- |
| _Extension[AbilityInfo](../../topics/misc/AbilityInfo.md).ExtensionAbilityInfo | ExtensionAbility信息。 |

#### ElementName

type ElementName = [_ElementName](../../topics/misc/ElementName.md#ZH-CN_TOPIC_0000002529444599__elementname-1)
...
| 类型 | 说明 |
| --- | --- |
| [_ElementName](../../topics/misc/ElementName.md#ZH-CN_TOPIC_0000002529444599__elementname-1) | ElementName信息。 |

#### Skill12+

type Skill = [_Skill.Skill](../../topics/misc/Skill.md#ZH-CN_TOPIC_0000002497444658__skill-1)
...
| 类型 | 说明 |
| --- | --- |
| [_Skill.Skill](../../topics/misc/Skill.md#ZH-CN_TOPIC_0000002497444658__skill-1) | skill信息。 |

#### SkillUrl12+

type SkillUrl = [_Skill.Skill](../../topics/misc/Skill.md#ZH-CN_TOPIC_0000002497444658__skill-1)Uri
...
| 类型 | 说明 |
| --- | --- |
| [_Skill.Skill](../../topics/misc/Skill.md#ZH-CN_TOPIC_0000002497444658__skill-1)Uri | SkillUri信息。 |

#### [AppCloneIdentity](../../topics/misc/BundleInfo.md#ZH-CN_TOPIC_0000002529284625__appcloneidentity14)15+

type AppCloneIdentity = _[BundleInfo](../../topics/misc/BundleInfo.md).AppCloneIdentity
...
| 类型 | 说明 |
| --- | --- |
| _[BundleInfo](../../topics/misc/BundleInfo.md).AppCloneIdentity | 应用包的身份信息。 |