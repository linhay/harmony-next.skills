...
名称类型只读可选说明context[AccessibilityExtensionContext](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md)否否表示辅助扩展能力上下文。
...
target[AccessibilityElement](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__accessibilityelement9)否是发生事件的目标组件。timeStampnumber否是事件时间戳，单位是毫秒。默认值为0。elementId12+number否是主动聚焦的组件ID。默认值为0。textAnnouncedForAccessibility12+string否是主动播报的内容。当应用需要主动播报时根据实际场景设置播报内容，无特殊限制。extraInfo20+string否是针对TextArea、TextInput、SearchField、RichEdit组件，当文本内容有新增或删除时，携带的文本内容。根据实际场景设置，无特殊限制。

#### AccessibilityElement10+

type AccessibilityElement = _AccessibilityElement

表示无障碍节点元素，请参考[AccessibilityElement](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__accessibilityelement9)。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明_AccessibilityElement表示无障碍节点元素，请参考[AccessibilityElement](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__accessibilityelement9)。
...
表示节点元素具备的属性名称及属性值类型信息，请参考[ElementAttributeValues](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__elementattributevalues)。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明_ElementAttributeValues表示节点元素具备的属性名称及属性值类型信息，请参考[ElementAttributeValues](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__elementattributevalues)。
...
表示查询下一焦点元素的方向，请参考[FocusDirection](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__focusdirection)。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明_FocusDirection表示查询下一焦点元素的方向，请参考[FocusDirection](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__focusdirection)。
...
表示[ElementAttributeValues](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__elementattributevalues)的属性名称。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明keyof [ElementAttributeValues](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__elementattributevalues)表示[ElementAttributeValues](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__elementattributevalues)中所有属性名组成的联合类型。
...
表示查询焦点元素的类型，请参考[FocusType](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__focustype)。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明_FocusType表示查询焦点元素的类型，请参考[FocusType](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__focustype)。
...
表示窗口的类型，请参考[WindowType](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__windowtype)。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明_WindowType表示窗口的类型，请参考[WindowType](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__windowtype)。
...
表示矩形区域，请参考[Rect](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__rect)。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明_Rect表示矩形区域，请参考[Rect](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002529444641__rect)。
...
表示辅助功能扩展的上下文环境，请参考[AccessibilityExtensionContext](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md)。

**系统能力**：SystemCapability.BarrierFree.Accessibility.Core

类型说明_AccessibilityExtensionContext.default表示辅助功能扩展的上下文环境，请参考[AccessibilityExtensionContext](../../topics/graphics/AccessibilityExtensionContext (辅助功能扩展上下文).md)。
