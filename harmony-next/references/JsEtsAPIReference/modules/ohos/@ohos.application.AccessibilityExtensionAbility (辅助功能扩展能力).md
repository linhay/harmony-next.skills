...
表示无障碍节点元素，请参考[AccessibilityElement](AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002553200587__accessibilityelement9)。
...
表示节点元素具备的属性名称及属性值类型信息，请参考[ElementAttributeValues](AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002553200587__elementattributevalues)。
...
表示查询下一焦点元素的方向，请参考[FocusDirection](AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002553200587__focusdirection)。
...
表示[ElementAttributeValues](AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002553200587__elementattributevalues)的属性名称。
...
表示查询焦点元素的类型，请参考[FocusType](AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002553200587__focustype)。
...
表示窗口的类型，请参考[WindowType](AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002553200587__windowtype)。
...
表示矩形区域，请参考[Rect](AccessibilityExtensionContext (辅助功能扩展上下文).md#ZH-CN_TOPIC_0000002553200587__rect)。
