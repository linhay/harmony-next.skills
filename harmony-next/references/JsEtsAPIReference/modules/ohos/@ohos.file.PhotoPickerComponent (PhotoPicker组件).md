...
Picker配置选项，继承自[photoAccessHelper.BaseSelectOptions](../../types/classes/Classes (其他).md#ZH-CN_TOPIC_0000002497605950__baseselectoptions)。
...
gridMargin14+[Margin](../../topics/misc/尺寸设置.md#ZH-CN_TOPIC_0000002497444850__margin)否是

设置组件宫格页margin。

**元服务API：** 从API version 14开始，该接口支持在元服务中使用。

photoBrowserMargin14+[Margin](../../topics/misc/尺寸设置.md#ZH-CN_TOPIC_0000002497444850__margin)否是
...
参数名类型必填说明uristring是动态照片uri。state[photoAccessHelper.MovingPhotoBadgeStateType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__movingphotobadgestatetype22)是动态照片状态。
...
参数名类型必填说明trustedUrisArray<string>是需要保存到图库的应用沙箱图片/视频uri。trustedUris一般来自[replacePhotoPickerPreview](#ZH-CN_TOPIC_0000002497605958__replacephotopickerpreview15)替换显示成功的newUri。callbackAsyncCallback<Array<string>>是返回保存后新生成的媒体库文件对应的uri。configsArray<[photoAccessHelper.PhotoCreationConfig](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__photocreationconfig12)>否
...
photoSubType21+[photoAccessHelper.PhotoSubtype](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__photosubtype12)否是
...
dynamicRangeType21+[photoAccessHelper.DynamicRangeType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__dynamicrangetype12)否是
...
movingPhotoBadgeState22+[photoAccessHelper.MovingPhotoBadgeStateType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__movingphotobadgestatetype22)否是
...
VideoMode22+[photoAccessHelper.VideoMode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__videomode22)否是
...
名称类型只读可选说明itemDisplayRatio[ItemDisplayRatio](#ZH-CN_TOPIC_0000002497605958__itemdisplayratio20)否是宫格显示宽高比，支持1:1，原图宽高比两种模式，默认为宽高比1:1显示。itemBorderRadius[Length](../../topics/misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length) | [BorderRadiuses](../../topics/misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__borderradiuses9) | [LocalizedBorderRadiuses](../../topics/misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedborderradiuses12)否是宫格圆角属性。itemGap[Length](../../topics/misc/基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是宫格间距。
...
名称类型只读可选说明mimeType[photoAccessHelper.PhotoViewMIMETypes](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__photoviewmimetypes)否是

可选择的媒体文件类型。

若无此参数，则默认为图片和视频类型。

mimeTypeFilter[photoAccessHelper.MimeTypeFilter](../../types/classes/Classes (其他).md#ZH-CN_TOPIC_0000002497605950__mimetypefilter19)否是
...
singleSelectionMode[photoAccessHelper.SingleSelectionMode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__singleselectionmode18)否是单选模式类型。默认为大图预览模式（SingleSelectionMode.BROWSER_MODE）。isRepeatSelectSupportedboolean否是
