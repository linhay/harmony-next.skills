...
应用接入数据备份恢复需要通过BackupExtensionAbility实现，开发者可以通过[onBackup](#ZH-CN_TOPIC_0000002553361141__onbackup)，[onRestore](#ZH-CN_TOPIC_0000002553361141__onrestore)来实现自定义的备份恢复操作。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context11+ | Backup[ExtensionContext](../../topics/misc/ExtensionContext.md) | 否 | 否 | BackupExtensionAbility的上下文环境，继承自ExtensionContext。 |
