...
名称类型只读可选说明pickRect[Rect](#ZH-CN_TOPIC_0000002529444771__rect)否否表示截取图像的区域。pixelMap[image.PixelMap](../../types/interfaces/Interface (PixelMap).md)否否表示截取的图像PixelMap对象。
...
类型说明Promise<[image.PixelMap](../../types/interfaces/Interface (PixelMap).md)>Promise对象。返回一个PixelMap对象。
