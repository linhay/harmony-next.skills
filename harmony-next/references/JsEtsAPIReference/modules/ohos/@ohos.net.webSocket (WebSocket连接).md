...
以下错误码的详细介绍参见[webSocket错误码](../../errors/webSocket错误码.md)和[通用错误码](../../errors/通用错误码.md)。
...
以下错误码的详细介绍参见[通用错误码](../../errors/通用错误码.md)。
...
可通过监听error事件获得该接口的执行结果，错误码说明参见[webSocket错误码](../../errors/webSocket错误码.md)。
...
以下错误码的详细介绍请参见[通用错误码](../../errors/通用错误码.md)和[webSocket错误码](../../errors/webSocket错误码.md)。
