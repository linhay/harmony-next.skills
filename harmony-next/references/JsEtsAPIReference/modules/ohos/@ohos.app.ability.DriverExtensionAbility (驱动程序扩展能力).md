...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [DriverExtensionContext](../../topics/misc/DriverExtensionContext.md) | 否 | 否 | DriverExtension的上下文环境，继承自ExtensionContext。 |
...
#### [DriverExtensionContext](../../topics/misc/DriverExtensionContext.md)

type [DriverExtensionContext](../../topics/misc/DriverExtensionContext.md) = _DriverExtensionContext;
...
| 类型 | 说明 |
| --- | --- |
| _[DriverExtensionContext](../../topics/misc/DriverExtensionContext.md) | DriverExtensionAbility的上下文环境，继承自ExtensionContext，其具体使用方法可参考DriverExtensionContext。 |