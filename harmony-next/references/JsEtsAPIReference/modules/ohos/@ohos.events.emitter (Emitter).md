...
该接口支持跨线程传输数据对象，需要遵循数据跨线程传输的规格约束，详见[线程间通信对象](../../guides/线程间通信对象概述.md)。目前不支持使用[@State装饰器](@ohos.arkui.StateManagement (状态管理).md)、[@Observed装饰器](../../guides/@Observed与@ObjectLink：V1数据对象观测.md)等装饰器修饰的复杂类型数据。
