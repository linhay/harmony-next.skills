...
以下错误码的详细介绍请参见[Socket错误码](../../errors/SOCKET 错误码.md)和[通用错误码](../../errors/通用错误码.md)。
...
以下错误码的详细介绍请参见[Socket错误码](../../errors/SOCKET 错误码.md)。
...
错误码的详细介绍参见[Socket错误码](../../errors/SOCKET 错误码.md)。
