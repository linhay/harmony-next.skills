...
后台读卡是指不需要打开应用程序，电子设备通过NFC读取标签卡片后，根据标签卡片的类型匹配到一个或多个应用程序。如果仅匹配到一个，则直接拉起应用程序的读卡页面；如果是多个则弹出应用选择器，让用户选择指定的读卡应用。后台读卡不涉及tag相关接口，示例参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md#后台读取标签)。

前台读卡是指提前打开应用程序，并进入对应的NFC读卡页面后读卡，只会把读到的标签卡片信息分发给前台应用程序。

1. 本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
1. 调用本模块接口和常量时请使用canIUse("SystemCapability.Communication.NFC.Tag")判断设备是否支持NFC能力，否则可能导致应用运行稳定性问题，参考[nfc-tag开发指南](../../guides/NFC标签读写开发指南.md)。
...
在对相关Tag类型卡片进行读写之前，必须先获取[TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)相关属性值，以确认设备读取到的Tag卡片支持哪些技术类型。这样Tag应用程序才能调用正确的接口和所读取到的Tag卡片进行通信。
...
getNfcATag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcATag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcatag)

获取NFC A类型Tag对象，通过该对象可访问NfcA技术类型的Tag。


从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getNfcA](#ZH-CN_TOPIC_0000002553361371__taggetnfca9)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tagInfo | TagInfo | 是 | 包含Tag技术类型和相关参数，从tag.getTagInfo(want: Want)获取。 |
...
getNfcA(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcATag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcatag)
...
getNfcBTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcBTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcbtag)

获取NFC B类型Tag对象，通过该对象可访问NfcB技术类型的Tag。


从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getNfcB](#ZH-CN_TOPIC_0000002553361371__taggetnfcb9)替代。
...
getNfcB(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcBTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcbtag)
...
getNfcFTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcFTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcftag)

获取NFC F类型Tag对象，通过该对象可访问NfcF技术类型的Tag。


从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getNfcF](#ZH-CN_TOPIC_0000002553361371__taggetnfcf9)替代。
...
getNfcF(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcFTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcftag)
...
getNfcVTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcVTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcvtag)

获取NFC V类型Tag对象，通过该对象可访问NfcV技术类型的Tag。


从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getNfcV](#ZH-CN_TOPIC_0000002553361371__taggetnfcv9)替代。
...
getNfcV(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NfcVTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__nfcvtag)
...
getIsoDep(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [IsoDepTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__isodeptag9)
...
getNdef(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NdefTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__ndeftag9)
...
getMifareClassic(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [MifareClassicTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__mifareclassictag9)
...
getMifareUltralight(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [MifareUltralightTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__mifareultralighttag9)
...
getNdefFormatable(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [NdefFormatableTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__ndefformatabletag9)
...
getBarcodeTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)): [BarcodeTag](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__barcodetag18)
...
getTagInfo(want: [Want](@ohos.app.ability.Want (Want).md#ZH-CN_TOPIC_0000002553360483__want)): [TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | Want | 是 | 分发Ability时，在系统onCreate入口函数的参数中获取。 |
...
registerForegroundDispatch(elementName: [ElementName](ElementName.md), discTech: number[], callback: AsyncCallback<[TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)>): void

注册对NFC Tag读卡事件的监听，实现前台应用优先分发的目的。通过discTech设置支持的读卡技术类型，通过callback方式获取读取到Tag的[TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)信息。应用必须在前台才能调用。需要与取消监听接口[tag.unregisterForegroundDispatch](#ZH-CN_TOPIC_0000002553361371__tagunregisterforegrounddispatch10)成对使用。如果已注册事件监听，需要在页面退出前台或页面销毁前调用取消注册。使用callback异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementName | [ElementName](../../topics/misc/ElementName.md) | 是 | 所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值），不可以为空。 |
...
| callback | AsyncCallback<TagInfo> | 是 | 前台读卡监听回调函数，返回读到的Tag信息，不可以为空。 |
...
示例请参见[tag.unregisterForegroundDispatch](#ZH-CN_TOPIC_0000002553361371__tagunregisterforegrounddispatch10)接口的示例。
...
on(type: 'readerMode', elementName: [ElementName](ElementName.md), discTech: number[], callback: AsyncCallback<[TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)>): void

订阅NFC Tag读卡事件，实现前台应用优先分发。设备会进入读卡器模式，同时关闭卡模拟。通过discTech设置支持的读卡技术类型，通过callback方式获取到Tag的[TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)信息。需要与取消读卡器模式的[tag.off](#ZH-CN_TOPIC_0000002553361371__tagoff11)成对使用，如果已通过on进行设置，需要在页面退出前台或页面销毁时调用[tag.off](#ZH-CN_TOPIC_0000002553361371__tagoff11)。使用callback异步回调。
...
示例请参见[tag.off](#ZH-CN_TOPIC_0000002553361371__tagoff11)接口的示例。

#### tag.off11+

off(type: 'readerMode', elementName: [ElementName](ElementName.md), callback?: AsyncCallback<[TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)>): void

取消订阅NFC Tag读卡事件。设备退出读卡模式，并恢复卡模拟。如果已通过[tag.on](#ZH-CN_TOPIC_0000002553361371__tagon11)设置NFC的读卡器模式，需要在页面退出前台或页面销毁时调用off进行取消。
...
on(type: 'readerModeWithInterval', elementName: [ElementName](../../topics/misc/ElementName.md), discTech: number[], callback: AsyncCallback<TagInfo>, interval: number): void

订阅NFC Tag读卡事件，实现前台应用优先分发，并支持卡在位检测间隔设置。使用callback异步回调。

- 设备会进入读卡器模式，同时关闭卡模拟。

- 通过discTech设置支持的读卡技术类型，通过callback方式获取到Tag的[TagInfo](#ZH-CN_TOPIC_0000002553361371__taginfo)信息，通过interval设置卡在位检测间隔。

- 需要与取消读卡器模式的[tag.off](#ZH-CN_TOPIC_0000002553361371__tagoff23)成对使用，如果已通过on进行设置，需要在页面退出前台或页面销毁时调用[tag.off](#ZH-CN_TOPIC_0000002553361371__tagoff23)。
...
| elementName | [ElementName](../../topics/misc/ElementName.md) | 是 | 所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值）。 |
...
| callback | AsyncCallback<TagInfo> | 是 | 读卡器模式监听回调函数，返回读到的Tag信息。 |
...
示例请参见[tag.off](#ZH-CN_TOPIC_0000002553361371__tagoff23)接口的示例。

**tag.off23+**

off(type: 'readerModeWithInterval', elementName: [ElementName](../../topics/misc/ElementName.md), callback: AsyncCallback<TagInfo>): void

取消订阅NFC Tag读卡事件。设备退出读卡模式，并恢复卡模拟。如果已通过[tag.on](#ZH-CN_TOPIC_0000002553361371__tagon23)设置NFC的读卡器模式，需要在页面退出前台或页面销毁时调用off进行取消。使用callback异步回调。
...
messageToBytes(ndefMessage: [NdefMessage](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__ndefmessage9)): number[]
...
createNdefMessage(data: number[]): [NdefMessage](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__ndefmessage9)
...
createNdefMessage(ndefRecords: NdefRecord[]): [NdefMessage](nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002553361375__ndefmessage9)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ndefRecords | NdefRecord[] | 是 | NDEF标签的Record列表，详见NDEF技术规范《NFCForum-TS-NDEF_1.0》。 |
...
| supportedProfiles(deprecated) | number[] | 否 | 否 | 支持的技术类型。 说明： 从API version 7开始支持，从API version 9开始废弃，使用tag.TagInfo#technology替代。 |
...
| 类型 | 说明 |
| --- | --- |
| _NfcATag | NfcATag 提供 NFC-A(ISO 14443-3A)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _NfcBTag | NfcBTag 提供 NFC-B(ISO 14443-3B)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _NfcFTag | NfcFTag 提供对 NFC-F(JIS 6319-4)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _NfcVTag | NfcVTag 提供对 NFC-V(ISO 15693)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _IsoDepTag | IsoDepTag 提供 ISO-DEP(ISO 14443-4)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _NdefTag | 提供对已格式化为NDEF的NFC标签的数据和操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _MifareClassicTag | MifareClassicTag提供对MIFARE Classic属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _MifareUltralightTag | MifareUltralightTag 提供对MIFARE Ultralight属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _NdefFormatableTag | NdefFormatableTag为NDEF Formattable的标签提供格式化操作。 |
...
| 类型 | 说明 |
| --- | --- |
| _BarcodeTag | 提供对条形码标签的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| _TagSession | TagSession是所有NFC Tag技术类型的基类， 提供建立连接和发送数据等共同接口。 |