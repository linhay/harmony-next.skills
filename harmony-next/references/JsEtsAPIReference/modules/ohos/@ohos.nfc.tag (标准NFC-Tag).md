...
getNfcATag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcATag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcatag)
...
**类型****说明**[NfcATag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcatag)NFC A类型Tag对象。

#### tag.getNfcA9+

getNfcA(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcATag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcatag)
...
getNfcBTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcBTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcbtag)
...
**类型****说明**[NfcBTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcbtag)NFC B类型Tag对象。

#### tag.getNfcB9+

getNfcB(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcBTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcbtag)
...
getNfcFTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcFTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcftag)
...
**类型****说明**[NfcFTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcftag)NFC F类型Tag对象。

#### tag.getNfcF9+

getNfcF(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcFTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcftag)
...
getNfcVTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcVTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcvtag)
...
**类型****说明**[NfcVTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcvtag)NFC V类型Tag对象。

#### tag.getNfcV9+

getNfcV(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NfcVTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcvtag)
...
getIsoDep(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [IsoDepTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__isodeptag9)
...
**类型****说明**[IsoDepTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__isodeptag9)IsoDep类型Tag对象，通过该对象访问IsoDep类型的相关接口。
...
getNdef(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NdefTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndeftag9)
...
**类型****说明**[NdefTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndeftag9)NDEF类型Tag对象，通过该对象访问NDEF类型的相关接口。
...
getMifareClassic(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [MifareClassicTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__mifareclassictag9)
...
**类型****说明**[MifareClassicTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__mifareclassictag9)MIFARE Classic类型Tag对象，通过该对象访问MIFARE Classic类型的相关接口。
...
getMifareUltralight(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [MifareUltralightTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__mifareultralighttag9)
...
**类型****说明**[MifareUltralightTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__mifareultralighttag9)MIFARE Ultralight类型Tag对象，通过该对象访问MIFARE Ultralight类型的相关接口。
...
getNdefFormatable(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [NdefFormatableTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefformatabletag9)
...
**类型****说明**[NdefFormatableTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefformatabletag9)NDEF Formatable类型Tag对象，通过该对象访问NDEF Formatable类型的相关接口。
...
getBarcodeTag(tagInfo: [TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)): [BarcodeTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__barcodetag18)
...
类型说明[BarcodeTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__barcodetag18)BarcodeTag类型Tag对象。
...
registerForegroundDispatch(elementName: [ElementName](../../topics/misc/ElementName.md), discTech: number[], callback: AsyncCallback<[TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)>): void
...
unregisterForegroundDispatch(elementName: [ElementName](../../topics/misc/ElementName.md)): void
...
参数名类型必填说明elementName[ElementName](../../topics/misc/ElementName.md)是所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值），不可以为空。
...
on(type: 'readerMode', elementName: [ElementName](../../topics/misc/ElementName.md), discTech: number[], callback: AsyncCallback<[TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)>): void
...
off(type: 'readerMode', elementName: [ElementName](../../topics/misc/ElementName.md), callback?: AsyncCallback<[TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)>): void
...
参数名类型必填说明typestring是要注销的回调类型，固定填"readerMode"字符串。elementName[ElementName](../../topics/misc/ElementName.md)是所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值），不可以为空。callbackAsyncCallback<[TagInfo](#ZH-CN_TOPIC_0000002529445389__taginfo)>否前台读卡监听回调函数，返回读到的Tag信息。
...
messageToBytes(ndefMessage: [NdefMessage](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefmessage9)): number[]
...
参数名类型必填说明ndefMessage[NdefMessage](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefmessage9)是NDEF消息数据对象。
...
createNdefMessage(data: number[]): [NdefMessage](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefmessage9)
...
**类型****说明**[NdefMessage](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefmessage9)NDEF标签的Message，详见NDEF技术规范《NFCForum-TS-NDEF_1.0》。
...
createNdefMessage(ndefRecords: NdefRecord[]): [NdefMessage](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefmessage9)
...
类型说明[_NfcATag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcatag)NfcATag 提供 NFC-A(ISO 14443-3A)技术的属性和I/O操作的访问。
...
类型说明[_NfcBTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcbtag)NfcBTag 提供 NFC-B(ISO 14443-3B)技术的属性和I/O操作的访问。
...
类型说明[_NfcFTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcftag)NfcFTag 提供对 NFC-F(JIS 6319-4)技术的属性和I/O操作的访问。
...
类型说明[_NfcVTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__nfcvtag)NfcVTag 提供对 NFC-V(ISO 15693)技术的属性和I/O操作的访问。
...
类型说明[_IsoDepTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__isodeptag9)IsoDepTag 提供 ISO-DEP(ISO 14443-4)技术的属性和I/O操作的访问。
...
类型说明[_NdefTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndeftag9)提供对已格式化为NDEF的NFC标签的数据和操作的访问。
...
类型说明[_MifareClassicTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__mifareclassictag9)MifareClassicTag提供对MIFARE Classic属性和I/O操作的访问。
...
类型说明[_MifareUltralightTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__mifareultralighttag9)MifareUltralightTag 提供对MIFARE Ultralight属性和I/O操作的访问。
...
类型说明[_NdefFormatableTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefformatabletag9)NdefFormatableTag为NDEF Formattable的标签提供格式化操作。
...
类型说明[_BarcodeTag](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__barcodetag18)提供对条形码标签的属性和I/O操作的访问。
...
类型说明[_NdefMessage](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md#ZH-CN_TOPIC_0000002497605426__ndefmessage9)获取NDEF消息中的所有记录。
...
类型说明[_TagSession](../../topics/misc/tagSession (标准NFC-Tag TagSession).md#ZH-CN_TOPIC_0000002497445448__tagsession)TagSession是所有[NFC Tag技术类型](../../topics/misc/nfctech (标准NFC-Tag Nfc 技术).md)的基类， 提供建立连接和发送数据等共同接口。