...
publish(request: [NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1), callback: AsyncCallback<void>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1) | 是 | 设置发布通知的内容和相关配置信息。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当发布通知成功，err为undefined，否则为错误对象。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码]([通用错误码](../../errors/通用错误码.md).md)、[通知错误码]([通知错误码](../../errors/通知错误码.md).md)、[HTTP错误码]([HTTP错误码](../../errors/HTTP错误码.md).md)。
...
publish(request: [NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)): Promise<void>
...
getSlot(slotType: SlotType, callback: AsyncCallback<[NotificationSlot](../../topics/misc/NotificationSlot.md)>): void
...
| callback | AsyncCallback<[NotificationSlot](../../topics/misc/NotificationSlot.md)> | 是 | 回调函数。当获取通知渠道成功，err为undefined，data为获取到的NotificationSlot，否则为错误对象。 |
...
getSlot(slotType: SlotType): Promise<[NotificationSlot](../../topics/misc/NotificationSlot.md)>
...
| 类型 | 说明 |
| --- | --- |
| Promise<[NotificationSlot](../../topics/misc/NotificationSlot.md)> | Promise对象，返回通知渠道对象。 |
...
getSlots(callback: AsyncCallback<Array<[NotificationSlot](../../topics/misc/NotificationSlot.md)>>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[NotificationSlot](../../topics/misc/NotificationSlot.md)>> | 是 | 回调函数。当获取通知渠道成功，err为undefined，data为获取到的NotificationSlot数组，否则为错误对象。 |
...
getSlots(): Promise<Array<[NotificationSlot](../../topics/misc/NotificationSlot.md)>>
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[NotificationSlot](../../topics/misc/NotificationSlot.md)>> | Promise对象，返回通知渠道对象。 |
...
以下错误码的详细介绍请参见[通用错误码](通用错误码.md)、[通知错误码](通知错误码.md)、[包管理子系统通用错误码]([包管理子系统通用错误码](../../errors/包管理子系统通用错误码.md).md)。
...
getActiveNotifications(callback: AsyncCallback<Array<[NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)>>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)>> | 是 | 回调函数。当获取未删除的通知列表成功，err为undefined，data为获取到的通知列表，否则为错误对象。 |
...
getActiveNotifications(): Promise<Array<[NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)>>
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)>> | Promise对象，返回当前应用的通知列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| groupName | string | 是 | 通知组名称，此名称需要在发布通知时通过[NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)对象指定。 |
...
requestEnableNotification(context: [UIAbilityContext](../../topics/misc/UIAbilityContext.md), callback: AsyncCallback<void>): void

应用需要获取用户授权才能发送通知。在通知发布前调用该接口，可以拉起通知授权弹窗，让用户选择是否允许发送通知。使用callback异步回调。


- 仅当应用界面加载完成后（即调用[loadContent](@ohos.app.ability.UIExtensionContentSession (UIExtensionAbility界面操作类).md#ZH-CN_TOPIC_0000002522080542__loadcontent)成功），方可使用该接口。

- 在使用该接口拉起通知授权弹窗后，如果用户拒绝授权，将无法使用该接口再次拉起弹窗。开发者可以调用[openNotificationSettings](#ZH-CN_TOPIC_0000002553202383__notificationmanageropennotificationsettings13)二次申请授权，拉起通知管理弹窗。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](../../topics/misc/UIAbilityContext.md) | 是 | 通知弹窗绑定Ability的上下文。 |
...
requestEnableNotification(context: [UIAbilityContext](../../topics/misc/UIAbilityContext.md)): Promise<void>
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](../../topics/misc/UIAbilityContext.md) | 是 | 通知弹窗绑定的Ability上下文。 |
...
从API version 9开始支持，从API version 12开始废弃，建议使用有context入参的[requestEnableNotification](#ZH-CN_TOPIC_0000002553202383__notificationmanagerrequestenablenotification10)替代。
...
从API version 9开始支持，从API version 12开始废弃，建议使用有context入参的[requestEnableNotification](#ZH-CN_TOPIC_0000002553202383__notificationmanagerrequestenablenotification10-1)替代。
...
openNotificationSettings(context: [UIAbilityContext](../../topics/misc/UIAbilityContext.md)): Promise<void>
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](../../topics/misc/UIAbilityContext.md) | 是 | 通知设置页面绑定Ability的上下文。 |
...
type BundleOption = [_BundleOption](../../topics/misc/NotificationCommonDef.md#ZH-CN_TOPIC_0000002529446079__bundleoption)
...
| 类型 | 说明 |
| --- | --- |
| [_BundleOption](../../topics/misc/NotificationCommonDef.md#ZH-CN_TOPIC_0000002529446079__bundleoption) | 指定应用的包信息。 |

#### NotificationActionButton

type NotificationActionButton = [_NotificationActionButton](../../topics/misc/NotificationActionButton.md)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationActionButton](../../topics/misc/NotificationActionButton.md) | 通知中显示的操作按钮。 |

#### NotificationBasicContent

type NotificationBasicContent = [_NotificationBasicContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationbasiccontent)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationBasicContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationbasiccontent) | 描述普通文本通知。 |

#### NotificationContent

type NotificationContent = [_NotificationContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationcontent-1)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationcontent-1) | 描述通知内容。 |

#### NotificationLongTextContent

type NotificationLongTextContent = [_NotificationLongTextContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationlongtextcontent)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationLongTextContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationlongtextcontent) | 描述长文本通知。 |

#### NotificationMultiLineContent

type NotificationMultiLineContent = [_NotificationMultiLineContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationmultilinecontent)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationMultiLineContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationmultilinecontent) | 描述多行文本通知。 |

#### NotificationPictureContent

type NotificationPictureContent = [_NotificationPictureContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationpicturecontent)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationPictureContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationpicturecontent) | 附有图片的通知。 |

#### NotificationSystemLiveViewContent11+

type NotificationSystemLiveViewContent = [_NotificationSystemLiveViewContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationsystemliveviewcontent)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationSystemLiveViewContent](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationsystemliveviewcontent) | 系统实况窗通知内容。 |

#### [NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)

type [NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1) = [_NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1)
...
| 类型 | 说明 |
| --- | --- |
| _[NotificationRequest](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__notificationrequest-1) | 通知请求。 |

#### DistributedOptions

type DistributedOptions = [_DistributedOptions](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__distributedoptions8)
...
| 类型 | 说明 |
| --- | --- |
| [_DistributedOptions](../../topics/misc/NotificationRequest.md#ZH-CN_TOPIC_0000002497606118__distributedoptions8) | 分布式选项。 |

#### [NotificationSlot](../../topics/misc/NotificationSlot.md)

type [NotificationSlot](../../topics/misc/NotificationSlot.md) = [_NotificationSlot](../../topics/misc/NotificationSlot.md)
...
| 类型 | 说明 |
| --- | --- |
| _[NotificationSlot](../../topics/misc/NotificationSlot.md) | 通知渠道。 |

#### NotificationTemplate

type NotificationTemplate = [_NotificationTemplate](../../topics/misc/NotificationTemplate.md)

[通知模板](../../topics/misc/NotificationTemplate.md)。

**系统能力**： SystemCapability.Notification.Notification

| 类型 | 说明 |
| --- | --- |
| _NotificationTemplate | [通知模板](../../topics/misc/NotificationTemplate.md)。 |

#### NotificationUserInput

type NotificationUserInput = [_NotificationUserInput](../../topics/misc/NotificationUserInput.md)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationUserInput](../../topics/misc/NotificationUserInput.md) | 保存用户输入的通知消息。 |

#### NotificationCapsule11+

type NotificationCapsule = [_NotificationCapsule](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationcapsule11)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationCapsule](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationcapsule11) | 通知胶囊。 |

#### NotificationButton11+

type NotificationButton = [_NotificationButton](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationbutton11)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationButton](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationbutton11) | 通知按钮。 |

#### NotificationTime11+

type NotificationTime = [_NotificationTime](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationtime11)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationTime](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationtime11) | 描述通知计时信息。 |

#### NotificationProgress11+

type NotificationProgress = [_NotificationProgress](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationprogress11)
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationProgress](../../topics/misc/NotificationContent.md#ZH-CN_TOPIC_0000002497606116__notificationprogress11) | 描述通知进度。 |
