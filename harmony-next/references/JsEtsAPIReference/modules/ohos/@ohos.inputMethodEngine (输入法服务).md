...
参数名类型必填说明size[window.Size](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__size7)是当前面板大小。keyboardArea[KeyboardArea](#ZH-CN_TOPIC_0000002529445255__keyboardarea15)否当前面板中可作为键盘区域的大小。
...
输入法面板不支持创建子窗口。例如：不支持使用[window.createWindow](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-window-fa#设置应用子窗口)、[bindContextMenu](../../topics/misc/菜单控制.md#ZH-CN_TOPIC_0000002497604848__bindcontextmenu8)、[CustomDialog](../../topics/components/自定义弹窗 (CustomDialog).md)等接口创建子窗口弹窗。建议开发者采用非子窗的替代方案，如[弹出框](../../topics/components/弹出框 (Dialog).md)、[bindMenu](../../topics/misc/菜单控制.md#ZH-CN_TOPIC_0000002497604848__bindmenu)或设置showInSubwindow为false。

**系统能力：** SystemCapability.MiscServices.InputMethodFramework

**参数：**

参数名类型必填说明ctx[BaseContext](../../topics/graphics/BaseContext.md)是当前输入法应用上下文信息。info[PanelInfo](#ZH-CN_TOPIC_0000002529445255__panelinfo10)是输入法面板信息。callbackAsyncCallback<[Panel](#ZH-CN_TOPIC_0000002529445255__panel10)>是回调函数。当输入法面板创建成功，返回当前创建的输入法面板对象。
...
参数名类型必填说明ctx[BaseContext](../../topics/graphics/BaseContext.md)是当前输入法应用上下文信息。info[PanelInfo](#ZH-CN_TOPIC_0000002529445255__panelinfo10)是输入法面板信息。
...
参数名类型必填说明pathstring是LocalStorage相关联的具体页面的路径。storage[LocalStorage](../../topics/misc/应用级变量的状态管理.md#ZH-CN_TOPIC_0000002529284961__localstorage9)是存储单元，为应用程序范围内的可变和不可变状态属性提供存储。callbackAsyncCallback<void>是回调函数。当面板页面内容加载成功，err为undefined，否则err为错误对象。
...
参数名类型必填说明pathstring是设置加载页面的路径。storage[LocalStorage](../../topics/misc/应用级变量的状态管理.md#ZH-CN_TOPIC_0000002529284961__localstorage9)是存储单元，为应用程序范围内的可变状态属性和非可变状态属性提供存储。
...
参数名类型必填说明inputRegionArray<[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)>是
...
- 从API version 12-14开始支持，此接口回调函数中仅包含[window.Size](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__size7)类型的必选参数。
...
以下错误码的详细介绍请参见[通用错误码说明文档](../../errors/通用错误码.md)和[输入法框架错误码](../../errors/输入法框架错误码.md)。
...
bundleName14+string是是编辑框所属应用包名；该值可能为""，使用该属性时需要考虑为""的场景。immersiveMode15+[ImmersiveMode](#ZH-CN_TOPIC_0000002529445255__immersivemode15)是是输入法沉浸模式。windowId18+number是是编辑框设置所属窗口ID。displayId18+number是是编辑框设置窗口对应的屏幕ID。如果没有设置windowId，取当前焦点窗口屏幕ID。placeholder20+string是是编辑框设置的占位符信息。abilityName20+string是是编辑框设置的ability名称。capitalizeMode20+[CapitalizeMode](#ZH-CN_TOPIC_0000002529445255__capitalizemode20)是是编辑框设置大小写模式。如果没有设置或设置非法值，默认不进行任何首字母大写处理。gradientMode20+[GradientMode](#ZH-CN_TOPIC_0000002529445255__gradientmode20)是是渐变模式。如果没有设置或设置非法值，默认不使用渐变模式。extraConfig22+[InputMethodExtraConfig](@ohos.inputMethod.ExtraConfig (输入法扩展信息).md#ZH-CN_TOPIC_0000002497445312__inputmethodextraconfig)是是输入法扩展信息。
...
名称类型只读可选说明landscapeRect[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)否否横屏状态时输入法面板窗口的位置大小。portraitRect[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)否否竖屏状态时输入法面板窗口的位置大小。
...
名称类型只读可选说明landscapeRect[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)否是

横屏状态时输入法面板窗口的位置大小。

- 当fullScreenMode不填写或值为false时，此属性为必选。

portraitRect[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)否是
...
landscapeInputRegionArray<[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)>否是
...
portraitInputRegionArray<[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)>否是
...
名称类型只读可选说明rect[window.Rect](../../types/interfaces/Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__rect7)否否窗口矩形区域。status[window.WindowStatusType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529444769__windowstatustype11)否否窗口模式类型。
