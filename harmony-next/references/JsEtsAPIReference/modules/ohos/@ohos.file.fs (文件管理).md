...
接口抛出错误码的详细介绍请参见[基础文件IO错误码](../../errors/文件管理错误码.md#ZH-CN_TOPIC_0000002529445241__基础文件io错误码)和[通用错误码](../../errors/通用错误码.md)。
...
- [13900046](../../errors/文件管理错误码.md#ZH-CN_TOPIC_0000002529445241__13900046-软件造成连接中断)：软件造成连接中断。
...
文件可读流，需要先通过[fs.createReadStream](#ZH-CN_TOPIC_0000002529445221__fscreatereadstream12)方法来构建一个ReadStream实例。ReadStream继承自数据流基类[stream](@ohos.util.stream (数据流基类stream).md#ZH-CN_TOPIC_0000002497444782__readable)。
...
文件可写流，需要先通过[fs.createWriteStream](#ZH-CN_TOPIC_0000002529445221__fscreatewritestream12)方法来构建一个WriteStream实例。WriteStream继承自数据流基类[stream](@ohos.util.stream (数据流基类stream).md#ZH-CN_TOPIC_0000002497444782__writable)。
