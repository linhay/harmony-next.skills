...
为[UIExtensionAbility](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md)组件加载页面，支持通过[LocalStorage](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-localstorage)传递状态属性给被加载的页面。该接口用于开发者在UIExtensionAbility组件的[onSessionCreate](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md#ZH-CN_TOPIC_0000002553200505__onsessioncreate)生命周期中加载页面。
...
为[UIExtensionAbility](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md)组件加载[命名路由](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-routing#命名路由)页面，支持通过[LocalStorage](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-localstorage)传递状态属性给被加载的页面。该接口用于开发者在UIExtensionAbility组件的[onSessionCreate](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md#ZH-CN_TOPIC_0000002553200505__onsessioncreate)生命周期中加载命名路由页面。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [AbilityResult](../../topics/misc/AbilityResult.md) | 是 | 返回给宿主应用的信息。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当接口调用成功，err为undefined，否则为错误对象。 |
...
startAbilityByType(type: string, wantParam: Record<string, Object>, abilityStartCallback: [AbilityStartCallback](../../topics/misc/AbilityStartCallback.md), callback: AsyncCallback<void>): void
...
| abilityStartCallback | [AbilityStartCallback](../../topics/misc/AbilityStartCallback.md) | 是 | 表示启动UIExtensionAbility组件的执行结果。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当接口调用成功，err为undefined，否则为错误对象。 |
...
startAbilityByType(type: string, wantParam: Record<string, Object>, abilityStartCallback: [AbilityStartCallback](../../topics/misc/AbilityStartCallback.md)): Promise<void>
