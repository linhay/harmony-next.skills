...
为[UIExtensionAbility](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md)组件加载页面，支持通过[LocalStorage](../../topics/components/应用级变量的状态管理.md)传递状态属性给被加载的页面。该接口用于开发者在UIExtensionAbility组件的[onSessionCreate](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md#ZH-CN_TOPIC_0000002553200505__onsessioncreate)生命周期中加载页面。
...
为[UIExtensionAbility](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md)组件加载[命名路由](../../types/classes/Class (Router).md)页面，支持通过[LocalStorage](../../topics/components/应用级变量的状态管理.md)传递状态属性给被加载的页面。该接口用于开发者在UIExtensionAbility组件的[onSessionCreate](@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件).md#ZH-CN_TOPIC_0000002553200505__onsessioncreate)生命周期中加载命名路由页面。
