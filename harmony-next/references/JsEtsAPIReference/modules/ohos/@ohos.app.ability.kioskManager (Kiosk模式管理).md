...
- 本模块接口仅适用于通过[setAllowedKioskApps接口](@ohos.enterprise.applicationManager（应用管理）.md#ZH-CN_TOPIC_0000002522081688__applicationmanagersetallowedkioskapps20)配置的支持Kiosk模式的应用。
...
enterKioskMode(context: [UIAbilityContext](../../topics/misc/UIAbilityContext.md)): Promise<void>
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](../../topics/misc/UIAbilityContext.md) | 是 | 需要进入kiosk模式的UIAbility的上下文。 |
...
exitKioskMode(context: [UIAbilityContext](../../topics/misc/UIAbilityContext.md)): Promise<void>
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](../../topics/misc/UIAbilityContext.md) | 是 | 需要退出kiosk模式的UIAbility的上下文。 |
...
| 类型 | 说明 |
| --- | --- |
| _KioskStatus | 表示Kiosk状态信息，包括系统是否处于Kiosk模式以及该模式下的应用信息。 |