...
字幕配置管理，在调用CaptionsManager的方法前，需要先通过 [accessibility.getCaptionsManager() ](#ZH-CN_TOPIC_0000002553200585__accessibilitygetcaptionsmanagerdeprecated)获取 CaptionsManager实例。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | EventType | 否 | 否 | 无障碍事件类型，不可缺省。 |
...
| triggerAction | Action | 否 | 否 | 触发事件的Action，不可缺省。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[accessibility.getAccessibilityExtensionList](#ZH-CN_TOPIC_0000002553200585__accessibilitygetaccessibilityextensionlist9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[accessibility.getAccessibilityExtensionList](#ZH-CN_TOPIC_0000002553200585__accessibilitygetaccessibilityextensionlist9-1)替代。
...
监听辅助应用启用状态变化事件，使用callback异步回调。如需获取系统内辅助应用信息，推荐使用[accessibility.getAccessibilityExtensionListSync](#ZH-CN_TOPIC_0000002553200585__accessibilitygetaccessibilityextensionlistsync12)。
...
监听触摸浏览功能启用状态变化事件，使用callback异步回调。如需获取系统内辅助应用信息，推荐使用[accessibility.getAccessibilityExtensionListSync](#ZH-CN_TOPIC_0000002553200585__accessibilitygetaccessibilityextensionlistsync12)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<boolean> | 否 | 回调函数。取消指定callback对象的事件响应。需与accessibility.onAnimationReduceStateChange的callback一致。缺省时，表示注销所有已注册事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<boolean> | 否 | 回调函数。取消指定callback对象的事件响应。需与accessibility.onFlashReminderStateChange的callback一致。缺省时，表示注销所有已注册事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<boolean> | 否 | 回调函数。取消指定callback对象的事件响应。需与accessibility.onAudioMonoStateChange的callback一致。缺省时，表示注销所有已注册事件。 |
...
从API version 7开始支持，从API version 10开始废弃，建议使用[accessibility.isOpenAccessibilitySync](#ZH-CN_TOPIC_0000002553200585__accessibilityisopenaccessibilitysync10)替代。
...
查询当前系统内是否存在已开启的辅助应用。如需获取系统内辅助应用信息，推荐使用[accessibility.getAccessibilityExtensionListSync](#ZH-CN_TOPIC_0000002553200585__accessibilitygetaccessibilityextensionlistsync12)。
...
从API version 7开始支持，从API version 10开始废弃，建议使用[accessibility.isOpenTouchGuideSync](#ZH-CN_TOPIC_0000002553200585__accessibilityisopentouchguidesync10)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[accessibility.sendAccessibilityEvent](#ZH-CN_TOPIC_0000002553200585__accessibilitysendaccessibilityevent9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[accessibility.sendAccessibilityEvent](#ZH-CN_TOPIC_0000002553200585__accessibilitysendaccessibilityevent9-1)替代。
