...
以下错误码的详细介绍请参见[通用错误码]([通用错误码](../../errors/通用错误码.md).md)和[基础文件IO错误码](文件管理错误码.md#ZH-CN_TOPIC_0000002522241236__基础文件io错误码)。
...
HashStream 类是用于创建数据的哈希摘要的实用工具。由 [createHash](#ZH-CN_TOPIC_0000002553201183__hashcreatehash12) 接口获得。
...
以下错误码的详细介绍请参见[通用错误码](通用错误码.md)和[基础文件IO错误码](文件管理错误码.md#ZH-CN_TOPIC_0000002522241236__基础文件io错误码)。
