...
通过[startAbility](../../topics/graphics/UIAbilityContext.md#ZH-CN_TOPIC_0000002497604628__startability)接口启动Ability。

**元服务API**：从API version 11开始，该接口支持在元服务中使用。

CALL2

通过[startAbilityByCall](../../topics/graphics/UIAbilityContext.md#ZH-CN_TOPIC_0000002497604628__startabilitybycall)接口启动Ability。
...
启动UIAbility时窗口的创建模式，类型为枚举。可配合[startAbility](../../topics/graphics/UIAbilityContext.md#ZH-CN_TOPIC_0000002497604628__startability-2)方法使用。
...
流转状态枚举值。用于表示当前应用任务流转的状态。可配合[UIAbilityContext](../../topics/graphics/UIAbilityContext.md)的[setMissionContinueState](../../topics/graphics/UIAbilityContext.md#ZH-CN_TOPIC_0000002497604628__setmissioncontinuestate10)方法进行设置。
