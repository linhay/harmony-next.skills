...
详细介绍请参见[@Env错误码](../../errors/环境变量错误码.md)。
...
[@Env](#ZH-CN_TOPIC_0000002529284965__env)变量参数，通过@Env(SystemProperties.BREAK_POINT)可获取[WindowSizeLayoutBreakpointInfo](../ohos/@ohos.arkui.observer (无感监听).md#ZH-CN_TOPIC_0000002529444737__windowsizelayoutbreakpointinfo22)实例。
