...
- 模块维护策略：
  ...
  - 对于支持该模块的其他设备类型，该模块从API version 8开始不再维护，推荐使用新接口[@ohos.vibrator](../ohos/@ohos.vibrator (振动).md)。
...
除Lite Wearable外，从API Version8开始，推荐使用[vibrator.startVibration()](../ohos/@ohos.vibrator (振动).md#ZH-CN_TOPIC_0000002529445607__vibratorstartvibration9)。
