...
- 从API Version 6开始不再维护，建议使用[@ohos.batteryInfo](../ohos/@ohos.batteryInfo (电量信息).md)替代。
...
**说明：** 除Lite Wearable外，从API Version 6开始不再维护，建议使用[batteryInfo.chargingStatus](../ohos/@ohos.batteryInfo (电量信息).md#ZH-CN_TOPIC_0000002497605502__常量)替代。

levelnumber否否

当前电池的电量，取值范围：0.00 - 1.00 。

**说明：** 除Lite Wearable外，从API Version 6开始不再维护，建议使用[batteryInfo.batterySOC](../ohos/@ohos.batteryInfo (电量信息).md#ZH-CN_TOPIC_0000002497605502__常量)替代。