...
从API version 9开始废弃， 建议使用[@ohos.security.cryptoFramework的Cipher](@ohos.security.cryptoFramework (加解密算法库框架).md#ZH-CN_TOPIC_0000002553201293__cipher)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | CipherRsaOptions | 是 | rsa加解密需要设置的参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | CipherAesOptions | 是 | aes加解密需要设置的参数。 |
