...
从API Version9开始，推荐使用[bundleManager.getBundleInfoForSelf](../ohos/@ohos.bundle.bundleManager (应用程序包管理模块).md#ZH-CN_TOPIC_0000002497444634__bundlemanagergetbundleinfoforself)。
...
从API Version 7开始，推荐使用[@ohos.ability.featureAbility](../ohos/@ohos.ability.featureAbility (FeatureAbility模块).md)。
...
setImageCacheCount方法需要在@Entry标记的页面，[onPageShow](../../topics/misc/自定义组件的生命周期.md#ZH-CN_TOPIC_0000002529444913__onpageshow)或[aboutToAppear](../../topics/misc/自定义组件的生命周期.md#ZH-CN_TOPIC_0000002529444913__abouttoappear)里面设置才生效。
...
setImageRawDataCacheSize方法需要在@Entry标记的页面，[onPageShow](../../topics/misc/自定义组件的生命周期.md#ZH-CN_TOPIC_0000002529444913__onpageshow)或[aboutToAppear](../../topics/misc/自定义组件的生命周期.md#ZH-CN_TOPIC_0000002529444913__abouttoappear)里面设置才生效。
...
从API Version 7开始，推荐使用[@ohos.window](../../guides/模块描述.md)。
