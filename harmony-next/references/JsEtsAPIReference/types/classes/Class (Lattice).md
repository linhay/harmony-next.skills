...
static createImageLattice(xDivs: Array<number>, yDivs: Array<number>, fXCount: number, fYCount: number, fBounds?: common2D.Rect | null, f[RectType](../enums/Enums.md#ZH-CN_TOPIC_0000002529285977__recttype12)s?: Array<RectType> | null, fColors?: Array<common2D.Color> | null): Lattice
...
| f[RectType](../enums/Enums.md#ZH-CN_TOPIC_0000002529285977__recttype12)s | Array<RectType> | null | 否 | 可选，填充网格类型的数组，默认为空。如果设置，大小必须为(fXCount + 1) * (fYCount + 1)。 |
...
static createImageLattice(xDivs: Array<number>, yDivs: Array<number>, fXCount: number, fYCount: number, fBounds?: common2D.Rect | null, f[RectType](../enums/Enums.md#ZH-CN_TOPIC_0000002529285977__recttype12)s?: Array<RectType> | null, fColors?: Array<number> | null): Lattice
