...
类型说明[FontHinting](../../topics/graphics/Enums (arkts-apis-graphics-drawing-e).md#ZH-CN_TOPIC_0000002529285977__fonthinting12)返回字型轮廓效果。
...
类型说明[FontEdging](../../topics/graphics/Enums (arkts-apis-graphics-drawing-e).md#ZH-CN_TOPIC_0000002529285977__fontedging12)返回字型边缘效果。
...
类型说明[FontMetrics](../interfaces/Interfaces (其他) (arkts-apis-graphics-drawing-i).md#ZH-CN_TOPIC_0000002497446006__fontmetrics)FontMetrics属性。
...
参数名类型必填说明textstring是文本内容。encoding[TextEncoding](../../topics/graphics/Enums (arkts-apis-graphics-drawing-e).md#ZH-CN_TOPIC_0000002529285977__textencoding)是编码格式。
...
参数名类型必填说明textstring是待测量的单个字符。字符串长度必须为1。featuresArray<[FontFeature](../interfaces/Interfaces (其他) (arkts-apis-graphics-drawing-i).md#ZH-CN_TOPIC_0000002497446006__fontfeature20)>是字体特征对象数组。参数为空数组时使用TTF(TrueType Font)文件中预设的字体特征。
...
参数名类型必填说明edging[FontEdging](../../topics/graphics/Enums (arkts-apis-graphics-drawing-e).md#ZH-CN_TOPIC_0000002529285977__fontedging12)是字型边缘效果。
...
参数名类型必填说明hinting[FontHinting](../../topics/graphics/Enums (arkts-apis-graphics-drawing-e).md#ZH-CN_TOPIC_0000002529285977__fonthinting12)是字型轮廓效果。
