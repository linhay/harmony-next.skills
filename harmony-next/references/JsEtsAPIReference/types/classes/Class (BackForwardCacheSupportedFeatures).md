...
选择性允许使用以下特性的页面进入前进后退缓存。完整示例代码参考[enableBackForwardCache](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__enablebackforwardcache12)。
...
名称类型只读可选说明nativeEmbed12+boolean否否
