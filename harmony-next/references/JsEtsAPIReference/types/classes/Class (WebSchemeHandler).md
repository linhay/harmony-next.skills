...
当请求完成时的回调，仅当[onRequestStart](#ZH-CN_TOPIC_0000002522081160__onrequeststart12)回调决定拦截此请求时触发。触发的时机有以下两点：
...
完整示例代码参考[onRequestStart](#ZH-CN_TOPIC_0000002522081160__onrequeststart12)。