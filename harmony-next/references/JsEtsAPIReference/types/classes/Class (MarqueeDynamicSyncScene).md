# Class ([Marquee](../../topics/misc/marquee.md)DynamicSyncScene)

提供[Marquee](../../topics/misc/marquee.md)组件相关帧率的配置。
...
MarqueeDynamicSyncScene继承自[DynamicSyncScene](Class (DynamicSyncScene).md)，对应[Marquee](Marquee.md)的动态帧率场景。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [Marquee](../../topics/misc/marquee.md)DynamicSyncSceneType | 是 | 否 | Marquee的动态帧率场景。 |
