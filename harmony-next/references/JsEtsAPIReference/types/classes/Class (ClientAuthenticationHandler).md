...
Web组件返回的SSL客户端证书请求事件的处理对象。示例代码参考[onClientAuthenticationRequest事件](事件.md#ZH-CN_TOPIC_0000002522081170__onclientauthenticationrequest9)。
...
confirm(identity: string, credentialTypeOrCertChainFile: [CredentialType](../enums/Enums.md#ZH-CN_TOPIC_0000002497605218__credentialtype22) | string): void
...
| credentialTypeOrCertChainFile | [CredentialType](../enums/Enums.md#ZH-CN_TOPIC_0000002497605218__credentialtype22) | string | 是 | 类型为CredentialType时，代表凭据类型；类型为string时，表示证书链文件路径。 |
