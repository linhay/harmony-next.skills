...
属性继承自[BaseSpan](Span.md#ZH-CN_TOPIC_0000002522240844__basespan)，通用属性方法支持[尺寸设置](尺寸设置.md)、[背景设置](背景设置.md)、[边框设置](边框设置.md)。
...
![image](public_sys-resources/zh-cn_image_0000002553205035.webp)

![image](public_sys-resources/zh-cn_image_0000002522085082.webp)
...
从API version 10开始，该示例通过[verticalAlign](#ZH-CN_TOPIC_0000002553200809__verticalalign)、[objectFit](#ZH-CN_TOPIC_0000002553200809__objectfit)属性展示了ImageSpan组件的对齐方式以及缩放效果。
...
![image](public_sys-resources/zh-cn_image_0000002553364999.webp)

**示例2（设置背景样式）**

从API version 11开始，该示例通过[textBackgroundStyle](Span.md#ZH-CN_TOPIC_0000002522240844__textbackgroundstyle11)属性展示了文本设置背景样式的效果。
...
![image](public_sys-resources/zh-cn_image_0000002522245076.webp)

**示例3（为图片添加事件）**

从API version 12开始，该示例通过[onComplete](#ZH-CN_TOPIC_0000002553200809__oncomplete12)、[onError](#ZH-CN_TOPIC_0000002553200809__onerror12)为图片添加加载成功和加载异常的事件。
...
从API version 14开始，该示例通过[colorFilter](#ZH-CN_TOPIC_0000002553200809__colorfilter14)属性展示了给ImageSpan图像设置颜色滤镜的效果。
...
![image](public_sys-resources/zh-cn_image_0000002553205037.webp)

**示例5（设置加载占位图）**

从API version 12开始，该示例[alt](#ZH-CN_TOPIC_0000002553200809__alt12)属性展示了ImageSpan设置加载网络图片时占位图的效果。
...
![image](public_sys-resources/zh-cn_image_0000002522085084.webp)

**示例6（使用supportSvg2属性时，SVG图片的显示效果）**

从API version 22开始，该示例通过设置[supportSvg2](#ZH-CN_TOPIC_0000002553200809__supportsvg222)属性，使[SVG标签解析能力增强功能](SVG标签解析能力增强.md#ZH-CN_TOPIC_0000002522240852__svg易用性提升)的SVG易用性提升能力生效。
...
![image](public_sys-resources/zh-cn_image_0000002553365001.webp)