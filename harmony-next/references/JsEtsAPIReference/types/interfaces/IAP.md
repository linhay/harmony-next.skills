...
设备行为差异： 该接口在Phone、Tablet、2in1、TV、Wearable设备中可正常调用，其中Wearable仅支持部分设备，在不支持的设备中返回801错误码。
...
废弃说明： 从4.1.0(11)开始废弃，建议使用[createPurchase](#ZH-CN_TOPIC_0000002522082360__iapcreatepurchase)替代。
...
废弃说明： 从4.1.0(11)开始废弃，建议使用[createPurchase](#ZH-CN_TOPIC_0000002522082360__iapcreatepurchase-1)替代。
...
废弃说明： 从4.1.0(11)开始废弃，建议使用[finishPurchase](#ZH-CN_TOPIC_0000002522082360__iapfinishpurchase)替代。
...
废弃说明： 从4.1.0(11)开始废弃，建议使用[finishPurchase](#ZH-CN_TOPIC_0000002522082360__iapfinishpurchase-1)替代。
...
若查询消耗型商品，IAP仅返回用户已购未消耗的购买数据。若有购买数据返回，说明可能存在因某些异常而导致未进行发货的情况，需要应用判断是否已发货，未发货则需要进行补发货处理。开发者应用发货成功后调用[consumePurchase](#ZH-CN_TOPIC_0000002522082360__iapconsumepurchasedeprecated)接口进行消耗。消耗成功的订单信息将不会在此接口返回，可通过[queryPurchaseRecords](#ZH-CN_TOPIC_0000002522082360__iapquerypurchaserecordsdeprecated)接口获取。
...
废弃说明： 从4.1.0(11)开始废弃，建议使用[queryPurchases](#ZH-CN_TOPIC_0000002522082360__iapquerypurchases)替代。
...
若查询消耗型商品，IAP仅返回用户已购未消耗的购买数据。若有购买数据返回，说明可能存在因某些异常而导致未进行发货的情况，需要应用判断是否已发货，未发货则需要进行补发货处理。开发者应用发货成功后调用[consumePurchase](#ZH-CN_TOPIC_0000002522082360__iapconsumepurchasedeprecated)接口进行消耗。消耗成功的订单信息将不会在此接口返回，可通过[queryPurchaseRecords](#ZH-CN_TOPIC_0000002522082360__iapquerypurchaserecordsdeprecated-1)接口获取。
...
废弃说明： 从4.1.0(11)开始废弃，建议使用[queryPurchases](#ZH-CN_TOPIC_0000002522082360__iapquerypurchases-1)替代。
...
[queryProducts](#ZH-CN_TOPIC_0000002522082360__iapqueryproducts)接口的请求参数。
...
[purchase](#ZH-CN_TOPIC_0000002522082360__iappurchasedeprecated)接口和[createPurchase](#ZH-CN_TOPIC_0000002522082360__iapcreatepurchase)接口的请求参数。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| productId | string | 否 | 否 | 待支付的商品ID。商品ID来源于开发者在AppGallery Connect中配置商品信息时设置的“商品ID”，具体请参见配置商品信息。 |
| productType | ProductType | 否 | 否 | 需要查询的商品类型。 - CONSUMABLE：消耗型商品 - NONCONSUMABLE：非消耗型商品 - AUTORENEWABLE：自动续期订阅商品 - NONRENEWABLE：非续期订阅商品 |
...
| promotionalOfferId | string | 否 | 是 | 优惠ID。优惠ID来源于开发者为商品提供优惠-配置优惠促销时设置的促销优惠标志符。传递该字段且要生效，需同时在jwsRepresentation字段中传递促销优惠信息。 起始版本： 5.0.0(12) |
...
[purchase](#ZH-CN_TOPIC_0000002522082360__iappurchasedeprecated)接口的返回结果。
...
[createPurchase](#ZH-CN_TOPIC_0000002522082360__iapcreatepurchase)接口的返回结果。
...
[consumePurchase](#ZH-CN_TOPIC_0000002522082360__iapconsumepurchasedeprecated)接口的请求参数。
...
[consumePurchase](#ZH-CN_TOPIC_0000002522082360__iapconsumepurchasedeprecated)接口的返回结果。
...
[finishPurchase](#ZH-CN_TOPIC_0000002522082360__iapfinishpurchase)接口请求参数。
...
[queryOwnedPurchases](#ZH-CN_TOPIC_0000002522082360__iapqueryownedpurchasesdeprecated)、[queryPurchaseRecords](#ZH-CN_TOPIC_0000002522082360__iapquerypurchaserecordsdeprecated)和[queryPurchases](#ZH-CN_TOPIC_0000002522082360__iapquerypurchases)接口的请求参数。
...
[queryOwnedPurchases](#ZH-CN_TOPIC_0000002522082360__iapqueryownedpurchasesdeprecated)和[queryPurchaseRecords](#ZH-CN_TOPIC_0000002522082360__iapquerypurchaserecordsdeprecated)接口的返回结果。
...
[queryPurchases](#ZH-CN_TOPIC_0000002522082360__iapquerypurchases)接口的返回结果。
...
[iap.showManagedSubscriptions](#ZH-CN_TOPIC_0000002522082360__iapshowmanagedsubscriptions)接口界面窗口参数。
