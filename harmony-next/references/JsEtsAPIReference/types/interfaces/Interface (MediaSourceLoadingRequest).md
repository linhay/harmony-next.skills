...
参数名类型必填说明uuidnumber是资源句柄的标识。来源是[SourceOpenCallback](../../topics/misc/Types.md#ZH-CN_TOPIC_0000002529285893__sourceopencallback18)。offsetnumber是当前媒体数据相对于资源起始位置的偏移量。offset不能小于0。bufferArrayBuffer是
...
用于应用程序向播放器发送响应头信息，应在第一次调用[respondData](#ZH-CN_TOPIC_0000002529445865__responddata18)方法之前调用。
...
参数名类型必填说明uuidnumber是资源句柄的标识。来源是[SourceOpenCallback](../../topics/misc/Types.md#ZH-CN_TOPIC_0000002529285893__sourceopencallback18)。headerRecord<string, string>否
...
redirectUrlstring否如果存在，为HTTP响应中的重定向URL。
...
参数名类型必填说明uuidnumber是资源句柄的标识。来源是[SourceOpenCallback](../../topics/misc/Types.md#ZH-CN_TOPIC_0000002529285893__sourceopencallback18)。state[LoadingRequestError](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445922__loadingrequesterror18)是请求的状态。
