...
[CreateNativeMediaPlayerCallback](Types.md#ZH-CN_TOPIC_0000002553201127__createnativemediaplayercallback12)回调函数的返回值类型。接管网页媒体的播放器和 ArkWeb 内核之间的一个接口类。
...
suspendPlayer?(type: [SuspendType](../enums/Enums.md#ZH-CN_TOPIC_0000002529445167__suspendtype12)): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [SuspendType](../enums/Enums.md#ZH-CN_TOPIC_0000002529445167__suspendtype12) | 是 | 播放器挂起类型。 |
