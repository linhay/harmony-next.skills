...
[CreateNativeMediaPlayerCallback](../../topics/misc/Types.md#ZH-CN_TOPIC_0000002497605202__createnativemediaplayercallback12)回调函数的返回值类型。接管网页媒体的播放器和 ArkWeb 内核之间的一个接口类。
...
参数名类型必填说明type[SuspendType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445167__suspendtype12)是播放器挂起类型。
