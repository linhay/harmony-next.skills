...
将原[Swiper](Swiper.md)组件中的[indicator](Swiper.md#ZH-CN_TOPIC_0000002522240824__indicator)已有的能力作为一个单独组件提供给开发者使用。开发者可以不依赖Swiper组件单独显示导航点，也可以通过IndicatorComponentController与Swiper组件绑定使用。
...
当indicatorStyle类型为DotIndicator且未与Swiper组件绑定时，[maxDisplayCount](Swiper.md#ZH-CN_TOPIC_0000002522240824__maxdisplaycount12)不生效。
...
该示例通过[Swiper](Swiper.md)组件的[indicator](Swiper.md#ZH-CN_TOPIC_0000002522240824__indicator)接口与[IndicatorComponent](#ZH-CN_TOPIC_0000002522080832__indicatorcomponent)的构造函数绑定同一[IndicatorComponentController](#ZH-CN_TOPIC_0000002522080832__indicatorcomponentcontroller)对象，实现了圆点单独导航点与Swiper的交互。
...
![image](public_sys-resources/zh-cn_image_0000002553364845.webp)

**示例2（数字单独导航点与Swiper绑定使用）**

该示例通过[Swiper](Swiper.md)组件的[indicator](Swiper.md#ZH-CN_TOPIC_0000002522240824__indicator)接口与[IndicatorComponent](#ZH-CN_TOPIC_0000002522080832__indicatorcomponent)的构造函数绑定同一[IndicatorComponentController](#ZH-CN_TOPIC_0000002522080832__indicatorcomponentcontroller)对象，实现了数字单独导航点与Swiper的交互。
...
![image](public_sys-resources/zh-cn_image_0000002522244924.webp)