...
相机管理器类，使用前需要通过[getCameraManager](../../topics/misc/Functions.md#ZH-CN_TOPIC_0000002529445741__cameragetcameramanager)接口获取相机管理实例。
...
类型说明Array<[SceneMode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__scenemode11)>相机支持的模式列表。
...
参数名类型必填说明camera[CameraDevice](Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__cameradevice)是相机设备，通过 [getSupportedCameras](#ZH-CN_TOPIC_0000002497445800__getsupportedcameras) 接口获取。mode[SceneMode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__scenemode11)是相机模式，通过 [getSupportedSceneModes](#ZH-CN_TOPIC_0000002497445800__getsupportedscenemodes11) 接口获取。
...
类型说明[CameraInput](Interface (CameraInput).md)返回CameraInput实例。接口调用失败会返回相应错误码，错误码类型为[CameraErrorCode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
参数名类型必填说明position[CameraPosition](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraposition)是相机位置，首先通过 [getSupportedCameras](#ZH-CN_TOPIC_0000002497445800__getsupportedcameras) 接口获取支持的相机设备对象，然后根据返回的相机设备对象获取设备位置信息。type[CameraType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameratype)是相机类型，首先通过 [getSupportedCameras](#ZH-CN_TOPIC_0000002497445800__getsupportedcameras) 接口获取支持的相机设备对象，然后根据返回的相机设备对象获取设备类型信息。
...
参数名类型必填说明profile[Profile](Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__profile)是支持的预览配置信息，通过[getSupportedOutputCapability](#ZH-CN_TOPIC_0000002497445800__getsupportedoutputcapability11)接口获取。surfaceIdstring是从[XComponent](../../topics/components/XComponent.md)或者[ImageReceiver](Interface (ImageReceiver).md)组件获取的surfaceId。

**返回值：**

类型说明[PreviewOutput](Interface (PreviewOutput).md)PreviewOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
参数名类型必填说明surfaceIdstring是从[XComponent](../../topics/components/XComponent.md)或者[ImageReceiver](Interface (ImageReceiver).md)组件获取的surfaceId。
...
类型说明[PhotoOutput](Interface (PhotoOutput).md)PhotoOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
参数名类型必填说明profile[VideoProfile](Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__videoprofile)是支持的录像配置信息，通过[getSupportedOutputCapability](#ZH-CN_TOPIC_0000002497445800__getsupportedoutputcapability11)接口获取。surfaceIdstring是从[AVRecorder](Interface (AVRecorder).md)获取的surfaceId。

**返回值：**

类型说明[VideoOutput](Interface (VideoOutput).md)VideoOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
参数名类型必填说明metadataObjectTypesArray<[MetadataObjectType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__metadataobjecttype)>是metadata流类型信息，通过[getSupportedOutputCapability](#ZH-CN_TOPIC_0000002497445800__getsupportedoutputcapability11)接口获取。

**返回值：**

类型说明[MetadataOutput](Interface (MetadataOutput).md)MetadataOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
参数名类型必填说明mode[SceneMode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__scenemode11)是相机支持的模式。如果传入的参数异常（如超出范围、传入null或未定义等），实际接口不会生效。

**返回值：**

类型说明[T](Interface (Session).md)Session实例。接口调用失败会返回相应的错误码，错误码类型为[CameraErrorCode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
...
参数名类型必填说明mode[TorchMode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__torchmode11)是手电筒模式。传参为null或者undefined，作为0处理，手电筒关闭。
...
类型说明[TorchMode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__torchmode11)返回设备当前手电筒模式。
...
参数名类型必填说明position[CameraPosition](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraposition)是需要得到的CameraDevice对象对应的CameraPosition条件。type[CameraType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameratype)是需要得到的CameraDevice对象对应的CameraType条件。
...
参数名类型必填说明profile[Profile](Interfaces (其他).md#ZH-CN_TOPIC_0000002497605794__profile)是支持的拍照配置信息，通过[getSupportedOutputCapability](#ZH-CN_TOPIC_0000002497445800__getsupportedoutputcapability11)接口获取。surfaceIdstring是从[ImageReceiver](Interface (ImageReceiver).md)获取的surfaceId。
...
类型说明[CaptureSession](../../topics/misc/废弃的Interface (CaptureSession, deprecated).md)CaptureSession实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。
