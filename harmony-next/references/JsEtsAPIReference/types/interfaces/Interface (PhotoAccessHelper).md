...
参数名类型必填说明options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是图片和视频检索选项。callbackAsyncCallback<[FetchResult](Interface (FetchResult).md)<[PhotoAsset](Interface (PhotoAsset).md)>>是callback返回图片和视频检索结果集。
...
参数名类型必填说明options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是图片和视频检索选项。
...
错误码ID错误信息201Permission denied.13900020Invalid argument.14000011System inner fail.
...
参数名类型必填说明burstKeystring是一组连拍照片的唯一标识：uuid(可传入[PhotoKeys](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__photokeys)的BURST_KEY)。字符串长度为36。options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是连拍照片检索选项。

**返回值：**

类型说明Promise<[FetchResult](Interface (FetchResult).md)<[PhotoAsset](Interface (PhotoAsset).md)>>Promise对象，返回连拍照片数据结果集。

**错误码：**

接口抛出错误码的详细介绍请参见[通用错误码](../../errors/通用错误码.md)和[文件管理错误码](../../errors/文件管理错误码.md)。

错误码ID错误信息201Permission denied.14000011Internal system error.
...
参数名类型必填说明photoType[PhotoType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是创建的文件类型，IMAGE或者VIDEO类型。extensionstring是文件名后缀参数，例如：'jpg'。options[CreateOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__createoptions)是

创建选项，当前仅支持'title'，例如{title: 'testPhoto'}。
...
callbackAsyncCallback<string>是callback返回创建的图片和视频的uri。
...
参数名类型必填说明photoType[PhotoType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是创建的文件类型，IMAGE或者VIDEO类型。extensionstring是文件名后缀参数，例如：'jpg'。callbackAsyncCallback<string>是callback返回创建的图片和视频的uri。
...
参数名类型必填说明photoType[PhotoType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是创建的文件类型，IMAGE或者VIDEO类型。extensionstring是文件名后缀参数，例如：'jpg'。options[CreateOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__createoptions)否
...
类型说明Promise<string>Promise对象，返回创建的图片和视频的uri。
...
参数名类型必填说明type[AlbumType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__albumtype)是相册类型。subtype[AlbumSubtype](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__albumsubtype)是相册子类型。options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是检索选项。callbackAsyncCallback<[FetchResult](Interface (FetchResult).md)<[Album](Interface (Album).md)>>是callback返回获取相册的结果集。
...
参数名类型必填说明type[AlbumType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__albumtype)是相册类型。subtype[AlbumSubtype](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__albumsubtype)是相册子类型。callbackAsyncCallback<[FetchResult](Interface (FetchResult).md)<[Album](Interface (Album).md)>>是callback返回获取相册的结果集。
...
参数名类型必填说明type[AlbumType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__albumtype)是相册类型。subtype[AlbumSubtype](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__albumsubtype)是相册子类型。options[FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)否检索选项，不填时默认根据相册类型检索。

**返回值：**

类型说明Promise<[FetchResult](Interface (FetchResult).md)<[Album](Interface (Album).md)>>Promise对象，返回获取相册的结果集。
...
参数名类型必填说明uristring是PhotoAsset的uri, Album的uri或[DefaultChangeUri](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__defaultchangeuri)的值。forChildUrisboolean是是否模糊监听。uri为相册uri时：forChildUris为true，能监听到相册中文件的变化。如果是false，只能监听相册本身变化；uri为photoAsset时：forChildUris为true、false没有区别；uri为DefaultChangeUri时：forChildUris必须为true，如果为false将找不到该uri，收不到任何消息。callbackCallback<[ChangeData](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__changedata)>是返回要监听的[ChangeData](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__changedata)。注：uri可以注册多个不同的callback监听，[unRegisterChange](#ZH-CN_TOPIC_0000002529445917__unregisterchange)可以关闭该uri所有监听，也可以关闭指定callback的监听。
...
错误码ID错误信息401Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types; 3. Parameter verification failed.13900012Permission denied.13900020Invalid argument.
...
参数名类型必填说明uristring是PhotoAsset的uri, Album的uri或[DefaultChangeUri](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__defaultchangeuri)的值。callbackCallback<[ChangeData](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__changedata)>否取消[registerChange](#ZH-CN_TOPIC_0000002529445917__registerchange)注册时的callback的监听，不填时，取消该uri的所有监听。注：off指定注册的callback后不会进入此回调。
...
参数名类型必填说明mediaChangeRequest[MediaChangeRequest](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__mediachangerequest11)是媒体变更请求，支持资产变更请求和相册变更请求。
...
该接口依赖于[MediaChangeRequest](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__mediachangerequest11)对象，详细代码示例请参见[MediaAssetChangeRequest](../classes/Class (MediaAssetChangeRequest).md)和[MediaAlbumChangeRequest](../classes/Class (MediaAlbumChangeRequest).md)中的接口示例。
...
参数名类型必填说明callbackAsyncCallback<void>是回调表示成功还是失败。

**错误码：**

接口抛出错误码的详细介绍请参见[通用错误码](../../errors/通用错误码.md)和[文件管理错误码](../../errors/文件管理错误码.md)。

错误码ID错误信息401Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types.13900020Invalid argument.14000011System inner fail.
...
参数名类型必填说明srcFileUrisArray<string>是

需保存到媒体库中的图片/视频文件对应的[媒体库uri](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。
...
photoCreationConfigsArray<[PhotoCreationConfig](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__photocreationconfig12)>是

保存图片或视频到媒体库的配置，包括文件名等，与srcFileUris保持一一对应。
...
参数名类型必填说明photoCreationConfig[PhotoCreationConfig](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__photocreationconfig12);是
...
Promise对象，返回给应用的媒体库文件uri。uri已对应用授权，支持应用写入数据。如果生成uri异常，则返回批量创建错误码。
...
需进行授权的图片/视频文件对应的[媒体库uri](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。
...
类型说明Promise<Array<string>>Promise对象，返回已授权的uri列表。
...
参数名类型必填说明photoType[PhotoType](../../topics/misc/Enums.md#ZH-CN_TOPIC_0000002529445919__phototype)是媒体文件类型。

**返回值：**

类型说明Promise<Array<string>>Promise对象，返回支持的图片或者视频后缀列表。

**错误码：**

接口抛出错误码的详细介绍请参见[通用错误码](../../errors/通用错误码.md)和[文件管理错误码](../../errors/文件管理错误码.md)。

错误码ID错误信息401Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types; 3. Parameter verification failed.14000011Internal system error. It is recommended to retry and check the logs.
...
参数名类型必填说明typestring是注册监听媒体资产，取值为'photoChange'。注册完成后，有资产发生变化时，通过callback返回变更信息。callbackCallback<[PhotoAssetChangeInfos](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__photoassetchangeinfos20)>是

返回变更的媒体资产信息[PhotoAssetChangeInfos](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__photoassetchangeinfos20)。

**注意：**

该接口可以注册多个不同的callback监听，[off('photoChange')](#ZH-CN_TOPIC_0000002529445917__offphotochange20)既可以关闭所有监听，也可以关闭指定callback监听。

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../errors/通用错误码.md)和[媒体库错误码](../../errors/媒体库错误码.md)。

错误码ID错误信息201Permission denied.23800151

The scenario parameter verification fails.

Possible causes: 1. The type is not fixed at 'photoChange'; 2. The same callback is registered repeatedly.

23800301

Internal system error. You are advised to retry and check the logs.
...
参数名类型必填说明typestring是取消监听媒体资产，取值为'photoChange'。取消监听后，有资产发生变化时，不再通过callback返回变更信息。callbackCallback<[PhotoAssetChangeInfos](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__photoassetchangeinfos20)>否

取消[on('photoChange')](#ZH-CN_TOPIC_0000002529445917__onphotochange20)注册时指定的callback监听；不填时，则取消对'photoChange'的所有监听。
...
参数名类型必填说明typestring是注册监听相册，取值为'photoAlbumChange'。注册完成后，有相册发生变化时，通过callback返回变更信息。callbackCallback<[AlbumChangeInfos](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__albumchangeinfos20)>是

返回变更的相册信息[AlbumChangeInfos](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__albumchangeinfos20)。

**注意：**

该接口可以注册多个不同的callback监听，[off('photoAlbumChange')](#ZH-CN_TOPIC_0000002529445917__offphotoalbumchange20)既可以关闭所有监听，也可以关闭指定callback监听。
...
参数名类型必填说明typestring是取消监听相册，取值为'photoAlbumChange'。取消监听后，有相册发生变化时，不再通过callback返回变更信息。callbackCallback<[AlbumChangeInfos](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__albumchangeinfos20)>否

取消[on('photoAlbumChange')](#ZH-CN_TOPIC_0000002529445917__onphotoalbumchange20)注册时指定的callback监听；不填时，则取消对'photoAlbumChange'的所有监听。
...
类型说明Promise<string>Promise对象，返回默认相册的相册名。

**错误码：**

以下错误码的详细介绍请参见[文件管理错误码](../../errors/文件管理错误码.md)。

错误码ID错误信息23800301Internal system error. It is recommended to retry and check the logs. Possible causes: 1. The IPC request timed out. 2. system running error.
...
从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAssetChangeRequest.deleteAssets](../classes/Class (MediaAssetChangeRequest).md#ZH-CN_TOPIC_0000002497445968__deleteassets11-1)替代。
...
参数名类型必填说明uriListArray<string>是待删除的媒体文件uri数组，最大删除数量300。callbackAsyncCallback<void>是callback返回void。
...
参数名类型必填说明uriListArray<string>是待删除的媒体文件uri数组，最大删除数量300。
...
参数名类型必填说明options[RecentPhotoOptions](../classes/Classes (其他).md#ZH-CN_TOPIC_0000002497605950__recentphotooptions20)否

最近图片配置选项参数。若无此参数，则按照时间找到最近图片。

该参数在配置的情况下，需与RecentPhotoComponent组件中的options配置相同才可以查到一样的图片，否则可能存在接口能查到最近图片，组件没查到最近图片的情况。

**返回值：**

类型说明Promise<[RecentPhotoInfo](../classes/Classes (其他).md#ZH-CN_TOPIC_0000002497605950__recentphotoinfo20)>Promise对象，返回最近图片信息。
...
参数名类型必填说明lpathstring是相册的虚拟路径，lpath长度不能超过255个字符。

**返回值：**

类型说明Promise<number>Promise对象，返回相册lpath对应的媒体库相册的ID。

**错误码：**

接口抛出错误码的详细介绍请参见[媒体库错误码](../../errors/媒体库错误码.md)。

错误码ID错误信息23800151The lpath is invalid, such as null, undefined and empty.23800301Internal system error. You are advised to retry and check the logs. Possible causes: 1. The database is corrupted. 2. The file system is abnormal. 3. The IPC request timed out.
