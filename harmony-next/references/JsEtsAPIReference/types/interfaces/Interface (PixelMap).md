...
图像像素类，用于读取或写入图像数据以及获取图像信息。在调用PixelMap的方法前，需要先通过[image.createPixelMap](Functions.md#ZH-CN_TOPIC_0000002522241966__imagecreatepixelmap8)创建一个PixelMap实例。目前pixelmap序列化大小最大128MB，超过会送显失败。大小计算方式为(宽*高*[每像素占用字节数](Enums.md#ZH-CN_TOPIC_0000002522081978__pixelmapformat7))。
...
在调用PixelMap的方法前，可以通过[image.createPixelMap](Functions.md#ZH-CN_TOPIC_0000002522241966__imagecreatepixelmap8)传入像素数据创建一个PixelMap对象，也可以通过[ImageSource](Interface (ImageSource).md)进行图片解码创建PixelMap对象。

开发元服务请通过[ImageSource](Interface (ImageSource).md)构建PixelMap对象。

图片使用的内存往往较大，在PixelMap对象使用完成后，应主动调用[release](#ZH-CN_TOPIC_0000002522241972__release7)方法及时释放内存。释放时应确保该对象的所有异步方法均执行完成，且后续不再使用该对象。
...
固定按照BGRA_8888格式，读取PixelMap指定区域内的图像像素数据，并写入[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).pixels缓冲区中，该区域由[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).region指定。使用Promise异步回调。
...
固定按照BGRA_8888格式，读取PixelMap指定区域内的图像像素数据，并写入[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).pixels缓冲区中，该区域由[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).region指定，使用callback形式返回。
...
固定按照BGRA_8888格式，读取PixelMap指定区域内的图像像素数据，并写入[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).pixels缓冲区中，该区域由[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).region指定，同步返回结果。
...
固定按照BGRA_8888格式，读取[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).pixels缓冲区中的图像像素数据，并写入PixelMap指定区域内，该区域由[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).region指定。使用Promise异步回调。
...
固定按照BGRA_8888格式，读取[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).pixels缓冲区中的图像像素数据，并写入PixelMap指定区域内，该区域由[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).region指定，使用callback形式返回。
...
固定按照BGRA_8888格式，读取[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).pixels缓冲区中的图像像素数据，并写入PixelMap指定区域内，该区域由[PositionArea](Interfaces (其他).md#ZH-CN_TOPIC_0000002553201939__positionarea7).region指定，同步返回结果。
...
scale(x: number, y: number, level: [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12)): Promise<void>
...
| x | number | 是 | 宽度的缩放倍数。 |
| y | number | 是 | 高度的缩放倍数。 |
| level | [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12) | 是 | 采用的缩放算法。 |
...
scaleSync(x: number, y: number, level: [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12)): void
...
createScaledPixelMap(x: number, y: number, level?: [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12)): Promise<PixelMap>
...
| x | number | 是 | 宽度的缩放倍数。 |
| y | number | 是 | 高度的缩放倍数。 |
| level | [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12) | 否 | 采用的缩放算法。 |
...
createScaledPixelMapSync(x: number, y: number, level?: [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12)): PixelMap
...
createCroppedAndScaledPixelMap(region: Region, x: number, y: number, level?: [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12)): Promise<PixelMap>
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | Region | 是 | 裁剪的区域。取值范围不能超过图片的宽和高（单位：像素）。 |
| x | number | 是 | 宽度的缩放倍数。不能为0。 |
| y | number | 是 | 高度的缩放倍数。不能为0。 |
| level | [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12) | 否 | 采用的缩放算法。默认值是AntiAliasingLevel.NONE。 |
...
createCroppedAndScaledPixelMapSync(region: Region, x: number, y: number, level?: [AntiAliasingLevel](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__antialiasinglevel12)): PixelMap
...
getMetadata(key: [HdrMetadataKey](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__hdrmetadatakey12)): HdrMetadataValue
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [HdrMetadataKey](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__hdrmetadatakey12) | 是 | HDR元数据的关键字，可用于查询对应值。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [HdrMetadataValue](../../topics/misc/Types.md#ZH-CN_TOPIC_0000002529445811__hdrmetadatavalue12) | 返回元数据的值。 |
...
setMetadata(key: [HdrMetadataKey](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__hdrmetadatakey12), value: HdrMetadataValue): Promise<void>
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [HdrMetadataKey](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__hdrmetadatakey12) | 是 | HDR元数据的关键字，用于设置对应值。 |
| value | [HdrMetadataValue](../../topics/misc/Types.md#ZH-CN_TOPIC_0000002529445811__hdrmetadatavalue12) | 是 | 元数据的值。 |
...
从MessageSequence中获取PixelMap，如需使用同步方式创建PixelMap可使用：[createPixelMapFromParcel](Functions.md#ZH-CN_TOPIC_0000002522241966__imagecreatepixelmapfromparcel11)。
...
convertPixelFormat(targetPixelFormat: [PixelMapFormat](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__pixelmapformat7)): Promise<void>
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| targetPixelFormat | [PixelMapFormat](../enums/Enums.md#ZH-CN_TOPIC_0000002529285837__pixelmapformat7) | 是 | 目标像素格式，用于YUV和RGB类型互转，或者ASTC_4x4类型转为RGBA_8888类型。目前仅支持NV12/NV21与RGB888/RGBA8888/RGB565/BGRA8888/RGBAF16互转，YCRCB_P010/YCBCR_P010与RGBA1010102互转，ASTC_4x4转为RGBA_8888。 |
