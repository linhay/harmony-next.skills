...
#### is[FocusMode](../enums/Enums.md#ZH-CN_TOPIC_0000002497445814__focusmode)Supported11+

is[FocusMode](../enums/Enums.md#ZH-CN_TOPIC_0000002497445814__focusmode)Supported(afMode: FocusMode): boolean
...
| 类型 | 说明 |
| --- | --- |
| boolean | 检测对焦模式是否支持。true表示支持，false表示不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](../enums/Enums.md#ZH-CN_TOPIC_0000002497445814__cameraerrorcode)。 |
