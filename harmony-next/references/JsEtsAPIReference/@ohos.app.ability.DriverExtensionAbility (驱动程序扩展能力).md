...
名称类型只读可选说明context[DriverExtensionContext](DriverExtensionContext.md)否否DriverExtension的上下文环境，继承自ExtensionContext。
...
类型说明_DriverExtensionContextDriverExtensionAbility的上下文环境，继承自ExtensionContext，其具体使用方法可参考[DriverExtensionContext](DriverExtensionContext.md)。