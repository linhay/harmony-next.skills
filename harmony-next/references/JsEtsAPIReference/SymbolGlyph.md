...
参数名类型必填说明value[Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否SymbolGlyph组件的资源名，如 $r('sys.symbol.ohos_wifi')。

 $r('sys.symbol.ohos_wifi')中引用的资源为系统预置，SymbolGlyph仅支持系统预置的symbol资源名，引用非symbol资源将显示异常。

#### 属性

支持[通用属性](通用属性.md)，不支持文本通用属性，仅支持以下特有属性：
...
参数名类型必填说明valueArray<[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)>是
...
参数名类型必填说明valuenumber | [FontWeight](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontweight) | string是
...
参数名类型必填说明value[SymbolRenderingStrategy](#ZH-CN_TOPIC_0000002529284889__symbolrenderingstrategy11枚举说明)是
...
参数名类型必填说明value[SymbolEffectStrategy](#ZH-CN_TOPIC_0000002529284889__symboleffectstrategy11枚举说明)是
...
参数名类型必填说明symbolEffect[SymbolEffect](#ZH-CN_TOPIC_0000002529284889__symboleffect12对象说明)是

SymbolGlyph组件动效策略。

默认值：[SymbolEffect](#ZH-CN_TOPIC_0000002529284889__symboleffect12对象说明)
...
可以显示为径向渐变[RadialGradientStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__radialgradientstyle20)或线性渐变[LinearGradientStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__lineargradientstyle20)或纯色[ColorShaderStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__colorshaderstyle20)的效果，shaderStyle的优先级高于[fontColor](SymbolSpan.md#ZH-CN_TOPIC_0000002497444918__fontcolor)和AI识别，纯色建议使用[fontColor](SymbolSpan.md#ZH-CN_TOPIC_0000002497444918__fontcolor)。
...
参数名类型必填说明shaderArray<[ShaderStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__shaderstyle20) | undefined> | [ShaderStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__shaderstyle20)是

径向渐变或线性渐变或纯色。

传入ShaderStyle时，覆盖所有层；传入数组时，数据项是ShaderStyle，则应用该层；数组项是undefined，则该层使用SymbolGlyph默认颜色，未设置的层也应用默认颜色。根据传入的参数区分处理径向渐变[RadialGradientStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__radialgradientstyle20)或线性渐变[LinearGradientStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__lineargradientstyle20)或纯色[ColorShaderStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__colorshaderstyle20)，最终设置到SymbolGlyph组件上显示为渐变色效果。
...
参数名类型必填说明shadow[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[ShadowOptions](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowoptions对象说明)>是
...
名称类型只读可选说明scope[EffectScope](#ZH-CN_TOPIC_0000002529284889__effectscope12枚举说明)否是

动效范围。

默认值：EffectScope.LAYER

direction[EffectDirection](#ZH-CN_TOPIC_0000002529284889__effectdirection12枚举说明)否是
...
参数名类型必填说明scope[EffectScope](#ZH-CN_TOPIC_0000002529284889__effectscope12枚举说明)否

动效范围。

默认值：EffectScope.LAYER

direction[EffectDirection](#ZH-CN_TOPIC_0000002529284889__effectdirection12枚举说明)否
...
名称类型只读可选说明fillStyle[EffectFillStyle](#ZH-CN_TOPIC_0000002529284889__effectfillstyle12枚举说明)否是
...
参数名类型必填说明fillStyle[EffectFillStyle](#ZH-CN_TOPIC_0000002529284889__effectfillstyle12枚举说明)否
...
replaceType20+[ReplaceEffectType](#ZH-CN_TOPIC_0000002529284889__replaceeffecttype20枚举说明)否是
...
replaceType[ReplaceEffectType](#ZH-CN_TOPIC_0000002529284889__replaceeffecttype20枚举说明)否
...
名称值说明NONE0无动效（默认值）。SCALE1整体缩放动效。HIERARCHICAL2层级动效。
...
名称值说明CUMULATIVE0累加模式。ITERATIVE1迭代模式。
...
名称值说明SEQUENTIAL0默认替换动效：当前symbol完全消失后，新symbol出现。CROSS_FADE1快速替换动效：当前symbol淡出的同时，新symbol淡入，产生更流畅、更快速的过渡效果。SLASH_OVERLAY2禁用动效：用带有斜杠遮罩层的symbol替换当前symbol，通常用于表示禁用或非活动状态。
...
从API version 11开始，该示例通过[renderingStrategy](#ZH-CN_TOPIC_0000002529284889__renderingstrategy)、[effectStrategy](#ZH-CN_TOPIC_0000002529284889__effectstrategy)属性展示了不同的渲染和动效策略。
...
从API version 12开始，该示例通过[symbolEffect](#ZH-CN_TOPIC_0000002529284889__symboleffect12)属性展示了各种动效的效果以及结合[symbolShadow](#ZH-CN_TOPIC_0000002529284889__symbolshadow20)（从API version 20开始）的阴影效果。
...
从API version 20开始，该示例通过[shaderStyle](#ZH-CN_TOPIC_0000002529284889__shaderstyle20)接口实现了symbolGlyph组件显示为渐变色的功能。
