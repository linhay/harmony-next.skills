...
参数名类型必填说明content[ComponentContent](ComponentContent.md)是
...
levelOrder[LevelOrder](@ohos.promptAction (弹窗).md#ZH-CN_TOPIC_0000002529284783__levelorder18)否
...
参数名类型必填说明content[ComponentContent](ComponentContent.md)是在OverlayManager上删除此content。
...
参数名类型必填说明content[ComponentContent](ComponentContent.md)是在OverlayManager上显示此content。
...
参数名类型必填说明content[ComponentContent](ComponentContent.md)是在OverlayManager上隐藏此content。
