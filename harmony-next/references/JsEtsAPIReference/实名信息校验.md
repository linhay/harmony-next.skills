...
public class VerifyRealNameDemo {
    public static void main(String[] args) throws IOException {
        ...
        JSONObject result = verifyRealName(url, accessToken, realName, ctfCode);
        // 解析获取state
    ...
    private static JSONObject verifyRealName (String url, String accessToken, String realName, String ctfCode) throws IOException {
        HttpPost httpPost = new HttpPost(url);
        List<NameValuePair> request = new ArrayList<>();
        request.add(new BasicNameValuePair("access_token", accessToken));
        // 请根据实际情况调整sceneID的值
        request.add(new BasicNameValuePair("sceneID", "*<sceneID>*"));
        // 请根据实际情况调整idType的值
        request.add(new BasicNameValuePair("idType", "*<idType>*"));
        // 请根据实际情况调整idValue的值
        request.add(new BasicNameValuePair("idValue", "*<idValue>*"));
        // 请根据实际情况调整ctfType的值
        request.add(new BasicNameValuePair("ctfType", "*<ctfType>*"));
