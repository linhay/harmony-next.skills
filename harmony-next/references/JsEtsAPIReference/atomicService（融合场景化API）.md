...
[1009601001](ArkTS API错误码.md#section310313457116)

Invalid service account id.

[1009601002](ArkTS API错误码.md#section182327351133)

The user has not logged in with HUAWEI ID.

[1009601003](ArkTS API错误码.md#section1710114369396)

Request server failed.

[1009601004](ArkTS API错误码.md#section12303893910)

Network connection error.

[1009601005](ArkTS API错误码.md#section17511740104712)
