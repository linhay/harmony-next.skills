...
名称类型只读可选说明start[PixelRoundCalcPolicy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__pixelroundcalcpolicy11)否是

组件前部边界取整对齐方式。

设置异常值时按四舍五入规则取整。

top[PixelRoundCalcPolicy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__pixelroundcalcpolicy11)否是

组件上部边界取整对齐方式。

设置异常值时按四舍五入规则取整。

end[PixelRoundCalcPolicy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__pixelroundcalcpolicy11)否是

组件尾部边界取整对齐方式。

设置异常值时按四舍五入规则取整。

bottom[PixelRoundCalcPolicy](枚举说明.md#ZH-CN_TOPIC_0000002529284967__pixelroundcalcpolicy11)否是
