...
参数项描述[OH_MovingPhoto](OH_MovingPhoto.md)* movingPhoto[OH_MovingPhoto](OH_MovingPhoto.md)实例。const char** uri动态照片的uri。
...
参数项描述[OH_MovingPhoto](OH_MovingPhoto.md)* movingPhoto[OH_MovingPhoto](OH_MovingPhoto.md)实例。char* imageUri用于保存图像数据的目标文件uri。char* videoUri用于保存视频数据的目标文件uri。
...
Release [OH_MovingPhoto](OH_MovingPhoto.md)实例。

**起始版本：** 13

**参数：**

参数项描述[OH_MovingPhoto](OH_MovingPhoto.md)* movingPhoto要释放的[OH_MovingPhoto](OH_MovingPhoto.md)实例。
