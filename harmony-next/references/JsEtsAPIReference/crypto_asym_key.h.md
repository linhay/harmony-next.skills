...
**相关模块：**[CryptoAsymKeyApi](CryptoAsymKeyApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoKeyPair](OH_CryptoKeyPair.md)OH_CryptoKeyPair定义密钥对结构体。[OH_CryptoPubKey](OH_CryptoPubKey.md)OH_CryptoPubKey定义公钥结构体。[OH_CryptoPrivKey](OH_CryptoPrivKey.md)OH_CryptoPrivKey定义私钥结构体。[OH_CryptoAsymKeyGenerator](OH_CryptoAsymKeyGenerator.md)OH_CryptoAsymKeyGenerator定义非对称密钥生成器结构体。[OH_CryptoPrivKeyEncodingParams](OH_CryptoPrivKeyEncodingParams.md)OH_CryptoPrivKeyEncodingParams定义私钥编码参数结构体。[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md)OH_CryptoAsymKeySpec定义非对称密钥规格结构体。[OH_CryptoAsymKeyGeneratorWithSpec](OH_CryptoAsymKeyGeneratorWithSpec.md)OH_CryptoAsymKeyGeneratorWithSpec定义带规格的非对称密钥生成器。[OH_CryptoEcPoint](OH_CryptoEcPoint.md)OH_CryptoEcPoint定义EC点结构体。
...
[OH_CryptoAsymKeyGenerator](OH_CryptoAsymKeyGenerator.md) **ctx指向非对称密钥生成器上下文的指针。
...
参数项描述[OH_CryptoAsymKeyGenerator](OH_CryptoAsymKeyGenerator.md) *ctx非对称密钥生成器实例。[OH_CryptoKeyPair](OH_CryptoKeyPair.md) **keyCtx指向非对称密钥对实例的指针。
...
参数项描述[OH_CryptoAsymKeyGenerator](OH_CryptoAsymKeyGenerator.md) *ctx非对称密钥生成器实例。[Crypto_EncodingType](#ZH-CN_TOPIC_0000002497445378__crypto_encodingtype) type编码格式。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *pubKeyData公钥数据。[Crypto_DataBlob](Crypto_DataBlob.md) *priKeyData私钥数据。[OH_CryptoKeyPair](OH_CryptoKeyPair.md) **keyCtx指向非对称密钥对实例的指针。
...
参数项描述[OH_CryptoKeyPair](OH_CryptoKeyPair.md) *keyCtx密钥对实例。
...
类型说明[OH_CryptoPubKey](OH_CryptoPubKey.md) *返回从密钥对中得到的公钥实例。
...
类型说明[OH_CryptoPrivKey](OH_CryptoPrivKey.md) *返回从密钥对中得到的私钥实例。
...
参数项描述[OH_CryptoPubKey](OH_CryptoPubKey.md) *key公钥实例。[Crypto_EncodingType](#ZH-CN_TOPIC_0000002497445378__crypto_encodingtype) type编码类型。const char *encodingStandard编码格式。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *out输出的公钥结果。
...
参数项描述[OH_CryptoPubKey](OH_CryptoPubKey.md) *key公钥实例。[CryptoAsymKey_ParamType](#ZH-CN_TOPIC_0000002497445378__cryptoasymkey_paramtype) item非对称密钥参数类型。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value参数输出值。
...
参数项描述[OH_CryptoAsymKeyGenerator](OH_CryptoAsymKeyGenerator.md) *ctx指向非对称加密上下文的指针。const unsigned char *password表示密码。uint32_t passwordLen表示密码长度。
...
参数项描述[OH_CryptoPrivKeyEncodingParams](OH_CryptoPrivKeyEncodingParams.md) **ctx私钥编码参数。
...
参数项描述[OH_CryptoPrivKeyEncodingParams](OH_CryptoPrivKeyEncodingParams.md) *ctx私钥编码参数。[CryptoPrivKeyEncoding_ParamType](#ZH-CN_TOPIC_0000002497445378__cryptoprivkeyencoding_paramtype) type私钥编码参数类型。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value私钥编码参数值。
...
参数项描述[OH_CryptoPrivKey](OH_CryptoPrivKey.md) *key私钥。[Crypto_EncodingType](#ZH-CN_TOPIC_0000002497445378__crypto_encodingtype) type私钥编码类型。const char *encodingStandard

编码标准。

 例如"PKCS8"。

[OH_CryptoPrivKeyEncodingParams](OH_CryptoPrivKeyEncodingParams.md) *params私钥编码参数，可以为NULL，如果要加密私钥，则应设置此参数。[Crypto_DataBlob](Crypto_DataBlob.md) *out编码结果。
...
参数项描述[OH_CryptoPrivKey](OH_CryptoPrivKey.md) *key私钥。[CryptoAsymKey_ParamType](#ZH-CN_TOPIC_0000002497445378__cryptoasymkey_paramtype) item非对称密钥参数类型。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value输出数据。
...
参数项描述const char *curveNameECC曲线名称。[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) **spec指向EC通用参数规格的指针。
...
参数项描述int pLen素数p的字节长度。int skLen私钥的字节长度。[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) **spec指向DH通用参数规格的指针。
...
[CryptoAsymKeySpec_Type](#ZH-CN_TOPIC_0000002497445378__cryptoasymkeyspec_type) type非对称密钥规格类型。[OH_CryptoAsymKeySpec](zh-cn_topic_0000002497605366.html) **spec指向非对称密钥规格的指针。
...
参数项描述[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) *spec非对称密钥规格。[CryptoAsymKey_ParamType](#ZH-CN_TOPIC_0000002497445378__cryptoasymkey_paramtype) type非对称密钥参数类型。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value输入数据。
...
参数项描述[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) *spec非对称密钥规格。[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) *commonParamsSpec通用参数规格。
...
参数项描述[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) *spec非对称密钥规格。[CryptoAsymKey_ParamType](#ZH-CN_TOPIC_0000002497445378__cryptoasymkey_paramtype) type非对称密钥参数类型。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value输出数据。
...
参数项描述[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) *spec非对称密钥规格。
...
参数项描述[OH_CryptoAsymKeySpec](OH_CryptoAsymKeySpec.md) *keySpec非对称密钥规格。[OH_CryptoAsymKeyGeneratorWithSpec](OH_CryptoAsymKeyGeneratorWithSpec.md) **generator带规格的非对称密钥生成器。
...
参数项描述[OH_CryptoAsymKeyGeneratorWithSpec](OH_CryptoAsymKeyGeneratorWithSpec.md) *generator带规格的非对称密钥生成器。[OH_CryptoKeyPair](OH_CryptoKeyPair.md) **keyPair指向密钥对的指针。
...
参数项描述[OH_CryptoAsymKeyGeneratorWithSpec](OH_CryptoAsymKeyGeneratorWithSpec.md) *generator带规格的非对称密钥生成器。
...
参数项描述const char *curveName曲线名称。[Crypto_DataBlob](Crypto_DataBlob.md) *ecKeyDataEC点数据，支持"04 || x || y"、"02 || x"或"03 || x"格式。如果ecKeyData参数为NULL，将创建一个空的EC点规格。[OH_CryptoEcPoint](OH_CryptoEcPoint.md) **point指向EC点的指针。
...
参数项描述[OH_CryptoEcPoint](OH_CryptoEcPoint.md) *pointEC点。[Crypto_DataBlob](Crypto_DataBlob.md) *xEC点的x坐标,可以为NULL。[Crypto_DataBlob](Crypto_DataBlob.md) *yEC点的y坐标,可以为NULL。
...
参数项描述[OH_CryptoEcPoint](OH_CryptoEcPoint.md) *pointEC点。[Crypto_DataBlob](Crypto_DataBlob.md) *xEC点的x坐标。[Crypto_DataBlob](Crypto_DataBlob.md) *yEC点的y坐标。
...
参数项描述[OH_CryptoEcPoint](OH_CryptoEcPoint.md) *pointEC点。const char *format编码格式,支持"UNCOMPRESSED"和"COMPRESSED"。[Crypto_DataBlob](Crypto_DataBlob.md) *out编码后的EC点数据。
...
参数项描述[OH_CryptoEcPoint](OH_CryptoEcPoint.md) *pointEC点。