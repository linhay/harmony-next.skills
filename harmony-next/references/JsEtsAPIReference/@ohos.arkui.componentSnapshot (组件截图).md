...
对于使用[XComponent](XComponent.md)的场景，例如：Video或者相机流媒体展示类组件，不建议使用组件截图相关接口，建议从[surface](Functions.md#ZH-CN_TOPIC_0000002529445805__imagecreatepixelmapfromsurface11)直接获取图片。

-

如果组件自身内容不能填满组件大小区域，那么剩余位置截图返回的内容为透明像素。如果组件使用了[图像效果](图像效果.md)类属性或其他的效果类属性，则可能产生非用户预期的截图结果。请排查是否需要填充组件透明内容区域，或使用[窗口截图](Interface (Window).md#ZH-CN_TOPIC_0000002497604802__snapshot9)替代。
...
从API version 10开始支持，从API version 18开始废弃，建议使用[get](Class (ComponentSnapshot).md#ZH-CN_TOPIC_0000002497444796__get12)替代。get需先通过[UIContext](Class (UIContext).md)中的[getComponentSnapshot](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__getcomponentsnapshot12)方法获取[ComponentSnapshot](Class (ComponentSnapshot).md)对象，然后通过该对象进行调用。

-

从API version 12开始，可以通过使用[UIContext](Class (UIContext).md)中的[getComponentSnapshot](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__getcomponentsnapshot12)方法获取当前UI上下文关联的[ComponentSnapshot](Class (ComponentSnapshot).md)对象。
...
参数名类型必填说明idstring是目标组件的[组件标识](组件标识.md)。callback[AsyncCallback](@ohos.base (公共回调信息).md#ZH-CN_TOPIC_0000002497445536__asynccallback)<image.[PixelMap](Interface (PixelMap).md)>是截图返回结果的回调。options12+[SnapshotOptions](#ZH-CN_TOPIC_0000002497444790__snapshotoptions12)否截图相关的自定义参数。
...
直接使用componentSnapshot可能导致[UI上下文不明确](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-global-interface#ui上下文不明确)的问题，建议使用getUIContext()获取[UIContext](zh-cn_topic_0000002529444749.html)实例，并使用[getComponentSnapshot](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__getcomponentsnapshot12)获取绑定实例的componentSnapshot。
...
从API version 10开始支持，从API version 18开始废弃，建议使用[get](Class (ComponentSnapshot).md#ZH-CN_TOPIC_0000002497444796__get12-1)替代。get需先通过[UIContext](Class (UIContext).md)中的[getComponentSnapshot](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__getcomponentsnapshot12)方法获取[ComponentSnapshot](Class (ComponentSnapshot).md)对象，然后通过该对象进行调用。
...
参数名类型必填说明idstring是目标组件的[组件标识](组件标识.md)。options12+[SnapshotOptions](#ZH-CN_TOPIC_0000002497444790__snapshotoptions12)否截图相关的自定义参数。

**返回值：**

类型说明Promise<image.[PixelMap](Interface (PixelMap).md)>截图返回的结果。
...
从API version 10开始支持，从API version 18开始废弃，建议使用[createFromBuilder](Class (ComponentSnapshot).md#ZH-CN_TOPIC_0000002497444796__createfrombuilder12)替代。createFromBuilder需先通过[UIContext](Class (UIContext).md)中的[getComponentSnapshot](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__getcomponentsnapshot12)方法获取[ComponentSnapshot](Class (ComponentSnapshot).md)对象，然后通过该对象进行调用。
...
参数名类型必填说明builder[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是
...
callback[AsyncCallback](@ohos.base (公共回调信息).md#ZH-CN_TOPIC_0000002497445536__asynccallback)<image.[PixelMap](Interface (PixelMap).md)>是截图返回结果的回调。支持在回调中获取离屏组件绘制区域坐标和大小。delay12+number否
...
从API version 10开始支持，从API version 18开始废弃，建议使用[createFromBuilder](Class (ComponentSnapshot).md#ZH-CN_TOPIC_0000002497444796__createfrombuilder12-1)替代。createFromBuilder需先通过[UIContext](Class (UIContext).md)中的[getComponentSnapshot](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__getcomponentsnapshot12)方法获取[ComponentSnapshot](Class (ComponentSnapshot).md)对象，然后通过该对象进行调用。
...
参数名类型必填说明idstring是目标组件的[组件标识](组件标识.md)。options[SnapshotOptions](#ZH-CN_TOPIC_0000002497444790__snapshotoptions12)否截图相关的自定义参数。

**返回值：**

类型说明image.[PixelMap](Interface (PixelMap).md)截图返回的结果。
