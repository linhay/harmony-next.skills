...
网页触发alert()告警弹窗时触发回调。若不调用[handleCancel](Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlecancel)或[handleConfirm](Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handleconfirm)接口，会造成render进程阻塞。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnAlertEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onalertevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnBeforeUnloadEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onbeforeunloadevent12), boolean>是
...
网页调用confirm()告警时触发此回调。若不调用[handleCancel](Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlecancel)或[handleConfirm](Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handleconfirm)接口，会造成render进程阻塞。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnConfirmEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconfirmevent12), boolean>是
...
网页调用prompt()告警时触发此回调。若不调用[handleCancel](Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlecancel)或[handlePromptConfirm](Class (JsResult).md#ZH-CN_TOPIC_0000002497605212__handlepromptconfirm9)接口，会造成render进程阻塞。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnPromptEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpromptevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnConsoleEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onconsoleevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnDownloadStartEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondownloadstartevent12)>是开始下载时触发。
...
网页加载遇到错误时触发该回调。主资源与子资源出错都会回调该接口，可以通过[isMainFrame](Class (WebResourceRequest).md#ZH-CN_TOPIC_0000002497445238__ismainframe)来判断是否是主资源报错。出于性能考虑，建议此回调中尽量执行简单逻辑。在无网络的情况下，触发此回调。

**系统能力：** SystemCapability.Web.Webview.Core

**参数：**

参数名类型必填说明callbackCallback<[OnErrorReceiveEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onerrorreceiveevent12)>是网页收到 Web 资源加载错误时触发。
...
参数名类型必填说明callbackCallback<[OnHttpErrorReceiveEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttperrorreceiveevent12)>是网页收到加载资源返回HTTP错误码时触发。
...
参数名类型必填说明callbackCallback<[OnPageBeginEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagebeginevent12)>是网页加载开始时触发。
...
参数名类型必填说明callbackCallback<[OnPageEndEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpageendevent12)>是网页加载结束时触发。
...
参数名类型必填说明callbackCallback<[OnLoadStartedEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadstartedevent20)>是网页加载开始时触发。
...
参数名类型必填说明callbackCallback<[OnLoadFinishedEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadfinishedevent20)>是网页加载结束时触发。
...
参数名类型必填说明callbackCallback<[OnProgressChangeEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onprogresschangeevent12)>是页面加载进度变化时触发的回调。
...
参数名类型必填说明callbackCallback<[OnTitleReceiveEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ontitlereceiveevent12)>是页面文档标题发生变更时触发。
...
参数名类型必填说明callbackCallback<[OnRefreshAccessedHistoryEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrefreshaccessedhistoryevent12)>是在导航完成时触发。
...
应用处理该回调时，可以调用绑定的webviewController相关接口来恢复页面。例如[refresh](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__refresh)、[loadUrl](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__loadurl)等。
...
参数名类型必填说明callbackCallback<[OnRenderExitedEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onrenderexitedevent12)>是渲染过程退出时触发。
...
应用可以通过WebviewController接口[terminateRenderProcess](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__terminaterenderprocess12)来终止关联的渲染进程，这可能会影响同一渲染进程的其他Web组件。
...
参数名类型必填说明callbackCallback<[OnShowFileSelectorEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onshowfileselectorevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnResourceLoadEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onresourceloadevent12)>是加载url时触发。
...
参数名类型必填说明callbackCallback<[OnScaleChangeEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscalechangeevent12)>是当页面显示比例发生变化时，触发该回调。
...
参数名类型必填说明callbackCallback<[OnInterceptRequestEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oninterceptrequestevent12), [WebResourceResponse](Class (WebResourceResponse).md)>是

当Web组件加载url之前触发。

返回值[WebResourceResponse](Class (WebResourceResponse).md)。返回响应数据则按照响应数据加载，无响应数据则返回null表示按照原来的方式加载。
...
参数名类型必填说明callbackCallback<[OnHttpAuthRequestEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onhttpauthrequestevent12), boolean>是
...
- 应用程序需要调用[handler.handleCancel()](Class (SslErrorHandler).md#ZH-CN_TOPIC_0000002529445179__handlecancel9)或[handler.handleConfirm()](Class (SslErrorHandler).md#ZH-CN_TOPIC_0000002529445179__handleconfirm9)处理该回调，如果没有处理该回调则默认取消资源加载。handleConfirm()或者handleCancel()的行为可能会被记录下来，以便为将来的SSL错误做出响应。
...
参数名类型必填说明callbackCallback<[OnSslErrorEventReceiveEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onsslerroreventreceiveevent12)>是当网页收到SSL错误时触发。
...
通知用户加载资源（主资源+子资源）时发生SSL错误，如果只想处理主资源的SSL错误，请用[isMainFrame](Class (WebResourceRequest).md#ZH-CN_TOPIC_0000002497445238__ismainframe)字段进行区分。
...
- Web组件有三种响应方式：[ClientAuthenticationHandler.confirm](Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002529285199__confirm10)（继续）、[ClientAuthenticationHandler.cancel](Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002529285199__cancel9)（取消）或[ClientAuthenticationHandler.ignore](Class (ClientAuthenticationHandler).md#ZH-CN_TOPIC_0000002529285199__ignore9)（忽略）。
...
参数名类型必填说明callbackCallback<[OnClientAuthenticationEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onclientauthenticationevent12)>是当需要用户提供的SSL客户端证书时触发的回调。
...
参数名类型必填说明callbackCallback<[OnPermissionRequestEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpermissionrequestevent12)>是通知收到获取权限请求触发。
...
参数名类型必填说明callbackCallback<[OnContextMenuShowEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__oncontextmenushowevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnScrollEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscrollevent12)>是当页面滑动到指定位置时触发。
...
参数名类型必填说明callbackCallback<[OnGeolocationShowEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ongeolocationshowevent12)>是回调函数，请求显示地理位置权限时触发，返回地理位置信息请求对象。
...
若不调用[setWebController](Class (ControllerHandler).md#ZH-CN_TOPIC_0000002497605208__setwebcontroller9)接口，会造成render进程阻塞。

如果没有创建新窗口，调用[setWebController](Class (ControllerHandler).md#ZH-CN_TOPIC_0000002497605208__setwebcontroller9)接口时设置成null，通知Web没有创建新窗口。
...
参数名类型必填说明callbackCallback<[OnWindowNewEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onwindownewevent12)>是网页要求用户创建窗口时触发的回调。
...
参数名类型必填说明callbackCallback<[OnSearchResultReceiveEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onsearchresultreceiveevent12)>是通知调用方网页页内查找的结果。
...
参数名类型必填说明callbackCallback<[OnDataResubmittedEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ondataresubmittedevent12)>是网页表单可以重新提交时触发。
...
参数名类型必填说明callbackCallback<[OnPageVisibleEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpagevisibleevent12)>是旧页面不再呈现，新页面即将可见时触发的回调函数。
...
参数名类型必填说明callbackCallback<[OnTouchIconUrlReceivedEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__ontouchiconurlreceivedevent12)>是接收到的apple-touch-icon url地址时触发。
...
参数名类型必填说明callbackCallback<[OnFaviconReceivedEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfaviconreceivedevent12)>是当前页面接收到新的favicon时触发。
...
参数名类型必填说明callbackCallback<[OnAudioStateChangedEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onaudiostatechangedevent12)>是网页上的音频播放状态发生改变时触发。
...
参数名类型必填说明callbackCallback<[OnFirstContentfulPaintEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onfirstcontentfulpaintevent12)>是网页首次内容绘制回调函数。
...
参数名类型必填说明callbackCallback<[OnLoadInterceptEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onloadinterceptevent12), boolean>是
...
参数名类型必填说明callbackCallback<[OnScreenCaptureRequestEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onscreencapturerequestevent12)>是通知收到屏幕捕获请求。
...
参数名类型必填说明callbackCallback<[OnOverScrollEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onoverscrollevent12)>是网页过度滚动时触发。
...
因该回调调用时网页还未加载，无法在回调中使用有关操作网页的接口，例如[zoomIn](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__zoomin)、[zoomOut](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__zoomout)等，可以使用[loadUrl](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__loadurl)、[getWebId](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__getwebid)等操作网页不相关的接口。
...
参数名类型必填说明callback(event: [NativeEmbedDataInfo](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembeddatainfo11)) => void是同层标签生命周期变化时触发该回调。
...
参数名类型必填说明callback(event: [NativeEmbedTouchInfo](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__nativeembedtouchinfo11)) => void是手指触摸到同层标签时触发该回调。
...
当网页中同层标签（例如<embed>标签或<object>标签）在视口内的可见性发生变化时，将触发该回调。同层标签默认不可见，若在页面首次加载时已可见，则会上报；若不可见，则不会上报。同层标签全部不可见才视为不可见，部分可见或全部可见则视为可见。若要获取因同层标签CSS属性（包括visibility、display以及尺寸变化）导致的可见状态变化，需配置[nativeEmbedOptions](属性.md#ZH-CN_TOPIC_0000002497605206__nativeembedoptions16)，并将[EmbedOptions](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__embedoptions16)中的supportCssDisplayChange参数设为true。
...
此外，该功能需通过调用[setErrorPageEnabled](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__seterrorpageenabled20)接口启用默认错误页后，才会生效。
...
参数名类型必填说明callback(event?: { data:string | [WebResourceRequest](Class (WebResourceRequest).md) }) => boolean是
...
参数名类型必填说明callbackCallback<[OnPdfLoadEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfloadevent20)>是当PDF加载成功或失败时，会触发回调，通知用户PDF页面加载状态。
...
参数名类型必填说明callbackCallback<[OnPdfScrollEvent](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__onpdfscrollevent20)>是当PDF滚动到垂直方向底部时，会触发回调，通知用户PDF页面已滚动到底。
...
应用处理该回调时，可以调用绑定的WebViewController接口来恢复页面。例如[refresh](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__refresh)、[loadUrl](Class (WebviewController).md#ZH-CN_TOPIC_0000002497605192__loadurl)等。
