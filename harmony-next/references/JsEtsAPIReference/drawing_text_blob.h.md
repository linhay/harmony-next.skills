...
名称typedef关键字描述[OH_Drawing_RunBuffer](OH_Drawing_RunBuffer.md)OH_Drawing_RunBuffer结构体用于描述一块内存，描述文字和位置信息。
...
类型说明[OH_Drawing_TextBlobBuilder](OH_Drawing_TextBlobBuilder.md)*函数会返回一个指针，指针指向创建的文本构造器对象。
...
参数项描述const void* text指向文本的指针。size_t byteLength文本的字节长度。const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字体对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding) textEncoding文本编码类型[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding)。

**返回：**

类型说明[OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)*函数返回一个指针，指针指向创建的文本对象[OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)。
...
参数项描述const void* text指向文本的指针。size_t byteLength文本的字节长度。[OH_Drawing_Point2D](OH_Drawing_Point2D.md)* point2D二维点[OH_Drawing_Point2D](OH_Drawing_Point2D.md)数组首地址，数组个数由[OH_Drawing_FontCountText](drawing_font.h.md#ZH-CN_TOPIC_0000002529285991__oh_drawing_fontcounttext)计算结果决定。const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字体对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding) textEncoding文本编码类型[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding)。
...
参数项描述[OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)* textBlob指向文本对象[OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)的指针。[OH_Drawing_Rect](OH_Drawing_Rect.md)* rect指向矩形对象[OH_Drawing_Rect](OH_Drawing_Rect.md)的指针，开发者可调用[OH_Drawing_Rect](OH_Drawing_Rect.md)接口创建。
...
参数项描述const [OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)* textBlob指向文本对象[OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)的指针。
...
参数项描述[OH_Drawing_TextBlobBuilder](OH_Drawing_TextBlobBuilder.md)* textBlobBuilder指向文本构造器对象的指针。const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字体对象的指针。int32_t count文字的数量。const [OH_Drawing_Rect](OH_Drawing_Rect.md)* rect文本的边界框，为NULL表示不设置边界框。
...
参数项描述[OH_Drawing_TextBlobBuilder](OH_Drawing_TextBlobBuilder.md)* textBlobBuilder指向文本构造器对象的指针。

**返回：**

类型说明[OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)*返回一个指针，指针指向创建的文本对象。
...
参数项描述[OH_Drawing_TextBlob](OH_Drawing_TextBlob.md)* textBlob指向文本对象的指针。
