...
Metadata类，用于存储图像的元数据。目前支持的元数据类型可参考[MetadataType](Enums.md#ZH-CN_TOPIC_0000002529285837__metadatatype13)。
...
如要查询属性值信息请参考[PropertyKey](Enums.md#ZH-CN_TOPIC_0000002529285837__propertykey7)、[FragmentMapPropertyKey](Enums.md#ZH-CN_TOPIC_0000002529285837__fragmentmappropertykey13)和[GifPropertyKey](Enums.md#ZH-CN_TOPIC_0000002529285837__gifpropertykey20)。
