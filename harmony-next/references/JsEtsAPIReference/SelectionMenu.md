...
文本选择菜单，适用于[RichEditor](RichEditor.md)组件通过[bindSelectionMenu](RichEditor.md#ZH-CN_TOPIC_0000002497604894__bindselectionmenu)或[Text](Text.md)组件通过[bindSelectionMenu](Text.md#ZH-CN_TOPIC_0000002497444914__bindselectionmenu11)绑定自定义文本选择菜单，建议绑定鼠标右键或者鼠标选中方式弹出，不支持作为普通组件单独使用。
...
入参为空时，文本选择菜单组件SelectionMenu内容区大小及组件大小为零。表现例如，富文本组件[RichEditor](RichEditor.md)使用[bindSelectionMenu](RichEditor.md#ZH-CN_TOPIC_0000002497604894__bindselectionmenu)接口绑定一个SelectionMenu的右键菜单，则右键富文本组件区域时无任何菜单弹出。
...
controller[RichEditorController](RichEditor.md#ZH-CN_TOPIC_0000002497604894__richeditorcontroller)否是
...
**说明：**
 ...
 当富文本组件[RichEditor](RichEditor.md)的copyOptions属性设置为CopyOptions.None时，内置的复制剪切功能不会被限制。
...
symbolStyle18+[SymbolGlyphModifier](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__symbolglyphmodifier12)否是
...
名称类型只读可选说明content[RichEditorSelection](RichEditor.md#ZH-CN_TOPIC_0000002497604894__richeditorselection)否是选中内容信息。

#### 属性

不支持[通用属性](通用属性.md)，宽度默认224vp， 高度自适应内容。
