...
名称typedef关键字描述[OH_Drawing_Font_Metrics](OH_Drawing_Font_Metrics.md)OH_Drawing_Font_Metrics定义字体度量信息的结构体。
...
参数项描述[const OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const char* str待测量的单个字符。可以传入字符串，但只会以UTF-8编码解析并测量字符串中的首个字符。[const OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)* fontFeatures指向字体特征容器对象[OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)的指针。容器中未加入任何字体特征时使用TTF(TrueType Font)文件中预设的字体特征。float* textWidth用于存储得到的字符宽度，作为出参使用。
...
类型说明[OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)*

函数会返回一个指针，指向创建的字体特征容器对象[OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)。
...
参数项描述[OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)* fontFeatures指向字体特征容器对象[OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)的指针。const char* name字体特征的名称。常见的字体特征名称包含liga、frac、case等，需要对应的ttf文件支持才能生效。float value字体特征的数值。建议通过字体查看工具或查阅字体文档，确定具体的有效取值范围。
...
参数项描述[OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)* fontFeatures指向字体特征容器对象[OH_Drawing_FontFeatures](OH_Drawing_FontFeatures.md)的指针。
...
参数项描述const OH_Drawing_Font* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const void* text指向文本的指针。size_t byteLength表示以字节为单位的文本长度。[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding) encoding文本编码类型。const OH_Drawing_Brush* brush指向画刷对象[OH_Drawing_Brush](OH_Drawing_Brush.md)的指针。const OH_Drawing_Pen* pen指向画笔对象[OH_Drawing_Pen](OH_Drawing_Pen.md)的指针。OH_Drawing_Rect* bounds用于承载获取的边界框，可以为NULL。float* textWidth表示文本宽度。
...
参数项描述const OH_Drawing_Font* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const uint16_t* glyphs字形索引存储首地址。int count字形索引的数量，大小与glyphs数组大小保持一致。const OH_Drawing_Brush* brush指向画刷对象[OH_Drawing_Brush](OH_Drawing_Brush.md)的指针。const OH_Drawing_Pen* pen指向画笔对象[OH_Drawing_Pen](OH_Drawing_Pen.md)的指针。float* widths字形宽度存储首地址，用于存储得到的字形宽度，作为返回值返回给调用者。OH_Drawing_Array* bounds字形边界框存储首地址，用于存储得到的字形边界框。
...
参数项描述const OH_Drawing_Font* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const uint16_t* glyphs字形索引存储首地址。int count字形索引的数量，大小与glyphs数组大小保持一致。const OH_Drawing_Point* origin指向第一个字形的位置，可以为NULL，为NULL默认从(0, 0)开始。[OH_Drawing_Point2D](OH_Drawing_Point2D.md)* points字形相对位置存储首地址，用于存储得到的字形相对位置，作为返回值返回给调用者。
...
参数项描述const OH_Drawing_Font* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。float* spacing推荐的字型行间距，作为返回值返回给调用者。
...
类型说明[OH_Drawing_Font](OH_Drawing_Font.md)*函数会返回一个指针，指针指向创建的字型对象。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。bool baselineSnap指示字型基线是否和像素对齐。true表示对齐，false表示不对齐。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。bool isSubpixel字型是否使用次像素渲染。true为使用，false为不使用。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。bool isForceAutoHinting是否自动调整字型轮廓。true为自动调整，false为不自动调整。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象的指针。[OH_Drawing_Typeface](OH_Drawing_Typeface.md)* typeface指向字体对象的指针，为NULL会使用系统默认字体对象。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。

**返回：**

类型说明[OH_Drawing_Typeface](OH_Drawing_Typeface.md)*OH_Drawing_Typeface 函数返回一个指针，指向字体对象[OH_Drawing_Typeface](OH_Drawing_Typeface.md)。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象的指针。float textSize文字大小，该参数为浮点数，为负数时字体大小会被置为0。字体大小为0时，绘制的文字不会显示。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const void* text文本存储首地址。size_t byteLength文本长度，单位为字节。[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding) encoding文本编码类型[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding)。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const void* text文本存储首地址。uint32_t byteLength文本长度，单位为字节。[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding) encoding文本编码类型[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding)。uint16_t* glyphs字形索引存储首地址，用于存储得到的字形索引。int maxGlyphCount文本所表示的最大字符数量。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const uint16_t* glyphs字形索引存储首地址。int count字形索引的数量。float* widths字形宽度存储首地址，用于存储得到的字形宽度。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const char* str待测量的单个字符。可以传入字符串，但只会以UTF-8编码解析并测量字符串中的首个字符。float* textWidth用于存储得到的字符宽度。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const void* text指向文本的指针。size_t byteLength表示以字节为单位的文本长度。[OH_Drawing_TextEncoding](drawing_types.h.md#ZH-CN_TOPIC_0000002529286007__oh_drawing_textencoding) encoding文本编码类型。[OH_Drawing_Rect](OH_Drawing_Rect.md)* bounds用于承载获取的边界框，可以为NULL。float* textWidth表示文本宽度。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象的指针。bool isLinearText真为使能线性可缩放字型，假为不使能。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象的指针。float skewX轴相对于Y轴的倾斜度。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象的指针。bool isFakeBoldText真为使能增加描边宽度，假为不使能。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。float scaleX文本在x轴上的缩放比例。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。[OH_Drawing_FontHinting](#ZH-CN_TOPIC_0000002529285991__oh_drawing_fonthinting) fontHinting字型轮廓枚举类型[OH_Drawing_FontHinting](zh-cn_topic_0000002529285991.html#ZH-CN_TOPIC_0000002529285991__oh_drawing_fonthinting)。
...
类型说明[OH_Drawing_FontHinting](#ZH-CN_TOPIC_0000002529285991__oh_drawing_fonthinting)OH_Drawing_FontHinting 返回字型轮廓效果枚举类型[OH_Drawing_FontHinting](zh-cn_topic_0000002529285991.html#ZH-CN_TOPIC_0000002529285991__oh_drawing_fonthinting)。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。bool isEmbeddedBitmaps设置字型是否转换成位图处理，true表示转换成位图处理，false表示不转换成位图处理。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。[OH_Drawing_FontEdging](#ZH-CN_TOPIC_0000002529285991__oh_drawing_fontedging) fontEdging字型边缘效果。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象的指针。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。[OH_Drawing_Font_Metrics](OH_Drawing_Font_Metrics.md)* fontMetrics指向字体度量信息对象[OH_Drawing_Font_Metrics](OH_Drawing_Font_Metrics.md)的指针。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。const uint16_t* glyphs字形索引数组。uint32_t count字形数组的长度。[OH_Drawing_Array](OH_Drawing_Array.md)* bounds矩形边界数组。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指向字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。uint16_t glyph指定的字形索引。[OH_Drawing_Path](OH_Drawing_Path.md)* path指向路径对象[OH_Drawing_Path](OH_Drawing_Path.md)的指针, 用于存储得到的字形路径。
...
参数项描述[OH_Drawing_Font](OH_Drawing_Font.md)* font指示字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。bool followed字型中的字体是否跟随主题字体，true表示跟随主题字体，false表示不跟随主题字体。
...
参数项描述const [OH_Drawing_Font](OH_Drawing_Font.md)* font指示字型对象[OH_Drawing_Font](OH_Drawing_Font.md)的指针。bool* followed返回字型中的字体是否跟随主题字体的结果，true表示跟随主题字体，false表示不跟随主题字体。作为出参使用。
