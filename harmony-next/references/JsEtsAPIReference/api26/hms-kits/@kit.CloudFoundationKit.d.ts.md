 ...
 */
/**
 * @file Defines the capabilities of cloud foundation kit.
...
import cloudResPrefetch from '@hms.core.deviceCloudGateway.cloudResPrefetch';
export { cloudCommon, cloudFunction, cloudStorage, cloudDatabase, cloudResPrefetch };
