...
declare namespace huks {
     ...
     * The **huks.initSession**, **huks.updateSession**, and **huks.finishSession** must be used together.
     *
     * @param { number } handle - Handle of the **updateSession** operation, which is of the uint64 type.
     ...
     * Aborts a key operation. This API uses an asynchronous callback to return the result.
     *
     * @param { number } handle - Handle of the **abortSession** operation, which is of the uint64 type.
     ...
     * @since 26.0.0
     */
    function encapsulate(keyAlias: string, params: HuksParam[], sharedKeyAlias?: string, sharedKeyParams?: HuksParam[]): Promise<HuksReturnResult>;
    /**
     ...
     * @since 26.0.0
     */
    function decapsulate(keyAlias: string, params: HuksParam[], encapData: Uint8Array, sharedKeyAlias?: string, sharedKeyParams?: HuksParam[]): Promise<HuksReturnResult>;
    /**
