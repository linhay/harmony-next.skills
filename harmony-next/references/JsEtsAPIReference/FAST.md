...
[fast_ads_segment_map.h](fast_ads_segment_map.h.md)

线段表相关数据结构及函数定义。

[fast_common_def.h](fast_common_def.h.md)

FAST Kit错误码等类型的公共定义。

[fast_solver_rect_partition.h](fast_solver_rect_partition.h.md)
