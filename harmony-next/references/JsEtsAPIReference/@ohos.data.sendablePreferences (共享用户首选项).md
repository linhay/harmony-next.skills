...
参数名类型必填说明context[Context](Context (Stage模型的上下文基类).md)是应用上下文。options[Options](#ZH-CN_TOPIC_0000002529444647__options)是与Preferences实例相关的配置选项。
