...
**相关模块：**[CryptoCommonApi](CryptoCommonApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[Crypto_DataBlob](Crypto_DataBlob.md)Crypto_DataBlob加解密数据结构体。
...
参数项描述[Crypto_DataBlob](Crypto_DataBlob.md) *dataBlob需要释放的dataBlob数据。