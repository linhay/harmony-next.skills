...
调用onAuthResult可能会抛出错误码，错误码详细介绍请参见[通用错误码](通用错误码.md)和[用户认证错误码](用户认证错误码.md)。
