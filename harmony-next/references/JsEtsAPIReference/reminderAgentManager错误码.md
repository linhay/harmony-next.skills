...
1. 申请通知使能权限弹窗[Notification.requestEnableNotification](@ohos.notification (Notification模块).md#ZH-CN_TOPIC_0000002529286111__notificationrequestenablenotification8)。
1. 通知设置里开启应用通知开关。
