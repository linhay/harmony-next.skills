...
类型说明[OH_Drawing_MemoryStream](OH_Drawing_MemoryStream.md)*函数会返回一个指针，指针指向创建的内存流对象[OH_Drawing_MemoryStream](OH_Drawing_MemoryStream.md)。
...
参数项描述[OH_Drawing_MemoryStream](OH_Drawing_MemoryStream.md)* memoryStream指向内存流对象[OH_Drawing_MemoryStream](OH_Drawing_MemoryStream.md)的指针。