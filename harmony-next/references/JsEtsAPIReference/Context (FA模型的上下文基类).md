...
Context对象是在featureAbility中创建实例，并通过featureAbility的[getContext](@ohos.ability.featureAbility (FeatureAbility模块).md#ZH-CN_TOPIC_0000002529444565__featureabilitygetcontext)接口返回，因此在使用Context时，必须导入@ohos.ability.featureAbility库。示例如下：
...
示例代码中出现的getBundleInfo相关描述可参考对应[文档](@ohos.bundle.bundleManager (应用程序包管理模块).md)。
...
参数名类型必填说明callbackAsyncCallback<[ApplicationInfo](ApplicationInfo.md)>是回调函数，返回当前应用程序的信息。
...
类型说明Promise<[ApplicationInfo](ApplicationInfo.md)>Promise对象，返回当前应用程序的信息。
...
参数名类型必填说明callbackAsyncCallback<[bundle.DisplayOrientation](@ohos.bundle.bundleManager (应用程序包管理模块).md#ZH-CN_TOPIC_0000002497444634__displayorientation)>是回调函数，返回屏幕显示方向。
...
类型说明Promise<[bundle.DisplayOrientation](@ohos.bundle.bundleManager (应用程序包管理模块).md#ZH-CN_TOPIC_0000002497444634__displayorientation)>Promise对象，返回屏幕显示方向。
...
参数名类型必填说明orientation[bundle.DisplayOrientation](@ohos.bundle.bundleManager (应用程序包管理模块).md#ZH-CN_TOPIC_0000002497444634__displayorientation)是指示当前能力的新方向。callbackAsyncCallback<void>是回调函数。当设置当前Ability的显示方向成功，err为undefined，否则为错误对象。
...
参数名类型必填说明orientation[bundle.DisplayOrientation](@ohos.bundle.bundleManager (应用程序包管理模块).md#ZH-CN_TOPIC_0000002497444634__displayorientation)是表示屏幕显示方向。
...
参数名类型必填说明callbackAsyncCallback<[ProcessInfo](ProcessInfo.md)>是回调函数，返回当前进程的信息。
...
类型说明Promise<[ProcessInfo](ProcessInfo.md)>Promise对象，返回当前进程的信息。
...
参数名类型必填说明callbackAsyncCallback<[ElementName](ElementName.md)>是回调函数，返回当前ability的ohos.bundleManager.ElementName对象。
...
类型说明Promise<[ElementName](ElementName.md)>Promise对象，返回当前ability的ohos.bundleManager.ElementName对象。
...
参数名类型必填说明callbackAsyncCallback<[HapModuleInfo](HapModuleInfo.md)>是回调函数，返回应用的ModuleInfo对象。
...
类型说明Promise<[HapModuleInfo](HapModuleInfo.md)>Promise对象，返回应用的ModuleInfo对象。
...
参数名类型必填说明callbackAsyncCallback<[AppVersionInfo](AppVersionInfo.md)>是回调函数，返回应用版本信息。
...
类型说明Promise<[AppVersionInfo](AppVersionInfo.md)>Promise对象，返回应用版本信息。
...
参数名类型必填说明callbackAsyncCallback<[AbilityInfo](AbilityInfo.md)>是回调函数，返回当前归属Ability详细信息。
...
类型说明Promise<[AbilityInfo](AbilityInfo.md)>Promise对象，返回当前归属Ability详细信息。
