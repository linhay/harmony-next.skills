...
content[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)是@Prop
...
progressButtonWidth[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否-
...
progressButtonRadius18+[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Prop
...
名称类型只读可选说明progressColor[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是

进度条颜色。

默认值：#330A59F7

borderColor[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是

按钮描边颜色。

默认值：#330A59F7

textColor[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是
