...
[NavBar](#ZH-CN_TOPIC_0000002497444902__navbar12)嵌套使用Navigation时，内层Navigation的生命周期不和外层Navigation以及[全模态](zh-cn_topic_0000002529444815.html)的生命周期进行联动。
...
从API version 9开始，推荐与[NavRouter](NavRouter.md)组件搭配使用。
...
创建路由导航的根视图容器，适用于使用[NavRouter](NavRouter.md)组件进行页面路由。
...
参数名类型必填说明valueArray<[NavigationMenuItem](#ZH-CN_TOPIC_0000002497444902__navigationmenuitem)> | [CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)是页面右上角菜单。
...
参数名类型必填说明itemsArray<[NavigationMenuItem](#ZH-CN_TOPIC_0000002497444902__navigationmenuitem)> | [CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)是页面右上角菜单。options[NavigationMenuOptions](#ZH-CN_TOPIC_0000002497444902__navigationmenuoptions19)否页面右上角菜单选项。
...
参数名类型必填说明valueArray<[ToolbarItem](#ZH-CN_TOPIC_0000002497444902__toolbaritem10)> | [CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)是
...
参数名类型必填说明valuestring | [PixelMap](Interface (PixelMap).md) | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource) | [SymbolGlyphModifier12+](动态SymbolGlyphModifier属性设置.md#ZH-CN_TOPIC_0000002529444819__symbolglyphmodifier)是标题栏中返回键图标。
...
1. 不建议混合使用systemBarStyle属性和window设置状态栏样式的相关接口，例如：[setWindowSystemBarProperties](Interface (Window).md#ZH-CN_TOPIC_0000002497604802__setwindowsystembarproperties9)。
...
参数名类型必填说明style[Optional](自定义属性设置.md#ZH-CN_TOPIC_0000002529284845__optionalt12)<[SystemBarStyle](Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__systembarstyle12)>是系统状态栏样式。
...
参数名类型必填说明placeholder[ComponentContent](ComponentContent.md#ZH-CN_TOPIC_0000002497444816__componentcontent-1)是设置Navigation双栏模式下右侧的默认占位页。
...
将路由栈内指定navDestinationId的NavDestination页面删除。navDestinationId可以在NavDestination的[onReady](NavDestination.md#ZH-CN_TOPIC_0000002529284873__onready11)回调中获取，也可以在[NavDestinationInfo](@ohos.arkui.observer (无感监听).md#ZH-CN_TOPIC_0000002529444737__navdestinationinfo)中获取。
...
参数名类型必填说明from[NavPathInfo](Navigation.md#ZH-CN_TOPIC_0000002497444902__navpathinfo10) |[NavBar](#ZH-CN_TOPIC_0000002497444902__navbar12)是退场页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。to[NavPathInfo](zh-cn_topic_0000002497444902.html#ZH-CN_TOPIC_0000002497444902__navpathinfo10) |[NavBar](#ZH-CN_TOPIC_0000002497444902__navbar12)是进场页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。pathStack[NavPathStack](zh-cn_topic_0000002497444902.html#ZH-CN_TOPIC_0000002497444902__navpathstack10)是页面栈。operation[NavigationOperation](#ZH-CN_TOPIC_0000002497444902__navigationoperation11枚举说明)是当前页面跳转类型。isAnimatedboolean是
...
可滚动组件不满一屏时，如果想使用联动效果，就要使用滚动组件提供的[edgeEffect](List.md#ZH-CN_TOPIC_0000002529284863__edgeeffect)接口将options参数设置为true。未滚动状态，标题栏高度与Full模式一致；滚动时，标题栏的最小高度与Mini模式一致。
...
名称类型只读可选说明builder[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)否否设置标题栏内容。height[TitleHeight](枚举说明.md#ZH-CN_TOPIC_0000002529284967__titleheight9) | [Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否否设置标题栏高度。
...
paddingStart12+[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否是
...
paddingEnd12+[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否是
...
类型说明[SystemBarStyle](Interfaces (其他).md#ZH-CN_TOPIC_0000002529284795__systembarstyle12)
...
该示例演示如何使用[recoverable](#ZH-CN_TOPIC_0000002497444902__recoverable14)配置Navigation可恢复，需要开发者在应用模块初始化时启用[UIAbility](zh-cn_topic_0000002529444559.html)的备份恢复功能，可参考[UIAbility备份恢复](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ability-recover-guideline)。
