...
当“grant_type”为“authorization_code”时，此参数必选。获取方式详见[LoginWithHuaweiIDResponse](authentication (华为账号应用统一认证服务).md#section15454203811311)或[AuthorizationWithHuaweiIDResponse](authentication (华为账号应用统一认证服务).md#section10418450161620)。
