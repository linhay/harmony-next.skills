...
MyDataSource实现了[LazyForEach](LazyForEach.md)数据源接口[IDataSource](LazyForEach.md#ZH-CN_TOPIC_0000002529444937__idatasource)，用于通过LazyForEach给LazyVGridLayout提供子组件。
