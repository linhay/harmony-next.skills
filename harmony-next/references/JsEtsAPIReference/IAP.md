...
订单数据的JSON字符串，包含的参数请参见[InAppPurchaseData](数据类型说明.md#section494862084917)。
...
包含支付结果的JSON字符串，包含的参数请参见[PurchaseData](数据类型说明.md#section650794012482)。
...
purchaseToken需从购买数据[InAppPurchaseData](数据类型说明.md#section494862084917)中获取。支付成功或者请求[queryOwnedPurchases](#section78016131463)接口均会返回[InAppPurchaseData](zh-cn_topic_0000002446613081.html#section494862084917)的JSON字符串。
...
包含消耗结果数据的JSON字符串。字符串中包含参数请参见[InAppPurchaseData](数据类型说明.md#section494862084917)。
...
purchaseToken需从购买数据[PurchaseOrderPayload](数据类型说明.md#section260562820380)中获取。请求[createPurchase](#section18798154545516)或[queryPurchases](#section1147122418532)接口均会返回[PurchaseOrderPayload](zh-cn_topic_0000002446613081.html#section260562820380)。
...
purchaseOrderId需从购买数据[PurchaseOrderPayload](数据类型说明.md#section260562820380)中获取。请求[createPurchase](#section18798154545516)或[queryPurchases](#section1147122418532)接口均会返回[PurchaseOrderPayload](zh-cn_topic_0000002446613081.html#section260562820380)。
...
该字段以JSON字符串的形式记录[InAppPurchaseData](数据类型说明.md#section494862084917)的数据，用于配合inAppSignatureList验签。每个JSON字符串包含的参数请参见[InAppPurchaseData](数据类型说明.md#section494862084917)。
...
[PurchaseData](数据类型说明.md#section650794012482)字符串的数组。
