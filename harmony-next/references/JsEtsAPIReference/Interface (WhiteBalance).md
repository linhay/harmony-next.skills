...
参数名类型必填说明mode[WhiteBalanceMode](Enums.md#ZH-CN_TOPIC_0000002497445814__whitebalancemode20)是白平衡模式。
...
类型说明[WhiteBalanceMode](Enums.md#ZH-CN_TOPIC_0000002497445814__whitebalancemode20)获取当前白平衡模式。若接口调用失败，返回undefined。
