...
data[Uint8ClampedArray](Class (Uint8ClampedArray).md)否
...
用来配置ImageData对象的单位模式，配置后无法动态更改，配置方法同[CanvasRenderingContext2D](CanvasRenderingContext2D.md)。
...
data[Uint8ClampedArray](Class (Uint8ClampedArray).md)是否一维数组，保存了相应的颜色数据，数据值范围为0到255。
