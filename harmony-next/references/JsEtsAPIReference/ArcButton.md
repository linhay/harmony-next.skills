...
label[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否否弧形按钮显示文本。backgroundBlurStyle[BlurStyle](背景设置.md#ZH-CN_TOPIC_0000002529444791__blurstyle9)否否

弧形按钮背景模糊能力。

默认值：BlurStyle.NONE

backgroundColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否否
...
shadowColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否否
...
fontSize[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否否

弧形按钮文本大小。

默认值：19fp

fontColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否否
...
pressedFontColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否否
...
fontFamilystring | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否否弧形按钮字体名。fontMargin[LocalizedMargin](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedmargin12)否否

弧形按钮文本边距。

默认值：{start:24vp, top: 10vp,end: 24vp, bottom:16vp }

onTouch[Callback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)< [TouchEvent](触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)>否是弧形按钮手指触摸动作触发该回调。onClick[Callback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)<[ClickEvent](点击事件.md#ZH-CN_TOPIC_0000002529284807__clickevent) >否是弧形按钮点击动作触发该回调。
...
label[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是弧形按钮显示文本。backgroundBlurStyle[BlurStyle](背景设置.md#ZH-CN_TOPIC_0000002529444791__blurstyle9)否是

弧形按钮背景模糊能力。

默认值：BlurStyle.NONE

backgroundColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否是
...
shadowColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否是
...
fontSize[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否是
...
pressedFontColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否是
...
fontFamilystring | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是弧形按钮字体名。fontMargin[LocalizedMargin](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedmargin12)否是
