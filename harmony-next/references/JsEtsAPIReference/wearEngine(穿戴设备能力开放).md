...
以下错误码的详细介绍请参见[Wear Engine ArkTS API错误码](ArkTS API错误码.md)。

错误码ID

错误信息

[401](ArkTS API错误码.md#section201741341307)

Parameter error. Possible causes: 1. Mandatory parameters are left unspecified. 2. Incorrect parameter types.

[801](ArkTS API错误码.md#section5941173162512)

Capability not supported.

[1008509999](ArkTS API错误码.md#section93011432734)
...
[1008500001](ArkTS API错误码.md#section1047474644710)

Network error. The network is unavailable.

[1008500004](ArkTS API错误码.md#section485113712218)

App has not applied for the Wear Engine service.

[1008500006](ArkTS API错误码.md#section1461311549277)

User privacy is not agreed.

[1008500007](ArkTS API错误码.md#section15917165718219)

The device capability is not supported.

[1008500008](ArkTS API错误码.md#section612518413314)

Account error. The user has not logged in with HUAWEI ID.

[1008500009](ArkTS API错误码.md#section94850224314)
...
[1008500002](ArkTS API错误码.md#section18859424615)

No device is bound.

[1008500003](ArkTS API错误码.md#section11616131326)
...
[1008500005](ArkTS API错误码.md#section665613120197)
...
[1008500010](ArkTS API错误码.md#section411611281734)
...
[1008500012](ArkTS API错误码.md#section1599615141614)
...
[1008500011](ArkTS API错误码.md#section4583155021811)
