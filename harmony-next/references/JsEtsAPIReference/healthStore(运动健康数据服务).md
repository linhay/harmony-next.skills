...
[1002700001](ArkTS API错误码.md#section153755119333)

System internal error.

[1002700002](ArkTS API错误码.md#section1210612513414)

Database processing error.

[1002701001](ArkTS API错误码.md#section140917121405)

Network error. The network is unavailable.

[1002702001](ArkTS API错误码.md#section673773124213)

Account error. The user has not logged in with HUAWEI ID.

[1002702002](ArkTS API错误码.md#section1283610451436)

Account error. Failed to obtain account information with HUAWEI ID.

[1002703001](ArkTS API错误码.md#section9390213122310)
...
以下错误码的详细介绍请参见[运动健康服务ArkTS API错误码](ArkTS API错误码.md)，其他错误码请参见[华为账号服务ArkTS错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code)。
...
[801](ArkTS API错误码.md#section14722630151713)
