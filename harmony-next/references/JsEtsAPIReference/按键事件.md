...
名称类型只读可选说明type[KeyType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__keytype)否否

按键的类型。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

[keyCode](@ohos.multimodalInput.keyCode (键值).md#ZH-CN_TOPIC_0000002529285559__keycode)number否否
...
keySource[KeySource](枚举说明.md#ZH-CN_TOPIC_0000002529284967__keysource)否否
...
类型说明[IntentionCode](@ohos.multimodalInput.intentionCode (意图事件).md)按键对应的意图。
