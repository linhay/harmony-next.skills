...
类型说明[OH_AVBuffer](OH_AVBuffer.md) *
...
参数项描述[OH_AVBuffer](OH_AVBuffer.md) *buffer指向OH_AVBuffer实例的指针。
...
参数项描述[OH_AVBuffer](OH_AVBuffer.md) *buffer指向OH_AVBuffer实例的指针。[OH_AVCodecBufferAttr](OH_AVCodecBufferAttr.md) *attr指向OH_AVCodecBufferAttr实例的指针。
...
参数项描述[OH_AVBuffer](OH_AVBuffer.md) *buffer指向OH_AVBuffer实例的指针。[const OH_AVCodecBufferAttr](OH_AVCodecBufferAttr.md) *attr指向OH_AVCodecBufferAttr实例的指针。
...
参数项描述[OH_AVBuffer](OH_AVBuffer.md) *buffer指向OH_AVBuffer实例的指针。[const OH_AVFormat](OH_AVFormat.md) *format指向OH_AVFormat实例的指针。
...
类型说明[OH_NativeBuffer](OH_NativeBuffer.md) *
