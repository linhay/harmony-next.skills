...
参数名类型必填说明callbackCallback<[TouchEvent](触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明), [HitTestMode](枚举说明.md#ZH-CN_TOPIC_0000002529284967__hittestmode9)>是自定义事件拦截回调。在做[触摸测试](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-basic-principles#触摸测试)时回调此函数。通过返回值设置组件的[触摸碰撞测试模式](zh-cn_topic_0000002497444866.html)。
