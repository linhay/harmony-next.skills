...
名称typedef关键字描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)ArkUI_RenderNodeHandle渲染节点指针。[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md)ArkUI_RenderContentModifierHandle内容修改器指针。[ArkUI_FloatPropertyHandle](ArkUI_FloatPropertyHandle.md)ArkUI_FloatPropertyHandle浮点数属性指针。[ArkUI_Vector2PropertyHandle](ArkUI_Vector2PropertyHandle.md)ArkUI_Vector2PropertyHandle二维向量属性指针。[ArkUI_ColorPropertyHandle](ArkUI_ColorPropertyHandle.md)ArkUI_ColorPropertyHandle颜色属性指针。[ArkUI_FloatAnimatablePropertyHandle](ArkUI_FloatAnimatablePropertyHandle.md)ArkUI_FloatAnimatablePropertyHandle可动画的浮点数属性指针。[ArkUI_Vector2AnimatablePropertyHandle](ArkUI_Vector2AnimatablePropertyHandle.md)ArkUI_Vector2AnimatablePropertyHandle可动画的二维向量属性指针。[ArkUI_ColorAnimatablePropertyHandle](ArkUI_ColorAnimatablePropertyHandle.md)ArkUI_ColorAnimatablePropertyHandle可动画的颜色属性指针。[ArkUI_RectShapeOption](ArkUI_RectShapeOption.md)ArkUI_RectShapeOption范围形状结构体。[ArkUI_NodeBorderStyleOption](ArkUI_NodeBorderStyleOption.md)ArkUI_NodeBorderStyleOption边框样式配置项。[ArkUI_NodeBorderWidthOption](ArkUI_NodeBorderWidthOption.md)ArkUI_NodeBorderWidthOption边框宽度配置项。[ArkUI_NodeBorderColorOption](ArkUI_NodeBorderColorOption.md)ArkUI_NodeBorderColorOption边框颜色配置项。[ArkUI_NodeBorderRadiusOption](ArkUI_NodeBorderRadiusOption.md)ArkUI_NodeBorderRadiusOption边框弧度配置项。[ArkUI_CircleShapeOption](ArkUI_CircleShapeOption.md)ArkUI_CircleShapeOption圆形形状配置项。[ArkUI_RoundRectShapeOption](ArkUI_RoundRectShapeOption.md)ArkUI_RoundRectShapeOption圆角矩形形状配置项。[ArkUI_CommandPathOption](ArkUI_CommandPathOption.md)ArkUI_CommandPathOption自定义路径配置项。[ArkUI_RenderNodeMaskOption](ArkUI_RenderNodeMaskOption.md)ArkUI_RenderNodeMaskOption节点遮罩配置项。[ArkUI_RenderNodeClipOption](ArkUI_RenderNodeClipOption.md)ArkUI_RenderNodeClipOption节点裁剪配置项。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node目标节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) child目标渲染节点。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node目标节点。
...
类型说明[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)目标渲染节点。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标父渲染节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) child目标添加子渲染节点。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标父渲染节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) child目标添加子渲染节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) sibling目标子渲染节点。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标父渲染节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) child目标被移除子渲染节点。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标父渲染节点。int32_t index子节点的从零开始的索引。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)* child用于接收子节点的渲染节点指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)* child用于接收第一个子节点的渲染节点指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)* sibling用于接收下一个子节点的渲染节点指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node参考节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)* sibling用于接收上一个子节点的渲染节点指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标父渲染节点。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)** children用于存储所有子渲染节点的指针数组。int32_t* count用于存储获取到的子节点数量的指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标父渲染节点。int32_t* count用于存储子节点数量的指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。uint32_t color
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。int32_t clipToFrame
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。int32_t clipToBounds
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。float opacity
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。int32_t width
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。int32_t x
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。float x
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。float* matrix4x4 变换矩阵的浮点数数组（16 个连续值）。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。float alpha
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。float elevation
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。float radius
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_NodeBorderStyleOption](ArkUI_NodeBorderStyleOption.md)* borderStyle
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_NodeBorderWidthOption](ArkUI_NodeBorderWidthOption.md)* borderWidth
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_NodeBorderColorOption](ArkUI_NodeBorderColorOption.md)* borderColor
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_NodeBorderRadiusOption](ArkUI_NodeBorderRadiusOption.md)* borderRadius
...
将原节点图像作为源颜色，遮罩图形为目标颜色，通过[BlendMode.SRC_IN](Enums.md#ZH-CN_TOPIC_0000002529285977__blendmode)方式混合成Mask图像。

**起始版本：** 20

**参数：**

参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_RenderNodeMaskOption](ArkUI_RenderNodeMaskOption.md)* mask遮罩配置的指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_RenderNodeClipOption](ArkUI_RenderNodeClipOption.md)* clip裁剪配置的指针。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。bool markNodeGroup
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。float x边界左上角的X坐标（以像素为单位）。float y边界左上角的Y坐标（以像素为单位）。float w边界的宽度（以像素为单位）。float h边界的高度（以像素为单位）。
...
参数项描述[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md) node目标渲染节点。[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier内容修改器。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier内容修改器。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier为目标内容修改器设置浮点属性。[ArkUI_FloatPropertyHandle](ArkUI_FloatPropertyHandle.md) property浮点属性。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier为目标内容修改器设置二维向量属性。[ArkUI_Vector2PropertyHandle](ArkUI_Vector2PropertyHandle.md) property二维向量属性。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier为目标内容修改器设置颜色属性。[ArkUI_ColorPropertyHandle](ArkUI_ColorPropertyHandle.md) property颜色属性。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier为目标内容修改器设置可动画的浮点属性。[ArkUI_FloatAnimatablePropertyHandle](ArkUI_FloatAnimatablePropertyHandle.md) property可动画的浮点属性。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier为目标内容修改器设置可动画的二维向量属性。[ArkUI_Vector2AnimatablePropertyHandle](ArkUI_Vector2AnimatablePropertyHandle.md) property可动画的二维向量属性。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier为目标内容修改器设置可动画的颜色属性。[ArkUI_ColorAnimatablePropertyHandle](ArkUI_ColorAnimatablePropertyHandle.md) property可动画的颜色属性。
...
类型说明[ArkUI_FloatPropertyHandle](ArkUI_FloatPropertyHandle.md)浮点属性。
...
参数项描述[ArkUI_FloatPropertyHandle](ArkUI_FloatPropertyHandle.md) property浮点属性。float value属性值。
...
参数项描述[ArkUI_FloatPropertyHandle](ArkUI_FloatPropertyHandle.md) property浮点属性。float* value用于接收属性值的指针。
...
参数项描述[ArkUI_FloatPropertyHandle](ArkUI_FloatPropertyHandle.md) property浮点属性。
...
类型说明[ArkUI_Vector2PropertyHandle](ArkUI_Vector2PropertyHandle.md)二维向量属性。
...
参数项描述[ArkUI_Vector2PropertyHandle](ArkUI_Vector2PropertyHandle.md) property二维向量属性。float x属性的X坐标值。float y属性的Y坐标值。
...
参数项描述[ArkUI_Vector2PropertyHandle](ArkUI_Vector2PropertyHandle.md) property二维向量属性。float* x用于接收属性X坐标值的指针。float* y用于接收属性Y坐标值的指针。
...
参数项描述[ArkUI_Vector2PropertyHandle](ArkUI_Vector2PropertyHandle.md) property二维向量属性。
...
类型说明[ArkUI_ColorPropertyHandle](ArkUI_ColorPropertyHandle.md)颜色属性。
...
参数项描述[ArkUI_ColorPropertyHandle](ArkUI_ColorPropertyHandle.md) property颜色属性。uint32_t value属性值。
...
参数项描述[ArkUI_ColorPropertyHandle](ArkUI_ColorPropertyHandle.md) property颜色属性。uint32_t* value用于接收属性值的指针。
...
参数项描述[ArkUI_ColorPropertyHandle](ArkUI_ColorPropertyHandle.md) property颜色属性。
...
类型说明[ArkUI_FloatAnimatablePropertyHandle](ArkUI_FloatAnimatablePropertyHandle.md)可动画的浮点属性。
...
参数项描述[ArkUI_FloatAnimatablePropertyHandle](ArkUI_FloatAnimatablePropertyHandle.md) property可动画的浮点属性。float value属性值。
...
参数项描述[ArkUI_FloatAnimatablePropertyHandle](ArkUI_FloatAnimatablePropertyHandle.md) property可动画的浮点属性。float* value用于接收属性值的指针。
...
参数项描述[ArkUI_FloatAnimatablePropertyHandle](ArkUI_FloatAnimatablePropertyHandle.md) property可动画的浮点属性。
...
类型说明[ArkUI_Vector2AnimatablePropertyHandle](ArkUI_Vector2AnimatablePropertyHandle.md)可动画的二维向量属性。
...
参数项描述[ArkUI_Vector2AnimatablePropertyHandle](ArkUI_Vector2AnimatablePropertyHandle.md) property可动画的二维向量属性。float x属性的X坐标值。float y属性的Y坐标值。
...
参数项描述[ArkUI_Vector2AnimatablePropertyHandle](ArkUI_Vector2AnimatablePropertyHandle.md) property可动画的二维向量属性。float* x用于接收属性X坐标值的指针。float* y用于接收属性Y坐标值的指针。
...
参数项描述[ArkUI_Vector2AnimatablePropertyHandle](ArkUI_Vector2AnimatablePropertyHandle.md) property可动画的二维向量属性。
...
类型说明[ArkUI_ColorAnimatablePropertyHandle](ArkUI_ColorAnimatablePropertyHandle.md)可动画的颜色属性。
...
参数项描述[ArkUI_ColorAnimatablePropertyHandle](ArkUI_ColorAnimatablePropertyHandle.md) property可动画的颜色属性。uint32_t value属性值。
...
参数项描述[ArkUI_ColorAnimatablePropertyHandle](ArkUI_ColorAnimatablePropertyHandle.md) property可动画的颜色属性。uint32_t* value用于接收属性值的指针。
...
参数项描述[ArkUI_ColorAnimatablePropertyHandle](ArkUI_ColorAnimatablePropertyHandle.md) property可动画的颜色属性。
...
参数项描述[ArkUI_RenderContentModifierHandle](ArkUI_RenderContentModifierHandle.md) modifier目标内容修改器。void* userData要传递给回调的自定义数据。void (callback)([ArkUI_DrawContext](ArkUI_DrawContext.md) context, void* userData)绘制事件接收回调。
...
类型说明[ArkUI_RectShapeOption](ArkUI_RectShapeOption.md)*指向矩形形状的指针。
...
参数项描述[ArkUI_RectShapeOption](ArkUI_RectShapeOption.md)* option指向矩形形状的指针。
...
参数项描述[ArkUI_RectShapeOption](ArkUI_RectShapeOption.md)* option指向矩形形状的指针。float edgeValue矩形形状的边缘值。[ArkUI_EdgeDirection](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_edgedirection) direction要设置边缘值的矩形方向。
...
类型说明[ArkUI_NodeBorderStyleOption](ArkUI_NodeBorderStyleOption.md)*指向节点边框样式的指针。
...
参数项描述[ArkUI_NodeBorderStyleOption](ArkUI_NodeBorderStyleOption.md)* option指向节点边框样式的指针。
...
参数项描述[ArkUI_NodeBorderStyleOption](ArkUI_NodeBorderStyleOption.md)* option指向节点边框样式的指针。[ArkUI_BorderStyle](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_borderstyle) edgeStyle节点边框样式的边缘边框样式值。[ArkUI_EdgeDirection](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_edgedirection) direction边缘的方向。
...
类型说明[ArkUI_NodeBorderWidthOption](ArkUI_NodeBorderWidthOption.md)*指向节点边框宽度的指针。
...
参数项描述[ArkUI_NodeBorderWidthOption](ArkUI_NodeBorderWidthOption.md)* option指向节点边框宽度的指针。
...
参数项描述[ArkUI_NodeBorderWidthOption](ArkUI_NodeBorderWidthOption.md)* option指向节点边框宽度的指针。float edgeWidth
...
类型说明[ArkUI_NodeBorderColorOption](ArkUI_NodeBorderColorOption.md)*指向节点边框颜色的指针。
...
参数项描述[ArkUI_NodeBorderColorOption](ArkUI_NodeBorderColorOption.md)* option指向节点边框颜色的指针。
...
参数项描述[ArkUI_NodeBorderColorOption](ArkUI_NodeBorderColorOption.md)* option指向节点边框颜色的指针。uint32_t edgeColor节点边框颜色的边缘颜色值。[ArkUI_EdgeDirection](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_edgedirection) direction边缘的方向。
...
类型说明[ArkUI_NodeBorderRadiusOption](ArkUI_NodeBorderRadiusOption.md)*指向节点边框半径的指针。
...
参数项描述[ArkUI_NodeBorderRadiusOption](ArkUI_NodeBorderRadiusOption.md)* option指向节点边框半径的指针。
...
参数项描述[ArkUI_NodeBorderRadiusOption](ArkUI_NodeBorderRadiusOption.md)* option指向节点边框半径的指针。uint32_t cornerRadius节点边框半径的边缘半径值。[ArkUI_CornerDirection](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_cornerdirection) direction边缘的方向。
...
类型说明[ArkUI_CircleShapeOption](ArkUI_CircleShapeOption.md)*指向圆形形状的指针。
...
参数项描述[ArkUI_CircleShapeOption](ArkUI_CircleShapeOption.md)* option指向圆形形状的指针。
...
参数项描述[ArkUI_CircleShapeOption](ArkUI_CircleShapeOption.md)* option指向圆形形状的指针。float centerX圆心x轴坐标值。
...
参数项描述[ArkUI_CircleShapeOption](ArkUI_CircleShapeOption.md)* option指向圆形形状的指针。float centerY圆心y轴坐标值。
...
参数项描述[ArkUI_CircleShapeOption](ArkUI_CircleShapeOption.md)* option指向圆形形状的指针。float radius半径值（以像素为单位）。
...
类型说明[ArkUI_RoundRectShapeOption](ArkUI_RoundRectShapeOption.md)*指向圆角矩形形状的指针。
...
参数项描述[ArkUI_RoundRectShapeOption](ArkUI_RoundRectShapeOption.md)* option指向圆角矩形形状的指针。
...
参数项描述[ArkUI_RoundRectShapeOption](ArkUI_RoundRectShapeOption.md)* option指向圆角矩形形状的指针。float edgeValue圆角矩形形状的边缘值。[ArkUI_EdgeDirection](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_edgedirection) direction要设置边缘值的矩形方向。
...
参数项描述[ArkUI_RoundRectShapeOption](ArkUI_RoundRectShapeOption.md)* option指向圆角矩形形状的指针。float x目标角的X坐标（以像素为单位）。float y目标角的Y坐标（以像素为单位）。[ArkUI_CornerDirection](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_cornerdirection) direction角的方向。
...
类型说明[ArkUI_CommandPathOption](ArkUI_CommandPathOption.md)*指向自定义绘制路径的指针。
...
参数项描述[ArkUI_CommandPathOption](ArkUI_CommandPathOption.md)* option指向自定义绘制路径的指针。
...
参数项描述[ArkUI_CommandPathOption](ArkUI_CommandPathOption.md)* option指向自定义绘制路径的指针。char* commands命令值。入参格式为SVG的[<path>形状标签](SVG标签说明.md#ZH-CN_TOPIC_0000002497444924__基础形状)。
...
参数项描述[ArkUI_RectShapeOption*](ArkUI_RectShapeOption.md) shape指向矩形形状的指针。

**返回：**

类型说明[ArkUI_RenderNodeMaskOption](ArkUI_RenderNodeMaskOption.md)指向渲染节点遮罩的指针。
...
参数项描述[ArkUI_RoundRectShapeOption*](ArkUI_RoundRectShapeOption.md) shape指向圆角矩形形状的指针。
...
参数项描述[ArkUI_CircleShapeOption*](ArkUI_CircleShapeOption.md) shape指向圆形形状的指针。
...
参数项描述[ArkUI_RectShapeOption*](ArkUI_RectShapeOption.md) shape指向椭圆形形状的指针。
...
参数项描述[ArkUI_CommandPathOption*](ArkUI_CommandPathOption.md) path指向自定义绘制路径的指针。
...
参数项描述[ArkUI_RenderNodeMaskOption*](ArkUI_RenderNodeMaskOption.md) option指向渲染节点遮罩的指针。
...
参数项描述[ArkUI_RenderNodeMaskOption](ArkUI_RenderNodeMaskOption.md)* mask指向渲染节点遮罩的指针。uint32_t fillColor遮罩的填充颜色。
...
参数项描述[ArkUI_RenderNodeMaskOption](ArkUI_RenderNodeMaskOption.md)* mask指向渲染节点遮罩的指针。uint32_t strokeColor遮罩的描边颜色。
...
参数项描述[ArkUI_RenderNodeMaskOption](ArkUI_RenderNodeMaskOption.md)* mask指向渲染节点遮罩的指针。float strokeWidth
...
类型说明[ArkUI_RenderNodeClipOption](ArkUI_RenderNodeClipOption.md)*指向渲染节点裁剪的指针。
...
参数项描述[ArkUI_RenderNodeClipOption](ArkUI_RenderNodeClipOption.md)* option指向渲染节点裁剪的指针。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) nodeArkUI_NodeHandle指针。[ArkUI_RenderNodeHandle](ArkUI_RenderNodeHandle.md)* renderNodeArkUI_RenderNodeHandle*指针，目标节点的RenderNode。
