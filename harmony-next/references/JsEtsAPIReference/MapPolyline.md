...
折线，继承[BaseOverlay](BaseOverlay.md)。在调用map.[MapComponentController](MapComponentController.md)类的[addPolyline](MapComponentController.md#section6818109112812)方法时会返回该类型的实例。
...
[mapCommon.CapStyle](mapCommon（地图属性模型）.md#section173028494409)
...
[PatternItem](mapCommon（地图属性模型）.md#section917314511192)对象的集合。
