...
名称描述[image_common.h](image_common.h.md)声明图像接口使用的公共枚举和结构体。[image_native.h](image_native.h.md)声明图像的剪辑矩形、大小和组件数据的接口函数。[image_packer_native.h](image_packer_native.h.md)图片编码API。[image_receiver_native.h](image_receiver_native.h.md)声明从native层获取图片数据的方法。[image_source_native.h](image_source_native.h.md)图片解码API。[picture_native.h](picture_native.h.md)提供获取picture数据和信息的API。[pixelmap_native.h](pixelmap_native.h.md)访问Pixelmap的API。