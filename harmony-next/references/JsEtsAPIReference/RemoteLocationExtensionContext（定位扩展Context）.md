...
RemoteLocationExtensionContext是[RemoteLocationExtensionAbility](RemoteLocationExtensionAbility（定位扩展Ability）.md)的上下文环境，继承自[ExtensionContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-extensioncontext)。
