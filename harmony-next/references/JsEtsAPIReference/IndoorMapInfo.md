...
室内图信息。在调用map.[MapEventManager](MapEventManager.md)中[on](MapEventManager.md#section76731728143918)(type: 'indoorMapEnter', callback: Callback<[IndoorMapInfo](IndoorMapInfo.md)>)方法时会返回该类型的实例。
