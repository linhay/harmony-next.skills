...
参数名类型必填说明context[Context](Context (Stage模型的上下文基类).md)是传入Ability实例的Context。
...
接口抛出错误码的详细介绍请参见[通用错误码](通用错误码.md)。
...
参数名类型必填说明options[photoAccessHelper.FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是图片和视频检索选项。
...
参数名类型必填说明burstKeystring是一组连拍照片的唯一标识：uuid(可传入[PhotoKeys](Enums.md#ZH-CN_TOPIC_0000002529445919__photokeys)的BURST_KEY)。字符串长度为36。options[photoAccessHelper.FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是连拍照片检索选项。
...
参数名类型必填说明photoType[PhotoType](#ZH-CN_TOPIC_0000002497445976__phototype)是创建的文件类型，IMAGE或者VIDEO类型。extensionstring是文件名后缀参数，例如：'jpg'。字符串长度为1~255。options[photoAccessHelper.CreateOptions](zh-cn_topic_0000002529285945.html#ZH-CN_TOPIC_0000002529285945__createoptions)否
...
参数名类型必填说明type[AlbumType](#ZH-CN_TOPIC_0000002497445976__albumtype)是相册类型。subtype[AlbumSubtype](#ZH-CN_TOPIC_0000002497445976__albumsubtype)是相册子类型。options[photoAccessHelper.FetchOptions](zh-cn_topic_0000002529285945.html#ZH-CN_TOPIC_0000002529285945__fetchoptions)否检索选项，不填时默认根据相册类型检索。
...
参数名类型必填说明options[photoAccessHelper.FetchOptions](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__fetchoptions)是检索选项。
...
类型说明photoAccessHelper.PhotoAsset返回非Sendable类型的[PhotoAsset](Interface (PhotoAsset).md)。
...
参数名类型必填说明memberstring是成员参数名称，在get时，除了'uri'、'media_type'、'subtype'和'display_name'四个属性之外，其他的属性都需要在fetchColumns中填入需要get的[PhotoKeys](Enums.md#ZH-CN_TOPIC_0000002529445919__photokeys)，例如：get title属性fetchColumns: ['title']。

**返回值：**

类型说明[photoAccessHelper.MemberType](Types.md#ZH-CN_TOPIC_0000002497605956__membertype)获取PhotoAsset成员参数的值。
...
参数名类型必填说明memberstring是成员参数名称例如：[PhotoKeys](Enums.md#ZH-CN_TOPIC_0000002529445919__photokeys).TITLE。字符串长度为1~255。valuestring是

设置成员参数名称，只能修改[PhotoKeys](Enums.md#ZH-CN_TOPIC_0000002529445919__photokeys).TITLE的值。title的参数规格为：
...
详细错误码请参见[通用错误码](通用错误码.md)和[文件管理错误码](文件管理错误码.md)。
...
类型说明[photoAccessHelper.Album](Interface (Album).md)返回非Sendable类型的Album。
