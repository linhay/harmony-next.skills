...
名称类型只读可选说明result[ResultCode](#ZH-CN_TOPIC_0000002529444575__resultcode)否否表示结果码。want10+[Want](zh-cn_topic_0000002529284603.html)否是表示Want类型信息，如ability名称，包名等。
