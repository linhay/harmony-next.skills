...
以下错误码的详细介绍请参见[通用错误码](通用错误码.md)和[无障碍子系统错误码](无障碍子系统错误码.md)。
...
参数名类型必填说明gesturePath[GesturePath](@ohos.accessibility.GesturePath (手势路径).md#ZH-CN_TOPIC_0000002497604674__gesturepath)是表示手势的路径信息。
...
参数名类型必填说明gesturePath[GesturePath](@ohos.accessibility.GesturePath (手势路径).md#ZH-CN_TOPIC_0000002497604674__gesturepath)是表示手势的路径信息。callbackAsyncCallback<void>是回调函数，表示注入手势执行结果的回调。
...
参数名类型必填说明actionNamestring是表示属性的名称，取值参考[Action](@ohos.accessibility (辅助应用).md#ZH-CN_TOPIC_0000002529444639__action)。parametersobject否表示执行操作时所需要的参数；默认为空。
...
参数名类型必填说明actionNamestring是表示属性的名称，取值参考[Action](@ohos.accessibility (辅助应用).md#ZH-CN_TOPIC_0000002529444639__action)。callbackAsyncCallback<void>是回调函数，表示执行指定操作的回调。
...
参数名类型必填说明actionNamestring是表示属性的名称，取值参考[Action](@ohos.accessibility (辅助应用).md#ZH-CN_TOPIC_0000002529444639__action)。parametersobject是表示执行操作时所需要的参数；默认为空。callbackAsyncCallback<void>是回调函数，表示执行指定操作的回调。
