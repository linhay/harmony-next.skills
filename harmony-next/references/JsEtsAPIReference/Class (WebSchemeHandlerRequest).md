...
类型说明Array<[WebHeader](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285193__webheader)>返回资源请求头信息。
...
类型说明[WebResourceType](Enums.md#ZH-CN_TOPIC_0000002529445167__webresourcetype12)返回资源请求的资源类型。
