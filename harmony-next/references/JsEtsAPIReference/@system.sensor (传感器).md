...
- 模块维护策略：
  ...
  - 对于支持该模块的其他设备类型，该模块从API version 8开始不再维护，推荐使用新接口[@ohos.sensor](@ohos.sensor (传感器).md)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__accelerometer9)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__accelerometerdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__orientationdeprecated)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__orientationdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__proximitydeprecated)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__proximitydeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__ambient_lightdeprecated)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__ambient_lightdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__pedometerdeprecated)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__pedometerdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__barometerdeprecated-1)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__barometerdeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__heart_ratedeprecated)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__heart_ratedeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__wear_detectiondeprecated)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__wear_detectiondeprecated-2)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.on()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__gyroscopedeprecated)。
...
除Lite Wearable外，从API Version8开始，推荐使用[sensor.off()](@ohos.sensor (传感器).md#ZH-CN_TOPIC_0000002529285633__gyroscopedeprecated-2)。
