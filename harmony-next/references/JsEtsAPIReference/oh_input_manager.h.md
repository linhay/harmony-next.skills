...
名称typedef关键字描述[Input_InterceptorEventCallback](Input_InterceptorEventCallback.md)Input_InterceptorEventCallback拦截回调事件结构体，拦截鼠标事件、触屏输入事件和轴事件。[Input_DeviceListener](Input_DeviceListener.md)Input_DeviceListener定义一个结构体用于监听设备热插拔。[Input_KeyState](Input_KeyState.md)Input_KeyState定义按键信息，用于标识按键行为。例如，“Ctrl”按键信息包含键值和键类型。[Input_KeyEvent](Input_KeyEvent.md)Input_KeyEvent按键事件对象。[Input_MouseEvent](Input_MouseEvent.md)Input_MouseEvent鼠标事件对象。[Input_TouchEvent](Input_TouchEvent.md)Input_TouchEvent触屏输入事件对象。[Input_AxisEvent](Input_AxisEvent.md)Input_AxisEvent轴事件对象。[Input_Hotkey](Input_Hotkey.md)Input_Hotkey定义快捷键结构体。[Input_DeviceInfo](Input_DeviceInfo.md)Input_DeviceInfo输入设备信息。[Input_InterceptorOptions](Input_InterceptorOptions.md)Input_InterceptorOptions事件拦截选项。[Input_CustomCursor](Input_CustomCursor.md)Input_CustomCursor自定义鼠标光标像素图资源。[Input_CursorConfig](Input_CursorConfig.md)Input_CursorConfig自定义鼠标光标配置。[Input_CursorInfo](Input_CursorInfo.md)Input_CursorInfo定义鼠标光标信息。
...
参数项描述const [Input_KeyEvent](Input_KeyEvent.md)* keyEvent
...
参数项描述const [Input_MouseEvent](Input_MouseEvent.md)* mouseEvent
...
参数项描述const [Input_TouchEvent](Input_TouchEvent.md)* touchEvent
...
参数项描述const [Input_AxisEvent](Input_AxisEvent.md)* axisEvent
...
参数项描述struct [Input_KeyState](Input_KeyState.md)* keyState按键状态的枚举对象，具体请参考[Input_KeyStateAction](#ZH-CN_TOPIC_0000002529445539__input_keystateaction)。
...
类型说明struct如果操作成功，@return返回一个[Input_KeyState](Input_KeyState.md)指针对象；否则返回空指针。
...
参数项描述struct [Input_KeyState](Input_KeyState.md)* keyState按键状态的枚举对象，具体请参考[Input_KeyStateAction](#ZH-CN_TOPIC_0000002529445539__input_keystateaction)。int32_t keyCode按键键值。
...
参数项描述const struct [Input_KeyState](Input_KeyState.md)* keyState按键状态的枚举对象，具体请参考[Input_KeyStateAction](oh_input_manager.h.md#ZH-CN_TOPIC_0000002529445539__input_keystateaction)。
...
参数项描述struct [Input_KeyState](Input_KeyState.md)* keyState按键状态的枚举对象，具体请参考[Input_KeyStateAction](#ZH-CN_TOPIC_0000002529445539__input_keystateaction)。int32_t keyAction按键是否按下，具体请参考[Input_KeyEventAction](#ZH-CN_TOPIC_0000002529445539__input_keyeventaction)。
...
参数项描述struct [Input_KeyState](Input_KeyState.md)* keyState按键状态的枚举对象，具体请参考[Input_KeyStateAction](#ZH-CN_TOPIC_0000002529445539__input_keystateaction)。int32_t keySwitch按键开关。
...
参数项描述const struct [Input_KeyEvent](Input_KeyEvent.md)* keyEvent
...
类型说明struct如果操作成功返回一个[Input_KeyEvent](Input_KeyEvent.md)指针对象，否则返回空指针。
...
参数项描述struct [Input_KeyEvent](Input_KeyEvent.md)** keyEvent按键事件对象。
...
参数项描述struct [Input_KeyEvent](Input_KeyEvent.md)* keyEvent
...
类型说明struct如果操作成功返回一个[Input_MouseEvent](Input_MouseEvent.md)指针对象，否则返回空指针。
...
参数项描述struct [Input_MouseEvent](Input_MouseEvent.md)** mouseEvent鼠标事件对象。
...
参数项描述struct [Input_MouseEvent](Input_MouseEvent.md)* mouseEvent
...
参数项描述const struct [Input_MouseEvent](Input_MouseEvent.md)* mouseEvent
...
类型说明struct如果操作成功返回一个[Input_TouchEvent](Input_TouchEvent.md)指针对象，否则返回空指针。
...
参数项描述struct [Input_TouchEvent](Input_TouchEvent.md)** touchEvent触屏输入事件对象。
...
参数项描述struct [Input_TouchEvent](Input_TouchEvent.md)* touchEvent
...
参数项描述const struct [Input_TouchEvent](Input_TouchEvent.md)* touchEvent
...
类型说明Input_AxisEvent*成功返回[Input_AxisEvent](Input_AxisEvent.md)对象实例，失败则返回null。
...
参数项描述[Input_AxisEvent](Input_AxisEvent.md)** axisEvent轴事件对象实例的指针。
...
参数项描述[Input_AxisEvent](Input_AxisEvent.md)* axisEvent
...
参数项描述[Input_KeyEventCallback](#ZH-CN_TOPIC_0000002529445539__input_keyeventcallback) callback回调函数，用于接收按键事件。[Input_InterceptorOptions](zh-cn_topic_0000002497605580.html) *optionoption 输入事件拦截的可选项，传null则使用默认值。
...
参数项描述[Input_InterceptorEventCallback](Input_InterceptorEventCallback.md) *callbackcallback 用于回调输入事件的结构体指针，请参考定义[Input_InterceptorEventCallback](Input_InterceptorEventCallback.md)。[Input_InterceptorOptions](Input_InterceptorOptions.md) *optionoption 输入事件拦截的可选项，传null则使用默认值。
...
类型说明[Input_Hotkey](Input_Hotkey.md)如果操作成功,则返回一个[Input_Hotkey](Input_Hotkey.md)指针对象。否则, 返回一个空指针， 可能的原因是内存分配失败。
...
参数项描述[Input_Hotkey](Input_Hotkey.md) **hotkeyhotkey 快捷键对象的实例。
...
参数项描述[Input_Hotkey](Input_Hotkey.md) *hotkeyhotkey 快捷键对象的实例。int32_t *preKeyspreKeys 修饰键列表。int32_t size修饰键个数， 取值范围1~2个。
...
参数项描述const [Input_Hotkey](Input_Hotkey.md) *hotkeyhotkey 快捷键对象的实例。int32_t **preKeyspreKeys 返回修饰键列表。int32_t *preKeyCountpreKeyCount 返回修饰键个数。
...
参数项描述[Input_Hotkey](Input_Hotkey.md)* hotkey快捷键对象的实例。int32_t finalKey被修饰键值，被修饰键值只能是1个。
...
参数项描述const [Input_Hotkey](Input_Hotkey.md)* hotkey快捷键对象的实例。int32_t *finalKeyCodefinalKeyCode 返回被修饰键键值。
...
创建[Input_Hotkey](Input_Hotkey.md)类型实例的数组。
...
参数项描述int32_t count创建[Input_Hotkey](Input_Hotkey.md)实例的数量。

**返回：**

类型说明[Input_Hotkey](Input_Hotkey.md)
...
销毁[Input_Hotkey](Input_Hotkey.md)实例数组并回收内存。
...
参数项描述[Input_Hotkey](Input_Hotkey.md) **hotkeyshotkeys 指向[Input_Hotkey](Input_Hotkey.md)实例数组的双指针。int32_t count销毁[Input_Hotkey](Input_Hotkey.md)实例的数量。
...
参数项描述[Input_Hotkey](Input_Hotkey.md) **hotkeyhotkey 返回[Input_Hotkey](Input_Hotkey.md) 类型实例数组。首次调用可传入NULL，可获取数组长度。int32_t *countcount 返回支持快捷键的个数。
...
参数项描述[Input_Hotkey](Input_Hotkey.md)* hotkey快捷键对象的实例。bool isRepeat是否上报重复key事件。true表示上报，false表示不上报。
...
参数项描述const [Input_Hotkey](Input_Hotkey.md)* hotkey快捷键对象的实例。bool *isRepeatisRepeat 返回Key事件是否重复。true表示重复，false表示不重复。
...
参数项描述const [Input_Hotkey](Input_Hotkey.md)* hotkey指定要订阅的快捷键对象。[Input_HotkeyCallback](#ZH-CN_TOPIC_0000002529445539__input_hotkeycallback) callback回调函数，用于回调快捷键事件。
...
参数项描述const [Input_Hotkey](Input_Hotkey.md)* hotkey指定要取消订阅的快捷键对象。[Input_HotkeyCallback](#ZH-CN_TOPIC_0000002529445539__input_hotkeycallback) callback回调函数，用于回调快捷键事件。
...
参数项描述[Input_DeviceListener](Input_DeviceListener.md)* listener指向设备热插拔监听器[Input_DeviceListener](Input_DeviceListener.md)的指针。
...
参数项描述int32_t deviceId输入设备的唯一标识，同一个物理设备反复插拔或重启，设备ID可能会发生变化。[Input_DeviceInfo](Input_DeviceInfo.md) **deviceInfodeviceInfo 指向输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)的指针。
...
类型说明Input_DeviceInfo*如果操作成功，返回设备信息[Input_DeviceInfo](Input_DeviceInfo.md)实例的指针。否则返回空指针，可能的原因是分配内存失败。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) **deviceInfodeviceInfo 设备信息的对象。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) *deviceInfodeviceInfo 输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)。int32_t *idid 指向输入设备ID的指针。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) *deviceInfodeviceInfo 输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)。char **namename 指向输入设备名称的指针。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) *deviceInfodeviceInfo 输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)。int32_t *capabilitiescapabilities 指向输入设备能力信息的指针。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) *deviceInfodeviceInfo 输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)。int32_t *versionversion 指向输入设备版本信息的指针。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) *deviceInfodeviceInfo 输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)。int32_t *productproduct 指向输入设备产品信息的指针。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) *deviceInfodeviceInfo 输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)。int32_t *vendorvendor 指向输入设备厂商信息的指针。
...
参数项描述[Input_DeviceInfo](Input_DeviceInfo.md) *deviceInfodeviceInfo 输入设备信息[Input_DeviceInfo](Input_DeviceInfo.md)。char **addressaddress 指向输入设备物理地址的指针。
...
建议先使用[OH_Input_RequestInjection](#ZH-CN_TOPIC_0000002529445539__oh_input_requestinjection)请求授权。然后通过[OH_Input_QueryAuthorizedStatus](#ZH-CN_TOPIC_0000002529445539__oh_input_queryauthorizedstatus)查询授权状态，当授权状态为[AUTHORIZED](zh-cn_topic_0000002529445539.html#ZH-CN_TOPIC_0000002529445539__input_injectionstatus)时，再使用该接口。
...
参数项描述[Input_KeyEvent](Input_KeyEvent.md)* keyEvent
...
窗口ID。取值范围为大于等于-1的整数，取值为-1时表示全局窗口。
 ...
 仅支持传入当前窗口和全局窗口的ID，传入其他ID返回全局窗口的默认光标样式，当前窗口ID可以通过[getWindowProperties](Interface (Window).md#ZH-CN_TOPIC_0000002497604802__getwindowproperties9)获取。
...
窗口ID。取值范围为大于等于0的整数。
 ...
 仅支持传入当前窗口的光标样式，传入其他窗口ID本接口可以运行成功但设置不生效，当前窗口ID可以通过[getWindowProperties](Interface (Window).md#ZH-CN_TOPIC_0000002497604802__getwindowproperties9)获取。
...
参数项描述OH_PixelmapNative* pixelMap[OH_PixelmapNative](OH_PixelmapNative.md)自定义鼠标光标像素图。最小限制为资源图本身的最小限制。最大限制为256 x 256px。int32_t anchorX自定义鼠标光标焦点的水平坐标。该坐标受自定义鼠标光标大小的限制。最小值为0，最大值为资源图的宽度最大值，单位为px。int32_t anchorY自定义鼠标光标焦点的垂直坐标。该坐标受自定义鼠标光标大小的限制。最小值为0，最大值为资源图的高度最大值，单位为px。

**返回：**

类型说明Input_CustomCursor*[Input_CustomCursor](Input_CustomCursor.md)对象。操作成功时返回自定义鼠标光标资源对象的指针。异常时返回空指针。
...
参数项描述Input_CustomCursor** customCursor自定义鼠标光标资源[Input_CustomCursor](Input_CustomCursor.md)。
...
参数项描述Input_CustomCursor* customCursor自定义鼠标光标资源[Input_CustomCursor](Input_CustomCursor.md)。OH_PixelmapNative** pixelMap[OH_PixelmapNative](OH_PixelmapNative.md)自定义鼠标光标像素图。
...
参数项描述Input_CustomCursor* customCursor自定义鼠标光标资源[Input_CustomCursor](Input_CustomCursor.md)。int32_t* anchorX自定义鼠标光标资源的焦点水平坐标，单位为px。int32_t* anchorY自定义鼠标光标资源的焦点垂直坐标，单位为px。
...
类型说明Input_CursorConfig*自定义鼠标光标配置[Input_CursorConfig](Input_CursorConfig.md)对象。
...
参数项描述Input_CursorConfig** cursorConfig自定义鼠标光标配置[Input_CursorConfig](Input_CursorConfig.md)对象。
...
参数项描述Input_CursorConfig* cursorConfig自定义鼠标光标配置[Input_CursorConfig](Input_CursorConfig.md)。bool* followSystem是否根据系统设置调整光标大小，取值为true表示根据系统设置调整鼠标光标大小，取值为false表示使用自定义鼠标光标样式大小。
...
参数项描述int32_t windowId窗口ID。取值范围为大于等于0的整数，仅支持传入当前窗口的光标样式。Input_CustomCursor* customCursor自定义鼠标光标资源[Input_CustomCursor](Input_CustomCursor.md)。Input_CursorConfig* cursorConfig自定义鼠标光标配置[Input_CursorConfig](Input_CursorConfig.md)。
...
类型说明struct Input_CursorInfo*创建成功返回一个[Input_CursorInfo](Input_CursorInfo.md)对象，否则返回空指针，可能原因是内存分配失败。
...
参数项描述[Input_CursorInfo](Input_CursorInfo.md)** cursorInfo鼠标光标信息对象。
...
参数项描述[Input_CursorInfo](Input_CursorInfo.md)* cursorInfo指定鼠标光标信息对象。可以通过[OH_Input_GetMouseEventCursorInfo](#ZH-CN_TOPIC_0000002529445539__oh_input_getmouseeventcursorinfo)查询指定鼠标事件的鼠标光标信息、或通过[OH_Input_GetCursorInfo](#ZH-CN_TOPIC_0000002529445539__oh_input_getcursorinfo)接口查询当前的鼠标光标信息。[Input_PointerStyle](zh-cn_topic_0000002497445596.html)鼠标光标信息的光标样式枚举，具体请参考[Input_PointerStyle](oh_pointer_style.h.md#ZH-CN_TOPIC_0000002497445596__input_pointerstyle)。
...
参数项描述[Input_CursorInfo](Input_CursorInfo.md)* cursorInfo指定鼠标光标信息对象。可以通过[OH_Input_GetMouseEventCursorInfo](#ZH-CN_TOPIC_0000002529445539__oh_input_getmouseeventcursorinfo)查询指定鼠标事件的鼠标光标信息、或通过[OH_Input_GetCursorInfo](#ZH-CN_TOPIC_0000002529445539__oh_input_getcursorinfo)接口查询当前的鼠标光标信息。int32_t* sizeLevel鼠标光标信息的光标大小档位。取值范围为整数1~7，数值越大则光标越大。应用自定义光标[DEVELOPER_DEFINED_ICON](zh-cn_topic_0000002497445596.html#ZH-CN_TOPIC_0000002497445596__input_pointerstyle)请以实际位图大小为准。
...
参数项描述[Input_CursorInfo](Input_CursorInfo.md)* cursorInfo指定鼠标光标信息对象。可以通过[OH_Input_GetMouseEventCursorInfo](#ZH-CN_TOPIC_0000002529445539__oh_input_getmouseeventcursorinfo)查询指定鼠标事件的鼠标光标信息、或通过[OH_Input_GetCursorInfo](#ZH-CN_TOPIC_0000002529445539__oh_input_getcursorinfo)接口查询当前的鼠标光标信息。uint32_t* color鼠标光标信息的光标颜色, 使用32位ARGB整数表示。应用自定义光标[DEVELOPER_DEFINED_ICON](zh-cn_topic_0000002497445596.html#ZH-CN_TOPIC_0000002497445596__input_pointerstyle)请以实际位图颜色为准。
...
参数项描述const [Input_MouseEvent](Input_MouseEvent.md)* mouseEvent鼠标事件对象。可以通过[OH_Input_AddMouseEventMonitor](#ZH-CN_TOPIC_0000002529445539__oh_input_addmouseeventmonitor)或者[OH_Input_AddInputEventInterceptor](#ZH-CN_TOPIC_0000002529445539__oh_input_addinputeventinterceptor)接口的回调函数中获取鼠标事件对象。[Input_CursorInfo](zh-cn_topic_0000002529445547.html)* cursorInfo鼠标光标信息对象，可以通过[OH_Input_CursorInfo_Create](#ZH-CN_TOPIC_0000002529445539__oh_input_cursorinfo_create)接口创建鼠标光标信息对象。
...
参数项描述[Input_CursorInfo](Input_CursorInfo.md)* cursorInfo鼠标光标信息对象，可以通过[OH_Input_CursorInfo_Create](#ZH-CN_TOPIC_0000002529445539__oh_input_cursorinfo_create)接口创建鼠标光标信息对象。[OH_PixelmapNative](zh-cn_topic_0000002497445884.html)** pixelmap
