...
类型说明[common2D.Rect](@ohos.graphics.common2D (2D图形通用数据类型).md#ZH-CN_TOPIC_0000002529445937__rect)返回当前区域的边界矩形。
...
参数名类型必填说明region[Region](Class (Region).md)是区域对象。regionOp[RegionOp](Enums.md#ZH-CN_TOPIC_0000002529285977__regionop12)是区域合并操作类型。
