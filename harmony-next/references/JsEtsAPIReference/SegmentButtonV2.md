...
$selectedIndex[OnSelectedIndexChange](#ZH-CN_TOPIC_0000002497444984__onselectedindexchange)否@Event配置分段按钮选中项变更时触发的回调函数。onItemClickedCallback<number>否@Event配置分段按钮选项被单击时触发的回调函数。buttonBackgroundColor[ColorMetrics](zh-cn_topic_0000002529444761.html#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
buttonBackgroundBlurStyle[BlurStyle](背景设置.md#ZH-CN_TOPIC_0000002529444791__blurstyle9)否@Param
...
buttonBackgroundBlurStyleOptions[BackgroundBlurStyleOptions](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundblurstyleoptions10对象说明)否@Param
...
buttonBackgroundEffect[BackgroundEffectOptions](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundeffectoptions11)否@Param
...
buttonBorderRadius[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
buttonMinHeight[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
buttonPadding[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
itemSelectedBackgroundColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
itemMinHeight[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
itemPadding[LocalizedPadding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12)否@Param
...
itemShadow[ShadowOptions](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowoptions对象说明) | [ShadowStyle](图像效果.md#ZH-CN_TOPIC_0000002497444856__shadowstyle10枚举说明)否@Param
...
itemSpace[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
itemMinFontScalenumber | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否@Param
...
itemMaxFontScalenumber | [Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否@Param
...
itemFontSize[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
itemSelectedFontSize[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
itemFontColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
itemSelectedFontColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
itemFontWeight[FontWeight](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontweight)否@Param
...
itemSelectedFontWeight[FontWeight](枚举说明.md#ZH-CN_TOPIC_0000002529284967__fontweight)否@Param
...
itemBorderRadius[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
itemIconSize[SizeT](Graphics.md#ZH-CN_TOPIC_0000002529444761__sizett12)<[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)>否@Param
...
itemIconFillColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
itemSelectedIconFillColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
itemSymbolFontSize[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)否@Param
...
itemSymbolFontColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
itemSelectedSymbolFontColor[ColorMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
languageDirection[Direction](枚举说明.md#ZH-CN_TOPIC_0000002529284967__direction)否@Param
...
$selectedIndex[OnSelectedIndexChange](#ZH-CN_TOPIC_0000002497444984__onselectedindexchange)否@Event配置分段按钮选中项变更时的回调函数。onItemClickedCallback<number>否@Event配置分段按钮选项被单击时触发的回调函数。buttonBackgroundColor[ColorMetrics](zh-cn_topic_0000002529444761.html#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
$selectedIndexes[OnSelectedIndexesChange](#ZH-CN_TOPIC_0000002497444984__onselectedindexeschange)是@Event配置分段按钮选中项变更时的回调函数。onItemClickedCallback<number>否@Event配置分段按钮选项被单击时触发的回调函数。itemBackgroundColor[ColorMetrics](zh-cn_topic_0000002529444761.html#ZH-CN_TOPIC_0000002529444761__colormetrics12)否@Param
...
itemBackgroundEffect[BackgroundEffectOptions](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundeffectoptions11)否@Param
...
itemBackgroundBlurStyle[BlurStyle](背景设置.md#ZH-CN_TOPIC_0000002529444791__blurstyle9)否@Param
...
itemBackgroundBlurStyleOptions[BackgroundBlurStyleOptions](背景设置.md#ZH-CN_TOPIC_0000002529444791__backgroundblurstyleoptions10对象说明)否@Param
...
名称类型只读可选说明text[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
symbol[Resource](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resource)否是
...
textModifier[TextModifier](动态属性设置.md)否是
...
iconModifier[ImageModifier](动态属性设置.md)否是
...
symbolModifier[SymbolGlyphModifier](动态属性设置.md)否是
...
分段按钮选项的[无障碍重要性](无障碍属性.md#ZH-CN_TOPIC_0000002497444870__accessibilitylevel)。
...
分段按钮选项[无障碍重要性](无障碍属性.md#ZH-CN_TOPIC_0000002497444870__accessibilitylevel)。
