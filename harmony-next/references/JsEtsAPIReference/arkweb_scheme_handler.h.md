...
名称typedef关键字描述[ArkWeb_SchemeHandler_](ArkWeb_SchemeHandler_.md)ArkWeb_SchemeHandler该类用于拦截指定scheme的请求。[ArkWeb_ResourceHandler_](ArkWeb_ResourceHandler_.md)ArkWeb_ResourceHandler用于被拦截的URL请求。可以通过ArkWeb_ResourceHandler发送自定义请求头以及自定义请求体。[ArkWeb_Response_](ArkWeb_Response_.md)ArkWeb_Response为被拦截的请求构造一个ArkWeb_Response。[ArkWeb_ResourceRequest_](ArkWeb_ResourceRequest_.md)ArkWeb_ResourceRequest对应内核的一个请求，可以通过OH_ArkWeb_ResourceRequest获取请求的URL、method、post data以及其他信息。[ArkWeb_RequestHeaderList_](ArkWeb_RequestHeaderList_.md)ArkWeb_RequestHeaderList请求头列表。[ArkWeb_HttpBodyStream_](ArkWeb_HttpBodyStream_.md)ArkWeb_HttpBodyStream请求的上传数据。使用OH_ArkWebHttpBodyStream_接口来读取上传的数据。
...
参数项描述const [ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandlerArkWeb_SchemeHandler。[ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequest通过该对象获取请求的信息。const [ArkWeb_ResourceHandler](ArkWeb_ResourceHandler_.md)* resourceHandler请求的ArkWeb_ResourceHandler。如果intercept设置为false，则不应使用它。bool* intercept如果为true，则会拦截请求；如果为false，则不会拦截。
...
参数项描述const [ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandlerArkWeb_SchemeHandler。const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。
...
参数项描述const [ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。uint8_t* buffer接收数据的buffer。int bytesReadOH_ArkWebHttpBodyStream_Read后的回调函数。如果bytesRead大于0，则表示buffer已填充了bytesRead大小的数据。调用者可以从buffer中读取数据，如果OH_ArkWebHttpBodyStream_IsEOF为false，则调用者可以继续读取剩余的数据。
...
参数项描述const [ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。uint8_t* buffer接收数据的缓存区。int bytesRead标识异步读取操作执行结果的字节计数值。如果bytesRead大于0，则表示buffer已填充了bytesRead大小的数据。开发者可以从buffer中读取数据，如果OH_ArkWebHttpBodyStream_IsEOF为false，则开发者可以继续读取剩余的数据。
...
参数项描述const [ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。[ArkWeb_NetError](arkweb_net_error_list.h.md#ZH-CN_TOPIC_0000002497445244__arkweb_neterror) result成功时返回ARKWEB_NET_OK，否则请参考[arkweb_net_error_list.h](arkweb_net_error_list.h.md)。
...
参数项描述[ArkWeb_RequestHeaderList](ArkWeb_RequestHeaderList_.md)* requestHeaderList将被销毁的ArkWeb_RequestHeaderList。
...
参数项描述const [ArkWeb_RequestHeaderList](ArkWeb_RequestHeaderList_.md)* requestHeaderList请求头的列表。
...
参数项描述[ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。void* userData将要设置的用户数据。
...
参数项描述const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。
...
参数项描述const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。char** methodHTTP请求方法。此函数将为method字符串分配内存，调用者必须使用OH_ArkWeb_ReleaseString释放字符串。
...
参数项描述const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。char** url请求的URL。此函数将为URL字符串分配内存，调用者必须通过OH_ArkWeb_ReleaseString释放该字符串。
...
参数项描述const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。[ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)** httpBodyStream请求的上传数据。此函数将为httpBodyStream分配内存，调用者必须使用OH_ArkWebResourceRequest_DestroyHttpBodyStream释放httpBodyStream。
...
参数项描述[ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStream待销毁的httpBodyStream。
...
参数项描述const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。char** frameUrl触发此请求的Frame的URL。此函数将为URL字符串分配内存，并且调用者必须通过OH_ArkWeb_ReleaseString来释放该字符串。
...
参数项描述[ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。void* userData要设置的用户数据。
...
参数项描述const [ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。
...
参数项描述[ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。[ArkWeb_HttpBodyStreamReadCallback](#ZH-CN_TOPIC_0000002529285215__arkweb_httpbodystreamreadcallback) readCallbackOH_ArkWebHttpBodyStream_Read的回调函数。
...
参数项描述[ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。[ArkWeb_HttpBodyStreamAsyncReadCallback](#ZH-CN_TOPIC_0000002529285215__arkweb_httpbodystreamasyncreadcallback) readCallbackOH_ArkWebHttpBodyStream_AsyncRead的回调函数。
...
参数项描述[ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。[ArkWeb_HttpBodyStreamInitCallback](#ZH-CN_TOPIC_0000002529285215__arkweb_httpbodystreaminitcallback) initCallback初始化的回调函数。
...
参数项描述const [ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。uint8_t* buffer接收数据的buffer。int bufLen要读取的字节的大小。
...
参数项描述const [ArkWeb_HttpBodyStream](ArkWeb_HttpBodyStream_.md)* httpBodyStreamArkWeb_HttpBodyStream。uint8_t* buffer接收数据的缓存区。int bufLen要读取的字节的大小。
...
参数项描述const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。char** referrer请求的Referrer。此函数将为referrer字符串分配内存，调用者必须使用 OH_ArkWeb_ReleaseString 释放该字符串。
...
参数项描述const [ArkWeb_ResourceRequest](ArkWeb_ResourceRequest_.md)* resourceRequestArkWeb_ResourceRequest。[ArkWeb_RequestHeaderList](ArkWeb_RequestHeaderList_.md)** requestHeaderList请求的请求头列表。
...
参数项描述const char* scheme需要被拦截的scheme。[ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandler该scheme的拦截器ArkWeb_SchemeHandler。只有通过ServiceWorker触发的请求才会通过这个schemeHandler进行通知。
...
参数项描述const char* scheme需要被拦截的scheme。const char* webTagWeb组件的标签名称，用于标识某个唯一组件，由开发者来保证名称唯一性。[ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandler该scheme的拦截器ArkWeb_SchemeHandler。只有从指定web触发的请求才会通过这个schemeHandler进行通知。
...
参数项描述[ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)** schemeHandler返回创建的ArkWeb_SchemeHandler。在不需要时使用OH_ArkWeb_DestroyschemeHandler销毁它。
...
参数项描述[ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandler待销毁的ArkWeb_SchemeHandler。
...
参数项描述[ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandlerArkWeb_SchemeHandler。void* userData要设置的用户数据。
...
参数项描述const [ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandlerArkWeb_SchemeHandler。
...
参数项描述[ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandler该scheme的SchemeHandler。[ArkWeb_OnRequestStart](#ZH-CN_TOPIC_0000002529285215__arkweb_onrequeststart) onRequestStartOnRequestStart回调函数。
...
参数项描述[ArkWeb_SchemeHandler](ArkWeb_SchemeHandler_.md)* schemeHandler该scheme的SchemeHandler。[ArkWeb_OnRequestStop](#ZH-CN_TOPIC_0000002529285215__arkweb_onrequeststop) onRequestStopOnRequestStop回调函数。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)** response返回创建的ArkWeb_Response。在不需要时使用OH_ArkWeb_DestroyResponse进行销毁。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* response待销毁的ArkWeb_Response。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。const char* url解析后的URL。
...
参数项描述const [ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。char** url解析后的URL。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。[ArkWeb_NetError](arkweb_net_error_list.h.md#ZH-CN_TOPIC_0000002497445244__arkweb_neterror) errorCode失败请求的错误码。
...
参数项描述const [ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。int status请求的HTTP状态码。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。const char* statusText请求的状态文本。
...
参数项描述const [ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。char** statusText返回ArkWeb_Response的状态文本。此函数将为statusText字符串分配内存，调用方必须通过OH_ArkWeb_ReleaseString释放该字符串。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。const char* mimeType请求的媒体类型。
...
参数项描述const [ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。char** mimeType返回ArkWeb_Response的媒体类型。此函数将为mimeType字符串分配内存，调用方必须通过OH_ArkWeb_ReleaseString释放该字符串。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。const char* charset请求的字符集。
...
参数项描述const [ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。char** charset返回ArkWeb_Response的字符集。此函数将为charset字符串分配内存，调用方必须通过OH_ArkWeb_ReleaseString释放字符串。
...
参数项描述[ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。const char* nameheader的名称。const char* valueheader的值。bool overwrite如果为true，将覆盖现有的header，否则不覆盖。
...
参数项描述const [ArkWeb_Response](ArkWeb_Response_.md)* responseArkWeb_Response。const char* nameheader的名称。char** value返回header的值。此函数将为value字符串分配内存，调用方必须通过OH_ArkWeb_ReleaseString释放该字符串。
...
参数项描述const [ArkWeb_ResourceHandler](ArkWeb_ResourceHandler_.md)* resourceHandlerArkWeb_ResourceHandler。
...
参数项描述const [ArkWeb_ResourceHandler](ArkWeb_ResourceHandler_.md)* resourceHandler该请求的ArkWeb_ResourceHandler。const [ArkWeb_Response](ArkWeb_Response_.md)* response该拦截请求的ArkWeb_Response。
...
参数项描述const [ArkWeb_ResourceHandler](ArkWeb_ResourceHandler_.md)* resourceHandler该请求的ArkWeb_ResourceHandler。const uint8_t* buffer要发送的buffer数据。int64_t bufLenbuffer的大小。
...
参数项描述const [ArkWeb_ResourceHandler](ArkWeb_ResourceHandler_.md)* resourceHandler该请求的ArkWeb_ResourceHandler。
...
参数项描述const [ArkWeb_ResourceHandler](ArkWeb_ResourceHandler_.md)* resourceHandler用于被拦截的URL请求。可以通过ArkWeb_ResourceHandler发送自定义请求头以及自定义请求体。[ArkWeb_NetError](arkweb_net_error_list.h.md#ZH-CN_TOPIC_0000002497445244__arkweb_neterror) errorCode该请求的错误码。请参考[arkweb_net_error_list.h](arkweb_net_error_list.h.md)。
