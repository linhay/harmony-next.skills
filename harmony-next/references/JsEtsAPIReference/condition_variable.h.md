...
参数项描述[ffrt_cond_t](ffrt_cond_t.md)* cond条件变量指针。[const ffrt_condattr_t](ffrt_condattr_t.md)* attr条件变量属性指针。
...
参数项描述[ffrt_cond_t](ffrt_cond_t.md)* cond条件变量指针。
...
参数项描述[ffrt_cond_t](ffrt_cond_t.md)* cond条件变量指针。[ffrt_mutex_t](ffrt_mutex_t.md)* mutexmutex指针。
...
参数项描述[ffrt_cond_t](ffrt_cond_t.md)* cond条件变量指针。[ffrt_mutex_t](ffrt_mutex_t.md)* mutexmutex指针。const struct timespec* time_point最大等待到的时间点，超过这个时间点等待返回。
