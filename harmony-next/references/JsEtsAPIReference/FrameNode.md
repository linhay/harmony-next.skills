...
名称类型只读可选说明maxSize[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)否否最大尺寸。minSize[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)否否最小尺寸。percentReference[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)否否子节点计算百分比时的尺寸基准。
...
名称值说明NOT_EXPAND0表示不展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](LazyForEach.md)子节点，获取在主节点树上的子节点时，不展开当前FrameNode的子节点。子节点序列号按在主节点树上的子节点计算。EXPAND1表示展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](LazyForEach.md)子节点，获取所有子节点时，展开当前FrameNode的子节点。子节点序列号按所有子节点计算。LAZY_EXPAND2表示按需展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](LazyForEach.md)子节点，获取在主树上的子节点时，不展开当前FrameNode的子节点；获取不在主树上的子节点时，展开当前FrameNode的子节点。子节点序列号按所有子节点计算。
...
参数名类型必填说明uiContext[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。
...
当前仅支持根节点为以下类型组件的[BuilderNode](BuilderNode.md#ZH-CN_TOPIC_0000002497604794__buildernode-1)进行移动操作：[Stack](Stack.md)、[XComponent](XComponent.md)、[EmbeddedComponent](EmbeddedComponent.md)。对于其他类型的组件，移动操作不会生效。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点相对于窗口的位置偏移，单位为VP。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点相对于父组件的位置偏移，单位为VP。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点相对于屏幕的位置偏移，单位为VP。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点相对于全局屏幕的位置偏移，单位为VP。
...
获取FrameNode相对于父组件带有绘制属性的位置偏移，单位为VP，绘制属性比如[transform](图形变换.md#ZH-CN_TOPIC_0000002497604834__transform), [translate](图形变换.md#ZH-CN_TOPIC_0000002497604834__translate)等，返回的坐标是组件布局时左上角变换后的坐标。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点相对于父组件的位置偏移，单位为VP。 当设置了其他（比如：transform, translate等）绘制属性，由于浮点数精度的影响，返回值会有微小偏差。
...
获取FrameNode相对于窗口带有绘制属性的位置偏移，单位为VP，绘制属性比如[transform](图形变换.md#ZH-CN_TOPIC_0000002497604834__transform), [translate](图形变换.md#ZH-CN_TOPIC_0000002497604834__translate)等，返回的坐标是组件布局时左上角变换后的坐标。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点相对于窗口的位置偏移，单位为VP。 当设置了其他（比如：transform, translate等）绘制属性，由于浮点数精度的影响，返回值会有微小偏差。
...
获取FrameNode相对于屏幕带有绘制属性的位置偏移，单位为VP，绘制属性比如[transform](图形变换.md#ZH-CN_TOPIC_0000002497604834__transform), [translate](图形变换.md#ZH-CN_TOPIC_0000002497604834__translate)等，返回的坐标是组件布局时左上角变换后的坐标。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点相对于屏幕的位置偏移，单位为VP。 当设置了其他（比如：transform, translate等）绘制属性，由于浮点数精度的影响，返回值会有微小偏差。
...
类型说明[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)节点测量后的大小，单位为PX。
...
类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)节点布局后相对于父组件的位置偏移，单位为PX。
...
类型说明[Edges](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)<[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)>用户设置的边框宽度。
...
类型说明[Edges](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)<[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)>用户设置的内边距。
...
类型说明[Edges](Graphics.md#ZH-CN_TOPIC_0000002529444761__edgest12)<[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)>用户设置的外边距。
...
类型说明[SizeT](Graphics.md#ZH-CN_TOPIC_0000002529444761__sizett12)<[LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12)>用户设置的宽高。
...
类型说明string用户设置的节点ID（通用属性设置的[ID](组件标识.md)）。
...
类型说明[UICommonEvent](设置事件回调.md#ZH-CN_TOPIC_0000002529444941__uicommonevent)UICommonEvent对象，用于设置基础事件。
...
类型说明[UIGestureEvent](设置组件绑定的手势.md#ZH-CN_TOPIC_0000002529444823__uigestureevent)UIGestureEvent对象，用于设置组件绑定的手势。
...
该接口的[DrawContext](Graphics.md#ZH-CN_TOPIC_0000002529444761__drawcontext)中的Canvas是用于记录指令的临时Canvas，并非节点的真实Canvas。使用请参见[调整自定义绘制Canvas的变换矩阵](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-framenode#调整自定义绘制canvas的变换矩阵)。
...
参数名类型必填说明context[DrawContext](Graphics.md#ZH-CN_TOPIC_0000002529444761__drawcontext)是图形绘制上下文。自绘制区域无法超出组件自身大小。
...
参数名类型必填说明position[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)是组件进行布局时使用的位置信息。
...
参数名类型必填说明size[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)是FrameNode的测量后的尺寸。
...
参数名类型必填说明position[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)是FrameNode的布局后的位置。
...
参数名类型必填说明eventType[EventQueryType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__eventquerytype19)是要查询的交互事件类型。
...
参数名类型必填说明property[AnimationPropertyType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__animationpropertytype20)是动画属性枚举。startValueOptional<number[]>是
...
param[AnimateParam](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__animateparam对象说明)是动画参数。包含时长、动画曲线、结束回调等参数。
...
参数名类型必填说明properties[AnimationPropertyType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__animationpropertytype20)[]是待取消的动画属性枚举数组。可以一次取消一个节点上的多个属性的动画。
...
参数名类型必填说明property[AnimationPropertyType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__animationpropertytype20)是动画属性枚举。
...
参数名类型必填说明position[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)是当前节点坐标系中的相对坐标。targetNode[FrameNode](#ZH-CN_TOPIC_0000002529284787__framenode-1)是本次坐标转换的目标节点，转换得到的点坐标就是该节点坐标系中的相对坐标。

**返回值：**

类型说明[Position](Graphics.md#ZH-CN_TOPIC_0000002529444761__position)目标节点局部坐标系中的转换坐标。
...
类型说明TypedFrameNode<[TextInterface](Text.md#ZH-CN_TOPIC_0000002497444914__接口), [TextAttribute](Text.md#ZH-CN_TOPIC_0000002497444914__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Text'是创建Text类型的FrameNode节点。
...
将文本控制器[TextController](Text.md#ZH-CN_TOPIC_0000002497444914__textcontroller11)绑定到[Text](#ZH-CN_TOPIC_0000002529284787__text12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
参数名类型必填说明node[FrameNode](FrameNode.md)是绑定文本控制器的目标节点。controller[TextController](Text.md#ZH-CN_TOPIC_0000002497444914__textcontroller11)是文本控制器。nodeType'Text'是绑定输入框控制器的目标节点的节点类型为Text。
...
类型说明TypedFrameNode<[ColumnInterface](Column.md#ZH-CN_TOPIC_0000002529444831__接口), [ColumnAttribute](Column.md#ZH-CN_TOPIC_0000002529444831__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Column'是创建Column类型的FrameNode节点。
...
类型说明TypedFrameNode<[RowInterface](Row.md#ZH-CN_TOPIC_0000002497604866__接口), [RowAttribute](Row.md#ZH-CN_TOPIC_0000002497604866__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Row'是创建Row类型的FrameNode节点。
...
类型说明TypedFrameNode<[StackInterface](Stack.md#ZH-CN_TOPIC_0000002497444888__接口), [StackAttribute](Stack.md#ZH-CN_TOPIC_0000002497444888__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Stack'是创建Stack类型的FrameNode节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'GridRow'是创建GridRow类型的FrameNode节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'GridCol'是创建GridCol类型的FrameNode节点。
...
类型说明TypedFrameNode<[FlexInterface](Flex.md#ZH-CN_TOPIC_0000002529284857__接口), [FlexAttribute](Flex.md#ZH-CN_TOPIC_0000002529284857__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Flex'是创建Flex类型的FrameNode节点。
...
类型说明TypedFrameNode<[SwiperInterface](Swiper.md#ZH-CN_TOPIC_0000002529284867__接口), [SwiperAttribute](Swiper.md#ZH-CN_TOPIC_0000002529284867__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Swiper'是创建Swiper类型的FrameNode节点。
...
将控制器[SwiperController](Swiper.md#ZH-CN_TOPIC_0000002529284867__swipercontroller)绑定到[Swiper](#ZH-CN_TOPIC_0000002529284787__swiper12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
参数名类型必填说明node[FrameNode](FrameNode.md)是绑定控制器的目标节点。controller[SwiperController](Swiper.md#ZH-CN_TOPIC_0000002529284867__swipercontroller)是Swiper容器组件的控制器。nodeType'Swiper'是绑定控制器的目标节点的节点类型为Swiper。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Progress'是创建Progress类型的FrameNode节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Scroll'是创建Scroll类型的FrameNode节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'RelativeContainer'是创建RelativeContainer类型的FrameNode节点。
...
类型说明TypedFrameNode<[DividerInterface](Divider.md#ZH-CN_TOPIC_0000002497604912__接口), [DividerAttribute](Divider.md#ZH-CN_TOPIC_0000002497604912__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Divider'是创建Divider类型的FrameNode节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'LoadingProgress'是创建LoadingProgress类型的FrameNode节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Search'是创建Search类型的FrameNode节点。
...
类型说明TypedFrameNode<[BlankInterface](Blank.md#ZH-CN_TOPIC_0000002529444877__接口), [BlankAttribute](Blank.md#ZH-CN_TOPIC_0000002529444877__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Blank'是创建Blank类型的FrameNode节点。
...
类型说明TypedFrameNode<[ImageInterface](Image.md#ZH-CN_TOPIC_0000002497444922__接口), [ImageAttribute](Image.md#ZH-CN_TOPIC_0000002497444922__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Image'是创建Image类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'List'是创建List类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'ListItem'是创建ListItem类型的节点。
...
类型说明TypedFrameNode<[TextInputInterface](TextInput.md#ZH-CN_TOPIC_0000002529444859__接口), [TextInputAttribute](TextInput.md#ZH-CN_TOPIC_0000002529444859__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'TextInput'是创建TextInput类型的节点。
...
将输入框控制器[TextInputController](TextInput.md#ZH-CN_TOPIC_0000002529444859__textinputcontroller8)绑定到[TextInput](#ZH-CN_TOPIC_0000002529284787__textinput12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
参数名类型必填说明node[FrameNode](FrameNode.md)是绑定输入框控制器的目标节点。controller[TextInputController](TextInput.md#ZH-CN_TOPIC_0000002529444859__textinputcontroller8)是输入框控制器。nodeType'TextInput'是绑定输入框控制器的目标节点的节点类型为TextInput。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Button'是创建Button类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'ListItemGroup'是创建ListItemGroup类型的节点。
...
类型说明TypedFrameNode<[WaterFlowInterface](WaterFlow.md#ZH-CN_TOPIC_0000002497604876__接口), [WaterFlowAttribute](WaterFlow.md#ZH-CN_TOPIC_0000002497604876__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'WaterFlow'是创建WaterFlow类型的节点。
...
类型说明[UIWaterFlowEvent](WaterFlow.md#ZH-CN_TOPIC_0000002497604876__uiwaterflowevent19) | undefinedWaterFlow节点类型的滚动事件，若获取失败，则返回undefined。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'FlowItem'是创建FlowItem类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'XComponent'是创建XComponent类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'XComponent'是创建XComponent类型的节点。options[XComponentOptions](XComponent.md#ZH-CN_TOPIC_0000002529444889__xcomponentoptions12)是定义XComponent的具体配置参数。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'XComponent'是创建XComponent类型的节点。parameters[NativeXComponentParameters](XComponent.md#ZH-CN_TOPIC_0000002529444889__nativexcomponentparameters19)是定义XComponent的具体配置参数。
...
类型说明TypedFrameNode<[QRCodeInterface](QRCode.md#ZH-CN_TOPIC_0000002529284901__接口), [QRCodeAttribute](QRCode.md#ZH-CN_TOPIC_0000002529284901__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'QRCode'是创建QRCode类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Badge'是创建Badge类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Grid'是创建Grid类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'GridItem'是创建GridItem类型的节点。
...
类型说明TypedFrameNode<[TextClockInterface](TextClock.md#ZH-CN_TOPIC_0000002529444875__接口), [TextClockAttribute](TextClock.md#ZH-CN_TOPIC_0000002529444875__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'TextClock'是创建TextClock类型的节点。
...
类型说明TypedFrameNode<[TextTimerInterface](TextTimer.md#ZH-CN_TOPIC_0000002497604910__接口), [TextTimerAttribute](TextTimer.md#ZH-CN_TOPIC_0000002497604910__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'TextTimer'是创建TextTimer类型的节点。
...
类型说明TypedFrameNode<[MarqueeInterface](Marquee.md#ZH-CN_TOPIC_0000002529444873__接口), [MarqueeAttribute](Marquee.md#ZH-CN_TOPIC_0000002529444873__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Marquee'是创建Marquee类型的节点。
...
类型说明TypedFrameNode<[TextAreaInterface](TextArea.md#ZH-CN_TOPIC_0000002529284885__接口), [TextAreaAttribute](TextArea.md#ZH-CN_TOPIC_0000002529284885__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'TextArea'是创建TextArea类型的节点。
...
将输入框控制器[TextAreaController](TextArea.md#ZH-CN_TOPIC_0000002529284885__textareacontroller8)绑定到[TextArea](#ZH-CN_TOPIC_0000002529284787__textarea14)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
参数名类型必填说明node[FrameNode](FrameNode.md)是绑定输入框控制器的目标节点。controller[TextAreaController](TextArea.md#ZH-CN_TOPIC_0000002529284885__textareacontroller8)是输入框控制器。nodeType'TextArea'是绑定输入框控制器的目标节点的节点类型为TextArea。
...
类型说明TypedFrameNode<[SymbolGlyphInterface](SymbolGlyph.md#ZH-CN_TOPIC_0000002529284889__接口), [SymbolGlyphAttribute](SymbolGlyph.md#ZH-CN_TOPIC_0000002529284889__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'SymbolGlyph'是创建SymbolGlyph类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Checkbox'是创建Checkbox类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'CheckboxGroup'是创建CheckboxGroup类型的节点。
...
类型说明TypedFrameNode<[RatingInterface](Rating.md#ZH-CN_TOPIC_0000002529284881__接口), [RatingAttribute](Rating.md#ZH-CN_TOPIC_0000002529284881__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Rating'是创建Rating类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Radio'是创建Radio类型的节点。
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Slider'是创建Slider类型的节点。
...
类型说明TypedFrameNode<[SelectInterface](Select.md#ZH-CN_TOPIC_0000002529444855__接口), [SelectAttribute](Select.md#ZH-CN_TOPIC_0000002529444855__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Select'是创建Select类型的节点。
...
type Toggle = TypedFrameNode<[ToggleInterface](Toggle.md#ZH-CN_TOPIC_0000002497444906__接口), [ToggleAttribute](Toggle.md#ZH-CN_TOPIC_0000002497444906__属性)>
...
类型说明TypedFrameNode<[ToggleInterface](Toggle.md#ZH-CN_TOPIC_0000002497444906__接口), [ToggleAttribute](Toggle.md#ZH-CN_TOPIC_0000002497444906__属性)>
...
参数名类型必填说明context[UIContext](Class (UIContext).md)是创建对应节点时所需的UI上下文。nodeType'Toggle'是创建Toggle类型的节点。options[ToggleOptions](Toggle.md#ZH-CN_TOPIC_0000002497444906__toggleoptions18对象说明)否创建Toggle节点的接口参数，仅可通过ToggleOptions中的type属性设置开关样式。
...
重新加载全部数据操作。实际调用了LazyForEach中的[OnDataReloaded](LazyForEach.md#ZH-CN_TOPIC_0000002529444937__ondatareloaded)接口通知组件重新加载所有数据。
