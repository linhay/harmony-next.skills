...
构造一个新的采样选项对象，[FilterMode](Enums.md#ZH-CN_TOPIC_0000002529285977__filtermode12)的默认值为FILTER_MODE_NEAREST。
...
参数名类型必填说明filterMode[FilterMode](Enums.md#ZH-CN_TOPIC_0000002529285977__filtermode12)是过滤模式。
