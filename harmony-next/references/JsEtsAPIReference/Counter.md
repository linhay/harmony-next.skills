...
参数名类型必填说明event[VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是Counter数值增加的回调函数。
...
参数名类型必填说明event[VoidCallback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__voidcallback12)是Counter数值减少的回调函数。
