...
BuilderNode下的自定义组件支持使用[@Prop](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-prop)装饰器。不支持使用[@Link](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-link)装饰器来跨越BuilderNode同步外界的数据和状态。

-

如果BuilderNode的子节点是自定义组件，不支持该自定义组件使用[@Reusable](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-reusable)装饰器，详细内容参见[BuilderNode在子自定义组件中使用@Reusable装饰器](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-buildernode#buildernode在子自定义组件中使用reusable装饰器)。
...
从API version 20开始，通过配置[BuildOptions](#ZH-CN_TOPIC_0000002497604794__buildoptions12)，内部自定义组件的[@Consume](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-provide-and-consume)支持接收所在页面的[@Provide](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-provide-and-consume)数据。
...
名称值说明RENDER_TYPE_DISPLAY0表示该节点将被显示到屏幕上。RENDER_TYPE_TEXTURE1表示该节点将被导出为纹理。

-

RENDER_TYPE_TEXTURE类型目前仅在[BuilderNode](#ZH-CN_TOPIC_0000002497604794__buildernode-1)持有组件树的根节点为自定义组件时以及[XComponentNode](zh-cn_topic_0000002529444775.html)中设置生效。

-

在[BuilderNode](#ZH-CN_TOPIC_0000002497604794__buildernode-1)的情况下，目前在作为根节点的自定义组件中支持纹理导出的有以下组件：[Badge](zh-cn_topic_0000002529284897.html)、[Blank](Blank.md)、[Button](Button.md)、[CanvasGradient](CanvasGradient.md)、[CanvasPattern](CanvasPattern.md)、[CanvasRenderingContext2D](CanvasRenderingContext2D.md)、[Canvas](Canvas.md)、[CheckboxGroup](CheckboxGroup.md)、[Checkbox](Checkbox.md)、[Circle](Circle.md)、[ColumnSplit](ColumnSplit.md)、[Column](Column.md)、[ContainerSpan](ContainerSpan.md)、[Counter](Counter.md)、[DataPanel](DataPanel.md)、[Divider](Divider.md)、[Ellipse](Ellipse.md)、[Flex](Flex.md)、[Gauge](Gauge.md)、[Hyperlink](Hyperlink.md)、[ImageBitmap](ImageBitmap.md)、[ImageData](ImageData.md)、[Image](Image.md)、[Line](Line.md)、[LoadingProgress](LoadingProgress.md)、[Marquee](Marquee.md)、[Matrix2D](Matrix2D.md)、[OffscreenCanvasRenderingContext2D](OffscreenCanvasRenderingContext2D.md)、[OffscreenCanvas](OffscreenCanvas.md)、[Path2D](Path2D.md)、[Path](Path.md)、[PatternLock](PatternLock.md)、[Polygon](Polygon.md)、[Polyline](Polyline.md)、[Progress](Progress.md)、[QRCode](QRCode.md)、[Radio](Radio.md)、[Rating](Rating.md)、[Rect](Rect.md)、[RelativeContainer](RelativeContainer.md)、[RowSplit](RowSplit.md)、[Row](Row.md)、[Shape](Shape.md)、[Slider](Slider.md)、[Span](Span.md)、[Stack](Stack.md)、[TextArea](TextArea.md)、[TextClock](TextClock.md)、[TextInput](TextInput.md)、[TextTimer](TextTimer.md)、[Text](Text.md)、[Toggle](Toggle.md)、[Video](Video.md)（不含全屏播放能力）、[Web](组件描述.md)、[XComponent](XComponent.md)。

-

从API version 12开始，新增以下组件支持纹理导出：[DatePicker](DatePicker.md)、[ForEach](ForEach.md)、[Grid](Grid.md)、[IfElse](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-ifelse)、[LazyForEach](zh-cn_topic_0000002529444937.md)、[List](List.md)、[Scroll](Scroll.md)、[Swiper](Swiper.md)、[TimePicker](TimePicker.md)、[@Component](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-create-custom-components#component)修饰的自定义组件、[NodeContainer](zh-cn_topic_0000002497604946.html)以及[NodeContainer](NodeContainer.md)下挂载的[FrameNode](FrameNode.md)和[RenderNode](RenderNode.md)。
...
名称类型只读可选说明selfIdealSize[Size](Graphics.md#ZH-CN_TOPIC_0000002529444761__size)否是

节点的理想大小。

默认值：{ width: 0, height: 0 }

type[NodeRenderType](#ZH-CN_TOPIC_0000002497604794__noderendertype)否是
...
纹理接收方的surfaceId。纹理接收方一般为[OH_NativeImage](OH_NativeImage.md)。
...
名称类型只读可选说明nestingBuilderSupportedboolean否是

是否支持Builder嵌套Builder进行使用。其中，true表示支持，false表示不支持。默认值：false

**元服务API：** 从API version 12开始，该接口支持在元服务中使用。

localStorage20+[LocalStorage](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-localstorage)否是

给当前BuilderNode设置LocalStorage，挂载在此BuilderNode下的自定义组件共享该LocalStorage。如果自定义组件构造函数同时也传入LocalStorage，优先使用构造函数中传入的LocalStorage。默认值：null

**元服务API：** 从API version 20开始，该接口支持在元服务中使用。

enableProvideConsumeCrossing20+boolean否是

定义BuilderNode内状态管理V1自定义组件的@Consume是否与BuilderNode外部的@Provide状态互通，BuilderNode内状态管理V2自定义组件的@Consumer是否与BuilderNode外部的@Provider状态互通。

从API version 20开始支持状态管理V1自定义组件的状态互通，从API version 22开始支持状态管理V2自定义组件的状态互通。

true表示支持，false表示不支持。默认值：false
...
[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)的参数，定义要发送的输入事件类型。

**元服务API：** 从API version 20开始，该接口支持在元服务中使用。

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

类型说明[TouchEvent](触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)触摸事件。[MouseEvent](鼠标事件.md#ZH-CN_TOPIC_0000002497604812__mouseevent对象说明)鼠标事件。[AxisEvent](轴事件.md#ZH-CN_TOPIC_0000002497444834__axisevent)轴事件。

#### BuilderNode

class BuilderNode<Args extends Object[]>

BuilderNode支持通过无状态的UI方法[@Builder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder)生成组件树，并持有组件树的根节点。不支持定义为状态变量。BuilderNode中持有的FrameNode仅用于将该BuilderNode作为子节点挂载到其他FrameNode上。对BuilderNode持有的FrameNode进行属性设置与子节点操作可能会产生未定义行为，因此不建议通过BuilderNode的[getFrameNode](#ZH-CN_TOPIC_0000002497604794__getframenode)方法和[FrameNode](zh-cn_topic_0000002529284787.html)的[getRenderNode](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getrendernode)方法获取RenderNode，并通过[RenderNode](RenderNode.md)的接口对其进行属性设置与子节点操作。
...
参数名类型必填说明uiContext[UIContext](Class (UIContext).md)是UI上下文，获取方式可参考[UIContext获取方法](@ohos.arkui.node.md#ZH-CN_TOPIC_0000002529284763__uicontext获取方法)。options[RenderOptions](#ZH-CN_TOPIC_0000002497604794__renderoptions)否
...
build的参数是值传递，需要使用[update](#ZH-CN_TOPIC_0000002497604794__update)接口进行更新。

-

需要操作BuilderNode中的对象时，需要保证其引用不被回收。当BuilderNode对象被虚拟机回收之后，它的[FrameNode](FrameNode.md)、[RenderNode](RenderNode.md)对象也会与后端节点解引用。即从BuilderNode中获取的FrameNode对象不对应任何一个节点。

-

BuilderNode对象会持有实体节点的引用。如果不需要使用BuilderNode前端对象管理后端节点，可以调用[dispose](#ZH-CN_TOPIC_0000002497604794__dispose12)接口，实现前后端对象的解绑。
...
参数名类型必填说明builder[WrappedBuilder<Args>](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-wrapbuilder)是创建对应节点树的时候所需的无状态UI方法[@Builder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder)。argObject否
...
参数名类型必填说明builder[WrappedBuilder<Args>](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-wrapbuilder)是创建对应节点树的时候所需的无状态UI方法[@Builder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder)。argObject是builder的入参。当前仅支持一个入参，且入参对象类型与@Builder定义的入参类型保持一致。options[BuildOptions](#ZH-CN_TOPIC_0000002497604794__buildoptions12)是build的配置参数，判断是否支持@Builder中嵌套@Builder的行为。
...
获取BuilderNode中的[FrameNode](FrameNode.md)。在BuilderNode执行build操作之后，才会生成FrameNode。
...
类型说明[FrameNode](FrameNode.md) | null一个FrameNode对象。若该BuilderNode不包含FrameNode，则返回空对象null。

**示例1：**

BuilderNode作为[NodeContainer](NodeContainer.md)的根节点返回。
...
BuilderNode的[FrameNode](FrameNode.md)挂到其它FrameNode下。
...
BuilderNode的[RenderNode](RenderNode.md)挂到其它RenderNode下。由于RenderNode不传递布局约束，不推荐通过该方式挂载节点。
...
根据提供的参数更新BuilderNode，该参数与[build](#ZH-CN_TOPIC_0000002497604794__build)方法调用时传入的参数类型相同。对自定义组件进行update的时候需要在自定义组件中将使用的变量定义为[@Prop](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-prop)类型。
...
参数名类型必填说明argObject是用于更新BuilderNode的参数，和[build](#ZH-CN_TOPIC_0000002497604794__build)调用时传入的参数类型一致。
...
OffsetA为buildNode相对于父组件的偏移量，可以通过FrameNode中的[getPositionToParent](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getpositiontoparent12)获取。OffsetB为point点相对于buildNode的偏移量，可以通过[TouchEvent](触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明) 获取。OffsetC为OffsetA与OffsetB的和，是传给postTouchEvent的最终结果。
...
在[webview](模块描述.md)中，内部已经处理过坐标系变换，可以将TouchEvent事件直接下发。
...
参数名类型必填说明event[TouchEvent](触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)是触摸事件。
...
触发BuilderNode中的自定义组件的复用。组件复用请参见[@Reusable装饰器：组件复用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-reusable)。关于BuilderNode的解绑场景请参见[节点解绑](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-buildernode#解除实体节点引用关系)。
...
参数名类型必填说明paramObject否用于复用BuilderNode的参数。该参数将直接用于BuilderNode中所有顶层自定义组件的复用，应该包含每个自定义组件的构造函数参数所需内容，否则，会导致未定义行为。调用此方法将同步触发内部自定义组件的[aboutToReuse](自定义组件的生命周期.md#ZH-CN_TOPIC_0000002529444913__abouttoreuse10)生命周期回调，并将该参数作为回调的入参。默认值为undefined，此时BuilderNode中的自定义组件将直接使用构造时的数据源。

#### recycle12+

recycle(): void

- 触发BuilderNode中自定义组件的回收。自定义组件的回收是组件复用机制中的环节，具体信息请参见[@Reusable装饰器：组件复用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-reusable)。
...
传递[系统环境变化](@ohos.app.ability.Configuration (环境变量).md)事件，触发节点的全量更新。
...
该示例演示了BuilderNode释放节点前后分别使用[isDisposed](#ZH-CN_TOPIC_0000002497604794__isdisposed20)接口验证节点的状态，释放节点前节点调用isDisposed接口返回true，释放节点后节点调用isDisposed接口返回false。
...
鼠标左键点击事件将转换为触摸事件，转发时应注意不在外层同时绑定触摸事件与鼠标事件，否则可能导致坐标偏移。这是由于在事件转换过程中，SourceType不会发生变化，规格可查看[onTouch](触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)。

-

注入事件为[轴事件](轴事件.md#ZH-CN_TOPIC_0000002497444834__axisevent)时，由于轴事件中缺少旋转轴信息，因此注入的事件无法触发[rotate旋转手势](RotationGesture.md)。
...
如果是开发者构造的事件，必填字段必须赋值，比如触摸事件的touches字段，轴事件的scrollStep字段。要保证事件的完整，比如触摸事件的[TouchType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__touchtype)中DOWN和UP字段都要有，防止出现未定义行为。

-

[webview](模块描述.md)已经处理过坐标系变换，可以将事件直接下发。
...
参数名类型必填说明event[InputEventType](#ZH-CN_TOPIC_0000002497604794__inputeventtype20)是用于透传的输入事件。

**返回值：**

类型说明boolean事件是否被成功派发。如果事件派发成功，则返回true；否则，返回false。

**示例：**

请参考[示例1（BuilderNode中鼠标事件）](#ZH-CN_TOPIC_0000002497604794__示例1buildernode中鼠标事件)、[示例2（BuilderNode中触摸事件）](#ZH-CN_TOPIC_0000002497604794__示例2buildernode中触摸事件)、[示例3（BuilderNode中轴事件）](#ZH-CN_TOPIC_0000002497604794__示例3buildernode中轴事件)。
...
参数名类型必填说明enabledboolean是BuilderNode对象是否设置为继承父组件中自定义组件的冻结策略。true为继承父组件中自定义组件的冻结策略，false为不继承父组件中自定义组件的冻结策略。
...
ReactiveBuilderNode支持通过无状态的UI方法[@Builder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder)生成组件树，并持有该组件树的根节点，不支持定义为状态变量。ReactiveBuilderNode中持有的[FrameNode](zh-cn_topic_0000002529284787.md)仅用于将此ReactiveBuilderNode作为子节点挂载到其他FrameNode上。对ReactiveBuilderNode持有的FrameNode进行属性设置与子节点操作可能会导致未定义行为，因此不建议通过ReactiveBuilderNode的[getFrameNode](#ZH-CN_TOPIC_0000002497604794__getframenode)方法和[FrameNode](zh-cn_topic_0000002529284787.html)节点的[getRenderNode](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getrendernode)方法获取RenderNode，并通过[RenderNode](RenderNode.md)的接口对其进行属性设置与子节点操作。
...
用于构造ReactiveBuilderNode类。当将ReactiveBuilderNode生成的内容嵌入到其它[RenderNode](RenderNode.md)中显示时，需要显式指定[RenderOptions](BuilderNode.md#ZH-CN_TOPIC_0000002497604794__renderoptions)中的[selfIdealSize](BuilderNode.md#ZH-CN_TOPIC_0000002497604794__renderoptions)，否则ReactiveBuilderNode内的节点默认父组件布局约束为[0, 0]。调用此接口，若不设置selfIdealSize则认为ReactiveBuilderNode中子树的根节点大小为[0, 0]。
...
参数名类型必填说明uiContext[UIContext](Class (UIContext).md)是UI上下文，获取方式可参考[UIContext获取方法](@ohos.arkui.node.md#ZH-CN_TOPIC_0000002529284763__uicontext获取方法)。uiContext需要为一个有效的值，即UI上下文正确，如果传入非法值或者未设置，会导致创建失败。options[RenderOptions](BuilderNode.md#ZH-CN_TOPIC_0000002497604794__renderoptions)否
...
参数名类型必填说明builder[WrappedBuilder<Args>](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-wrapbuilder)是创建对应节点树时所需的无状态UI方法[@Builder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder)。config[BuildOptions](#ZH-CN_TOPIC_0000002497604794__buildoptions12)是作用是配置Builder的构建行为，BuildOptions中所有属性都是可选的，默认值为BuildOptions中对应的默认值。...argsArgs否builder的入参，用于构造WrappedBuilder对象封装的builder函数。支持多个入参。默认值为undefined。
...
获取ReactiveBuilderNode中的[FrameNode](FrameNode.md)。在ReactiveBuilderNode执行build操作之后，才会生成FrameNode。
...
类型说明[FrameNode](FrameNode.md) | nullFrameNode对象。若该ReactiveBuilderNode不包含FrameNode，则返回空对象null。
...
触发ReactiveBuilderNode中的自定义组件的复用。组件复用请参见[@Reusable装饰器：组件复用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-reusable)。关于ReactiveBuilderNode的解绑场景请参见[节点解绑](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-buildernode#解除实体节点引用关系)。

ReactiveBuilderNode通过reuse和[recycle](#ZH-CN_TOPIC_0000002497604794__recycle22)完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-buildernode#buildernode调用reuse和recycle接口实现节点复用能力)。
...
参数名类型必填说明paramObject否用于复用[ReactiveBuilderNode](#ZH-CN_TOPIC_0000002497604794__reactivebuildernode22)的参数。该参数将直接用于[ReactiveBuilderNode](#ZH-CN_TOPIC_0000002497604794__reactivebuildernode22)中所有顶层自定义组件的复用，应该包含每个自定义组件的构造函数参数所需内容，否则，会导致未定义行为。调用此方法将同步触发内部自定义组件的[aboutToReuse](zh-cn_topic_0000002529444913.html#ZH-CN_TOPIC_0000002529444913__abouttoreuse10)生命周期回调，并将该参数作为回调的入参。默认值为undefined，此时ReactiveBuilderNode中的自定义组件将直接使用构造时的数据源。

**示例：**

请参考[recycle](#ZH-CN_TOPIC_0000002497604794__recycle22)中的示例。

#### recycle22+

recycle(): void

触发ReactiveBuilderNode中自定义组件的回收。自定义组件的回收是组件复用机制中的环节，具体信息请参见[@Reusable装饰器：组件复用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-reusable)。

ReactiveBuilderNode通过[reuse](#ZH-CN_TOPIC_0000002497604794__reuse22)和recycle完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-user-defined-arktsnode-buildernode#buildernode调用reuse和recycle接口实现节点复用能力)。
...
传递[系统环境变化](@ohos.app.ability.Configuration (环境变量).md)事件，触发节点的全量更新。可用于通知对象更新，是否更新所使用的系统环境由应用当前的系统环境变化决定。
...
鼠标左键点击事件将转换为触摸事件，转发时应注意不在外层且绑定触摸事件与鼠标事件，否则可能导致坐标偏移。这是由于在事件转换过程中，SourceType不会发生变化，规格可查看[onTouch](触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)。

注入事件为[轴事件](轴事件.md#ZH-CN_TOPIC_0000002497444834__axisevent)时，由于轴事件中缺少旋转轴信息，因此注入的事件无法触发[rotate旋转手势](RotationGesture.md)。

转发的事件会在被分发到的目标组件所在的子树里做触摸测试（TouchTest），并触发对应手势，原始事件也会触发当前组件所在组件树中的手势。不保证两类手势的竞争结果。

如果是开发者构造的事件，必填字段必须赋值，比如触摸事件的touches字段、轴事件的scrollStep字段，同时要保证事件的完整，比如触摸事件的[TouchType](枚举说明.md#ZH-CN_TOPIC_0000002529284967__touchtype)中DOWN和UP字段都要有，防止出现未定义行为。
...
参数名类型必填说明event[InputEventType](BuilderNode.md#ZH-CN_TOPIC_0000002497604794__inputeventtype20)是待分发的输入事件。

**返回值：**

类型说明boolean事件是否被成功分发。如果事件分发成功，则返回true；否则，返回false。

**示例：**

请参考[示例13（ReactiveBuilderNode中鼠标事件）](#ZH-CN_TOPIC_0000002497604794__示例13reactivebuildernode中鼠标事件)、[示例14（ReactiveBuilderNode中触摸事件）](#ZH-CN_TOPIC_0000002497604794__示例14reactivebuildernode中触摸事件)、[示例15（ReactiveBuilderNode中轴事件）](#ZH-CN_TOPIC_0000002497604794__示例15reactivebuildernode中轴事件)。
...
参数名类型必填说明enabledboolean是ReactiveBuilderNode对象是否设置为继承父组件中自定义组件的冻结策略。true为继承父组件中自定义组件的冻结策略，false为不继承父组件中自定义组件的冻结策略。
...
参考[isDisposed](BuilderNode.md#ZH-CN_TOPIC_0000002497604794__isdisposed20)示例。

该示例演示了ReactiveBuilderNode释放节点前后分别使用[isDisposed](#ZH-CN_TOPIC_0000002497604794__isdisposed22)接口验证节点的状态，释放节点前节点调用isDisposed接口返回true，释放节点后节点调用isDisposed接口返回false。
...
该示例演示了在自定义组件中截获鼠标事件并进行坐标转换的完整流程。组件通过[onMouse](鼠标事件.md#ZH-CN_TOPIC_0000002497604812__onmouse)回调读取本地x/y，再结合FrameNode.[getPositionToParent](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getpositiontoparent12)()得到的偏移量，调用vp2px将相对坐标转换为像素坐标，更新[MouseEvent](鼠标事件.md#ZH-CN_TOPIC_0000002497604812__mouseevent对象说明)的windowX/windowY、displayX/displayY。最后通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)(event)将转换后的鼠标事件分发给子节点进行处理。
...
该示例演示了在自定义组件中截获触摸事件并对触点坐标进行转换的完整流程。在[onTouch](触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)回调中，遍历[TouchEvent](触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)的changedTouches和touches数组，对每个触点的x/y加上组件偏移量并调用vp2px转换为像素，更新各自的windowX/windowY、displayX/displayY。最后同样通过rootNode.postInputEvent(event)将转换后的触摸事件分发给子节点处理。
...
该示例演示了在自定义组件中截获滚轮或触控板轴事件并进行坐标转换的完整流程。在[onAxisEvent](轴事件.md#ZH-CN_TOPIC_0000002497444834__onaxisevent)回调中，先获取事件的相对x/y，再加上组件偏移量后调用vp2px转换为像素，更新AxisEvent的windowX/windowY、displayX/displayY，最后通过rootNode.postInputEvent(event)将转换后的轴事件分发给子节点进行处理。
...
该示例演示了如何在BuilderNode通过build方法传入外部[localStorage](应用级变量的状态管理.md#ZH-CN_TOPIC_0000002529284961__localstorage9)，此时挂载在BuilderNode的所有自定义组件共享该localStorage。
...
设置BuilderNode的[BuildOptions](#ZH-CN_TOPIC_0000002497604794__buildoptions12)中enableProvideConsumeCrossing为true，以实现BuilderNode内部自定义组件的@Consume与所在自定义组件的@Provide数据互通。
...
设置BuilderNode的[BuildOptions](#ZH-CN_TOPIC_0000002497604794__buildoptions12)中enableProvideConsumeCrossing为true，以实现BuilderNode内部自定义组件的@Consumer与所在自定义组件的@Provider数据互通。
...
该示例演示了在自定义组件中截获鼠标事件并进行坐标转换的完整流程。组件通过[onMouse](鼠标事件.md#ZH-CN_TOPIC_0000002497604812__onmouse)回调读取本地x/y坐标，再结合FrameNode.[getPositionToParent](FrameNode.md#ZH-CN_TOPIC_0000002529284787__getpositiontoparent12)()得到的偏移量，调用[vp2px](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__vp2px12)将相对坐标转换为像素坐标，更新[MouseEvent](鼠标事件.md#ZH-CN_TOPIC_0000002497604812__mouseevent对象说明)的windowX/windowY、displayX/displayY。最后通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)将转换后的鼠标事件分发给子节点进行处理。
...
该示例演示了在自定义组件中截获触摸事件并对触点坐标进行转换的完整流程。在[onTouch](触摸事件.md#ZH-CN_TOPIC_0000002529444777__ontouch)回调中，遍历[TouchEvent](触摸事件.md#ZH-CN_TOPIC_0000002529444777__touchevent对象说明)的changedTouches和touches数组，对每个触点的x/y坐标加上组件偏移量并调用[vp2px](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__vp2px12)转换为像素，更新各自的windowX/windowY、displayX/displayY。最后同样通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)将转换后的触摸事件分发给子节点处理。
...
该示例演示了在自定义组件中截获滚轮或触控板轴事件并进行坐标转换的完整流程。在[onAxisEvent](轴事件.md#ZH-CN_TOPIC_0000002497444834__onaxisevent)回调中，先获取事件的相对x/y坐标，再加上组件偏移量后调用[vp2px](Class (UIContext).md#ZH-CN_TOPIC_0000002529444749__vp2px12)转换为像素，更新AxisEvent的windowX/windowY、displayX/displayY，最后通过rootNode.[postInputEvent](#ZH-CN_TOPIC_0000002497604794__postinputevent20)将转换后的轴事件分发给子节点进行处理。
