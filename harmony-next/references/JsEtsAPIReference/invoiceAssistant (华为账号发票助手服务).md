...
[1010060001](ArkTS错误码.md#section165992015527)

用户取消发票助手服务。

SYSTEM_ERROR

[1010060002](ArkTS错误码.md#section730115513413)

系统内部错误。

APP_NOT_AUTHORIZED

[1010060003](ArkTS错误码.md#section717135217914)

应用指纹证书校验失败。

FREQUENT_CALLS

[1010060004](ArkTS错误码.md#section12371175713102)

接口访问过频。

NETWORK_ERROR

[1010060005](ArkTS错误码.md#section17507143210121)

网络连接错误。

ACCOUNT_NOT_LOGGED_IN

[1010060006](ArkTS错误码.md#section569215704317)

用户未登录华为账号。

INVOICE_TITLE_EXISTS

[1010060007](ArkTS错误码.md#section670931214512)

发票抬头信息已存在。

UNSUPPORTED

[1010060008](ArkTS错误码.md#section16845834174215)
