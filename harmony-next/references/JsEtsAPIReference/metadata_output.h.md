...
名称typedef关键字描述[MetadataOutput_Callbacks](MetadataOutput_Callbacks.md)MetadataOutput_Callbacks元数据输出的回调。[Camera_MetadataOutput](Camera_MetadataOutput.md)Camera_MetadataOutput
...
在[MetadataOutput_Callbacks](MetadataOutput_Callbacks.md)中被调用的元数据输出元数据对象可用回调。

**起始版本：** 11

**参数：**

参数项描述[Camera_MetadataOutput](Camera_MetadataOutput.md)* metadataOutput传递回调的元数据输出实例。[Camera_MetadataObject](Camera_MetadataObject.md)* metadataObject回调传递的元数据实例信息。uint32_t size元数据对象的大小。
...
在[MetadataOutput_Callbacks](MetadataOutput_Callbacks.md)中被调用的元数据输出错误回调。

**起始版本：** 11

**参数：**

参数项描述[Camera_MetadataOutput](Camera_MetadataOutput.md)* metadataOutput传递回调的元数据输出实例。[Camera_ErrorCode](camera.h.md#ZH-CN_TOPIC_0000002497605798__camera_errorcode) errorCode元数据输出的错误码。
...
参数项描述[Camera_MetadataOutput](Camera_MetadataOutput.md)* metadataOutput元数据输出实例。[MetadataOutput_Callbacks](MetadataOutput_Callbacks.md)* callback要注册的元数据输出回调。
...
参数项描述[Camera_MetadataOutput](Camera_MetadataOutput.md)* metadataOutput元数据输出实例。[MetadataOutput_Callbacks](MetadataOutput_Callbacks.md)* callback要注销的元数据输出回调。
...
参数项描述[Camera_MetadataOutput](Camera_MetadataOutput.md)* metadataOutput要启动的元数据输出实例。
...
参数项描述[Camera_MetadataOutput](Camera_MetadataOutput.md)* metadataOutput要停止的元数据输出实例。
...
参数项描述[Camera_MetadataOutput](Camera_MetadataOutput.md)* metadataOutput要释放的元数据输出实例。
