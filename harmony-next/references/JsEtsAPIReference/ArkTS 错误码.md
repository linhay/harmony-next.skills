...
使用[createCollaborationServiceMenuItems](CollaborationService (跨设备互通组件).md#section149271552154711)传入的自定义图片张数canReceiveNumber小于等于0。

**处理步骤**

使用[createCollaborationServiceMenuItems](CollaborationService (跨设备互通组件).md#section149271552154711)时，自定义图片张数canReceiveNumber请传入1到50的值。