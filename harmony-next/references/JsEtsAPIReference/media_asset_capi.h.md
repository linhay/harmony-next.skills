...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。const char** uri媒体资产的uri。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。[MediaLibrary_MediaType](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_mediatype)* mediaType媒体资源类型。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。[MediaLibrary_MediaSubType](media_asset_base_capi.h.md#ZH-CN_TOPIC_0000002497605962__medialibrary_mediasubtype)* mediaSubType媒体资源子类型。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。const char** displayName媒体资源的显示名称。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* size媒体资源的文件大小（以字节为单位）。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* dateAdded资产添加日期。该值是添加文件时间距1970年1月1日的秒数值。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* dateModified资产的修改日期。该值是修改文件时间距1970年1月1日的秒数值，修改文件名不会改变此值，当文件内容发生修改时才会更新。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* dateTaken资产的拍摄日期。该值是文件拍照时间距1970年1月1日的秒数值。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* dateAddedMs资产的添加时间（毫秒）。该值是添加文件时间距1970年1月1日的毫秒数值。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* dateModifiedMs资产的修改时间（毫秒）。该值是修改文件时间距1970年1月1日的毫秒数值，修改文件名不会改变此值，当文件内容发生修改时才会更新。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* duration媒体资源的持续时间（毫秒）。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* width媒体资源的图像宽度（像素）。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* height媒体资源的图像高度（像素）。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* orientation图像的旋转角度，单位为度。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。uint32_t* favorite资产的收藏状态。
...
参数项描述[OH_MediaAsset](OH_MediaAsset.md)* mediaAsset[OH_MediaAsset](OH_MediaAsset.md)实例。const char** title媒体资产的标题。
