...
builder[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是配置全屏模态页面内容。type[ModalTransition](半模态转场.md#ZH-CN_TOPIC_0000002497604850__modaltransition)否
...
builder[CustomBuilder](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__custombuilder8)是配置全屏模态页面内容。options[ContentCoverOptions](#ZH-CN_TOPIC_0000002529444815__contentcoveroptions)否配置全屏模态页面的可选属性。
...
继承自[BindOptions](半模态转场.md#ZH-CN_TOPIC_0000002497604850__bindoptions)。

全屏模态页面内容选项。

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

名称类型只读可选说明modalTransition[ModalTransition](半模态转场.md#ZH-CN_TOPIC_0000002497604850__modaltransition)否是
...
onWillDismiss12+Callback<[DismissContentCoverAction](#ZH-CN_TOPIC_0000002529444815__dismisscontentcoveraction12类型说明)>否是
...
名称类型只读可选说明dismiss[Callback](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__callback12)<void>否否全屏模态页面关闭回调函数。开发者需要退出页面时调用。reason[DismissReason](Popup控制.md#ZH-CN_TOPIC_0000002529284839__dismissreason12枚举说明)否否返回本次拦截全屏模态页面退出的事件原因。
