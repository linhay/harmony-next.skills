...
名称typedef关键字描述[OH_PictureNative](OH_PictureNative.md)OH_PictureNativePicture结构体类型，用于执行picture相关操作。[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md)OH_AuxiliaryPictureNativeAuxiliaryPicture结构体类型，用于执行AuxiliaryPicture相关操作。[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md)OH_AuxiliaryPictureInfoAuxiliaryPictureInfo结构体类型，用于执行AuxiliaryPictureInfo相关操作。
...
参数项描述[OH_PixelmapNative](OH_PictureNative.md) *mainPixelmap主图的OH_PixelmapNative指针。[OH_PictureNative](OH_PictureNative.md) **picture被创建的OH_PictureNative指针。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。[OH_PictureNative](OH_PictureNative.md) **mainPixelmap获取的OH_PixelmapNative指针。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。[OH_PictureNative](OH_PictureNative.md) **hdrPixelmap获取的hdr图OH_PixelmapNative指针。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。[OH_PictureNative](OH_PictureNative.md) **gainmapPixelmap获取的增益图OH_PixelmapNative指针。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。[Image_AuxiliaryPictureType](#ZH-CN_TOPIC_0000002529285845__image_auxiliarypicturetype) type辅助图的类型。[OH_AuxiliaryPictureNative](zh-cn_topic_0000002497445894.html) *auxiliaryPicture设置的OH_AuxiliaryPictureNative指针。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。[Image_AuxiliaryPictureType](#ZH-CN_TOPIC_0000002529285845__image_auxiliarypicturetype) type辅助图类型。[OH_AuxiliaryPictureNative](zh-cn_topic_0000002497445894.html) **auxiliaryPicture获取的OH_AuxiliaryPictureNative指针。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。[Image_MetadataType](image_common.h.md#ZH-CN_TOPIC_0000002497445872__image_metadatatype) metadataType元数据类型。[OH_PictureMetadata](OH_PictureMetadata.md) **metadata主图的元数据。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。[Image_MetadataType](image_common.h.md#ZH-CN_TOPIC_0000002497445872__image_metadatatype) metadataType元数据类型。[OH_PictureMetadata](OH_PictureMetadata.md) *metadata将设置的元数据。
...
参数项描述[OH_PictureNative](OH_PictureNative.md) *picture被操作的OH_PictureNative指针。
...
参数项描述uint8_t *data图像数据。size_t dataLength图像数据长度。[Image_Size](Image_Size.md) *size辅助图尺寸。[Image_AuxiliaryPictureType](#ZH-CN_TOPIC_0000002529285845__image_auxiliarypicturetype) type辅助图类型。[OH_AuxiliaryPictureNative](zh-cn_topic_0000002497445894.html) **auxiliaryPicture被创建的OH_AuxiliaryPictureNative指针。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *auxiliaryPicture被操作的OH_AuxiliaryPictureNative指针。uint8_t *source将被写入的图像像素数据。size_t bufferSize图像像素数据长度。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *auxiliaryPicture被操作的OH_AuxiliaryPictureNative指针。uint8_t *destination缓冲区，获取的辅助图像素数据写入到该内存区域内。size_t *bufferSize缓冲区大小。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *auxiliaryPicture被操作的OH_AuxiliaryPictureNative指针。[Image_AuxiliaryPictureType](#ZH-CN_TOPIC_0000002529285845__image_auxiliarypicturetype) *type辅助图类型。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *auxiliaryPicture被操作的OH_AuxiliaryPictureNative指针。[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) **info辅助图信息。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *auxiliaryPicture将操作的OH_AuxiliaryPictureNative指针。[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将要设置的辅助图信息。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *auxiliaryPicture将操作的OH_AuxiliaryPictureNative指针。[Image_MetadataType](image_common.h.md#ZH-CN_TOPIC_0000002497445872__image_metadatatype) metadataType元数据类型。[OH_PictureMetadata](OH_PictureMetadata.md) **metadata获取的元数据。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *auxiliaryPicture将操作的OH_AuxiliaryPictureNative指针。[Image_MetadataType](image_common.h.md#ZH-CN_TOPIC_0000002497445872__image_metadatatype) metadataType元数据类型。[OH_PictureMetadata](OH_PictureMetadata.md) *metadata将要设置的元数据。
...
参数项描述[OH_AuxiliaryPictureNative](OH_AuxiliaryPictureNative.md) *picture将操作的OH_AuxiliaryPictureNative指针。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) **info将操作的OH_AuxiliaryPictureInfo指针。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将操作的OH_AuxiliaryPictureInfo指针。[Image_AuxiliaryPictureType](#ZH-CN_TOPIC_0000002529285845__image_auxiliarypicturetype) *type获取的辅助图类型。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将操作的OH_AuxiliaryPictureInfo指针。[Image_AuxiliaryPictureType](#ZH-CN_TOPIC_0000002529285845__image_auxiliarypicturetype) type将要设置的辅助图类型。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将操作的OH_AuxiliaryPictureInfo指针。[Image_Size](Image_Size.md) *size获取的图片尺寸。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将操作的OH_AuxiliaryPictureInfo指针。[Image_Size](Image_Size.md) *size将要设置的图片尺寸。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将操作的OH_AuxiliaryPictureInfo指针。uint32_t *rowStride跨距，内存中每行像素所占的空间。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将操作的OH_AuxiliaryPictureInfo指针。[PIXEL_FORMAT](pixelmap_native.h.md#ZH-CN_TOPIC_0000002529445819__pixel_format) *pixelFormat获取的像素格式。
...
参数项描述[OH_AuxiliaryPictureInfo](OH_AuxiliaryPictureInfo.md) *info将操作的OH_AuxiliaryPictureInfo指针。[PIXEL_FORMAT](pixelmap_native.h.md#ZH-CN_TOPIC_0000002529445819__pixel_format) pixelFormat将要设置的像素格式。
