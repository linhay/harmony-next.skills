...
创建一个采样选项对象副本[OH_Drawing_SamplingOptions](OH_Drawing_SamplingOptions.md)，用于拷贝一个已有采样选项对象。
...
参数项描述[OH_Drawing_FilterMode](#ZH-CN_TOPIC_0000002497446030__oh_drawing_filtermode) filterMode过滤采样模式[OH_Drawing_FilterMode](zh-cn_topic_0000002497446030.html#ZH-CN_TOPIC_0000002497446030__oh_drawing_filtermode)。[OH_Drawing_MipmapMode](#ZH-CN_TOPIC_0000002497446030__oh_drawing_mipmapmode) mipmapMode多级渐远纹理采样模式[OH_Drawing_MipmapMode](zh-cn_topic_0000002497446030.html#ZH-CN_TOPIC_0000002497446030__oh_drawing_mipmapmode)。

**返回：**

类型说明[OH_Drawing_SamplingOptions](OH_Drawing_SamplingOptions.md)*函数会返回一个指针，指针指向创建的采样选项对象[OH_Drawing_SamplingOptions](OH_Drawing_SamplingOptions.md)。
...
参数项描述[OH_Drawing_SamplingOptions](OH_Drawing_SamplingOptions.md)* samplingOptions指向采样选项对象[OH_Drawing_SamplingOptions](OH_Drawing_SamplingOptions.md)的指针。

**返回：**

类型说明OH_Drawing_SamplingOptions*函数会返回一个指针，指针指向创建的采样选项对象副本[OH_Drawing_SamplingOptions](OH_Drawing_SamplingOptions.md)。如果对象返回NULL，表示创建失败；可能的原因是可用内存为空，或者是samplingOptions为NULL。
