...
名称typedef关键字描述[OH_PhotoNative](OH_PhotoNative.md)OH_PhotoNative
...
参数项描述[OH_PhotoNative](OH_PhotoNative.md)* photoOH_PhotoNative实例。[OH_ImageNative](OH_ImageNative.md)** mainImage用于获取全质量图的OH_ImageNative。
...
参数项描述[OH_PhotoNative](OH_PhotoNative.md)* photo要被释放的OH_PhotoNative实例。
