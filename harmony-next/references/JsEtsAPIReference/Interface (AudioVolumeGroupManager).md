...
参数名类型必填说明volumeType[AudioVolumeType](Enums.md#ZH-CN_TOPIC_0000002529285695__audiovolumetype)是音频音量类型。callbackAsyncCallback<boolean>是回调函数。当获取指定音量流静音状态成功，err为undefined，data为true表示静音，false表示非静音；否则为错误对象。
...
类型说明[AudioRingMode](Enums.md#ZH-CN_TOPIC_0000002529285695__audioringmode)返回系统的铃声模式。
...
监听铃声模式变化事件（当[铃声模式](Enums.md#ZH-CN_TOPIC_0000002529285695__audioringmode)发生变化时触发）。使用callback异步回调。

**系统能力：** SystemCapability.Multimedia.Audio.Volume

**参数：**

参数名类型必填说明typestring是事件回调类型，支持的事件为'ringerModeChange'，当铃声模式发生变化时，触发该事件。callbackCallback<[AudioRingMode](Enums.md#ZH-CN_TOPIC_0000002529285695__audioringmode)>是回调函数，返回变化后的铃音模式。
...
参数名类型必填说明typestring是事件回调类型，支持的事件为'ringerModeChange'，当取消监听铃声模式变化事件时，触发该事件。callbackCallback<[AudioRingMode](Enums.md#ZH-CN_TOPIC_0000002529285695__audioringmode)>否回调函数，返回变化后的铃音模式。
...
参数名类型必填说明volumeType[AudioVolumeType](Enums.md#ZH-CN_TOPIC_0000002529285695__audiovolumetype)是音频音量类型。volumeLevelnumber是音量等级。device[DeviceType](Enums.md#ZH-CN_TOPIC_0000002529285695__devicetype)是设备类型。callbackAsyncCallback<number>是回调函数。当获取音量增益dB值成功，err为undefined，data为获取到的音量增益dB值；否则为错误对象。
...
参数名类型必填说明volumeType[AudioVolumeType](Enums.md#ZH-CN_TOPIC_0000002529285695__audiovolumetype)是音频音量类型。volumeLevelnumber是音量等级。device[DeviceType](Enums.md#ZH-CN_TOPIC_0000002529285695__devicetype)是设备类型。
