...
名称typedef关键字描述[Vibrator_Attribute](Vibrator_Attribute.md)Vibrator_Attribute马达属性。[Vibrator_FileDescription](Vibrator_FileDescription.md)Vibrator_FileDescription振动文件描述。
