...
**相关模块：**[CryptoSignatureApi](CryptoSignatureApi.md)

#### 汇总

#### 结构体

名称typedef关键字描述[OH_CryptoVerify](OH_CryptoVerify.md)OH_CryptoVerify定义验签结构体。[OH_CryptoSign](OH_CryptoSign.md)OH_CryptoSign定义签名结构体。[OH_CryptoEccSignatureSpec](OH_CryptoEccSignatureSpec.md)OH_CryptoEccSignatureSpec定义ECC签名规范结构体。
...
[OH_CryptoVerify](OH_CryptoVerify.md) **verify指向验签实例的指针。
...
参数项描述[OH_CryptoVerify](OH_CryptoVerify.md) *ctx指向验签实例。[OH_CryptoPubKey](OH_CryptoPubKey.md) *pubKey公钥对象。
...
参数项描述[OH_CryptoVerify](OH_CryptoVerify.md) *ctx指向验签实例。[Crypto_DataBlob](Crypto_DataBlob.md) *in传入的消息。
...
参数项描述[OH_CryptoVerify](OH_CryptoVerify.md) *ctx指向验签实例。[Crypto_DataBlob](Crypto_DataBlob.md) *in传入的数据。[Crypto_DataBlob](Crypto_DataBlob.md) *signData签名数据。
...
参数项描述[OH_CryptoVerify](OH_CryptoVerify.md) *ctx指向验签实例。[Crypto_DataBlob](Crypto_DataBlob.md) *signData签名数据。[Crypto_DataBlob](Crypto_DataBlob.md) *rawSignData验签恢复的数据。
...
参数项描述[OH_CryptoVerify](OH_CryptoVerify.md) *ctx指向验签实例。
...
参数项描述[OH_CryptoVerify](OH_CryptoVerify.md) *ctx指向验签实例。[CryptoSignature_ParamType](#ZH-CN_TOPIC_0000002497605360__cryptosignature_paramtype) type用于指定需要设置的验签参数。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value用于指定验签参数的具体值。
...
参数项描述[OH_CryptoVerify](OH_CryptoVerify.md) *ctx指向验签实例。[CryptoSignature_ParamType](#ZH-CN_TOPIC_0000002497605360__cryptosignature_paramtype) type用于指定需要获取的验签参数。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value获取的验签参数的具体值。
...
[OH_CryptoSign](OH_CryptoSign.md) **sign签名实例。
...
参数项描述[OH_CryptoSign](OH_CryptoSign.md) *ctx指向签名实例。[OH_CryptoPrivKey](OH_CryptoPrivKey.md) *privKey私钥。
...
参数项描述[OH_CryptoSign](OH_CryptoSign.md) *ctx指向签名实例。[const Crypto_DataBlob](Crypto_DataBlob.md) *in需要签名的数据。
...
参数项描述[OH_CryptoSign](OH_CryptoSign.md) *ctx指向签名实例。[const Crypto_DataBlob](Crypto_DataBlob.md) *in需要签名的数据。[Crypto_DataBlob](Crypto_DataBlob.md) *out签名结果。
...
参数项描述[OH_CryptoSign](OH_CryptoSign.md) *ctx指向签名实例。
...
参数项描述[OH_CryptoSign](OH_CryptoSign.md) *ctx指向签名实例。[CryptoSignature_ParamType](#ZH-CN_TOPIC_0000002497605360__cryptosignature_paramtype) type签名参数类型。[const Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value输入数据。
...
参数项描述[OH_CryptoSign](OH_CryptoSign.md) *ctx指向签名实例。[CryptoSignature_ParamType](#ZH-CN_TOPIC_0000002497605360__cryptosignature_paramtype) type签名参数类型。[Crypto_DataBlob](zh-cn_topic_0000002497605362.html) *value输出数据。
...
参数项描述[Crypto_DataBlob](Crypto_DataBlob.md) *eccSignatureECC签名（DER格式），如果EccSignature参数为NULL，将创建一个空的ECC签名规范。[OH_CryptoEccSignatureSpec](OH_CryptoEccSignatureSpec.md) **spec输出的ECC签名规范。
...
参数项描述[OH_CryptoEccSignatureSpec](OH_CryptoEccSignatureSpec.md) *spec指向ECC签名规范。[Crypto_DataBlob](Crypto_DataBlob.md) *rr值。[Crypto_DataBlob](Crypto_DataBlob.md) *ss值。
...
参数项描述[OH_CryptoEccSignatureSpec](OH_CryptoEccSignatureSpec.md) *spec指向ECC签名规范。[Crypto_DataBlob](Crypto_DataBlob.md) *out输出数据。
...
参数项描述[OH_CryptoEccSignatureSpec](OH_CryptoEccSignatureSpec.md) *spec指向ECC签名规范。