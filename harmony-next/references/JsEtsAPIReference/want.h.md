...
参数项描述[AbilityBase_Element](AbilityBase_Element.md) elementElement数据结构。

**返回：**

类型说明[AbilityBase_Want](AbilityBase_Want.md)*返回want数据结构。
...
参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。
...
参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。[AbilityBase_Element](AbilityBase_Element.md) elementElement结构体。
...
设置Want Param参数，Param可参考[Want中的parameters参数](Want.md)。

**起始版本：** 15

**参数：**

参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* keyWant中字符串参数索引。const char* valueWant中字符串。
...
参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* keyWant中字符串参数索引。char* valueWant中字符串。size_t valueSizevalue字符串长度。如果valueSize小于实际需要获取的value长度，则会报[ABILITY_BASE_ERROR_CODE_PARAM_INVALID](ability_base_common.h.md#ZH-CN_TOPIC_0000002529444623__abilitybase_errorcode)错误。
...
添加Want文件描述符，文件描述符可通过[fs.open](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsopen)获取。

**起始版本：** 15

**参数：**

参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* keyWant中字符串参数索引。int32_t fd文件描述符，可通过[fs.open](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsopen)获取。
...
参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* keyWant中字符串参数索引。int32_t* fd文件描述符。
...
设置Want中URI字符串，URI可参考[Want中URI描述](@ohos.app.ability.Want (Want).md)。

**起始版本：** 17

**参数：**

参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* uri表示URI。如果在Want中指定了URI，则Want将匹配指定的URI信息。URI可参考[Want中URI描述](@ohos.app.ability.Want (Want).md)。
...
获取Want中URI字符串。URI可参考[Want中URI描述](@ohos.app.ability.Want (Want).md)。

**起始版本：** 17

**参数：**

参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。char* uri表示URI。如果在Want中指定了URI，则Want将匹配指定的URI信息。URI可参考[Want中URI描述](@ohos.app.ability.Want (Want).md)。size_t uriSizeURI字符串长度。如果uriSize小于实际需要获取的URI长度，则会报[ABILITY_BASE_ERROR_CODE_PARAM_INVALID](ability_base_common.h.md#ZH-CN_TOPIC_0000002529444623__abilitybase_errorcode)错误。
...
参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* keyWant中int32_t类型值的参数索引。int32_t valueWant中int32_t类型的值。
...
参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* keyWant中bool类型值的参数索引。bool valueWant中bool类型的值。
...
参数项描述[AbilityBase_Want](AbilityBase_Want.md)* wantWant指针。const char* keyWant中double类型值的参数索引。double valueWant中double类型的值。
