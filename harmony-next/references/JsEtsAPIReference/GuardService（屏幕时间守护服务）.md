...
[1019000001](ArkTS API错误码.md#section146742215461)

内部错误。

USER_NOT_AUTHORIZED

[1019000002](ArkTS API错误码.md#section20689133216551)

用户未授权。

USER_CANCELED

[1019000003](ArkTS API错误码.md#section133431336165512)

用户取消。

STRATEGIES_EXCEED_LIMIT

[1019000004](ArkTS API错误码.md#section53113406554)

策略数量超限。

STRATEGY_NAME_ALREADY_EXIST

[1019000005](ArkTS API错误码.md#section166061643165510)

策略名称重复。

NONEXISTENT_STRATEGY

[1019000006](ArkTS API错误码.md#section15125164745520)

策略不存在。

STRATEGY_ALREADY_EXECUTED

[1019000007](ArkTS API错误码.md#section1826085035513)

策略重复执行。

STRATEGY_NOT_STARTED

[1019000008](ArkTS API错误码.md#section730515419559)

策略未执行。

INVALID_PARAM

[1019000009](ArkTS API错误码.md#section28550355113)
