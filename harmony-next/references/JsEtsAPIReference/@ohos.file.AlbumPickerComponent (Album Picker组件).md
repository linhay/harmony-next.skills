...
filterType13+[photoAccessHelper.PhotoViewMIMETypes](Enums.md#ZH-CN_TOPIC_0000002529445919__photoviewmimetypes)否是
...
字体大小，取值范围参考[fontsize](Text.md#ZH-CN_TOPIC_0000002497444914__fontsize)。
...
参数名类型必填说明fontSizenumber | string是字体大小，取值范围参考[fontsize](Text.md#ZH-CN_TOPIC_0000002497444914__fontsize)。
