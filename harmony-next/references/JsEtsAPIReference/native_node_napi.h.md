...
参数项描述napi_env envnapi的环境指针。napi_value frameNodeArkTS侧创建的FrameNode对象。[ArkUI_NodeHandle](ArkUI_Node_.md)* handleArkUI_NodeHandle指针。
...
参数项描述napi_env envnapi的环境指针。napi_value valueArkTS侧创建的context对象。[ArkUI_ContextHandle](ArkUI_Context_.md)* contextArkUI_ContextHandle指针。
...
参数项描述napi_env envnapi的环境指针。napi_value valueArkTS侧创建的NodeContent对象。[ArkUI_NodeContentHandle](ArkUI_NodeContent_.md)* contentArkUI_NodeContentHandle指针。
...
参数项描述napi_env envnapi的环境指针。napi_value valueArkTS侧创建的DrawableDescriptor对象。[ArkUI_DrawableDescriptor](ArkUI_DrawableDescriptor.md)** drawableDescriptor接受ArkUI_DrawableDescriptor指针的对象。
...
参数项描述napi_env envnapi的环境指针。napi_value valueArkTS侧创建的$r资源对象。[ArkUI_DrawableDescriptor](ArkUI_DrawableDescriptor.md)** drawableDescriptor接受ArkUI_DrawableDescriptor指针的对象。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。char* buffer缓冲区，被查询的NavDestination名称写入该内存区域。int32_t bufferSize缓冲区大小。int32_t* writeLength在返回[ARKUI_ERROR_CODE_NO_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示实际写入到缓冲区的字符串长度。 在返回[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示可以容纳目标的最小缓冲区大小。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。int32_t* length栈的长度。查询成功后将结果写回该参数。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。int32_t index被查询NavDestination在栈中的索引。char* buffer缓冲区，被查询页面的名称写入该内存区域。int32_t bufferSize缓冲区大小。int32_t* writeLength在返回[ARKUI_ERROR_CODE_NO_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示实际写入到缓冲区的字符串长度。 在返回[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示可以容纳目标的最小缓冲区大小。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。char* buffer缓冲区，NavDestinationID写入该内存区域。int32_t bufferSize缓冲区大小。int32_t* writeLength在返回[ARKUI_ERROR_CODE_NO_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示实际写入到缓冲区的字符串长度。 在返回[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示可以容纳目标的最小缓冲区大小。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。[ArkUI_NavDestinationState](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_navdestinationstate)* stateNavDestination的状态值写回该参数中。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。int32_t* index索引值，从0开始计数。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。int32_t* index索引值，从1开始计数。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。char* buffer缓冲区，页面名称写入该内存区域。int32_t bufferSize缓冲区大小。int32_t* writeLength在返回[ARKUI_ERROR_CODE_NO_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示实际写入到缓冲区的字符串长度。 在返回[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示可以容纳目标的最小缓冲区大小。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。char* buffer缓冲区，Page Path写入该内存区域。int32_t bufferSize缓冲区大小。int32_t* writeLength在返回[ARKUI_ERROR_CODE_NO_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示实际写入到缓冲区的字符串长度。 在返回[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示可以容纳目标的最小缓冲区大小。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。[ArkUI_RouterPageState](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_routerpagestate)* stateRouter Page的状态值写回该参数中。
...
参数项描述[ArkUI_NodeHandle](ArkUI_Node_.md) node指定的节点。char* buffer缓冲区，Page Id写入该内存区域。int32_t bufferSize缓冲区大小。int32_t* writeLength在返回[ARKUI_ERROR_CODE_NO_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示实际写入到缓冲区的字符串长度。 在返回[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](native_type.h.md#ZH-CN_TOPIC_0000002497445102__arkui_errorcode)时表示可以容纳目标的最小缓冲区大小。
...
参数项描述[ArkUI_ContextHandle](ArkUI_Context_.md) uiContextUIContext对象，用以绑定实例。void* userData自定义事件参数，当事件触发时在回调参数中携带回来。callback自定义回调函数。uint64_t nanoTimestamp帧信号的时间戳。uint32_t frameCount帧号。
...
参数项描述[ArkUI_ContextHandle](ArkUI_Context_.md) uiContextUIContext对象，用以绑定实例。void* userData自定义事件参数，当自定义回调函数触发时在回调参数中携带回来。callback自定义回调函数，会在下一帧事件结束后剩余时间大于1ms时回调执行。uint64_t nanoTimeLeft下一帧渲染后的剩余时间。uint32_t frameCount帧号。
