...
名称描述[PARAM_USER_ID](#ZH-CN_TOPIC_0000002529445635__param_user_id) "user_id"

用户ID。

**起始版本：** 8

[PARAM_DISTRIBUTED_SERVICE_NAME](#ZH-CN_TOPIC_0000002529445635__param_distributed_service_name) "ds_name"

分布式服务名称。

**起始版本：** 8

[PARAM_DISTRIBUTED_SERVICE_INSTANCE_ID](#ZH-CN_TOPIC_0000002529445635__param_distributed_service_instance_id) "ds_instance_id"
