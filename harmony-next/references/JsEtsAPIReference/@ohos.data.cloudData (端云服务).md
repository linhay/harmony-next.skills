...
参数名类型必填说明strategy[StrategyType](#ZH-CN_TOPIC_0000002497604690__strategytype)是配置的策略类型。paramArray<[commonType.ValueType](zh-cn_topic_0000002497604678.html#ZH-CN_TOPIC_0000002497604678__valuetype)>否策略参数。当前仅支持设置网络策略，默认支持WIFI和蜂窝网络策略。
