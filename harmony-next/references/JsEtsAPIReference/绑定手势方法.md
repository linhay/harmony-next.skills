...
可以通过gesture、priorityGesture和parallelGesture给组件绑定手势识别，手势识别成功后可以通过事件回调通知组件。可以通过[触摸热区](触摸热区设置.md)指定可识别手势的区域。gesture、priorityGesture和parallelGesture当前不支持使用三目运算符（条件? 表达式1 : 表达式2）切换手势绑定。
...
参数名类型必填说明gesture[GestureType](手势公共接口.md#ZH-CN_TOPIC_0000002497604864__gesturetype)是绑定的手势类型。mask[GestureMask](手势公共接口.md#ZH-CN_TOPIC_0000002497604864__gesturemask枚举说明)否
...
参数名类型必填说明gesture[GestureType](手势公共接口.md#ZH-CN_TOPIC_0000002497604864__gesturetype)是绑定的手势对象。mask[GestureMask](手势公共接口.md#ZH-CN_TOPIC_0000002497604864__gesturemask枚举说明)否
