...
名称类型只读可选说明recommendationType[RecommendationType](Enums.md#ZH-CN_TOPIC_0000002529445919__recommendationtype11)否是

如果需要根据枚举值推荐相应的图片，则配置此参数。

**元服务API：** 从API version 11开始，该接口支持在元服务中使用。

textContextInfo12+[TextContextInfo](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285945__textcontextinfo12)否是
...
名称类型只读可选说明MIMEType[PhotoViewMIMETypes](Enums.md#ZH-CN_TOPIC_0000002529445919__photoviewmimetypes)否是
...
singleSelectionMode18+[SingleSelectionMode](Enums.md#ZH-CN_TOPIC_0000002529445919__singleselectionmode18)否是
...
completeButtonText14+[CompleteButtonText](Enums.md#ZH-CN_TOPIC_0000002529445919__completebuttontext14)否是
...
movingPhotoBadgeStates22+Array<[MovingPhotoBadgeStateType](Enums.md#ZH-CN_TOPIC_0000002529445919__movingphotobadgestatetype22)>否否
...
名称类型只读可选说明filterOperator[FilterOperator](Enums.md#ZH-CN_TOPIC_0000002529445919__filteroperator19)否否
...
MIMEType[photoAccessHelper.PhotoViewMIMETypes](Enums.md#ZH-CN_TOPIC_0000002529445919__photoviewmimetypes)否是

最近图片控件显示的文件类型，默认为PhotoViewMIMETypes.IMAGE_VIDEO_TYPE。

**元服务API**：从API version 20开始，该接口支持在元服务中使用。

photoSource[PhotoSource](Enums.md#ZH-CN_TOPIC_0000002529445919__photosource20)否是
...
名称类型只读可选说明photoViewMimeType[PhotoViewMIMETypes](Enums.md#ZH-CN_TOPIC_0000002529445919__photoviewmimetypes)否否指定媒体文件类型，用于文件大小过滤。sizeFilter[FileSizeFilter](#ZH-CN_TOPIC_0000002497605950__filesizefilter19)否否指定文件大小过滤规则。
...
用户上次选择时设置的推荐内容枚举值，参考[RecommendationType](Enums.md#ZH-CN_TOPIC_0000002529445919__recommendationtype11)值定义。

上次选择时未设置推荐时，默认为0。

selectedRecommendationTypenumber否否

用户上次选择时选中的推荐内容枚举值，参考[RecommendationType](Enums.md#ZH-CN_TOPIC_0000002529445919__recommendationtype11)值定义。
...
名称类型只读可选说明operationType[OperationType](Enums.md#ZH-CN_TOPIC_0000002529445919__operationtype22)否否各类谓词的枚举。field[PhotoKeys](Enums.md#ZH-CN_TOPIC_0000002529445919__photokeys)否是
...
通过[select](Class (PhotoViewPicker).md#ZH-CN_TOPIC_0000002529445913__select)接口配置此参数时，输入非法字段会抛出错误码401；通过[PhotoPickerComponent (PhotoPicker组件)](@ohos.file.PhotoPickerComponent (PhotoPicker组件).md)配置此参数时，输入非法字段无onPickerControllerReady回调。

非条件谓词如and、or、beginWrap、endWrap等不涉及该字段。

valueArray<[OperationValueType](Types.md#ZH-CN_TOPIC_0000002497605956__operationvaluetype22)>否是
