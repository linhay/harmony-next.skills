...
参数名类型必填说明range[ExpectedFrameRateRange](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__expectedframeraterange11)是
...
类型说明[ExpectedFrameRateRange](显式动画 (animateTo).md#ZH-CN_TOPIC_0000002497444950__expectedframeraterange11)期望帧率范围。
