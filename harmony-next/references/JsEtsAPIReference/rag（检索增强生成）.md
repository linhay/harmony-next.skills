...
表示LLM流式输出过程中出现的错误。[code](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#businesserror)取值范围为[1021011000, 1021012000)，超过范围则会报错[1021000000](zh-cn_topic_0000002342660646.html#section16205152494111)。基类必选参数name和message的长度上限为1000字符，超出部分将被截断。不带本参数则认为无错误发生。
...
**错误码：**
 ...
 以下错误码的详细介绍请参见 [通用错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-universal)和 [数据增强错误码](zh-cn_topic_0000002342660646.md)。

错误码ID

错误信息

[1021000000](ArkTS API错误码.md#section16205152494111)

Insufficient system resources or memory access exception.

[1021000001](ArkTS API错误码.md#section067520119311)

A timeout occurred when calling the LLM.

[1021000002](ArkTS API错误码.md#section398619111131)

A loading failure occurred when calling the LLM.

[1021000003](ArkTS API错误码.md#section821961514310)

A request failure occurred when calling the LLM.

[1021000004](ArkTS API错误码.md#section57321151039)

The LLM chat is busy.

[1021000005](ArkTS API错误码.md#section151441316239)

The output of LLM chat does not comply with the constraints.

[1021000007](ArkTS API错误码.md#section1787571610312)

The RAG session is busy.

[1021000008](ArkTS API错误码.md#section16220417239)

The RAG session is Already closed.

[1021000009](ArkTS API错误码.md#section12582191715318)

User has canceled the stream run.

[1021000010](ArkTS API错误码.md#section13942117932)

A timeout occurred in the session.

[1021000011](ArkTS API错误码.md#section3292318836)
...
[1021000006](ArkTS API错误码.md#section34911416737)
