...
名称typedef关键字描述[OH_AVMemory](OH_AVMemory.md)OH_AVMemory为音视频内存接口定义native层对象。
...
类型说明[OH_AVMemory](OH_AVMemory.md) *
...
参数项描述[struct OH_AVMemory](OH_AVMemory.md) *mem指向OH_AVMemory实例的指针。
