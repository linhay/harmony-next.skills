...
参数名类型必填说明idstring是组件id，可通过通用属性[id](组件标识.md#ZH-CN_TOPIC_0000002497604824__id)或[key](组件标识.md#ZH-CN_TOPIC_0000002497604824__key12)设置。当组件id为空字符串或未找到匹配id的组件时，不显示放大镜。
