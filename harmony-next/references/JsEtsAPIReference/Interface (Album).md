...
Album extends [AbsAlbum](Interface (AbsAlbum).md).
...
从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAlbumChangeRequest.addAssets](Class (MediaAlbumChangeRequest).md#ZH-CN_TOPIC_0000002497605948__addassets11)替代。
...
从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAlbumChangeRequest.removeAssets](Class (MediaAlbumChangeRequest).md#ZH-CN_TOPIC_0000002497605948__removeassets11)替代。
