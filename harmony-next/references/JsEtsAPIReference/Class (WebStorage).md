...
参数名类型必填说明callbackAsyncCallback<Array<[WebStorageOrigin](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285193__webstorageorigin)>>是以数组方式返回源的信息。
...
类型说明Promise<Array<[WebStorageOrigin](Interfaces (其他).md#ZH-CN_TOPIC_0000002529285193__webstorageorigin)>>Promise实例，用于获取当前所有源的信息。
