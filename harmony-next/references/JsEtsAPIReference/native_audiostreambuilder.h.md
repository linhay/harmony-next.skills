...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)** builder该引用指向创建的构造器的结果。[OH_AudioStream_Type](native_audiostream_base.h.md#ZH-CN_TOPIC_0000002529445679__oh_audiostream_type) type构造器的流类型。AUDIOSTREAM_TYPE_RENDERER或AUDIOSTREAM_TYPE_CAPTURER。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。int32_t rate音频流采样率。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。int32_t channelCount音频流通道数。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioStream_SampleFormat](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiostream_sampleformat) format音频流采样格式。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioStream_EncodingType](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiostream_encodingtype) encodingType音频流编码类型。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioStream_LatencyMode](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiostream_latencymode) latencyMode音频流时延模式。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioChannelLayout](zh-cn_topic_0000002497445760.html#ZH-CN_TOPIC_0000002497445760__oh_audiochannellayout) channelLayout音频流声道布局。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioStream_Usage](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiostream_usage) usage输出音频流属性，使用的工作场景。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioStream_VolumeMode](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiostream_volumemode) volumeMode要设置的音频流音量模式。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioStream_SourceType](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiostream_sourcetype) sourceType输入音频流属性，使用的工作场景。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_Callbacks](zh-cn_topic_0000002497445744.html) callbacks将被用来处理输出音频流相关事件的回调函数。void* userData指向通过回调函数传递的应用数据指针。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_OutputDeviceChangeCallback](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiorenderer_outputdevicechangecallback) callback将被用来处理输出流设备变更相关事件的回调函数。void* userData指向通过回调函数传递的应用数据指针。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioStream_PrivacyType](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiostream_privacytype) privacy标识对应播放音频流是否会被其它应用录制。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioCapturer_Callbacks](zh-cn_topic_0000002529285715.html) callbacks将被用来处理输入音频流相关事件的回调函数。void* userData指向通过回调函数传递的应用数据指针。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_WriteDataWithMetadataCallback](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiorenderer_writedatawithmetadatacallback) callback将被用来同时写入音频数据和元数据的回调函数。void* userData指向通过回调函数传递的应用数据指针。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer](zh-cn_topic_0000002497605724.html)** audioRenderer指向输出音频流实例的指针，将被用来接收函数创建的结果。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioCapturer](zh-cn_topic_0000002497445746.html)** audioCapturer指向输入音频流实例的指针，将被用来接收函数创建的结果。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。int32_t frameSize要设置音频数据的帧长。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioInterrupt_Mode](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiointerrupt_mode) mode音频中断模式。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_OnWriteDataCallback](zh-cn_topic_0000002529445679.html#ZH-CN_TOPIC_0000002529445679__oh_audiorenderer_onwritedatacallback) callback将被用来写入音频数据的回调函数。void* userData指向通过回调函数传递的应用数据指针。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_OnWriteDataCallbackAdvanced](zh-cn_topic_0000002529445677.html#ZH-CN_TOPIC_0000002529445677__oh_audiorenderer_onwritedatacallbackadvanced) callback将被用来写入音频数据的回调函数。void* userData指向通过回调函数传递的应用数据指针。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_OnInterruptCallback](zh-cn_topic_0000002529445677.html#ZH-CN_TOPIC_0000002529445677__oh_audiorenderer_oninterruptcallback) callback用于接收中断事件的回调函数。void* userData指向应用程序数据结构的指针，该结构将传递给回调函数。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_OnErrorCallback](zh-cn_topic_0000002529445677.html#ZH-CN_TOPIC_0000002529445677__oh_audiorenderer_onerrorcallback) callback用于接收错误事件的回调函数。void* userData指向应用程序数据结构的指针，该结构将传递给回调函数。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioCapturer_OnReadDataCallback](zh-cn_topic_0000002497445730.html#ZH-CN_TOPIC_0000002497445730__oh_audiocapturer_onreaddatacallback) callback用于接收读取数据事件的回调函数。void* userData指向应用程序数据结构的指针，该结构将传递给回调函数。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioCapturer_OnDeviceChangeCallback](zh-cn_topic_0000002497445730.html#ZH-CN_TOPIC_0000002497445730__oh_audiocapturer_ondevicechangecallback) callback用于接收设备变更事件的回调函数。void* userData指向应用程序数据结构的指针，该结构将传递给回调函数。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioCapturer_OnErrorCallback](zh-cn_topic_0000002497445730.html#ZH-CN_TOPIC_0000002497445730__oh_audiocapturer_onerrorcallback) callback用于接收错误事件的回调函数。void* userData指向应用程序数据结构的指针，该结构将传递给回调函数。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。bool muteWhenInterrupted设置当前录制音频流是否启用静音打断模式。true表示启用；false表示不启用，保持为默认打断模式。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioRenderer_OnFastStatusChange](zh-cn_topic_0000002529445677.html#ZH-CN_TOPIC_0000002529445677__oh_audiorenderer_onfaststatuschange) callback用于接收播放低时延状态改变事件的回调函数。void* userData向应用程序数据结构的指针，该结构将传递给回调函数。
...
参数项描述[OH_AudioStreamBuilder](OH_AudioStreamBuilderStruct.md)* builder指向[OH_AudioStreamBuilder_Create](#ZH-CN_TOPIC_0000002497605714__oh_audiostreambuilder_create)创建的构造器实例。[OH_AudioCapturer_OnFastStatusChange](zh-cn_topic_0000002497445730.html#ZH-CN_TOPIC_0000002497445730__oh_audiocapturer_onfaststatuschange) callback用于接收录制低时延状态改变事件的回调函数。void* userData向应用程序数据结构的指针，该结构将传递给回调函数。
