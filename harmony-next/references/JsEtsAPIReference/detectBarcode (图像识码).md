...
[InputImage](#section2194164873812)
...
回调函数，当图片识码成功，err为undefined，data为获取到的识码结果Array<scanBarcode.[ScanResult](scanBarcode (默认界面扫码).md#section10614317162112)>，否则为错误对象。
...
[ImageFormat](#section326142720394)
...
Array<scanBarcode.[ScanResult](scanBarcode (默认界面扫码).md#section10614317162112)>
...
1. 使用Camera Kit [setZoomRatio](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-zoom#setzoomratio11)接口设置targetRatio，目标值为zoomRatio * zoomValue。
...
Promise<[DetectResult](#section655375703713)>
