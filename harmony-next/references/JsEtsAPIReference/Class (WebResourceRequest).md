...
Web组件获取资源请求对象。示例代码参考[onErrorReceive事件](事件.md#ZH-CN_TOPIC_0000002497445228__onerrorreceive)。
...
类型说明Array<[Header](Interfaces（其他）.md#ZH-CN_TOPIC_0000002529445183__header)>返回资源请求头信息。
