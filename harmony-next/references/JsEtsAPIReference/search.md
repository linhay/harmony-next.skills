...
名称类型只读可选说明value8+[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
placeholder8+[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是
...
icon的数据源支持[使用相对路径显示图片](Image.md#ZH-CN_TOPIC_0000002497444922__示例25使用相对路径显示图片)和网络图片。
...
参数名类型必填说明value[Font](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font)否placeholder文本样式。

可以使用[loadFontSync](@ohos.graphics.text (文本模块).md#ZH-CN_TOPIC_0000002497605988__loadfontsync)注册自定义字体。
...
参数名类型必填说明value[Font](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__font)否搜索框内输入文本样式。
...
参数名类型必填说明value[IconOptions](#ZH-CN_TOPIC_0000002497444916__iconoptions10对象说明) | [SymbolGlyphModifier](zh-cn_topic_0000002529284891.html#ZH-CN_TOPIC_0000002529284891__symbolglyphmodifier12)是
...
参数名类型必填说明value[CaretStyle](文本组件公共接口.md#ZH-CN_TOPIC_0000002529444865__caretstyle10)是
...
名称类型只读可选说明size[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是图标尺寸，不支持百分比。color[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是图标颜色。src[ResourceStr](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcestr)否是图标/图片源。

#### SearchButtonOptions10+对象说明

**系统能力：** SystemCapability.ArkUI.ArkUI.Full

名称类型只读可选说明fontSize[Length](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__length)否是文本按钮字体大小，不支持百分比。**元服务API：** 从API version 11开始，该接口支持在元服务中使用。fontColor[ResourceColor](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__resourcecolor)否是文本按钮字体颜色。**元服务API：** 从API version 11开始，该接口支持在元服务中使用。autoDisable18+Boolean否是
...
名称类型只读可选说明style[CancelButtonStyle](#ZH-CN_TOPIC_0000002497444916__cancelbuttonstyle10枚举说明)否是右侧清除按钮显示状态。icon[SymbolGlyphModifier](zh-cn_topic_0000002529284891.html#ZH-CN_TOPIC_0000002529284891__symbolglyphmodifier12)否是右侧清除按钮Symbol图标。
...
参数名类型必填说明callback[OnPasteCallback](TextInput.md#ZH-CN_TOPIC_0000002529444859__onpastecallback18)是粘贴回调。
...
参数名类型必填说明callback[OnTextSelectionChangeCallback](TextInput.md#ZH-CN_TOPIC_0000002529444859__ontextselectionchangecallback18)是文本选择变化回调或光标位置变化回调。
...
参数名类型必填说明callback[OnContentScrollCallback](TextInput.md#ZH-CN_TOPIC_0000002529444859__oncontentscrollcallback18)是文本内容滚动回调。
...
options[SelectionOptions](输入框类组件通用接口.md#ZH-CN_TOPIC_0000002529284891__selectionoptions12对象说明)否
...
参数名类型必填说明searchContentstring是当前搜索框中输入的文本内容。event[SubmitEvent](TextInput.md#ZH-CN_TOPIC_0000002529444859__submitevent11)否提交事件。
...
该示例通过[customKeyboard](#ZH-CN_TOPIC_0000002497444916__customkeyboard10)（从API version 10开始）属性分别将value中的入参类型设置为[CustomBuilder](zh-cn_topic_0000002497604974.html#ZH-CN_TOPIC_0000002497604974__custombuilder8)和[ComponentContent](ComponentContent.md#ZH-CN_TOPIC_0000002497444816__componentcontent-1)，实现了自定义键盘的功能。

从API version 22开始[customKeyboard](#ZH-CN_TOPIC_0000002497444916__customkeyboard10)属性新增了入参类型[ComponentContent](zh-cn_topic_0000002497444816.html#ZH-CN_TOPIC_0000002497444816__componentcontent-1)。
...
该示例通过[customKeyboard](#ZH-CN_TOPIC_0000002497444916__customkeyboard10)（从API version 10开始）属性配置[KeyboardOptions](zh-cn_topic_0000002497604894.html#ZH-CN_TOPIC_0000002497604894__keyboardoptions12)（从API version 12开始）接口实现了自定义键盘避让的效果。
...
从API version 12开始，该示例通过[editMenuOptions](#ZH-CN_TOPIC_0000002497444916__editmenuoptions12)接口实现了文本设置自定义菜单扩展项的文本内容、图标以及回调的功能，同时，可以在[onPrepareMenu](zh-cn_topic_0000002529444865.html#ZH-CN_TOPIC_0000002529444865__属性-1)（从API version 20开始）回调中，进行菜单数据的设置。
...
该示例通过[defaultFocus](焦点控制.md#ZH-CN_TOPIC_0000002529444807__defaultfocus9)（从API version 9开始）、[enableKeyboardOnFocus](#ZH-CN_TOPIC_0000002497444916__enablekeyboardonfocus10)（从API version 10开始）属性展示如何设置默认获焦并拉起软键盘。
