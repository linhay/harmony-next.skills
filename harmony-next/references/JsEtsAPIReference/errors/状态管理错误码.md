...
[addMonitor](@ohos.arkui.StateManagement (状态管理).md#ZH-CN_TOPIC_0000002553200701__addmonitor20)/[clearMonitor](@ohos.arkui.StateManagement (状态管理).md#ZH-CN_TOPIC_0000002553200701__clearmonitor20)的目标对象参数不合法。

**可能原因**

目标对象不满足以下情况：

- [@ObservedV2](../guides/@ObservedV2与@Trace：类属性变化观测.md)装饰的class(至少有一个[@Trace](../guides/@ObservedV2与@Trace：类属性变化观测.md)装饰的变量)。
- [@ComponentV2](../topics/components/自定义组件.md)装饰的自定义组件的实例。

**处理步骤**

确保addMonitor/clearMonitor的目标对象合法，详情请参见[addMonitor/clearMonitor开发指南](../guides/addMonitor与clearMonitor开发指南.md#限制条件)。
...
确保addMonitor/clearMonitor的路径合法，详情可见[addMonitor/clearMonitor开发指南](../guides/addMonitor与clearMonitor开发指南.md#限制条件)。
...
确保addMonitor/clearMonitor的回调方法合法，详情可见[addMonitor/clearMonitor开发指南](../guides/addMonitor与clearMonitor开发指南.md#限制条件)。
