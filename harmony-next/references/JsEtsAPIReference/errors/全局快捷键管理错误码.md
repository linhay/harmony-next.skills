...
1. 可以通过[getAllSystemHotkeys](../modules/ohos/@ohos.multimodalInput.inputConsumer (全局快捷键).md#ZH-CN_TOPIC_0000002497445592__inputconsumergetallsystemhotkeys)接口查询所有的系统快捷键。
