...
当请求数据量超大时推荐使用[OnDataReceive](rcp.md#ZH-CN_TOPIC_0000002522081536__ondatareceive)。
...
可能是因为[StaticDnsRule](rcp.md#ZH-CN_TOPIC_0000002522081536__staticdnsrule)或者[DynamicDnsRule](rcp.md#ZH-CN_TOPIC_0000002522081536__dynamicdnsrule)传入的IP地址格式不正确。

处理步骤

确认[StaticDnsRule](rcp.md#ZH-CN_TOPIC_0000002522081536__staticdnsrule)或者[DynamicDnsRule](rcp.md#ZH-CN_TOPIC_0000002522081536__dynamicdnsrule)传入参数格式是否正确可用。
...
通过使用[PathPreference](rcp.md#ZH-CN_TOPIC_0000002522081536__pathpreference)的'cellular'模式拉起蜂窝数据连接时，因为条件不满足而导致激活蜂窝超时。
...
URPC请求超出开发者配置的[UrpcConnectConfiguration](urpc.md#ZH-CN_TOPIC_0000002553361457__urpcconnectconfiguration)时长。
...
排查[UrpcStub](urpc.md#ZH-CN_TOPIC_0000002553361457__urpcstub)类的声明和使用是否正确。
