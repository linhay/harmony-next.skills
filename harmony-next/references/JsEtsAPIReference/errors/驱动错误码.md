...
1. 服务内部遇到通信输入输出异常。
1. 若接口存在busType参数，请检查参数是否错误。

**处理步骤**

1. 请更换目标产品形态。
1. 请尝试重启设备，或通过[在线提交问题单](https://developer.huawei.com/consumer/cn/support)来反映问题。
1. 通过[deviceManager.BusType](../modules/ohos/@ohos.driver.deviceManager (外设管理).md#ZH-CN_TOPIC_0000002497445624__bustype)查询支持的枚举值。
