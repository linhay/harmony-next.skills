...
检查入参卡片尺寸是否在[FormDimension](@ohos.app.form.formInfo (formInfo).md#ZH-CN_TOPIC_0000002553361175__formdimension)和[supportDimensions](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-configuration#配置文件字段说明)配置列表。
