...
1. 空参数错误，比如传入空字符串（''）。
1. 参数格式错误。
1. 参数值错误。输入参数需要与[app.json5](../guides/app.json5配置文件.md)和[配置ArkTS卡片的配置文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-configuration)中对应的配置保持一致。
