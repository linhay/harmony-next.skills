...
应用需创建NotificationSubscriberExtensionAbility，具体配置方法参考[ExtensionAbility组件](../guides/ExtensionAbility组件.md)中的[NotificationSubscriberExtensionAbility](@ohos.application.NotificationSubscriberExtensionAbility (通知订阅扩展能力).md)。