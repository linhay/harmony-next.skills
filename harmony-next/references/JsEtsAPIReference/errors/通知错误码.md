...
参考[NotificationRequest](../topics/misc/NotificationRequest.md)通知禁止删除属性。
...
应用未设置或未正确设置[NotificationSubscriberExtensionAbility](../modules/ohos/@ohos.application.NotificationSubscriberExtensionAbility (通知订阅扩展能力).md)。

**处理步骤**

应用需创建NotificationSubscriberExtensionAbility，具体配置方法参考[ExtensionAbility组件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/extensionability-overview)中的[NotificationSubscriberExtensionAbility](../modules/ohos/@ohos.application.NotificationSubscriberExtensionAbility (通知订阅扩展能力).md)。
