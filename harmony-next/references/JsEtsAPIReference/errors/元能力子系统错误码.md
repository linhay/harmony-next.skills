...
1. 确认被调用方（服务端）的Ability类型与调用接口是否匹配。对于ServiceExtensionAbility，应使用[connectServiceExtensionAbility()](UIAbilityContext.md#ZH-CN_TOPIC_0000002553200541__connectserviceextensionability)方法连接。同时需要确保[module.json5配置文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file)中extensionAbilities的type设置为与接口匹配的service。
...
[startAppServiceExtensionAbility](UIAbilityContext.md#ZH-CN_TOPIC_0000002553200541__startappserviceextensionability20)、[stopAppServiceExtensionAbility](UIAbilityContext.md#ZH-CN_TOPIC_0000002553200541__stopappserviceextensionability20)接口调用方的app-identifier不在目标[AppServiceExtensionAbility](@ohos.app.ability.AppServiceExtensionAbility (应用后台服务扩展组件).md)的[appIdentifierAllowList](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#extensionabilities标签)中。

**处理步骤**

将接口调用方的app-identifier配置在目标[AppServiceExtensionAbility](@ohos.app.ability.AppServiceExtensionAbility (应用后台服务扩展组件).md)的[appIdentifierAllowList](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#extensionabilities标签)中。
...
1. 由当前应用拉起目标服务时，需要将接口调用方的app-identifier配置在目标[AppServiceExtensionAbility](@ohos.app.ability.AppServiceExtensionAbility (应用后台服务扩展组件).md)的[appIdentifierAllowList](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#extensionabilities标签)中。
