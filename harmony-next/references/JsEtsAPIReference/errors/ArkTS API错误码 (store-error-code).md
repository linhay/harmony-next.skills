...
调用BMS（Bundle Manager Service）使能动态图标失败。
...
2. 调用[appInfoManager.selectDynamicIcon](../topics/system-services/appInfoManager（应用元数据管理服务）.md#section16502191111574)重新设置动态图标。
