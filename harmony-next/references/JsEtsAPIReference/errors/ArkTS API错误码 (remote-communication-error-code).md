...
当请求数据量超大时推荐使用[OnDataReceive](../topics/misc/rcp.md#section9264115918536)。
...
可能是因为[StaticDnsRule](../topics/misc/rcp.md#section47911616155511)或者[DynamicDnsRule](../topics/misc/rcp.md#section8160554134811)传入的IP地址格式不正确。

**处理步骤**

确认[StaticDnsRule](../topics/misc/rcp.md#section47911616155511)或者[DynamicDnsRule](../topics/misc/rcp.md#section8160554134811)传入参数格式是否正确可用。
...
通过使用[PathPreference](../topics/misc/rcp.md#section828055885811)的'cellular'模式拉起蜂窝数据连接时，因为条件不满足而导致激活蜂窝超时。
...
URPC请求超出开发者配置的[UrpcConnectConfiguration](../topics/misc/urpc.md#section4802256134519)时长。

**可能原因**

1. 请求侧请求发送失败，底层发送队列阻塞。
1. 服务侧发生异常，未正常回复response。
...
排查[UrpcStub](../topics/misc/urpc.md#section1671892662116)类的声明和使用是否正确。
