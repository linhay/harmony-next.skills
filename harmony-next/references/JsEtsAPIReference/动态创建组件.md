...
参数名类型必填说明tagstring是组件名称。

**返回值：**

类型说明Element对应tag名称的组件对象。
...
参数名类型必填说明namestring是属性名称。valuestring是属性值。
...
参数名类型必填说明namestring是样式名称。valuestring是样式值。

**返回值：**

类型说明boolean设置成功时返回true，失败时返回false。
