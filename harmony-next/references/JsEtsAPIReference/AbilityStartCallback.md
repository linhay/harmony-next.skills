...
名称类型只读可选说明completionHandler21+[CompletionHandlerForAbilityStartCallback](@ohos.app.ability.CompletionHandlerForAbilityStartCallback (拉起应用结果回调的操作类).md)否是
...
参数名类型必填说明parameter[AbilityResult](AbilityResult.md)是当调用[terminateSelfWithResult](UIExtensionContext.md#ZH-CN_TOPIC_0000002497444650__terminateselfwithresult12)方法终止UIExtensionAbility时返回的结果。
