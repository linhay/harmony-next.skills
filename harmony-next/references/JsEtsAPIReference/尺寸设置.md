...
在[TextInput](TextInput.md)组件中，width设置auto表示自适应文本宽度。
...
类型说明T返回当前组件。
 ...
 在[Row](Row.md)、[Column](Column.md)、[RelativeContainer](RelativeContainer.md)组件中，width、height设置auto表示自适应子组件。
...
参数名类型必填说明paddingValue[Padding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__padding) | [LengthMetrics](Graphics.md#ZH-CN_TOPIC_0000002529444761__lengthmetrics12) | [LocalizedPadding](基础类型定义.md#ZH-CN_TOPIC_0000002497604974__localizedpadding12)是
