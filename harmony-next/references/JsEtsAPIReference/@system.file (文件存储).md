...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.moveFile](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsmovefile)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.copyFile](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fscopyfile)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.listFile](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fslistfile)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.stat](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsstat)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.unlink](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsunlink)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.write](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fswrite)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.readText](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsreadtext)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.read](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsread)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.access](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsaccess)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.mkdir](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsmkdir)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fs.rmdir](@ohos.file.fs (文件管理).md#ZH-CN_TOPIC_0000002529445221__fsrmdir)替代。
