...
名称typedef关键字描述[MediaKeySession](MediaKeySession.md)MediaKeySessionMediaKeySession类型。[DRM_MediaKeySystemInfo](DRM_MediaKeySystemInfo.md)DRM_MediaKeySystemInfoDRM_MediaKeySystemInfo类型。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[DRM_MediaKeySystemInfo](DRM_MediaKeySystemInfo.md)* mediaKeySystemInfoDRM信息。
...
类型说明[OH_AVPlayer](OH_AVPlayer.md) *
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。const char *url播放源。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t fd媒体源的文件描述符。int64_t offset媒体源在文件描述符中的偏移量。int64_t size表示媒体源的大小。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。OH_AVDataSourceExt* datasrc指向自定义媒体数据的指针。void* userData用户传入的句柄，用于回调中传入。userData若为空，不支持AVPlayer的多实例播放。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。float leftVolume要设置的左声道目标音量。float rightVolume要设置的右声道目标音量。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。float loudnessGain设置播放器的响度值，单位为dB，响度范围为[-90.0, 24.0]。
...
AV_ERR_OK：成功设置响度。
 ...
 AV_ERR_INVALID_STATE：函数在不正常的状态下调用，或者audioRendererInfo的usage参数不是[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage).STREAM_USAGE_MUSIC，

[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage).STREAM_USAGE_MOVIE ，[StreamUsage](Enums.md#ZH-CN_TOPIC_0000002529285695__streamusage).STREAM_USAGE_AUDIOBOOK 之一。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t mSeconds播放目标位置，精确到毫秒。[AVPlayerSeekMode](avplayer_base.h.md#ZH-CN_TOPIC_0000002529285905__avplayerseekmode) mode播放器的跳转模式。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t *currentTime播放位置。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t *videoWidth视频宽度。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t *videoHeight视频高度。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[AVPlaybackSpeed](avplayer_base.h.md#ZH-CN_TOPIC_0000002529285905__avplaybackspeed) speed速率模式。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。float rate播放速率，有效范围是0.125~4。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[OH_AudioStream_Usage](native_audiostream_base.h.md#ZH-CN_TOPIC_0000002529445679__oh_audiostream_usage) streamUsageplayer音频流设置的类型。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[OH_AudioStream_VolumeMode](native_audiostream_base.h.md#ZH-CN_TOPIC_0000002529445679__oh_audiostream_volumemode) volumeMode指定音频流音量模式。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[OH_AudioInterrupt_Mode](native_audiostream_base.h.md#ZH-CN_TOPIC_0000002529445679__oh_audiointerrupt_mode) interruptModeplayer音频流使用的打断模式。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[OH_AudioStream_AudioEffectMode](native_audiostream_base.h.md#ZH-CN_TOPIC_0000002529445679__oh_audiostream_audioeffectmode) effectModeplayer音频流使用的音效模式。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。uint32_t bitRate码率，单位为bps。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。OHNativeWindow *window指向OHNativeWindow实例的指针。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t *duration媒体文件的总时长。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[AVPlayerState](avplayer_base.h.md#ZH-CN_TOPIC_0000002529285905__avplayerstate) *state当前播放状态。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。bool loop循环播放开关。true表示开启循环播放，false表示关闭循环播放。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[AVPlayerCallback](AVPlayerCallback.md) callback回调对象指针。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t index索引。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。int32_t trackType媒体类型。0：音频，1：视频。int32_t *index索引。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[Player_MediaKeySystemInfoCallback](#ZH-CN_TOPIC_0000002497445934__player_mediakeysysteminfocallback) callback对象指针。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[DRM_MediaKeySystemInfo](DRM_MediaKeySystemInfo.md) *mediaKeySystemInfo媒体密钥系统信息。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[MediaKeySession](MediaKeySession.md) *mediaKeySession具有解密功能的媒体密钥会话实例。bool secureVideoPath是否需要安全解码器。true表示需要安全解码器，false表示不需要安全解码器。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[OH_AVPlayerOnInfoCallback](avplayer_base.h.md#ZH-CN_TOPIC_0000002529285905__oh_avplayeroninfocallback) callback执行回调监听函数的指针，空指针表示取消设置播放器消息回调监听。void *userData指向应用调用者设置的实例的指针。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。[OH_AVPlayerOnErrorCallback](avplayer_base.h.md#ZH-CN_TOPIC_0000002529285905__oh_avplayeronerrorcallback) callback执行回调监听函数的指针，空指针表示取消设置播放器错误回调监听。void *userData指向应用调用者设置的实例的指针。
...
参数项描述[OH_AVPlayer](OH_AVPlayer.md) *player指向OH_AVPlayer实例的指针。uint32_t index轨道索引下标。
