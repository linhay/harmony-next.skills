...
类型说明[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)*返回创建的颜色滤波器对象的指针。
...
参数项描述[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)* outerColorFilter指向颜色滤波器对象一的指针。[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)* innerColorFilter指向颜色滤波器对象二的指针。
...
参数项描述[OH_Drawing_ColorFilter](OH_Drawing_ColorFilter.md)* colorFilter表示指向颜色滤波器对象的指针。