...
会话配置前，调用[start](Interface (Session).md#ZH-CN_TOPIC_0000002529445753__start11-1)操作等。
...
会话运行前，调用[capture](Interface (PhotoOutput).md#ZH-CN_TOPIC_0000002529445751__capture)操作等。
