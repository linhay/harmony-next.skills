...
名称描述[VkNativeBufferPropertiesOHOS](../topics/misc/VkNativeBufferPropertiesOHOS.md)包含了NativeBuffer的属性。[VkNativeBufferFormatPropertiesOHOS](../topics/misc/VkNativeBufferFormatPropertiesOHOS.md)包含了NativeBuffer的一些格式属性。[VkImportNativeBufferInfoOHOS](../topics/misc/VkImportNativeBufferInfoOHOS.md)包含了OH_NativeBuffer结构体的指针。[VkMemoryGetNativeBufferInfoOHOS](../topics/misc/VkMemoryGetNativeBufferInfoOHOS.md)用于从Vulkan内存中获取OH_NativeBuffer。[VkExternalFormatOHOS](../topics/misc/VkExternalFormatOHOS.md)表示外部定义的格式标识符。

#### 函数

名称描述VKAPI_ATTR VkResult VKAPI_CALL [vkGetNativeBufferPropertiesOHOS](../capi/headers/vulkan_ohos.h.md#ZH-CN_TOPIC_0000002529446153__vkgetnativebufferpropertiesohos) (VkDevice device, const struct OH_NativeBuffer *buffer, [VkNativeBufferPropertiesOHOS](../topics/misc/VkNativeBufferPropertiesOHOS.md) *pProperties)获取OH_NativeBuffer属性。
...
创建NatvieImage对象作为OHNativeBuffer的消费端，并根据NativeImage对象获取对应的NativeWindow对象，将NativeWindow句柄传给视频编解码，作为OHNativeBuffer的生产端，用于生产视频帧内容。
