...
- [newLatLngBounds](../topics/misc/newLatLngBounds.md)：设置地图经纬度范围、地图区域和边界之间的距离。
- [newLatLngBounds](../topics/misc/newLatLngBounds.md)：设置地图经纬度范围、经纬度矩形范围的高和宽、地图区域和边界之间的距离。
- [newLatLngBounds](../topics/misc/newLatLngBounds.md)：设置地图经纬度范围和4个方向与边界之间的距离。
